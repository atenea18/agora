...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $institucion = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['campos'][0]; 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['campos'][1]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['campos'][2]; 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['campos'][0] = $this->institucion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['campos'][1] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['campos'][2] = $this->pswd; 
...
//
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][app_Login_pack_protect_string(NM_charset_to_utf8($this->institucion))]) ? $aLookup[0][app_Login_pack_protect_string(NM_charset_to_utf8($this->institucion))] : "";
