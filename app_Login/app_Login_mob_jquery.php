...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_institucion' + iSeqRow).bind('blur', function() { sc_app_Login_institucion_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_app_Login_institucion_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_app_Login_institucion_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_app_Login_institucion_onblur(oThis, iSeqRow) {
  do_ajax_app_Login_mob_validate_institucion();
  scCssBlur(oThis);
}

function sc_app_Login_institucion_onchange(oThis, iSeqRow) {
  do_ajax_app_Login_mob_event_institucion_onchange();
}

function sc_app_Login_institucion_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
