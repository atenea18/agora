...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_con_conn_mysql_ge']         = "conn_mysql_ge";
//
class app_Login_ini
{
   var $nm_cod_apl;
...
/*NM*/            $_SESSION['scriptcase']['app_Login']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['app_Login']['glo_con_conn_mysql_ge'], $this->path_libs, "S");
          $this->nm_con_conn_mysql_ge['servidor'] = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_mysql_ge['usuario']  = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_mysql_ge['banco']    = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_mysql_ge['senha']    = $_SESSION['scriptcase']['glo_senha'];
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'agora_IV'); 
      } 
      else 
      { 
...
//
    ...
    {
        if ('ajax_app_Login_validate_institucion' == $_POST['rs'])
        {
        ...
        if ('ajax_app_Login_event_institucion_onchange' == $_POST['rs'])
        {
            $institucion = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_Login_autocomp_institucion' == $_POST['rs'])
        {
            $institucion = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
    ...
    else
    {
        ...
        if (isset($_POST["grupo"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['grupo']);
        }
        if (isset($_GET["grupo"])) 
        {
        ...
        if (isset($_POST["docente"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['docente']);
        }
        ...
        if (isset($_POST["institucion"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['institucion']);
        }
        ...
        if (isset($_POST["par_nombre_institucion"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_nombre_institucion']);
        }
        ...
        if (isset($_POST["logo"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['logo']);
        }
        if (isset($_GET["logo"])) 
        {
        ...
        if (isset($_POST["database"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['database']);
        }
        ...
        if (isset($_POST["par_fecha"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_fecha']);
        }
        ...
        if (isset($_POST["par_idestudiante"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_idestudiante']);
        }
        ...
        if (isset($_POST["par_year"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_year']);
        }
        ...
        if (isset($_POST["par_estudiante"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_estudiante']);
        }
        ...
        if (isset($_POST["par_tipo_identif"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_tipo_identif']);
        }
        ...
        if (isset($_POST["par_numero_doc"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_numero_doc']);
        }
        ...
        if (isset($_POST["modelo"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['modelo']);
        }
        ...
        if (isset($_POST["par_1"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_1']);
        }
        if (isset($_GET["par_1"])) 
        {
        ...
        if (isset($_POST["par_2"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_2']);
        }
        if (isset($_GET["par_2"])) 
        {
        ...
        if (isset($_POST["par_3"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_3']);
        }
        if (isset($_GET["par_3"])) 
        {
        ...
        if (isset($_POST["par_4"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_4']);
        }
        if (isset($_GET["par_4"])) 
        {
        ...
        if (isset($_POST["par_5"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_5']);
        }
        if (isset($_GET["par_5"])) 
        {
        ...
        if (isset($_POST["par_6"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_6']);
        }
        if (isset($_GET["par_6"])) 
        {
        ...
        if (isset($_POST["par_7"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_7']);
        }
        if (isset($_GET["par_7"])) 
        {
        ...
        if (isset($_POST["par_8"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_8']);
        }
        if (isset($_GET["par_8"])) 
        {
        ...
        if (isset($_POST["par_9"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_9']);
        }
        if (isset($_GET["par_9"])) 
        {
        ...
        if (isset($_POST["par_10"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_10']);
        }
        ...
        if (isset($_POST["par_11"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_11']);
        }
        ...
        if (isset($_POST["par_12"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_12']);
        }
        ...
        if (isset($_POST["par_13"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_13']);
        }
        ...
        if (isset($_POST["par_14"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_14']);
        }
        ...
        if (isset($_POST["par_15"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_15']);
        }
        ...
        if (isset($_POST["par_16"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_16']);
        }
        ...
        if (isset($_POST["par_17"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_17']);
        }
        ...
        if (isset($_POST["par_18"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_18']);
        }
        ...
        if (isset($_POST["par_19"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_19']);
        }
        ...
        if (isset($_POST["par_20"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_20']);
        }
        ...
        if (isset($_POST["par_21"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_21']);
        }
        ...
        if (isset($_POST["par_22"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_22']);
        }
        ...
        if (isset($_POST["par_23"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_23']);
        }
        ...
        if (isset($_POST["par_24"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_24']);
        }
        ...
        if (isset($_POST["par_25"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_25']);
        }
        ...
        if (isset($_POST["par_nota_maxima"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['par_nota_maxima']);
        }
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_app_Login_validate_institucion");
    ...
    sajax_export("ajax_app_Login_event_institucion_onchange");
    sajax_export("ajax_app_Login_autocomp_institucion");
...
//
    ...
    function ajax_app_Login_validate_institucion($institucion, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'validate_institucion';
    ...
    function ajax_app_Login_event_institucion_onchange($institucion, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'event_institucion_onchange';
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param'] = array(
                  'institucion' => NM_utf8_urldecode($institucion),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
    ...
    function ajax_app_Login_autocomp_institucion($institucion, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'autocomp_institucion';
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param'] = array(
                  'institucion' => NM_utf8_urldecode($institucion),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param']['institucion'] = utf8_decode(urldecode($inicial_app_Login->contr_app_Login->NM_ajax_info['param']['institucion']));
        if ($inicial_app_Login->contr_app_Login->NM_ajax_info['param']['buffer_output'])
        {
            ob_start();
        }
    ...
    function ajax_app_Login_submit_form($institucion, $login, $pswd, $links, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
