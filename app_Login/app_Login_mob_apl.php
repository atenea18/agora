...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $institucion = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['campos'][0]; 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['campos'][1]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['campos'][2]; 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['campos'][0] = $this->institucion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['campos'][1] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['campos'][2] = $this->pswd; 
...
if (isset($this->rs[0][0]))     
{
  $par_nombre_institucion = $this->rs[0][0];
	 $logo = '<img src=../_lib/file/img/'.$this->rs[0][1].' width="60" height="60">';
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form("http://docentes.agora.net.co/auth/login/$this->sc_temp_database/$this->sc_temp_usr_login", $this->nm_location, "", "_self", "ret_self", 440, 630);
 }; 
	}else{
	 if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
 if (isset($this->sc_temp_database)) { $_SESSION['database'] = $this->sc_temp_database;}
...
//
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][app_Login_mob_pack_protect_string(NM_charset_to_utf8($this->institucion))]) ? $aLookup[0][app_Login_mob_pack_protect_string(NM_charset_to_utf8($this->institucion))] : "";
...
$arr_conn['user'] = "agoranet";
$arr_conn['password'] = "Richard_111";
