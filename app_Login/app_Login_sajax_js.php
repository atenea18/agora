...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_app_Login_validate_institucion()
  {
  } // do_ajax_app_Login_validate_institucion

  function do_ajax_app_Login_validate_institucion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_institucion_cb
  ...
  function do_ajax_app_Login_event_institucion_onchange()
  {
    var var_institucion = scAjaxGetFieldText("institucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    scEventControl_onChange_call("institucion", "");
    x_ajax_app_Login_event_institucion_onchange(var_institucion, var_script_case_init, do_ajax_app_Login_event_institucion_onchange_cb);
  } // do_ajax_app_Login_event_institucion_onchange

  function do_ajax_app_Login_event_institucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "institucion";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_Login_event_institucion_onchange_cb
  // ---------- Form
  function do_ajax_app_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_submit_form(var_institucion, var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_submit_form_cb);
