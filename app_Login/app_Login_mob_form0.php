 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-institucion", elem).focus(function() {
   ...
   select: function (event, ui) {
    ...
    do_ajax_app_Login_mob_event_institucion_onchange(sRow);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_institucion_line" id="hidden_field_data_institucion" style="<?php echo $sStyleHidden_institucion; ?>"> <span class="scFormLabelOddFormat css_institucion_label"><span id="id_label_institucion"><?php echo $this->nm_new_label['institucion']; ?></span></span><br>
...
$aLookup = array();
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Lookup_institucion']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Lookup_institucion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Lookup_institucion']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Lookup_institucion'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Ini->nm_db_conn_mysql_ge->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(app_Login_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => app_Login_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['Lookup_institucion'][] = $rs->fields[0];
