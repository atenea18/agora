...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_t_grupos_calif_m_jj_vaios_doce_cero']['contr_erro']) && $_SESSION['scriptcase']['grid_t_grupos_calif_m_jj_vaios_doce_cero']['contr_erro'] == 'on')
    {
