<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estu_subgrupo_selec_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estu_subgrupo_selec_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   {
       $tab_def_campos['nombre_completo'] = "CONCAT_WS(' ',primer_apellido,segundo_apellido,primer_nombre,segundo_nombre)";
       $tab_converte["CONCAT_WS(' ',primer_apellido,segundo_apellido,primer_nombre,segundo_nombre)"]   = "nombre_completo";
   }
   $tab_labels["nombre_completo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['labels']["nombre_completo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['labels']["nombre_completo"] : "Nombre Completo";
   ...
   $tab_labels["t_estudiante_grupo_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['labels']["t_estudiante_grupo_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['labels']["t_estudiante_grupo_id_grupo"] : "Grupo";
   ...
   $tab_labels["t_estudiante_grupo_idstudent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['labels']["t_estudiante_grupo_idstudent"])) ? $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['labels']["t_estudiante_grupo_idstudent"] : "Idstudent";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estu_subgrupo_selec_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estu_subgrupo_selec']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
