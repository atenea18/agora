...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "t_estudiante_grupo_id_grupo";$Nm_numeric[] = "t_estudiante_grupo_idstudent";$Nm_numeric[] = "t_estudiante_grupo_id_grupo";$Nm_numeric[] = "t_estudiante_grupo_idstudent";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_completo"  <?php echo $str_hide_nombre_completo?>><?php
      $nombre_completo_look = substr($this->Db->qstr($nombre_completo), 1, -1); 
      $nmgp_def_dados = array(); 
