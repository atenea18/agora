  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_evaluacion_p1_trancicion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_id_estudiante_(iNumLinha)
  {
    ...
    x_ajax_form_t_evaluacion_p1_trancicion_validate_id_estudiante_(var_id_estudiante_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_id_estudiante__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_id_estudiante_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_id_estudiante__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_id_estudiante__cb

  // ---------- Validate estatus_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_estatus_(iNumLinha)
  {
    var nomeCampo_estatus_ = "estatus_" + iNumLinha;
    var var_estatus_ = scAjaxGetFieldHidden(nomeCampo_estatus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_estatus_(var_estatus_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_estatus__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_estatus_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_estatus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_estatus__cb

  // ---------- Validate novedad_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_novedad_(iNumLinha)
  {
    var nomeCampo_novedad_ = "novedad_" + iNumLinha;
    var var_novedad_ = scAjaxGetFieldHidden(nomeCampo_novedad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_novedad_(var_novedad_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_novedad__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_novedad_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_novedad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_novedad__cb

  // ---------- Validate asienta_inasistencias_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_asienta_inasistencias_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_asienta_inasistencias_(var_asienta_inasistencias_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_asienta_inasistencias__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_asienta_inasistencias_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_asienta_inasistencias__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_asienta_inasistencias__cb

  // ---------- Validate inasistencia_p1_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_inasistencia_p1_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_inasistencia_p1_(var_inasistencia_p1_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_inasistencia_p1__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_inasistencia_p1_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_inasistencia_p1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_inasistencia_p1__cb

  // ---------- Validate eval_1_per_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_eval_1_per_(iNumLinha)
  {
    var nomeCampo_eval_1_per_ = "eval_1_per_" + iNumLinha;
    var var_eval_1_per_ = scAjaxGetFieldHidden(nomeCampo_eval_1_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_eval_1_per_(var_eval_1_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_eval_1_per__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_eval_1_per_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_eval_1_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_eval_1_per__cb

  // ---------- Validate dc1_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc1_(iNumLinha)
  {
    var nomeCampo_dc1_ = "dc1_" + iNumLinha;
    var var_dc1_ = scAjaxGetFieldText(nomeCampo_dc1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc1_(var_dc1_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc1__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc1_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc1__cb

  // ---------- Validate dc2_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc2_(iNumLinha)
  {
    var nomeCampo_dc2_ = "dc2_" + iNumLinha;
    var var_dc2_ = scAjaxGetFieldText(nomeCampo_dc2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc2_(var_dc2_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc2__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc2_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc2__cb

  // ---------- Validate dc3_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc3_(iNumLinha)
  {
    var nomeCampo_dc3_ = "dc3_" + iNumLinha;
    var var_dc3_ = scAjaxGetFieldText(nomeCampo_dc3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc3_(var_dc3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc3__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc3_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc3__cb

  // ---------- Validate dc4_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc4_(iNumLinha)
  {
    var nomeCampo_dc4_ = "dc4_" + iNumLinha;
    var var_dc4_ = scAjaxGetFieldText(nomeCampo_dc4_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc4_(var_dc4_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc4__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc4_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc4__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc4__cb

  // ---------- Validate dc5_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc5_(iNumLinha)
  {
    var nomeCampo_dc5_ = "dc5_" + iNumLinha;
    var var_dc5_ = scAjaxGetFieldText(nomeCampo_dc5_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc5_(var_dc5_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc5__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc5_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc5__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc5__cb

  // ---------- Validate dc6_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc6_(iNumLinha)
  {
    var nomeCampo_dc6_ = "dc6_" + iNumLinha;
    var var_dc6_ = scAjaxGetFieldText(nomeCampo_dc6_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc6_(var_dc6_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc6__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc6_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc6__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc6__cb

  // ---------- Validate dc7_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc7_(iNumLinha)
  {
    var nomeCampo_dc7_ = "dc7_" + iNumLinha;
    var var_dc7_ = scAjaxGetFieldText(nomeCampo_dc7_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc7_(var_dc7_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc7__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc7_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc7__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc7__cb

  // ---------- Validate dc8_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc8_(iNumLinha)
  {
    var nomeCampo_dc8_ = "dc8_" + iNumLinha;
    var var_dc8_ = scAjaxGetFieldText(nomeCampo_dc8_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc8_(var_dc8_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc8__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc8_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc8__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc8__cb

  // ---------- Validate dc9_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc9_(iNumLinha)
  {
    var nomeCampo_dc9_ = "dc9_" + iNumLinha;
    var var_dc9_ = scAjaxGetFieldText(nomeCampo_dc9_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc9_(var_dc9_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc9__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc9_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc9__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc9__cb

  // ---------- Validate dc10_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc10_(iNumLinha)
  {
    var nomeCampo_dc10_ = "dc10_" + iNumLinha;
    var var_dc10_ = scAjaxGetFieldText(nomeCampo_dc10_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc10_(var_dc10_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc10__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc10_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc10__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc10__cb

  // ---------- Validate dc11_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc11_(iNumLinha)
  {
    var nomeCampo_dc11_ = "dc11_" + iNumLinha;
    var var_dc11_ = scAjaxGetFieldText(nomeCampo_dc11_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc11_(var_dc11_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc11__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc11_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc11__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc11__cb

  // ---------- Validate dc12_
  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc12_(iNumLinha)
  {
    var nomeCampo_dc12_ = "dc12_" + iNumLinha;
    var var_dc12_ = scAjaxGetFieldText(nomeCampo_dc12_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_validate_dc12_(var_dc12_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_validate_dc12__cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc12_

  function do_ajax_form_t_evaluacion_p1_trancicion_validate_dc12__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p1_trancicion_validate_dc12__cb

  // ---------- Event onblur aeep1_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_aeep1__onblur(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_aeep1__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_aeep1__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_aeep1__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_aeep1__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_aeep1__onblur_cb

  // ---------- Event onblur dc10_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc10__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc10__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc10__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc10__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc10__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc10__onblur_cb

  // ---------- Event onblur dc11_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc11__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc11__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc11__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc11__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc11__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc11__onblur_cb

  // ---------- Event onblur dc12_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc12__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc12__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc12__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc12__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc12__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc12__onblur_cb

  // ---------- Event onblur dc1_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc1__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc1__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc1__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc1__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc1__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc1__onblur_cb

  // ---------- Event onblur dc2_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc2__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc2__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc2__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc2__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc2__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc2__onblur_cb

  // ---------- Event onblur dc3_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc3__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc3__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc3__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc3__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc3__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc3__onblur_cb

  // ---------- Event onblur dc4_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc4__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc4__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc4__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc4__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc4__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc4__onblur_cb

  // ---------- Event onblur dc5_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc5__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc5__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc5__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc5__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc5__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc5__onblur_cb

  // ---------- Event onblur dc6_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc6__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc6__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc6__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc6__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc6__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc6__onblur_cb

  // ---------- Event onblur dc7_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc7__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc7__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc7__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc7__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc7__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc7__onblur_cb

  // ---------- Event onblur dc8_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc8__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc8__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc8__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc8__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc8__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc8__onblur_cb

  // ---------- Event onblur dc9_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc9__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dc9__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dc9__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc9__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dc9__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dc9__onblur_cb

  // ---------- Event onblur dp1_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp1__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dp1__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dp1__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp1__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp1__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp1__onblur_cb

  // ---------- Event onblur dp2_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp2__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dp2__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dp2__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp2__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp2__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp2__onblur_cb

  // ---------- Event onblur dp3_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp3__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dp3__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dp3__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp3__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp3__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp3__onblur_cb

  // ---------- Event onblur dp4_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp4__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dp4__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dp4__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp4__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp4__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp4__onblur_cb

  // ---------- Event onblur dp5_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp5__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_dp5__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_dp5__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp5__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_dp5__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_dp5__onblur_cb

  // ---------- Event onblur ds1_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds1__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_ds1__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_ds1__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds1__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds1__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds1__onblur_cb

  // ---------- Event onblur ds2_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds2__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_ds2__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_ds2__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds2__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds2__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds2__onblur_cb

  // ---------- Event onblur ds3_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds3__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_ds3__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_ds3__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds3__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds3__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds3__onblur_cb

  // ---------- Event onblur ds4_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds4__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_ds4__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_ds4__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds4__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds4__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds4__onblur_cb

  // ---------- Event onblur ds5_
  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds5__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_dc3_ = scAjaxGetFieldText("dc3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_event_ds5__onblur(var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_p1_trancicion_event_ds5__onblur_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds5__onblur

  function do_ajax_form_t_evaluacion_p1_trancicion_event_ds5__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_p1_trancicion_event_ds5__onblur_cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_evaluacion_p1_trancicion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_evaluacion_p1_trancicion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p1_trancicion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_add_new_line_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_add_new_line

  function do_ajax_form_t_evaluacion_p1_trancicion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_evaluacion_p1_trancicion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_evaluacion_p1_trancicion_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p1_trancicion_backup_line(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_backup_line_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_backup_line

  function do_ajax_form_t_evaluacion_p1_trancicion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_evaluacion_p1_trancicion_backup_line_cb

  function do_ajax_form_t_evaluacion_p1_trancicion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_evaluacion_p1_trancicion_cancel_insert

  function do_ajax_form_t_evaluacion_p1_trancicion_cancel_update(iSeqVert)
  {
    do_ajax_form_t_evaluacion_p1_trancicion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_evaluacion_p1_trancicion_cancel_update

  function do_ajax_form_t_evaluacion_p1_trancicion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_evaluacion_p1_trancicion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_evaluacion_p1_trancicion_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_p1_trancicion_table_refresh(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_table_refresh_cb);
  } //  do_ajax_form_t_evaluacion_p1_trancicion_table_refresh

  function do_ajax_form_t_evaluacion_p1_trancicion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_evaluacion_p1_trancicion_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_evaluacion_p1_trancicion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_evaluacion_p1_trancicion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_t_evaluacion_p1_trancicion_submit_form(var_id_estudiante_, var_estatus_, var_novedad_, var_asienta_inasistencias_, var_inasistencia_p1_, var_eval_1_per_, var_dc1_, var_dc2_, var_dc3_, var_dc4_, var_dc5_, var_dc6_, var_dc7_, var_dc8_, var_dc9_, var_dc10_, var_dc11_, var_dc12_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_evaluacion_p1_trancicion_submit_form_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_submit_form

  function do_ajax_form_t_evaluacion_p1_trancicion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_t_evaluacion_p1_trancicion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_evaluacion_p1_trancicion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_t_evaluacion_p1_trancicion_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_p1_trancicion_navigate_form(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_p1_trancicion_navigate_form_cb);
  } // do_ajax_form_t_evaluacion_p1_trancicion_navigate_form

  function do_ajax_form_t_evaluacion_p1_trancicion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_t_evaluacion_p1_trancicion_navigate_form_cb
  function sc_hide_form_t_evaluacion_p1_trancicion_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_evaluacion_p1_trancicion_form
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_estudiante_" + iRow] || "on" == ajax_error_count["estatus_" + iRow] || "on" == ajax_error_count["novedad_" + iRow] || "on" == ajax_error_count["asienta_inasistencias_" + iRow] || "on" == ajax_error_count["inasistencia_p1_" + iRow] || "on" == ajax_error_count["eval_1_per_" + iRow] || "on" == ajax_error_count["dc1_" + iRow] || "on" == ajax_error_count["dc2_" + iRow] || "on" == ajax_error_count["dc3_" + iRow] || "on" == ajax_error_count["dc4_" + iRow] || "on" == ajax_error_count["dc5_" + iRow] || "on" == ajax_error_count["dc6_" + iRow] || "on" == ajax_error_count["dc7_" + iRow] || "on" == ajax_error_count["dc8_" + iRow] || "on" == ajax_error_count["dc9_" + iRow] || "on" == ajax_error_count["dc10_" + iRow] || "on" == ajax_error_count["dc11_" + iRow] || "on" == ajax_error_count["dc12_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_estudiante_" + iRow] && "off" == ajax_error_count["estatus_" + iRow] && "off" == ajax_error_count["novedad_" + iRow] && "off" == ajax_error_count["asienta_inasistencias_" + iRow] && "off" == ajax_error_count["inasistencia_p1_" + iRow] && "off" == ajax_error_count["eval_1_per_" + iRow] && "off" == ajax_error_count["dc1_" + iRow] && "off" == ajax_error_count["dc2_" + iRow] && "off" == ajax_error_count["dc3_" + iRow] && "off" == ajax_error_count["dc4_" + iRow] && "off" == ajax_error_count["dc5_" + iRow] && "off" == ajax_error_count["dc6_" + iRow] && "off" == ajax_error_count["dc7_" + iRow] && "off" == ajax_error_count["dc8_" + iRow] && "off" == ajax_error_count["dc9_" + iRow] && "off" == ajax_error_count["dc10_" + iRow] && "off" == ajax_error_count["dc11_" + iRow] && "off" == ajax_error_count["dc12_" + iRow]))
    {
      if (bErrorRow)
      {
