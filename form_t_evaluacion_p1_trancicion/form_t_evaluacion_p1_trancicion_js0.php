...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_evaluacion_p1_trancicion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_id_grado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
var var_btn_sc_btn_0_id_grupo = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['dados_form'][$sc_seq_vert]['id_grupo_'])?>;
var var_btn_sc_btn_0_id_asign = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
var var_btn_sc_btn_0_par_idgrupo = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['dados_form'][$sc_seq_vert]['id_grupo_'])?>;
var var_btn_sc_btn_0_par_asign = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
var var_btn_sc_btn_0_par_idgrado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_trancicion']['where_detal']))
  {
?>  
...
{ 
   ...
   {
       window.open('<?php echo$this->Ini->path_link . "" . SC_dir_app_name('form_t_evaluacion_p1_trancicion') . "/form_t_evaluacion_p1_trancicion_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . $this->form_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id(); ?>&apl_prt=form_t_evaluacion_p1_trancicion.php&opcao=print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');
   }
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_t_evaluacion_p1_trancicion_submit_form(y, z); 
} 
<?php
}
?>
...
{
    NovaJanela = window.open ("form_t_evaluacion_p1_trancicion_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
