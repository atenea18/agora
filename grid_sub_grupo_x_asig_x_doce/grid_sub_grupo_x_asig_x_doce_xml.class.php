...
class grid_sub_grupo_x_asig_x_doce_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_sub_grupo_x_asig_x_doce_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_sub_grupo_x_asig_x_doce.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sub_grupo_x_asig_x_doce']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sub_grupo_x_asig_x_doce']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sub_grupo_x_asig_x_doce']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sub_grupo_x_asig_x_doce']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_sub_grupo_x_asig_x_doce";
   ...
   function NM_export_peso_asig_fre_area()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->peso_asig_fre_area))
         {
             $this->peso_asig_fre_area = sc_convert_encoding($this->peso_asig_fre_area, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " peso_asig_fre_area =\"" . $this->trata_dados($this->peso_asig_fre_area) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sub_grupo_x_asig_x_doce']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sub_grupo_x_asig_x_doce']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - sub_grupo_x_asig_x_doce :: XML</TITLE>
