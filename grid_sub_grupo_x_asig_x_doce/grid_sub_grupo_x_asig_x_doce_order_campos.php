<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_sub_grupo_x_asig_x_doce_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_sub_grupo_x_asig_x_doce_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_docente_grupo'] = "on";
   $tab_def_campos['id_docente_grupo'] = "id_docente_grupo";
   $tab_converte["id_docente_grupo"]   = "id_docente_grupo";
   $tab_labels["id_docente_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_docente_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_docente_grupo"] : "Id Docente Grupo";
   $tab_ger_campos['id_subgrupo'] = "on";
   $tab_def_campos['id_subgrupo'] = "id_subgrupo";
   $tab_converte["id_subgrupo"]   = "id_subgrupo";
   $tab_labels["id_subgrupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_subgrupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_subgrupo"] : "Id Subgrupo";
   $tab_ger_campos['id_asignatura'] = "on";
   $tab_def_campos['id_asignatura'] = "id_asignatura";
   $tab_converte["id_asignatura"]   = "id_asignatura";
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['id_docente'] = "on";
   $tab_def_campos['id_docente'] = "id_docente";
   $tab_converte["id_docente"]   = "id_docente";
   $tab_labels["id_docente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_docente"])) ? $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["id_docente"] : "Id Docente";
   ...
   $tab_labels["intensidad_horaria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["intensidad_horaria"])) ? $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["intensidad_horaria"] : "Intensidad Horaria";
   $tab_ger_campos['peso_asig_fre_area'] = "on";
   $tab_def_campos['peso_asig_fre_area'] = "peso_asig_fre_area";
   $tab_converte["peso_asig_fre_area"]   = "peso_asig_fre_area";
   $tab_labels["peso_asig_fre_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["peso_asig_fre_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['labels']["peso_asig_fre_area"] : "Peso Asig Fre Area";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - sub_grupo_x_asig_x_doce</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_sub_grupo_x_asig_x_doce_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_sub_grupo_x_asig_x_doce']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
