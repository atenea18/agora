...
class grid_t_evaluacion_prueba_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_t_evaluacion_prueba_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_t_evaluacion_prueba_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_t_evaluacion_prueba_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_t_evaluacion_prueba_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_t_evaluacion_prueba/grid_t_evaluacion_prueba_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_t_evaluacion_prueba_ajax_search.js"></script>
 <script type="text/javascript" src="grid_t_evaluacion_prueba_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_estudiante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['id_estudiante']; 
          $id_estudiante_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['id_estudiante_input_2']; 
          $id_estudiante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['id_estudiante_cond']; 
          $primer_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_apellido']; 
          $primer_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_apellido_cond']; 
          $segundo_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['segundo_apellido']; 
          $segundo_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['segundo_apellido_cond']; 
          $primer_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_nombre']; 
          $primer_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_t_evaluacion_prueba_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_prueba']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_prueba']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_t_evaluacion_prueba";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_t_evaluacion_prueba/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['id_estudiante'] = $id_estudiante; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['id_estudiante_input_2'] = $id_estudiante_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['id_estudiante_cond'] = $id_estudiante_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_apellido'] = $primer_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_apellido_cond'] = $primer_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['segundo_apellido'] = $segundo_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['segundo_apellido_cond'] = $segundo_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_nombre'] = $primer_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['primer_nombre_cond'] = $primer_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_prueba']['where_pesq_ant'] = $this->comando . $this->comando_fim;
