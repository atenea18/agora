<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_prueba_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_prueba_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["id_estudiante"] : "Id Estudiante";
   $tab_ger_campos['primer_apellido'] = "on";
   $tab_def_campos['primer_apellido'] = "primer_apellido";
   $tab_converte["primer_apellido"]   = "primer_apellido";
   $tab_labels["primer_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["primer_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["primer_apellido"] : "Primer Apellido";
   $tab_ger_campos['segundo_apellido'] = "on";
   $tab_def_campos['segundo_apellido'] = "segundo_apellido";
   $tab_converte["segundo_apellido"]   = "segundo_apellido";
   $tab_labels["segundo_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["segundo_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["segundo_apellido"] : "Segundo Apellido";
   $tab_ger_campos['primer_nombre'] = "on";
   $tab_def_campos['primer_nombre'] = "primer_nombre";
   $tab_converte["primer_nombre"]   = "primer_nombre";
   $tab_labels["primer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["primer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["primer_nombre"] : "Primer Nombre";
   $tab_ger_campos['segundo_nombre'] = "on";
   $tab_def_campos['segundo_nombre'] = "segundo_nombre";
   $tab_converte["segundo_nombre"]   = "segundo_nombre";
   $tab_labels["segundo_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["segundo_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["segundo_nombre"] : "Segundo Nombre";
   $tab_ger_campos['id_grupo'] = "on";
   $tab_def_campos['id_grupo'] = "id_grupo";
   $tab_converte["id_grupo"]   = "id_grupo";
   $tab_labels["id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['labels']["id_grupo"] : "Id Grupo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_prueba_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_prueba']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
