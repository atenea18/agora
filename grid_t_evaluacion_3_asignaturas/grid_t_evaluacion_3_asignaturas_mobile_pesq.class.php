...
class grid_t_evaluacion_3_asignaturas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_t_evaluacion_3_asignaturas_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_t_evaluacion_3_asignaturas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_t_evaluacion_3_asignaturas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_t_evaluacion_3_asignaturas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_id_estudiante($id_estudiante)
   {
      ...
      {
          $nm_comando = "select distinct id_estudiante from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and  id_estudiante like '%" . $id_estudiante . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_estudiante from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and  id_estudiante like '%" . $id_estudiante . "%'"; 
   ...
   function lookup_ajax_primer_apellido($primer_apellido)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_apellido from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and  primer_apellido like '%" . $primer_apellido . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_segundo_apellido($segundo_apellido)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct segundo_apellido from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and  segundo_apellido like '%" . $segundo_apellido . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_primer_nombre($primer_nombre)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_nombre from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and  primer_nombre like '%" . $primer_nombre . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_t_evaluacion_3_asignaturas/grid_t_evaluacion_3_asignaturas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_t_evaluacion_3_asignaturas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_t_evaluacion_3_asignaturas_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_estudiante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['id_estudiante']; 
          $id_estudiante_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['id_estudiante_input_2']; 
          $id_estudiante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['id_estudiante_cond']; 
          $primer_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_apellido']; 
          $primer_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_apellido_cond']; 
          $segundo_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['segundo_apellido']; 
          $segundo_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['segundo_apellido_cond']; 
          $primer_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_nombre']; 
          $primer_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_t_evaluacion_3_asignaturas_help.txt"))
   {
...
<?php echo $SC_Label ?><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_estudiante from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and id_estudiante = $id_estudiante_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_estudiante from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and id_estudiante = $id_estudiante_look"; 
...
<?php echo $SC_Label ?><br>
      ...
      $primer_apellido_look = substr($this->Db->qstr($primer_apellido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_apellido from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and primer_apellido = '$primer_apellido_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_primer_apellido" name="primer_apellido" value="<?php echo NM_encode_input($primer_apellido) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_primer_apellido" name="primer_apellido_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php echo $SC_Label ?><br>
      ...
      $segundo_apellido_look = substr($this->Db->qstr($segundo_apellido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct segundo_apellido from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and segundo_apellido = '$segundo_apellido_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_segundo_apellido" name="segundo_apellido" value="<?php echo NM_encode_input($segundo_apellido) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_segundo_apellido" name="segundo_apellido_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php echo $SC_Label ?><br>
      ...
      $primer_nombre_look = substr($this->Db->qstr($primer_nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_nombre from " . $this->Ini->nm_tabela . " where id_estudiante = " . $_SESSION['par_id_estudiante'] . " AND id_area = " . $_SESSION['par_id_area'] . " and primer_nombre = '$primer_nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_primer_nombre" name="primer_nombre" value="<?php echo NM_encode_input($primer_nombre) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_primer_nombre" name="primer_nombre_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_3_asignaturas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_3_asignaturas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_t_evaluacion_3_asignaturas";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_t_evaluacion_3_asignaturas/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      global $id_estudiante_cond, $id_estudiante, $id_estudiante_input_2, $id_estudiante_autocomp,
             $primer_apellido_cond, $primer_apellido, $primer_apellido_autocomp,
             $segundo_apellido_cond, $segundo_apellido, $segundo_apellido_autocomp,
             $primer_nombre_cond, $primer_nombre, $primer_nombre_autocomp, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['id_estudiante'] = $id_estudiante; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['id_estudiante_input_2'] = $id_estudiante_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['id_estudiante_cond'] = $id_estudiante_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_apellido'] = $primer_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_apellido_cond'] = $primer_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['segundo_apellido'] = $segundo_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['segundo_apellido_cond'] = $segundo_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_nombre'] = $primer_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['primer_nombre_cond'] = $primer_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['where_pesq_ant'] = $this->comando . $this->comando_fim;
