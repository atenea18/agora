...
class grid_t_evaluacion_3_asignaturas_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_evaluacion_3_asignaturas_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_t_evaluacion_3_asignaturas";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_t_evaluacion_3_asignaturas.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "eval_2_per" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "eval_3_per" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "eval_4_per" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "sup_p4" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
   ...
   function NM_export_eval_2_per()
   {
         ...
         if (!NM_is_utf8($this->eval_2_per))
         {
             $this->eval_2_per = sc_convert_encoding($this->eval_2_per, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->eval_2_per = str_replace('<', '&lt;', $this->eval_2_per);
         $this->eval_2_per = str_replace('>', '&gt;', $this->eval_2_per);
         $this->Texto_tag .= "<td>" . $this->eval_2_per . "</td>\r\n";
   }
   //----- sup_p2
   ...
   function NM_export_eval_3_per()
   {
         ...
         if (!NM_is_utf8($this->eval_3_per))
         {
             $this->eval_3_per = sc_convert_encoding($this->eval_3_per, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->eval_3_per = str_replace('<', '&lt;', $this->eval_3_per);
         $this->eval_3_per = str_replace('>', '&gt;', $this->eval_3_per);
         $this->Texto_tag .= "<td>" . $this->eval_3_per . "</td>\r\n";
   }
   //----- sup_p3
   ...
   function NM_export_eval_4_per()
   {
         ...
         if (!NM_is_utf8($this->eval_4_per))
         {
             $this->eval_4_per = sc_convert_encoding($this->eval_4_per, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->eval_4_per = str_replace('<', '&lt;', $this->eval_4_per);
         $this->eval_4_per = str_replace('>', '&gt;', $this->eval_4_per);
         $this->Texto_tag .= "<td>" . $this->eval_4_per . "</td>\r\n";
   }
   //----- sup_p4
   function NM_export_sup_p4()
   {
         $this->sup_p4 = html_entity_decode($this->sup_p4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sup_p4 = strip_tags($this->sup_p4);
         if (!NM_is_utf8($this->sup_p4))
         {
             $this->sup_p4 = sc_convert_encoding($this->sup_p4, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->sup_p4 = str_replace('<', '&lt;', $this->sup_p4);
         $this->sup_p4 = str_replace('>', '&gt;', $this->sup_p4);
         $this->Texto_tag .= "<td>" . $this->sup_p4 . "</td>\r\n";
   }
   //----- fea_re_ac
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_3_asignaturas'][$path_doc_md5][1] = $this->Tit_doc;
?>
