<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_3_asignaturas_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_3_asignaturas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_asignatura'] = "on";
   $tab_def_campos['id_asignatura'] = "id_asignatura";
   $tab_converte["id_asignatura"]   = "id_asignatura";
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["id_asignatura"] : "Asignatura";
   $tab_ger_campos['ihs_vac'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ihs_vac'] = "ihs_vac";
       $tab_converte["ihs_vac"]   = "ihs_vac";
   }
   else
   {
       $tab_def_campos['ihs_vac'] = "";
       $tab_converte[""]   = "ihs_vac";
   }
   $tab_labels["ihs_vac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["ihs_vac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["ihs_vac"] : "IHS";
   $tab_ger_campos['eval_1_per'] = "on";
   $tab_def_campos['eval_1_per'] = "eval_1_per";
   $tab_converte["eval_1_per"]   = "eval_1_per";
   $tab_labels["eval_1_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_1_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_1_per"] : "Eval 1 Per";
   $tab_ger_campos['sup_p1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sup_p1'] = "sup_p1";
       $tab_converte["sup_p1"]   = "sup_p1";
   }
   else
   {
       $tab_def_campos['sup_p1'] = "";
       $tab_converte[""]   = "sup_p1";
   }
   $tab_labels["sup_p1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p1"] : "SUP";
   $tab_ger_campos['eval_2_per'] = "on";
   $tab_def_campos['eval_2_per'] = "eval_2_per";
   $tab_converte["eval_2_per"]   = "eval_2_per";
   $tab_labels["eval_2_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_2_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_2_per"] : "Eval 2 Per";
   $tab_ger_campos['sup_p2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sup_p2'] = "sup_p2";
       $tab_converte["sup_p2"]   = "sup_p2";
   }
   else
   {
       $tab_def_campos['sup_p2'] = "";
       $tab_converte[""]   = "sup_p2";
   }
   $tab_labels["sup_p2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p2"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p2"] : "SUP";
   $tab_ger_campos['eval_3_per'] = "on";
   $tab_def_campos['eval_3_per'] = "eval_3_per";
   $tab_converte["eval_3_per"]   = "eval_3_per";
   $tab_labels["eval_3_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_3_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_3_per"] : "Eval 3 Per";
   $tab_ger_campos['sup_p3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sup_p3'] = "sup_p3";
       $tab_converte["sup_p3"]   = "sup_p3";
   }
   else
   {
       $tab_def_campos['sup_p3'] = "";
       $tab_converte[""]   = "sup_p3";
   }
   $tab_labels["sup_p3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p3"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p3"] : "SUP";
   $tab_ger_campos['eval_4_per'] = "on";
   $tab_def_campos['eval_4_per'] = "eval_4_per";
   $tab_converte["eval_4_per"]   = "eval_4_per";
   $tab_labels["eval_4_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_4_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["eval_4_per"] : "Eval 4 Per";
   $tab_ger_campos['sup_p4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sup_p4'] = "sup_p4";
       $tab_converte["sup_p4"]   = "sup_p4";
   }
   else
   {
       $tab_def_campos['sup_p4'] = "";
       $tab_converte[""]   = "sup_p4";
   }
   $tab_labels["sup_p4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p4"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["sup_p4"] : "SUP";
   $tab_ger_campos['fea_re_ac'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fea_re_ac'] = "fea_re_ac";
       $tab_converte["fea_re_ac"]   = "fea_re_ac";
   }
   else
   {
       $tab_def_campos['fea_re_ac'] = "";
       $tab_converte[""]   = "fea_re_ac";
   }
   $tab_labels["fea_re_ac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["fea_re_ac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["fea_re_ac"] : "Fa/Re Ac";
   $tab_ger_campos['definitiva'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['definitiva'] = "definitiva";
       $tab_converte["definitiva"]   = "definitiva";
   }
   else
   {
       $tab_def_campos['definitiva'] = "";
       $tab_converte[""]   = "definitiva";
   }
   $tab_labels["definitiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["definitiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["definitiva"] : "DEF";
   ...
   $tab_labels["vac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["vac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["vac"] : "VAc";
   ...
   $tab_labels["vra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["vra"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['labels']["vra"] : "VRA";
   $tab_ger_campos['ihs_vac'] = "none";
   $tab_ger_campos['sup_p1'] = "none";
   $tab_ger_campos['sup_p2'] = "none";
   $tab_ger_campos['sup_p3'] = "none";
   $tab_ger_campos['sup_p4'] = "none";
   $tab_ger_campos['fea_re_ac'] = "none";
   $tab_ger_campos['definitiva'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - t_evaluacion</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_3_asignaturas_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3_asignaturas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
