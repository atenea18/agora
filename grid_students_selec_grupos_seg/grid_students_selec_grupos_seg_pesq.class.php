...
class grid_students_selec_grupos_seg_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_students_selec_grupos_seg_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_students_selec_grupos_seg_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_students_selec_grupos_seg_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_students_selec_grupos_seg_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_students_idstudents')
      {
          $students_idstudents = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_students_idstudents($students_idstudents);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Estudiantes Disponibles en el Grado</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_students_selec_grupos_seg/grid_students_selec_grupos_seg_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_students_selec_grupos_seg_ajax_search.js"></script>
 <script type="text/javascript" src="grid_students_selec_grupos_seg_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_students_idstudents_cond#NMF#' + search_get_sel_txt('SC_students_idstudents_cond') + '@NMF@';
  str_out += 'SC_students_idstudents#NMF#' + search_get_text('SC_students_idstudents') + '@NMF@';
  str_out += 'id_ac_students_idstudents#NMF#' + search_get_text('id_ac_students_idstudents') + '@NMF@';
  str_out += 'SC_students_idstudents_input_2#NMF#' + search_get_text('SC_students_idstudents_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_students_idstudents").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_students_idstudents",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_students_idstudents").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_students_idstudents").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Estudiantes Disponibles en el Grado</span></td>
...
<?php
   ...
   {
      global 
             $students_idstudents_cond, $students_idstudents, $students_idstudents_input_2, $students_idstudents_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $students_idstudents = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['students_idstudents']; 
          $students_idstudents_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['students_idstudents_input_2']; 
          $students_idstudents_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['students_idstudents_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['NM_operador']; 
      } 
      if (!isset($students_idstudents_cond) || empty($students_idstudents_cond))
      {
         $students_idstudents_cond = "gt";
      }
      ...
      $str_hide_students_idstudents = (in_array($students_idstudents_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre = (in_array($nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_students_idstudents = ('bw' == $students_idstudents_cond) ? $display_aberto : $display_fechado;

      if (!isset($students_idstudents) || $students_idstudents == "")
      {
          $students_idstudents = "";
      }
      if (isset($students_idstudents) && !empty($students_idstudents))
      {
         $tmp_pos = strpos($students_idstudents, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $students_idstudents = substr($students_idstudents, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_students_selec_grupos_seg_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['students_idstudents'])) ? $this->New_label['students_idstudents'] : "Idstudents"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_students_idstudents_cond" name="students_idstudents_cond" onChange="nm_campos_between(document.getElementById('id_vis_students_idstudents'), this, 'students_idstudents')">
       <OPTION value="gt" <?php if ("gt" == $students_idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $students_idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $students_idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $students_idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_students_idstudents" <?php echo $str_hide_students_idstudents?> valign="top">
 ...
 $nmgp_tab_label .= "students_idstudents?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $students_idstudents_look = substr($this->Db->qstr($students_idstudents), 1, -1); 
   ...
   { 
      ...
      {
          $sAutocompValue = $students_idstudents;
      }
?>
<INPUT  type="text" id="SC_students_idstudents" name="students_idstudents" value="<?php echo NM_encode_input($students_idstudents) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_students_idstudents" name="students_idstudents_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_students_idstudents"  <?php echo $str_display_students_idstudents; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_students_idstudents_input_2" name="students_idstudents_input_2" value="<?php echo NM_encode_input($students_idstudents_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<INPUT  type="text" id="SC_nombre" name="nombre" value="<?php echo NM_encode_input($nombre) ?>" size=50 alt="{datatype: 'text', maxLength: 369, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_students_selec_grupos_seg']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_students_selec_grupos_seg']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_students_idstudents'), document.F1.students_idstudents_cond, 'students_idstudents');
   document.F1.students_idstudents.value = "";
   document.F1.students_idstudents_autocomp.value = "";
   document.F1.students_idstudents_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_students_selec_grupos_seg";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_students_selec_grupos_seg/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_students_idstudents_cond'] = 'cond';
      $tp_fields['SC_students_idstudents'] = 'text_aut';
      $tp_fields['id_ac_students_idstudents'] = 'text_aut';
      $tp_fields['SC_students_idstudents_input_2'] = 'text';
   ...
   {
      global $students_idstudents_cond, $students_idstudents, $students_idstudents_input_2, $students_idstudents_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($students_idstudents_autocomp) && empty($students_idstudents))
      {
          $students_idstudents = $students_idstudents_autocomp;
      }
      if (!empty($nombre_autocomp) && empty($nombre))
      {
          $nombre = $nombre_autocomp;
      }
      $students_idstudents_cond_salva = $students_idstudents_cond; 
      if (!isset($students_idstudents_input_2) || $students_idstudents_input_2 == "")
      {
          $students_idstudents_input_2 = $students_idstudents;
      }
      ...
      if ($students_idstudents_cond != "in")
      {
          nm_limpa_numero($students_idstudents, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $students_idstudents);
          ...
          $students_idstudents = implode(",", $Nm_sc_valores);
      }
      if ($students_idstudents_cond != "in")
      {
          nm_limpa_numero($students_idstudents_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['students_idstudents'] = $students_idstudents; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['students_idstudents_input_2'] = $students_idstudents_input_2; 
      if (is_array($students_idstudents) && !empty($students_idstudents))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['val'][0] = $students_idstudents;
      }
      elseif ($students_idstudents_cond_salva == "nu" || $students_idstudents_cond_salva == "nn" || $students_idstudents_cond_salva == "ep" || $students_idstudents_cond_salva == "ne" || !empty($students_idstudents))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['val'][0][0] = $students_idstudents;
      }
      if (is_array($students_idstudents_input_2) && !empty($students_idstudents_input_2))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['val'][1] = $students_idstudents_input_2;
      }
      elseif ($students_idstudents_cond_salva == "nu" || $students_idstudents_cond_salva == "nn" || $students_idstudents_cond_salva == "ep" || $students_idstudents_cond_salva == "ne" || !empty($students_idstudents_input_2))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['val'][1][0] = $students_idstudents_input_2;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['students_idstudents_cond'] = $students_idstudents_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['cmp'] = "students_idstudents"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['opc'] = $students_idstudents_cond_salva; 
          $I_Dyn++;
      }
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['nombre'] = $nombre; 
      if (is_array($nombre) && !empty($nombre))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['val'][0] = $nombre;
      }
      elseif ($nombre_cond_salva == "nu" || $nombre_cond_salva == "nn" || $nombre_cond_salva == "ep" || $nombre_cond_salva == "ne" || !empty($nombre))
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['val'][0][0] = $nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['cmp'] = "nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['dyn_search'][$I_Dyn]['opc'] = $nombre_cond_salva; 
          $I_Dyn++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($students_idstudents_cond != "in" && $students_idstudents_cond != "bw" && !empty($students_idstudents) && !is_numeric($students_idstudents))
      {
      ...
      if ($students_idstudents_cond == "bw" && ((!empty($students_idstudents) && !is_numeric($students_idstudents)) || (!empty($students_idstudents_input_2) && !is_numeric($students_idstudents_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idstudents";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['students_idstudents'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['students_idstudents'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['students_idstudents'] = $students_idstudents;
      }
      $Conteudo = $students_idstudents_input_2;
      if (strtoupper($students_idstudents_cond) != "II" && strtoupper($students_idstudents_cond) != "QP" && strtoupper($students_idstudents_cond) != "NP" && strtoupper($students_idstudents_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['students_idstudents_input_2'] = $Conteudo;
      $nombre_look = substr($this->Db->qstr($nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct concat_ws(' ',primer_apellido,segundo_apellido,primer_nombre,segundo_nombre) as sc_alias_0 from " . $this->Ini->nm_tabela . " where grado_igreso = " . $_SESSION['par_id_grado'] . " AND students.id_jornada = " . $_SESSION['par_jornada'] . "  AND students.id_sede = " . $_SESSION['par_sede'] . " AND  t_estudiante_grupo.idstudent  IS NULL and concat_ws(' ' = '$nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (isset($students_idstudents) || $students_idstudents_cond == "nu" || $students_idstudents_cond == "nn" || $students_idstudents_cond == "ep" || $students_idstudents_cond == "ne")
      {
         $this->monta_condicao("students.idstudents", $students_idstudents_cond, $students_idstudents, $students_idstudents_input_2, "students_idstudents");
      }
      ...
      {
         $this->monta_condicao("concat_ws(' ',primer_apellido,segundo_apellido,primer_nombre,segundo_nombre)", $nombre_cond, $nombre, "", "nombre");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_selec_grupos_seg']['where_pesq_ant'] = $this->comando . $this->comando_fim;
