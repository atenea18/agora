...
class grid_t_grupos_calif_m_jj_vaios_doce_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_grupos_calif_m_jj_vaios_doce_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_t_grupos_calif_m_jj_vaios_doce.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_jj_vaios_doce']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_jj_vaios_doce']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_jj_vaios_doce']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_jj_vaios_doce']['xls_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_jj_vaios_doce']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_jj_vaios_doce']['xls_file'] = $this->Xls_f;
      }
