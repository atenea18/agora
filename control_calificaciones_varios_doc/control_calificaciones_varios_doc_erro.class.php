...
class control_calificaciones_varios_doc_erro
{
   var $Ini;
   ...
   //----- 
   function control_calificaciones_varios_doc_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return control_calificaciones_varios_doc_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
