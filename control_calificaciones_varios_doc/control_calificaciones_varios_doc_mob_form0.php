...
<?php
include_once("control_calificaciones_varios_doc_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_calificaciones_varios_doc_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['recarga'];
}
?>
...
<?php
 include_once("control_calificaciones_varios_doc_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_calificaciones_varios_doc_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_calificaciones_varios_doc_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_calificaciones_varios_doc_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php  $this->docente_1 = explode(",", trim($this->docente)) ; ?>
    <TD class="scFormDataOdd css_docente_line" id="hidden_field_data_docente" style="<?php echo $sStyleHidden_docente; ?>"> <span class="scFormLabelOddFormat css_docente_label"><span id="id_label_docente"><?php echo $this->nm_new_label['docente']; ?></span></span><br>
...
else
{
   ...
   echo " <span id=\"idAjaxSelect_docente\"><select class=\"sc-js-input scFormObjectOdd css_docente_obj\" style=\"\" id=\"id_sc_field_docente\" name=\"docente[]\" size=\"5\" alt=\"{type: 'select', enterTab: false}\" multiple>" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_asignatura_line" id="hidden_field_data_asignatura" style="<?php echo $sStyleHidden_asignatura; ?>"> <span class="scFormLabelOddFormat css_asignatura_label"><span id="id_label_asignatura"><?php echo $this->nm_new_label['asignatura']; ?></span></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_calificaciones_varios_doc_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_calificaciones_varios_doc_mob");
 parent.scAjaxDetailHeight("control_calificaciones_varios_doc_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
