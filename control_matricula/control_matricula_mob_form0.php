...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Imprimir Matrícula"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_matricula/control_matricula_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_matricula_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_matricula_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['recarga'];
}
?>
...
<?php
 include_once("control_matricula_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_matricula_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_matricula_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_matricula_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Imprimir Matrícula"; } ?></span></td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['tipo_impresion'] = "Tipo de Impresión";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_impresion_line" id="hidden_field_data_tipo_impresion" style="<?php echo $sStyleHidden_tipo_impresion; ?>"> <span class="scFormLabelOddFormat css_tipo_impresion_label"><span id="id_label_tipo_impresion"><?php echo $this->nm_new_label['tipo_impresion']; ?></span></span><br>
...
$tipo_impresion_look = "";
 if ($this->tipo_impresion == "1") { $tipo_impresion_look .= "Grado" ;} 
 if ($this->tipo_impresion == "2") { $tipo_impresion_look .= "Grupo" ;} 
 if ($this->tipo_impresion == "3") { $tipo_impresion_look .= "Estudiante" ;} 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['Lookup_tipo_impresion'][] = 'null'; ?>
 <option value="null">Seleccione</option>
 <option value="1" <?php  if ($this->tipo_impresion == "1") { echo " selected" ;} ?>>Grado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['Lookup_tipo_impresion'][] = '1'; ?>
 <option value="2" <?php  if ($this->tipo_impresion == "2") { echo " selected" ;} ?>>Grupo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['Lookup_tipo_impresion'][] = '2'; ?>
 <option value="3" <?php  if ($this->tipo_impresion == "3") { echo " selected" ;} ?>>Estudiante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['Lookup_tipo_impresion'][] = '3'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "nm_atualiza('alterar');", "nm_atualiza('alterar');", "sub_form_b", "", "Imprimir", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_matricula_mob");
 parent.scAjaxDetailHeight("control_matricula_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
