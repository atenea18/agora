...
<?php
include_once("control_matricula_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_matricula_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['recarga'];
}
?>
...
<?php
 include_once("control_matricula_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_matricula'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_matricula'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['Lookup_tipo_impresion'][] = 'null'; ?>
 <option value="null">Seleccione</option>
 <option value="1" <?php  if ($this->tipo_impresion == "1") { echo " selected" ;} ?>>Grado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['Lookup_tipo_impresion'][] = '1'; ?>
 <option value="2" <?php  if ($this->tipo_impresion == "2") { echo " selected" ;} ?>>Grupo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['Lookup_tipo_impresion'][] = '2'; ?>
 <option value="3" <?php  if ($this->tipo_impresion == "3") { echo " selected" ;} ?>>Estudiante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['Lookup_tipo_impresion'][] = '3'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricula']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_matricula");
 parent.scAjaxDetailHeight("control_matricula", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
