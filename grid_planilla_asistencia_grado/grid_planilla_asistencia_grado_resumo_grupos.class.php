...
class grid_planilla_asistencia_grado_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_planilla_asistencia_grado_resumo($tipo = "")
   {
...
$_SESSION['scriptcase']['grid_planilla_asistencia_grado']['contr_erro'] = 'off'; 
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['contr_total_geral'] == "OK")
      {
          $this->array_total_id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['arr_total']['id_grupo'];
      }
      else
      {
          $this->array_total_id_grupo = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['arr_total']['id_grupo'] = $this->array_total_id_grupo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['pivot_tabular'];
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] = "print";
      ...
      $this->total   = new grid_planilla_asistencia_grado_total($this->Ini->sc_page);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_planilla_asistencia_grado_ajax.js\"></script>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_planilla_asistencia_grado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_planilla_asistencia_grado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_planilla_asistencia_grado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_planilla_asistencia_grado/grid_planilla_asistencia_grado_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_planilla_asistencia_grado/grid_planilla_asistencia_grado_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_planilla_asistencia_grado_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_planilla_asistencia_grado_config_pivot.php?nome_apl=grid_planilla_asistencia_grado&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("{\r\n");
      $nm_saida->saida("    window.open('" . $this->Ini->path_link . "grid_planilla_asistencia_grado/grid_planilla_asistencia_grado_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=ZZ','','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_planilla_asistencia_grado/grid_planilla_asistencia_grado_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_planilla_asistencia_grado_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_planilla_asistencia_grado/grid_planilla_asistencia_grado_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_planilla_asistencia_grado']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nombre_grupo = $rs_res->fields[1] ;  
            $this->jornada = $rs_res->fields[2] ;  
            $this->id_director_grupo = $rs_res->fields[3] ;  
            $this->id_grupo = $rs_res->fields[4] ;  
            $this->id_sede = $rs_res->fields[5] ;  
