<?php
//
class form_t_evaluacion_p4_apl
{
   ...
   var $form_vert_form_t_evaluacion_p4 = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['dc1_p4_']))
          {
              $this->dc1_p4_ = $this->NM_ajax_info['param']['dc1_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dc2_p4_']))
          {
              $this->dc2_p4_ = $this->NM_ajax_info['param']['dc2_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dc3_p4_']))
          {
              $this->dc3_p4_ = $this->NM_ajax_info['param']['dc3_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dc4_p4_']))
          {
              $this->dc4_p4_ = $this->NM_ajax_info['param']['dc4_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dc5_p4_']))
          {
              $this->dc5_p4_ = $this->NM_ajax_info['param']['dc5_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dp1_p4_']))
          {
              $this->dp1_p4_ = $this->NM_ajax_info['param']['dp1_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dp2_p4_']))
          {
              $this->dp2_p4_ = $this->NM_ajax_info['param']['dp2_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dp3_p4_']))
          {
              $this->dp3_p4_ = $this->NM_ajax_info['param']['dp3_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dp4_p4_']))
          {
              $this->dp4_p4_ = $this->NM_ajax_info['param']['dp4_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['dp5_p4_']))
          {
              $this->dp5_p4_ = $this->NM_ajax_info['param']['dp5_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['ds1_p4_']))
          {
              $this->ds1_p4_ = $this->NM_ajax_info['param']['ds1_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['ds2_p4_']))
          {
              $this->ds2_p4_ = $this->NM_ajax_info['param']['ds2_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['ds3_p4_']))
          {
              $this->ds3_p4_ = $this->NM_ajax_info['param']['ds3_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['ds4_p4_']))
          {
              $this->ds4_p4_ = $this->NM_ajax_info['param']['ds4_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['ds5_p4_']))
          {
              $this->ds5_p4_ = $this->NM_ajax_info['param']['ds5_p4_'];
          }
          if (isset($this->NM_ajax_info['param']['estatus_']))
          {
              $this->estatus_ = $this->NM_ajax_info['param']['estatus_'];
          }
          if (isset($this->NM_ajax_info['param']['eval_4_per_']))
          {
              $this->eval_4_per_ = $this->NM_ajax_info['param']['eval_4_per_'];
          }
          if (isset($this->NM_ajax_info['param']['eval_final_']))
          {
              $this->eval_final_ = $this->NM_ajax_info['param']['eval_final_'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['pcent_dc4_']))
          {
              $this->pcent_dc4_ = $this->NM_ajax_info['param']['pcent_dc4_'];
          }
          if (isset($this->NM_ajax_info['param']['pcent_dp4_']))
          {
              $this->pcent_dp4_ = $this->NM_ajax_info['param']['pcent_dp4_'];
          }
          if (isset($this->NM_ajax_info['param']['pcent_ds4_']))
          {
              $this->pcent_ds4_ = $this->NM_ajax_info['param']['pcent_ds4_'];
          }
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_t_evaluacion_p4($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idgrupo)) 
          {
              $_SESSION['par_idgrupo'] = $this->par_idgrupo;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_t_evaluacion_p4_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['initialize'])
          {
              $_SESSION['scriptcase']['form_t_evaluacion_p4']['contr_erro'] = 'on';
     ...
     $nm_select = $update_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         if ($rf === false)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                form_t_evaluacion_p4_pack_ajax_response();
             }
             exit;
         }
         $rf->Close();
      ;
$_SESSION['scriptcase']['form_t_evaluacion_p4']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p4']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_t_evaluacion_p4']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_t_evaluacion_p4'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p4']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p4']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_t_evaluacion_p4') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p4']['label'] = "ASIGNATURA: " . $_SESSION['nombre_asignatura'] . "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_view'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['prt_view'] = false;
      if ($this->nmgp_opcao == "pdf" || $this->nmgp_opcao == "print")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_view'] = true;
          if ($this->nmgp_opcao == "print")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['prt_view'] = true;
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opc_ant'] == "novo")
          {
              $this->nmgp_opcao = "novo";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao'] = "novo";
          }
          else
          {
              $this->nmgp_opcao = "igual";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao'] = "igual";
          }
      } 
      $this->Db = $this->Ini->Db; 
      ...
      $_SESSION['scriptcase']['error_icon']['form_t_evaluacion_p4']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_t_evaluacion_p4'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_orig'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura= " . $_SESSION['par_id_asignatura'] . " AND entorno = " . $_SESSION['entorno'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_pesq'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura= " . $_SESSION['par_id_asignatura'] . " AND entorno = " . $_SESSION['entorno'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p4']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['exit'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_t_evaluacion_p4", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_t_evaluacion_p4_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_t_evaluacion_p4_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_t_evaluacion_p4/form_t_evaluacion_p4_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_t_evaluacion_p4_erro.class.php"); 
      }
      $this->Erro      = new form_t_evaluacion_p4_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao']))
         { 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['final'];
      }
      else
      {
      }
...
//
   ...
   function controle()
   {
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->eval_4_per_)) { $this->nm_limpa_alfa($this->eval_4_per_); }
         if (isset($this->dc1_p4_)) { $this->nm_limpa_alfa($this->dc1_p4_); }
         if (isset($this->dc2_p4_)) { $this->nm_limpa_alfa($this->dc2_p4_); }
         if (isset($this->dc3_p4_)) { $this->nm_limpa_alfa($this->dc3_p4_); }
         if (isset($this->dc4_p4_)) { $this->nm_limpa_alfa($this->dc4_p4_); }
         if (isset($this->dc5_p4_)) { $this->nm_limpa_alfa($this->dc5_p4_); }
         if (isset($this->pcent_dc4_)) { $this->nm_limpa_alfa($this->pcent_dc4_); }
         if (isset($this->ds1_p4_)) { $this->nm_limpa_alfa($this->ds1_p4_); }
         if (isset($this->ds2_p4_)) { $this->nm_limpa_alfa($this->ds2_p4_); }
         if (isset($this->ds3_p4_)) { $this->nm_limpa_alfa($this->ds3_p4_); }
         if (isset($this->ds4_p4_)) { $this->nm_limpa_alfa($this->ds4_p4_); }
         if (isset($this->ds5_p4_)) { $this->nm_limpa_alfa($this->ds5_p4_); }
         if (isset($this->pcent_ds4_)) { $this->nm_limpa_alfa($this->pcent_ds4_); }
         if (isset($this->dp1_p4_)) { $this->nm_limpa_alfa($this->dp1_p4_); }
         if (isset($this->dp2_p4_)) { $this->nm_limpa_alfa($this->dp2_p4_); }
         if (isset($this->dp3_p4_)) { $this->nm_limpa_alfa($this->dp3_p4_); }
         if (isset($this->dp4_p4_)) { $this->nm_limpa_alfa($this->dp4_p4_); }
         if (isset($this->dp5_p4_)) { $this->nm_limpa_alfa($this->dp5_p4_); }
         if (isset($this->pcent_dp4_)) { $this->nm_limpa_alfa($this->pcent_dp4_); }
         if (isset($this->eval_final_)) { $this->nm_limpa_alfa($this->eval_final_); }
         if (isset($this->Sc_num_lin_alt) && $this->Sc_num_lin_alt > 0) 
         {
             $sc_seq_vert = $this->Sc_num_lin_alt;
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'][$sc_seq_vert];
             ...
             $this->eval_1_per_ = $this->nmgp_dados_form['eval_1_per_']; 
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4']) || !is_array($this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_eval_4_per_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'eval_4_per_');
          }
          if ('validate_dc1_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dc1_p4_');
          }
          if ('validate_dc2_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dc2_p4_');
          }
          if ('validate_dc3_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dc3_p4_');
          }
          if ('validate_dc4_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dc4_p4_');
          }
          if ('validate_dc5_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dc5_p4_');
          }
          if ('validate_pcent_dc4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'pcent_dc4_');
          }
          if ('validate_dp1_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dp1_p4_');
          }
          if ('validate_dp2_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dp2_p4_');
          }
          if ('validate_dp3_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dp3_p4_');
          }
          if ('validate_dp4_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dp4_p4_');
          }
          if ('validate_dp5_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dp5_p4_');
          }
          if ('validate_pcent_dp4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'pcent_dp4_');
          }
          if ('validate_ds1_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ds1_p4_');
          }
          if ('validate_ds2_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ds2_p4_');
          }
          if ('validate_ds3_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ds3_p4_');
          }
          if ('validate_ds4_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ds4_p4_');
          }
          if ('validate_ds5_p4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ds5_p4_');
          }
          if ('validate_pcent_ds4_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'pcent_ds4_');
          }
          ...
          if ('validate_eval_final_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'eval_final_');
          }
          form_t_evaluacion_p4_pack_ajax_response();
          exit;
      }
      ...
      { 
         ...
         $this->eval_4_per_ = $GLOBALS["eval_4_per_" . $sc_seq_vert]; 
         $this->dc1_p4_ = $GLOBALS["dc1_p4_" . $sc_seq_vert]; 
         $this->dc2_p4_ = $GLOBALS["dc2_p4_" . $sc_seq_vert]; 
         $this->dc3_p4_ = $GLOBALS["dc3_p4_" . $sc_seq_vert]; 
         $this->dc4_p4_ = $GLOBALS["dc4_p4_" . $sc_seq_vert]; 
         $this->dc5_p4_ = $GLOBALS["dc5_p4_" . $sc_seq_vert]; 
         $this->pcent_dc4_ = $GLOBALS["pcent_dc4_" . $sc_seq_vert]; 
         $this->dp1_p4_ = $GLOBALS["dp1_p4_" . $sc_seq_vert]; 
         $this->dp2_p4_ = $GLOBALS["dp2_p4_" . $sc_seq_vert]; 
         $this->dp3_p4_ = $GLOBALS["dp3_p4_" . $sc_seq_vert]; 
         $this->dp4_p4_ = $GLOBALS["dp4_p4_" . $sc_seq_vert]; 
         $this->dp5_p4_ = $GLOBALS["dp5_p4_" . $sc_seq_vert]; 
         $this->pcent_dp4_ = $GLOBALS["pcent_dp4_" . $sc_seq_vert]; 
         $this->ds1_p4_ = $GLOBALS["ds1_p4_" . $sc_seq_vert]; 
         $this->ds2_p4_ = $GLOBALS["ds2_p4_" . $sc_seq_vert]; 
         $this->ds3_p4_ = $GLOBALS["ds3_p4_" . $sc_seq_vert]; 
         $this->ds4_p4_ = $GLOBALS["ds4_p4_" . $sc_seq_vert]; 
         $this->ds5_p4_ = $GLOBALS["ds5_p4_" . $sc_seq_vert]; 
         $this->pcent_ds4_ = $GLOBALS["pcent_ds4_" . $sc_seq_vert]; 
         $this->val_acumulada_ = $GLOBALS["val_acumulada_" . $sc_seq_vert]; 
         $this->val_requerida_ = $GLOBALS["val_requerida_" . $sc_seq_vert]; 
         $this->eval_final_ = $GLOBALS["eval_final_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'][$sc_seq_vert];
             $this->primer_apellido_ = $this->nmgp_dados_form['primer_apellido_']; 
         ...
         if (isset($this->pcent_dp4_)) { $this->nm_limpa_alfa($this->pcent_dp4_); }
         if (isset($this->eval_final_)) { $this->nm_limpa_alfa($this->eval_final_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_estudiante_'] =  $this->id_estudiante_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['estatus_'] =  $this->estatus_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['novedad_'] =  $this->novedad_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['eval_4_per_'] =  $this->eval_4_per_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc1_p4_'] =  $this->dc1_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc2_p4_'] =  $this->dc2_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc3_p4_'] =  $this->dc3_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc4_p4_'] =  $this->dc4_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc5_p4_'] =  $this->dc5_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dc4_'] =  $this->pcent_dc4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp1_p4_'] =  $this->dp1_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp2_p4_'] =  $this->dp2_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp3_p4_'] =  $this->dp3_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp4_p4_'] =  $this->dp4_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp5_p4_'] =  $this->dp5_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dp4_'] =  $this->pcent_dp4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds1_p4_'] =  $this->ds1_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds2_p4_'] =  $this->ds2_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds3_p4_'] =  $this->ds3_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds4_p4_'] =  $this->ds4_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds5_p4_'] =  $this->ds5_p4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_ds4_'] =  $this->pcent_ds4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['val_acumulada_'] =  $this->val_acumulada_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['val_requerida_'] =  $this->val_requerida_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['eval_final_'] =  $this->eval_final_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['primer_apellido_'] =  $this->primer_apellido_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['segundo_apellido_'] =  $this->segundo_apellido_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['primer_nombre_'] =  $this->primer_nombre_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['segundo_nombre_'] =  $this->segundo_nombre_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_grupo_'] =  $this->id_grupo_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_area_'] =  $this->id_area_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_asignatura_'] =  $this->id_asignatura_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_grado_'] =  $this->id_grado_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_nivel_'] =  $this->id_nivel_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ihs_'] =  $this->ihs_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pfa_'] =  $this->pfa_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['tipo_asig_'] =  $this->tipo_asig_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['eval_1_per_'] =  $this->eval_1_per_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc1_'] =  $this->dc1_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc2_'] =  $this->dc2_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc3_'] =  $this->dc3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc4_'] =  $this->dc4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc5_'] =  $this->dc5_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dc_'] =  $this->pcent_dc_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds1_'] =  $this->ds1_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds2_'] =  $this->ds2_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds3_'] =  $this->ds3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds4_'] =  $this->ds4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds5_'] =  $this->ds5_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_ds_'] =  $this->pcent_ds_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp1_'] =  $this->dp1_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp2_'] =  $this->dp2_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp3_'] =  $this->dp3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp4_'] =  $this->dp4_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp5_'] =  $this->dp5_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dp_'] =  $this->pcent_dp_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['eval_2_per_'] =  $this->eval_2_per_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc1_2p_'] =  $this->dc1_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc2_2p_'] =  $this->dc2_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc3_2p_'] =  $this->dc3_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc4_2p_'] =  $this->dc4_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc5_2p_'] =  $this->dc5_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dc2_'] =  $this->pcent_dc2_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds1_2p_'] =  $this->ds1_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds2_2p_'] =  $this->ds2_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds3_2p_'] =  $this->ds3_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds4_2p_'] =  $this->ds4_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds5_2p_'] =  $this->ds5_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_ds2_'] =  $this->pcent_ds2_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp1_2p_'] =  $this->dp1_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp2_2p_'] =  $this->dp2_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp3_2p_'] =  $this->dp3_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp4_2p_'] =  $this->dp4_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp5_2p_'] =  $this->dp5_2p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dp2_'] =  $this->pcent_dp2_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['eval_3_per_'] =  $this->eval_3_per_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc1_3p_'] =  $this->dc1_3p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc2_3p_'] =  $this->dc2_3p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc3_3p_'] =  $this->dc3_3p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc4_3p_'] =  $this->dc4_3p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dc5_3p_'] =  $this->dc5_3p_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dc3_'] =  $this->pcent_dc3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds1_p3_'] =  $this->ds1_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds2_p3_'] =  $this->ds2_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds3_p3_'] =  $this->ds3_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds4_p3_'] =  $this->ds4_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['ds5_p3_'] =  $this->ds5_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_ds3_'] =  $this->pcent_ds3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp1_p3_'] =  $this->dp1_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp2_p3_'] =  $this->dp2_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp3_p3_'] =  $this->dp3_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['dp4_p3_'] =  $this->dp4_p3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['sc_field_0_'] =  $this->sc_field_0_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['pcent_dp3_'] =  $this->pcent_dp3_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['entorno_'] =  $this->entorno_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['estudiantes_'] =  $this->estudiantes_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_novedad_'] =  $this->id_novedad_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['nom_grupo_'] =  $this->nom_grupo_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_t_evaluacion_p4);
      ...
      { 
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['prt_view'] && in_array(trim($this->Ini->str_lang), $this->Ini->nm_font_ttf) && strtolower($_SESSION['scriptcase']['charset']) != "utf-8")
          { 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//--------------------------------------------------------------------------------------
   function NM_pdf_output()
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_view'])
      { 
          $arq_pdf_in = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_form_t_evaluacion_p4_html_" . session_id() . ".html";
          $url_pdf_in = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_form_t_evaluacion_p4_html_" . session_id() . ".html";
          $str_htm    =  ob_get_contents();
          ob_end_clean();
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['prt_view'])
          { 
              echo $str_htm ;
              exit;
          } 
          ...
          fclose($arq_htm);
          $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "form_t_evaluacion_p4";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_name']))
          {
              $nm_arquivo_pdf_base = str_replace(".pdf", "", $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_name']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_name']);
          }
          ...
          $NM_tit_doc = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['pdf_name'] : "form_t_evaluacion_p4";
...
<HEAD>
 <TITLE><?php echo strip_tags("<FONT SIZE=4>ASIGNATURA: [nombre_asignatura]</font>") ?></TITLE>
...
<form name="Fdown" method="get" action="form_t_evaluacion_p4_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_t_evaluacion_p4"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p4'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $filtro || 'eval_4_per_' == $filtro)
        $this->ValidateField_eval_4_per_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dc1_p4_' == $filtro)
        $this->ValidateField_dc1_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dc2_p4_' == $filtro)
        $this->ValidateField_dc2_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dc3_p4_' == $filtro)
        $this->ValidateField_dc3_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dc4_p4_' == $filtro)
        $this->ValidateField_dc4_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dc5_p4_' == $filtro)
        $this->ValidateField_dc5_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'pcent_dc4_' == $filtro)
        $this->ValidateField_pcent_dc4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dp1_p4_' == $filtro)
        $this->ValidateField_dp1_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dp2_p4_' == $filtro)
        $this->ValidateField_dp2_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dp3_p4_' == $filtro)
        $this->ValidateField_dp3_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dp4_p4_' == $filtro)
        $this->ValidateField_dp4_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dp5_p4_' == $filtro)
        $this->ValidateField_dp5_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'pcent_dp4_' == $filtro)
        $this->ValidateField_pcent_dp4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'ds1_p4_' == $filtro)
        $this->ValidateField_ds1_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'ds2_p4_' == $filtro)
        $this->ValidateField_ds2_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'ds3_p4_' == $filtro)
        $this->ValidateField_ds3_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'ds4_p4_' == $filtro)
        $this->ValidateField_ds4_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'ds5_p4_' == $filtro)
        $this->ValidateField_ds5_p4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'pcent_ds4_' == $filtro)
        $this->ValidateField_pcent_ds4_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'eval_final_' == $filtro)
        $this->ValidateField_eval_final_($Campos_Crit, $Campos_Falta, $Campos_Erros);
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_estudiante_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['php_cmp_required']['id_estudiante_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['php_cmp_required']['id_estudiante_'] == "on"))
      {
          ...
          if (!empty($this->id_estudiante_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['Lookup_id_estudiante_']) && !in_array($this->id_estudiante_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['Lookup_id_estudiante_']))
          {
    ...
    function ValidateField_eval_4_per_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->eval_4_per_ == "")  
      { 
      ...
      if (!empty($this->field_config['eval_4_per_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->eval_4_per_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->eval_4_per_, 1)))
              {
                  $this->eval_4_per_ = '';
              }
              else
              {
                  $this->eval_4_per_ = '0' . $this->eval_4_per_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->eval_4_per_) > $iTestSize)  
              { 
                  $Campos_Crit .= "4 Per: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['eval_4_per_']))
                  {
                      $Campos_Erros['eval_4_per_'] = array();
                  }
                  $Campos_Erros['eval_4_per_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['eval_4_per_']) || !is_array($this->NM_ajax_info['errList']['eval_4_per_']))
                  {
                      $this->NM_ajax_info['errList']['eval_4_per_'] = array();
                  }
                  $this->NM_ajax_info['errList']['eval_4_per_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->eval_4_per_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "4 Per; " ; 
                  if (!isset($Campos_Erros['eval_4_per_']))
                  {
                  ...
                  $Campos_Erros['eval_4_per_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['eval_4_per_']) || !is_array($this->NM_ajax_info['errList']['eval_4_per_']))
                  {
                      $this->NM_ajax_info['errList']['eval_4_per_'] = array();
                  }
                  $this->NM_ajax_info['errList']['eval_4_per_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_eval_4_per_

    function ValidateField_dc1_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dc1_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dc1_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dc1_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dc1_p4_, 1)))
              {
                  $this->dc1_p4_ = '';
              }
              else
              {
                  $this->dc1_p4_ = '0' . $this->dc1_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dc1_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dc 1 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dc1_p4_']))
                  {
                      $Campos_Erros['dc1_p4_'] = array();
                  }
                  $Campos_Erros['dc1_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dc1_p4_']) || !is_array($this->NM_ajax_info['errList']['dc1_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc1_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc1_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dc1_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 1 P 4; " ; 
                  if (!isset($Campos_Erros['dc1_p4_']))
                  {
                      $Campos_Erros['dc1_p4_'] = array();
                  }
                  $Campos_Erros['dc1_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dc1_p4_']) || !is_array($this->NM_ajax_info['errList']['dc1_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc1_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc1_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dc1_p4_

    function ValidateField_dc2_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dc2_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dc2_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dc2_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dc2_p4_, 1)))
              {
                  $this->dc2_p4_ = '';
              }
              else
              {
                  $this->dc2_p4_ = '0' . $this->dc2_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dc2_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dc 2 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dc2_p4_']))
                  {
                      $Campos_Erros['dc2_p4_'] = array();
                  }
                  $Campos_Erros['dc2_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dc2_p4_']) || !is_array($this->NM_ajax_info['errList']['dc2_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc2_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc2_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dc2_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 2 P 4; " ; 
                  if (!isset($Campos_Erros['dc2_p4_']))
                  {
                      $Campos_Erros['dc2_p4_'] = array();
                  }
                  $Campos_Erros['dc2_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dc2_p4_']) || !is_array($this->NM_ajax_info['errList']['dc2_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc2_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc2_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dc2_p4_

    function ValidateField_dc3_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dc3_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dc3_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dc3_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dc3_p4_, 1)))
              {
                  $this->dc3_p4_ = '';
              }
              else
              {
                  $this->dc3_p4_ = '0' . $this->dc3_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dc3_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dc 3 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dc3_p4_']))
                  {
                      $Campos_Erros['dc3_p4_'] = array();
                  }
                  $Campos_Erros['dc3_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dc3_p4_']) || !is_array($this->NM_ajax_info['errList']['dc3_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc3_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc3_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dc3_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 3 P 4; " ; 
                  if (!isset($Campos_Erros['dc3_p4_']))
                  {
                      $Campos_Erros['dc3_p4_'] = array();
                  }
                  $Campos_Erros['dc3_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dc3_p4_']) || !is_array($this->NM_ajax_info['errList']['dc3_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc3_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc3_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dc3_p4_

    function ValidateField_dc4_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dc4_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dc4_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dc4_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dc4_p4_, 1)))
              {
                  $this->dc4_p4_ = '';
              }
              else
              {
                  $this->dc4_p4_ = '0' . $this->dc4_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dc4_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dc 4 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dc4_p4_']))
                  {
                      $Campos_Erros['dc4_p4_'] = array();
                  }
                  $Campos_Erros['dc4_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dc4_p4_']) || !is_array($this->NM_ajax_info['errList']['dc4_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc4_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc4_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dc4_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 4 P 4; " ; 
                  if (!isset($Campos_Erros['dc4_p4_']))
                  {
                      $Campos_Erros['dc4_p4_'] = array();
                  }
                  $Campos_Erros['dc4_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dc4_p4_']) || !is_array($this->NM_ajax_info['errList']['dc4_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc4_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc4_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dc4_p4_

    function ValidateField_dc5_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dc5_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dc5_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dc5_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dc5_p4_, 1)))
              {
                  $this->dc5_p4_ = '';
              }
              else
              {
                  $this->dc5_p4_ = '0' . $this->dc5_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dc5_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dc 5 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dc5_p4_']))
                  {
                      $Campos_Erros['dc5_p4_'] = array();
                  }
                  $Campos_Erros['dc5_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dc5_p4_']) || !is_array($this->NM_ajax_info['errList']['dc5_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc5_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc5_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dc5_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 5 P 4; " ; 
                  if (!isset($Campos_Erros['dc5_p4_']))
                  {
                      $Campos_Erros['dc5_p4_'] = array();
                  }
                  $Campos_Erros['dc5_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dc5_p4_']) || !is_array($this->NM_ajax_info['errList']['dc5_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dc5_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc5_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dc5_p4_

    function ValidateField_pcent_dc4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->pcent_dc4_ == "")  
      { 
      ...
      if (!empty($this->field_config['pcent_dc4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->pcent_dc4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->pcent_dc4_, 1)))
              {
                  $this->pcent_dc4_ = '';
              }
              else
              {
                  $this->pcent_dc4_ = '0' . $this->pcent_dc4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->pcent_dc4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Pcent Dc 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['pcent_dc4_']))
                  {
                      $Campos_Erros['pcent_dc4_'] = array();
                  }
                  $Campos_Erros['pcent_dc4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['pcent_dc4_']) || !is_array($this->NM_ajax_info['errList']['pcent_dc4_']))
                  {
                      $this->NM_ajax_info['errList']['pcent_dc4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['pcent_dc4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->pcent_dc4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Pcent Dc 4; " ; 
                  if (!isset($Campos_Erros['pcent_dc4_']))
                  {
                      $Campos_Erros['pcent_dc4_'] = array();
                  }
                  $Campos_Erros['pcent_dc4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['pcent_dc4_']) || !is_array($this->NM_ajax_info['errList']['pcent_dc4_']))
                  {
                      $this->NM_ajax_info['errList']['pcent_dc4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['pcent_dc4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_pcent_dc4_

    function ValidateField_dp1_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dp1_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dp1_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dp1_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dp1_p4_, 1)))
              {
                  $this->dp1_p4_ = '';
              }
              else
              {
                  $this->dp1_p4_ = '0' . $this->dp1_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dp1_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dp 1 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dp1_p4_']))
                  {
                      $Campos_Erros['dp1_p4_'] = array();
                  }
                  $Campos_Erros['dp1_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dp1_p4_']) || !is_array($this->NM_ajax_info['errList']['dp1_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp1_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp1_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dp1_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dp 1 P 4; " ; 
                  if (!isset($Campos_Erros['dp1_p4_']))
                  {
                      $Campos_Erros['dp1_p4_'] = array();
                  }
                  $Campos_Erros['dp1_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dp1_p4_']) || !is_array($this->NM_ajax_info['errList']['dp1_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp1_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp1_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dp1_p4_

    function ValidateField_dp2_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dp2_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dp2_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dp2_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dp2_p4_, 1)))
              {
                  $this->dp2_p4_ = '';
              }
              else
              {
                  $this->dp2_p4_ = '0' . $this->dp2_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dp2_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dp 2 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dp2_p4_']))
                  {
                      $Campos_Erros['dp2_p4_'] = array();
                  }
                  $Campos_Erros['dp2_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dp2_p4_']) || !is_array($this->NM_ajax_info['errList']['dp2_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp2_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp2_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dp2_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dp 2 P 4; " ; 
                  if (!isset($Campos_Erros['dp2_p4_']))
                  {
                      $Campos_Erros['dp2_p4_'] = array();
                  }
                  $Campos_Erros['dp2_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dp2_p4_']) || !is_array($this->NM_ajax_info['errList']['dp2_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp2_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp2_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dp2_p4_

    function ValidateField_dp3_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dp3_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dp3_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dp3_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dp3_p4_, 1)))
              {
                  $this->dp3_p4_ = '';
              }
              else
              {
                  $this->dp3_p4_ = '0' . $this->dp3_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dp3_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dp 3 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dp3_p4_']))
                  {
                      $Campos_Erros['dp3_p4_'] = array();
                  }
                  $Campos_Erros['dp3_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dp3_p4_']) || !is_array($this->NM_ajax_info['errList']['dp3_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp3_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp3_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dp3_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dp 3 P 4; " ; 
                  if (!isset($Campos_Erros['dp3_p4_']))
                  {
                      $Campos_Erros['dp3_p4_'] = array();
                  }
                  $Campos_Erros['dp3_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dp3_p4_']) || !is_array($this->NM_ajax_info['errList']['dp3_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp3_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp3_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dp3_p4_

    function ValidateField_dp4_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dp4_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dp4_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dp4_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dp4_p4_, 1)))
              {
                  $this->dp4_p4_ = '';
              }
              else
              {
                  $this->dp4_p4_ = '0' . $this->dp4_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dp4_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dp 4 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dp4_p4_']))
                  {
                      $Campos_Erros['dp4_p4_'] = array();
                  }
                  $Campos_Erros['dp4_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dp4_p4_']) || !is_array($this->NM_ajax_info['errList']['dp4_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp4_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp4_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dp4_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dp 4 P 4; " ; 
                  if (!isset($Campos_Erros['dp4_p4_']))
                  {
                      $Campos_Erros['dp4_p4_'] = array();
                  }
                  $Campos_Erros['dp4_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dp4_p4_']) || !is_array($this->NM_ajax_info['errList']['dp4_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp4_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp4_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dp4_p4_

    function ValidateField_dp5_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dp5_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['dp5_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dp5_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dp5_p4_, 1)))
              {
                  $this->dp5_p4_ = '';
              }
              else
              {
                  $this->dp5_p4_ = '0' . $this->dp5_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dp5_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dp 5 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dp5_p4_']))
                  {
                      $Campos_Erros['dp5_p4_'] = array();
                  }
                  $Campos_Erros['dp5_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dp5_p4_']) || !is_array($this->NM_ajax_info['errList']['dp5_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp5_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp5_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dp5_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dp 5 P 4; " ; 
                  if (!isset($Campos_Erros['dp5_p4_']))
                  {
                      $Campos_Erros['dp5_p4_'] = array();
                  }
                  $Campos_Erros['dp5_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dp5_p4_']) || !is_array($this->NM_ajax_info['errList']['dp5_p4_']))
                  {
                      $this->NM_ajax_info['errList']['dp5_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['dp5_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dp5_p4_

    function ValidateField_pcent_dp4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->pcent_dp4_ == "")  
      { 
      ...
      if (!empty($this->field_config['pcent_dp4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->pcent_dp4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->pcent_dp4_, 1)))
              {
                  $this->pcent_dp4_ = '';
              }
              else
              {
                  $this->pcent_dp4_ = '0' . $this->pcent_dp4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->pcent_dp4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Pcent Dp 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['pcent_dp4_']))
                  {
                      $Campos_Erros['pcent_dp4_'] = array();
                  }
                  $Campos_Erros['pcent_dp4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['pcent_dp4_']) || !is_array($this->NM_ajax_info['errList']['pcent_dp4_']))
                  {
                      $this->NM_ajax_info['errList']['pcent_dp4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['pcent_dp4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->pcent_dp4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Pcent Dp 4; " ; 
                  if (!isset($Campos_Erros['pcent_dp4_']))
                  {
                      $Campos_Erros['pcent_dp4_'] = array();
                  }
                  $Campos_Erros['pcent_dp4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['pcent_dp4_']) || !is_array($this->NM_ajax_info['errList']['pcent_dp4_']))
                  {
                      $this->NM_ajax_info['errList']['pcent_dp4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['pcent_dp4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_pcent_dp4_

    function ValidateField_ds1_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ds1_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['ds1_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->ds1_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->ds1_p4_, 1)))
              {
                  $this->ds1_p4_ = '';
              }
              else
              {
                  $this->ds1_p4_ = '0' . $this->ds1_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->ds1_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Ds 1 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['ds1_p4_']))
                  {
                      $Campos_Erros['ds1_p4_'] = array();
                  }
                  $Campos_Erros['ds1_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['ds1_p4_']) || !is_array($this->NM_ajax_info['errList']['ds1_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds1_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds1_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->ds1_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ds 1 P 4; " ; 
                  if (!isset($Campos_Erros['ds1_p4_']))
                  {
                      $Campos_Erros['ds1_p4_'] = array();
                  }
                  $Campos_Erros['ds1_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['ds1_p4_']) || !is_array($this->NM_ajax_info['errList']['ds1_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds1_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds1_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_ds1_p4_

    function ValidateField_ds2_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ds2_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['ds2_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->ds2_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->ds2_p4_, 1)))
              {
                  $this->ds2_p4_ = '';
              }
              else
              {
                  $this->ds2_p4_ = '0' . $this->ds2_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->ds2_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Ds 2 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['ds2_p4_']))
                  {
                      $Campos_Erros['ds2_p4_'] = array();
                  }
                  $Campos_Erros['ds2_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['ds2_p4_']) || !is_array($this->NM_ajax_info['errList']['ds2_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds2_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds2_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->ds2_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ds 2 P 4; " ; 
                  if (!isset($Campos_Erros['ds2_p4_']))
                  {
                      $Campos_Erros['ds2_p4_'] = array();
                  }
                  $Campos_Erros['ds2_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['ds2_p4_']) || !is_array($this->NM_ajax_info['errList']['ds2_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds2_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds2_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_ds2_p4_

    function ValidateField_ds3_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ds3_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['ds3_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->ds3_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->ds3_p4_, 1)))
              {
                  $this->ds3_p4_ = '';
              }
              else
              {
                  $this->ds3_p4_ = '0' . $this->ds3_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->ds3_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Ds 3 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['ds3_p4_']))
                  {
                      $Campos_Erros['ds3_p4_'] = array();
                  }
                  $Campos_Erros['ds3_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['ds3_p4_']) || !is_array($this->NM_ajax_info['errList']['ds3_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds3_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds3_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->ds3_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ds 3 P 4; " ; 
                  if (!isset($Campos_Erros['ds3_p4_']))
                  {
                      $Campos_Erros['ds3_p4_'] = array();
                  }
                  $Campos_Erros['ds3_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['ds3_p4_']) || !is_array($this->NM_ajax_info['errList']['ds3_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds3_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds3_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_ds3_p4_

    function ValidateField_ds4_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ds4_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['ds4_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->ds4_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->ds4_p4_, 1)))
              {
                  $this->ds4_p4_ = '';
              }
              else
              {
                  $this->ds4_p4_ = '0' . $this->ds4_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->ds4_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Ds 4 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['ds4_p4_']))
                  {
                      $Campos_Erros['ds4_p4_'] = array();
                  }
                  $Campos_Erros['ds4_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['ds4_p4_']) || !is_array($this->NM_ajax_info['errList']['ds4_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds4_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds4_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->ds4_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ds 4 P 4; " ; 
                  if (!isset($Campos_Erros['ds4_p4_']))
                  {
                      $Campos_Erros['ds4_p4_'] = array();
                  }
                  $Campos_Erros['ds4_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['ds4_p4_']) || !is_array($this->NM_ajax_info['errList']['ds4_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds4_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds4_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_ds4_p4_

    function ValidateField_ds5_p4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ds5_p4_ == "")  
      { 
      ...
      if (!empty($this->field_config['ds5_p4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->ds5_p4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->ds5_p4_, 1)))
              {
                  $this->ds5_p4_ = '';
              }
              else
              {
                  $this->ds5_p4_ = '0' . $this->ds5_p4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->ds5_p4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Ds 5 P 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['ds5_p4_']))
                  {
                      $Campos_Erros['ds5_p4_'] = array();
                  }
                  $Campos_Erros['ds5_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['ds5_p4_']) || !is_array($this->NM_ajax_info['errList']['ds5_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds5_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds5_p4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->ds5_p4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ds 5 P 4; " ; 
                  if (!isset($Campos_Erros['ds5_p4_']))
                  {
                      $Campos_Erros['ds5_p4_'] = array();
                  }
                  $Campos_Erros['ds5_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['ds5_p4_']) || !is_array($this->NM_ajax_info['errList']['ds5_p4_']))
                  {
                      $this->NM_ajax_info['errList']['ds5_p4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['ds5_p4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_ds5_p4_

    function ValidateField_pcent_ds4_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->pcent_ds4_ == "")  
      { 
      ...
      if (!empty($this->field_config['pcent_ds4_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->pcent_ds4_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->pcent_ds4_, 1)))
              {
                  $this->pcent_ds4_ = '';
              }
              else
              {
                  $this->pcent_ds4_ = '0' . $this->pcent_ds4_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->pcent_ds4_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Pcent Ds 4: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['pcent_ds4_']))
                  {
                      $Campos_Erros['pcent_ds4_'] = array();
                  }
                  $Campos_Erros['pcent_ds4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['pcent_ds4_']) || !is_array($this->NM_ajax_info['errList']['pcent_ds4_']))
                  {
                      $this->NM_ajax_info['errList']['pcent_ds4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['pcent_ds4_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->pcent_ds4_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Pcent Ds 4; " ; 
                  if (!isset($Campos_Erros['pcent_ds4_']))
                  {
                      $Campos_Erros['pcent_ds4_'] = array();
                  }
                  $Campos_Erros['pcent_ds4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['pcent_ds4_']) || !is_array($this->NM_ajax_info['errList']['pcent_ds4_']))
                  {
                      $this->NM_ajax_info['errList']['pcent_ds4_'] = array();
                  }
                  $this->NM_ajax_info['errList']['pcent_ds4_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_pcent_ds4_
    ...
    function ValidateField_eval_final_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->eval_final_ == "")  
      { 
      ...
      if (!empty($this->field_config['eval_final_']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->eval_final_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->eval_final_, 1)))
              {
                  $this->eval_final_ = '';
              }
              else
              {
                  $this->eval_final_ = '0' . $this->eval_final_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->eval_final_) > $iTestSize)  
              { 
                  $Campos_Crit .= "Eval Final: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['eval_final_']))
                  {
                      $Campos_Erros['eval_final_'] = array();
                  }
                  $Campos_Erros['eval_final_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['eval_final_']) || !is_array($this->NM_ajax_info['errList']['eval_final_']))
                  {
                      $this->NM_ajax_info['errList']['eval_final_'] = array();
                  }
                  $this->NM_ajax_info['errList']['eval_final_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->eval_final_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Eval Final; " ; 
                  if (!isset($Campos_Erros['eval_final_']))
                  {
                      $Campos_Erros['eval_final_'] = array();
                  }
                  $Campos_Erros['eval_final_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['eval_final_']) || !is_array($this->NM_ajax_info['errList']['eval_final_']))
                  {
                      $this->NM_ajax_info['errList']['eval_final_'] = array();
                  }
                  $this->NM_ajax_info['errList']['eval_final_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_eval_final_
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   ...
   {
      global $nm_form_submit;
      if (!empty($this->eval_4_per_) || (!empty($format_fields) && isset($format_fields['eval_4_per_'])))
      {
          nmgp_Form_Num_Val($this->eval_4_per_, $this->field_config['eval_4_per_']['symbol_grp'], $this->field_config['eval_4_per_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['eval_4_per_']['symbol_fmt']) ; 
      }
      if (!empty($this->dc1_p4_) || (!empty($format_fields) && isset($format_fields['dc1_p4_'])))
      {
          nmgp_Form_Num_Val($this->dc1_p4_, $this->field_config['dc1_p4_']['symbol_grp'], $this->field_config['dc1_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dc1_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dc2_p4_) || (!empty($format_fields) && isset($format_fields['dc2_p4_'])))
      {
          nmgp_Form_Num_Val($this->dc2_p4_, $this->field_config['dc2_p4_']['symbol_grp'], $this->field_config['dc2_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dc2_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dc3_p4_) || (!empty($format_fields) && isset($format_fields['dc3_p4_'])))
      {
          nmgp_Form_Num_Val($this->dc3_p4_, $this->field_config['dc3_p4_']['symbol_grp'], $this->field_config['dc3_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dc3_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dc4_p4_) || (!empty($format_fields) && isset($format_fields['dc4_p4_'])))
      {
          nmgp_Form_Num_Val($this->dc4_p4_, $this->field_config['dc4_p4_']['symbol_grp'], $this->field_config['dc4_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dc4_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dc5_p4_) || (!empty($format_fields) && isset($format_fields['dc5_p4_'])))
      {
          nmgp_Form_Num_Val($this->dc5_p4_, $this->field_config['dc5_p4_']['symbol_grp'], $this->field_config['dc5_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dc5_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->pcent_dc4_) || (!empty($format_fields) && isset($format_fields['pcent_dc4_'])))
      {
          nmgp_Form_Num_Val($this->pcent_dc4_, $this->field_config['pcent_dc4_']['symbol_grp'], $this->field_config['pcent_dc4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['pcent_dc4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dp1_p4_) || (!empty($format_fields) && isset($format_fields['dp1_p4_'])))
      {
          nmgp_Form_Num_Val($this->dp1_p4_, $this->field_config['dp1_p4_']['symbol_grp'], $this->field_config['dp1_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dp1_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dp2_p4_) || (!empty($format_fields) && isset($format_fields['dp2_p4_'])))
      {
          nmgp_Form_Num_Val($this->dp2_p4_, $this->field_config['dp2_p4_']['symbol_grp'], $this->field_config['dp2_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dp2_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dp3_p4_) || (!empty($format_fields) && isset($format_fields['dp3_p4_'])))
      {
          nmgp_Form_Num_Val($this->dp3_p4_, $this->field_config['dp3_p4_']['symbol_grp'], $this->field_config['dp3_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dp3_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dp4_p4_) || (!empty($format_fields) && isset($format_fields['dp4_p4_'])))
      {
          nmgp_Form_Num_Val($this->dp4_p4_, $this->field_config['dp4_p4_']['symbol_grp'], $this->field_config['dp4_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dp4_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->dp5_p4_) || (!empty($format_fields) && isset($format_fields['dp5_p4_'])))
      {
          nmgp_Form_Num_Val($this->dp5_p4_, $this->field_config['dp5_p4_']['symbol_grp'], $this->field_config['dp5_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dp5_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->pcent_dp4_) || (!empty($format_fields) && isset($format_fields['pcent_dp4_'])))
      {
          nmgp_Form_Num_Val($this->pcent_dp4_, $this->field_config['pcent_dp4_']['symbol_grp'], $this->field_config['pcent_dp4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['pcent_dp4_']['symbol_fmt']) ; 
      }
      if (!empty($this->ds1_p4_) || (!empty($format_fields) && isset($format_fields['ds1_p4_'])))
      {
          nmgp_Form_Num_Val($this->ds1_p4_, $this->field_config['ds1_p4_']['symbol_grp'], $this->field_config['ds1_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['ds1_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->ds2_p4_) || (!empty($format_fields) && isset($format_fields['ds2_p4_'])))
      {
          nmgp_Form_Num_Val($this->ds2_p4_, $this->field_config['ds2_p4_']['symbol_grp'], $this->field_config['ds2_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['ds2_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->ds3_p4_) || (!empty($format_fields) && isset($format_fields['ds3_p4_'])))
      {
          nmgp_Form_Num_Val($this->ds3_p4_, $this->field_config['ds3_p4_']['symbol_grp'], $this->field_config['ds3_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['ds3_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->ds4_p4_) || (!empty($format_fields) && isset($format_fields['ds4_p4_'])))
      {
          nmgp_Form_Num_Val($this->ds4_p4_, $this->field_config['ds4_p4_']['symbol_grp'], $this->field_config['ds4_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['ds4_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->ds5_p4_) || (!empty($format_fields) && isset($format_fields['ds5_p4_'])))
      {
          nmgp_Form_Num_Val($this->ds5_p4_, $this->field_config['ds5_p4_']['symbol_grp'], $this->field_config['ds5_p4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['ds5_p4_']['symbol_fmt']) ; 
      }
      if (!empty($this->pcent_ds4_) || (!empty($format_fields) && isset($format_fields['pcent_ds4_'])))
      {
          nmgp_Form_Num_Val($this->pcent_ds4_, $this->field_config['pcent_ds4_']['symbol_grp'], $this->field_config['pcent_ds4_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['pcent_ds4_']['symbol_fmt']) ; 
      }
      ...
      if (!empty($this->eval_final_) || (!empty($format_fields) && isset($format_fields['eval_final_'])))
      {
          nmgp_Form_Num_Val($this->eval_final_, $this->field_config['eval_final_']['symbol_grp'], $this->field_config['eval_final_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['eval_final_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['id_estudiante_']['keyVal'] = form_t_evaluacion_p4_pack_protect_string($this->nmgp_dados_form['id_estudiante_']);
              $this->NM_ajax_info['fldList']['id_grupo_']['keyVal'] = form_t_evaluacion_p4_pack_protect_string($this->nmgp_dados_form['id_grupo_']);
              $this->NM_ajax_info['fldList']['id_asignatura_']['keyVal'] = form_t_evaluacion_p4_pack_protect_string($this->nmgp_dados_form['id_asignatura_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['id_estudiante_'] = $this->id_estudiante_;
                  }
                  if (isset($this->NM_ajax_changed['estatus_']) && $this->NM_ajax_changed['estatus_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['estatus_'] = $this->estatus_;
                  }
                  if (isset($this->NM_ajax_changed['novedad_']) && $this->NM_ajax_changed['novedad_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['novedad_'] = $this->novedad_;
                  }
                  if (isset($this->NM_ajax_changed['eval_4_per_']) && $this->NM_ajax_changed['eval_4_per_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['eval_4_per_'] = $this->eval_4_per_;
                  }
                  if (isset($this->NM_ajax_changed['dc1_p4_']) && $this->NM_ajax_changed['dc1_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dc1_p4_'] = $this->dc1_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dc2_p4_']) && $this->NM_ajax_changed['dc2_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dc2_p4_'] = $this->dc2_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dc3_p4_']) && $this->NM_ajax_changed['dc3_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dc3_p4_'] = $this->dc3_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dc4_p4_']) && $this->NM_ajax_changed['dc4_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dc4_p4_'] = $this->dc4_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dc5_p4_']) && $this->NM_ajax_changed['dc5_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dc5_p4_'] = $this->dc5_p4_;
                  }
                  if (isset($this->NM_ajax_changed['pcent_dc4_']) && $this->NM_ajax_changed['pcent_dc4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['pcent_dc4_'] = $this->pcent_dc4_;
                  }
                  if (isset($this->NM_ajax_changed['dp1_p4_']) && $this->NM_ajax_changed['dp1_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dp1_p4_'] = $this->dp1_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dp2_p4_']) && $this->NM_ajax_changed['dp2_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dp2_p4_'] = $this->dp2_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dp3_p4_']) && $this->NM_ajax_changed['dp3_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dp3_p4_'] = $this->dp3_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dp4_p4_']) && $this->NM_ajax_changed['dp4_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dp4_p4_'] = $this->dp4_p4_;
                  }
                  if (isset($this->NM_ajax_changed['dp5_p4_']) && $this->NM_ajax_changed['dp5_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['dp5_p4_'] = $this->dp5_p4_;
                  }
                  if (isset($this->NM_ajax_changed['pcent_dp4_']) && $this->NM_ajax_changed['pcent_dp4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['pcent_dp4_'] = $this->pcent_dp4_;
                  }
                  if (isset($this->NM_ajax_changed['ds1_p4_']) && $this->NM_ajax_changed['ds1_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['ds1_p4_'] = $this->ds1_p4_;
                  }
                  if (isset($this->NM_ajax_changed['ds2_p4_']) && $this->NM_ajax_changed['ds2_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['ds2_p4_'] = $this->ds2_p4_;
                  }
                  if (isset($this->NM_ajax_changed['ds3_p4_']) && $this->NM_ajax_changed['ds3_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['ds3_p4_'] = $this->ds3_p4_;
                  }
                  if (isset($this->NM_ajax_changed['ds4_p4_']) && $this->NM_ajax_changed['ds4_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['ds4_p4_'] = $this->ds4_p4_;
                  }
                  if (isset($this->NM_ajax_changed['ds5_p4_']) && $this->NM_ajax_changed['ds5_p4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['ds5_p4_'] = $this->ds5_p4_;
                  }
                  if (isset($this->NM_ajax_changed['pcent_ds4_']) && $this->NM_ajax_changed['pcent_ds4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['pcent_ds4_'] = $this->pcent_ds4_;
                  }
                  if (isset($this->NM_ajax_changed['val_acumulada_']) && $this->NM_ajax_changed['val_acumulada_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['val_acumulada_'] = $this->val_acumulada_;
                  }
                  if (isset($this->NM_ajax_changed['val_requerida_']) && $this->NM_ajax_changed['val_requerida_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['val_requerida_'] = $this->val_requerida_;
                  }
                  if (isset($this->NM_ajax_changed['eval_final_']) && $this->NM_ajax_changed['eval_final_'])
                  {
                      $this->form_vert_form_t_evaluacion_p4[$this->nmgp_refresh_row]['eval_final_'] = $this->eval_final_;
                  }
              }
          }
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_t_evaluacion_p4);
          foreach($this->form_vert_form_t_evaluacion_p4 as $sc_seq_vert => $aRecData)
          {
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_t_evaluacion_p4_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_t_evaluacion_p4_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_estudiante_' . $sc_seq_vert]['valList'][$i] = form_t_evaluacion_p4_pack_protect_string($v);
          }
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("eval_4_per_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['eval_4_per_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['eval_4_per_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dc1_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dc1_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dc1_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dc2_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dc2_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dc2_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dc3_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dc3_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dc3_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dc4_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dc4_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dc4_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dc5_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dc5_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dc5_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("pcent_dc4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['pcent_dc4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['pcent_dc4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dp1_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dp1_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dp1_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dp2_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dp2_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dp2_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dp3_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dp3_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dp3_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dp4_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dp4_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dp4_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dp5_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['dp5_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['dp5_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("pcent_dp4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['pcent_dp4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['pcent_dp4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ds1_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['ds1_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['ds1_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ds2_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['ds2_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['ds2_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ds3_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['ds3_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['ds3_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ds4_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['ds4_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['ds4_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ds5_p4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['ds5_p4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['ds5_p4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("pcent_ds4_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['pcent_ds4_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['pcent_ds4_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("eval_final_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['eval_final_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['eval_final_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['id_estudiante_'] = $this->id_estudiante_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['estatus_'] = $this->estatus_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['novedad_'] = $this->novedad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['eval_4_per_'] = $this->eval_4_per_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dc1_p4_'] = $this->dc1_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dc2_p4_'] = $this->dc2_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dc3_p4_'] = $this->dc3_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dc4_p4_'] = $this->dc4_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dc5_p4_'] = $this->dc5_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['pcent_dc4_'] = $this->pcent_dc4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dp1_p4_'] = $this->dp1_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dp2_p4_'] = $this->dp2_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dp3_p4_'] = $this->dp3_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dp4_p4_'] = $this->dp4_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['dp5_p4_'] = $this->dp5_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['pcent_dp4_'] = $this->pcent_dp4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['ds1_p4_'] = $this->ds1_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['ds2_p4_'] = $this->ds2_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['ds3_p4_'] = $this->ds3_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['ds4_p4_'] = $this->ds4_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['ds5_p4_'] = $this->ds5_p4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['pcent_ds4_'] = $this->pcent_ds4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert]['eval_final_'] = $this->eval_final_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET novedad = '$this->novedad_', estatus = '$this->estatus_', eval_4_per = $this->eval_4_per_, dc1_p4 = $this->dc1_p4_, dc2_p4 = $this->dc2_p4_, dc3_p4 = $this->dc3_p4_, dc4_p4 = $this->dc4_p4_, dc5_p4 = $this->dc5_p4_, pcent_dc4 = $this->pcent_dc4_, ds1_p4 = $this->ds1_p4_, ds2_p4 = $this->ds2_p4_, ds3_p4 = $this->ds3_p4_, ds4_p4 = $this->ds4_p4_, ds5_p4 = $this->ds5_p4_, pcent_ds4 = $this->pcent_ds4_, dp1_p4 = $this->dp1_p4_, dp2_p4 = $this->dp2_p4_, dp3_p4 = $this->dp3_p4_, dp4_p4 = $this->dp4_p4_, dp5_p4 = $this->dp5_p4_, pcent_dp4 = $this->pcent_dp4_, eval_final = $this->eval_final_";  
              } 
              else 
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET novedad = '$this->novedad_', estatus = '$this->estatus_', eval_4_per = $this->eval_4_per_, dc1_p4 = $this->dc1_p4_, dc2_p4 = $this->dc2_p4_, dc3_p4 = $this->dc3_p4_, dc4_p4 = $this->dc4_p4_, dc5_p4 = $this->dc5_p4_, pcent_dc4 = $this->pcent_dc4_, ds1_p4 = $this->ds1_p4_, ds2_p4 = $this->ds2_p4_, ds3_p4 = $this->ds3_p4_, ds4_p4 = $this->ds4_p4_, ds5_p4 = $this->ds5_p4_, pcent_ds4 = $this->pcent_ds4_, dp1_p4 = $this->dp1_p4_, dp2_p4 = $this->dp2_p4_, dp3_p4 = $this->dp3_p4_, dp4_p4 = $this->dp4_p4_, dp5_p4 = $this->dp5_p4_, pcent_dp4 = $this->pcent_dp4_, eval_final = $this->eval_final_";  
              } 
              ...
              if (isset($NM_val_form['eval_1_per_']) && $NM_val_form['eval_1_per_'] != $this->nmgp_dados_select['eval_1_per_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " eval_1_per = $this->eval_1_per_"; 
                  $comando_oracle        .= " eval_1_per = $this->eval_1_per_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
          ...
          $this->estatus_ = $this->estatus__before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['eval_4_per_'])) { $this->eval_4_per_ = $NM_val_form['eval_4_per_']; }
              elseif (isset($this->eval_4_per_)) { $this->nm_limpa_alfa($this->eval_4_per_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dc1_p4_'])) { $this->dc1_p4_ = $NM_val_form['dc1_p4_']; }
              elseif (isset($this->dc1_p4_)) { $this->nm_limpa_alfa($this->dc1_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dc2_p4_'])) { $this->dc2_p4_ = $NM_val_form['dc2_p4_']; }
              elseif (isset($this->dc2_p4_)) { $this->nm_limpa_alfa($this->dc2_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dc3_p4_'])) { $this->dc3_p4_ = $NM_val_form['dc3_p4_']; }
              elseif (isset($this->dc3_p4_)) { $this->nm_limpa_alfa($this->dc3_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dc4_p4_'])) { $this->dc4_p4_ = $NM_val_form['dc4_p4_']; }
              elseif (isset($this->dc4_p4_)) { $this->nm_limpa_alfa($this->dc4_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dc5_p4_'])) { $this->dc5_p4_ = $NM_val_form['dc5_p4_']; }
              elseif (isset($this->dc5_p4_)) { $this->nm_limpa_alfa($this->dc5_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['pcent_dc4_'])) { $this->pcent_dc4_ = $NM_val_form['pcent_dc4_']; }
              elseif (isset($this->pcent_dc4_)) { $this->nm_limpa_alfa($this->pcent_dc4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['ds1_p4_'])) { $this->ds1_p4_ = $NM_val_form['ds1_p4_']; }
              elseif (isset($this->ds1_p4_)) { $this->nm_limpa_alfa($this->ds1_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['ds2_p4_'])) { $this->ds2_p4_ = $NM_val_form['ds2_p4_']; }
              elseif (isset($this->ds2_p4_)) { $this->nm_limpa_alfa($this->ds2_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['ds3_p4_'])) { $this->ds3_p4_ = $NM_val_form['ds3_p4_']; }
              elseif (isset($this->ds3_p4_)) { $this->nm_limpa_alfa($this->ds3_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['ds4_p4_'])) { $this->ds4_p4_ = $NM_val_form['ds4_p4_']; }
              elseif (isset($this->ds4_p4_)) { $this->nm_limpa_alfa($this->ds4_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['ds5_p4_'])) { $this->ds5_p4_ = $NM_val_form['ds5_p4_']; }
              elseif (isset($this->ds5_p4_)) { $this->nm_limpa_alfa($this->ds5_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['pcent_ds4_'])) { $this->pcent_ds4_ = $NM_val_form['pcent_ds4_']; }
              elseif (isset($this->pcent_ds4_)) { $this->nm_limpa_alfa($this->pcent_ds4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dp1_p4_'])) { $this->dp1_p4_ = $NM_val_form['dp1_p4_']; }
              elseif (isset($this->dp1_p4_)) { $this->nm_limpa_alfa($this->dp1_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dp2_p4_'])) { $this->dp2_p4_ = $NM_val_form['dp2_p4_']; }
              elseif (isset($this->dp2_p4_)) { $this->nm_limpa_alfa($this->dp2_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dp3_p4_'])) { $this->dp3_p4_ = $NM_val_form['dp3_p4_']; }
              elseif (isset($this->dp3_p4_)) { $this->nm_limpa_alfa($this->dp3_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dp4_p4_'])) { $this->dp4_p4_ = $NM_val_form['dp4_p4_']; }
              elseif (isset($this->dp4_p4_)) { $this->nm_limpa_alfa($this->dp4_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['dp5_p4_'])) { $this->dp5_p4_ = $NM_val_form['dp5_p4_']; }
              elseif (isset($this->dp5_p4_)) { $this->nm_limpa_alfa($this->dp5_p4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['pcent_dp4_'])) { $this->pcent_dp4_ = $NM_val_form['pcent_dp4_']; }
              elseif (isset($this->pcent_dp4_)) { $this->nm_limpa_alfa($this->pcent_dp4_); }
              if     (isset($NM_val_form) && isset($NM_val_form['eval_final_'])) { $this->eval_final_ = $NM_val_form['eval_final_']; }
              elseif (isset($this->eval_final_)) { $this->nm_limpa_alfa($this->eval_final_); }

              $this->nm_formatar_campos();

              $aOldRefresh               = $this->nmgp_refresh_fields;
              $this->nmgp_refresh_fields = array_diff(array('id_estudiante_', 'estatus_', 'novedad_', 'eval_4_per_', 'dc1_p4_', 'dc2_p4_', 'dc3_p4_', 'dc4_p4_', 'dc5_p4_', 'pcent_dc4_', 'dp1_p4_', 'dp2_p4_', 'dp3_p4_', 'dp4_p4_', 'dp5_p4_', 'pcent_dp4_', 'ds1_p4_', 'ds2_p4_', 'ds3_p4_', 'ds4_p4_', 'ds5_p4_', 'pcent_ds4_', 'val_acumulada_', 'val_requerida_', 'eval_final_'), $aDoNotUpdate);
              $this->ajax_return_values();
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['eval_4_per_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dc1_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dc2_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dc3_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dc4_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dc5_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['pcent_dc4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dp1_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dp2_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dp3_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dp4_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dp5_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['pcent_dp4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['ds1_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['ds2_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['ds3_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['ds4_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['ds5_p4_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['pcent_ds4_' . $this->nmgp_refresh_row] = 'on';
                  ...
                  $this->NM_ajax_info['readOnly']['eval_final_' . $this->nmgp_refresh_row] = 'on';
...
ORDER BY nombre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_t_evaluacion_p4_pack_protect_string(NM_charset_to_utf8($this->id_estudiante_)))
              {
          ...
          $tmpLabel_id_estudiante_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['eval_4_per_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['eval_4_per_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->eval_4_per_));
                  $this->NM_ajax_info['fldList']['eval_4_per_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_eval_4_per_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['eval_4_per_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['eval_4_per_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dc1_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dc1_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dc1_p4_));
                  $this->NM_ajax_info['fldList']['dc1_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dc1_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dc1_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dc1_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dc2_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dc2_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dc2_p4_));
                  $this->NM_ajax_info['fldList']['dc2_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dc2_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dc2_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dc2_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dc3_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dc3_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dc3_p4_));
                  $this->NM_ajax_info['fldList']['dc3_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dc3_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dc3_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dc3_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dc4_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dc4_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dc4_p4_));
                  $this->NM_ajax_info['fldList']['dc4_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dc4_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dc4_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dc4_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dc5_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dc5_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dc5_p4_));
                  $this->NM_ajax_info['fldList']['dc5_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dc5_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dc5_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dc5_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['pcent_dc4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['pcent_dc4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->pcent_dc4_));
                  $this->NM_ajax_info['fldList']['pcent_dc4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_pcent_dc4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['pcent_dc4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['pcent_dc4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dp1_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dp1_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dp1_p4_));
                  $this->NM_ajax_info['fldList']['dp1_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dp1_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dp1_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dp1_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dp2_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dp2_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dp2_p4_));
                  $this->NM_ajax_info['fldList']['dp2_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dp2_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dp2_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dp2_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dp3_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dp3_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dp3_p4_));
                  $this->NM_ajax_info['fldList']['dp3_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dp3_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dp3_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dp3_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dp4_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dp4_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dp4_p4_));
                  $this->NM_ajax_info['fldList']['dp4_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dp4_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dp4_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dp4_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['dp5_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['dp5_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->dp5_p4_));
                  $this->NM_ajax_info['fldList']['dp5_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_dp5_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['dp5_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['dp5_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['pcent_dp4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['pcent_dp4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->pcent_dp4_));
                  $this->NM_ajax_info['fldList']['pcent_dp4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_pcent_dp4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['pcent_dp4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['pcent_dp4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['ds1_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['ds1_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->ds1_p4_));
                  $this->NM_ajax_info['fldList']['ds1_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_ds1_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['ds1_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['ds1_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['ds2_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['ds2_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->ds2_p4_));
                  $this->NM_ajax_info['fldList']['ds2_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_ds2_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['ds2_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['ds2_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['ds3_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['ds3_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->ds3_p4_));
                  $this->NM_ajax_info['fldList']['ds3_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_ds3_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['ds3_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['ds3_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['ds4_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['ds4_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->ds4_p4_));
                  $this->NM_ajax_info['fldList']['ds4_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_ds4_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['ds4_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['ds4_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['ds5_p4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['ds5_p4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->ds5_p4_));
                  $this->NM_ajax_info['fldList']['ds5_p4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_ds5_p4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['ds5_p4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['ds5_p4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['pcent_ds4_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['pcent_ds4_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->pcent_ds4_));
                  $this->NM_ajax_info['fldList']['pcent_ds4_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_pcent_ds4_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['pcent_ds4_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['pcent_ds4_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['eval_final_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['eval_final_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->eval_final_));
                  $this->NM_ajax_info['fldList']['eval_final_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_eval_final_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['eval_final_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['eval_final_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['parms'] = "id_estudiante_?#?$this->id_estudiante_?@?id_grupo_?#?$this->id_grupo_?@?id_asignatura_?#?$this->id_asignatura_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p4']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['embutida_liga_qtd_reg'];
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_t_evaluacion_p4 = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['parms'] = ""; 
      } 
      if ($this->sc_teve_excl)
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter'] . ")";
          }
      }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total']))
          {
              ...
              $qt_geral_reg_form_t_evaluacion_p4 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total'] = $qt_geral_reg_form_t_evaluacion_p4;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_estudiante_) && !empty($this->id_grupo_) && !empty($this->id_asignatura_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_t_evaluacion_p4 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_t_evaluacion_p4) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] > $qt_geral_reg_form_t_evaluacion_p4)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = $qt_geral_reg_form_t_evaluacion_p4 - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = ($qt_geral_reg_form_t_evaluacion_p4 + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['ordem_ord']; 
      } 
      $nmgp_select = "SELECT id_estudiante, primer_apellido, segundo_apellido, primer_nombre, segundo_nombre, id_grupo, id_area, id_asignatura, id_grado, id_nivel, ihs, pfa, tipo_asig, novedad, estatus, eval_1_per, dc1, dc2, dc3, dc4, dc5, pcent_dc, ds1, ds2, ds3, ds4, ds5, pcent_ds, dp1, dp2, dp3, dp4, dp5, pcent_dp, eval_2_per, dc1_2p, dc2_2p, dc3_2p, dc4_2p, dc5_2p, pcent_dc2, ds1_2p, ds2_2p, ds3_2p, ds4_2p, ds5_2p, pcent_ds2, dp1_2p, dp2_2p, dp3_2p, dp4_2p, dp5_2p, pcent_dp2, eval_3_per, dc1_3p, dc2_3p, dc3_3p, dc4_3p, dc5_3p, pcent_dc3, ds1_p3, ds2_p3, ds3_p3, ds4_p3, ds5_p3, pcent_ds3, dp1_p3, dp2_p3, dp3_p3, dp4_p3, `dp5-p3` as sc_field_0_, pcent_dp3, eval_4_per, dc1_p4, dc2_p4, dc3_p4, dc4_p4, dc5_p4, pcent_dc4, ds1_p4, ds2_p4, ds3_p4, ds4_p4, ds5_p4, pcent_ds4, dp1_p4, dp2_p4, dp3_p4, dp4_p4, dp5_p4, pcent_dp4, eval_final, entorno from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      if ($this->nmgp_opcao != "novo") 
      { 
      ...
      else
      {
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start']) ; 
              } 
              else  
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['parms'] = "id_estudiante_?#?$this->id_estudiante_?@?id_grupo_?#?$this->id_grupo_?@?id_asignatura_?#?$this->id_asignatura_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['id_estudiante_'] =  $this->id_estudiante_; 
             $this->form_vert_form_t_evaluacion_p4[$sc_seq_vert]['estatus_'] =  $this->estatus_; 
          ...
          ksort ($this->form_vert_form_t_evaluacion_p4); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total'] + 1; 
          }
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['reg_start'] < (($qt_geral_reg_form_t_evaluacion_p4 + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          { 
              ...
              $this->pcent_dp4_ = "";  
              $this->eval_final_ = "";  
              $this->entorno_ = "" . $_SESSION['entorno'] . "";  
              $this->val_acumulada_ = "";  
              $this->val_requerida_ = "";  
              $this->nm_proc_onload_record($sc_seq_vert);
              if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['foreign_key']))
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter_form'] . " and (id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura= " . $_SESSION['par_id_asignatura'] . " AND entorno = " . $_SESSION['entorno'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_t_evaluacion_p4 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['total'] = $qt_geral_reg_form_t_evaluacion_p4;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_t_evaluacion_p4_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_t_evaluacion_p4_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_t_evaluacion_p4_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p4']['masterValue']))
{
?>
