<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiantes_n_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiantes_n_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['students_idstudents'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_idstudents'] = "students_idstudents";
       $tab_converte["students_idstudents"]   = "students_idstudents";
   }
   else
   {
       $tab_def_campos['students_idstudents'] = "students.idstudents";
       $tab_converte["students.idstudents"]   = "students_idstudents";
   }
   $tab_labels["students_idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_idstudents"] : "";
   $tab_ger_campos['students_id_sede'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_id_sede'] = "students_id_sede";
       $tab_converte["students_id_sede"]   = "students_id_sede";
   }
   else
   {
       $tab_def_campos['students_id_sede'] = "students.id_sede";
       $tab_converte["students.id_sede"]   = "students_id_sede";
   }
   $tab_labels["students_id_sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_id_sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_id_sede"] : "Sede";
   $tab_ger_campos['students_primer_apellido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_primer_apellido'] = "students_primer_apellido";
       $tab_converte["students_primer_apellido"]   = "students_primer_apellido";
   }
   else
   {
       $tab_def_campos['students_primer_apellido'] = "students.primer_apellido";
       $tab_converte["students.primer_apellido"]   = "students_primer_apellido";
   }
   $tab_labels["students_primer_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_primer_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_primer_apellido"] : "Primer Apellido";
   $tab_ger_campos['students_segundo_apellido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_segundo_apellido'] = "students_segundo_apellido";
       $tab_converte["students_segundo_apellido"]   = "students_segundo_apellido";
   }
   else
   {
       $tab_def_campos['students_segundo_apellido'] = "students.segundo_apellido";
       $tab_converte["students.segundo_apellido"]   = "students_segundo_apellido";
   }
   $tab_labels["students_segundo_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_segundo_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_segundo_apellido"] : "Segundo Apellido";
   $tab_ger_campos['students_grado_igreso'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_grado_igreso'] = "students_grado_igreso";
       $tab_converte["students_grado_igreso"]   = "students_grado_igreso";
   }
   else
   {
       $tab_def_campos['students_grado_igreso'] = "students.grado_igreso";
       $tab_converte["students.grado_igreso"]   = "students_grado_igreso";
   }
   $tab_labels["students_grado_igreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_grado_igreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_grado_igreso"] : "Grado Igreso";
   $tab_ger_campos['students_id_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_id_grupo'] = "students_id_grupo";
       $tab_converte["students_id_grupo"]   = "students_id_grupo";
   }
   else
   {
       $tab_def_campos['students_id_grupo'] = "students.id_grupo";
       $tab_converte["students.id_grupo"]   = "students_id_grupo";
   }
   $tab_labels["students_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["students_id_grupo"] : "Id Grupo";
   $tab_ger_campos['t_estudiante_grupo_entorno'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_estudiante_grupo_entorno'] = "t_estudiante_grupo_entorno";
       $tab_converte["t_estudiante_grupo_entorno"]   = "t_estudiante_grupo_entorno";
   }
   else
   {
       $tab_def_campos['t_estudiante_grupo_entorno'] = "t_estudiante_grupo.entorno";
       $tab_converte["t_estudiante_grupo.entorno"]   = "t_estudiante_grupo_entorno";
   }
   $tab_labels["t_estudiante_grupo_entorno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["t_estudiante_grupo_entorno"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["t_estudiante_grupo_entorno"] : "Entorno";
   $tab_ger_campos['dias_inasiste'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dias_inasiste'] = "dias_inasiste";
       $tab_converte["dias_inasiste"]   = "dias_inasiste";
   }
   else
   {
       $tab_def_campos['dias_inasiste'] = "";
       $tab_converte[""]   = "dias_inasiste";
   }
   $tab_labels["dias_inasiste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["dias_inasiste"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["dias_inasiste"] : "dias_inasiste";
   $tab_ger_campos['dir_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dir_grupo'] = "dir_grupo";
       $tab_converte["dir_grupo"]   = "dir_grupo";
   }
   else
   {
       $tab_def_campos['dir_grupo'] = "SELECT
...
WHERE
t_estudiante_grupo.idstudent = '{students.idstudents}'";
       $tab_converte["SELECT
CONCAT_WS(' ',docentes.primer_nombre,
docentes.segundo_nombre,
docentes.primer_apellido,
...
INNER JOIN docentes ON docentes.id_docente = t_grupos.id_director_grupo
WHERE
t_estudiante_grupo.idstudent = '{students.idstudents}'"]   = "dir_grupo";
   }
   $tab_labels["dir_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["dir_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["dir_grupo"] : "dir_grupo";
   $tab_ger_campos['linea_1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['linea_1'] = "linea_1";
       $tab_converte["linea_1"]   = "linea_1";
   }
   else
   {
       $tab_def_campos['linea_1'] = "";
       $tab_converte[""]   = "linea_1";
   }
   $tab_labels["linea_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["linea_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["linea_1"] : "linea_1";
   ...
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["obs"] : "obs";
   ...
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['labels']["titulo"] : "";
   $tab_ger_campos['dias_inasiste'] = "none";
   $tab_ger_campos['dir_grupo'] = "none";
   $tab_ger_campos['linea_1'] = "none";
   $tab_ger_campos['obs'] = "none";
   $tab_ger_campos['titulo'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_n']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_n']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_n']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiantes_n_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_n']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
