...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_estudiantes_n"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_estudiantes_n"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_estudiantes_n</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_n']['embutida_filho'] as $ind => $sc_init)
          {
