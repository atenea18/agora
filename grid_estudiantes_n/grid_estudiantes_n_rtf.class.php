...
class grid_estudiantes_n_rtf
{
   ...
   //---- 
   function grid_estudiantes_n_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_estudiantes_n.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_n']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_n']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_n']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_n']['rtf_name']);
      }
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['students_grado_igreso'])) ? $this->New_label['students_grado_igreso'] : "Grado Igreso"; 
          if ($Cada_col == "students_grado_igreso" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          $SC_Label = (isset($this->New_label['t_estudiante_grupo_entorno'])) ? $this->New_label['t_estudiante_grupo_entorno'] : "Entorno"; 
          if ($Cada_col == "t_estudiante_grupo_entorno" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
   ...
   function NM_export_students_grado_igreso()
   {
         ...
         if (!NM_is_utf8($this->look_students_grado_igreso))
         {
             $this->look_students_grado_igreso = sc_convert_encoding($this->look_students_grado_igreso, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->look_students_grado_igreso = str_replace('<', '&lt;', $this->look_students_grado_igreso);
         $this->look_students_grado_igreso = str_replace('>', '&gt;', $this->look_students_grado_igreso);
         $this->Texto_tag .= "<td>" . $this->look_students_grado_igreso . "</td>\r\n";
   }
   //----- students_id_grupo
   function NM_export_students_id_grupo()
   {
         ...
         if (!NM_is_utf8($this->look_students_id_grupo))
         {
             $this->look_students_id_grupo = sc_convert_encoding($this->look_students_id_grupo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->look_students_id_grupo = str_replace('<', '&lt;', $this->look_students_id_grupo);
         $this->look_students_id_grupo = str_replace('>', '&gt;', $this->look_students_id_grupo);
         $this->Texto_tag .= "<td>" . $this->look_students_id_grupo . "</td>\r\n";
   }
   ...
   function NM_export_t_estudiante_grupo_entorno()
   {
         ...
         if (!NM_is_utf8($this->t_estudiante_grupo_entorno))
         {
             $this->t_estudiante_grupo_entorno = sc_convert_encoding($this->t_estudiante_grupo_entorno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->t_estudiante_grupo_entorno = str_replace('<', '&lt;', $this->t_estudiante_grupo_entorno);
         $this->t_estudiante_grupo_entorno = str_replace('>', '&gt;', $this->t_estudiante_grupo_entorno);
         $this->Texto_tag .= "<td>" . $this->t_estudiante_grupo_entorno . "</td>\r\n";
   }
   //----- dias_inasiste
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_n']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_n']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
