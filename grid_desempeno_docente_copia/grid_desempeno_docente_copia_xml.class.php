...
class grid_desempeno_docente_copia_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_desempeno_docente_copia_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_desempeno_docente_copia.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_desempeno_docente_copia";
...
$_SESSION['scriptcase']['grid_desempeno_docente_copia']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_periodos))
         {
             $this->look_periodos = sc_convert_encoding($this->look_periodos, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " periodos =\"" . $this->trata_dados($this->look_periodos) . "\"";
   }
   //----- superior
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
