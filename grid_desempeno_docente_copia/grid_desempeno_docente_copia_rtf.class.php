...
class grid_desempeno_docente_copia_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_desempeno_docente_copia_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_desempeno_docente_copia.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_desempeno_docente_copia']['contr_erro'] = 'off'; 
   ...
   function NM_export_periodos()
   {
         ...
         $this->look_periodos = str_replace('<', '&lt;', $this->look_periodos);
         $this->look_periodos = str_replace('>', '&gt;', $this->look_periodos);
         $this->Texto_tag .= "<td>" . $this->look_periodos . "</td>\r\n";
   }
   //----- superior
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
