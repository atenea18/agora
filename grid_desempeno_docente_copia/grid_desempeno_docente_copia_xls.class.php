...
class grid_desempeno_docente_copia_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $Tit_doc;
   //---- 
   function grid_desempeno_docente_copia_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_desempeno_docente_copia";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_desempeno_docente_copia.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->periodos = $rs->fields[1] ;  
         $this->superior = $rs->fields[2] ;  
         $this->id_grado = $rs->fields[3] ;  
         $this->id_grado = (string)$this->id_grado;
         $this->id_area = $rs->fields[4] ;  
         ...
         $this->look_periodos = ($this->look_periodos == "&nbsp;") ? "" : $this->look_periodos; 
         //----- lookup - id_grado
...
$_SESSION['scriptcase']['grid_desempeno_docente_copia']['contr_erro'] = 'off'; 
   ...
   function NM_export_codigo()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->codigo);
         $this->Xls_col++;
   }
   //----- periodos
   function NM_export_periodos()
   {
         $this->look_periodos = html_entity_decode($this->look_periodos, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_periodos = strip_tags($this->look_periodos);
         if (!NM_is_utf8($this->look_periodos))
         {
             $this->look_periodos = sc_convert_encoding($this->look_periodos, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_periodos, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- superior
   function NM_export_superior()
   {
      if (!empty($this->superior))
      {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->superior, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- id_grado
   ...
   function NM_export_id_clas_chs()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->look_id_clas_chs))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_id_clas_chs);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desempeno_docente_copia'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - desempeno :: Excel</TITLE>
