...
<?php
include_once("control_imp_boletines_comf_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_imp_boletines_comf_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_estudent", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_imp_boletines_comf.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['recarga'];
}
?>
...
<?php
 include_once("control_imp_boletines_comf_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_imp_boletines_comf'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_imp_boletines_comf'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_comf']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_imp_boletines_comf");
 parent.scAjaxDetailHeight("control_imp_boletines_comf", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
