<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_actividades_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_actividades_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["estudiantes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["estudiantes"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["estudiantes"] : "Estudiantes";
   ...
   $tab_labels["desempeno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["desempeno"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["desempeno"] : "Desempeño";
   ...
   $tab_labels["evaluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluar"] : "Evaluar";
   $tab_ger_campos['evaluardc2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evaluardc2'] = "evaluardc2";
       $tab_converte["evaluardc2"]   = "evaluardc2";
   }
   else
   {
       $tab_def_campos['evaluardc2'] = "";
       $tab_converte[""]   = "evaluardc2";
   }
   $tab_labels["evaluardc2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc2"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc2"] : "Evaluar";
   $tab_ger_campos['evaluardc3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evaluardc3'] = "evaluardc3";
       $tab_converte["evaluardc3"]   = "evaluardc3";
   }
   else
   {
       $tab_def_campos['evaluardc3'] = "";
       $tab_converte[""]   = "evaluardc3";
   }
   $tab_labels["evaluardc3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc3"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc3"] : "Evaluar";
   $tab_ger_campos['evaluardc4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evaluardc4'] = "evaluardc4";
       $tab_converte["evaluardc4"]   = "evaluardc4";
   }
   else
   {
       $tab_def_campos['evaluardc4'] = "";
       $tab_converte[""]   = "evaluardc4";
   }
   $tab_labels["evaluardc4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc4"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc4"] : "Evaluar";
   $tab_ger_campos['evaluardc5'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evaluardc5'] = "evaluardc5";
       $tab_converte["evaluardc5"]   = "evaluardc5";
   }
   else
   {
       $tab_def_campos['evaluardc5'] = "";
       $tab_converte[""]   = "evaluardc5";
   }
   $tab_labels["evaluardc5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc5"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['labels']["evaluardc5"] : "Evaluar";
   $tab_ger_campos['estudiantes'] = "none";
   $tab_ger_campos['desempeno'] = "none";
   $tab_ger_campos['evaluar'] = "none";
   $tab_ger_campos['evaluardc2'] = "none";
   $tab_ger_campos['evaluardc3'] = "none";
   $tab_ger_campos['evaluardc4'] = "none";
   $tab_ger_campos['evaluardc5'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_actividades_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_actividades']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
