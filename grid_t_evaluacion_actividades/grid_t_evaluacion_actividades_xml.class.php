...
class grid_t_evaluacion_actividades_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_evaluacion_actividades_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_t_evaluacion_actividades.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_actividades']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_actividades']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_actividades']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_actividades']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_t_evaluacion_actividades";
...
$_SESSION['scriptcase']['grid_t_evaluacion_actividades']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evaluardc2))
         {
             $this->evaluardc2 = sc_convert_encoding($this->evaluardc2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evaluardc2 =\"" . $this->trata_dados($this->evaluardc2) . "\"";
   }
   //----- evaluardc3
   function NM_export_evaluardc3()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evaluardc3))
         {
             $this->evaluardc3 = sc_convert_encoding($this->evaluardc3, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evaluardc3 =\"" . $this->trata_dados($this->evaluardc3) . "\"";
   }
   //----- evaluardc4
   function NM_export_evaluardc4()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evaluardc4))
         {
             $this->evaluardc4 = sc_convert_encoding($this->evaluardc4, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evaluardc4 =\"" . $this->trata_dados($this->evaluardc4) . "\"";
   }
   //----- evaluardc5
   function NM_export_evaluardc5()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evaluardc5))
         {
             $this->evaluardc5 = sc_convert_encoding($this->evaluardc5, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evaluardc5 =\"" . $this->trata_dados($this->evaluardc5) . "\"";
   }
   //----- id_estudiante
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_actividades']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_actividades']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
