...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____notas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____notas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['notas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['notas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['notas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['notas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['notas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['notas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['notas']['embutida_filho'] as $ind => $sc_init)
          {
