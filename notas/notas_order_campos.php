...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['t_asignaturas_asignatura'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_asignaturas_asignatura'] = "t_asignaturas_asignatura";
       $tab_converte["t_asignaturas_asignatura"]   = "t_asignaturas_asignatura";
   }
   else
   {
       $tab_def_campos['t_asignaturas_asignatura'] = "t_asignaturas.asignatura";
       $tab_converte["t_asignaturas.asignatura"]   = "t_asignaturas_asignatura";
   }
   $tab_labels["t_asignaturas_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['notas']['labels']["t_asignaturas_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['notas']['labels']["t_asignaturas_asignatura"] : "Asignatura";
   ...
   $tab_labels["t_evaluacion_id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_id_estudiante"] : "Id Estudiante";
   ...
   $tab_labels["t_evaluacion_primer_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_primer_apellido"])) ? $_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_primer_apellido"] : "Primer Apellido";
   ...
   $tab_labels["t_evaluacion_segundo_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_segundo_apellido"])) ? $_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_segundo_apellido"] : "Segundo Apellido";
   ...
   $tab_labels["t_evaluacion_primer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_primer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_primer_nombre"] : "Primer Nombre";
   ...
   $tab_labels["t_evaluacion_segundo_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_segundo_nombre"])) ? $_SESSION['sc_session'][$sc_init]['notas']['labels']["t_evaluacion_segundo_nombre"] : "Segundo Nombre";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['notas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['notas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['notas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['notas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['notas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['notas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['notas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['notas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['notas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['notas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['notas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
