<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiantes_boletines_normal_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiantes_boletines_normal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["students_idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["students_idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["students_idstudents"] : "";
   ...
   $tab_labels["areas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["areas"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["areas"] : "areas";
   ...
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["obs"] : "obs";
   ...
   $tab_labels["linea_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["linea_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["linea_1"] : "linea_1";
   ...
   $tab_labels["linea_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["linea_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["linea_2"] : "linea_2";
   ...
   $tab_labels["dias_inasiste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["dias_inasiste"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['labels']["dias_inasiste"] : "dias_inasiste";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_boletines_normal']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_boletines_normal']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_boletines_normal']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiantes_boletines_normal_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines_normal']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
