...
class grid_estudiantes_boletines_normal_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_estudiantes_boletines_normal_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_estudiantes_boletines_normal.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_boletines_normal']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_boletines_normal']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_boletines_normal']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_boletines_normal']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_estudiantes_boletines_normal";
...
$_SESSION['scriptcase']['grid_estudiantes_boletines_normal']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->linea_2))
         {
             $this->linea_2 = sc_convert_encoding($this->linea_2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " linea_2 =\"" . $this->trata_dados($this->linea_2) . "\"";
   }
   //----- dias_inasiste
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_boletines_normal']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_boletines_normal']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
