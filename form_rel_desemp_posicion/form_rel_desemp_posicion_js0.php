...
<input type="hidden" name="id_asign" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_asign']); ?>">
<input type="hidden" name="posicion" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['posicion']); ?>">
<input type="hidden" name="cod_desemp" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cod_desemp']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_rel_desemp_posicion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("gra=disabled;gru=disabled;are=disabled;asign=disabled;peri=disabled;cod_de=disabled", "");
