...
<?php
include_once("form_rel_desemp_posicion_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_rel_desemp_posicion_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['recarga'];
}
?>
...
<?php
 include_once("form_rel_desemp_posicion_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_rel_desemp_posicion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_rel_desemp_posicion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_grupo_line" id="hidden_field_data_id_grupo" style="<?php echo $sStyleHidden_id_grupo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_grupo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_grupo_label"><span id="id_label_id_grupo"><?php echo $this->nm_new_label['id_grupo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['php_cmp_required']['id_grupo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['php_cmp_required']['id_grupo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_line" id="hidden_field_data_posicion" style="<?php echo $sStyleHidden_posicion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_label"><span id="id_label_posicion"><?php echo $this->nm_new_label['posicion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['php_cmp_required']['posicion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['php_cmp_required']['posicion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rel_desemp_posicion']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_rel_desemp_posicion");
 parent.scAjaxDetailHeight("form_rel_desemp_posicion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
