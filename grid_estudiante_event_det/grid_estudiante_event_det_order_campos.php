<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiante_event_det_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiante_event_det_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['nomb_estudiante'] = "nomb_estudiante";
       $tab_converte["nomb_estudiante"]   = "nomb_estudiante";
   }
   else
   {
       $tab_def_campos['nomb_estudiante'] = "CONCAT_WS(' ',primer_apellido,segundo_apellido,primer_nombre,segundo_nombre)";
       $tab_converte["CONCAT_WS(' ',primer_apellido,segundo_apellido,primer_nombre,segundo_nombre)"]   = "nomb_estudiante";
   }
   $tab_labels["nomb_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['labels']["nomb_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['labels']["nomb_estudiante"] : "Estudiante                                                                                             ";
   ...
   {
       $tab_def_campos['telefonos'] = "";
       $tab_converte[""]   = "telefonos";
   }
   $tab_labels["telefonos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['labels']["telefonos"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['labels']["telefonos"] : "Teléfonos &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp";
   ...
   $tab_labels["firma"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['labels']["firma"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['labels']["firma"] : "Firmas                                          ";
   $tab_ger_campos['telefonos'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiante_event_det_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiante_event_det']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
