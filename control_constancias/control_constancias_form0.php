...
<?php
include_once("control_constancias_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_constancias_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['recarga'];
}
?>
...
<?php
 include_once("control_constancias_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_constancias'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_constancias'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_anyo_label" id="hidden_field_label_anyo" style="<?php echo $sStyleHidden_anyo; ?>"><span id="id_label_anyo"><?php echo $this->nm_new_label['anyo']; ?></span></TD>
    <TD class="scFormDataOdd css_anyo_line" id="hidden_field_data_anyo" style="<?php echo $sStyleHidden_anyo; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2009'; ?>
 <option value="2010" <?php  if ($this->anyo == "2010") { echo " selected" ;} ?>>2010</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2010'; ?>
 <option value="2011" <?php  if ($this->anyo == "2011") { echo " selected" ;} ?>>2011</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2011'; ?>
 <option value="2012" <?php  if ($this->anyo == "2012") { echo " selected" ;} ?>>2012</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2012'; ?>
 <option value="2013" <?php  if ($this->anyo == "2013") { echo " selected" ;} ?>>2013</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2013'; ?>
 <option value="2014" <?php  if ($this->anyo == "2014") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2014'; ?>
 <option value="2015" <?php  if ($this->anyo == "2015") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2015'; ?>
 <option value="2016" <?php  if ($this->anyo == "2016") { echo " selected" ;} ?>>2016</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2016'; ?>
 <option value="2017" <?php  if ($this->anyo == "2017") { echo " selected" ;} ?>>2017</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2017'; ?>
 <option value="2018" <?php  if ($this->anyo == "2018") { echo " selected" ;} ?>>2018</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2018'; ?>
 <option value="2019" <?php  if ($this->anyo == "2019") { echo " selected" ;} ?>>2019</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2019'; ?>
 <option value="2020" <?php  if ($this->anyo == "2020") { echo " selected" ;} ?>>2020</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['Lookup_anyo'][] = '2020'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estudiante_line" id="hidden_field_data_estudiante" style="<?php echo $sStyleHidden_estudiante; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_especialidad_label" id="hidden_field_label_especialidad" style="<?php echo $sStyleHidden_especialidad; ?>"><span id="id_label_especialidad"><?php echo $this->nm_new_label['especialidad']; ?></span></TD>
    <TD class="scFormDataOdd css_especialidad_line" id="hidden_field_data_especialidad" style="<?php echo $sStyleHidden_especialidad; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pri_firma_label" id="hidden_field_label_pri_firma" style="<?php echo $sStyleHidden_pri_firma; ?>"><span id="id_label_pri_firma"><?php echo $this->nm_new_label['pri_firma']; ?></span></TD>
    <TD class="scFormDataOdd css_pri_firma_line" id="hidden_field_data_pri_firma" style="<?php echo $sStyleHidden_pri_firma; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cargo_pri_firm_label" id="hidden_field_label_cargo_pri_firm" style="<?php echo $sStyleHidden_cargo_pri_firm; ?>"><span id="id_label_cargo_pri_firm"><?php echo $this->nm_new_label['cargo_pri_firm']; ?></span></TD>
    <TD class="scFormDataOdd css_cargo_pri_firm_line" id="hidden_field_data_cargo_pri_firm" style="<?php echo $sStyleHidden_cargo_pri_firm; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_seg_firma_label" id="hidden_field_label_seg_firma" style="<?php echo $sStyleHidden_seg_firma; ?>"><span id="id_label_seg_firma"><?php echo $this->nm_new_label['seg_firma']; ?></span></TD>
    <TD class="scFormDataOdd css_seg_firma_line" id="hidden_field_data_seg_firma" style="<?php echo $sStyleHidden_seg_firma; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cargo_seg_firm_label" id="hidden_field_label_cargo_seg_firm" style="<?php echo $sStyleHidden_cargo_seg_firm; ?>"><span id="id_label_cargo_seg_firm"><?php echo $this->nm_new_label['cargo_seg_firm']; ?></span></TD>
    <TD class="scFormDataOdd css_cargo_seg_firm_line" id="hidden_field_data_cargo_seg_firm" style="<?php echo $sStyleHidden_cargo_seg_firm; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_encabezado_label" id="hidden_field_label_encabezado" style="<?php echo $sStyleHidden_encabezado; ?>"><span id="id_label_encabezado"><?php echo $this->nm_new_label['encabezado']; ?></span></TD>
    <TD class="scFormDataOdd css_encabezado_line" id="hidden_field_data_encabezado" style="<?php echo $sStyleHidden_encabezado; ?>">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pie_pagina_label" id="hidden_field_label_pie_pagina" style="<?php echo $sStyleHidden_pie_pagina; ?>"><span id="id_label_pie_pagina"><?php echo $this->nm_new_label['pie_pagina']; ?></span></TD>
    <TD class="scFormDataOdd css_pie_pagina_line" id="hidden_field_data_pie_pagina" style="<?php echo $sStyleHidden_pie_pagina; ?>">
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_constancias']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_constancias");
 parent.scAjaxDetailHeight("control_constancias", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
