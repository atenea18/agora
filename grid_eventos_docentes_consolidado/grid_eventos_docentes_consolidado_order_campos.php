<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_eventos_docentes_consolidado_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_eventos_docentes_consolidado_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['labels']["nombre"] : "Nombres y Apellidos";
   $tab_ger_campos['docentes_documento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['docentes_documento'] = "docentes_documento";
       $tab_converte["docentes_documento"]   = "docentes_documento";
   }
   else
   {
       $tab_def_campos['docentes_documento'] = "docentes.documento";
       $tab_converte["docentes.documento"]   = "docentes_documento";
   }
   $tab_labels["docentes_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['labels']["docentes_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['labels']["docentes_documento"] : "Documento";
   $tab_ger_campos['firma'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['firma'] = "firma";
       $tab_converte["firma"]   = "firma";
   }
   else
   {
       $tab_def_campos['firma'] = "";
       $tab_converte[""]   = "firma";
   }
   $tab_labels["firma"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['labels']["firma"])) ? $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['labels']["firma"] : "Firma";
   $tab_ger_campos['nombre'] = "none";
   $tab_ger_campos['firma'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_eventos_docentes_consolidado_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_eventos_docentes_consolidado']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
