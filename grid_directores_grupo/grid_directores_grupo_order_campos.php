<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_directores_grupo_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_directores_grupo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['t_grupos_id_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_grupos_id_grupo'] = "t_grupos_id_grupo";
       $tab_converte["t_grupos_id_grupo"]   = "t_grupos_id_grupo";
   }
   else
   {
       $tab_def_campos['t_grupos_id_grupo'] = "t_grupos.id_grupo";
       $tab_converte["t_grupos.id_grupo"]   = "t_grupos_id_grupo";
   }
   $tab_labels["t_grupos_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["t_grupos_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["t_grupos_id_grupo"] : "Id Grupo";
   ...
   $tab_labels["t_grupos_id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["t_grupos_id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["t_grupos_id_grado"] : "Grado";
   ...
   $tab_labels["t_grupos_nombre_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["t_grupos_nombre_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["t_grupos_nombre_grupo"] : "Nombre Grupo";
   ...
   {
       $tab_def_campos['nombre'] = "concat_ws(' ',docentes.primer_apellido,docentes.segundo_apellido,docentes.primer_nombre,docentes.segundo_nombre)";
       $tab_converte["concat_ws(' ',docentes.primer_apellido,docentes.segundo_apellido,docentes.primer_nombre,docentes.segundo_nombre)"]   = "nombre";
   }
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['labels']["nombre"] : "Director de Grupo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_directores_grupo_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_directores_grupo']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
