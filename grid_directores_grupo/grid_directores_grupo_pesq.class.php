...
class grid_directores_grupo_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_directores_grupo_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_directores_grupo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_directores_grupo_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_directores_grupo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_t_grupos_id_grado')
      {
          $t_grupos_id_grado = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_t_grupos_id_grado($t_grupos_id_grado);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_t_grupos_jornada')
      {
          $t_grupos_jornada = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_t_grupos_jornada($t_grupos_jornada);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_t_grupos_id_grado($t_grupos_id_grado)
   {
      $t_grupos_id_grado = substr($this->Db->qstr($t_grupos_id_grado), 1, -1);
            $t_grupos_id_grado_look = substr($this->Db->qstr($t_grupos_id_grado), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct t_grupos.id_grado from " . $this->Ini->nm_tabela . " where  t_grupos.id_grado like '%" . $t_grupos_id_grado . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct t_grupos.id_grado from " . $this->Ini->nm_tabela . " where  t_grupos.id_grado like '%" . $t_grupos_id_grado . "%'"; 
   ...
   function lookup_ajax_t_grupos_nombre_grupo($t_grupos_nombre_grupo)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t_grupos.nombre_grupo from " . $this->Ini->nm_tabela . " where  t_grupos.nombre_grupo like '%" . $t_grupos_nombre_grupo . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_t_grupos_jornada($t_grupos_jornada)
   {
      $t_grupos_jornada = substr($this->Db->qstr($t_grupos_jornada), 1, -1);
            $t_grupos_jornada_look = substr($this->Db->qstr($t_grupos_jornada), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t_grupos.jornada from " . $this->Ini->nm_tabela . " where  t_grupos.jornada like '%" . $t_grupos_jornada . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_directores_grupo/grid_directores_grupo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_directores_grupo_ajax_search.js"></script>
 <script type="text/javascript" src="grid_directores_grupo_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_t_grupos_id_grado_cond#NMF#' + search_get_sel_txt('SC_t_grupos_id_grado_cond') + '@NMF@';
  str_out += 'SC_t_grupos_id_grado#NMF#' + search_get_text('SC_t_grupos_id_grado') + '@NMF@';
  str_out += 'id_ac_t_grupos_id_grado#NMF#' + search_get_text('id_ac_t_grupos_id_grado') + '@NMF@';
  str_out += 'SC_t_grupos_id_grado_input_2#NMF#' + search_get_text('SC_t_grupos_id_grado_input_2') + '@NMF@';
  ...
  str_out += 'SC_t_grupos_jornada_cond#NMF#' + search_get_sel_txt('SC_t_grupos_jornada_cond') + '@NMF@';
  str_out += 'SC_t_grupos_jornada#NMF#' + search_get_text('SC_t_grupos_jornada') + '@NMF@';
  str_out += 'id_ac_t_grupos_jornada#NMF#' + search_get_text('id_ac_t_grupos_jornada') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_t_grupos_id_grado").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_t_grupos_id_grado",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_t_grupos_id_grado").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_t_grupos_id_grado").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_t_grupos_jornada").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_t_grupos_jornada",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_t_grupos_jornada").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_t_grupos_jornada").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $t_grupos_id_grado_cond, $t_grupos_id_grado, $t_grupos_id_grado_input_2, $t_grupos_id_grado_autocomp,
             $t_grupos_nombre_grupo_cond, $t_grupos_nombre_grupo, $t_grupos_nombre_grupo_autocomp,
             $t_grupos_jornada_cond, $t_grupos_jornada, $t_grupos_jornada_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $t_grupos_id_grado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_id_grado']; 
          $t_grupos_id_grado_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_id_grado_input_2']; 
          $t_grupos_id_grado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_id_grado_cond']; 
          $t_grupos_nombre_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_nombre_grupo']; 
          $t_grupos_nombre_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_nombre_grupo_cond']; 
          $t_grupos_jornada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_jornada']; 
          $t_grupos_jornada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_jornada_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['NM_operador']; 
      } 
      if (!isset($t_grupos_id_grado_cond) || empty($t_grupos_id_grado_cond))
      {
         $t_grupos_id_grado_cond = "gt";
      }
      if (!isset($t_grupos_nombre_grupo_cond) || empty($t_grupos_nombre_grupo_cond))
      {
         $t_grupos_nombre_grupo_cond = "qp";
      }
      if (!isset($t_grupos_jornada_cond) || empty($t_grupos_jornada_cond))
      {
         $t_grupos_jornada_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_t_grupos_id_grado = (in_array($t_grupos_id_grado_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_t_grupos_nombre_grupo = (in_array($t_grupos_nombre_grupo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_t_grupos_jornada = (in_array($t_grupos_jornada_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_t_grupos_id_grado = ('bw' == $t_grupos_id_grado_cond) ? $display_aberto : $display_fechado;

      if (!isset($t_grupos_id_grado) || $t_grupos_id_grado == "")
      {
          $t_grupos_id_grado = "";
      }
      if (isset($t_grupos_id_grado) && !empty($t_grupos_id_grado))
      {
      ...
      if (!isset($t_grupos_jornada) || $t_grupos_jornada == "")
      {
          $t_grupos_jornada = "";
      }
      if (isset($t_grupos_jornada) && !empty($t_grupos_jornada))
      {
         $tmp_pos = strpos($t_grupos_jornada, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $t_grupos_jornada = substr($t_grupos_jornada, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_directores_grupo_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['t_grupos_id_grado'])) ? $this->New_label['t_grupos_id_grado'] : "Grado"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_t_grupos_id_grado_cond" name="t_grupos_id_grado_cond" onChange="nm_campos_between(document.getElementById('id_vis_t_grupos_id_grado'), this, 't_grupos_id_grado')">
       <OPTION value="gt" <?php if ("gt" == $t_grupos_id_grado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $t_grupos_id_grado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $t_grupos_id_grado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $t_grupos_id_grado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_t_grupos_id_grado" <?php echo $str_hide_t_grupos_id_grado?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['t_grupos_id_grado'])) ? $this->New_label['t_grupos_id_grado'] : "Grado";
 $nmgp_tab_label .= "t_grupos_id_grado?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $t_grupos_id_grado_look = substr($this->Db->qstr($t_grupos_id_grado), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($t_grupos_id_grado))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct t_grupos.id_grado from " . $this->Ini->nm_tabela . " where t_grupos.id_grado = $t_grupos_id_grado_look"; 
      }
      else
      {
          $nm_comando = "select distinct t_grupos.id_grado from " . $this->Ini->nm_tabela . " where t_grupos.id_grado = $t_grupos_id_grado_look"; 
      ...
      if (isset($nmgp_def_dados[0][$t_grupos_id_grado]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$t_grupos_id_grado];
      }
      else
      {
          $sAutocompValue = $t_grupos_id_grado;
      }
?>
<INPUT  type="text" id="SC_t_grupos_id_grado" name="t_grupos_id_grado" value="<?php echo NM_encode_input($t_grupos_id_grado) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_t_grupos_id_grado" name="t_grupos_id_grado_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_t_grupos_id_grado"  <?php echo $str_display_t_grupos_id_grado; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_t_grupos_id_grado_input_2" name="t_grupos_id_grado_input_2" value="<?php echo NM_encode_input($t_grupos_id_grado_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
      $t_grupos_nombre_grupo_look = substr($this->Db->qstr($t_grupos_nombre_grupo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t_grupos.nombre_grupo from " . $this->Ini->nm_tabela . " where t_grupos.nombre_grupo = '$t_grupos_nombre_grupo_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_t_grupos_nombre_grupo" name="t_grupos_nombre_grupo_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['t_grupos_jornada'])) ? $this->New_label['t_grupos_jornada'] : "Jornada"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_t_grupos_jornada_cond" name="t_grupos_jornada_cond" onChange="nm_campos_between(document.getElementById('id_vis_t_grupos_jornada'), this, 't_grupos_jornada')">
       <OPTION value="qp" <?php if ("qp" == $t_grupos_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $t_grupos_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $t_grupos_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $t_grupos_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_t_grupos_jornada" <?php echo $str_hide_t_grupos_jornada?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['t_grupos_jornada'])) ? $this->New_label['t_grupos_jornada'] : "Jornada";
 $nmgp_tab_label .= "t_grupos_jornada?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $t_grupos_jornada_look = substr($this->Db->qstr($t_grupos_jornada), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t_grupos.jornada from " . $this->Ini->nm_tabela . " where t_grupos.jornada = '$t_grupos_jornada_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$t_grupos_jornada]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$t_grupos_jornada];
      }
      else
      {
          $sAutocompValue = $t_grupos_jornada;
      }
?>
<INPUT  type="text" id="SC_t_grupos_jornada" name="t_grupos_jornada" value="<?php echo NM_encode_input($t_grupos_jornada) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_t_grupos_jornada" name="t_grupos_jornada_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_directores_grupo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_directores_grupo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_t_grupos_id_grado'), document.F1.t_grupos_id_grado_cond, 't_grupos_id_grado');
   document.F1.t_grupos_id_grado.value = "";
   document.F1.t_grupos_id_grado_autocomp.value = "";
   document.F1.t_grupos_id_grado_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_t_grupos_jornada'), document.F1.t_grupos_jornada_cond, 't_grupos_jornada');
   document.F1.t_grupos_jornada.value = "";
   document.F1.t_grupos_jornada_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_directores_grupo";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_directores_grupo/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_t_grupos_id_grado_cond'] = 'cond';
      $tp_fields['SC_t_grupos_id_grado'] = 'text_aut';
      $tp_fields['id_ac_t_grupos_id_grado'] = 'text_aut';
      $tp_fields['SC_t_grupos_id_grado_input_2'] = 'text';
      ...
      $tp_fields['SC_t_grupos_jornada_cond'] = 'cond';
      $tp_fields['SC_t_grupos_jornada'] = 'text_aut';
      $tp_fields['id_ac_t_grupos_jornada'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $t_grupos_id_grado_cond, $t_grupos_id_grado, $t_grupos_id_grado_input_2, $t_grupos_id_grado_autocomp,
             $t_grupos_nombre_grupo_cond, $t_grupos_nombre_grupo, $t_grupos_nombre_grupo_autocomp,
             $t_grupos_jornada_cond, $t_grupos_jornada, $t_grupos_jornada_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($t_grupos_id_grado_autocomp) && empty($t_grupos_id_grado))
      {
          $t_grupos_id_grado = $t_grupos_id_grado_autocomp;
      }
      if (!empty($t_grupos_nombre_grupo_autocomp) && empty($t_grupos_nombre_grupo))
      {
          $t_grupos_nombre_grupo = $t_grupos_nombre_grupo_autocomp;
      }
      if (!empty($t_grupos_jornada_autocomp) && empty($t_grupos_jornada))
      {
          $t_grupos_jornada = $t_grupos_jornada_autocomp;
      }
      $t_grupos_id_grado_cond_salva = $t_grupos_id_grado_cond; 
      if (!isset($t_grupos_id_grado_input_2) || $t_grupos_id_grado_input_2 == "")
      {
          $t_grupos_id_grado_input_2 = $t_grupos_id_grado;
      }
      ...
      $t_grupos_jornada_cond_salva = $t_grupos_jornada_cond; 
      if (!isset($t_grupos_jornada_input_2) || $t_grupos_jornada_input_2 == "")
      {
          $t_grupos_jornada_input_2 = $t_grupos_jornada;
      }
      if ($t_grupos_id_grado_cond != "in")
      {
          nm_limpa_numero($t_grupos_id_grado, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $t_grupos_id_grado);
          ...
          $t_grupos_id_grado = implode(",", $Nm_sc_valores);
      }
      if ($t_grupos_id_grado_cond != "in")
      {
          nm_limpa_numero($t_grupos_id_grado_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_id_grado'] = $t_grupos_id_grado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_id_grado_input_2'] = $t_grupos_id_grado_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_id_grado_cond'] = $t_grupos_id_grado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_nombre_grupo'] = $t_grupos_nombre_grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_nombre_grupo_cond'] = $t_grupos_nombre_grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_jornada'] = $t_grupos_jornada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['t_grupos_jornada_cond'] = $t_grupos_jornada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($t_grupos_id_grado_cond != "in" && $t_grupos_id_grado_cond != "bw" && !empty($t_grupos_id_grado) && !is_numeric($t_grupos_id_grado))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Grado";
      }
      if ($t_grupos_id_grado_cond == "bw" && ((!empty($t_grupos_id_grado) && !is_numeric($t_grupos_id_grado)) || (!empty($t_grupos_id_grado_input_2) && !is_numeric($t_grupos_id_grado_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Grado";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['t_grupos_id_grado'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['t_grupos_id_grado'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['t_grupos_id_grado'] = $t_grupos_id_grado;
      }
      $Conteudo = $t_grupos_id_grado_input_2;
      if (strtoupper($t_grupos_id_grado_cond) != "II" && strtoupper($t_grupos_id_grado_cond) != "QP" && strtoupper($t_grupos_id_grado_cond) != "NP" && strtoupper($t_grupos_id_grado_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['t_grupos_id_grado_input_2'] = $Conteudo;
      $t_grupos_nombre_grupo_look = substr($this->Db->qstr($t_grupos_nombre_grupo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t_grupos.nombre_grupo from " . $this->Ini->nm_tabela . " where t_grupos.nombre_grupo = '$t_grupos_nombre_grupo_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['t_grupos_jornada'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['t_grupos_jornada'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['t_grupos_jornada'] = $t_grupos_jornada;
      }

      //----- $t_grupos_id_grado
      $this->Date_part = false;
      if (isset($t_grupos_id_grado) || $t_grupos_id_grado_cond == "nu" || $t_grupos_id_grado_cond == "nn" || $t_grupos_id_grado_cond == "ep" || $t_grupos_id_grado_cond == "ne")
      {
         $this->monta_condicao("t_grupos.id_grado", $t_grupos_id_grado_cond, $t_grupos_id_grado, $t_grupos_id_grado_input_2, "t_grupos_id_grado");
      }
      ...
      //----- $t_grupos_jornada
      $this->Date_part = false;
      if (isset($t_grupos_jornada) || $t_grupos_jornada_cond == "nu" || $t_grupos_jornada_cond == "nn" || $t_grupos_jornada_cond == "ep" || $t_grupos_jornada_cond == "ne")
      {
         $this->monta_condicao("t_grupos.jornada", $t_grupos_jornada_cond, $t_grupos_jornada, "", "t_grupos_jornada");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_directores_grupo']['where_pesq_ant'] = $this->comando . $this->comando_fim;
