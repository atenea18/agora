...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "t_grupos_id_grupo";$Nm_numeric[] = "t_grupos_id_grado";$Nm_numeric[] = "t_grupos_id_grupo";$Nm_numeric[] = "t_grupos_id_grado";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_t_grupos_id_grado"  <?php echo $str_hide_t_grupos_id_grado?>><?php
      $t_grupos_id_grado_look = substr($this->Db->qstr($t_grupos_id_grado), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_t_grupos_id_grado" name="t_grupos_id_grado_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_t_grupos_id_grado"  <?php echo $str_display_t_grupos_id_grado; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_t_grupos_id_grado_input_2" name="t_grupos_id_grado_input_2" value="<?php echo NM_encode_input($t_grupos_id_grado_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_t_grupos_jornada"  <?php echo $str_hide_t_grupos_jornada?>><?php
      $t_grupos_jornada_look = substr($this->Db->qstr($t_grupos_jornada), 1, -1); 
      $nmgp_def_dados = array(); 
