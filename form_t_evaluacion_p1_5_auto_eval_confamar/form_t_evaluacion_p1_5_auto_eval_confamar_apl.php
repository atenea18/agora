<?php
//
class form_t_evaluacion_p1_5_auto_eval_confamar_apl
{
   ...
   var $form_vert_form_t_evaluacion_p1_5_auto_eval_confamar = array();
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_t_evaluacion_p1_5_auto_eval_confamar($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idgrupo)) 
          {
              $_SESSION['par_idgrupo'] = $this->par_idgrupo;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_t_evaluacion_p1_5_auto_eval_confamar_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['initialize'])
          {
              $_SESSION['scriptcase']['form_t_evaluacion_p1_5_auto_eval_confamar']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_par_idgrupo)) {$this->sc_temp_par_idgrupo = (isset($_SESSION['par_idgrupo'])) ? $_SESSION['par_idgrupo'] : "";}
                                       $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'] = 'on';
$_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'] = 'off';$this->parametrosGenerales();
     ...
     $nm_select = $update_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         if ($rf === false)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                form_t_evaluacion_p1_5_auto_eval_confamar_pack_ajax_response();
             }
             exit;
         }
         $rf->Close();
...
$_SESSION['scriptcase']['form_t_evaluacion_p1_5_auto_eval_confamar']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_t_evaluacion_p1_5_auto_eval_confamar']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_t_evaluacion_p1_5_auto_eval_confamar'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p1_5_auto_eval_confamar']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p1_5_auto_eval_confamar']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_t_evaluacion_p1_5_auto_eval_confamar') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p1_5_auto_eval_confamar']['label'] = "ASIGNATURA:  " . $_SESSION['asigna'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_t_evaluacion_p1_5_auto_eval_confamar")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_view'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['prt_view'] = false;
      if ($this->nmgp_opcao == "pdf" || $this->nmgp_opcao == "print")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_view'] = true;
          if ($this->nmgp_opcao == "print")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['prt_view'] = true;
          } 
          $this->nmgp_opcao = "igual";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao'] = "igual";
      } 
      $this->Db = $this->Ini->Db; 
      ...
      $_SESSION['scriptcase']['error_icon']['form_t_evaluacion_p1_5_auto_eval_confamar']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_t_evaluacion_p1_5_auto_eval_confamar'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_orig'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura= " . $_SESSION['par_id_asignatura'] . " AND entorno = " . $_SESSION['entorno'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_pesq'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura= " . $_SESSION['par_id_asignatura'] . " AND entorno = " . $_SESSION['entorno'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_auto_eval_confamar']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['exit'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_t_evaluacion_p1_5_auto_eval_confamar", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_t_evaluacion_p1_5_auto_eval_confamar_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_t_evaluacion_p1_5_auto_eval_confamar_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_t_evaluacion_p1_5_auto_eval_confamar/form_t_evaluacion_p1_5_auto_eval_confamar_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_t_evaluacion_p1_5_auto_eval_confamar_erro.class.php"); 
      }
      $this->Erro      = new form_t_evaluacion_p1_5_auto_eval_confamar_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao']))
         { 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['final'];
      }
      else
      {
      }
...
//
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar']) || !is_array($this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar'][] = $this->Campos_Mens_erro;
                  }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_atualiz'] == "ok")
          {
      ...
      { 
         ...
         if (isset($this->aeep1_)) { $this->nm_limpa_alfa($this->aeep1_); }
         if (isset($this->porcent_aeep1_)) { $this->nm_limpa_alfa($this->porcent_aeep1_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_estudiante_'] =  $this->id_estudiante_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['estatus_'] =  $this->estatus_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['novedad_'] =  $this->novedad_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['asienta_inasistencias_'] =  $this->asienta_inasistencias_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['inasistencia_p1_'] =  $this->inasistencia_p1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['eval_1_per_'] =  $this->eval_1_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc1_'] =  $this->dc1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc2_'] =  $this->dc2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc3_'] =  $this->dc3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc4_'] =  $this->dc4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc5_'] =  $this->dc5_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc6_'] =  $this->dc6_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dc_'] =  $this->pcent_dc_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp1_'] =  $this->dp1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp2_'] =  $this->dp2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp3_'] =  $this->dp3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp4_'] =  $this->dp4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp5_'] =  $this->dp5_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dp_'] =  $this->pcent_dp_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds1_'] =  $this->ds1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds2_'] =  $this->ds2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds3_'] =  $this->ds3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds4_'] =  $this->ds4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds5_'] =  $this->ds5_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_ds_'] =  $this->pcent_ds_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['aeep1_'] =  $this->aeep1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['porcent_aeep1_'] =  $this->porcent_aeep1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['primer_apellido_'] =  $this->primer_apellido_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['segundo_apellido_'] =  $this->segundo_apellido_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['primer_nombre_'] =  $this->primer_nombre_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['segundo_nombre_'] =  $this->segundo_nombre_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_grupo_'] =  $this->id_grupo_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_area_'] =  $this->id_area_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_asignatura_'] =  $this->id_asignatura_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_grado_'] =  $this->id_grado_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_nivel_'] =  $this->id_nivel_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ihs_'] =  $this->ihs_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pfa_'] =  $this->pfa_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['tipo_asig_'] =  $this->tipo_asig_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc7_'] =  $this->dc7_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc8_'] =  $this->dc8_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc9_'] =  $this->dc9_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc10_'] =  $this->dc10_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc11_'] =  $this->dc11_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc12_'] =  $this->dc12_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['letras_p1_'] =  $this->letras_p1_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['inasistencia_p2_'] =  $this->inasistencia_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['eval_2_per_'] =  $this->eval_2_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc1_2p_'] =  $this->dc1_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc2_2p_'] =  $this->dc2_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc3_2p_'] =  $this->dc3_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc4_2p_'] =  $this->dc4_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc5_2p_'] =  $this->dc5_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dc2_'] =  $this->pcent_dc2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds1_2p_'] =  $this->ds1_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds2_2p_'] =  $this->ds2_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds3_2p_'] =  $this->ds3_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds4_2p_'] =  $this->ds4_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds5_2p_'] =  $this->ds5_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_ds2_'] =  $this->pcent_ds2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp1_2p_'] =  $this->dp1_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp2_2p_'] =  $this->dp2_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp3_2p_'] =  $this->dp3_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp4_2p_'] =  $this->dp4_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp5_2p_'] =  $this->dp5_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dp2_'] =  $this->pcent_dp2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['aee_p2_'] =  $this->aee_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['letras_p2_'] =  $this->letras_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['porcet_aee_p2_'] =  $this->porcet_aee_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['inasistencia_p3_'] =  $this->inasistencia_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['eval_3_per_'] =  $this->eval_3_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc1_3p_'] =  $this->dc1_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc2_3p_'] =  $this->dc2_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc3_3p_'] =  $this->dc3_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc4_3p_'] =  $this->dc4_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc5_3p_'] =  $this->dc5_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dc3_'] =  $this->pcent_dc3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds1_p3_'] =  $this->ds1_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds2_p3_'] =  $this->ds2_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds3_p3_'] =  $this->ds3_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds4_p3_'] =  $this->ds4_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds5_p3_'] =  $this->ds5_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_ds3_'] =  $this->pcent_ds3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp1_p3_'] =  $this->dp1_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp2_p3_'] =  $this->dp2_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp3_p3_'] =  $this->dp3_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp4_p3_'] =  $this->dp4_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['sc_field_0_'] =  $this->sc_field_0_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dp3_'] =  $this->pcent_dp3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['aee_p3_'] =  $this->aee_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['letras_p3_'] =  $this->letras_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['porcent_aee_p3_'] =  $this->porcent_aee_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['inasistencia_p4_'] =  $this->inasistencia_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['eval_4_per_'] =  $this->eval_4_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc1_p4_'] =  $this->dc1_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc2_p4_'] =  $this->dc2_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc3_p4_'] =  $this->dc3_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc4_p4_'] =  $this->dc4_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dc5_p4_'] =  $this->dc5_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dc4_'] =  $this->pcent_dc4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds1_p4_'] =  $this->ds1_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds2_p4_'] =  $this->ds2_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds3_p4_'] =  $this->ds3_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds4_p4_'] =  $this->ds4_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['ds5_p4_'] =  $this->ds5_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_ds4_'] =  $this->pcent_ds4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp1_p4_'] =  $this->dp1_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp2_p4_'] =  $this->dp2_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp3_p4_'] =  $this->dp3_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp4_p4_'] =  $this->dp4_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['dp5_p4_'] =  $this->dp5_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['aee_p4_'] =  $this->aee_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['letras_p4_'] =  $this->letras_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['porcent_aee_p4_'] =  $this->porcent_aee_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['pcent_dp4_'] =  $this->pcent_dp4_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['eval_final_'] =  $this->eval_final_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['entorno_'] =  $this->entorno_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['nom_grupo_'] =  $this->nom_grupo_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_view'])
      { 
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['prt_view'] && in_array(trim($this->Ini->str_lang), $this->Ini->nm_font_ttf) && strtolower($_SESSION['scriptcase']['charset']) != "utf-8")
          { 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//--------------------------------------------------------------------------------------
   function NM_pdf_output()
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_view'])
      { 
          $arq_pdf_in = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_form_t_evaluacion_p1_5_auto_eval_confamar_html_" . session_id() . ".html";
          $url_pdf_in = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_form_t_evaluacion_p1_5_auto_eval_confamar_html_" . session_id() . ".html";
          $str_htm    =  ob_get_contents();
          ob_end_clean();
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['prt_view'])
          { 
              echo $str_htm ;
              exit;
          } 
          ...
          fclose($arq_htm);
          $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "form_t_evaluacion_p1_5_auto_eval_confamar";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_name']))
          {
              $nm_arquivo_pdf_base = str_replace(".pdf", "", $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_name']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_name']);
          }
          ...
          $NM_tit_doc = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['pdf_name'] : "form_t_evaluacion_p1_5_auto_eval_confamar";
...
<form name="Fdown" method="get" action="form_t_evaluacion_p1_5_auto_eval_confamar_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_t_evaluacion_p1_5_auto_eval_confamar"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_auto_eval_confamar'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_estudiante_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['php_cmp_required']['id_estudiante_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['php_cmp_required']['id_estudiante_'] == "on"))
      {
          ...
          if (!empty($this->id_estudiante_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_']) && !in_array($this->id_estudiante_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_']))
          {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['id_estudiante_']['keyVal'] = form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string($this->nmgp_dados_form['id_estudiante_']);
              $this->NM_ajax_info['fldList']['id_grupo_']['keyVal'] = form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string($this->nmgp_dados_form['id_grupo_']);
              $this->NM_ajax_info['fldList']['id_asignatura_']['keyVal'] = form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string($this->nmgp_dados_form['id_asignatura_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['id_estudiante_'] = $this->id_estudiante_;
                  }
                  if (isset($this->NM_ajax_changed['estatus_']) && $this->NM_ajax_changed['estatus_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['estatus_'] = $this->estatus_;
                  }
                  if (isset($this->NM_ajax_changed['novedad_']) && $this->NM_ajax_changed['novedad_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['novedad_'] = $this->novedad_;
                  }
                  if (isset($this->NM_ajax_changed['asienta_inasistencias_']) && $this->NM_ajax_changed['asienta_inasistencias_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['asienta_inasistencias_'] = $this->asienta_inasistencias_;
                  }
                  if (isset($this->NM_ajax_changed['inasistencia_p1_']) && $this->NM_ajax_changed['inasistencia_p1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['inasistencia_p1_'] = $this->inasistencia_p1_;
                  }
                  if (isset($this->NM_ajax_changed['eval_1_per_']) && $this->NM_ajax_changed['eval_1_per_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['eval_1_per_'] = $this->eval_1_per_;
                  }
                  if (isset($this->NM_ajax_changed['dc1_']) && $this->NM_ajax_changed['dc1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dc1_'] = $this->dc1_;
                  }
                  if (isset($this->NM_ajax_changed['dc2_']) && $this->NM_ajax_changed['dc2_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dc2_'] = $this->dc2_;
                  }
                  if (isset($this->NM_ajax_changed['dc3_']) && $this->NM_ajax_changed['dc3_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dc3_'] = $this->dc3_;
                  }
                  if (isset($this->NM_ajax_changed['dc4_']) && $this->NM_ajax_changed['dc4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dc4_'] = $this->dc4_;
                  }
                  if (isset($this->NM_ajax_changed['dc5_']) && $this->NM_ajax_changed['dc5_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dc5_'] = $this->dc5_;
                  }
                  if (isset($this->NM_ajax_changed['dc6_']) && $this->NM_ajax_changed['dc6_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dc6_'] = $this->dc6_;
                  }
                  if (isset($this->NM_ajax_changed['pcent_dc_']) && $this->NM_ajax_changed['pcent_dc_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['pcent_dc_'] = $this->pcent_dc_;
                  }
                  if (isset($this->NM_ajax_changed['dp1_']) && $this->NM_ajax_changed['dp1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dp1_'] = $this->dp1_;
                  }
                  if (isset($this->NM_ajax_changed['dp2_']) && $this->NM_ajax_changed['dp2_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dp2_'] = $this->dp2_;
                  }
                  if (isset($this->NM_ajax_changed['dp3_']) && $this->NM_ajax_changed['dp3_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dp3_'] = $this->dp3_;
                  }
                  if (isset($this->NM_ajax_changed['dp4_']) && $this->NM_ajax_changed['dp4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dp4_'] = $this->dp4_;
                  }
                  if (isset($this->NM_ajax_changed['dp5_']) && $this->NM_ajax_changed['dp5_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['dp5_'] = $this->dp5_;
                  }
                  if (isset($this->NM_ajax_changed['pcent_dp_']) && $this->NM_ajax_changed['pcent_dp_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['pcent_dp_'] = $this->pcent_dp_;
                  }
                  if (isset($this->NM_ajax_changed['ds1_']) && $this->NM_ajax_changed['ds1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['ds1_'] = $this->ds1_;
                  }
                  if (isset($this->NM_ajax_changed['ds2_']) && $this->NM_ajax_changed['ds2_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['ds2_'] = $this->ds2_;
                  }
                  if (isset($this->NM_ajax_changed['ds3_']) && $this->NM_ajax_changed['ds3_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['ds3_'] = $this->ds3_;
                  }
                  if (isset($this->NM_ajax_changed['ds4_']) && $this->NM_ajax_changed['ds4_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['ds4_'] = $this->ds4_;
                  }
                  if (isset($this->NM_ajax_changed['ds5_']) && $this->NM_ajax_changed['ds5_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['ds5_'] = $this->ds5_;
                  }
                  if (isset($this->NM_ajax_changed['pcent_ds_']) && $this->NM_ajax_changed['pcent_ds_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['pcent_ds_'] = $this->pcent_ds_;
                  }
                  if (isset($this->NM_ajax_changed['aeep1_']) && $this->NM_ajax_changed['aeep1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['aeep1_'] = $this->aeep1_;
                  }
                  if (isset($this->NM_ajax_changed['porcent_aeep1_']) && $this->NM_ajax_changed['porcent_aeep1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$this->nmgp_refresh_row]['porcent_aeep1_'] = $this->porcent_aeep1_;
                  }
              }
          }
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar);
          foreach($this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar as $sc_seq_vert => $aRecData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['Lookup_id_estudiante_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_estudiante_' . $sc_seq_vert]['valList'][$i] = form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string($v);
          }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_sc_btn_0_id_grado'] = $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_grado_']);
       $this->NM_ajax_info['btnVars']['var_btn_sc_btn_0_id_grupo'] = $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_grupo_']);
       $this->NM_ajax_info['btnVars']['var_btn_sc_btn_0_id_asign'] = $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_asignatura_']);
       $this->NM_ajax_info['btnVars']['var_btn_sc_btn_0_par_idgrupo'] = $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_grupo_']);
       $this->NM_ajax_info['btnVars']['var_btn_sc_btn_0_par_asign'] = $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_asignatura_']);
       $this->NM_ajax_info['btnVars']['var_btn_sc_btn_0_par_idgrado'] = $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_grado_']);
   } // ajax_add_parameters
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['id_estudiante_'] = $this->id_estudiante_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['estatus_'] = $this->estatus_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['novedad_'] = $this->novedad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['inasistencia_p1_'] = $this->inasistencia_p1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['eval_1_per_'] = $this->eval_1_per_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dc1_'] = $this->dc1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dc2_'] = $this->dc2_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dc3_'] = $this->dc3_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dc4_'] = $this->dc4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dc5_'] = $this->dc5_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dc6_'] = $this->dc6_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['pcent_dc_'] = $this->pcent_dc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dp1_'] = $this->dp1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dp2_'] = $this->dp2_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dp3_'] = $this->dp3_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dp4_'] = $this->dp4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['dp5_'] = $this->dp5_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['pcent_dp_'] = $this->pcent_dp_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['ds1_'] = $this->ds1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['ds2_'] = $this->ds2_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['ds3_'] = $this->ds3_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['ds4_'] = $this->ds4_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['ds5_'] = $this->ds5_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['pcent_ds_'] = $this->pcent_ds_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['aeep1_'] = $this->aeep1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert]['porcent_aeep1_'] = $this->porcent_aeep1_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->letras_p4_ = $this->letras_p4__before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['db_changed'] = true;
      ...
      { 
          ...
          { 
              ...
              $this->sc_evento = "insert"; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_I_E']++; 
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total'] + 1; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
...
ORDER BY nombre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_t_evaluacion_p1_5_auto_eval_confamar_pack_protect_string(NM_charset_to_utf8($this->id_estudiante_)))
              {
          ...
          $sTmpImgHtml = "<a href=\"javascript:nm_gp_submit('" . $this->Ini->link_form_inasistencias_edit . "', '$this->nm_location', 'par_idstudents?#?" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_estudiante_'] . "?@?par_id_grado?#?" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_grupo_'] . "?@?par_id_grupo?#?" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_grupo_'] . "?@?par_id_asignatura?#?" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_form'][$sc_seq_vert]['id_asignatura_'] . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?S?@?', '', '_self', '0', '0', 'form_inasistencias')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $asienta_inasistencias_ . "</font></a>";
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['parms'] = "id_estudiante_?#?$this->id_estudiante_?@?id_grupo_?#?$this->id_grupo_?@?id_asignatura_?#?$this->id_asignatura_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_auto_eval_confamar']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['parms'] = ""; 
      } 
      if ($this->sc_teve_excl)
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter'] . ")";
          }
      }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']))
          {
              ...
              $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total'] = $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_estudiante_) && !empty($this->id_grupo_) && !empty($this->id_asignatura_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] > $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = ($qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['ordem_ord']; 
      } 
      ...
      else
      {
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start']) ; 
              } 
              else  
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['parms'] = "id_estudiante_?#?$this->id_estudiante_?@?id_grupo_?#?$this->id_grupo_?@?id_asignatura_?#?$this->id_asignatura_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['id_estudiante_'] =  $this->id_estudiante_; 
             $this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar[$sc_seq_vert]['estatus_'] =  $this->estatus_; 
          ...
          ksort ($this->form_vert_form_t_evaluacion_p1_5_auto_eval_confamar); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] < (($qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['reg_start'] + $this->sc_max_reg;
...
if ($this->dc1_  > $this->sc_temp_nota_maxima || $this->dc2_  > $this->sc_temp_nota_maxima || $this->dc3_  > $this->sc_temp_nota_maxima|| $this->dc4_  > $this->sc_temp_nota_maxima|| $this->dc5_  > $this->sc_temp_nota_maxima|| $this->dc6_  > $this->sc_temp_nota_maxima ||$this->ds1_ > $this->sc_temp_nota_maxima||$this->ds2_ > $this->sc_temp_nota_maxima||$this->ds3_ > $this->sc_temp_nota_maxima||$this->ds4_ > $this->sc_temp_nota_maxima||$this->ds5_ > $this->sc_temp_nota_maxima||$this->dp1_ > $this->sc_temp_nota_maxima||$this->dp2_2p_  > $this->sc_temp_nota_maxima||$this->dp3_ > $this->sc_temp_nota_maxima||$this->dp4_ > $this->sc_temp_nota_maxima||$this->dp5_ > $this->sc_temp_nota_maxima )
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_t_evaluacion_p1_5_auto_eval_confamar' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter_form'] . " and (id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura= " . $_SESSION['par_id_asignatura'] . " AND entorno = " . $_SESSION['entorno'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['total'] = $qt_geral_reg_form_t_evaluacion_p1_5_auto_eval_confamar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_t_evaluacion_p1_5_auto_eval_confamar_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_t_evaluacion_p1_5_auto_eval_confamar_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_t_evaluacion_p1_5_auto_eval_confamar_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_auto_eval_confamar']['masterValue'] as $cmp_master => $val_master)
{
?>
