...
<?php
include_once("form_students_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_students_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['recarga'];
}
?>
...
<?php
 include_once("form_students_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_students_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_students_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_students_mob_form0";
</script>
<ul class="scTabLine">
<?php
    if ($nmgp_num_form == "form_students_mob_form0")
    {
...
?>
   <li id="id_form_students_mob_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_students_mob_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__user2_24.png" align="absmiddle">
     Identificación
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_students_mob_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_students_mob_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_students_mob_form1')">
     Salud y Programas Especiales
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_students_mob_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_students_mob_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_students_mob_form2')">
     Economía y Territorialidad
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_students_mob_form3")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_students_mob_form3" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_students_mob_form3')">
     Capacidades Discapacidades
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_students_mob_form4")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_students_mob_form4" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_students_mob_form4')">
     Novedades
    </a>
   </li>
</ul>
...
<div id="form_students_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus'][] = 'N'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus'][] = 'C'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_genero'][] = 'M'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_genero'][] = 'F'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_zona'][] = 'Rural'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_zona'][] = 'Urbana'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'null'; ?>
 <option value="null">Seleccione</option>
 <option value="A" <?php  if ($this->resultado == "A") { echo " selected" ;} ?>>Aprobado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'A'; ?>
 <option value="R" <?php  if ($this->resultado == "R") { echo " selected" ;} ?>>Reprobado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'R'; ?>
 <option value="D" <?php  if ($this->resultado == "D") { echo " selected" ;} ?>>Desertó</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'D'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_subsidado'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_subsidado'][] = 'N'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_interno'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_interno'][] = 'N'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_otro_modelo'][] = 'N1'; ?>
 <option value="N2" <?php  if ($this->otro_modelo == "N2") { echo " selected" ;} ?>>Nivel II</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_otro_modelo'][] = 'N2'; ?>
 <option value="OM" <?php  if ($this->otro_modelo == "OM") { echo " selected" ;} ?>>Otro Modelo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_otro_modelo'][] = 'OM'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_caracter'][] = 'A'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_caracter'][] = 'T'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'NULL'; ?>
 <option value="C" <?php  if ($this->especialidad == "C") { echo " selected" ;} ?>>Comercial</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'C'; ?>
 <option value="A" <?php  if ($this->especialidad == "A") { echo " selected" ;} ?>>Agropecuario</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'A'; ?>
 <option value="T" <?php  if ($this->especialidad == "T") { echo " selected" ;} ?>>Turismo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'T'; ?>
 <option value="N" <?php  if ($this->especialidad == "N") { echo " selected" ;} ?>>Normalista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'N'; ?>
 <option value="I" <?php  if ($this->especialidad == "I") { echo " selected" ;} ?>>Industrial</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'I'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_year_mat'][] = '2017'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_matricular'][] = '1'; ?>
 <option value="2" <?php  if ($this->matricular == "2") { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_matricular'][] = '2'; ?>
 </select></span>
</span><?php  }?>
