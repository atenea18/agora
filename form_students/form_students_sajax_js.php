  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_students" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate estatus
  function do_ajax_form_students_validate_estatus()
  {
    var nomeCampo_estatus = "estatus";
    var var_estatus = scAjaxGetFieldRadio(nomeCampo_estatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_estatus(var_estatus, var_script_case_init, do_ajax_form_students_validate_estatus_cb);
  } // do_ajax_form_students_validate_estatus

  function do_ajax_form_students_validate_estatus_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_estatus_cb

  // ---------- Validate fecha_matricula
  function do_ajax_form_students_validate_fecha_matricula()
  {
    var nomeCampo_fecha_matricula = "fecha_matricula";
    var var_fecha_matricula = scAjaxGetFieldText(nomeCampo_fecha_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_fecha_matricula(var_fecha_matricula, var_script_case_init, do_ajax_form_students_validate_fecha_matricula_cb);
  } // do_ajax_form_students_validate_fecha_matricula

  function do_ajax_form_students_validate_fecha_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_fecha_matricula_cb

  // ---------- Validate genero
  function do_ajax_form_students_validate_genero()
  {
    var nomeCampo_genero = "genero";
    var var_genero = scAjaxGetFieldRadio(nomeCampo_genero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_genero(var_genero, var_script_case_init, do_ajax_form_students_validate_genero_cb);
  } // do_ajax_form_students_validate_genero

  function do_ajax_form_students_validate_genero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "genero";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_genero_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_students_validate_fecha_nacimiento()
  {
    var nomeCampo_fecha_nacimiento = "fecha_nacimiento";
    var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_form_students_validate_fecha_nacimiento_cb);
  } // do_ajax_form_students_validate_fecha_nacimiento

  function do_ajax_form_students_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_fecha_nacimiento_cb

  // ---------- Validate primer_apellido
  function do_ajax_form_students_validate_primer_apellido()
  {
    var nomeCampo_primer_apellido = "primer_apellido";
    var var_primer_apellido = scAjaxGetFieldText(nomeCampo_primer_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_primer_apellido(var_primer_apellido, var_script_case_init, do_ajax_form_students_validate_primer_apellido_cb);
  } // do_ajax_form_students_validate_primer_apellido

  function do_ajax_form_students_validate_primer_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_primer_apellido_cb

  // ---------- Validate segundo_apellido
  function do_ajax_form_students_validate_segundo_apellido()
  {
    var nomeCampo_segundo_apellido = "segundo_apellido";
    var var_segundo_apellido = scAjaxGetFieldText(nomeCampo_segundo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_segundo_apellido(var_segundo_apellido, var_script_case_init, do_ajax_form_students_validate_segundo_apellido_cb);
  } // do_ajax_form_students_validate_segundo_apellido

  function do_ajax_form_students_validate_segundo_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_segundo_apellido_cb

  // ---------- Validate primer_nombre
  function do_ajax_form_students_validate_primer_nombre()
  {
    var nomeCampo_primer_nombre = "primer_nombre";
    var var_primer_nombre = scAjaxGetFieldText(nomeCampo_primer_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_primer_nombre(var_primer_nombre, var_script_case_init, do_ajax_form_students_validate_primer_nombre_cb);
  } // do_ajax_form_students_validate_primer_nombre

  function do_ajax_form_students_validate_primer_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_primer_nombre_cb

  // ---------- Validate segundo_nombre
  function do_ajax_form_students_validate_segundo_nombre()
  {
    var nomeCampo_segundo_nombre = "segundo_nombre";
    var var_segundo_nombre = scAjaxGetFieldText(nomeCampo_segundo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_segundo_nombre(var_segundo_nombre, var_script_case_init, do_ajax_form_students_validate_segundo_nombre_cb);
  } // do_ajax_form_students_validate_segundo_nombre

  function do_ajax_form_students_validate_segundo_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_segundo_nombre_cb

  // ---------- Validate tipo_identificacion
  function do_ajax_form_students_validate_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_tipo_identificacion(var_tipo_identificacion, var_script_case_init, do_ajax_form_students_validate_tipo_identificacion_cb);
  } // do_ajax_form_students_validate_tipo_identificacion

  function do_ajax_form_students_validate_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_tipo_identificacion_cb

  // ---------- Validate numero_documento
  function do_ajax_form_students_validate_numero_documento()
  {
    var nomeCampo_numero_documento = "numero_documento";
    var var_numero_documento = scAjaxGetFieldText(nomeCampo_numero_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_numero_documento(var_numero_documento, var_script_case_init, do_ajax_form_students_validate_numero_documento_cb);
  } // do_ajax_form_students_validate_numero_documento

  function do_ajax_form_students_validate_numero_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_numero_documento_cb

  // ---------- Validate departanebti_expedicion
  function do_ajax_form_students_validate_departanebti_expedicion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_departanebti_expedicion(var_departanebti_expedicion, var_script_case_init, do_ajax_form_students_validate_departanebti_expedicion_cb);
  } // do_ajax_form_students_validate_departanebti_expedicion

  function do_ajax_form_students_validate_departanebti_expedicion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_departanebti_expedicion_cb

  // ---------- Validate municipio_expedicion
  function do_ajax_form_students_validate_municipio_expedicion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_municipio_expedicion(var_municipio_expedicion, var_script_case_init, do_ajax_form_students_validate_municipio_expedicion_cb);
  } // do_ajax_form_students_validate_municipio_expedicion

  function do_ajax_form_students_validate_municipio_expedicion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_municipio_expedicion_cb

  // ---------- Validate firstname
  function do_ajax_form_students_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_firstname(var_firstname, var_script_case_init, do_ajax_form_students_validate_firstname_cb);
  } // do_ajax_form_students_validate_firstname

  function do_ajax_form_students_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_form_students_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_lastname(var_lastname, var_script_case_init, do_ajax_form_students_validate_lastname_cb);
  } // do_ajax_form_students_validate_lastname

  function do_ajax_form_students_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_lastname_cb

  // ---------- Validate anos_cumplidos
  function do_ajax_form_students_validate_anos_cumplidos()
  {
    var nomeCampo_anos_cumplidos = "anos_cumplidos";
    var var_anos_cumplidos = scAjaxGetFieldText(nomeCampo_anos_cumplidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_anos_cumplidos(var_anos_cumplidos, var_script_case_init, do_ajax_form_students_validate_anos_cumplidos_cb);
  } // do_ajax_form_students_validate_anos_cumplidos

  function do_ajax_form_students_validate_anos_cumplidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_anos_cumplidos_cb

  // ---------- Validate dpto_nacimiento
  function do_ajax_form_students_validate_dpto_nacimiento()
  {
    var nomeCampo_dpto_nacimiento = "dpto_nacimiento";
    var var_dpto_nacimiento = scAjaxGetFieldSelect(nomeCampo_dpto_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_dpto_nacimiento(var_dpto_nacimiento, var_script_case_init, do_ajax_form_students_validate_dpto_nacimiento_cb);
  } // do_ajax_form_students_validate_dpto_nacimiento

  function do_ajax_form_students_validate_dpto_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_dpto_nacimiento_cb

  // ---------- Validate municipio_nacimiento
  function do_ajax_form_students_validate_municipio_nacimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_municipio_nacimiento(var_municipio_nacimiento, var_script_case_init, do_ajax_form_students_validate_municipio_nacimiento_cb);
  } // do_ajax_form_students_validate_municipio_nacimiento

  function do_ajax_form_students_validate_municipio_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_municipio_nacimiento_cb

  // ---------- Validate observaciones
  function do_ajax_form_students_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_students_validate_observaciones_cb);
  } // do_ajax_form_students_validate_observaciones

  function do_ajax_form_students_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_observaciones_cb

  // ---------- Validate login
  function do_ajax_form_students_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_login(var_login, var_script_case_init, do_ajax_form_students_validate_login_cb);
  } // do_ajax_form_students_validate_login

  function do_ajax_form_students_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_form_students_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_pswd(var_pswd, var_script_case_init, do_ajax_form_students_validate_pswd_cb);
  } // do_ajax_form_students_validate_pswd

  function do_ajax_form_students_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_form_students_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_form_students_validate_confirm_pswd_cb);
  } // do_ajax_form_students_validate_confirm_pswd

  function do_ajax_form_students_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_confirm_pswd_cb

  // ---------- Validate photo
  function do_ajax_form_students_validate_photo()
  {
    var nomeCampo_photo = "photo";
    var var_photo = scAjaxGetFieldText(nomeCampo_photo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_photo(var_photo, var_script_case_init, do_ajax_form_students_validate_photo_cb);
  } // do_ajax_form_students_validate_photo

  function do_ajax_form_students_validate_photo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "photo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_photo_cb

  // ---------- Validate state
  function do_ajax_form_students_validate_state()
  {
    var nomeCampo_state = "state";
    var var_state = scAjaxGetFieldSelect(nomeCampo_state);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_state(var_state, var_script_case_init, do_ajax_form_students_validate_state_cb);
  } // do_ajax_form_students_validate_state

  function do_ajax_form_students_validate_state_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "state";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_state_cb

  // ---------- Validate city
  function do_ajax_form_students_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldSelect(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_city(var_city, var_script_case_init, do_ajax_form_students_validate_city_cb);
  } // do_ajax_form_students_validate_city

  function do_ajax_form_students_validate_city_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "city";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_city_cb

  // ---------- Validate address
  function do_ajax_form_students_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_address(var_address, var_script_case_init, do_ajax_form_students_validate_address_cb);
  } // do_ajax_form_students_validate_address

  function do_ajax_form_students_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "address";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_address_cb

  // ---------- Validate barrio
  function do_ajax_form_students_validate_barrio()
  {
    var nomeCampo_barrio = "barrio";
    var var_barrio = scAjaxGetFieldText(nomeCampo_barrio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_barrio(var_barrio, var_script_case_init, do_ajax_form_students_validate_barrio_cb);
  } // do_ajax_form_students_validate_barrio

  function do_ajax_form_students_validate_barrio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "barrio";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_barrio_cb

  // ---------- Validate postalcode
  function do_ajax_form_students_validate_postalcode()
  {
    var nomeCampo_postalcode = "postalcode";
    var var_postalcode = scAjaxGetFieldText(nomeCampo_postalcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_postalcode(var_postalcode, var_script_case_init, do_ajax_form_students_validate_postalcode_cb);
  } // do_ajax_form_students_validate_postalcode

  function do_ajax_form_students_validate_postalcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_postalcode_cb

  // ---------- Validate zona
  function do_ajax_form_students_validate_zona()
  {
    var nomeCampo_zona = "zona";
    var var_zona = scAjaxGetFieldRadio(nomeCampo_zona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_zona(var_zona, var_script_case_init, do_ajax_form_students_validate_zona_cb);
  } // do_ajax_form_students_validate_zona

  function do_ajax_form_students_validate_zona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "zona";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_zona_cb

  // ---------- Validate telefono
  function do_ajax_form_students_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_students_validate_telefono_cb);
  } // do_ajax_form_students_validate_telefono

  function do_ajax_form_students_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_telefono_cb

  // ---------- Validate email
  function do_ajax_form_students_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_email(var_email, var_script_case_init, do_ajax_form_students_validate_email_cb);
  } // do_ajax_form_students_validate_email

  function do_ajax_form_students_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_email_cb

  // ---------- Validate id_sede
  function do_ajax_form_students_validate_id_sede()
  {
    var nomeCampo_id_sede = "id_sede";
    var var_id_sede = scAjaxGetFieldSelect(nomeCampo_id_sede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_id_sede(var_id_sede, var_script_case_init, do_ajax_form_students_validate_id_sede_cb);
  } // do_ajax_form_students_validate_id_sede

  function do_ajax_form_students_validate_id_sede_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_sede";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_id_sede_cb

  // ---------- Validate id_jornada
  function do_ajax_form_students_validate_id_jornada()
  {
    var nomeCampo_id_jornada = "id_jornada";
    var var_id_jornada = scAjaxGetFieldSelect(nomeCampo_id_jornada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_id_jornada(var_id_jornada, var_script_case_init, do_ajax_form_students_validate_id_jornada_cb);
  } // do_ajax_form_students_validate_id_jornada

  function do_ajax_form_students_validate_id_jornada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_id_jornada_cb

  // ---------- Validate id_nivel
  function do_ajax_form_students_validate_id_nivel()
  {
    var nomeCampo_id_nivel = "id_nivel";
    var var_id_nivel = scAjaxGetFieldSelect(nomeCampo_id_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_id_nivel(var_id_nivel, var_script_case_init, do_ajax_form_students_validate_id_nivel_cb);
  } // do_ajax_form_students_validate_id_nivel

  function do_ajax_form_students_validate_id_nivel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_id_nivel_cb

  // ---------- Validate grado_igreso
  function do_ajax_form_students_validate_grado_igreso()
  {
    var nomeCampo_grado_igreso = "grado_igreso";
    var var_grado_igreso = scAjaxGetFieldSelect(nomeCampo_grado_igreso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_grado_igreso(var_grado_igreso, var_script_case_init, do_ajax_form_students_validate_grado_igreso_cb);
  } // do_ajax_form_students_validate_grado_igreso

  function do_ajax_form_students_validate_grado_igreso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_grado_igreso_cb

  // ---------- Validate id_grupo
  function do_ajax_form_students_validate_id_grupo()
  {
    var nomeCampo_id_grupo = "id_grupo";
    var var_id_grupo = scAjaxGetFieldSelect(nomeCampo_id_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_id_grupo(var_id_grupo, var_script_case_init, do_ajax_form_students_validate_id_grupo_cb);
  } // do_ajax_form_students_validate_id_grupo

  function do_ajax_form_students_validate_id_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_id_grupo_cb

  // ---------- Validate grado_anterior
  function do_ajax_form_students_validate_grado_anterior()
  {
    var nomeCampo_grado_anterior = "grado_anterior";
    var var_grado_anterior = scAjaxGetFieldSelect(nomeCampo_grado_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_grado_anterior(var_grado_anterior, var_script_case_init, do_ajax_form_students_validate_grado_anterior_cb);
  } // do_ajax_form_students_validate_grado_anterior

  function do_ajax_form_students_validate_grado_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_grado_anterior_cb

  // ---------- Validate last_year
  function do_ajax_form_students_validate_last_year()
  {
    var nomeCampo_last_year = "last_year";
    var var_last_year = scAjaxGetFieldText(nomeCampo_last_year);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_last_year(var_last_year, var_script_case_init, do_ajax_form_students_validate_last_year_cb);
  } // do_ajax_form_students_validate_last_year

  function do_ajax_form_students_validate_last_year_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_last_year_cb

  // ---------- Validate nombre_ult_plantel
  function do_ajax_form_students_validate_nombre_ult_plantel()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_nombre_ult_plantel(var_nombre_ult_plantel, var_script_case_init, do_ajax_form_students_validate_nombre_ult_plantel_cb);
  } // do_ajax_form_students_validate_nombre_ult_plantel

  function do_ajax_form_students_validate_nombre_ult_plantel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_nombre_ult_plantel_cb

  // ---------- Validate resultado
  function do_ajax_form_students_validate_resultado()
  {
    var nomeCampo_resultado = "resultado";
    var var_resultado = scAjaxGetFieldSelect(nomeCampo_resultado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_resultado(var_resultado, var_script_case_init, do_ajax_form_students_validate_resultado_cb);
  } // do_ajax_form_students_validate_resultado

  function do_ajax_form_students_validate_resultado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_resultado_cb

  // ---------- Validate subsidado
  function do_ajax_form_students_validate_subsidado()
  {
    var nomeCampo_subsidado = "subsidado";
    var var_subsidado = scAjaxGetFieldRadio(nomeCampo_subsidado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_subsidado(var_subsidado, var_script_case_init, do_ajax_form_students_validate_subsidado_cb);
  } // do_ajax_form_students_validate_subsidado

  function do_ajax_form_students_validate_subsidado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_subsidado_cb

  // ---------- Validate interno
  function do_ajax_form_students_validate_interno()
  {
    var nomeCampo_interno = "interno";
    var var_interno = scAjaxGetFieldRadio(nomeCampo_interno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_interno(var_interno, var_script_case_init, do_ajax_form_students_validate_interno_cb);
  } // do_ajax_form_students_validate_interno

  function do_ajax_form_students_validate_interno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "interno";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_interno_cb

  // ---------- Validate otro_modelo
  function do_ajax_form_students_validate_otro_modelo()
  {
    var nomeCampo_otro_modelo = "otro_modelo";
    var var_otro_modelo = scAjaxGetFieldSelect(nomeCampo_otro_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_otro_modelo(var_otro_modelo, var_script_case_init, do_ajax_form_students_validate_otro_modelo_cb);
  } // do_ajax_form_students_validate_otro_modelo

  function do_ajax_form_students_validate_otro_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_otro_modelo_cb

  // ---------- Validate caracter
  function do_ajax_form_students_validate_caracter()
  {
    var nomeCampo_caracter = "caracter";
    var var_caracter = scAjaxGetFieldRadio(nomeCampo_caracter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_caracter(var_caracter, var_script_case_init, do_ajax_form_students_validate_caracter_cb);
  } // do_ajax_form_students_validate_caracter

  function do_ajax_form_students_validate_caracter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_caracter_cb

  // ---------- Validate especialidad
  function do_ajax_form_students_validate_especialidad()
  {
    var nomeCampo_especialidad = "especialidad";
    var var_especialidad = scAjaxGetFieldSelect(nomeCampo_especialidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_especialidad(var_especialidad, var_script_case_init, do_ajax_form_students_validate_especialidad_cb);
  } // do_ajax_form_students_validate_especialidad

  function do_ajax_form_students_validate_especialidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_especialidad_cb

  // ---------- Validate year_mat
  function do_ajax_form_students_validate_year_mat()
  {
    var nomeCampo_year_mat = "year_mat";
    var var_year_mat = scAjaxGetFieldSelect(nomeCampo_year_mat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_year_mat(var_year_mat, var_script_case_init, do_ajax_form_students_validate_year_mat_cb);
  } // do_ajax_form_students_validate_year_mat

  function do_ajax_form_students_validate_year_mat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_year_mat_cb

  // ---------- Validate matricular
  function do_ajax_form_students_validate_matricular()
  {
    var nomeCampo_matricular = "matricular";
    var var_matricular = scAjaxGetFieldSelect(nomeCampo_matricular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_matricular(var_matricular, var_script_case_init, do_ajax_form_students_validate_matricular_cb);
  } // do_ajax_form_students_validate_matricular

  function do_ajax_form_students_validate_matricular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_matricular_cb

  // ---------- Validate eps
  function do_ajax_form_students_validate_eps()
  {
    var nomeCampo_eps = "eps";
    var var_eps = scAjaxGetFieldSelect(nomeCampo_eps);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_eps(var_eps, var_script_case_init, do_ajax_form_students_validate_eps_cb);
  } // do_ajax_form_students_validate_eps

  function do_ajax_form_students_validate_eps_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "eps";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_eps_cb

  // ---------- Validate ips
  function do_ajax_form_students_validate_ips()
  {
    var nomeCampo_ips = "ips";
    var var_ips = scAjaxGetFieldText(nomeCampo_ips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_ips(var_ips, var_script_case_init, do_ajax_form_students_validate_ips_cb);
  } // do_ajax_form_students_validate_ips

  function do_ajax_form_students_validate_ips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ips";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_ips_cb

  // ---------- Validate ars
  function do_ajax_form_students_validate_ars()
  {
    var nomeCampo_ars = "ars";
    var var_ars = scAjaxGetFieldText(nomeCampo_ars);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_ars(var_ars, var_script_case_init, do_ajax_form_students_validate_ars_cb);
  } // do_ajax_form_students_validate_ars

  function do_ajax_form_students_validate_ars_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ars";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_ars_cb

  // ---------- Validate tipo_sangre
  function do_ajax_form_students_validate_tipo_sangre()
  {
    var nomeCampo_tipo_sangre = "tipo_sangre";
    var var_tipo_sangre = scAjaxGetFieldSelect(nomeCampo_tipo_sangre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_tipo_sangre(var_tipo_sangre, var_script_case_init, do_ajax_form_students_validate_tipo_sangre_cb);
  } // do_ajax_form_students_validate_tipo_sangre

  function do_ajax_form_students_validate_tipo_sangre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_tipo_sangre_cb

  // ---------- Validate victima_conflicto
  function do_ajax_form_students_validate_victima_conflicto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_victima_conflicto(var_victima_conflicto, var_script_case_init, do_ajax_form_students_validate_victima_conflicto_cb);
  } // do_ajax_form_students_validate_victima_conflicto

  function do_ajax_form_students_validate_victima_conflicto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_victima_conflicto_cb

  // ---------- Validate peso
  function do_ajax_form_students_validate_peso()
  {
    var nomeCampo_peso = "peso";
    var var_peso = scAjaxGetFieldText(nomeCampo_peso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_peso(var_peso, var_script_case_init, do_ajax_form_students_validate_peso_cb);
  } // do_ajax_form_students_validate_peso

  function do_ajax_form_students_validate_peso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "peso";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_peso_cb

  // ---------- Validate talla
  function do_ajax_form_students_validate_talla()
  {
    var nomeCampo_talla = "talla";
    var var_talla = scAjaxGetFieldText(nomeCampo_talla);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_talla(var_talla, var_script_case_init, do_ajax_form_students_validate_talla_cb);
  } // do_ajax_form_students_validate_talla

  function do_ajax_form_students_validate_talla_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "talla";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_talla_cb

  // ---------- Validate cobertura
  function do_ajax_form_students_validate_cobertura()
  {
    var nomeCampo_cobertura = "cobertura";
    var var_cobertura = scAjaxGetFieldText(nomeCampo_cobertura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_cobertura(var_cobertura, var_script_case_init, do_ajax_form_students_validate_cobertura_cb);
  } // do_ajax_form_students_validate_cobertura

  function do_ajax_form_students_validate_cobertura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_cobertura_cb

  // ---------- Validate vive_con
  function do_ajax_form_students_validate_vive_con()
  {
    var nomeCampo_vive_con = "vive_con";
    var var_vive_con = scAjaxGetFieldText(nomeCampo_vive_con);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_vive_con(var_vive_con, var_script_case_init, do_ajax_form_students_validate_vive_con_cb);
  } // do_ajax_form_students_validate_vive_con

  function do_ajax_form_students_validate_vive_con_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_vive_con_cb

  // ---------- Validate subsidio
  function do_ajax_form_students_validate_subsidio()
  {
    var nomeCampo_subsidio = "subsidio";
    var var_subsidio = scAjaxGetFieldText(nomeCampo_subsidio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_subsidio(var_subsidio, var_script_case_init, do_ajax_form_students_validate_subsidio_cb);
  } // do_ajax_form_students_validate_subsidio

  function do_ajax_form_students_validate_subsidio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_subsidio_cb

  // ---------- Validate estatus_vca
  function do_ajax_form_students_validate_estatus_vca()
  {
    var nomeCampo_estatus_vca = "estatus_vca";
    var var_estatus_vca = scAjaxGetFieldSelect(nomeCampo_estatus_vca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_estatus_vca(var_estatus_vca, var_script_case_init, do_ajax_form_students_validate_estatus_vca_cb);
  } // do_ajax_form_students_validate_estatus_vca

  function do_ajax_form_students_validate_estatus_vca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_estatus_vca_cb

  // ---------- Validate depto_expulsor
  function do_ajax_form_students_validate_depto_expulsor()
  {
    var nomeCampo_depto_expulsor = "depto_expulsor";
    var var_depto_expulsor = scAjaxGetFieldSelect(nomeCampo_depto_expulsor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_depto_expulsor(var_depto_expulsor, var_script_case_init, do_ajax_form_students_validate_depto_expulsor_cb);
  } // do_ajax_form_students_validate_depto_expulsor

  function do_ajax_form_students_validate_depto_expulsor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_depto_expulsor_cb

  // ---------- Validate municipio_expulsor
  function do_ajax_form_students_validate_municipio_expulsor()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_municipio_expulsor(var_municipio_expulsor, var_script_case_init, do_ajax_form_students_validate_municipio_expulsor_cb);
  } // do_ajax_form_students_validate_municipio_expulsor

  function do_ajax_form_students_validate_municipio_expulsor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_municipio_expulsor_cb

  // ---------- Validate fecha_expulsion
  function do_ajax_form_students_validate_fecha_expulsion()
  {
    var nomeCampo_fecha_expulsion = "fecha_expulsion";
    var var_fecha_expulsion = scAjaxGetFieldText(nomeCampo_fecha_expulsion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_fecha_expulsion(var_fecha_expulsion, var_script_case_init, do_ajax_form_students_validate_fecha_expulsion_cb);
  } // do_ajax_form_students_validate_fecha_expulsion

  function do_ajax_form_students_validate_fecha_expulsion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_fecha_expulsion_cb

  // ---------- Validate certificado
  function do_ajax_form_students_validate_certificado()
  {
    var nomeCampo_certificado = "certificado";
    var var_certificado = scAjaxGetFieldRadio(nomeCampo_certificado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_certificado(var_certificado, var_script_case_init, do_ajax_form_students_validate_certificado_cb);
  } // do_ajax_form_students_validate_certificado

  function do_ajax_form_students_validate_certificado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_certificado_cb

  // ---------- Validate semestre
  function do_ajax_form_students_validate_semestre()
  {
    var nomeCampo_semestre = "semestre";
    var var_semestre = scAjaxGetFieldText(nomeCampo_semestre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_semestre(var_semestre, var_script_case_init, do_ajax_form_students_validate_semestre_cb);
  } // do_ajax_form_students_validate_semestre

  function do_ajax_form_students_validate_semestre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_semestre_cb

  // ---------- Validate numero_carne_sisben
  function do_ajax_form_students_validate_numero_carne_sisben()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_numero_carne_sisben(var_numero_carne_sisben, var_script_case_init, do_ajax_form_students_validate_numero_carne_sisben_cb);
  } // do_ajax_form_students_validate_numero_carne_sisben

  function do_ajax_form_students_validate_numero_carne_sisben_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_numero_carne_sisben_cb

  // ---------- Validate nivel_sisben
  function do_ajax_form_students_validate_nivel_sisben()
  {
    var nomeCampo_nivel_sisben = "nivel_sisben";
    var var_nivel_sisben = scAjaxGetFieldText(nomeCampo_nivel_sisben);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_nivel_sisben(var_nivel_sisben, var_script_case_init, do_ajax_form_students_validate_nivel_sisben_cb);
  } // do_ajax_form_students_validate_nivel_sisben

  function do_ajax_form_students_validate_nivel_sisben_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_nivel_sisben_cb

  // ---------- Validate estrato
  function do_ajax_form_students_validate_estrato()
  {
    var nomeCampo_estrato = "estrato";
    var var_estrato = scAjaxGetFieldSelect(nomeCampo_estrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_estrato(var_estrato, var_script_case_init, do_ajax_form_students_validate_estrato_cb);
  } // do_ajax_form_students_validate_estrato

  function do_ajax_form_students_validate_estrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estrato";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_estrato_cb

  // ---------- Validate fuente_recurso
  function do_ajax_form_students_validate_fuente_recurso()
  {
    var nomeCampo_fuente_recurso = "fuente_recurso";
    var var_fuente_recurso = scAjaxGetFieldSelect(nomeCampo_fuente_recurso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_fuente_recurso(var_fuente_recurso, var_script_case_init, do_ajax_form_students_validate_fuente_recurso_cb);
  } // do_ajax_form_students_validate_fuente_recurso

  function do_ajax_form_students_validate_fuente_recurso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_fuente_recurso_cb

  // ---------- Validate opcion
  function do_ajax_form_students_validate_opcion()
  {
    var nomeCampo_opcion = "opcion";
    var var_opcion = scAjaxGetFieldSelect(nomeCampo_opcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_opcion(var_opcion, var_script_case_init, do_ajax_form_students_validate_opcion_cb);
  } // do_ajax_form_students_validate_opcion

  function do_ajax_form_students_validate_opcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "opcion";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_opcion_cb

  // ---------- Validate resguardo
  function do_ajax_form_students_validate_resguardo()
  {
    var nomeCampo_resguardo = "resguardo";
    var var_resguardo = scAjaxGetFieldText(nomeCampo_resguardo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_resguardo(var_resguardo, var_script_case_init, do_ajax_form_students_validate_resguardo_cb);
  } // do_ajax_form_students_validate_resguardo

  function do_ajax_form_students_validate_resguardo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_resguardo_cb

  // ---------- Validate negritudes
  function do_ajax_form_students_validate_negritudes()
  {
    var nomeCampo_negritudes = "negritudes";
    var var_negritudes = scAjaxGetFieldRadio(nomeCampo_negritudes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_negritudes(var_negritudes, var_script_case_init, do_ajax_form_students_validate_negritudes_cb);
  } // do_ajax_form_students_validate_negritudes

  function do_ajax_form_students_validate_negritudes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_negritudes_cb

  // ---------- Validate etnia
  function do_ajax_form_students_validate_etnia()
  {
    var nomeCampo_etnia = "etnia";
    var var_etnia = scAjaxGetFieldText(nomeCampo_etnia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_etnia(var_etnia, var_script_case_init, do_ajax_form_students_validate_etnia_cb);
  } // do_ajax_form_students_validate_etnia

  function do_ajax_form_students_validate_etnia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "etnia";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_etnia_cb

  // ---------- Validate discapacidades
  function do_ajax_form_students_validate_discapacidades()
  {
    var nomeCampo_discapacidades = "discapacidades";
    var var_discapacidades = scAjaxGetFieldSelect(nomeCampo_discapacidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_discapacidades(var_discapacidades, var_script_case_init, do_ajax_form_students_validate_discapacidades_cb);
  } // do_ajax_form_students_validate_discapacidades

  function do_ajax_form_students_validate_discapacidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_discapacidades_cb

  // ---------- Validate capacidades
  function do_ajax_form_students_validate_capacidades()
  {
    var nomeCampo_capacidades = "capacidades";
    var var_capacidades = scAjaxGetFieldSelect(nomeCampo_capacidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_capacidades(var_capacidades, var_script_case_init, do_ajax_form_students_validate_capacidades_cb);
  } // do_ajax_form_students_validate_capacidades

  function do_ajax_form_students_validate_capacidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_capacidades_cb

  // ---------- Validate novedades
  function do_ajax_form_students_validate_novedades()
  {
    var nomeCampo_novedades = "novedades";
    var var_novedades = scAjaxGetFieldText(nomeCampo_novedades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_students_validate_novedades(var_novedades, var_script_case_init, do_ajax_form_students_validate_novedades_cb);
  } // do_ajax_form_students_validate_novedades

  function do_ajax_form_students_validate_novedades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_validate_novedades_cb

  // ---------- Refresh departanebti_expedicion
  function do_ajax_form_students_refresh_departanebti_expedicion()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_students_refresh_departanebti_expedicion(var_departanebti_expedicion, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_students_refresh_departanebti_expedicion_cb);
  } // do_ajax_form_students_refresh_departanebti_expedicion

  function do_ajax_form_students_refresh_departanebti_expedicion_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_refresh_departanebti_expedicion_cb

  // ---------- Refresh dpto_nacimiento
  function do_ajax_form_students_refresh_dpto_nacimiento()
  {
    var var_dpto_nacimiento = scAjaxGetFieldSelect("dpto_nacimiento");
    var var_nmgp_refresh_fields = "municipio_nacimiento";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_students_refresh_dpto_nacimiento(var_dpto_nacimiento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_students_refresh_dpto_nacimiento_cb);
  } // do_ajax_form_students_refresh_dpto_nacimiento

  function do_ajax_form_students_refresh_dpto_nacimiento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_refresh_dpto_nacimiento_cb

  // ---------- Refresh state
  function do_ajax_form_students_refresh_state()
  {
    var var_state = scAjaxGetFieldSelect("state");
    var var_nmgp_refresh_fields = "city";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_students_refresh_state(var_state, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_students_refresh_state_cb);
  } // do_ajax_form_students_refresh_state

  function do_ajax_form_students_refresh_state_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_refresh_state_cb

  // ---------- Refresh id_nivel
  function do_ajax_form_students_refresh_id_nivel()
  {
    var var_id_nivel = scAjaxGetFieldSelect("id_nivel");
    var var_nmgp_refresh_fields = "grado_igreso";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_students_refresh_id_nivel(var_id_nivel, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_students_refresh_id_nivel_cb);
  } // do_ajax_form_students_refresh_id_nivel

  function do_ajax_form_students_refresh_id_nivel_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    do_ajax_form_students_refresh_grado_igreso();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_refresh_id_nivel_cb

  // ---------- Refresh grado_igreso
  function do_ajax_form_students_refresh_grado_igreso()
  {
    var var_grado_igreso = scAjaxGetFieldSelect("grado_igreso");
    var var_nmgp_refresh_fields = "id_grupo";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_students_refresh_grado_igreso(var_grado_igreso, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_students_refresh_grado_igreso_cb);
  } // do_ajax_form_students_refresh_grado_igreso

  function do_ajax_form_students_refresh_grado_igreso_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_refresh_grado_igreso_cb

  // ---------- Refresh depto_expulsor
  function do_ajax_form_students_refresh_depto_expulsor()
  {
    var var_depto_expulsor = scAjaxGetFieldSelect("depto_expulsor");
    var var_nmgp_refresh_fields = "tipo_sangre";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_students_refresh_depto_expulsor(var_depto_expulsor, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_students_refresh_depto_expulsor_cb);
  } // do_ajax_form_students_refresh_depto_expulsor

  function do_ajax_form_students_refresh_depto_expulsor_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_students_refresh_depto_expulsor_cb

  // ---------- Event onchange fecha_nacimiento
  function do_ajax_form_students_event_fecha_nacimiento_onchange()
  {
    ...
    x_ajax_form_students_event_fecha_nacimiento_onchange(var_fecha_nacimiento, var_anos_cumplidos, var_script_case_init, do_ajax_form_students_event_fecha_nacimiento_onchange_cb);
  } // do_ajax_form_students_event_fecha_nacimiento_onchange

  function do_ajax_form_students_event_fecha_nacimiento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha_nacimiento";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_students_event_fecha_nacimiento_onchange_cb

  // ---------- Event onchange victima_conflicto
  function do_ajax_form_students_event_victima_conflicto_onchange()
  {
    var var_victima_conflicto = scAjaxGetFieldSelect("victima_conflicto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    scEventControl_onChange_call("victima_conflicto", "");
    x_ajax_form_students_event_victima_conflicto_onchange(var_victima_conflicto, var_script_case_init, do_ajax_form_students_event_victima_conflicto_onchange_cb);
  } // do_ajax_form_students_event_victima_conflicto_onchange

  function do_ajax_form_students_event_victima_conflicto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "victima_conflicto";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_students_event_victima_conflicto_onchange_cb
  // ---------- Form
  function do_ajax_form_students_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_students_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
  ...
  } // do_ajax_form_students_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_novedades_x_estudiante_fecha"] = "off";

  function do_ajax_form_students_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_students_navigate_form(var_idstudents, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_students_navigate_form_cb);
  } // do_ajax_form_students_navigate_form

  function do_ajax_form_students_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_students_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_students_navigate_form_cb
  function sc_hide_form_students_form()
  {
