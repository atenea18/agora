...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'year_mat':
      case 'matricular':
        sc_exib_ocult_pag('form_students_form0');
        break;
      case 'eps':
      case 'ips':
      case 'ars':
      ...
      case 'certificado':
      case 'semestre':
        sc_exib_ocult_pag('form_students_form1');
        break;
      ...
      case 'negritudes':
      case 'etnia':
        sc_exib_ocult_pag('form_students_form2');
        break;
      case 'discapacidades':
      case 'capacidades':
        sc_exib_ocult_pag('form_students_form3');
        break;
      case 'novedades':
        sc_exib_ocult_pag('form_students_form4');
        break;
    }
  }
