<div id="form_students_form2" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $sStyleHidden_fecha_expulsion_dumb = ('' == $sStyleHidden_fecha_expulsion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fecha_expulsion_dumb" style="<?php echo $sStyleHidden_fecha_expulsion_dumb; ?>"></TD>
<?php $sStyleHidden_certificado_dumb = ('' == $sStyleHidden_certificado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_certificado_dumb" style="<?php echo $sStyleHidden_certificado_dumb; ?>"></TD>
...
<?php } 
?> 
<?php $sStyleHidden_numero_carne_sisben_dumb = ('' == $sStyleHidden_numero_carne_sisben) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_numero_carne_sisben_dumb" style="<?php echo $sStyleHidden_numero_carne_sisben_dumb; ?>"></TD>
<?php $sStyleHidden_nivel_sisben_dumb = ('' == $sStyleHidden_nivel_sisben) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_nivel_sisben_dumb" style="<?php echo $sStyleHidden_nivel_sisben_dumb; ?>"></TD>
...
<?php } ?>
<?php $sStyleHidden_fuente_recurso_dumb = ('' == $sStyleHidden_fuente_recurso) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fuente_recurso_dumb" style="<?php echo $sStyleHidden_fuente_recurso_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['Lookup_negritudes'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['Lookup_negritudes'][] = 'N'; ?>
