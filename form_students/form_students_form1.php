<div id="form_students_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $sStyleHidden_caracter_dumb = ('' == $sStyleHidden_caracter) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_caracter_dumb" style="<?php echo $sStyleHidden_caracter_dumb; ?>"></TD>
<?php $sStyleHidden_especialidad_dumb = ('' == $sStyleHidden_especialidad) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_especialidad_dumb" style="<?php echo $sStyleHidden_especialidad_dumb; ?>"></TD>
<?php $sStyleHidden_year_mat_dumb = ('' == $sStyleHidden_year_mat) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_year_mat_dumb" style="<?php echo $sStyleHidden_year_mat_dumb; ?>"></TD>
<?php $sStyleHidden_matricular_dumb = ('' == $sStyleHidden_matricular) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_matricular_dumb" style="<?php echo $sStyleHidden_matricular_dumb; ?>"></TD>
...
<?php } 
?> 
<?php $sStyleHidden_eps_dumb = ('' == $sStyleHidden_eps) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_eps_dumb" style="<?php echo $sStyleHidden_eps_dumb; ?>"></TD>
<?php $sStyleHidden_ips_dumb = ('' == $sStyleHidden_ips) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ips_dumb" style="<?php echo $sStyleHidden_ips_dumb; ?>"></TD>
<?php $sStyleHidden_ars_dumb = ('' == $sStyleHidden_ars) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ars_dumb" style="<?php echo $sStyleHidden_ars_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['Lookup_victima_conflicto'][] = '1'; ?>
 <option value="2" <?php  if ($this->victima_conflicto == "2") { echo " selected" ;} ?><?php  if (empty($this->victima_conflicto)) { echo " selected" ;} ?>>No</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['Lookup_victima_conflicto'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_tipo_sangre_dumb = ('' == $sStyleHidden_tipo_sangre) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tipo_sangre_dumb" style="<?php echo $sStyleHidden_tipo_sangre_dumb; ?>"></TD>
<?php $sStyleHidden_victima_conflicto_dumb = ('' == $sStyleHidden_victima_conflicto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_victima_conflicto_dumb" style="<?php echo $sStyleHidden_victima_conflicto_dumb; ?>"></TD>
...
<?php } 
?> 
<?php $sStyleHidden_talla_dumb = ('' == $sStyleHidden_talla) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_talla_dumb" style="<?php echo $sStyleHidden_talla_dumb; ?>"></TD>
<?php $sStyleHidden_cobertura_dumb = ('' == $sStyleHidden_cobertura) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cobertura_dumb" style="<?php echo $sStyleHidden_cobertura_dumb; ?>"></TD>
<?php $sStyleHidden_vive_con_dumb = ('' == $sStyleHidden_vive_con) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_vive_con_dumb" style="<?php echo $sStyleHidden_vive_con_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_estatus_vca_dumb = ('' == $sStyleHidden_estatus_vca) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_estatus_vca_dumb" style="<?php echo $sStyleHidden_estatus_vca_dumb; ?>"></TD>
<?php $sStyleHidden_depto_expulsor_dumb = ('' == $sStyleHidden_depto_expulsor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_depto_expulsor_dumb" style="<?php echo $sStyleHidden_depto_expulsor_dumb; ?>"></TD>
<?php $sStyleHidden_municipio_expulsor_dumb = ('' == $sStyleHidden_municipio_expulsor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_municipio_expulsor_dumb" style="<?php echo $sStyleHidden_municipio_expulsor_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['Lookup_certificado'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['Lookup_certificado'][] = 'N'; ?>
