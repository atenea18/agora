...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_students_mob']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_students_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_students_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_students_mob']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_novedades_x_estudiante_fecha_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_novedades_x_estudiante_fecha_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_students_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_students_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->entorno)) 
          {
              $_SESSION['entorno'] = $this->entorno;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_students_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_students_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_students_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_students'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_students_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_students_mob']['upload_field_info']['photo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_students_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_students_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_students_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_students_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_students_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_students_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_students_mob']['label'] = "" . $this->Ini->Nm_lang['lang_tbl_students'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_students_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_students_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['table_refresh'] = false;
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_field_ul_name'][$this->photo_ul_name]))
          {
              $this->NM_ajax_info['param']['photo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_field_ul_name'][$this->photo_ul_name];
          }
      ...
      elseif (isset($this->photo_ul_name) && '' != $this->photo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_field_ul_name'][$this->photo_ul_name]))
          {
              $this->photo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_field_ul_name'][$this->photo_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_students_mob']['goto'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_students/form_students_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_students_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_students_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_students_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_students/form_students_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_students_mob_erro.class.php"); 
      }
      $this->Erro      = new form_students_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao']))
         { 
             if ($this->idstudents != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_students_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_novedades_x_estudiante_fecha_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novedades_x_estudiante_fecha_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_novedades_x_estudiante_fecha_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_novedades_x_estudiante_fecha_mob') . "/form_novedades_x_estudiante_fecha_apl.php");
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_students_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_students_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_students_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_students_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
      ...
      {
      $_SESSION['scriptcase']['form_students_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_students_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_estatus(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->estatus != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus']) && !in_array($this->estatus, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus']))
          {
    ...
    function ValidateField_genero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->genero != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_genero']) && !in_array($this->genero, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_genero']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->tipo_identificacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion']) && !in_array($this->tipo_identificacion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->departanebti_expedicion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion']) && !in_array($this->departanebti_expedicion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->municipio_expedicion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion']) && !in_array($this->municipio_expedicion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_anos_cumplidos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->anos_cumplidos, 11, 0, -0, 99999999999, "N") == false)  
              { 
    ...
    {
        global $teste_validade;
               if (!empty($this->dpto_nacimiento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento']) && !in_array($this->dpto_nacimiento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->municipio_nacimiento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento']) && !in_array($this->municipio_nacimiento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->state) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state']) && !in_array($this->state, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->city) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city']) && !in_array($this->city, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_zona(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->zona != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_zona']) && !in_array($this->zona, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_zona']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_sede) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede']) && !in_array($this->id_sede, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_jornada) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada']) && !in_array($this->id_jornada, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_nivel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel']) && !in_array($this->id_nivel, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->grado_igreso) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso']) && !in_array($this->grado_igreso, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_grupo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo']) && !in_array($this->id_grupo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->grado_anterior) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior']) && !in_array($this->grado_anterior, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_subsidado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->subsidado != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_subsidado']) && !in_array($this->subsidado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_subsidado']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_interno(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->interno != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_interno']) && !in_array($this->interno, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_interno']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_caracter(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->caracter != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_caracter']) && !in_array($this->caracter, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_caracter']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->eps) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_eps']) && !in_array($this->eps, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_eps']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->tipo_sangre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_sangre']) && !in_array($this->tipo_sangre, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_sangre']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_peso(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->peso, 12, 0, -0, 999999999999, "N") == false)  
              { 
                  $Campos_Crit .= "Peso; " ; 
                  if (!isset($Campos_Erros['peso']))
                  {
    ...
    function ValidateField_talla(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->talla, 12, 0, -0, 999999999999, "N") == false)  
              { 
                  $Campos_Crit .= "Talla; " ; 
                  if (!isset($Campos_Erros['talla']))
                  {
    ...
    {
        global $teste_validade;
               if (!empty($this->estatus_vca) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus_vca']) && !in_array($this->estatus_vca, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus_vca']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->depto_expulsor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_depto_expulsor']) && !in_array($this->depto_expulsor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_depto_expulsor']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->municipio_expulsor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expulsor']) && !in_array($this->municipio_expulsor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expulsor']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_certificado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->certificado != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_certificado']) && !in_array($this->certificado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_certificado']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->estrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estrato']) && !in_array($this->estrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estrato']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->fuente_recurso) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_fuente_recurso']) && !in_array($this->fuente_recurso, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_fuente_recurso']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->opcion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_opcion']) && !in_array($this->opcion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_opcion']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_negritudes(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->negritudes != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_negritudes']) && !in_array($this->negritudes, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_negritudes']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->discapacidades) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades']) && !in_array($this->discapacidades, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->capacidades) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades']) && !in_array($this->capacidades, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_students_mob_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idstudents']['keyVal'] = form_students_mob_pack_protect_string($this->nmgp_dados_form['idstudents']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total'] < 0)
              {
...
$aLookup[] = array(form_students_mob_pack_protect_string('N') => form_students_mob_pack_protect_string("Nuevo"));
$aLookup[] = array(form_students_mob_pack_protect_string('C') => form_students_mob_pack_protect_string("Continuidad"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus'][] = 'N';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_estatus'][] = 'C';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatus']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_students_mob_pack_protect_string('M') => form_students_mob_pack_protect_string("Masculino"));
$aLookup[] = array(form_students_mob_pack_protect_string('F') => form_students_mob_pack_protect_string("Femenino"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_genero'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_genero'][] = 'F';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['genero']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY tipo";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_students_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_students_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_tipo_identificacion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_identificacion']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_departanebti_expedicion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['departanebti_expedicion']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion'] = array(); 
}
...
ORDER BY nombreMunicipio";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_expedicion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['municipio_expedicion']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_dpto_nacimiento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['dpto_nacimiento']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento'] = array(); 
}
...
ORDER BY nombreMunicipio";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_municipio_nacimiento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['municipio_nacimiento']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_state'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['state']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city'] = array(); 
}
if ($this->state != "")
{ 
...
ORDER BY nombreMunicipio";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_city'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['city']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('Rural') => form_students_mob_pack_protect_string("Rural"));
$aLookup[] = array(form_students_mob_pack_protect_string('Urbana') => form_students_mob_pack_protect_string("Urbana"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_zona'][] = 'Rural';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_zona'][] = 'Urbana';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['zona']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY id_sede";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_sede'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_sede']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY id_jornada";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_jornada'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_jornada']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY id_nivel";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_nivel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_nivel']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso'] = array(); 
}
if ($this->id_nivel != "")
{ 
...
ORDER BY  id_grado";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_igreso'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grado_igreso']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo'][] = 'null';
...
ORDER BY nombre_grupo";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_id_grupo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_grupo']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY  id_grado";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_grado_anterior'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grado_anterior']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('A') => form_students_mob_pack_protect_string("Aprobado"));
$aLookup[] = array(form_students_mob_pack_protect_string('R') => form_students_mob_pack_protect_string("Reprobado"));
$aLookup[] = array(form_students_mob_pack_protect_string('D') => form_students_mob_pack_protect_string("Desertó"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'A';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'R';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_resultado'][] = 'D';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['resultado']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('Y') => form_students_mob_pack_protect_string("Si"));
$aLookup[] = array(form_students_mob_pack_protect_string('N') => form_students_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_subsidado'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_subsidado'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['subsidado']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('Y') => form_students_mob_pack_protect_string("Sí"));
$aLookup[] = array(form_students_mob_pack_protect_string('N') => form_students_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_interno'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_interno'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['interno']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('N1') => form_students_mob_pack_protect_string("Nivel I"));
$aLookup[] = array(form_students_mob_pack_protect_string('N2') => form_students_mob_pack_protect_string("Nivel II"));
$aLookup[] = array(form_students_mob_pack_protect_string('OM') => form_students_mob_pack_protect_string("Otro Modelo"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_otro_modelo'][] = 'N1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_otro_modelo'][] = 'N2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_otro_modelo'][] = 'OM';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['otro_modelo']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('A') => form_students_mob_pack_protect_string("Académico"));
$aLookup[] = array(form_students_mob_pack_protect_string('T') => form_students_mob_pack_protect_string("Técnico"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_caracter'][] = 'A';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_caracter'][] = 'T';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['caracter']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('NULL') => form_students_mob_pack_protect_string("Seleccione"));
$aLookup[] = array(form_students_mob_pack_protect_string('C') => form_students_mob_pack_protect_string("Comercial"));
$aLookup[] = array(form_students_mob_pack_protect_string('A') => form_students_mob_pack_protect_string("Agropecuario"));
$aLookup[] = array(form_students_mob_pack_protect_string('T') => form_students_mob_pack_protect_string("Turismo"));
$aLookup[] = array(form_students_mob_pack_protect_string('N') => form_students_mob_pack_protect_string("Normalista"));
$aLookup[] = array(form_students_mob_pack_protect_string('I') => form_students_mob_pack_protect_string("Industrial"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'NULL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'C';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'A';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'T';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'N';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_especialidad'][] = 'I';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['especialidad']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('2017') => form_students_mob_pack_protect_string("2017"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_year_mat'][] = '2017';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['year_mat']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('1') => form_students_mob_pack_protect_string("Si"));
$aLookup[] = array(form_students_mob_pack_protect_string('2') => form_students_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_matricular'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_matricular'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['matricular']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY eps_nombre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['eps']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY tipo_sangre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_sangre']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('1') => form_students_mob_pack_protect_string("Si"));
$aLookup[] = array(form_students_mob_pack_protect_string('2') => form_students_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_victima_conflicto'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_victima_conflicto'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['victima_conflicto']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY tipo";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['estatus_vca']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY nombre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['depto_expulsor']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY nombreMunicipio";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['municipio_expulsor']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('Y') => form_students_mob_pack_protect_string("Sí"));
$aLookup[] = array(form_students_mob_pack_protect_string('N') => form_students_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_certificado'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_certificado'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['certificado']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY estrato";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['estrato']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY fuente_recurso";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fuente_recurso']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY opcion";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['opcion']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_students_mob_pack_protect_string('Y') => form_students_mob_pack_protect_string("Sí"));
$aLookup[] = array(form_students_mob_pack_protect_string('N') => form_students_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_negritudes'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_negritudes'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['negritudes']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY discapacidad";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_discapacidades'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['discapacidades']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades'] = array(); 
}
$aLookup[] = array(form_students_mob_pack_protect_string('null') => form_students_mob_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades'][] = 'null';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY capacidad";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['Lookup_capacidades'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['capacidades']['valList'][$i] = form_students_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_idstudents($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
...
if (isset($this->rs[0][0]))     
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_students_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_students_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->novedades = $this->novedades_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['parms'] = "idstudents?#?$this->idstudents?@?"; 
      }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_students_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total'] = $qt_geral_reg_form_students_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idstudents))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_students_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] > $qt_geral_reg_form_students_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] = $qt_geral_reg_form_students_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['sc_btn_0'] = $this->nmgp_botoes['sc_btn_0'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['parms'] = "idstudents?#?$this->idstudents?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sub_dir'][0]  = "estudiante";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['reg_start'] < $qt_geral_reg_form_students_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['dados_select'];
                  ...
                  $this->fecha_matricula = $this->nmgp_dados_select['fecha_matricula'];  
                  $this->tipo_identificacion = $this->nmgp_dados_select['tipo_identificacion'];  
                  $this->numero_documento = $this->nmgp_dados_select['numero_documento'];  
                  $this->departanebti_expedicion = $this->nmgp_dados_select['departanebti_expedicion'];  
                  $this->municipio_expedicion = $this->nmgp_dados_select['municipio_expedicion'];  
                  ...
                  $this->genero = $this->nmgp_dados_select['genero'];  
                  $this->fecha_nacimiento = $this->nmgp_dados_select['fecha_nacimiento'];  
                  $this->anos_cumplidos = $this->nmgp_dados_select['anos_cumplidos'];  
                  $this->dpto_nacimiento = $this->nmgp_dados_select['dpto_nacimiento'];  
                  $this->municipio_nacimiento = $this->nmgp_dados_select['municipio_nacimiento'];  
                  ...
                  $this->grado_anterior = $this->nmgp_dados_select['grado_anterior'];  
                  $this->last_year = $this->nmgp_dados_select['last_year'];  
                  $this->nombre_ult_plantel = $this->nmgp_dados_select['nombre_ult_plantel'];  
                  $this->resultado = $this->nmgp_dados_select['resultado'];  
                  $this->grado_igreso = $this->nmgp_dados_select['grado_igreso'];  
                  $this->id_nivel = $this->nmgp_dados_select['id_nivel'];  
                  $this->subsidado = $this->nmgp_dados_select['subsidado'];  
                  $this->interno = $this->nmgp_dados_select['interno'];  
                  $this->id_grupo = $this->nmgp_dados_select['id_grupo'];  
                  $this->otro_modelo = $this->nmgp_dados_select['otro_modelo'];  
                  $this->caracter = $this->nmgp_dados_select['caracter'];  
                  $this->especialidad = $this->nmgp_dados_select['especialidad'];  
                  $this->eps = $this->nmgp_dados_select['eps'];  
                  $this->ips = $this->nmgp_dados_select['ips'];  
                  $this->ars = $this->nmgp_dados_select['ars'];  
                  $this->tipo_sangre = $this->nmgp_dados_select['tipo_sangre'];  
                  $this->victima_conflicto = $this->nmgp_dados_select['victima_conflicto'];  
                  $this->estatus_vca = $this->nmgp_dados_select['estatus_vca'];  
                  $this->depto_expulsor = $this->nmgp_dados_select['depto_expulsor'];  
                  $this->municipio_expulsor = $this->nmgp_dados_select['municipio_expulsor'];  
                  $this->fecha_expulsion = $this->nmgp_dados_select['fecha_expulsion'];  
                  $this->certificado = $this->nmgp_dados_select['certificado'];  
                  $this->numero_carne_sisben = $this->nmgp_dados_select['numero_carne_sisben'];  
                  $this->nivel_sisben = $this->nmgp_dados_select['nivel_sisben'];  
                  $this->estrato = $this->nmgp_dados_select['estrato'];  
                  $this->fuente_recurso = $this->nmgp_dados_select['fuente_recurso'];  
                  $this->opcion = $this->nmgp_dados_select['opcion'];  
                  $this->resguardo = $this->nmgp_dados_select['resguardo'];  
                  $this->negritudes = $this->nmgp_dados_select['negritudes'];  
                  $this->etnia = $this->nmgp_dados_select['etnia'];  
                  $this->discapacidades = $this->nmgp_dados_select['discapacidades'];  
                  $this->capacidades = $this->nmgp_dados_select['capacidades'];  
                  ...
                  $this->talla = $this->nmgp_dados_select['talla'];  
                  $this->cobertura = $this->nmgp_dados_select['cobertura'];  
                  $this->vive_con = $this->nmgp_dados_select['vive_con'];  
                  $this->subsidio = $this->nmgp_dados_select['subsidio'];  
                  $this->novedades = $this->nmgp_dados_select['novedades'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['foreign_key']))
          {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_photo))
       {
        ...
        include_once("form_students_mob_form0.php");
        include_once("form_students_mob_form1.php");
        include_once("form_students_mob_form2.php");
        include_once("form_students_mob_form3.php");
        include_once("form_students_mob_form4.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_students_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      $Nm_datas['fecha_matricula'] = "date";$Nm_datas['fecha_nacimiento'] = "date";$Nm_datas['last_year'] = "date";$Nm_datas['fecha_expulsion'] = "date";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_students_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_students_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
