...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_students_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_students_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
    document.getElementById('form_students_mob_form0').style.width='1px';
    document.getElementById('form_students_mob_form0').style.height='0px';
    document.getElementById('form_students_mob_form0').style.display='none';
    document.getElementById('form_students_mob_form0').style.overflow='scroll';
    document.getElementById('form_students_mob_form1').style.width='1px';
    document.getElementById('form_students_mob_form1').style.height='0px';
    document.getElementById('form_students_mob_form1').style.display='none';
    document.getElementById('form_students_mob_form1').style.overflow='scroll';
    document.getElementById('form_students_mob_form2').style.width='1px';
    document.getElementById('form_students_mob_form2').style.height='0px';
    document.getElementById('form_students_mob_form2').style.display='none';
    document.getElementById('form_students_mob_form2').style.overflow='scroll';
    document.getElementById('form_students_mob_form3').style.width='1px';
    document.getElementById('form_students_mob_form3').style.height='0px';
    document.getElementById('form_students_mob_form3').style.display='none';
    document.getElementById('form_students_mob_form3').style.overflow='scroll';
    document.getElementById('form_students_mob_form4').style.width='1px';
    document.getElementById('form_students_mob_form4').style.height='0px';
    document.getElementById('form_students_mob_form4').style.display='none';
    document.getElementById('form_students_mob_form4').style.overflow='scroll';
   ...
   if ("form_students_mob_form4" == N_pagina) {
