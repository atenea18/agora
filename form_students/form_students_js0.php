<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idstudents" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idstudents']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_students"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_par_idstudents = "<?php echo $this->form_encode_input($this->nmgp_dados_form['idstudents']); ?>";
function sc_btn_sc_btn_0()
{
  ...
  tb_show('', '<?php echo $this->Ini->link_form_matricula_edit; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&script_case_session=<?php echo session_id() ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "par_idstudents*scin' + var_btn_sc_btn_0_par_idstudents + '*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutsc_redir_atualiz*scinok*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=400&width=450&modal=true', '');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_students_form0').style.width='1px';
    document.getElementById('form_students_form0').style.height='0px';
    document.getElementById('form_students_form0').style.display='none';
    document.getElementById('form_students_form0').style.overflow='scroll';
    document.getElementById('form_students_form1').style.width='1px';
    document.getElementById('form_students_form1').style.height='0px';
    document.getElementById('form_students_form1').style.display='none';
    document.getElementById('form_students_form1').style.overflow='scroll';
    document.getElementById('form_students_form2').style.width='1px';
    document.getElementById('form_students_form2').style.height='0px';
    document.getElementById('form_students_form2').style.display='none';
    document.getElementById('form_students_form2').style.overflow='scroll';
    document.getElementById('form_students_form3').style.width='1px';
    document.getElementById('form_students_form3').style.height='0px';
    document.getElementById('form_students_form3').style.display='none';
    document.getElementById('form_students_form3').style.overflow='scroll';
    document.getElementById('form_students_form4').style.width='1px';
    document.getElementById('form_students_form4').style.height='0px';
    document.getElementById('form_students_form4').style.display='none';
    document.getElementById('form_students_form4').style.overflow='scroll';
   ...
   if ("form_students_form4" == N_pagina) {
