...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_t_grupos_calif_m_normal_vaios_doce']['contr_erro']) && $_SESSION['scriptcase']['grid_t_grupos_calif_m_normal_vaios_doce']['contr_erro'] == 'on')
    {
