...
class grid_desem_notas_seg_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_desem_notas_seg_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_desem_notas_seg.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_desem_notas_seg']['contr_erro'] = 'off'; 
   ...
   function NM_export_desem_asig1()
   {
         ...
         $this->desem_asig1 = str_replace('<', '&lt;', $this->desem_asig1);
         $this->desem_asig1 = str_replace('>', '&gt;', $this->desem_asig1);
         $this->Texto_tag .= "<td>" . $this->desem_asig1 . "</td>\r\n";
   }
   //----- desem_asig2
   function NM_export_desem_asig2()
   {
         ...
         $this->desem_asig2 = str_replace('<', '&lt;', $this->desem_asig2);
         $this->desem_asig2 = str_replace('>', '&gt;', $this->desem_asig2);
         $this->Texto_tag .= "<td>" . $this->desem_asig2 . "</td>\r\n";
   }
   //----- desem_asig3
   function NM_export_desem_asig3()
   {
         ...
         $this->desem_asig3 = str_replace('<', '&lt;', $this->desem_asig3);
         $this->desem_asig3 = str_replace('>', '&gt;', $this->desem_asig3);
         $this->Texto_tag .= "<td>" . $this->desem_asig3 . "</td>\r\n";
   }
   //----- desem_asig4
   function NM_export_desem_asig4()
   {
         ...
         $this->desem_asig4 = str_replace('<', '&lt;', $this->desem_asig4);
         $this->desem_asig4 = str_replace('>', '&gt;', $this->desem_asig4);
         $this->Texto_tag .= "<td>" . $this->desem_asig4 . "</td>\r\n";
   }
   //----- desem_asig5
   function NM_export_desem_asig5()
   {
         ...
         $this->desem_asig5 = str_replace('<', '&lt;', $this->desem_asig5);
         $this->desem_asig5 = str_replace('>', '&gt;', $this->desem_asig5);
         $this->Texto_tag .= "<td>" . $this->desem_asig5 . "</td>\r\n";
   }
   //----- desem_asig6
   function NM_export_desem_asig6()
   {
         ...
         $this->desem_asig6 = str_replace('<', '&lt;', $this->desem_asig6);
         $this->desem_asig6 = str_replace('>', '&gt;', $this->desem_asig6);
         $this->Texto_tag .= "<td>" . $this->desem_asig6 . "</td>\r\n";
   }
   //----- desem_asig7
   function NM_export_desem_asig7()
   {
         ...
         $this->desem_asig7 = str_replace('<', '&lt;', $this->desem_asig7);
         $this->desem_asig7 = str_replace('>', '&gt;', $this->desem_asig7);
         $this->Texto_tag .= "<td>" . $this->desem_asig7 . "</td>\r\n";
   }
   //----- desem_asig8
   function NM_export_desem_asig8()
   {
         ...
         $this->desem_asig8 = str_replace('<', '&lt;', $this->desem_asig8);
         $this->desem_asig8 = str_replace('>', '&gt;', $this->desem_asig8);
         $this->Texto_tag .= "<td>" . $this->desem_asig8 . "</td>\r\n";
   }
   //----- desem_asig9
   function NM_export_desem_asig9()
   {
         ...
         $this->desem_asig9 = str_replace('<', '&lt;', $this->desem_asig9);
         $this->desem_asig9 = str_replace('>', '&gt;', $this->desem_asig9);
         $this->Texto_tag .= "<td>" . $this->desem_asig9 . "</td>\r\n";
   }
   //----- desem_asig10
   function NM_export_desem_asig10()
   {
         ...
         $this->desem_asig10 = str_replace('<', '&lt;', $this->desem_asig10);
         $this->desem_asig10 = str_replace('>', '&gt;', $this->desem_asig10);
         $this->Texto_tag .= "<td>" . $this->desem_asig10 . "</td>\r\n";
   }
   //----- desem_asig11
   function NM_export_desem_asig11()
   {
         ...
         $this->desem_asig11 = str_replace('<', '&lt;', $this->desem_asig11);
         $this->desem_asig11 = str_replace('>', '&gt;', $this->desem_asig11);
         $this->Texto_tag .= "<td>" . $this->desem_asig11 . "</td>\r\n";
   }
   //----- desem_asig12
   function NM_export_desem_asig12()
   {
         ...
         $this->desem_asig12 = str_replace('<', '&lt;', $this->desem_asig12);
         $this->desem_asig12 = str_replace('>', '&gt;', $this->desem_asig12);
         $this->Texto_tag .= "<td>" . $this->desem_asig12 . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - desem_notas :: RTF</TITLE>
