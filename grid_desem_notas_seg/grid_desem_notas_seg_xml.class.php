...
class grid_desem_notas_seg_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_desem_notas_seg_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_desem_notas_seg.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_desem_notas_seg";
...
$_SESSION['scriptcase']['grid_desem_notas_seg']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig4))
         {
             $this->desem_asig4 = sc_convert_encoding($this->desem_asig4, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig4 =\"" . $this->trata_dados($this->desem_asig4) . "\"";
   }
   //----- desem_asig5
   function NM_export_desem_asig5()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig5))
         {
             $this->desem_asig5 = sc_convert_encoding($this->desem_asig5, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig5 =\"" . $this->trata_dados($this->desem_asig5) . "\"";
   }
   //----- desem_asig6
   function NM_export_desem_asig6()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig6))
         {
             $this->desem_asig6 = sc_convert_encoding($this->desem_asig6, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig6 =\"" . $this->trata_dados($this->desem_asig6) . "\"";
   }
   //----- desem_asig7
   function NM_export_desem_asig7()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig7))
         {
             $this->desem_asig7 = sc_convert_encoding($this->desem_asig7, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig7 =\"" . $this->trata_dados($this->desem_asig7) . "\"";
   }
   //----- desem_asig8
   function NM_export_desem_asig8()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig8))
         {
             $this->desem_asig8 = sc_convert_encoding($this->desem_asig8, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig8 =\"" . $this->trata_dados($this->desem_asig8) . "\"";
   }
   //----- desem_asig9
   function NM_export_desem_asig9()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig9))
         {
             $this->desem_asig9 = sc_convert_encoding($this->desem_asig9, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig9 =\"" . $this->trata_dados($this->desem_asig9) . "\"";
   }
   //----- desem_asig10
   function NM_export_desem_asig10()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig10))
         {
             $this->desem_asig10 = sc_convert_encoding($this->desem_asig10, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig10 =\"" . $this->trata_dados($this->desem_asig10) . "\"";
   }
   //----- desem_asig11
   function NM_export_desem_asig11()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig11))
         {
             $this->desem_asig11 = sc_convert_encoding($this->desem_asig11, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig11 =\"" . $this->trata_dados($this->desem_asig11) . "\"";
   }
   //----- desem_asig12
   function NM_export_desem_asig12()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->desem_asig12))
         {
             $this->desem_asig12 = sc_convert_encoding($this->desem_asig12, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " desem_asig12 =\"" . $this->trata_dados($this->desem_asig12) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
