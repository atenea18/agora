<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_desem_notas_seg_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_desem_notas_seg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['desem_asig1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig1'] = "desem_asig1";
       $tab_converte["desem_asig1"]   = "desem_asig1";
   }
   else
   {
       $tab_def_campos['desem_asig1'] = "";
       $tab_converte[""]   = "desem_asig1";
   }
   $tab_labels["desem_asig1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig1"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig1"] : "desem_asig1";
   $tab_ger_campos['desem_asig2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig2'] = "desem_asig2";
       $tab_converte["desem_asig2"]   = "desem_asig2";
   }
   else
   {
       $tab_def_campos['desem_asig2'] = "";
       $tab_converte[""]   = "desem_asig2";
   }
   $tab_labels["desem_asig2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig2"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig2"] : "desem_asig2";
   $tab_ger_campos['desem_asig3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig3'] = "desem_asig3";
       $tab_converte["desem_asig3"]   = "desem_asig3";
   }
   else
   {
       $tab_def_campos['desem_asig3'] = "";
       $tab_converte[""]   = "desem_asig3";
   }
   $tab_labels["desem_asig3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig3"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig3"] : "desem_asig3";
   $tab_ger_campos['desem_asig4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig4'] = "desem_asig4";
       $tab_converte["desem_asig4"]   = "desem_asig4";
   }
   else
   {
       $tab_def_campos['desem_asig4'] = "";
       $tab_converte[""]   = "desem_asig4";
   }
   $tab_labels["desem_asig4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig4"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig4"] : "desem_asig4";
   $tab_ger_campos['desem_asig5'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig5'] = "desem_asig5";
       $tab_converte["desem_asig5"]   = "desem_asig5";
   }
   else
   {
       $tab_def_campos['desem_asig5'] = "";
       $tab_converte[""]   = "desem_asig5";
   }
   $tab_labels["desem_asig5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig5"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig5"] : "desem_asig5";
   $tab_ger_campos['desem_asig6'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig6'] = "desem_asig6";
       $tab_converte["desem_asig6"]   = "desem_asig6";
   }
   else
   {
       $tab_def_campos['desem_asig6'] = "";
       $tab_converte[""]   = "desem_asig6";
   }
   $tab_labels["desem_asig6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig6"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig6"] : "desem_asig6";
   $tab_ger_campos['desem_asig7'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig7'] = "desem_asig7";
       $tab_converte["desem_asig7"]   = "desem_asig7";
   }
   else
   {
       $tab_def_campos['desem_asig7'] = "";
       $tab_converte[""]   = "desem_asig7";
   }
   $tab_labels["desem_asig7"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig7"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig7"] : "desem_asig7";
   $tab_ger_campos['desem_asig8'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig8'] = "desem_asig8";
       $tab_converte["desem_asig8"]   = "desem_asig8";
   }
   else
   {
       $tab_def_campos['desem_asig8'] = "";
       $tab_converte[""]   = "desem_asig8";
   }
   $tab_labels["desem_asig8"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig8"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig8"] : "desem_asig8";
   $tab_ger_campos['desem_asig9'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig9'] = "desem_asig9";
       $tab_converte["desem_asig9"]   = "desem_asig9";
   }
   else
   {
       $tab_def_campos['desem_asig9'] = "";
       $tab_converte[""]   = "desem_asig9";
   }
   $tab_labels["desem_asig9"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig9"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig9"] : "desem_asig9";
   $tab_ger_campos['desem_asig10'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig10'] = "desem_asig10";
       $tab_converte["desem_asig10"]   = "desem_asig10";
   }
   else
   {
       $tab_def_campos['desem_asig10'] = "";
       $tab_converte[""]   = "desem_asig10";
   }
   $tab_labels["desem_asig10"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig10"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig10"] : "desem_asig10";
   $tab_ger_campos['desem_asig11'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig11'] = "desem_asig11";
       $tab_converte["desem_asig11"]   = "desem_asig11";
   }
   else
   {
       $tab_def_campos['desem_asig11'] = "";
       $tab_converte[""]   = "desem_asig11";
   }
   $tab_labels["desem_asig11"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig11"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig11"] : "desem_asig11";
   $tab_ger_campos['desem_asig12'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig12'] = "desem_asig12";
       $tab_converte["desem_asig12"]   = "desem_asig12";
   }
   else
   {
       $tab_def_campos['desem_asig12'] = "";
       $tab_converte[""]   = "desem_asig12";
   }
   $tab_labels["desem_asig12"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig12"])) ? $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['labels']["desem_asig12"] : "desem_asig12";
   $tab_ger_campos['desem_asig1'] = "none";
   $tab_ger_campos['desem_asig2'] = "none";
   $tab_ger_campos['desem_asig3'] = "none";
   $tab_ger_campos['desem_asig4'] = "none";
   $tab_ger_campos['desem_asig5'] = "none";
   $tab_ger_campos['desem_asig6'] = "none";
   $tab_ger_campos['desem_asig7'] = "none";
   $tab_ger_campos['desem_asig8'] = "none";
   $tab_ger_campos['desem_asig9'] = "none";
   $tab_ger_campos['desem_asig10'] = "none";
   $tab_ger_campos['desem_asig11'] = "none";
   $tab_ger_campos['desem_asig12'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_desem_notas_seg']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_desem_notas_seg']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_desem_notas_seg']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - desem_notas</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_desem_notas_seg_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_desem_notas_seg']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
