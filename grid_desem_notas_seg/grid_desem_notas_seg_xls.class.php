...
class grid_desem_notas_seg_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $Tit_doc;
   //---- 
   function grid_desem_notas_seg_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_desem_notas_seg.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      { 
          ...
          if ($Cada_col == "desem_asig2" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig3" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig4" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig5" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig6" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig7" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig8" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig9" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig10" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig11" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "desem_asig12" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$_SESSION['scriptcase']['grid_desem_notas_seg']['contr_erro'] = 'off'; 
   ...
   {
         $this->desem_asig2 = html_entity_decode($this->desem_asig2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig2 = strip_tags($this->desem_asig2);
         if (!NM_is_utf8($this->desem_asig2))
         {
             $this->desem_asig2 = sc_convert_encoding($this->desem_asig2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig3
   function NM_export_desem_asig3()
   {
         $this->desem_asig3 = html_entity_decode($this->desem_asig3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig3 = strip_tags($this->desem_asig3);
         if (!NM_is_utf8($this->desem_asig3))
         {
             $this->desem_asig3 = sc_convert_encoding($this->desem_asig3, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig4
   function NM_export_desem_asig4()
   {
         $this->desem_asig4 = html_entity_decode($this->desem_asig4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig4 = strip_tags($this->desem_asig4);
         if (!NM_is_utf8($this->desem_asig4))
         {
             $this->desem_asig4 = sc_convert_encoding($this->desem_asig4, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig5
   function NM_export_desem_asig5()
   {
         $this->desem_asig5 = html_entity_decode($this->desem_asig5, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig5 = strip_tags($this->desem_asig5);
         if (!NM_is_utf8($this->desem_asig5))
         {
             $this->desem_asig5 = sc_convert_encoding($this->desem_asig5, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig6
   function NM_export_desem_asig6()
   {
         $this->desem_asig6 = html_entity_decode($this->desem_asig6, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig6 = strip_tags($this->desem_asig6);
         if (!NM_is_utf8($this->desem_asig6))
         {
             $this->desem_asig6 = sc_convert_encoding($this->desem_asig6, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig7
   function NM_export_desem_asig7()
   {
         $this->desem_asig7 = html_entity_decode($this->desem_asig7, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig7 = strip_tags($this->desem_asig7);
         if (!NM_is_utf8($this->desem_asig7))
         {
             $this->desem_asig7 = sc_convert_encoding($this->desem_asig7, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig8
   function NM_export_desem_asig8()
   {
         $this->desem_asig8 = html_entity_decode($this->desem_asig8, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig8 = strip_tags($this->desem_asig8);
         if (!NM_is_utf8($this->desem_asig8))
         {
             $this->desem_asig8 = sc_convert_encoding($this->desem_asig8, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig9
   function NM_export_desem_asig9()
   {
         $this->desem_asig9 = html_entity_decode($this->desem_asig9, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig9 = strip_tags($this->desem_asig9);
         if (!NM_is_utf8($this->desem_asig9))
         {
             $this->desem_asig9 = sc_convert_encoding($this->desem_asig9, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig10
   function NM_export_desem_asig10()
   {
         $this->desem_asig10 = html_entity_decode($this->desem_asig10, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig10 = strip_tags($this->desem_asig10);
         if (!NM_is_utf8($this->desem_asig10))
         {
             $this->desem_asig10 = sc_convert_encoding($this->desem_asig10, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig11
   function NM_export_desem_asig11()
   {
         $this->desem_asig11 = html_entity_decode($this->desem_asig11, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig11 = strip_tags($this->desem_asig11);
         if (!NM_is_utf8($this->desem_asig11))
         {
             $this->desem_asig11 = sc_convert_encoding($this->desem_asig11, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- desem_asig12
   function NM_export_desem_asig12()
   {
         $this->desem_asig12 = html_entity_decode($this->desem_asig12, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->desem_asig12 = strip_tags($this->desem_asig12);
         if (!NM_is_utf8($this->desem_asig12))
         {
             $this->desem_asig12 = sc_convert_encoding($this->desem_asig12, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->desem_asig12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_desem_notas_seg']['xls_file'] = $this->Xls_f;
      }
