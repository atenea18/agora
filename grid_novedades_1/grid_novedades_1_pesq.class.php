...
class grid_novedades_1_pesq
{
    ...
    * @access  public
    */
   function grid_novedades_1_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_novedades_1_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_novedades_1_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_novedades_1_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_novedad')
      {
          $novedad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_novedad($novedad);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_novedad($id_novedad)
   {
      ...
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where  id_novedad like '%" . $id_novedad . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where  id_novedad like '%" . $id_novedad . "%'"; 
   ...
   function lookup_ajax_novedad($novedad)
   {
      $novedad = substr($this->Db->qstr($novedad), 1, -1);
            $novedad_look = substr($this->Db->qstr($novedad), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct novedad from " . $this->Ini->nm_tabela . " where  novedad like '%" . $novedad . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - novedades</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_novedades_1/grid_novedades_1_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_novedades_1_ajax_search.js"></script>
 <script type="text/javascript" src="grid_novedades_1_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_novedad_cond#NMF#' + search_get_sel_txt('SC_novedad_cond') + '@NMF@';
  str_out += 'SC_novedad#NMF#' + search_get_text('SC_novedad') + '@NMF@';
  str_out += 'id_ac_novedad#NMF#' + search_get_text('id_ac_novedad') + '@NMF@';
   ...
   $("#id_ac_novedad").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_novedad",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_novedad").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_novedad").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - novedades</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $novedad_cond, $novedad, $novedad_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_novedad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['id_novedad']; 
          $id_novedad_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['id_novedad_input_2']; 
          $id_novedad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['id_novedad_cond']; 
          $novedad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['novedad']; 
          $novedad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['novedad_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_novedad_cond) || empty($id_novedad_cond))
      {
         $id_novedad_cond = "gt";
      }
      if (!isset($novedad_cond) || empty($novedad_cond))
      {
         $novedad_cond = "qp";
      }
      ...
      $str_hide_novedad = (in_array($novedad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($novedad) || $novedad == "")
      {
          $novedad = "";
      }
      if (isset($novedad) && !empty($novedad))
      {
         $tmp_pos = strpos($novedad, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $novedad = substr($novedad, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_novedades_1_help.txt"))
   {
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where id_novedad = $id_novedad_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where id_novedad = $id_novedad_look"; 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_novedad" name="id_novedad_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['novedad'])) ? $this->New_label['novedad'] : "Novedad"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_novedad_cond" name="novedad_cond" onChange="nm_campos_between(document.getElementById('id_vis_novedad'), this, 'novedad')">
       <OPTION value="qp" <?php if ("qp" == $novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_novedad" <?php echo $str_hide_novedad?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['novedad'])) ? $this->New_label['novedad'] : "Novedad";
 $nmgp_tab_label .= "novedad?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $novedad_look = substr($this->Db->qstr($novedad), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct novedad from " . $this->Ini->nm_tabela . " where novedad = '$novedad_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$novedad]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$novedad];
      }
      else
      {
          $sAutocompValue = $novedad;
      }
?>
<INPUT  type="text" id="SC_novedad" name="novedad" value="<?php echo NM_encode_input($novedad) ?>" size=50 alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_novedad" name="novedad_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_novedades_1']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_novedades_1']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_novedad'), document.F1.novedad_cond, 'novedad');
   document.F1.novedad.value = "";
   document.F1.novedad_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_novedades_1";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_novedad_cond'] = 'cond';
      $tp_fields['SC_novedad'] = 'text_aut';
      $tp_fields['id_ac_novedad'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $id_novedad_cond, $id_novedad, $id_novedad_input_2, $id_novedad_autocomp,
             $novedad_cond, $novedad, $novedad_autocomp, $nmgp_tab_label;
      ...
      if (!empty($novedad_autocomp) && empty($novedad))
      {
          $novedad = $novedad_autocomp;
      }
      ...
      $novedad_cond_salva = $novedad_cond; 
      if (!isset($novedad_input_2) || $novedad_input_2 == "")
      {
          $novedad_input_2 = $novedad;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['id_novedad'] = $id_novedad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['id_novedad_input_2'] = $id_novedad_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['id_novedad_cond'] = $id_novedad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['novedad'] = $novedad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['novedad_cond'] = $novedad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['novedad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['novedad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['novedad'] = $novedad;
      }
      ...
      //----- $novedad
      $this->Date_part = false;
      if (isset($novedad) || $novedad_cond == "nu" || $novedad_cond == "nn" || $novedad_cond == "ep" || $novedad_cond == "ne")
      {
         $this->monta_condicao("novedad", $novedad_cond, $novedad, "", "novedad");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_1']['where_pesq_ant'] = $this->comando . $this->comando_fim;
