...
<?php
include_once("control_agrupa_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_agrupa_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['recarga'];
}
?>
...
<?php
 include_once("control_agrupa_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_agrupa'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_agrupa'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_password_label" id="hidden_field_label_password" style="<?php echo $sStyleHidden_password; ?>"><span id="id_label_password"><?php echo $this->nm_new_label['password']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['php_cmp_required']['password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['php_cmp_required']['password'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_agrupa']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_agrupa");
 parent.scAjaxDetailHeight("control_agrupa", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
