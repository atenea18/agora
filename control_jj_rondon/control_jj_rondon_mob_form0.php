...
<?php
include_once("control_jj_rondon_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_jj_rondon_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['recarga'];
}
?>
...
<?php
 include_once("control_jj_rondon_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_jj_rondon_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_jj_rondon_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_jj_rondon_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_documento_line" id="hidden_field_data_documento" style="<?php echo $sStyleHidden_documento; ?>"> <span class="scFormLabelOddFormat css_documento_label"><span id="id_label_documento"><?php echo $this->nm_new_label['documento']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['Lookup_documento'][] = '2'; ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_jj_rondon_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_jj_rondon_mob");
 parent.scAjaxDetailHeight("control_jj_rondon_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
