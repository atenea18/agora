...
class grid_evaluacion_asignaturas_n_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_evaluacion_asignaturas_n_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_evaluacion_asignaturas_n.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_n']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_n']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_n']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_n']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_evaluacion_asignaturas_n";
...
$_SESSION['scriptcase']['grid_evaluacion_asignaturas_n']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_n']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_n']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
