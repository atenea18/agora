...
//----- 
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_calendar_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_calendar_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - calendar";
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_calendar_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['where_orig'] = " where login = '" . $_SESSION['usr_login'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['where_pesq'] = " where login = '" . $_SESSION['usr_login'] . "'";
    ...
    function ValidateField_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_start_date' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['php_cmp_required']['start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['php_cmp_required']['start_date'] == "on")) 
           { 
...
$aLookup[] = array(calendar_calendar_mob_pack_protect_string('Y') => calendar_calendar_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_yes'] . ""));
$aLookup[] = array(calendar_calendar_mob_pack_protect_string('N') => calendar_calendar_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_no'] . ""));
...
$aLookup[] = array(calendar_calendar_mob_pack_protect_string('D') => calendar_calendar_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_daily'] . ""));
$aLookup[] = array(calendar_calendar_mob_pack_protect_string('W') => calendar_calendar_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_weekly'] . ""));
$aLookup[] = array(calendar_calendar_mob_pack_protect_string('A') => calendar_calendar_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_annual'] . ""));
...
$aLookup[] = array(calendar_calendar_mob_pack_protect_string('Y') => calendar_calendar_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . ""));
   ...
   { 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start'] = 0; 
              }
...
//---------- 
      ...
      { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start']) ;  
              } 
          } 
          ...
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['reg_start'] < $qt_geral_reg_calendar_calendar_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['opcao']   = '';
          }
      } 
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#calendar').fullCalendar({
      ...
      printUrl: "calendar_calendar_mob.php",
      editable: <?php echo ($this->calendarConfigValues['update'] ? 'true' : 'false'); ?>,
      events: 'calendar_calendar_mob.php?nmgp_opcao=calendar_fetch',
...
{
?>
        tb_show('', 'calendar_calendar_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_calendar_mob.php?nmgp_opcao=igual&id=' + calEvent.id + '&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['where_filter_form'] . " and (login = '" . $_SESSION['usr_login'] . "') and (" . $comando . ")";
      }
      else
      {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendar_mob']['sc_outra_jan'])
   {
