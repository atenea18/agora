...
class grid_t_estudiante_grupo_nuevo_det_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_t_estudiante_grupo_nuevo_det_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_t_estudiante_grupo_nuevo_det_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_t_estudiante_grupo_nuevo_det_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_t_estudiante_grupo_nuevo_det_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_students_tipo_identificacion')
      {
          $students_tipo_identificacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_students_tipo_identificacion($students_tipo_identificacion);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_students_numero_documento')
      {
          $students_numero_documento = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_students_numero_documento($students_numero_documento);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_students_tipo_identificacion($students_tipo_identificacion)
   {
      $students_tipo_identificacion = substr($this->Db->qstr($students_tipo_identificacion), 1, -1);
            $students_tipo_identificacion_look = substr($this->Db->qstr($students_tipo_identificacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct students.tipo_identificacion from " . $this->Ini->nm_tabela . " where t_estudiante_grupo.id_grupo=" . $_SESSION['par_grupo'] . " AND students.estatus LIKE 'N' and  students.tipo_identificacion like '%" . $students_tipo_identificacion . "%'"; 
   ...
   function lookup_ajax_students_numero_documento($students_numero_documento)
   {
      $students_numero_documento = substr($this->Db->qstr($students_numero_documento), 1, -1);
            $students_numero_documento_look = substr($this->Db->qstr($students_numero_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct students.numero_documento from " . $this->Ini->nm_tabela . " where t_estudiante_grupo.id_grupo=" . $_SESSION['par_grupo'] . " AND students.estatus LIKE 'N' and  students.numero_documento like '%" . $students_numero_documento . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_t_estudiante_grupo_nuevo_det/grid_t_estudiante_grupo_nuevo_det_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_t_estudiante_grupo_nuevo_det_ajax_search.js"></script>
 <script type="text/javascript" src="grid_t_estudiante_grupo_nuevo_det_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_students_tipo_identificacion_cond#NMF#' + search_get_sel_txt('SC_students_tipo_identificacion_cond') + '@NMF@';
  str_out += 'SC_students_tipo_identificacion#NMF#' + search_get_text('SC_students_tipo_identificacion') + '@NMF@';
  str_out += 'id_ac_students_tipo_identificacion#NMF#' + search_get_text('id_ac_students_tipo_identificacion') + '@NMF@';
  str_out += 'SC_students_numero_documento_cond#NMF#' + search_get_sel_txt('SC_students_numero_documento_cond') + '@NMF@';
  str_out += 'SC_students_numero_documento#NMF#' + search_get_text('SC_students_numero_documento') + '@NMF@';
  str_out += 'id_ac_students_numero_documento#NMF#' + search_get_text('id_ac_students_numero_documento') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_students_tipo_identificacion").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_students_tipo_identificacion",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_students_tipo_identificacion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_students_tipo_identificacion").val( $(this).val() );
       }
     }
   });
   $("#id_ac_students_numero_documento").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_students_numero_documento",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_students_numero_documento").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_students_numero_documento").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $students_tipo_identificacion_cond, $students_tipo_identificacion, $students_tipo_identificacion_autocomp,
             $students_numero_documento_cond, $students_numero_documento, $students_numero_documento_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $students_tipo_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_tipo_identificacion']; 
          $students_tipo_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_tipo_identificacion_cond']; 
          $students_numero_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_numero_documento']; 
          $students_numero_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_numero_documento_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['NM_operador']; 
      } 
      if (!isset($students_tipo_identificacion_cond) || empty($students_tipo_identificacion_cond))
      {
         $students_tipo_identificacion_cond = "qp";
      }
      if (!isset($students_numero_documento_cond) || empty($students_numero_documento_cond))
      {
         $students_numero_documento_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_students_tipo_identificacion = (in_array($students_tipo_identificacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_students_numero_documento = (in_array($students_numero_documento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($students_tipo_identificacion) || $students_tipo_identificacion == "")
      {
          $students_tipo_identificacion = "";
      }
      if (isset($students_tipo_identificacion) && !empty($students_tipo_identificacion))
      {
         $tmp_pos = strpos($students_tipo_identificacion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $students_tipo_identificacion = substr($students_tipo_identificacion, 0, $tmp_pos);
         }
      }
      if (!isset($students_numero_documento) || $students_numero_documento == "")
      {
          $students_numero_documento = "";
      }
      if (isset($students_numero_documento) && !empty($students_numero_documento))
      {
         $tmp_pos = strpos($students_numero_documento, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $students_numero_documento = substr($students_numero_documento, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_t_estudiante_grupo_nuevo_det_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['students_tipo_identificacion'])) ? $this->New_label['students_tipo_identificacion'] : "Tipo Documento"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_students_tipo_identificacion_cond" name="students_tipo_identificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_students_tipo_identificacion'), this, 'students_tipo_identificacion')">
       <OPTION value="qp" <?php if ("qp" == $students_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $students_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $students_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $students_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_students_tipo_identificacion" <?php echo $str_hide_students_tipo_identificacion?> valign="top">
 ...
 $nmgp_tab_label .= "students_tipo_identificacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $students_tipo_identificacion_look = substr($this->Db->qstr($students_tipo_identificacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct students.tipo_identificacion from " . $this->Ini->nm_tabela . " where t_estudiante_grupo.id_grupo=" . $_SESSION['par_grupo'] . " AND students.estatus LIKE 'N' and students.tipo_identificacion = '$students_tipo_identificacion_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$students_tipo_identificacion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$students_tipo_identificacion];
      }
      else
      {
          $sAutocompValue = $students_tipo_identificacion;
      }
?>
<INPUT  type="text" id="SC_students_tipo_identificacion" name="students_tipo_identificacion" value="<?php echo NM_encode_input($students_tipo_identificacion) ?>" size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_students_tipo_identificacion" name="students_tipo_identificacion_autocomp" size="6" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['students_numero_documento'])) ? $this->New_label['students_numero_documento'] : "Número Documento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_students_numero_documento_cond" name="students_numero_documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_students_numero_documento'), this, 'students_numero_documento')">
       <OPTION value="qp" <?php if ("qp" == $students_numero_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $students_numero_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $students_numero_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $students_numero_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_students_numero_documento" <?php echo $str_hide_students_numero_documento?> valign="top">
 ...
 $nmgp_tab_label .= "students_numero_documento?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $students_numero_documento_look = substr($this->Db->qstr($students_numero_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct students.numero_documento from " . $this->Ini->nm_tabela . " where t_estudiante_grupo.id_grupo=" . $_SESSION['par_grupo'] . " AND students.estatus LIKE 'N' and students.numero_documento = '$students_numero_documento_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$students_numero_documento]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$students_numero_documento];
      }
      else
      {
          $sAutocompValue = $students_numero_documento;
      }
?>
<INPUT  type="text" id="SC_students_numero_documento" name="students_numero_documento" value="<?php echo NM_encode_input($students_numero_documento) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_students_numero_documento" name="students_numero_documento_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_estudiante_grupo_nuevo_det']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_estudiante_grupo_nuevo_det']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_students_tipo_identificacion'), document.F1.students_tipo_identificacion_cond, 'students_tipo_identificacion');
   document.F1.students_tipo_identificacion.value = "";
   document.F1.students_tipo_identificacion_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_students_numero_documento'), document.F1.students_numero_documento_cond, 'students_numero_documento');
   document.F1.students_numero_documento.value = "";
   document.F1.students_numero_documento_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_t_estudiante_grupo_nuevo_det";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_t_estudiante_grupo_nuevo_det/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_students_tipo_identificacion_cond'] = 'cond';
      $tp_fields['SC_students_tipo_identificacion'] = 'text_aut';
      $tp_fields['id_ac_students_tipo_identificacion'] = 'text_aut';
      $tp_fields['SC_students_numero_documento_cond'] = 'cond';
      $tp_fields['SC_students_numero_documento'] = 'text_aut';
      $tp_fields['id_ac_students_numero_documento'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $students_tipo_identificacion_cond, $students_tipo_identificacion, $students_tipo_identificacion_autocomp,
             $students_numero_documento_cond, $students_numero_documento, $students_numero_documento_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($students_tipo_identificacion_autocomp) && empty($students_tipo_identificacion))
      {
          $students_tipo_identificacion = $students_tipo_identificacion_autocomp;
      }
      if (!empty($students_numero_documento_autocomp) && empty($students_numero_documento))
      {
          $students_numero_documento = $students_numero_documento_autocomp;
      }
      $students_tipo_identificacion_cond_salva = $students_tipo_identificacion_cond; 
      if (!isset($students_tipo_identificacion_input_2) || $students_tipo_identificacion_input_2 == "")
      {
          $students_tipo_identificacion_input_2 = $students_tipo_identificacion;
      }
      $students_numero_documento_cond_salva = $students_numero_documento_cond; 
      if (!isset($students_numero_documento_input_2) || $students_numero_documento_input_2 == "")
      {
          $students_numero_documento_input_2 = $students_numero_documento;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_tipo_identificacion'] = $students_tipo_identificacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_tipo_identificacion_cond'] = $students_tipo_identificacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_numero_documento'] = $students_numero_documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['students_numero_documento_cond'] = $students_numero_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['students_tipo_identificacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['students_tipo_identificacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['students_tipo_identificacion'] = $students_tipo_identificacion;
      }
      $students_numero_documento_look = substr($this->Db->qstr($students_numero_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct students.numero_documento from " . $this->Ini->nm_tabela . " where t_estudiante_grupo.id_grupo=" . $_SESSION['par_grupo'] . " AND students.estatus LIKE 'N' and students.numero_documento = '$students_numero_documento_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['students_numero_documento'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['students_numero_documento'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['students_numero_documento'] = $students_numero_documento;
      }

      //----- $students_tipo_identificacion
      $this->Date_part = false;
      if (isset($students_tipo_identificacion) || $students_tipo_identificacion_cond == "nu" || $students_tipo_identificacion_cond == "nn" || $students_tipo_identificacion_cond == "ep" || $students_tipo_identificacion_cond == "ne")
      {
         $this->monta_condicao("students.tipo_identificacion", $students_tipo_identificacion_cond, $students_tipo_identificacion, "", "students_tipo_identificacion");
      }

      //----- $students_numero_documento
      $this->Date_part = false;
      if (isset($students_numero_documento) || $students_numero_documento_cond == "nu" || $students_numero_documento_cond == "nn" || $students_numero_documento_cond == "ep" || $students_numero_documento_cond == "ne")
      {
         $this->monta_condicao("students.numero_documento", $students_numero_documento_cond, $students_numero_documento, "", "students_numero_documento");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['where_pesq_ant'] = $this->comando . $this->comando_fim;
