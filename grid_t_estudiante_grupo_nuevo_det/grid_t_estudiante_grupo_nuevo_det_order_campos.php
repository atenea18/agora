<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_estudiante_grupo_nuevo_det_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_estudiante_grupo_nuevo_det_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["students_estatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_estatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_estatus"] : "Estatus";
   ...
   $tab_labels["students_tipo_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_tipo_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_tipo_identificacion"] : "Tipo Documento";
   ...
   $tab_labels["students_numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_numero_documento"] : "Número Documento";
   $tab_ger_campos['t_estudiante_grupo_idstudent'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_estudiante_grupo_idstudent'] = "t_estudiante_grupo_idstudent";
       $tab_converte["t_estudiante_grupo_idstudent"]   = "t_estudiante_grupo_idstudent";
   }
   else
   {
       $tab_def_campos['t_estudiante_grupo_idstudent'] = "t_estudiante_grupo.idstudent";
       $tab_converte["t_estudiante_grupo.idstudent"]   = "t_estudiante_grupo_idstudent";
   }
   $tab_labels["t_estudiante_grupo_idstudent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["t_estudiante_grupo_idstudent"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["t_estudiante_grupo_idstudent"] : "Código";
   ...
   $tab_labels["students_primer_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_primer_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_primer_apellido"] : "Primer Apellido";
   ...
   $tab_labels["students_segundo_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_segundo_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_segundo_apellido"] : "Segundo Apellido";
   $tab_ger_campos['students_primer_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_primer_nombre'] = "students_primer_nombre";
       $tab_converte["students_primer_nombre"]   = "students_primer_nombre";
   }
   else
   {
       $tab_def_campos['students_primer_nombre'] = "students.primer_nombre";
       $tab_converte["students.primer_nombre"]   = "students_primer_nombre";
   }
   $tab_labels["students_primer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_primer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_primer_nombre"] : "Primer Nombre";
   $tab_ger_campos['students_segundo_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_segundo_nombre'] = "students_segundo_nombre";
       $tab_converte["students_segundo_nombre"]   = "students_segundo_nombre";
   }
   else
   {
       $tab_def_campos['students_segundo_nombre'] = "students.segundo_nombre";
       $tab_converte["students.segundo_nombre"]   = "students_segundo_nombre";
   }
   $tab_labels["students_segundo_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_segundo_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['labels']["students_segundo_nombre"] : "Segundo Nombre";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_estudiante_grupo_nuevo_det_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_nuevo_det']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
