...
class grid_t_estudiante_grupo_nuevo_det_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_estudiante_grupo_nuevo_det_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_t_estudiante_grupo_nuevo_det.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['rtf_name']);
      }
   ...
   function NM_export_t_estudiante_grupo_idstudent()
   {
         ...
         $this->t_estudiante_grupo_idstudent = str_replace('<', '&lt;', $this->t_estudiante_grupo_idstudent);
         $this->t_estudiante_grupo_idstudent = str_replace('>', '&gt;', $this->t_estudiante_grupo_idstudent);
         $this->Texto_tag .= "<td>" . $this->t_estudiante_grupo_idstudent . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_nuevo_det']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
