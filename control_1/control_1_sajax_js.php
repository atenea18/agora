...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate entorno
  function do_ajax_control_1_validate_entorno()
  {
    var nomeCampo_entorno = "entorno";
    var var_entorno = scAjaxGetFieldSelect(nomeCampo_entorno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_1_validate_entorno(var_entorno, var_script_case_init, do_ajax_control_1_validate_entorno_cb);
  } // do_ajax_control_1_validate_entorno

  function do_ajax_control_1_validate_entorno_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_1_validate_entorno_cb
  // ---------- Form
  function do_ajax_control_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_1_submit_form(var_entorno, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_1_submit_form_cb);
  } // do_ajax_control_1_submit_form

  function do_ajax_control_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_1_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_1_navigate_form

  function do_ajax_control_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_1_navigate_form_cb
  function sc_hide_control_1_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_1_form
