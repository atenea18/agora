  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_evento_docentes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate sede
  function do_ajax_control_evento_docentes_mob_validate_sede()
  {
    var nomeCampo_sede = "sede";
    var var_sede = scAjaxGetFieldSelect(nomeCampo_sede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_evento_docentes_mob_validate_sede(var_sede, var_script_case_init, do_ajax_control_evento_docentes_mob_validate_sede_cb);
  } // do_ajax_control_evento_docentes_mob_validate_sede

  function do_ajax_control_evento_docentes_mob_validate_sede_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_evento_docentes_mob_validate_sede_cb

  // ---------- Validate evento
  function do_ajax_control_evento_docentes_mob_validate_evento()
  {
    var nomeCampo_evento = "evento";
    var var_evento = scAjaxGetFieldText(nomeCampo_evento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_evento_docentes_mob_validate_evento(var_evento, var_script_case_init, do_ajax_control_evento_docentes_mob_validate_evento_cb);
  } // do_ajax_control_evento_docentes_mob_validate_evento

  function do_ajax_control_evento_docentes_mob_validate_evento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "evento";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_evento_docentes_mob_validate_evento_cb
  // ---------- Form
  function do_ajax_control_evento_docentes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_evento_docentes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_evento_docentes_mob_submit_form(var_sede, var_evento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_evento_docentes_mob_submit_form_cb);
  } // do_ajax_control_evento_docentes_mob_submit_form

  function do_ajax_control_evento_docentes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_evento_docentes_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_evento_docentes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_evento_docentes_mob_navigate_form

  function do_ajax_control_evento_docentes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_evento_docentes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_evento_docentes_mob_navigate_form_cb
  function sc_hide_control_evento_docentes_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_evento_docentes_mob_form
