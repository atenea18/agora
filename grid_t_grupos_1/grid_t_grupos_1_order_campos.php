<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_grupos_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_grupos_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_docente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['id_docente'] = "id_docente";
       $tab_converte["id_docente"]   = "id_docente";
   }
   else
   {
       $tab_def_campos['id_docente'] = "grupo_x_asig_x_doce.id_docente";
       $tab_converte["grupo_x_asig_x_doce.id_docente"]   = "id_docente";
   }
   $tab_labels["id_docente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["id_docente"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["id_docente"] : "Id Docente";
   ...
   {
       $tab_def_campos['id_grupo'] = "grupo_x_asig_x_doce.id_grupo";
       $tab_converte["grupo_x_asig_x_doce.id_grupo"]   = "id_grupo";
   }
   $tab_labels["id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["id_grupo"] : "Id Grupo";
   ...
   {
       $tab_def_campos['id_asignatura'] = "grupo_x_asig_x_doce.id_asignatura";
       $tab_converte["grupo_x_asig_x_doce.id_asignatura"]   = "id_asignatura";
   }
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['sec_users_login'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sec_users_login'] = "sec_users_login";
       $tab_converte["sec_users_login"]   = "sec_users_login";
   }
   else
   {
       $tab_def_campos['sec_users_login'] = "sec_users.login";
       $tab_converte["sec_users.login"]   = "sec_users_login";
   }
   $tab_labels["sec_users_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["sec_users_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["sec_users_login"] : "Login";
   $tab_ger_campos['grupo_x_asig_x_doce_peso_asig_fre_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['grupo_x_asig_x_doce_peso_asig_fre_area'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "grupo_x_asig_x_doce_peso_asig_fre_area";
   }
   else
   {
   ...
   $tab_labels["grupo_x_asig_x_doce_peso_asig_fre_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["grupo_x_asig_x_doce_peso_asig_fre_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["grupo_x_asig_x_doce_peso_asig_fre_area"] : "Peso Asig Fre Area";
   $tab_ger_campos['t_grupos_entorno'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_grupos_entorno'] = "t_grupos_entorno";
       $tab_converte["t_grupos_entorno"]   = "t_grupos_entorno";
   }
   else
   {
       $tab_def_campos['t_grupos_entorno'] = "t_grupos.entorno";
       $tab_converte["t_grupos.entorno"]   = "t_grupos_entorno";
   }
   $tab_labels["t_grupos_entorno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["t_grupos_entorno"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['labels']["t_grupos_entorno"] : "Entorno";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - t_grupos</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_grupos_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_grupos_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
