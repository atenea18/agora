...
class grid_t_grupos_1_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_t_grupos_1.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_1']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_1']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_1']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_1']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_t_grupos_1";
   ...
   function NM_export_sec_users_login()
   {
         ...
         $this->xml_registro .= " sec_users_login =\"" . $this->trata_dados($this->sec_users_login) . "\"";
   }
   ...
   function NM_export_t_grupos_entorno()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->t_grupos_entorno))
         {
             $this->t_grupos_entorno = sc_convert_encoding($this->t_grupos_entorno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " t_grupos_entorno =\"" . $this->trata_dados($this->t_grupos_entorno) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_1']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_1']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
