<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_c_asignatura_cert_repro_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_c_asignatura_cert_repro_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_asignaturas_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["t_asignaturas_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["t_asignaturas_asignatura"] : "Asignatura";
   ...
   $tab_labels["ihs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["ihs"])) ? $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["ihs"] : "IHS";
   $tab_ger_campos['c_evaluacion_evaluacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_evaluacion_evaluacion'] = "c_evaluacion_evaluacion";
       $tab_converte["c_evaluacion_evaluacion"]   = "c_evaluacion_evaluacion";
   }
   else
   {
       $tab_def_campos['c_evaluacion_evaluacion'] = "c_evaluacion.evaluacion";
       $tab_converte["c_evaluacion.evaluacion"]   = "c_evaluacion_evaluacion";
   }
   $tab_labels["c_evaluacion_evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["c_evaluacion_evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["c_evaluacion_evaluacion"] : "Evaluacion";
   ...
   $tab_labels["desempeno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["desempeno"])) ? $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['labels']["desempeno"] : "Desempeño";
   $tab_ger_campos['ihs'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_c_asignatura_cert_repro_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_c_asignatura_cert_repro']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
