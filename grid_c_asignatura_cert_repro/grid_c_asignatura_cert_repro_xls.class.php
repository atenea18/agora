...
class grid_c_asignatura_cert_repro_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $Tit_doc;
   //---- 
   function grid_c_asignatura_cert_repro_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_c_asignatura_cert_repro.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_c_asignatura_cert_repro']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_c_asignatura_cert_repro']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_c_asignatura_cert_repro']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_c_asignatura_cert_repro']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
$_SESSION['scriptcase']['grid_c_asignatura_cert_repro']['contr_erro'] = 'off'; 
   ...
   function NM_export_c_evaluacion_evaluacion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->c_evaluacion_evaluacion))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0.0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->c_evaluacion_evaluacion);
         $this->Xls_col++;
   }
   //----- desempeno
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_c_asignatura_cert_repro']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_c_asignatura_cert_repro']['xls_file'] = $this->Xls_f;
      }
