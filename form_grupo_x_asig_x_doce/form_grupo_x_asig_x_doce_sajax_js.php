  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grupo_x_asig_x_doce" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_area_
  function do_ajax_form_grupo_x_asig_x_doce_validate_id_area_(iNumLinha)
  {
    var nomeCampo_id_area_ = "id_area_" + iNumLinha;
    var var_id_area_ = scAjaxGetFieldSelect(nomeCampo_id_area_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_validate_id_area_(var_id_area_, iNumLinha, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_validate_id_area__cb);
  } // do_ajax_form_grupo_x_asig_x_doce_validate_id_area_

  function do_ajax_form_grupo_x_asig_x_doce_validate_id_area__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_x_asig_x_doce_validate_id_area__cb

  // ---------- Validate id_asignatura_
  function do_ajax_form_grupo_x_asig_x_doce_validate_id_asignatura_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_validate_id_asignatura_(var_id_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_validate_id_asignatura__cb);
  } // do_ajax_form_grupo_x_asig_x_doce_validate_id_asignatura_

  function do_ajax_form_grupo_x_asig_x_doce_validate_id_asignatura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_x_asig_x_doce_validate_id_asignatura__cb

  // ---------- Validate intensidad_horaria_
  function do_ajax_form_grupo_x_asig_x_doce_validate_intensidad_horaria_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_validate_intensidad_horaria_(var_intensidad_horaria_, iNumLinha, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_validate_intensidad_horaria__cb);
  } // do_ajax_form_grupo_x_asig_x_doce_validate_intensidad_horaria_

  function do_ajax_form_grupo_x_asig_x_doce_validate_intensidad_horaria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_x_asig_x_doce_validate_intensidad_horaria__cb

  // ---------- Validate peso_asig_fre_area_
  function do_ajax_form_grupo_x_asig_x_doce_validate_peso_asig_fre_area_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_validate_peso_asig_fre_area_(var_peso_asig_fre_area_, iNumLinha, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_validate_peso_asig_fre_area__cb);
  } // do_ajax_form_grupo_x_asig_x_doce_validate_peso_asig_fre_area_

  function do_ajax_form_grupo_x_asig_x_doce_validate_peso_asig_fre_area__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_x_asig_x_doce_validate_peso_asig_fre_area__cb

  // ---------- Validate id_docente_
  function do_ajax_form_grupo_x_asig_x_doce_validate_id_docente_(iNumLinha)
  {
    var nomeCampo_id_docente_ = "id_docente_" + iNumLinha;
    var var_id_docente_ = scAjaxGetFieldSelect(nomeCampo_id_docente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_validate_id_docente_(var_id_docente_, iNumLinha, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_validate_id_docente__cb);
  } // do_ajax_form_grupo_x_asig_x_doce_validate_id_docente_

  function do_ajax_form_grupo_x_asig_x_doce_validate_id_docente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_x_asig_x_doce_validate_id_docente__cb

  // ---------- Validate tipo_asig_
  function do_ajax_form_grupo_x_asig_x_doce_validate_tipo_asig_(iNumLinha)
  {
    var nomeCampo_tipo_asig_ = "tipo_asig_" + iNumLinha;
    var var_tipo_asig_ = scAjaxGetFieldRadio(nomeCampo_tipo_asig_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_validate_tipo_asig_(var_tipo_asig_, iNumLinha, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_validate_tipo_asig__cb);
  } // do_ajax_form_grupo_x_asig_x_doce_validate_tipo_asig_

  function do_ajax_form_grupo_x_asig_x_doce_validate_tipo_asig__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_x_asig_x_doce_validate_tipo_asig__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_grupo_x_asig_x_doce_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_grupo_x_asig_x_doce_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_grupo_x_asig_x_doce_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_add_new_line_cb);
  } // do_ajax_form_grupo_x_asig_x_doce_add_new_line

  function do_ajax_form_grupo_x_asig_x_doce_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_grupo_x_asig_x_doce_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_grupo_x_asig_x_doce_backup_line(iNumLinha)
  {
    var var_id_docente_grupo_ = scAjaxGetFieldText("id_docente_grupo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_x_asig_x_doce_backup_line(var_id_docente_grupo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_backup_line_cb);
  } // do_ajax_form_grupo_x_asig_x_doce_backup_line

  function do_ajax_form_grupo_x_asig_x_doce_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_grupo_x_asig_x_doce_backup_line_cb

  function do_ajax_form_grupo_x_asig_x_doce_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_grupo_x_asig_x_doce_cancel_insert

  function do_ajax_form_grupo_x_asig_x_doce_cancel_update(iSeqVert)
  {
    do_ajax_form_grupo_x_asig_x_doce_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_grupo_x_asig_x_doce_cancel_update

  function do_ajax_form_grupo_x_asig_x_doce_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_grupo_x_asig_x_doce_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_grupo_x_asig_x_doce_table_refresh()
  {
    var var_id_docente_grupo_ = document.F2.id_docente_grupo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_x_asig_x_doce_table_refresh(var_id_docente_grupo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_table_refresh_cb);
  } //  do_ajax_form_grupo_x_asig_x_doce_table_refresh

  function do_ajax_form_grupo_x_asig_x_doce_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_docente_grupo_.value = scAjaxGetKeyValue("id_docente_grupo_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_grupo_x_asig_x_doce_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_grupo_x_asig_x_doce_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_grupo_x_asig_x_doce_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_grupo_x_asig_x_doce_submit_form(var_id_area_, var_id_asignatura_, var_intensidad_horaria_, var_peso_asig_fre_area_, var_id_docente_, var_tipo_asig_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_grupo_x_asig_x_doce_submit_form_cb);
  } // do_ajax_form_grupo_x_asig_x_doce_submit_form

  function do_ajax_form_grupo_x_asig_x_doce_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_grupo_x_asig_x_doce_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_grupo_x_asig_x_doce_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_grupo_x_asig_x_doce_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_grupo_x_asig_x_doce_navigate_form(var_id_docente_grupo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_x_asig_x_doce_navigate_form_cb);
  } // do_ajax_form_grupo_x_asig_x_doce_navigate_form

  function do_ajax_form_grupo_x_asig_x_doce_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_docente_grupo_.value = scAjaxGetKeyValue("id_docente_grupo_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_grupo_x_asig_x_doce_navigate_form_cb
  function sc_hide_form_grupo_x_asig_x_doce_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_grupo_x_asig_x_doce_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["intensidad_horaria_" + iNumLinha] = {"label": "Ihr<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["peso_asig_fre_area_" + iNumLinha] = {"label": "% F Area<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_area_'])) ? $this->nmgp_cmp_readonly['id_area_'] : 'on';
?>
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_area_" + iRow] || "on" == ajax_error_count["id_asignatura_" + iRow] || "on" == ajax_error_count["intensidad_horaria_" + iRow] || "on" == ajax_error_count["peso_asig_fre_area_" + iRow] || "on" == ajax_error_count["id_docente_" + iRow] || "on" == ajax_error_count["tipo_asig_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_area_" + iRow] && "off" == ajax_error_count["id_asignatura_" + iRow] && "off" == ajax_error_count["intensidad_horaria_" + iRow] && "off" == ajax_error_count["peso_asig_fre_area_" + iRow] && "off" == ajax_error_count["id_docente_" + iRow] && "off" == ajax_error_count["tipo_asig_" + iRow]))
    {
      if (bErrorRow)
      {
