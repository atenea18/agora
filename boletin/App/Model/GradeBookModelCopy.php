...
class GradeBookModel extends DB
{
	...
	*/
	...
	{
		return $this->roundNumber($value, $roundNumber);
	}
	...
	*/
	...
	public function getFinalReportList($id_group, $year)
	{
		...
		foreach($data as $key => $value):
			$note = $this->resolveNoteFinalReport($value['definitiva'], $value['id_estudiante'], $value['id_grupo'], $value['id_asignatura']);
			array_push(
				$response, 
				array(
