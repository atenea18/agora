	...
	{	
		...
		if($respGroup['state']):
			...
			$this->_pdf->Output($this->_path.'lista-'.
				$this->_pdf->infoGroupAndAsig['doc_primer_nomb']."-".
				$this->_pdf->infoGroupAndAsig['doc_segundo_nomb']."-".
				$this->_pdf->infoGroupAndAsig['doc_primer_ape']."-".
				$this->_pdf->infoGroupAndAsig['doc_segundo_ape'].
