...
class GroupModel extends DB
{
	...
	public function getInfo($id_group){
		$this->query = "SELECT g.id_grupo, g.nombre_grupo, d.primer_apellido AS doc_primer_ape, d.segundo_apellido AS doc_segundo_ape, d.primer_nombre AS doc_primer_nomb, d.segundo_nombre AS doc_segundo_nomb, j.jornada, s.sede, gra.id_grado, gra.grado, niveles.nivel
						FROM docentes d
						...
						INNER JOIN niveles ON niveles.id_nivel = gra.id_nivel";
