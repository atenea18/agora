 ...
 */
    ...
    session_start();
    $SC_apl_proc = "form_t_evaluacion_p1_5_superacion_eval_confamar";
...
?>
     parent.nm_gp_export('<?php echo NM_encode_input($opc); ?>', '<?php echo NM_encode_input($target); ?>', cor, parms_pdf, grafico);return false;
  }
