<?php
//
class form_t_evaluacion_p1_5_superacion_eval_confamar_apl
{
   ...
   var $form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['entorno_']))
          {
              $this->entorno_ = $this->NM_ajax_info['param']['entorno_'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['nota_perdio_p1_']))
          {
              $this->nota_perdio_p1_ = $this->NM_ajax_info['param']['nota_perdio_p1_'];
          }
          if (isset($this->NM_ajax_info['param']['nota_supe_p1_']))
          {
              $this->nota_supe_p1_ = $this->NM_ajax_info['param']['nota_supe_p1_'];
          }
      ...
      $this->sc_conv_var['nota_supe_p1'] = "nota_supe_p1_";
      $this->sc_conv_var['nota_perdio_p1'] = "nota_perdio_p1_";
      ...
      $this->sc_conv_var['dc10'] = "dc10_";
      $this->sc_conv_var['dc11'] = "dc11_";
      $this->sc_conv_var['dc12'] = "dc12_";
      $this->sc_conv_var['letras_p1'] = "letras_p1_";
      ...
      $this->sc_conv_var['nota_supe_p2'] = "nota_supe_p2_";
      $this->sc_conv_var['nota_perdio_p2'] = "nota_perdio_p2_";
      ...
      $this->sc_conv_var['letras_p2'] = "letras_p2_";
      ...
      $this->sc_conv_var['nota_supe_p3'] = "nota_supe_p3_";
      $this->sc_conv_var['nota_perdio_p3'] = "nota_perdio_p3_";
      ...
      $this->sc_conv_var['letras_p3'] = "letras_p3_";
      ...
      $this->sc_conv_var['nota_supe_p4'] = "nota_supe_p4_";
      $this->sc_conv_var['nota_perdio_p4'] = "nota_perdio_p4_";
      ...
      $this->sc_conv_var['letras_p4'] = "letras_p4_";
      ...
      if (isset($this->bajo) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['bajo'] = $this->bajo;
      }
      ...
      if (isset($this->par_cod_desemp7) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['par_cod_desemp7'] = $this->par_cod_desemp7;
      }
      if (isset($this->par_cod_desemp8) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['par_cod_desemp8'] = $this->par_cod_desemp8;
      }
      if (isset($this->par_cod_desemp9) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['par_cod_desemp9'] = $this->par_cod_desemp9;
      }
      if (isset($this->par_cod_desemp10) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['par_cod_desemp10'] = $this->par_cod_desemp10;
      }
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_t_evaluacion_p1_5_superacion_eval_confamar($cadapar[1]);
                 ...
                 if ($cadapar[0] == "entorno_")
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= "entorno = " . $this->entorno_;
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
          ...
          if (isset($this->par_cod_desemp7)) 
          {
              $_SESSION['par_cod_desemp7'] = $this->par_cod_desemp7;
          }
          if (isset($this->par_cod_desemp8)) 
          {
              $_SESSION['par_cod_desemp8'] = $this->par_cod_desemp8;
          }
          if (isset($this->par_cod_desemp9)) 
          {
              $_SESSION['par_cod_desemp9'] = $this->par_cod_desemp9;
          }
          if (isset($this->par_cod_desemp10)) 
          {
              $_SESSION['par_cod_desemp10'] = $this->par_cod_desemp10;
          }
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idgrupo)) 
          {
              $_SESSION['par_idgrupo'] = $this->par_idgrupo;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_t_evaluacion_p1_5_superacion_eval_confamar_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['initialize'])
          {
              $_SESSION['scriptcase']['form_t_evaluacion_p1_5_superacion_eval_confamar']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'] = 'on';
$_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'] = 'off';$this->parametrosGenerales();
     ...
     $nm_select = $update_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         if ($rf === false)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                form_t_evaluacion_p1_5_superacion_eval_confamar_pack_ajax_response();
             }
             exit;
         }
         $rf->Close();
...
$_SESSION['scriptcase']['form_t_evaluacion_p1_5_superacion_eval_confamar']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_t_evaluacion_p1_5_superacion_eval_confamar']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_t_evaluacion_p1_5_superacion_eval_confamar'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p1_5_superacion_eval_confamar']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p1_5_superacion_eval_confamar']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_t_evaluacion_p1_5_superacion_eval_confamar') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_t_evaluacion_p1_5_superacion_eval_confamar']['label'] = "ASIGNATURA:  " . $_SESSION['asigna'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_t_evaluacion_p1_5_superacion_eval_confamar")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_view'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['prt_view'] = false;
      if ($this->nmgp_opcao == "pdf" || $this->nmgp_opcao == "print")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_view'] = true;
          if ($this->nmgp_opcao == "print")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['prt_view'] = true;
          } 
          $this->nmgp_opcao = "igual";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'] = "igual";
      } 
      $this->Db = $this->Ini->Db; 
      ...
      $_SESSION['scriptcase']['error_icon']['form_t_evaluacion_p1_5_superacion_eval_confamar']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_t_evaluacion_p1_5_superacion_eval_confamar'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_orig'] = " where id_grupo ='" . $_SESSION['par_idgrupo'] . "' AND id_asignatura=' " . $_SESSION['par_id_asignatura'] . "' AND entorno =' " . $_SESSION['entorno'] . "' AND eval_1_per<'" . $_SESSION['bajo'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_pesq'] = " where id_grupo ='" . $_SESSION['par_idgrupo'] . "' AND id_asignatura=' " . $_SESSION['par_id_asignatura'] . "' AND entorno =' " . $_SESSION['entorno'] . "' AND eval_1_per<'" . $_SESSION['bajo'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_t_evaluacion_p1_5_superacion_eval_confamar']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['exit'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_t_evaluacion_p1_5_superacion_eval_confamar", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_t_evaluacion_p1_5_superacion_eval_confamar_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_t_evaluacion_p1_5_superacion_eval_confamar_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_t_evaluacion_p1_5_superacion_eval_confamar/form_t_evaluacion_p1_5_superacion_eval_confamar_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_t_evaluacion_p1_5_superacion_eval_confamar_erro.class.php"); 
      }
      $this->Erro      = new form_t_evaluacion_p1_5_superacion_eval_confamar_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao']))
         { 
             if ($this->id_estudiante_ != "" || $this->id_grupo_ != "" || $this->id_asignatura_ != "" || $this->entorno_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['final'];
      }
      else
      {
      }
...
//
   ...
   function loadFieldConfig()
   {
      ...
      //-- nota_perdio_p1_
      $this->field_config['nota_perdio_p1_']               = array();
      $this->field_config['nota_perdio_p1_']['symbol_grp'] = '';
      $this->field_config['nota_perdio_p1_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_perdio_p1_']['symbol_dec'] = ',';
      $this->field_config['nota_perdio_p1_']['symbol_neg'] = '-';
      $this->field_config['nota_perdio_p1_']['format_neg'] = '2';
      //-- nota_supe_p1_
      $this->field_config['nota_supe_p1_']               = array();
      $this->field_config['nota_supe_p1_']['symbol_grp'] = '.';
      $this->field_config['nota_supe_p1_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_supe_p1_']['symbol_dec'] = ',';
      $this->field_config['nota_supe_p1_']['symbol_neg'] = '-';
      $this->field_config['nota_supe_p1_']['format_neg'] = '2';
      //-- id_grupo_
      ...
      $this->field_config['dc2_']['symbol_grp'] = '';
      $this->field_config['dc2_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc2_']['symbol_dec'] = ',';
      $this->field_config['dc2_']['symbol_neg'] = '-';
      $this->field_config['dc2_']['format_neg'] = '2';
      //-- dc3_
      ...
      $this->field_config['dc4_']['symbol_grp'] = '';
      $this->field_config['dc4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc4_']['symbol_dec'] = ',';
      $this->field_config['dc4_']['symbol_neg'] = '-';
      $this->field_config['dc4_']['format_neg'] = '2';
      //-- dc5_
      ...
      $this->field_config['dc6_']['symbol_grp'] = '';
      $this->field_config['dc6_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc6_']['symbol_dec'] = ',';
      $this->field_config['dc6_']['symbol_neg'] = '-';
      $this->field_config['dc6_']['format_neg'] = '2';
      //-- dc7_
      $this->field_config['dc7_']               = array();
      $this->field_config['dc7_']['symbol_grp'] = '';
      $this->field_config['dc7_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc7_']['symbol_dec'] = ',';
      $this->field_config['dc7_']['symbol_neg'] = '-';
      $this->field_config['dc7_']['format_neg'] = '2';
      //-- dc8_
      $this->field_config['dc8_']               = array();
      $this->field_config['dc8_']['symbol_grp'] = '';
      $this->field_config['dc8_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc8_']['symbol_dec'] = ',';
      $this->field_config['dc8_']['symbol_neg'] = '-';
      $this->field_config['dc8_']['format_neg'] = '2';
      //-- dc9_
      $this->field_config['dc9_']               = array();
      $this->field_config['dc9_']['symbol_grp'] = '';
      $this->field_config['dc9_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc9_']['symbol_dec'] = ',';
      $this->field_config['dc9_']['symbol_neg'] = '-';
      $this->field_config['dc9_']['format_neg'] = '2';
      //-- dc10_
      $this->field_config['dc10_']               = array();
      $this->field_config['dc10_']['symbol_grp'] = '';
      $this->field_config['dc10_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc10_']['symbol_dec'] = ',';
      $this->field_config['dc10_']['symbol_neg'] = '-';
      $this->field_config['dc10_']['format_neg'] = '2';
      //-- dc11_
      $this->field_config['dc11_']               = array();
      $this->field_config['dc11_']['symbol_grp'] = '';
      $this->field_config['dc11_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc11_']['symbol_dec'] = ',';
      $this->field_config['dc11_']['symbol_neg'] = '-';
      $this->field_config['dc11_']['format_neg'] = '2';
      //-- dc12_
      $this->field_config['dc12_']               = array();
      $this->field_config['dc12_']['symbol_grp'] = '';
      $this->field_config['dc12_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc12_']['symbol_dec'] = ',';
      $this->field_config['dc12_']['symbol_neg'] = '-';
      $this->field_config['dc12_']['format_neg'] = '2';
      //-- pcent_dc_
      ...
      $this->field_config['eval_2_per_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['eval_2_per_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['eval_2_per_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nota_supe_p2_
      $this->field_config['nota_supe_p2_']               = array();
      $this->field_config['nota_supe_p2_']['symbol_grp'] = '.';
      $this->field_config['nota_supe_p2_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_supe_p2_']['symbol_dec'] = ',';
      $this->field_config['nota_supe_p2_']['symbol_neg'] = '-';
      $this->field_config['nota_supe_p2_']['format_neg'] = '2';
      //-- nota_perdio_p2_
      $this->field_config['nota_perdio_p2_']               = array();
      $this->field_config['nota_perdio_p2_']['symbol_grp'] = '.';
      $this->field_config['nota_perdio_p2_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_perdio_p2_']['symbol_dec'] = ',';
      $this->field_config['nota_perdio_p2_']['symbol_neg'] = '-';
      $this->field_config['nota_perdio_p2_']['format_neg'] = '2';
      //-- dc1_2p_
      $this->field_config['dc1_2p_']               = array();
      $this->field_config['dc1_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc1_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc1_2p_']['symbol_dec'] = '';
      $this->field_config['dc1_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc1_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc2_2p_
      $this->field_config['dc2_2p_']               = array();
      $this->field_config['dc2_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc2_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc2_2p_']['symbol_dec'] = '';
      $this->field_config['dc2_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc2_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc3_2p_
      $this->field_config['dc3_2p_']               = array();
      $this->field_config['dc3_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc3_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc3_2p_']['symbol_dec'] = '';
      $this->field_config['dc3_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc3_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc4_2p_
      $this->field_config['dc4_2p_']               = array();
      $this->field_config['dc4_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc4_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc4_2p_']['symbol_dec'] = '';
      $this->field_config['dc4_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc4_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc5_2p_
      $this->field_config['dc5_2p_']               = array();
      $this->field_config['dc5_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc5_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc5_2p_']['symbol_dec'] = '';
      $this->field_config['dc5_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc5_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_dc2_
      $this->field_config['pcent_dc2_']               = array();
      $this->field_config['pcent_dc2_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_dc2_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_dc2_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds1_2p_
      $this->field_config['ds1_2p_']               = array();
      $this->field_config['ds1_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds1_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds1_2p_']['symbol_dec'] = '';
      $this->field_config['ds1_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds1_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds2_2p_
      $this->field_config['ds2_2p_']               = array();
      $this->field_config['ds2_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds2_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds2_2p_']['symbol_dec'] = '';
      $this->field_config['ds2_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds2_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds3_2p_
      $this->field_config['ds3_2p_']               = array();
      $this->field_config['ds3_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds3_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds3_2p_']['symbol_dec'] = '';
      $this->field_config['ds3_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds3_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds4_2p_
      $this->field_config['ds4_2p_']               = array();
      $this->field_config['ds4_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds4_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds4_2p_']['symbol_dec'] = '';
      $this->field_config['ds4_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds4_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds5_2p_
      $this->field_config['ds5_2p_']               = array();
      $this->field_config['ds5_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds5_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds5_2p_']['symbol_dec'] = '';
      $this->field_config['ds5_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds5_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_ds2_
      $this->field_config['pcent_ds2_']               = array();
      $this->field_config['pcent_ds2_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_ds2_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_ds2_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp1_2p_
      $this->field_config['dp1_2p_']               = array();
      $this->field_config['dp1_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp1_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp1_2p_']['symbol_dec'] = '';
      $this->field_config['dp1_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp1_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp2_2p_
      $this->field_config['dp2_2p_']               = array();
      $this->field_config['dp2_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp2_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp2_2p_']['symbol_dec'] = '';
      $this->field_config['dp2_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp2_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp3_2p_
      $this->field_config['dp3_2p_']               = array();
      $this->field_config['dp3_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp3_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp3_2p_']['symbol_dec'] = '';
      $this->field_config['dp3_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp3_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp4_2p_
      $this->field_config['dp4_2p_']               = array();
      $this->field_config['dp4_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp4_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp4_2p_']['symbol_dec'] = '';
      $this->field_config['dp4_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp4_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp5_2p_
      $this->field_config['dp5_2p_']               = array();
      $this->field_config['dp5_2p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp5_2p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp5_2p_']['symbol_dec'] = '';
      $this->field_config['dp5_2p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp5_2p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_dp2_
      $this->field_config['pcent_dp2_']               = array();
      $this->field_config['pcent_dp2_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_dp2_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_dp2_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- aee_p2_
      ...
      $this->field_config['eval_3_per_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['eval_3_per_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['eval_3_per_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nota_supe_p3_
      $this->field_config['nota_supe_p3_']               = array();
      $this->field_config['nota_supe_p3_']['symbol_grp'] = '.';
      $this->field_config['nota_supe_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_supe_p3_']['symbol_dec'] = ',';
      $this->field_config['nota_supe_p3_']['symbol_neg'] = '-';
      $this->field_config['nota_supe_p3_']['format_neg'] = '2';
      //-- nota_perdio_p3_
      $this->field_config['nota_perdio_p3_']               = array();
      $this->field_config['nota_perdio_p3_']['symbol_grp'] = '.';
      $this->field_config['nota_perdio_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_perdio_p3_']['symbol_dec'] = ',';
      $this->field_config['nota_perdio_p3_']['symbol_neg'] = '-';
      $this->field_config['nota_perdio_p3_']['format_neg'] = '2';
      //-- dc1_3p_
      $this->field_config['dc1_3p_']               = array();
      $this->field_config['dc1_3p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc1_3p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc1_3p_']['symbol_dec'] = '';
      $this->field_config['dc1_3p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc1_3p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc2_3p_
      $this->field_config['dc2_3p_']               = array();
      $this->field_config['dc2_3p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc2_3p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc2_3p_']['symbol_dec'] = '';
      $this->field_config['dc2_3p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc2_3p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc3_3p_
      $this->field_config['dc3_3p_']               = array();
      $this->field_config['dc3_3p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc3_3p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc3_3p_']['symbol_dec'] = '';
      $this->field_config['dc3_3p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc3_3p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc4_3p_
      $this->field_config['dc4_3p_']               = array();
      $this->field_config['dc4_3p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc4_3p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc4_3p_']['symbol_dec'] = '';
      $this->field_config['dc4_3p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc4_3p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc5_3p_
      $this->field_config['dc5_3p_']               = array();
      $this->field_config['dc5_3p_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc5_3p_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc5_3p_']['symbol_dec'] = '';
      $this->field_config['dc5_3p_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc5_3p_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_dc3_
      $this->field_config['pcent_dc3_']               = array();
      $this->field_config['pcent_dc3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_dc3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_dc3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds1_p3_
      $this->field_config['ds1_p3_']               = array();
      $this->field_config['ds1_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds1_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds1_p3_']['symbol_dec'] = '';
      $this->field_config['ds1_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds1_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds2_p3_
      $this->field_config['ds2_p3_']               = array();
      $this->field_config['ds2_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds2_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds2_p3_']['symbol_dec'] = '';
      $this->field_config['ds2_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds2_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds3_p3_
      $this->field_config['ds3_p3_']               = array();
      $this->field_config['ds3_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds3_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds3_p3_']['symbol_dec'] = '';
      $this->field_config['ds3_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds3_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds4_p3_
      $this->field_config['ds4_p3_']               = array();
      $this->field_config['ds4_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds4_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds4_p3_']['symbol_dec'] = '';
      $this->field_config['ds4_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds4_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds5_p3_
      $this->field_config['ds5_p3_']               = array();
      $this->field_config['ds5_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds5_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds5_p3_']['symbol_dec'] = '';
      $this->field_config['ds5_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds5_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_ds3_
      $this->field_config['pcent_ds3_']               = array();
      $this->field_config['pcent_ds3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_ds3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_ds3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp1_p3_
      $this->field_config['dp1_p3_']               = array();
      $this->field_config['dp1_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp1_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp1_p3_']['symbol_dec'] = '';
      $this->field_config['dp1_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp1_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp2_p3_
      $this->field_config['dp2_p3_']               = array();
      $this->field_config['dp2_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp2_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp2_p3_']['symbol_dec'] = '';
      $this->field_config['dp2_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp2_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp3_p3_
      $this->field_config['dp3_p3_']               = array();
      $this->field_config['dp3_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp3_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp3_p3_']['symbol_dec'] = '';
      $this->field_config['dp3_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp3_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp4_p3_
      $this->field_config['dp4_p3_']               = array();
      $this->field_config['dp4_p3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp4_p3_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp4_p3_']['symbol_dec'] = '';
      $this->field_config['dp4_p3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp4_p3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- sc_field_0_
      ...
      $this->field_config['pcent_dp3_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_dp3_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_dp3_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- aee_p3_
      ...
      $this->field_config['eval_4_per_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['eval_4_per_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['eval_4_per_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- nota_supe_p4_
      $this->field_config['nota_supe_p4_']               = array();
      $this->field_config['nota_supe_p4_']['symbol_grp'] = '.';
      $this->field_config['nota_supe_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_supe_p4_']['symbol_dec'] = ',';
      $this->field_config['nota_supe_p4_']['symbol_neg'] = '-';
      $this->field_config['nota_supe_p4_']['format_neg'] = '2';
      //-- nota_perdio_p4_
      $this->field_config['nota_perdio_p4_']               = array();
      $this->field_config['nota_perdio_p4_']['symbol_grp'] = '.';
      $this->field_config['nota_perdio_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['nota_perdio_p4_']['symbol_dec'] = ',';
      $this->field_config['nota_perdio_p4_']['symbol_neg'] = '-';
      $this->field_config['nota_perdio_p4_']['format_neg'] = '2';
      //-- dc1_p4_
      $this->field_config['dc1_p4_']               = array();
      $this->field_config['dc1_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc1_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc1_p4_']['symbol_dec'] = '';
      $this->field_config['dc1_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc1_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc2_p4_
      $this->field_config['dc2_p4_']               = array();
      $this->field_config['dc2_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc2_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc2_p4_']['symbol_dec'] = '';
      $this->field_config['dc2_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc2_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc3_p4_
      $this->field_config['dc3_p4_']               = array();
      $this->field_config['dc3_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc3_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc3_p4_']['symbol_dec'] = '';
      $this->field_config['dc3_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc3_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc4_p4_
      $this->field_config['dc4_p4_']               = array();
      $this->field_config['dc4_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc4_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc4_p4_']['symbol_dec'] = '';
      $this->field_config['dc4_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc4_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc5_p4_
      $this->field_config['dc5_p4_']               = array();
      $this->field_config['dc5_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc5_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc5_p4_']['symbol_dec'] = '';
      $this->field_config['dc5_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc5_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_dc4_
      $this->field_config['pcent_dc4_']               = array();
      $this->field_config['pcent_dc4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_dc4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_dc4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds1_p4_
      $this->field_config['ds1_p4_']               = array();
      $this->field_config['ds1_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds1_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds1_p4_']['symbol_dec'] = '';
      $this->field_config['ds1_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds1_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds2_p4_
      $this->field_config['ds2_p4_']               = array();
      $this->field_config['ds2_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds2_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds2_p4_']['symbol_dec'] = '';
      $this->field_config['ds2_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds2_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds3_p4_
      $this->field_config['ds3_p4_']               = array();
      $this->field_config['ds3_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds3_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds3_p4_']['symbol_dec'] = '';
      $this->field_config['ds3_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds3_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds4_p4_
      $this->field_config['ds4_p4_']               = array();
      $this->field_config['ds4_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds4_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds4_p4_']['symbol_dec'] = '';
      $this->field_config['ds4_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds4_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ds5_p4_
      $this->field_config['ds5_p4_']               = array();
      $this->field_config['ds5_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ds5_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ds5_p4_']['symbol_dec'] = '';
      $this->field_config['ds5_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ds5_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- pcent_ds4_
      $this->field_config['pcent_ds4_']               = array();
      $this->field_config['pcent_ds4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_ds4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_ds4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp1_p4_
      $this->field_config['dp1_p4_']               = array();
      $this->field_config['dp1_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp1_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp1_p4_']['symbol_dec'] = '';
      $this->field_config['dp1_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp1_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp2_p4_
      $this->field_config['dp2_p4_']               = array();
      $this->field_config['dp2_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp2_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp2_p4_']['symbol_dec'] = '';
      $this->field_config['dp2_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp2_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp3_p4_
      $this->field_config['dp3_p4_']               = array();
      $this->field_config['dp3_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp3_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp3_p4_']['symbol_dec'] = '';
      $this->field_config['dp3_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp3_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp4_p4_
      $this->field_config['dp4_p4_']               = array();
      $this->field_config['dp4_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp4_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp4_p4_']['symbol_dec'] = '';
      $this->field_config['dp4_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp4_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dp5_p4_
      $this->field_config['dp5_p4_']               = array();
      $this->field_config['dp5_p4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dp5_p4_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dp5_p4_']['symbol_dec'] = '';
      $this->field_config['dp5_p4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dp5_p4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- aee_p4_
      ...
      $this->field_config['pcent_dp4_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['pcent_dp4_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['pcent_dp4_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- eval_final_
      $this->field_config['eval_final_']               = array();
      $this->field_config['eval_final_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['eval_final_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['eval_final_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- entorno_
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->nota_supe_p1_)) { $this->nm_limpa_alfa($this->nota_supe_p1_); }
         if (isset($this->nota_perdio_p1_)) { $this->nm_limpa_alfa($this->nota_perdio_p1_); }
         if (isset($this->Sc_num_lin_alt) && $this->Sc_num_lin_alt > 0) 
         {
             $sc_seq_vert = $this->Sc_num_lin_alt;
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'][$sc_seq_vert];
             ...
             $this->novedad_ = $this->nmgp_dados_form['novedad_']; 
             $this->estatus_ = $this->nmgp_dados_form['estatus_']; 
             $this->inasistencia_p1_ = $this->nmgp_dados_form['inasistencia_p1_']; 
             $this->dc1_ = $this->nmgp_dados_form['dc1_']; 
             $this->dc2_ = $this->nmgp_dados_form['dc2_']; 
             $this->dc3_ = $this->nmgp_dados_form['dc3_']; 
             $this->dc4_ = $this->nmgp_dados_form['dc4_']; 
             $this->dc5_ = $this->nmgp_dados_form['dc5_']; 
             ...
             $this->dc10_ = $this->nmgp_dados_form['dc10_']; 
             $this->dc11_ = $this->nmgp_dados_form['dc11_']; 
             $this->dc12_ = $this->nmgp_dados_form['dc12_']; 
             $this->letras_p1_ = $this->nmgp_dados_form['letras_p1_']; 
             $this->pcent_dc_ = $this->nmgp_dados_form['pcent_dc_']; 
             $this->ds1_ = $this->nmgp_dados_form['ds1_']; 
             $this->ds2_ = $this->nmgp_dados_form['ds2_']; 
             $this->ds3_ = $this->nmgp_dados_form['ds3_']; 
             $this->ds4_ = $this->nmgp_dados_form['ds4_']; 
             $this->ds5_ = $this->nmgp_dados_form['ds5_']; 
             $this->pcent_ds_ = $this->nmgp_dados_form['pcent_ds_']; 
             $this->dp1_ = $this->nmgp_dados_form['dp1_']; 
             $this->dp2_ = $this->nmgp_dados_form['dp2_']; 
             $this->dp3_ = $this->nmgp_dados_form['dp3_']; 
             $this->dp4_ = $this->nmgp_dados_form['dp4_']; 
             $this->dp5_ = $this->nmgp_dados_form['dp5_']; 
             $this->pcent_dp_ = $this->nmgp_dados_form['pcent_dp_']; 
             $this->aeep1_ = $this->nmgp_dados_form['aeep1_']; 
             $this->porcent_aeep1_ = $this->nmgp_dados_form['porcent_aeep1_']; 
             $this->inasistencia_p2_ = $this->nmgp_dados_form['inasistencia_p2_']; 
             $this->eval_2_per_ = $this->nmgp_dados_form['eval_2_per_']; 
             $this->nota_supe_p2_ = $this->nmgp_dados_form['nota_supe_p2_']; 
             $this->nota_perdio_p2_ = $this->nmgp_dados_form['nota_perdio_p2_']; 
             ...
             $this->letras_p2_ = $this->nmgp_dados_form['letras_p2_']; 
             ...
             $this->nota_supe_p3_ = $this->nmgp_dados_form['nota_supe_p3_']; 
             $this->nota_perdio_p3_ = $this->nmgp_dados_form['nota_perdio_p3_']; 
             ...
             $this->letras_p3_ = $this->nmgp_dados_form['letras_p3_']; 
             ...
             $this->nota_supe_p4_ = $this->nmgp_dados_form['nota_supe_p4_']; 
             $this->nota_perdio_p4_ = $this->nmgp_dados_form['nota_perdio_p4_']; 
             ...
             $this->letras_p4_ = $this->nmgp_dados_form['letras_p4_']; 
             ...
             $this->asienta_inasistencias_ = $this->nmgp_dados_form['asienta_inasistencias_']; 
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar']) || !is_array($this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar'][] = $this->Campos_Mens_erro;
                  }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_nota_perdio_p1_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nota_perdio_p1_');
          }
          if ('validate_nota_supe_p1_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nota_supe_p1_');
          }
          form_t_evaluacion_p1_5_superacion_eval_confamar_pack_ajax_response();
          exit;
      }
      ...
      { 
         ...
         $this->nota_perdio_p1_ = $GLOBALS["nota_perdio_p1_" . $sc_seq_vert]; 
         $this->nota_supe_p1_ = $GLOBALS["nota_supe_p1_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'][$sc_seq_vert];
             $this->primer_apellido_ = $this->nmgp_dados_form['primer_apellido_']; 
         ...
         if (isset($this->nota_supe_p1_)) { $this->nm_limpa_alfa($this->nota_supe_p1_); }
         if (isset($this->nota_perdio_p1_)) { $this->nm_limpa_alfa($this->nota_perdio_p1_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_estudiante_'] =  $this->id_estudiante_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['eval_1_per_'] =  $this->eval_1_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_perdio_p1_'] =  $this->nota_perdio_p1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_supe_p1_'] =  $this->nota_supe_p1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['primer_apellido_'] =  $this->primer_apellido_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['segundo_apellido_'] =  $this->segundo_apellido_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['primer_nombre_'] =  $this->primer_nombre_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['segundo_nombre_'] =  $this->segundo_nombre_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_grupo_'] =  $this->id_grupo_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_area_'] =  $this->id_area_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_asignatura_'] =  $this->id_asignatura_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_grado_'] =  $this->id_grado_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_nivel_'] =  $this->id_nivel_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ihs_'] =  $this->ihs_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pfa_'] =  $this->pfa_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['tipo_asig_'] =  $this->tipo_asig_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['novedad_'] =  $this->novedad_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['estatus_'] =  $this->estatus_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['inasistencia_p1_'] =  $this->inasistencia_p1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc1_'] =  $this->dc1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc2_'] =  $this->dc2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc3_'] =  $this->dc3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc4_'] =  $this->dc4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc5_'] =  $this->dc5_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc6_'] =  $this->dc6_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc7_'] =  $this->dc7_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc8_'] =  $this->dc8_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc9_'] =  $this->dc9_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc10_'] =  $this->dc10_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc11_'] =  $this->dc11_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc12_'] =  $this->dc12_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['letras_p1_'] =  $this->letras_p1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dc_'] =  $this->pcent_dc_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds1_'] =  $this->ds1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds2_'] =  $this->ds2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds3_'] =  $this->ds3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds4_'] =  $this->ds4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds5_'] =  $this->ds5_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_ds_'] =  $this->pcent_ds_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp1_'] =  $this->dp1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp2_'] =  $this->dp2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp3_'] =  $this->dp3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp4_'] =  $this->dp4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp5_'] =  $this->dp5_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dp_'] =  $this->pcent_dp_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['aeep1_'] =  $this->aeep1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['porcent_aeep1_'] =  $this->porcent_aeep1_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['inasistencia_p2_'] =  $this->inasistencia_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['eval_2_per_'] =  $this->eval_2_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_supe_p2_'] =  $this->nota_supe_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_perdio_p2_'] =  $this->nota_perdio_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc1_2p_'] =  $this->dc1_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc2_2p_'] =  $this->dc2_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc3_2p_'] =  $this->dc3_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc4_2p_'] =  $this->dc4_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc5_2p_'] =  $this->dc5_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dc2_'] =  $this->pcent_dc2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds1_2p_'] =  $this->ds1_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds2_2p_'] =  $this->ds2_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds3_2p_'] =  $this->ds3_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds4_2p_'] =  $this->ds4_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds5_2p_'] =  $this->ds5_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_ds2_'] =  $this->pcent_ds2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp1_2p_'] =  $this->dp1_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp2_2p_'] =  $this->dp2_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp3_2p_'] =  $this->dp3_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp4_2p_'] =  $this->dp4_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp5_2p_'] =  $this->dp5_2p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dp2_'] =  $this->pcent_dp2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['aee_p2_'] =  $this->aee_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['letras_p2_'] =  $this->letras_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['porcet_aee_p2_'] =  $this->porcet_aee_p2_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['inasistencia_p3_'] =  $this->inasistencia_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['eval_3_per_'] =  $this->eval_3_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_supe_p3_'] =  $this->nota_supe_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_perdio_p3_'] =  $this->nota_perdio_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc1_3p_'] =  $this->dc1_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc2_3p_'] =  $this->dc2_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc3_3p_'] =  $this->dc3_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc4_3p_'] =  $this->dc4_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc5_3p_'] =  $this->dc5_3p_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dc3_'] =  $this->pcent_dc3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds1_p3_'] =  $this->ds1_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds2_p3_'] =  $this->ds2_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds3_p3_'] =  $this->ds3_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds4_p3_'] =  $this->ds4_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds5_p3_'] =  $this->ds5_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_ds3_'] =  $this->pcent_ds3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp1_p3_'] =  $this->dp1_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp2_p3_'] =  $this->dp2_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp3_p3_'] =  $this->dp3_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp4_p3_'] =  $this->dp4_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['sc_field_0_'] =  $this->sc_field_0_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dp3_'] =  $this->pcent_dp3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['aee_p3_'] =  $this->aee_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['letras_p3_'] =  $this->letras_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['porcent_aee_p3_'] =  $this->porcent_aee_p3_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['inasistencia_p4_'] =  $this->inasistencia_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['eval_4_per_'] =  $this->eval_4_per_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_supe_p4_'] =  $this->nota_supe_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nota_perdio_p4_'] =  $this->nota_perdio_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc1_p4_'] =  $this->dc1_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc2_p4_'] =  $this->dc2_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc3_p4_'] =  $this->dc3_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc4_p4_'] =  $this->dc4_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dc5_p4_'] =  $this->dc5_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dc4_'] =  $this->pcent_dc4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds1_p4_'] =  $this->ds1_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds2_p4_'] =  $this->ds2_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds3_p4_'] =  $this->ds3_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds4_p4_'] =  $this->ds4_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['ds5_p4_'] =  $this->ds5_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_ds4_'] =  $this->pcent_ds4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp1_p4_'] =  $this->dp1_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp2_p4_'] =  $this->dp2_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp3_p4_'] =  $this->dp3_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp4_p4_'] =  $this->dp4_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['dp5_p4_'] =  $this->dp5_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['aee_p4_'] =  $this->aee_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['letras_p4_'] =  $this->letras_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['porcent_aee_p4_'] =  $this->porcent_aee_p4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['pcent_dp4_'] =  $this->pcent_dp4_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['eval_final_'] =  $this->eval_final_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['entorno_'] =  $this->entorno_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['asienta_inasistencias_'] =  $this->asienta_inasistencias_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['nom_grupo_'] =  $this->nom_grupo_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar);
          ...
          $this->NM_ajax_info['fldList']['entorno_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['entorno_']);
          $this->NM_close_db();
          form_t_evaluacion_p1_5_superacion_eval_confamar_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_nota_supe_p1__onchange' == $this->NM_ajax_opcao)
          {
              $this->nota_supe_p1__onChange();
          }
          $this->NM_close_db();
          form_t_evaluacion_p1_5_superacion_eval_confamar_pack_ajax_response();
          exit;
      ...
      { 
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['prt_view'] && in_array(trim($this->Ini->str_lang), $this->Ini->nm_font_ttf) && strtolower($_SESSION['scriptcase']['charset']) != "utf-8")
          { 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//--------------------------------------------------------------------------------------
   function NM_pdf_output()
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_view'])
      { 
          $arq_pdf_in = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_form_t_evaluacion_p1_5_superacion_eval_confamar_html_" . session_id() . ".html";
          $url_pdf_in = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_form_t_evaluacion_p1_5_superacion_eval_confamar_html_" . session_id() . ".html";
          $str_htm    =  ob_get_contents();
          ob_end_clean();
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['prt_view'])
          { 
              echo $str_htm ;
              exit;
          } 
          ...
          fclose($arq_htm);
          $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "form_t_evaluacion_p1_5_superacion_eval_confamar";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_name']))
          {
              $nm_arquivo_pdf_base = str_replace(".pdf", "", $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_name']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_name']);
          }
          ...
          $NM_tit_doc = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['pdf_name'] : "form_t_evaluacion_p1_5_superacion_eval_confamar";
...
<HEAD>
 <TITLE><?php echo strip_tags("ASIGNATURA:  [asigna]") ?></TITLE>
...
<form name="Fdown" method="get" action="form_t_evaluacion_p1_5_superacion_eval_confamar_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_t_evaluacion_p1_5_superacion_eval_confamar"> 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'dc6_':
               ...
               break;
           case 'dc7_':
               return "" . $_SESSION['par_cod_desemp7'] . "";
               break;
           case 'dc8_':
               return "" . $_SESSION['par_cod_desemp8'] . "";
               break;
           case 'dc9_':
               return "" . $_SESSION['par_cod_desemp9'] . "";
               break;
           case 'dc10_':
               return "" . $_SESSION['par_cod_desemp10'] . "";
               break;
           case 'dc11_':
               return "" . $_SESSION['par_cod_desemp11'] . "";
               break;
           case 'dc12_':
               return "" . $_SESSION['par_cod_desemp12'] . "";
               break;
           case 'letras_p1_':
               return "Letras P 1";
               break;
           ...
           case 'eval_2_per_':
               ...
               break;
           case 'nota_supe_p2_':
               return "Nota Supe P 2";
               break;
           case 'nota_perdio_p2_':
               return "Nota Perdio P 2";
               break;
           case 'dc1_2p_':
               return "Dc 1 2p";
               break;
           ...
           case 'eval_3_per_':
               ...
               break;
           case 'nota_supe_p3_':
               return "Nota Supe P 3";
               break;
           case 'nota_perdio_p3_':
               return "Nota Perdio P 3";
               break;
           case 'dc1_3p_':
               return "Dc 1 3p";
               break;
           ...
           case 'eval_4_per_':
               ...
               break;
           case 'nota_supe_p4_':
               return "Nota Supe P 4";
               break;
           case 'nota_perdio_p4_':
               return "Nota Perdio P 4";
               break;
           case 'dc1_p4_':
               return "Dc 1 P 4";
               break;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_t_evaluacion_p1_5_superacion_eval_confamar'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "id_estudiante_";

      if ('' == $filtro || 'eval_1_per_' == $filtro)
        $this->ValidateField_eval_1_per_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "eval_1_per_";

      if ('' == $filtro || 'nota_perdio_p1_' == $filtro)
        $this->ValidateField_nota_perdio_p1_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "nota_perdio_p1_";

      if ('' == $filtro || 'nota_supe_p1_' == $filtro)
        $this->ValidateField_nota_supe_p1_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "nota_supe_p1_";
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_estudiante_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['php_cmp_required']['id_estudiante_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['php_cmp_required']['id_estudiante_'] == "on"))
      {
          ...
          if (!empty($this->id_estudiante_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['Lookup_id_estudiante_']) && !in_array($this->id_estudiante_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['Lookup_id_estudiante_']))
          {
    ...
    function ValidateField_eval_1_per_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "1Per: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_nota_perdio_p1_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nota_perdio_p1_ == "")  
      { 
          $this->nota_perdio_p1_ = 0;
          $this->sc_force_zero[] = 'nota_perdio_p1_';
      } 
      if (!empty($this->field_config['nota_perdio_p1_']['symbol_dec']))
      {
          nm_limpa_valor($this->nota_perdio_p1_, $this->field_config['nota_perdio_p1_']['symbol_dec'], $this->field_config['nota_perdio_p1_']['symbol_grp']) ; 
          if ('.' == substr($this->nota_perdio_p1_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->nota_perdio_p1_, 1)))
              {
                  $this->nota_perdio_p1_ = '';
              }
              else
              {
                  $this->nota_perdio_p1_ = '0' . $this->nota_perdio_p1_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->nota_perdio_p1_) > $iTestSize)  
              { 
                  $Campos_Crit .= "NPP1: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['nota_perdio_p1_']))
                  {
                      $Campos_Erros['nota_perdio_p1_'] = array();
                  }
                  $Campos_Erros['nota_perdio_p1_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['nota_perdio_p1_']) || !is_array($this->NM_ajax_info['errList']['nota_perdio_p1_']))
                  {
                      $this->NM_ajax_info['errList']['nota_perdio_p1_'] = array();
                  }
                  $this->NM_ajax_info['errList']['nota_perdio_p1_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->nota_perdio_p1_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "NPP1; " ; 
                  if (!isset($Campos_Erros['nota_perdio_p1_']))
                  {
                  ...
                  $Campos_Erros['nota_perdio_p1_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['nota_perdio_p1_']) || !is_array($this->NM_ajax_info['errList']['nota_perdio_p1_']))
                  {
                      $this->NM_ajax_info['errList']['nota_perdio_p1_'] = array();
                  }
                  $this->NM_ajax_info['errList']['nota_perdio_p1_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_nota_perdio_p1_

    function ValidateField_nota_supe_p1_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nota_supe_p1_ == "")  
      { 
          $this->nota_supe_p1_ = 0;
          $this->sc_force_zero[] = 'nota_supe_p1_';
      } 
      if (!empty($this->field_config['nota_supe_p1_']['symbol_dec']))
      {
          nm_limpa_valor($this->nota_supe_p1_, $this->field_config['nota_supe_p1_']['symbol_dec'], $this->field_config['nota_supe_p1_']['symbol_grp']) ; 
          if ('.' == substr($this->nota_supe_p1_, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->nota_supe_p1_, 1)))
              {
                  $this->nota_supe_p1_ = '';
              }
              else
              {
                  $this->nota_supe_p1_ = '0' . $this->nota_supe_p1_;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->nota_supe_p1_) > $iTestSize)  
              { 
                  $Campos_Crit .= "NSP1: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['nota_supe_p1_']))
                  {
                      $Campos_Erros['nota_supe_p1_'] = array();
                  }
                  $Campos_Erros['nota_supe_p1_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['nota_supe_p1_']) || !is_array($this->NM_ajax_info['errList']['nota_supe_p1_']))
                  {
                      $this->NM_ajax_info['errList']['nota_supe_p1_'] = array();
                  }
                  $this->NM_ajax_info['errList']['nota_supe_p1_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->nota_supe_p1_, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "NSP1; " ; 
                  if (!isset($Campos_Erros['nota_supe_p1_']))
                  {
                  ...
                  $Campos_Erros['nota_supe_p1_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['nota_supe_p1_']) || !is_array($this->NM_ajax_info['errList']['nota_supe_p1_']))
                  {
                      $this->NM_ajax_info['errList']['nota_supe_p1_'] = array();
                  }
                  $this->NM_ajax_info['errList']['nota_supe_p1_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_nota_supe_p1_
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['nota_perdio_p1_'] = $this->nota_perdio_p1_;
    $this->nmgp_dados_form['nota_supe_p1_'] = $this->nota_supe_p1_;
    ...
    $this->nmgp_dados_form['dc10_'] = $this->dc10_;
    $this->nmgp_dados_form['dc11_'] = $this->dc11_;
    $this->nmgp_dados_form['dc12_'] = $this->dc12_;
    $this->nmgp_dados_form['letras_p1_'] = $this->letras_p1_;
    ...
    $this->nmgp_dados_form['nota_supe_p2_'] = $this->nota_supe_p2_;
    $this->nmgp_dados_form['nota_perdio_p2_'] = $this->nota_perdio_p2_;
    ...
    $this->nmgp_dados_form['letras_p2_'] = $this->letras_p2_;
    ...
    $this->nmgp_dados_form['nota_supe_p3_'] = $this->nota_supe_p3_;
    $this->nmgp_dados_form['nota_perdio_p3_'] = $this->nota_perdio_p3_;
    ...
    $this->nmgp_dados_form['letras_p3_'] = $this->letras_p3_;
    ...
    $this->nmgp_dados_form['nota_supe_p4_'] = $this->nota_supe_p4_;
    $this->nmgp_dados_form['nota_perdio_p4_'] = $this->nota_perdio_p4_;
    ...
    $this->nmgp_dados_form['letras_p4_'] = $this->letras_p4_;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      if (!empty($this->field_config['dc6_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc6_, $this->field_config['dc6_']['symbol_dec'], $this->field_config['dc6_']['symbol_grp']);
      }
      if (!empty($this->field_config['dc7_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc7_, $this->field_config['dc7_']['symbol_dec'], $this->field_config['dc7_']['symbol_grp']);
      }
      if (!empty($this->field_config['dc8_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc8_, $this->field_config['dc8_']['symbol_dec'], $this->field_config['dc8_']['symbol_grp']);
      }
      if (!empty($this->field_config['dc9_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc9_, $this->field_config['dc9_']['symbol_dec'], $this->field_config['dc9_']['symbol_grp']);
      }
      if (!empty($this->field_config['dc10_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc10_, $this->field_config['dc10_']['symbol_dec'], $this->field_config['dc10_']['symbol_grp']);
      }
      if (!empty($this->field_config['dc11_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc11_, $this->field_config['dc11_']['symbol_dec'], $this->field_config['dc11_']['symbol_grp']);
      }
      if (!empty($this->field_config['dc12_']['symbol_dec']))
      {
         nm_limpa_valor($this->dc12_, $this->field_config['dc12_']['symbol_dec'], $this->field_config['dc12_']['symbol_grp']);
      }
      ...
      nm_limpa_numero($this->eval_2_per_, $this->field_config['eval_2_per_']['symbol_grp']) ; 
      if (!empty($this->field_config['nota_supe_p2_']['symbol_dec']))
      {
         nm_limpa_valor($this->nota_supe_p2_, $this->field_config['nota_supe_p2_']['symbol_dec'], $this->field_config['nota_supe_p2_']['symbol_grp']);
      }
      if (!empty($this->field_config['nota_perdio_p2_']['symbol_dec']))
      {
         nm_limpa_valor($this->nota_perdio_p2_, $this->field_config['nota_perdio_p2_']['symbol_dec'], $this->field_config['nota_perdio_p2_']['symbol_grp']);
      }
      nm_limpa_numero($this->dc1_2p_, $this->field_config['dc1_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc2_2p_, $this->field_config['dc2_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc3_2p_, $this->field_config['dc3_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc4_2p_, $this->field_config['dc4_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc5_2p_, $this->field_config['dc5_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_dc2_, $this->field_config['pcent_dc2_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds1_2p_, $this->field_config['ds1_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds2_2p_, $this->field_config['ds2_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds3_2p_, $this->field_config['ds3_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds4_2p_, $this->field_config['ds4_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds5_2p_, $this->field_config['ds5_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_ds2_, $this->field_config['pcent_ds2_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp1_2p_, $this->field_config['dp1_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp2_2p_, $this->field_config['dp2_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp3_2p_, $this->field_config['dp3_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp4_2p_, $this->field_config['dp4_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp5_2p_, $this->field_config['dp5_2p_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_dp2_, $this->field_config['pcent_dp2_']['symbol_grp']) ; 
      ...
      nm_limpa_numero($this->eval_3_per_, $this->field_config['eval_3_per_']['symbol_grp']) ; 
      if (!empty($this->field_config['nota_supe_p3_']['symbol_dec']))
      {
         nm_limpa_valor($this->nota_supe_p3_, $this->field_config['nota_supe_p3_']['symbol_dec'], $this->field_config['nota_supe_p3_']['symbol_grp']);
      }
      if (!empty($this->field_config['nota_perdio_p3_']['symbol_dec']))
      {
         nm_limpa_valor($this->nota_perdio_p3_, $this->field_config['nota_perdio_p3_']['symbol_dec'], $this->field_config['nota_perdio_p3_']['symbol_grp']);
      }
      nm_limpa_numero($this->dc1_3p_, $this->field_config['dc1_3p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc2_3p_, $this->field_config['dc2_3p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc3_3p_, $this->field_config['dc3_3p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc4_3p_, $this->field_config['dc4_3p_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc5_3p_, $this->field_config['dc5_3p_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_dc3_, $this->field_config['pcent_dc3_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds1_p3_, $this->field_config['ds1_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds2_p3_, $this->field_config['ds2_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds3_p3_, $this->field_config['ds3_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds4_p3_, $this->field_config['ds4_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds5_p3_, $this->field_config['ds5_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_ds3_, $this->field_config['pcent_ds3_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp1_p3_, $this->field_config['dp1_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp2_p3_, $this->field_config['dp2_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp3_p3_, $this->field_config['dp3_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp4_p3_, $this->field_config['dp4_p3_']['symbol_grp']) ; 
      nm_limpa_numero($this->sc_field_0_, $this->field_config['sc_field_0_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_dp3_, $this->field_config['pcent_dp3_']['symbol_grp']) ; 
      ...
      nm_limpa_numero($this->eval_4_per_, $this->field_config['eval_4_per_']['symbol_grp']) ; 
      if (!empty($this->field_config['nota_supe_p4_']['symbol_dec']))
      {
         nm_limpa_valor($this->nota_supe_p4_, $this->field_config['nota_supe_p4_']['symbol_dec'], $this->field_config['nota_supe_p4_']['symbol_grp']);
      }
      if (!empty($this->field_config['nota_perdio_p4_']['symbol_dec']))
      {
         nm_limpa_valor($this->nota_perdio_p4_, $this->field_config['nota_perdio_p4_']['symbol_dec'], $this->field_config['nota_perdio_p4_']['symbol_grp']);
      }
      nm_limpa_numero($this->dc1_p4_, $this->field_config['dc1_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc2_p4_, $this->field_config['dc2_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc3_p4_, $this->field_config['dc3_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc4_p4_, $this->field_config['dc4_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dc5_p4_, $this->field_config['dc5_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_dc4_, $this->field_config['pcent_dc4_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds1_p4_, $this->field_config['ds1_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds2_p4_, $this->field_config['ds2_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds3_p4_, $this->field_config['ds3_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds4_p4_, $this->field_config['ds4_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->ds5_p4_, $this->field_config['ds5_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->pcent_ds4_, $this->field_config['pcent_ds4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp1_p4_, $this->field_config['dp1_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp2_p4_, $this->field_config['dp2_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp3_p4_, $this->field_config['dp3_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp4_p4_, $this->field_config['dp4_p4_']['symbol_grp']) ; 
      nm_limpa_numero($this->dp5_p4_, $this->field_config['dp5_p4_']['symbol_grp']) ; 
      ...
      nm_limpa_numero($this->pcent_dp4_, $this->field_config['pcent_dp4_']['symbol_grp']) ; 
      nm_limpa_numero($this->eval_final_, $this->field_config['eval_final_']['symbol_grp']) ; 
   ...
   function nm_formatar_campos($format_fields = array())
   {
      ...
      if (!empty($this->nota_perdio_p1_) || (!empty($format_fields) && isset($format_fields['nota_perdio_p1_'])))
      {
          nmgp_Form_Num_Val($this->nota_perdio_p1_, $this->field_config['nota_perdio_p1_']['symbol_grp'], $this->field_config['nota_perdio_p1_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['nota_perdio_p1_']['symbol_fmt']) ; 
      }
      if (!empty($this->nota_supe_p1_) || (!empty($format_fields) && isset($format_fields['nota_supe_p1_'])))
      {
          nmgp_Form_Num_Val($this->nota_supe_p1_, $this->field_config['nota_supe_p1_']['symbol_grp'], $this->field_config['nota_supe_p1_']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['nota_supe_p1_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['id_estudiante_']['keyVal'] = form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string($this->nmgp_dados_form['id_estudiante_']);
              $this->NM_ajax_info['fldList']['id_grupo_']['keyVal'] = form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string($this->nmgp_dados_form['id_grupo_']);
              $this->NM_ajax_info['fldList']['id_asignatura_']['keyVal'] = form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string($this->nmgp_dados_form['id_asignatura_']);
              $this->NM_ajax_info['fldList']['entorno_']['keyVal'] = form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string($this->nmgp_dados_form['entorno_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$this->nmgp_refresh_row]['id_estudiante_'] = $this->id_estudiante_;
                  }
                  if (isset($this->NM_ajax_changed['eval_1_per_']) && $this->NM_ajax_changed['eval_1_per_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$this->nmgp_refresh_row]['eval_1_per_'] = $this->eval_1_per_;
                  }
                  if (isset($this->NM_ajax_changed['nota_perdio_p1_']) && $this->NM_ajax_changed['nota_perdio_p1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$this->nmgp_refresh_row]['nota_perdio_p1_'] = $this->nota_perdio_p1_;
                  }
                  if (isset($this->NM_ajax_changed['nota_supe_p1_']) && $this->NM_ajax_changed['nota_supe_p1_'])
                  {
                      $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$this->nmgp_refresh_row]['nota_supe_p1_'] = $this->nota_supe_p1_;
                  }
              }
          }
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar);
          foreach($this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar as $sc_seq_vert => $aRecData)
          {
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_estudiante_' . $sc_seq_vert]['valList'][$i] = form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string($v);
          }
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nota_perdio_p1_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['nota_perdio_p1_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['nota_perdio_p1_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nota_supe_p1_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['nota_supe_p1_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['nota_supe_p1_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
   ...
   { 
      ...
      $this->nota_perdio_p1_ = str_replace($sc_parm1, $sc_parm2, $this->nota_perdio_p1_); 
      $this->nota_supe_p1_ = str_replace($sc_parm1, $sc_parm2, $this->nota_supe_p1_); 
      ...
      $this->dc6_ = str_replace($sc_parm1, $sc_parm2, $this->dc6_); 
      $this->dc7_ = str_replace($sc_parm1, $sc_parm2, $this->dc7_); 
      $this->dc8_ = str_replace($sc_parm1, $sc_parm2, $this->dc8_); 
      $this->dc9_ = str_replace($sc_parm1, $sc_parm2, $this->dc9_); 
      $this->dc10_ = str_replace($sc_parm1, $sc_parm2, $this->dc10_); 
      $this->dc11_ = str_replace($sc_parm1, $sc_parm2, $this->dc11_); 
      $this->dc12_ = str_replace($sc_parm1, $sc_parm2, $this->dc12_); 
      ...
      $this->nota_supe_p2_ = str_replace($sc_parm1, $sc_parm2, $this->nota_supe_p2_); 
      $this->nota_perdio_p2_ = str_replace($sc_parm1, $sc_parm2, $this->nota_perdio_p2_); 
      $this->nota_supe_p3_ = str_replace($sc_parm1, $sc_parm2, $this->nota_supe_p3_); 
      $this->nota_perdio_p3_ = str_replace($sc_parm1, $sc_parm2, $this->nota_perdio_p3_); 
      $this->nota_supe_p4_ = str_replace($sc_parm1, $sc_parm2, $this->nota_supe_p4_); 
      $this->nota_perdio_p4_ = str_replace($sc_parm1, $sc_parm2, $this->nota_perdio_p4_); 
   } 
   function nm_poe_aspas_decimal() 
   { 
      $this->eval_1_per_ = "'" . $this->eval_1_per_ . "'";
      $this->nota_perdio_p1_ = "'" . $this->nota_perdio_p1_ . "'";
      $this->nota_supe_p1_ = "'" . $this->nota_supe_p1_ . "'";
      $this->dc1_ = "'" . $this->dc1_ . "'";
      $this->dc2_ = "'" . $this->dc2_ . "'";
      $this->dc3_ = "'" . $this->dc3_ . "'";
      $this->dc4_ = "'" . $this->dc4_ . "'";
      ...
      $this->dc8_ = "'" . $this->dc8_ . "'";
      $this->dc9_ = "'" . $this->dc9_ . "'";
      $this->dc10_ = "'" . $this->dc10_ . "'";
      $this->dc11_ = "'" . $this->dc11_ . "'";
      $this->dc12_ = "'" . $this->dc12_ . "'";
      ...
      $this->nota_supe_p2_ = "'" . $this->nota_supe_p2_ . "'";
      $this->nota_perdio_p2_ = "'" . $this->nota_perdio_p2_ . "'";
      $this->nota_supe_p3_ = "'" . $this->nota_supe_p3_ . "'";
      $this->nota_perdio_p3_ = "'" . $this->nota_perdio_p3_ . "'";
      $this->nota_supe_p4_ = "'" . $this->nota_supe_p4_ . "'";
      $this->nota_perdio_p4_ = "'" . $this->nota_perdio_p4_ . "'";
   } 
   function nm_tira_aspas_decimal() 
   { 
      $this->eval_1_per_ = str_replace("'", "", $this->eval_1_per_); 
      $this->nota_perdio_p1_ = str_replace("'", "", $this->nota_perdio_p1_); 
      $this->nota_supe_p1_ = str_replace("'", "", $this->nota_supe_p1_); 
      ...
      $this->dc6_ = str_replace("'", "", $this->dc6_); 
      $this->dc7_ = str_replace("'", "", $this->dc7_); 
      $this->dc8_ = str_replace("'", "", $this->dc8_); 
      $this->dc9_ = str_replace("'", "", $this->dc9_); 
      $this->dc10_ = str_replace("'", "", $this->dc10_); 
      $this->dc11_ = str_replace("'", "", $this->dc11_); 
      $this->dc12_ = str_replace("'", "", $this->dc12_); 
      ...
      $this->nota_supe_p2_ = str_replace("'", "", $this->nota_supe_p2_); 
      $this->nota_perdio_p2_ = str_replace("'", "", $this->nota_perdio_p2_); 
      $this->nota_supe_p3_ = str_replace("'", "", $this->nota_supe_p3_); 
      $this->nota_perdio_p3_ = str_replace("'", "", $this->nota_perdio_p3_); 
      $this->nota_supe_p4_ = str_replace("'", "", $this->nota_supe_p4_); 
      $this->nota_perdio_p4_ = str_replace("'", "", $this->nota_perdio_p4_); 
   } 
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          if ($this->nmgp_dados_select['id_estudiante_'] == $this->id_estudiante_ &&
              ...
              $this->nmgp_dados_select['nota_perdio_p1_'] == $this->nota_perdio_p1_ &&
              $this->nmgp_dados_select['nota_supe_p1_'] == $this->nota_supe_p1_)
          {
              $SC_ex_update = false; 
              $SC_ex_upd_or = false; 
          }
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'][$sc_seq_vert]['id_estudiante_'] = $this->id_estudiante_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'][$sc_seq_vert]['eval_1_per_'] = $this->eval_1_per_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'][$sc_seq_vert]['nota_perdio_p1_'] = $this->nota_perdio_p1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'][$sc_seq_vert]['nota_supe_p1_'] = $this->nota_supe_p1_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      $NM_val_form['nota_perdio_p1_'] = $this->nota_perdio_p1_;
      $NM_val_form['nota_supe_p1_'] = $this->nota_supe_p1_;
      ...
      $NM_val_form['dc10_'] = $this->dc10_;
      $NM_val_form['dc11_'] = $this->dc11_;
      $NM_val_form['dc12_'] = $this->dc12_;
      $NM_val_form['letras_p1_'] = $this->letras_p1_;
      ...
      $NM_val_form['nota_supe_p2_'] = $this->nota_supe_p2_;
      $NM_val_form['nota_perdio_p2_'] = $this->nota_perdio_p2_;
      ...
      $NM_val_form['letras_p2_'] = $this->letras_p2_;
      ...
      $NM_val_form['nota_supe_p3_'] = $this->nota_supe_p3_;
      $NM_val_form['nota_perdio_p3_'] = $this->nota_perdio_p3_;
      ...
      $NM_val_form['letras_p3_'] = $this->letras_p3_;
      ...
      $NM_val_form['nota_supe_p4_'] = $this->nota_supe_p4_;
      $NM_val_form['nota_perdio_p4_'] = $this->nota_perdio_p4_;
      ...
      $NM_val_form['letras_p4_'] = $this->letras_p4_;
      ...
      { 
          $this->dc10_ = 0;
          $this->sc_force_zero[] = 'dc10_';
      } 
      if ($this->dc11_ == "")  
      { 
          $this->dc11_ = 0;
          $this->sc_force_zero[] = 'dc11_';
      } 
      if ($this->dc12_ == "")  
      { 
          $this->dc12_ = 0;
          $this->sc_force_zero[] = 'dc12_';
      } 
      if ($this->pcent_dc_ == "")  
      { 
          $this->pcent_dc_ = 0;
      ...
      if ($this->nota_supe_p2_ == "")  
      { 
          $this->nota_supe_p2_ = 0;
          $this->sc_force_zero[] = 'nota_supe_p2_';
      } 
      if ($this->nota_perdio_p2_ == "")  
      { 
          $this->nota_perdio_p2_ = 0;
          $this->sc_force_zero[] = 'nota_perdio_p2_';
      } 
      if ($this->dc1_2p_ == "")  
      { 
          $this->dc1_2p_ = 0;
      ...
      if ($this->nota_supe_p3_ == "")  
      { 
          $this->nota_supe_p3_ = 0;
          $this->sc_force_zero[] = 'nota_supe_p3_';
      } 
      if ($this->nota_perdio_p3_ == "")  
      { 
          $this->nota_perdio_p3_ = 0;
          $this->sc_force_zero[] = 'nota_perdio_p3_';
      } 
      if ($this->dc1_3p_ == "")  
      { 
          $this->dc1_3p_ = 0;
      ...
      if ($this->nota_supe_p4_ == "")  
      { 
          $this->nota_supe_p4_ = 0;
          $this->sc_force_zero[] = 'nota_supe_p4_';
      } 
      if ($this->nota_perdio_p4_ == "")  
      { 
          $this->nota_perdio_p4_ = 0;
          $this->sc_force_zero[] = 'nota_perdio_p4_';
      } 
      if ($this->dc1_p4_ == "")  
      { 
          $this->dc1_p4_ = 0;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->letras_p1__before_qstr = $this->letras_p1_;
          $this->letras_p1_ = substr($this->Db->qstr($this->letras_p1_), 1, -1); 
          $this->letras_p2__before_qstr = $this->letras_p2_;
          $this->letras_p2_ = substr($this->Db->qstr($this->letras_p2_), 1, -1); 
          $this->letras_p3__before_qstr = $this->letras_p3_;
          $this->letras_p3_ = substr($this->Db->qstr($this->letras_p3_), 1, -1); 
          $this->letras_p4__before_qstr = $this->letras_p4_;
          $this->letras_p4_ = substr($this->Db->qstr($this->letras_p4_), 1, -1); 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) from " . $this->Ini->nm_tabela . " where id_estudiante = $this->id_estudiante_ and id_grupo = $this->id_grupo_ and id_asignatura = $this->id_asignatura_ and entorno = $this->entorno_ ";
          $rs1 = $this->Db->Execute("select count(*) from " . $this->Ini->nm_tabela . " where id_estudiante = $this->id_estudiante_ and id_grupo = $this->id_grupo_ and id_asignatura = $this->id_asignatura_ and entorno = $this->entorno_ "); 
          if ($rs1 === false)  
          { 
              $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              if ($this->NM_ajax_flag)
          ...
          { 
              ...
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET eval_1_per = $this->eval_1_per_, nota_supe_p1 = $this->nota_supe_p1_, nota_perdio_p1 = $this->nota_perdio_p1_";  
              } 
              else 
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET eval_1_per = $this->eval_1_per_, nota_supe_p1 = $this->nota_supe_p1_, nota_perdio_p1 = $this->nota_perdio_p1_";  
              } 
              ...
              if (isset($NM_val_form['novedad_']) && $NM_val_form['novedad_'] != $this->nmgp_dados_select['novedad_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " novedad = '$this->novedad_'"; 
                  $comando_oracle        .= " novedad = '$this->novedad_'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['estatus_']) && $NM_val_form['estatus_'] != $this->nmgp_dados_select['estatus_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " estatus = '$this->estatus_'"; 
                  $comando_oracle        .= " estatus = '$this->estatus_'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['inasistencia_p1_']) && $NM_val_form['inasistencia_p1_'] != $this->nmgp_dados_select['inasistencia_p1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " inasistencia_p1 = $this->inasistencia_p1_"; 
                  $comando_oracle        .= " inasistencia_p1 = $this->inasistencia_p1_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc1_']) && $NM_val_form['dc1_'] != $this->nmgp_dados_select['dc1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc1 = $this->dc1_"; 
                  $comando_oracle        .= " dc1 = $this->dc1_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc2_']) && $NM_val_form['dc2_'] != $this->nmgp_dados_select['dc2_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc2 = $this->dc2_"; 
                  $comando_oracle        .= " dc2 = $this->dc2_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc3_']) && $NM_val_form['dc3_'] != $this->nmgp_dados_select['dc3_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc3 = $this->dc3_"; 
                  $comando_oracle        .= " dc3 = $this->dc3_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc4_']) && $NM_val_form['dc4_'] != $this->nmgp_dados_select['dc4_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc4 = $this->dc4_"; 
                  $comando_oracle        .= " dc4 = $this->dc4_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc5_']) && $NM_val_form['dc5_'] != $this->nmgp_dados_select['dc5_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc5 = $this->dc5_"; 
                  $comando_oracle        .= " dc5 = $this->dc5_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['dc10_']) && $NM_val_form['dc10_'] != $this->nmgp_dados_select['dc10_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc10 = $this->dc10_"; 
                  $comando_oracle        .= " dc10 = $this->dc10_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc11_']) && $NM_val_form['dc11_'] != $this->nmgp_dados_select['dc11_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc11 = $this->dc11_"; 
                  $comando_oracle        .= " dc11 = $this->dc11_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dc12_']) && $NM_val_form['dc12_'] != $this->nmgp_dados_select['dc12_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc12 = $this->dc12_"; 
                  $comando_oracle        .= " dc12 = $this->dc12_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['letras_p1_']) && $NM_val_form['letras_p1_'] != $this->nmgp_dados_select['letras_p1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " letras_p1 = '$this->letras_p1_'"; 
                  $comando_oracle        .= " letras_p1 = '$this->letras_p1_'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['pcent_dc_']) && $NM_val_form['pcent_dc_'] != $this->nmgp_dados_select['pcent_dc_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " pcent_dc = $this->pcent_dc_"; 
                  $comando_oracle        .= " pcent_dc = $this->pcent_dc_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['ds1_']) && $NM_val_form['ds1_'] != $this->nmgp_dados_select['ds1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " ds1 = $this->ds1_"; 
                  $comando_oracle        .= " ds1 = $this->ds1_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['ds2_']) && $NM_val_form['ds2_'] != $this->nmgp_dados_select['ds2_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " ds2 = $this->ds2_"; 
                  $comando_oracle        .= " ds2 = $this->ds2_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['ds3_']) && $NM_val_form['ds3_'] != $this->nmgp_dados_select['ds3_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " ds3 = $this->ds3_"; 
                  $comando_oracle        .= " ds3 = $this->ds3_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['pcent_ds_']) && $NM_val_form['pcent_ds_'] != $this->nmgp_dados_select['pcent_ds_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " pcent_ds = $this->pcent_ds_"; 
                  $comando_oracle        .= " pcent_ds = $this->pcent_ds_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dp1_']) && $NM_val_form['dp1_'] != $this->nmgp_dados_select['dp1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dp1 = $this->dp1_"; 
                  $comando_oracle        .= " dp1 = $this->dp1_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dp2_']) && $NM_val_form['dp2_'] != $this->nmgp_dados_select['dp2_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dp2 = $this->dp2_"; 
                  $comando_oracle        .= " dp2 = $this->dp2_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['dp3_']) && $NM_val_form['dp3_'] != $this->nmgp_dados_select['dp3_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dp3 = $this->dp3_"; 
                  $comando_oracle        .= " dp3 = $this->dp3_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['pcent_dp_']) && $NM_val_form['pcent_dp_'] != $this->nmgp_dados_select['pcent_dp_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " pcent_dp = $this->pcent_dp_"; 
                  $comando_oracle        .= " pcent_dp = $this->pcent_dp_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['aeep1_']) && $NM_val_form['aeep1_'] != $this->nmgp_dados_select['aeep1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " aeep1 = $this->aeep1_"; 
                  $comando_oracle        .= " aeep1 = $this->aeep1_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['porcent_aeep1_']) && $NM_val_form['porcent_aeep1_'] != $this->nmgp_dados_select['porcent_aeep1_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " porcent_aeep1 = $this->porcent_aeep1_"; 
                  $comando_oracle        .= " porcent_aeep1 = $this->porcent_aeep1_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['nota_supe_p2_']) && $NM_val_form['nota_supe_p2_'] != $this->nmgp_dados_select['nota_supe_p2_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " nota_supe_p2 = $this->nota_supe_p2_"; 
                  $comando_oracle        .= " nota_supe_p2 = $this->nota_supe_p2_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['nota_perdio_p2_']) && $NM_val_form['nota_perdio_p2_'] != $this->nmgp_dados_select['nota_perdio_p2_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " nota_perdio_p2 = $this->nota_perdio_p2_"; 
                  $comando_oracle        .= " nota_perdio_p2 = $this->nota_perdio_p2_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['letras_p2_']) && $NM_val_form['letras_p2_'] != $this->nmgp_dados_select['letras_p2_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " letras_p2 = '$this->letras_p2_'"; 
                  $comando_oracle        .= " letras_p2 = '$this->letras_p2_'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['nota_supe_p3_']) && $NM_val_form['nota_supe_p3_'] != $this->nmgp_dados_select['nota_supe_p3_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " nota_supe_p3 = $this->nota_supe_p3_"; 
                  $comando_oracle        .= " nota_supe_p3 = $this->nota_supe_p3_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['nota_perdio_p3_']) && $NM_val_form['nota_perdio_p3_'] != $this->nmgp_dados_select['nota_perdio_p3_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " nota_perdio_p3 = $this->nota_perdio_p3_"; 
                  $comando_oracle        .= " nota_perdio_p3 = $this->nota_perdio_p3_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['letras_p3_']) && $NM_val_form['letras_p3_'] != $this->nmgp_dados_select['letras_p3_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " letras_p3 = '$this->letras_p3_'"; 
                  $comando_oracle        .= " letras_p3 = '$this->letras_p3_'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['nota_supe_p4_']) && $NM_val_form['nota_supe_p4_'] != $this->nmgp_dados_select['nota_supe_p4_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " nota_supe_p4 = $this->nota_supe_p4_"; 
                  $comando_oracle        .= " nota_supe_p4 = $this->nota_supe_p4_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['nota_perdio_p4_']) && $NM_val_form['nota_perdio_p4_'] != $this->nmgp_dados_select['nota_perdio_p4_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " nota_perdio_p4 = $this->nota_perdio_p4_"; 
                  $comando_oracle        .= " nota_perdio_p4 = $this->nota_perdio_p4_"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['letras_p4_']) && $NM_val_form['letras_p4_'] != $this->nmgp_dados_select['letras_p4_']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " letras_p4 = '$this->letras_p4_'"; 
                  $comando_oracle        .= " letras_p4 = '$this->letras_p4_'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              $comando .= " WHERE id_estudiante = $this->id_estudiante_ and id_grupo = $this->id_grupo_ and id_asignatura = $this->id_asignatura_ and entorno = $this->entorno_ ";  
          ...
          $this->letras_p1_ = $this->letras_p1__before_qstr;
          $this->letras_p2_ = $this->letras_p2__before_qstr;
          $this->letras_p3_ = $this->letras_p3__before_qstr;
          $this->letras_p4_ = $this->letras_p4__before_qstr;
              $this->sc_evento = "update"; 
              $this->nmgp_opcao = "igual"; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['nota_supe_p1_'])) { $this->nota_supe_p1_ = $NM_val_form['nota_supe_p1_']; }
              elseif (isset($this->nota_supe_p1_)) { $this->nm_limpa_alfa($this->nota_supe_p1_); }
              if     (isset($NM_val_form) && isset($NM_val_form['nota_perdio_p1_'])) { $this->nota_perdio_p1_ = $NM_val_form['nota_perdio_p1_']; }
              elseif (isset($this->nota_perdio_p1_)) { $this->nm_limpa_alfa($this->nota_perdio_p1_); }
              $this->nm_proc_onload_record($this->nmgp_refresh_row);

              $this->nm_formatar_campos();

              $aOldRefresh               = $this->nmgp_refresh_fields;
              $this->nmgp_refresh_fields = array_diff(array('id_estudiante_', 'eval_1_per_', 'nota_perdio_p1_', 'nota_supe_p1_'), $aDoNotUpdate);
              $this->ajax_return_values();
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['nota_perdio_p1_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['nota_supe_p1_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "id_estudiante, primer_apellido, segundo_apellido, primer_nombre, segundo_nombre, id_grupo, id_area, id_asignatura, id_grado, id_nivel, ihs, pfa, tipo_asig, novedad, estatus, inasistencia_p1, eval_1_per, nota_supe_p1, nota_perdio_p1, dc1, dc2, dc3, dc4, dc5, dc6, dc7, dc8, dc9, dc10, dc11, dc12, letras_p1, pcent_dc, ds1, ds2, ds3, ds4, ds5, pcent_ds, dp1, dp2, dp3, dp4, dp5, pcent_dp, aeep1, porcent_aeep1, inasistencia_p2, eval_2_per, nota_supe_p2, nota_perdio_p2, dc1_2p, dc2_2p, dc3_2p, dc4_2p, dc5_2p, pcent_dc2, ds1_2p, ds2_2p, ds3_2p, ds4_2p, ds5_2p, pcent_ds2, dp1_2p, dp2_2p, dp3_2p, dp4_2p, dp5_2p, pcent_dp2, aee_p2, letras_p2, porcet_aee_p2, inasistencia_p3, eval_3_per, nota_supe_p3, nota_perdio_p3, dc1_3p, dc2_3p, dc3_3p, dc4_3p, dc5_3p, pcent_dc3, ds1_p3, ds2_p3, ds3_p3, ds4_p3, ds5_p3, pcent_ds3, dp1_p3, dp2_p3, dp3_p3, dp4_p3, `dp5-p3`, pcent_dp3, aee_p3, letras_p3, porcent_aee_p3, inasistencia_p4, eval_4_per, nota_supe_p4, nota_perdio_p4, dc1_p4, dc2_p4, dc3_p4, dc4_p4, dc5_p4, pcent_dc4, ds1_p4, ds2_p4, ds3_p4, ds4_p4, ds5_p4, pcent_ds4, dp1_p4, dp2_p4, dp3_p4, dp4_p4, dp5_p4, aee_p4, letras_p4, porcent_aee_p4, pcent_dp4, eval_final, entorno) VALUES (" . $NM_seq_auto . "$this->id_estudiante_, '$this->primer_apellido_', '$this->segundo_apellido_', '$this->primer_nombre_', '$this->segundo_nombre_', $this->id_grupo_, $this->id_area_, $this->id_asignatura_, $this->id_grado_, $this->id_nivel_, $this->ihs_, $this->pfa_, '$this->tipo_asig_', '$this->novedad_', '$this->estatus_', $this->inasistencia_p1_, $this->eval_1_per_, $this->nota_supe_p1_, $this->nota_perdio_p1_, $this->dc1_, $this->dc2_, $this->dc3_, $this->dc4_, $this->dc5_, $this->dc6_, $this->dc7_, $this->dc8_, $this->dc9_, $this->dc10_, $this->dc11_, $this->dc12_, '$this->letras_p1_', $this->pcent_dc_, $this->ds1_, $this->ds2_, $this->ds3_, $this->ds4_, $this->ds5_, $this->pcent_ds_, $this->dp1_, $this->dp2_, $this->dp3_, $this->dp4_, $this->dp5_, $this->pcent_dp_, $this->aeep1_, $this->porcent_aeep1_, $this->inasistencia_p2_, $this->eval_2_per_, $this->nota_supe_p2_, $this->nota_perdio_p2_, $this->dc1_2p_, $this->dc2_2p_, $this->dc3_2p_, $this->dc4_2p_, $this->dc5_2p_, $this->pcent_dc2_, $this->ds1_2p_, $this->ds2_2p_, $this->ds3_2p_, $this->ds4_2p_, $this->ds5_2p_, $this->pcent_ds2_, $this->dp1_2p_, $this->dp2_2p_, $this->dp3_2p_, $this->dp4_2p_, $this->dp5_2p_, $this->pcent_dp2_, $this->aee_p2_, '$this->letras_p2_', $this->porcet_aee_p2_, $this->inasistencia_p3_, $this->eval_3_per_, $this->nota_supe_p3_, $this->nota_perdio_p3_, $this->dc1_3p_, $this->dc2_3p_, $this->dc3_3p_, $this->dc4_3p_, $this->dc5_3p_, $this->pcent_dc3_, $this->ds1_p3_, $this->ds2_p3_, $this->ds3_p3_, $this->ds4_p3_, $this->ds5_p3_, $this->pcent_ds3_, $this->dp1_p3_, $this->dp2_p3_, $this->dp3_p3_, $this->dp4_p3_, $this->sc_field_0_, $this->pcent_dp3_, $this->aee_p3_, '$this->letras_p3_', $this->porcent_aee_p3_, $this->inasistencia_p4_, $this->eval_4_per_, $this->nota_supe_p4_, $this->nota_perdio_p4_, $this->dc1_p4_, $this->dc2_p4_, $this->dc3_p4_, $this->dc4_p4_, $this->dc5_p4_, $this->pcent_dc4_, $this->ds1_p4_, $this->ds2_p4_, $this->ds3_p4_, $this->ds4_p4_, $this->ds5_p4_, $this->pcent_ds4_, $this->dp1_p4_, $this->dp2_p4_, $this->dp3_p4_, $this->dp4_p4_, $this->dp5_p4_, $this->aee_p4_, '$this->letras_p4_', $this->porcent_aee_p4_, $this->pcent_dp4_, $this->eval_final_, $this->entorno_)"; 
              }
              else
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "id_estudiante, primer_apellido, segundo_apellido, primer_nombre, segundo_nombre, id_grupo, id_area, id_asignatura, id_grado, id_nivel, ihs, pfa, tipo_asig, novedad, estatus, inasistencia_p1, eval_1_per, nota_supe_p1, nota_perdio_p1, dc1, dc2, dc3, dc4, dc5, dc6, dc7, dc8, dc9, dc10, dc11, dc12, letras_p1, pcent_dc, ds1, ds2, ds3, ds4, ds5, pcent_ds, dp1, dp2, dp3, dp4, dp5, pcent_dp, aeep1, porcent_aeep1, inasistencia_p2, eval_2_per, nota_supe_p2, nota_perdio_p2, dc1_2p, dc2_2p, dc3_2p, dc4_2p, dc5_2p, pcent_dc2, ds1_2p, ds2_2p, ds3_2p, ds4_2p, ds5_2p, pcent_ds2, dp1_2p, dp2_2p, dp3_2p, dp4_2p, dp5_2p, pcent_dp2, aee_p2, letras_p2, porcet_aee_p2, inasistencia_p3, eval_3_per, nota_supe_p3, nota_perdio_p3, dc1_3p, dc2_3p, dc3_3p, dc4_3p, dc5_3p, pcent_dc3, ds1_p3, ds2_p3, ds3_p3, ds4_p3, ds5_p3, pcent_ds3, dp1_p3, dp2_p3, dp3_p3, dp4_p3, `dp5-p3`, pcent_dp3, aee_p3, letras_p3, porcent_aee_p3, inasistencia_p4, eval_4_per, nota_supe_p4, nota_perdio_p4, dc1_p4, dc2_p4, dc3_p4, dc4_p4, dc5_p4, pcent_dc4, ds1_p4, ds2_p4, ds3_p4, ds4_p4, ds5_p4, pcent_ds4, dp1_p4, dp2_p4, dp3_p4, dp4_p4, dp5_p4, aee_p4, letras_p4, porcent_aee_p4, pcent_dp4, eval_final, entorno) VALUES (" . $NM_seq_auto . "$this->id_estudiante_, '$this->primer_apellido_', '$this->segundo_apellido_', '$this->primer_nombre_', '$this->segundo_nombre_', $this->id_grupo_, $this->id_area_, $this->id_asignatura_, $this->id_grado_, $this->id_nivel_, $this->ihs_, $this->pfa_, '$this->tipo_asig_', '$this->novedad_', '$this->estatus_', $this->inasistencia_p1_, $this->eval_1_per_, $this->nota_supe_p1_, $this->nota_perdio_p1_, $this->dc1_, $this->dc2_, $this->dc3_, $this->dc4_, $this->dc5_, $this->dc6_, $this->dc7_, $this->dc8_, $this->dc9_, $this->dc10_, $this->dc11_, $this->dc12_, '$this->letras_p1_', $this->pcent_dc_, $this->ds1_, $this->ds2_, $this->ds3_, $this->ds4_, $this->ds5_, $this->pcent_ds_, $this->dp1_, $this->dp2_, $this->dp3_, $this->dp4_, $this->dp5_, $this->pcent_dp_, $this->aeep1_, $this->porcent_aeep1_, $this->inasistencia_p2_, $this->eval_2_per_, $this->nota_supe_p2_, $this->nota_perdio_p2_, $this->dc1_2p_, $this->dc2_2p_, $this->dc3_2p_, $this->dc4_2p_, $this->dc5_2p_, $this->pcent_dc2_, $this->ds1_2p_, $this->ds2_2p_, $this->ds3_2p_, $this->ds4_2p_, $this->ds5_2p_, $this->pcent_ds2_, $this->dp1_2p_, $this->dp2_2p_, $this->dp3_2p_, $this->dp4_2p_, $this->dp5_2p_, $this->pcent_dp2_, $this->aee_p2_, '$this->letras_p2_', $this->porcet_aee_p2_, $this->inasistencia_p3_, $this->eval_3_per_, $this->nota_supe_p3_, $this->nota_perdio_p3_, $this->dc1_3p_, $this->dc2_3p_, $this->dc3_3p_, $this->dc4_3p_, $this->dc5_3p_, $this->pcent_dc3_, $this->ds1_p3_, $this->ds2_p3_, $this->ds3_p3_, $this->ds4_p3_, $this->ds5_p3_, $this->pcent_ds3_, $this->dp1_p3_, $this->dp2_p3_, $this->dp3_p3_, $this->dp4_p3_, $this->sc_field_0_, $this->pcent_dp3_, $this->aee_p3_, '$this->letras_p3_', $this->porcent_aee_p3_, $this->inasistencia_p4_, $this->eval_4_per_, $this->nota_supe_p4_, $this->nota_perdio_p4_, $this->dc1_p4_, $this->dc2_p4_, $this->dc3_p4_, $this->dc4_p4_, $this->dc5_p4_, $this->pcent_dc4_, $this->ds1_p4_, $this->ds2_p4_, $this->ds3_p4_, $this->ds4_p4_, $this->ds5_p4_, $this->pcent_ds4_, $this->dp1_p4_, $this->dp2_p4_, $this->dp3_p4_, $this->dp4_p4_, $this->dp5_p4_, $this->aee_p4_, '$this->letras_p4_', $this->porcent_aee_p4_, $this->pcent_dp4_, $this->eval_final_, $this->entorno_)"; 
              ...
              $this->sc_evento = "insert"; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_I_E']++; 
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total'] + 1; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
...
ORDER BY nombre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_t_evaluacion_p1_5_superacion_eval_confamar_pack_protect_string(NM_charset_to_utf8($this->id_estudiante_)))
              {
          ...
          $tmpLabel_id_estudiante_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['nota_perdio_p1_' . $this->nmgp_refresh_row]['type']    = 'label';
                  $this->NM_ajax_info['fldList']['nota_perdio_p1_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->nota_perdio_p1_));
                  $this->NM_ajax_info['fldList']['nota_perdio_p1_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_nota_perdio_p1_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['nota_perdio_p1_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['nota_perdio_p1_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['nota_supe_p1_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['nota_supe_p1_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->nota_supe_p1_));
                  $this->NM_ajax_info['fldList']['nota_supe_p1_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_nota_supe_p1_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['nota_supe_p1_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['nota_supe_p1_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['entorno_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['entorno_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->entorno_));
                  $this->NM_ajax_info['fldList']['entorno_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_entorno_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['entorno_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['entorno_' . $this->nmgp_refresh_row] = "on";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          $this->entorno_ = substr($this->Db->qstr($this->entorno_), 1, -1); 
          ...
          { 
              $rs1->Close(); 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where id_estudiante = $this->id_estudiante_ and id_grupo = $this->id_grupo_ and id_asignatura = $this->id_asignatura_ and entorno = $this->entorno_ "; 
              $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where id_estudiante = $this->id_estudiante_ and id_grupo = $this->id_grupo_ and id_asignatura = $this->id_asignatura_ and entorno = $this->entorno_ "); 
              if ($rs === false) 
              { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['parms'] = "id_estudiante_?#?$this->id_estudiante_?@?id_grupo_?#?$this->id_grupo_?@?id_asignatura_?#?$this->id_asignatura_?@?entorno_?#?$this->entorno_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_t_evaluacion_p1_5_superacion_eval_confamar']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['parms'] = ""; 
      } 
      if ($this->sc_teve_excl)
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter'] . ")";
          }
      }
      $sc_where = trim("id_grupo ='" . $_SESSION['par_idgrupo'] . "' AND id_asignatura=' " . $_SESSION['par_id_asignatura'] . "' AND entorno =' " . $_SESSION['entorno'] . "' AND eval_1_per<'" . $_SESSION['bajo'] . "'");
      ...
      if (((isset($this->NM_ajax_opcao) && 'backup_line' == $this->NM_ajax_opcao) || (isset($this->NM_btn_navega) && 'N' == $this->NM_btn_navega)) && !$this->has_where_params && 'novo' != $this->nmgp_opcao)
      {
          ...
          if (null != $this->entorno_)
          {
              $aNewWhereCond[] = "entorno = " . $this->entorno_;
          }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']))
          {
              ...
              $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total'] = $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_I_E'] = 0; 
          if (!$this->sc_teve_excl && !$this->sc_teve_incl) 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = 0; 
          } 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_estudiante_) && !empty($this->id_grupo_) && !empty($this->id_asignatura_) && !empty($this->entorno_))
          {
              $Reg_OK      = false;
              $Count_start = -1;
              $sc_order_by = "";
              $Sel_Chave = "id_estudiante, id_grupo, id_asignatura, entorno"; 
              ...
              while (!$rt->EOF && !$Reg_OK)
              { 
                  if ($rt->fields[0] == $this->id_estudiante_ && $rt->fields[1] == $this->id_grupo_ && $rt->fields[2] == $this->id_asignatura_ && $rt->fields[3] == $this->entorno_)
                  { 
                      $Reg_OK = true;
                  }  
                  $Count_start++;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] > $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = ($qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['ordem_ord']; 
      } 
      $nmgp_select = "SELECT id_estudiante, primer_apellido, segundo_apellido, primer_nombre, segundo_nombre, id_grupo, id_area, id_asignatura, id_grado, id_nivel, ihs, pfa, tipo_asig, novedad, estatus, inasistencia_p1, eval_1_per, nota_supe_p1, nota_perdio_p1, dc1, dc2, dc3, dc4, dc5, dc6, dc7, dc8, dc9, dc10, dc11, dc12, letras_p1, pcent_dc, ds1, ds2, ds3, ds4, ds5, pcent_ds, dp1, dp2, dp3, dp4, dp5, pcent_dp, aeep1, porcent_aeep1, inasistencia_p2, eval_2_per, nota_supe_p2, nota_perdio_p2, dc1_2p, dc2_2p, dc3_2p, dc4_2p, dc5_2p, pcent_dc2, ds1_2p, ds2_2p, ds3_2p, ds4_2p, ds5_2p, pcent_ds2, dp1_2p, dp2_2p, dp3_2p, dp4_2p, dp5_2p, pcent_dp2, aee_p2, letras_p2, porcet_aee_p2, inasistencia_p3, eval_3_per, nota_supe_p3, nota_perdio_p3, dc1_3p, dc2_3p, dc3_3p, dc4_3p, dc5_3p, pcent_dc3, ds1_p3, ds2_p3, ds3_p3, ds4_p3, ds5_p3, pcent_ds3, dp1_p3, dp2_p3, dp3_p3, dp4_p3, `dp5-p3` as sc_field_0_, pcent_dp3, aee_p3, letras_p3, porcent_aee_p3, inasistencia_p4, eval_4_per, nota_supe_p4, nota_perdio_p4, dc1_p4, dc2_p4, dc3_p4, dc4_p4, dc5_p4, pcent_dc4, ds1_p4, ds2_p4, ds3_p4, ds4_p4, ds5_p4, pcent_ds4, dp1_p4, dp2_p4, dp3_p4, dp4_p4, dp5_p4, aee_p4, letras_p4, porcent_aee_p4, pcent_dp4, eval_final, entorno from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      if ($this->nmgp_opcao != "novo") 
      { 
      ...
      else
      {
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start']) ; 
              } 
              else  
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              $this->nota_supe_p1_ = (strpos(strtolower($this->nota_supe_p1_), "e")) ? (float)$this->nota_supe_p1_ : $this->nota_supe_p1_; 
              $this->nota_supe_p1_ = (string)$this->nota_supe_p1_; 
              $this->nota_perdio_p1_ = (strpos(strtolower($this->nota_perdio_p1_), "e")) ? (float)$this->nota_perdio_p1_ : $this->nota_perdio_p1_; 
              $this->nota_perdio_p1_ = (string)$this->nota_perdio_p1_; 
              ...
              $this->dc10_ = (strpos(strtolower($this->dc10_), "e")) ? (float)$this->dc10_ : $this->dc10_; 
              $this->dc10_ = (string)$this->dc10_; 
              $this->dc11_ = (strpos(strtolower($this->dc11_), "e")) ? (float)$this->dc11_ : $this->dc11_; 
              $this->dc11_ = (string)$this->dc11_; 
              $this->dc12_ = (strpos(strtolower($this->dc12_), "e")) ? (float)$this->dc12_ : $this->dc12_; 
              $this->dc12_ = (string)$this->dc12_; 
              ...
              $this->nota_supe_p2_ = (strpos(strtolower($this->nota_supe_p2_), "e")) ? (float)$this->nota_supe_p2_ : $this->nota_supe_p2_; 
              $this->nota_supe_p2_ = (string)$this->nota_supe_p2_; 
              $this->nota_perdio_p2_ = (strpos(strtolower($this->nota_perdio_p2_), "e")) ? (float)$this->nota_perdio_p2_ : $this->nota_perdio_p2_; 
              $this->nota_perdio_p2_ = (string)$this->nota_perdio_p2_; 
              ...
              $this->nota_supe_p3_ = (strpos(strtolower($this->nota_supe_p3_), "e")) ? (float)$this->nota_supe_p3_ : $this->nota_supe_p3_; 
              $this->nota_supe_p3_ = (string)$this->nota_supe_p3_; 
              $this->nota_perdio_p3_ = (strpos(strtolower($this->nota_perdio_p3_), "e")) ? (float)$this->nota_perdio_p3_ : $this->nota_perdio_p3_; 
              $this->nota_perdio_p3_ = (string)$this->nota_perdio_p3_; 
              ...
              $this->nota_supe_p4_ = (strpos(strtolower($this->nota_supe_p4_), "e")) ? (float)$this->nota_supe_p4_ : $this->nota_supe_p4_; 
              $this->nota_supe_p4_ = (string)$this->nota_supe_p4_; 
              $this->nota_perdio_p4_ = (strpos(strtolower($this->nota_perdio_p4_), "e")) ? (float)$this->nota_perdio_p4_ : $this->nota_perdio_p4_; 
              $this->nota_perdio_p4_ = (string)$this->nota_perdio_p4_; 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['parms'] = "id_estudiante_?#?$this->id_estudiante_?@?id_grupo_?#?$this->id_grupo_?@?id_asignatura_?#?$this->id_asignatura_?@?entorno_?#?$this->entorno_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['id_estudiante_'] =  $this->id_estudiante_; 
             $this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar[$sc_seq_vert]['eval_1_per_'] =  $this->eval_1_per_; 
          ...
          ksort ($this->form_vert_form_t_evaluacion_p1_5_superacion_eval_confamar); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] < (($qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['reg_start'] + $this->sc_max_reg;
...
$this->nm_formatar_campos('eval_1_per_');
...
if ($this->dc1_  > $this->sc_temp_nota_maxima || $this->dc2_  > $this->sc_temp_nota_maxima || $this->dc3_  > $this->sc_temp_nota_maxima|| $this->dc4_  > $this->sc_temp_nota_maxima|| $this->dc5_  > $this->sc_temp_nota_maxima|| $this->dc6_  > $this->sc_temp_nota_maxima ||$this->ds1_ > $this->sc_temp_nota_maxima||$this->ds2_ > $this->sc_temp_nota_maxima||$this->ds3_ > $this->sc_temp_nota_maxima||$this->ds4_ > $this->sc_temp_nota_maxima||$this->ds5_ > $this->sc_temp_nota_maxima||$this->dp1_ > $this->sc_temp_nota_maxima||$this->dp2_2p_  > $this->sc_temp_nota_maxima||$this->dp3_ > $this->sc_temp_nota_maxima||$this->dp4_ > $this->sc_temp_nota_maxima||$this->dp5_ > $this->sc_temp_nota_maxima )
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_t_evaluacion_p1_5_superacion_eval_confamar' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$this->pcent_dc_  = $this->pcent_dc_ +$this->dc6_ *25/100;
...
function nota_supe_p1__onChange($nota_perdio_p1_, $nota_supe_p1_, $eval_1_per_)
{
$_SESSION['scriptcase']['form_t_evaluacion_p1_5_superacion_eval_confamar']['contr_erro'] = 'on';
                                         
$original_eval_1_per_ = $this->eval_1_per_;
$original_nota_supe_p1_ = $this->nota_supe_p1_;
$original_nota_perdio_p1_ = $this->nota_perdio_p1_;
$original_nota_perdio_p1_ = $this->nota_perdio_p1_;
$original_nota_supe_p1_ = $this->nota_supe_p1_;
$original_eval_1_per_ = $this->eval_1_per_;
...
if( $this->eval_1_per_ <$this->nota_supe_p1_ )
	{
	$this->nota_perdio_p1_ =$this->eval_1_per_ ;
	 $this->eval_1_per_ =$this->nota_supe_p1_ ;
	  
	 }
	else{
		  $error_message = 'La Nota de superación no puede ser Menor a Nota Periodo ';
 		$this->nm_mens_alert[] = "$error_message"; if ($this->NM_ajax_flag) { $this->sc_ajax_alert("$error_message"); }}
		 


$modificado_eval_1_per_ = $this->eval_1_per_;
$modificado_nota_supe_p1_ = $this->nota_supe_p1_;
$modificado_nota_perdio_p1_ = $this->nota_perdio_p1_;
$modificado_nota_perdio_p1_ = $this->nota_perdio_p1_;
$modificado_nota_supe_p1_ = $this->nota_supe_p1_;
$modificado_eval_1_per_ = $this->eval_1_per_;
$this->nm_formatar_campos('eval_1_per_', 'nota_supe_p1_', 'nota_perdio_p1_');
$this->nmgp_refresh_fields = array();
if ($original_eval_1_per_ !== $modificado_eval_1_per_ || (isset($bFlagRead_eval_1_per_) && $bFlagRead_eval_1_per_))
{
    $this->nmgp_refresh_fields[] = 'eval_1_per_';
...
if ($original_nota_supe_p1_ !== $modificado_nota_supe_p1_ || (isset($bFlagRead_nota_supe_p1_) && $bFlagRead_nota_supe_p1_))
{
    $this->nmgp_refresh_fields[] = 'nota_supe_p1_';
    $this->NM_ajax_changed['nota_supe_p1_'] = true;
    $this->NM_ajax_force_values = true;
}
if ($original_nota_perdio_p1_ !== $modificado_nota_perdio_p1_ || (isset($bFlagRead_nota_perdio_p1_) && $bFlagRead_nota_perdio_p1_))
{
    $this->nmgp_refresh_fields[] = 'nota_perdio_p1_';
    $this->NM_ajax_changed['nota_perdio_p1_'] = true;
    $this->NM_ajax_force_values = true;
}
if ($original_nota_perdio_p1_ !== $modificado_nota_perdio_p1_ || (isset($bFlagRead_nota_perdio_p1_) && $bFlagRead_nota_perdio_p1_))
{
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['empty_filter']);
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc6", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc7", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc8", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc9", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc10", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc11", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "dc12", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "letras_p1", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "inasistencia_p2", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "aee_p2", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "letras_p2", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "porcet_aee_p2", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "inasistencia_p3", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "aee_p3", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "letras_p3", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "porcent_aee_p3", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "inasistencia_p4", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "aee_p4", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "letras_p4", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "porcent_aee_p4", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "nota_perdio_p1", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "nota_supe_p1", $arg_search, $data_search);
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter_form'] . " and (id_grupo ='" . $_SESSION['par_idgrupo'] . "' AND id_asignatura=' " . $_SESSION['par_id_asignatura'] . "' AND entorno =' " . $_SESSION['entorno'] . "' AND eval_1_per<'" . $_SESSION['bajo'] . "') and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where id_grupo ='" . $_SESSION['par_idgrupo'] . "' AND id_asignatura=' " . $_SESSION['par_id_asignatura'] . "' AND entorno =' " . $_SESSION['entorno'] . "' AND eval_1_per<'" . $_SESSION['bajo'] . "' and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['total'] = $qt_geral_reg_form_t_evaluacion_p1_5_superacion_eval_confamar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_t_evaluacion_p1_5_superacion_eval_confamar_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "id_estudiante";$nm_numeric[] = "id_grupo";$nm_numeric[] = "id_area";$nm_numeric[] = "id_asignatura";$nm_numeric[] = "id_grado";$nm_numeric[] = "id_nivel";$nm_numeric[] = "ihs";$nm_numeric[] = "pfa";$nm_numeric[] = "inasistencia_p1";$nm_numeric[] = "eval_1_per";$nm_numeric[] = "nota_supe_p1";$nm_numeric[] = "nota_perdio_p1";$nm_numeric[] = "dc1";$nm_numeric[] = "dc2";$nm_numeric[] = "dc3";$nm_numeric[] = "dc4";$nm_numeric[] = "dc5";$nm_numeric[] = "dc6";$nm_numeric[] = "dc7";$nm_numeric[] = "dc8";$nm_numeric[] = "dc9";$nm_numeric[] = "dc10";$nm_numeric[] = "dc11";$nm_numeric[] = "dc12";$nm_numeric[] = "pcent_dc";$nm_numeric[] = "ds1";$nm_numeric[] = "ds2";$nm_numeric[] = "ds3";$nm_numeric[] = "ds4";$nm_numeric[] = "ds5";$nm_numeric[] = "pcent_ds";$nm_numeric[] = "dp1";$nm_numeric[] = "dp2";$nm_numeric[] = "dp3";$nm_numeric[] = "dp4";$nm_numeric[] = "dp5";$nm_numeric[] = "pcent_dp";$nm_numeric[] = "aeep1";$nm_numeric[] = "porcent_aeep1";$nm_numeric[] = "inasistencia_p2";$nm_numeric[] = "eval_2_per";$nm_numeric[] = "nota_supe_p2";$nm_numeric[] = "nota_perdio_p2";$nm_numeric[] = "dc1_2p";$nm_numeric[] = "dc2_2p";$nm_numeric[] = "dc3_2p";$nm_numeric[] = "dc4_2p";$nm_numeric[] = "dc5_2p";$nm_numeric[] = "pcent_dc2";$nm_numeric[] = "ds1_2p";$nm_numeric[] = "ds2_2p";$nm_numeric[] = "ds3_2p";$nm_numeric[] = "ds4_2p";$nm_numeric[] = "ds5_2p";$nm_numeric[] = "pcent_ds2";$nm_numeric[] = "dp1_2p";$nm_numeric[] = "dp2_2p";$nm_numeric[] = "dp3_2p";$nm_numeric[] = "dp4_2p";$nm_numeric[] = "dp5_2p";$nm_numeric[] = "pcent_dp2";$nm_numeric[] = "aee_p2";$nm_numeric[] = "porcet_aee_p2";$nm_numeric[] = "inasistencia_p3";$nm_numeric[] = "eval_3_per";$nm_numeric[] = "nota_supe_p3";$nm_numeric[] = "nota_perdio_p3";$nm_numeric[] = "dc1_3p";$nm_numeric[] = "dc2_3p";$nm_numeric[] = "dc3_3p";$nm_numeric[] = "dc4_3p";$nm_numeric[] = "dc5_3p";$nm_numeric[] = "pcent_dc3";$nm_numeric[] = "ds1_p3";$nm_numeric[] = "ds2_p3";$nm_numeric[] = "ds3_p3";$nm_numeric[] = "ds4_p3";$nm_numeric[] = "ds5_p3";$nm_numeric[] = "pcent_ds3";$nm_numeric[] = "dp1_p3";$nm_numeric[] = "dp2_p3";$nm_numeric[] = "dp3_p3";$nm_numeric[] = "dp4_p3";$nm_numeric[] = "`dp5-p3`";$nm_numeric[] = "pcent_dp3";$nm_numeric[] = "aee_p3";$nm_numeric[] = "porcent_aee_p3";$nm_numeric[] = "inasistencia_p4";$nm_numeric[] = "eval_4_per";$nm_numeric[] = "nota_supe_p4";$nm_numeric[] = "nota_perdio_p4";$nm_numeric[] = "dc1_p4";$nm_numeric[] = "dc2_p4";$nm_numeric[] = "dc3_p4";$nm_numeric[] = "dc4_p4";$nm_numeric[] = "dc5_p4";$nm_numeric[] = "pcent_dc4";$nm_numeric[] = "ds1_p4";$nm_numeric[] = "ds2_p4";$nm_numeric[] = "ds3_p4";$nm_numeric[] = "ds4_p4";$nm_numeric[] = "ds5_p4";$nm_numeric[] = "pcent_ds4";$nm_numeric[] = "dp1_p4";$nm_numeric[] = "dp2_p4";$nm_numeric[] = "dp3_p4";$nm_numeric[] = "dp4_p4";$nm_numeric[] = "dp5_p4";$nm_numeric[] = "aee_p4";$nm_numeric[] = "porcent_aee_p4";$nm_numeric[] = "pcent_dp4";$nm_numeric[] = "eval_final";$nm_numeric[] = "entorno";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_t_evaluacion_p1_5_superacion_eval_confamar_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_t_evaluacion_p1_5_superacion_eval_confamar_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_5_superacion_eval_confamar']['masterValue']))
{
?>
