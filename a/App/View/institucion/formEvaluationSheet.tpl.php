...
<head>
	...
	<link href="<?php echo pb;?>/Public/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo pb;?>/Public/css/style.css" rel="stylesheet" type="text/css">
</head>
<body>
	<input type="hidden" id="id_base" value="<?php echo $db;?>"/>
	<input type="hidden" id="id_url" value="<?php echo pb;?>"/>
	<div class="container">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-primary" style="margin-top: 10px;">
					...
					<div class="panel-body">
						<form action="<?php echo pb;?>/pdf/testPdf" method="POST" enctype="application/x-www-form-urlencoded">
					    	<div class="row">
					    		<div class="col-md-4">
			...
			var db = $('#id_base').val();
   			...
   			$('#selectSede').change(function(){
   				$.ajax({
	                type: "GET",
	                dataType: "html",
	                url: urls+'/ajax/getDocentes/'+db+'/'+this.value,
   			...
   			$('#selectDocente').change(function(){
   				$.ajax({
	                type: "GET",
	                dataType: "html",
	                url: urls+'/ajax/getAsignaturesByTeacher/'+db+'/'+this.value,
	                success: function(data){
