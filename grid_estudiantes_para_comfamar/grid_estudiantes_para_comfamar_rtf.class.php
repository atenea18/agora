...
class grid_estudiantes_para_comfamar_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_estudiantes_para_comfamar_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_estudiantes_para_comfamar.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_para_comfamar']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_para_comfamar']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_para_comfamar']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_para_comfamar']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_estudiantes_para_comfamar']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_para_comfamar']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_para_comfamar']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
