<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_estudiante_grupo_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_estudiante_grupo_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["nombre"] : "Nombre";
   ...
   $tab_labels["novedades_novedad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["novedades_novedad"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["novedades_novedad"] : "Nov";
   ...
   $tab_labels["col1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col1"] : "      ";
   ...
   $tab_labels["col2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col2"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col2"] : "      ";
   ...
   $tab_labels["col3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col3"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col3"] : "      ";
   ...
   $tab_labels["col4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col4"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col4"] : "      ";
   ...
   $tab_labels["col5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col5"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col5"] : "      ";
   ...
   $tab_labels["col6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col6"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col6"] : "      ";
   ...
   $tab_labels["col7"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col7"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col7"] : "      ";
   ...
   $tab_labels["col8"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col8"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col8"] : "      ";
   ...
   $tab_labels["col9"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col9"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col9"] : "      ";
   ...
   $tab_labels["col10"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col10"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col10"] : "      ";
   ...
   $tab_labels["col11"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col11"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col11"] : "      ";
   ...
   $tab_labels["col12"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col12"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col12"] : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   $tab_labels["col13"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col13"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col13"] : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   $tab_labels["col14"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col14"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col14"] : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   $tab_labels["col15"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col15"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col15"] : "&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   $tab_labels["col16"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col16"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col16"] : "&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   $tab_labels["col17"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col17"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['labels']["col17"] : "&nbsp;&nbsp;&nbsp;&nbsp;";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
function Sel_processa_form()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos;
   ...
   $str_schema_all = (isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['str_schema_all']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['str_schema_all'])) ? $_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['str_schema_all'] : "neutro_agora/neutro_agora";
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_estudiante_grupo_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_estudiante_grupo_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
