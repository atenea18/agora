...
$_SESSION['scriptcase']['grid_t_area']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['xml_name']);
      }
      if (!$this->Grava_view)
      {
...
$_SESSION['scriptcase']['grid_t_area']['contr_erro'] = 'off'; 
   ...
   function NM_export_sc_field_0()
   {
         ...
         $this->xml_registro .= " SUM(t_evaluacion.ihs) =\"" . $this->trata_dados($this->sc_field_0) . "\"";
   }
   //----- sc_field_1
   function NM_export_sc_field_1()
   {
         ...
         $this->xml_registro .= " AVG(evaluacion) =\"" . $this->trata_dados($this->sc_field_1) . "\"";
   }
   //----- n_desp_area
   function NM_export_n_desp_area()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->n_desp_area))
         {
             $this->n_desp_area = sc_convert_encoding($this->n_desp_area, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " n_desp_area =\"" . $this->trata_dados($this->n_desp_area) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>CERTIFICADO DE ESTUDIO :: XML</TITLE>
