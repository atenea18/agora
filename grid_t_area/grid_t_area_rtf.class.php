...
$_SESSION['scriptcase']['grid_t_area']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_t_area']['contr_erro'] = 'off'; 
   ...
   function NM_export_n_desp_area()
   {
         ...
         $this->n_desp_area = str_replace('<', '&lt;', $this->n_desp_area);
         $this->n_desp_area = str_replace('>', '&gt;', $this->n_desp_area);
         $this->Texto_tag .= "<td>" . $this->n_desp_area . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_area']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>CERTIFICADO DE ESTUDIO :: RTF</TITLE>
