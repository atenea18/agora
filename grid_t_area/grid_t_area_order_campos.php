<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_area_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_area_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_area_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["t_area_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["t_area_area"] : "Áreas y Asignaturas";
   ...
   {
       $tab_def_campos['sc_field_0'] = "SUM(t_evaluacion.ihs)";
       $tab_converte["SUM(t_evaluacion.ihs)"]   = "sc_field_0";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["sc_field_0"] : "IHS";
   ...
   {
       $tab_def_campos['sc_field_1'] = "AVG(evaluacion)";
       $tab_converte["AVG(evaluacion)"]   = "sc_field_1";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["sc_field_1"] : "Valoración";
   $tab_ger_campos['n_desp_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['n_desp_area'] = "n_desp_area";
       $tab_converte["n_desp_area"]   = "n_desp_area";
   }
   else
   {
       $tab_def_campos['n_desp_area'] = "";
       $tab_converte[""]   = "n_desp_area";
   }
   $tab_labels["n_desp_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["n_desp_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_area']['labels']["n_desp_area"] : "Desempeño";
   $tab_ger_campos['n_desp_area'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_area']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_area']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_area_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_area']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
