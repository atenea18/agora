...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_t_area_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_t_area_1"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_t_area'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_t_area_1']['embutida_filho'] as $ind => $sc_init)
          {
