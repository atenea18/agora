...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } 
?> 
<?php $sStyleHidden_iddepartamento_dumb = ('' == $sStyleHidden_iddepartamento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_iddepartamento_dumb" style="<?php echo $sStyleHidden_iddepartamento_dumb; ?>"></TD>
<?php $sStyleHidden_idmunicipio_dumb = ('' == $sStyleHidden_idmunicipio) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idmunicipio_dumb" style="<?php echo $sStyleHidden_idmunicipio_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_tel_fijo_dumb = ('' == $sStyleHidden_tel_fijo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tel_fijo_dumb" style="<?php echo $sStyleHidden_tel_fijo_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_tel_celular_dumb = ('' == $sStyleHidden_tel_celular) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tel_celular_dumb" style="<?php echo $sStyleHidden_tel_celular_dumb; ?>"></TD>
