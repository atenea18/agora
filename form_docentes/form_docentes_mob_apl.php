...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['sc_session'][$script_case_init]['form_docentes_mob']['upload_field_info']['foto'] = array(
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_docentes_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_docentes_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - docentes";
      ...
      $_SESSION['scriptcase']['error_icon']['form_docentes_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['upload_field_ul_name'][$this->foto_ul_name]))
          {
              $this->NM_ajax_info['param']['foto_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['upload_field_ul_name'][$this->foto_ul_name];
          }
      ...
      elseif (isset($this->foto_ul_name) && '' != $this->foto_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['upload_field_ul_name'][$this->foto_ul_name]))
          {
              $this->foto_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['upload_field_ul_name'][$this->foto_ul_name];
          }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['where_pesq'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['embutida_liga_form_insert'];
      }
...
//---------------------------------------------------------
    ...
    {
        global $teste_validade;
               if (!empty($this->iddepartamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['Lookup_iddepartamento']) && !in_array($this->iddepartamento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['Lookup_iddepartamento']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->idmunicipio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['Lookup_idmunicipio']) && !in_array($this->idmunicipio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['Lookup_idmunicipio']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_area) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['Lookup_id_area']) && !in_array($this->id_area, $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['Lookup_id_area']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_id_docente();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['id_docente']['keyVal'] = form_docentes_mob_pack_protect_string($this->nmgp_dados_form['id_docente']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_docentes_mob_pack_protect_string('null') => form_docentes_mob_pack_protect_string('Seleccione'));
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_docentes_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_docentes_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['iddepartamento']['valList'][$i] = form_docentes_mob_pack_protect_string($v);
          }
...
ORDER BY nombreMunicipio";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idmunicipio']['valList'][$i] = form_docentes_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY area";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_area']['valList'][$i] = form_docentes_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_perfil($bForce = false)
   {
          ...
          //----- id_docente
   function ajax_return_values_id_docente($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("id_docente", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->id_docente);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['id_docente'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
...
if (isset($this->rs[0][0]))     
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_docentes_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_docentes_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->perfil = $this->perfil_before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['id_docente'])) { $this->id_docente = $NM_val_form['id_docente']; }
              elseif (isset($this->id_docente)) { $this->nm_limpa_alfa($this->id_docente); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('documento', 'foto', 'primer_apellido', 'segundo_apellido', 'primer_nombre', 'segundo_nombre', 'iddepartamento', 'idmunicipio', 'direccion', 'tel_fijo', 'tel_celular', 'email', 'id_area', 'login', 'password', 'confirm_pswd', 'perfil'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['parms'] = "id_docente?#?$this->id_docente?@?"; 
      }
...
//------------ 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_docente))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
...
//---------- 
      ...
      { 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['parms'] = "id_docente?#?$this->id_docente?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['sub_dir'][0]  = "docentes";
          } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dados_select']))
              {
                  ...
                  $this->tel_fijo = $this->nmgp_dados_select['tel_fijo'];  
                  $this->tel_celular = $this->nmgp_dados_select['tel_celular'];  
                  ...
                  $this->perfil = $this->nmgp_dados_select['perfil'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['foreign_key']))
          {
...
//-- 
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['sc_outra_jan'])
   {
