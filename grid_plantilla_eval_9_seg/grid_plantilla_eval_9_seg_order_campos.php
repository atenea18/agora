<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_plantilla_eval_9_seg_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_plantilla_eval_9_seg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_evaluacion_id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_id_estudiante"] : "Estudiante";
   $tab_ger_campos['t_evaluacion_novedad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_novedad'] = "t_evaluacion_novedad";
       $tab_converte["t_evaluacion_novedad"]   = "t_evaluacion_novedad";
   }
   else
   {
       $tab_def_campos['t_evaluacion_novedad'] = "t_evaluacion.novedad";
       $tab_converte["t_evaluacion.novedad"]   = "t_evaluacion_novedad";
   }
   $tab_labels["t_evaluacion_novedad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_novedad"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_novedad"] : "Nov";
   $tab_ger_campos['t_evaluacion_inasistencia_p1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_inasistencia_p1'] = "t_evaluacion_inasistencia_p1";
       $tab_converte["t_evaluacion_inasistencia_p1"]   = "t_evaluacion_inasistencia_p1";
   }
   else
   {
       $tab_def_campos['t_evaluacion_inasistencia_p1'] = "t_evaluacion.inasistencia_p1";
       $tab_converte["t_evaluacion.inasistencia_p1"]   = "t_evaluacion_inasistencia_p1";
   }
   $tab_labels["t_evaluacion_inasistencia_p1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_inasistencia_p1"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_inasistencia_p1"] : "FA";
   ...
   $tab_labels["re"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["re"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["re"] : "RE";
   $tab_ger_campos['t_evaluacion_eval_1_per'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_eval_1_per'] = "t_evaluacion_eval_1_per";
       $tab_converte["t_evaluacion_eval_1_per"]   = "t_evaluacion_eval_1_per";
   }
   else
   {
       $tab_def_campos['t_evaluacion_eval_1_per'] = "t_evaluacion.eval_1_per";
       $tab_converte["t_evaluacion.eval_1_per"]   = "t_evaluacion_eval_1_per";
   }
   $tab_labels["t_evaluacion_eval_1_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_eval_1_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_eval_1_per"] : "P1";
   $tab_ger_campos['t_evaluacion_eval_2_per'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_eval_2_per'] = "t_evaluacion_eval_2_per";
       $tab_converte["t_evaluacion_eval_2_per"]   = "t_evaluacion_eval_2_per";
   }
   else
   {
       $tab_def_campos['t_evaluacion_eval_2_per'] = "t_evaluacion.eval_2_per";
       $tab_converte["t_evaluacion.eval_2_per"]   = "t_evaluacion_eval_2_per";
   }
   $tab_labels["t_evaluacion_eval_2_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_eval_2_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_eval_2_per"] : "P2";
   $tab_ger_campos['t_evaluacion_eval_3_per'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_eval_3_per'] = "t_evaluacion_eval_3_per";
       $tab_converte["t_evaluacion_eval_3_per"]   = "t_evaluacion_eval_3_per";
   }
   else
   {
       $tab_def_campos['t_evaluacion_eval_3_per'] = "t_evaluacion.eval_3_per";
       $tab_converte["t_evaluacion.eval_3_per"]   = "t_evaluacion_eval_3_per";
   }
   $tab_labels["t_evaluacion_eval_3_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_eval_3_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_eval_3_per"] : "P3";
   ...
   $tab_labels["fa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["fa"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["fa"] : "VAc";
   ...
   $tab_labels["vra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["vra"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["vra"] : "VRa";
   $tab_ger_campos['t_evaluacion_dc1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_dc1'] = "t_evaluacion_dc1";
       $tab_converte["t_evaluacion_dc1"]   = "t_evaluacion_dc1";
   }
   else
   {
       $tab_def_campos['t_evaluacion_dc1'] = "t_evaluacion.dc1";
       $tab_converte["t_evaluacion.dc1"]   = "t_evaluacion_dc1";
   }
   $tab_labels["t_evaluacion_dc1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc1"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc1"] : "ExP";
   $tab_ger_campos['t_evaluacion_dc2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_dc2'] = "t_evaluacion_dc2";
       $tab_converte["t_evaluacion_dc2"]   = "t_evaluacion_dc2";
   }
   else
   {
       $tab_def_campos['t_evaluacion_dc2'] = "t_evaluacion.dc2";
       $tab_converte["t_evaluacion.dc2"]   = "t_evaluacion_dc2";
   }
   $tab_labels["t_evaluacion_dc2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc2"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc2"] : "ExFp";
   $tab_ger_campos['t_evaluacion_dc3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_dc3'] = "t_evaluacion_dc3";
       $tab_converte["t_evaluacion_dc3"]   = "t_evaluacion_dc3";
   }
   else
   {
       $tab_def_campos['t_evaluacion_dc3'] = "t_evaluacion.dc3";
       $tab_converte["t_evaluacion.dc3"]   = "t_evaluacion_dc3";
   }
   $tab_labels["t_evaluacion_dc3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc3"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc3"] : "TyT";
   $tab_ger_campos['t_evaluacion_dc4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_dc4'] = "t_evaluacion_dc4";
       $tab_converte["t_evaluacion_dc4"]   = "t_evaluacion_dc4";
   }
   else
   {
       $tab_def_campos['t_evaluacion_dc4'] = "t_evaluacion.dc4";
       $tab_converte["t_evaluacion.dc4"]   = "t_evaluacion_dc4";
   }
   $tab_labels["t_evaluacion_dc4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc4"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc4"] : "ParA";
   $tab_ger_campos['t_evaluacion_dc5'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_dc5'] = "t_evaluacion_dc5";
       $tab_converte["t_evaluacion_dc5"]   = "t_evaluacion_dc5";
   }
   else
   {
       $tab_def_campos['t_evaluacion_dc5'] = "t_evaluacion.dc5";
       $tab_converte["t_evaluacion.dc5"]   = "t_evaluacion_dc5";
   }
   $tab_labels["t_evaluacion_dc5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc5"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["t_evaluacion_dc5"] : "ObsR";
   ...
   $tab_labels["val"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["val"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['labels']["val"] : "VAL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_plantilla_eval_9_seg_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9_seg']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
