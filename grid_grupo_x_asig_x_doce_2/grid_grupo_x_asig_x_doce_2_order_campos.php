<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_grupo_x_asig_x_doce_2_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_grupo_x_asig_x_doce_2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["id_area"] : "Area";
   $tab_ger_campos['id_asignatura'] = "on";
   $tab_def_campos['id_asignatura'] = "id_asignatura";
   $tab_converte["id_asignatura"]   = "id_asignatura";
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["id_asignatura"] : "Asignatura";
   $tab_ger_campos['id_docente'] = "on";
   $tab_def_campos['id_docente'] = "id_docente";
   $tab_converte["id_docente"]   = "id_docente";
   $tab_labels["id_docente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["id_docente"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["id_docente"] : "Docente";
   $tab_ger_campos['intensidad_horaria'] = "on";
   $tab_def_campos['intensidad_horaria'] = "intensidad_horaria";
   $tab_converte["intensidad_horaria"]   = "intensidad_horaria";
   $tab_labels["intensidad_horaria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["intensidad_horaria"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["intensidad_horaria"] : "Intensidad Horaria";
   $tab_ger_campos['form_jack'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['form_jack'] = "form_jack";
       $tab_converte["form_jack"]   = "form_jack";
   }
   else
   {
       $tab_def_campos['form_jack'] = "";
       $tab_converte[""]   = "form_jack";
   }
   $tab_labels["form_jack"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["form_jack"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["form_jack"] : "notas";
   $tab_ger_campos['form2_joe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['form2_joe'] = "form2_joe";
       $tab_converte["form2_joe"]   = "form2_joe";
   }
   else
   {
       $tab_def_campos['form2_joe'] = "";
       $tab_converte[""]   = "form2_joe";
   }
   $tab_labels["form2_joe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["form2_joe"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['labels']["form2_joe"] : "form2_joe";
   $tab_ger_campos['form_jack'] = "none";
   $tab_ger_campos['form2_joe'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - grupo_x_asig_x_doce</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_grupo_x_asig_x_doce_2_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_2']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
