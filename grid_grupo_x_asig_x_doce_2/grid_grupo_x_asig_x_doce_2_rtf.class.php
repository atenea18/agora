...
class grid_grupo_x_asig_x_doce_2_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_grupo_x_asig_x_doce_2_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_grupo_x_asig_x_doce_2.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_2']['contr_erro'] = 'off'; 
   ...
   {
         nmgp_Form_Num_Val($this->look_id_docente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         ...
         $this->look_id_docente = str_replace('<', '&lt;', $this->look_id_docente);
         $this->look_id_docente = str_replace('>', '&gt;', $this->look_id_docente);
         $this->Texto_tag .= "<td>" . $this->look_id_docente . "</td>\r\n";
   }
   //----- intensidad_horaria
   ...
   function NM_export_form_jack()
   {
         ...
         $this->form_jack = str_replace('<', '&lt;', $this->form_jack);
         $this->form_jack = str_replace('>', '&gt;', $this->form_jack);
         $this->Texto_tag .= "<td>" . $this->form_jack . "</td>\r\n";
   }
   //----- form2_joe
   function NM_export_form2_joe()
   {
         ...
         $this->form2_joe = str_replace('<', '&lt;', $this->form2_joe);
         $this->form2_joe = str_replace('>', '&gt;', $this->form2_joe);
         $this->Texto_tag .= "<td>" . $this->form2_joe . "</td>\r\n";
   }
   //----- id_docente_grupo
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
