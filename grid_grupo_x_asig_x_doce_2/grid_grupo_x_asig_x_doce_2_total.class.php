...
class grid_grupo_x_asig_x_doce_2_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function grid_grupo_x_asig_x_doce_2_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_grupo_x_asig_x_doce_2']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_grupo_x_asig_x_doce_2']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $id_area, $id_asignatura, $id_docente;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_2']['contr_total_geral'] = "OK";
   } 
