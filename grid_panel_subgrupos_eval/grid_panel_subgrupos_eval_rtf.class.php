...
class grid_panel_subgrupos_eval_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_panel_subgrupos_eval_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_panel_subgrupos_eval.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_panel_subgrupos_eval']['contr_erro'] = 'off'; 
   ...
   function NM_export_t_subgrupos_id_grado()
   {
         ...
         $this->look_t_subgrupos_id_grado = str_replace('<', '&lt;', $this->look_t_subgrupos_id_grado);
         $this->look_t_subgrupos_id_grado = str_replace('>', '&gt;', $this->look_t_subgrupos_id_grado);
         $this->Texto_tag .= "<td>" . $this->look_t_subgrupos_id_grado . "</td>\r\n";
   }
   ...
   function NM_export_t_subgrupos_id_subgrupo()
   {
         ...
         $this->look_t_subgrupos_id_subgrupo = str_replace('<', '&lt;', $this->look_t_subgrupos_id_subgrupo);
         $this->look_t_subgrupos_id_subgrupo = str_replace('>', '&gt;', $this->look_t_subgrupos_id_subgrupo);
         $this->Texto_tag .= "<td>" . $this->look_t_subgrupos_id_subgrupo . "</td>\r\n";
   }
   ...
   function NM_export_sub_grupo_x_asig_x_doce_id_asignatura()
   {
         ...
         $this->look_sub_grupo_x_asig_x_doce_id_asignatura = str_replace('<', '&lt;', $this->look_sub_grupo_x_asig_x_doce_id_asignatura);
         $this->look_sub_grupo_x_asig_x_doce_id_asignatura = str_replace('>', '&gt;', $this->look_sub_grupo_x_asig_x_doce_id_asignatura);
         $this->Texto_tag .= "<td>" . $this->look_sub_grupo_x_asig_x_doce_id_asignatura . "</td>\r\n";
   }
   //----- evaluar_tec
   function NM_export_evaluar_tec()
   {
         ...
         $this->evaluar_tec = str_replace('<', '&lt;', $this->evaluar_tec);
         $this->evaluar_tec = str_replace('>', '&gt;', $this->evaluar_tec);
         $this->Texto_tag .= "<td>" . $this->evaluar_tec . "</td>\r\n";
   }
   ...
   function NM_export_sub_grupo_x_asig_x_doce_id_docente_sub_grupo()
   {
         ...
         $this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo = str_replace('<', '&lt;', $this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo);
         $this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo = str_replace('>', '&gt;', $this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo);
         $this->Texto_tag .= "<td>" . $this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo . "</td>\r\n";
   }
   ...
   function NM_export_sub_grupo_x_asig_x_doce_intensidad_horaria()
   {
         ...
         $this->sub_grupo_x_asig_x_doce_intensidad_horaria = str_replace('<', '&lt;', $this->sub_grupo_x_asig_x_doce_intensidad_horaria);
         $this->sub_grupo_x_asig_x_doce_intensidad_horaria = str_replace('>', '&gt;', $this->sub_grupo_x_asig_x_doce_intensidad_horaria);
         $this->Texto_tag .= "<td>" . $this->sub_grupo_x_asig_x_doce_intensidad_horaria . "</td>\r\n";
   }
   ...
   function NM_export_sub_grupo_x_asig_x_doce_peso_asig_fre_area()
   {
         ...
         $this->sub_grupo_x_asig_x_doce_peso_asig_fre_area = str_replace('<', '&lt;', $this->sub_grupo_x_asig_x_doce_peso_asig_fre_area);
         $this->sub_grupo_x_asig_x_doce_peso_asig_fre_area = str_replace('>', '&gt;', $this->sub_grupo_x_asig_x_doce_peso_asig_fre_area);
         $this->Texto_tag .= "<td>" . $this->sub_grupo_x_asig_x_doce_peso_asig_fre_area . "</td>\r\n";
   }
   ...
   function NM_export_sub_grupo_x_asig_x_doce_tipo_asig()
   {
         ...
         $this->sub_grupo_x_asig_x_doce_tipo_asig = str_replace('<', '&lt;', $this->sub_grupo_x_asig_x_doce_tipo_asig);
         $this->sub_grupo_x_asig_x_doce_tipo_asig = str_replace('>', '&gt;', $this->sub_grupo_x_asig_x_doce_tipo_asig);
         $this->Texto_tag .= "<td>" . $this->sub_grupo_x_asig_x_doce_tipo_asig . "</td>\r\n";
   }
   //----- docentes_id_area
   function NM_export_docentes_id_area()
   {
         ...
         $this->docentes_id_area = str_replace('<', '&lt;', $this->docentes_id_area);
         $this->docentes_id_area = str_replace('>', '&gt;', $this->docentes_id_area);
         $this->Texto_tag .= "<td>" . $this->docentes_id_area . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
