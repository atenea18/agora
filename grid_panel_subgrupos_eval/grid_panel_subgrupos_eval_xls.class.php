...
class grid_panel_subgrupos_eval_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $Tit_doc;
   //---- 
   function grid_panel_subgrupos_eval_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_panel_subgrupos_eval.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      { 
          ...
          if ($Cada_col == "t_subgrupos_id_grado" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
          ...
          if ($Cada_col == "t_subgrupos_id_subgrupo" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "sub_grupo_x_asig_x_doce_id_asignatura" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "evaluar_tec" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "sub_grupo_x_asig_x_doce_id_docente_sub_grupo" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "sub_grupo_x_asig_x_doce_intensidad_horaria" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "sub_grupo_x_asig_x_doce_peso_asig_fre_area" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "sub_grupo_x_asig_x_doce_tipo_asig" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "docentes_id_area" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$_SESSION['scriptcase']['grid_panel_subgrupos_eval']['contr_erro'] = 'off'; 
   ...
   function NM_export_t_subgrupos_id_subgrupo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->look_t_subgrupos_id_subgrupo))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_t_subgrupos_id_subgrupo);
         $this->Xls_col++;
   }
   //----- sub_grupo_x_asig_x_doce_id_asignatura
   function NM_export_sub_grupo_x_asig_x_doce_id_asignatura()
   {
         if (!NM_is_utf8($this->look_sub_grupo_x_asig_x_doce_id_asignatura))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->look_sub_grupo_x_asig_x_doce_id_asignatura))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_sub_grupo_x_asig_x_doce_id_asignatura);
         $this->Xls_col++;
   }
   //----- evaluar_tec
   function NM_export_evaluar_tec()
   {
         if (!NM_is_utf8($this->evaluar_tec))
         {
             $this->evaluar_tec = sc_convert_encoding($this->evaluar_tec, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->evaluar_tec, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- sub_grupo_x_asig_x_doce_id_docente_sub_grupo
   function NM_export_sub_grupo_x_asig_x_doce_id_docente_sub_grupo()
   {
         if (!NM_is_utf8($this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->sub_grupo_x_asig_x_doce_id_docente_sub_grupo);
         $this->Xls_col++;
   }
   //----- sub_grupo_x_asig_x_doce_intensidad_horaria
   function NM_export_sub_grupo_x_asig_x_doce_intensidad_horaria()
   {
         if (!NM_is_utf8($this->sub_grupo_x_asig_x_doce_intensidad_horaria))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->sub_grupo_x_asig_x_doce_intensidad_horaria))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->sub_grupo_x_asig_x_doce_intensidad_horaria);
         $this->Xls_col++;
   }
   //----- sub_grupo_x_asig_x_doce_peso_asig_fre_area
   function NM_export_sub_grupo_x_asig_x_doce_peso_asig_fre_area()
   {
         if (!NM_is_utf8($this->sub_grupo_x_asig_x_doce_peso_asig_fre_area))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->sub_grupo_x_asig_x_doce_peso_asig_fre_area))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->sub_grupo_x_asig_x_doce_peso_asig_fre_area);
         $this->Xls_col++;
   }
   //----- sub_grupo_x_asig_x_doce_tipo_asig
   function NM_export_sub_grupo_x_asig_x_doce_tipo_asig()
   {
         $this->sub_grupo_x_asig_x_doce_tipo_asig = html_entity_decode($this->sub_grupo_x_asig_x_doce_tipo_asig, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sub_grupo_x_asig_x_doce_tipo_asig = strip_tags($this->sub_grupo_x_asig_x_doce_tipo_asig);
         if (!NM_is_utf8($this->sub_grupo_x_asig_x_doce_tipo_asig))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->sub_grupo_x_asig_x_doce_tipo_asig, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- docentes_id_area
   function NM_export_docentes_id_area()
   {
         if (!NM_is_utf8($this->docentes_id_area))
         {
             $this->docentes_id_area = sc_convert_encoding($this->docentes_id_area, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->docentes_id_area))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->docentes_id_area);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_panel_subgrupos_eval']['xls_file'] = $this->Xls_f;
      }
