<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_panel_subgrupos_eval_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_panel_subgrupos_eval_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['t_subgrupos_id_grado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_subgrupos_id_grado'] = "t_subgrupos_id_grado";
       $tab_converte["t_subgrupos_id_grado"]   = "t_subgrupos_id_grado";
   }
   else
   {
       $tab_def_campos['t_subgrupos_id_grado'] = "t_subgrupos.id_grado";
       $tab_converte["t_subgrupos.id_grado"]   = "t_subgrupos_id_grado";
   }
   $tab_labels["t_subgrupos_id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["t_subgrupos_id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["t_subgrupos_id_grado"] : "Grado";
   $tab_ger_campos['t_subgrupos_id_subgrupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_subgrupos_id_subgrupo'] = "t_subgrupos_id_subgrupo";
       $tab_converte["t_subgrupos_id_subgrupo"]   = "t_subgrupos_id_subgrupo";
   }
   else
   {
       $tab_def_campos['t_subgrupos_id_subgrupo'] = "t_subgrupos.id_subgrupo";
       $tab_converte["t_subgrupos.id_subgrupo"]   = "t_subgrupos_id_subgrupo";
   }
   $tab_labels["t_subgrupos_id_subgrupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["t_subgrupos_id_subgrupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["t_subgrupos_id_subgrupo"] : "Subgrupo";
   $tab_ger_campos['sub_grupo_x_asig_x_doce_id_asignatura'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sub_grupo_x_asig_x_doce_id_asignatura'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "sub_grupo_x_asig_x_doce_id_asignatura";
   }
   else
   {
       $tab_def_campos['sub_grupo_x_asig_x_doce_id_asignatura'] = "sub_grupo_x_asig_x_doce.id_asignatura";
       $tab_converte["sub_grupo_x_asig_x_doce.id_asignatura"]   = "sub_grupo_x_asig_x_doce_id_asignatura";
   }
   $tab_labels["sub_grupo_x_asig_x_doce_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["sub_grupo_x_asig_x_doce_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["sub_grupo_x_asig_x_doce_id_asignatura"] : "Asignatura";
   $tab_ger_campos['evaluar_tec'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evaluar_tec'] = "evaluar_tec";
       $tab_converte["evaluar_tec"]   = "evaluar_tec";
   }
   else
   {
       $tab_def_campos['evaluar_tec'] = "";
       $tab_converte[""]   = "evaluar_tec";
   }
   $tab_labels["evaluar_tec"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["evaluar_tec"])) ? $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['labels']["evaluar_tec"] : "";
   $tab_ger_campos['evaluar_tec'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_panel_subgrupos_eval_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_panel_subgrupos_eval']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
