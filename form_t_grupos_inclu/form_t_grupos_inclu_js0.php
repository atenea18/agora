<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_grupo" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_grupo']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_inclu']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_grupos_inclu"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Seleccionar_Alumnos_par_id_grado = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_grado']); ?>";
var var_btn_Seleccionar_Alumnos_par_jornada = "<?php echo $this->form_encode_input($this->nmgp_dados_form['jornada']); ?>";
var var_btn_Seleccionar_Alumnos_par_sede = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_sede']); ?>";
function sc_btn_Seleccionar_Alumnos()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Seleccionar_Alumnos(); }, 500);
      return;
    }
  nm_gp_submit('<?php echo $this->Ini->link_grid_students_selec_grupos_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "par_id_grado?#?' + var_btn_Seleccionar_Alumnos_par_id_grado + '?@?par_jornada?#?' + var_btn_Seleccionar_Alumnos_par_jornada + '?@?par_sede?#?' + var_btn_Seleccionar_Alumnos_par_sede + '?@?"; ?>', 'inicio', '_self', '0', '0', 'grid_students_selec_grupos');
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_inclu']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_t_grupos_inclu_form0').style.width='1px';
    document.getElementById('form_t_grupos_inclu_form0').style.height='0px';
    document.getElementById('form_t_grupos_inclu_form0').style.display='none';
    document.getElementById('form_t_grupos_inclu_form0').style.overflow='scroll';
    document.getElementById('form_t_grupos_inclu_form1').style.width='1px';
    document.getElementById('form_t_grupos_inclu_form1').style.height='0px';
    document.getElementById('form_t_grupos_inclu_form1').style.display='none';
    document.getElementById('form_t_grupos_inclu_form1').style.overflow='scroll';
   ...
   if ("form_t_grupos_inclu_form0" == N_pagina) {
     scAjaxDetailHeight("grid_t_estudiante_est_en_grupo", "600");
    }
   if ("form_t_grupos_inclu_form1" == N_pagina) {
