...
$old_error_handler = set_error_handler("form_t_grupos_inclu_scriptcase_error_handler");

function form_t_grupos_inclu_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_t_grupos_inclu']['contr_erro']) && $_SESSION['scriptcase']['form_t_grupos_inclu']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_t_grupos_inclu->contr_form_t_grupos_inclu->Apl_com_erro = true;
            if ($inicial_form_t_grupos_inclu->contr_form_t_grupos_inclu->NM_ajax_flag)
            {
                $inicial_form_t_grupos_inclu->contr_form_t_grupos_inclu->NM_ajax_info['errList']['geral_form_t_grupos_inclu'][] = $msg;
                return;
            }
            form_t_grupos_inclu_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_t_grupos_inclu_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_t_grupos_inclu'])  && '' != $_SESSION['scriptcase']['error_icon']['form_t_grupos_inclu'])  ? $_SESSION['scriptcase']['error_icon']['form_t_grupos_inclu']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_t_grupos_inclu']) && '' != $_SESSION['scriptcase']['error_span_title']['form_t_grupos_inclu']) ? $_SESSION['scriptcase']['error_span_title']['form_t_grupos_inclu'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_t_grupos_inclu']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_t_grupos_inclu']) ? $_SESSION['scriptcase']['error_icon_title']['form_t_grupos_inclu'] : '';
?>
