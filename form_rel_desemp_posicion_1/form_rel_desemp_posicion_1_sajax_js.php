  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_rel_desemp_posicion_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_grado_
  function do_ajax_form_rel_desemp_posicion_1_validate_id_grado_(iNumLinha)
  {
    var nomeCampo_id_grado_ = "id_grado_" + iNumLinha;
    var var_id_grado_ = scAjaxGetFieldText(nomeCampo_id_grado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_id_grado_(var_id_grado_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_id_grado__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_id_grado_

  function do_ajax_form_rel_desemp_posicion_1_validate_id_grado__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_id_grado__cb

  // ---------- Validate id_grupo_
  function do_ajax_form_rel_desemp_posicion_1_validate_id_grupo_(iNumLinha)
  {
    var nomeCampo_id_grupo_ = "id_grupo_" + iNumLinha;
    var var_id_grupo_ = scAjaxGetFieldText(nomeCampo_id_grupo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_id_grupo_(var_id_grupo_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_id_grupo__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_id_grupo_

  function do_ajax_form_rel_desemp_posicion_1_validate_id_grupo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_id_grupo__cb

  // ---------- Validate id_asign_
  function do_ajax_form_rel_desemp_posicion_1_validate_id_asign_(iNumLinha)
  {
    var nomeCampo_id_asign_ = "id_asign_" + iNumLinha;
    var var_id_asign_ = scAjaxGetFieldText(nomeCampo_id_asign_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_id_asign_(var_id_asign_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_id_asign__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_id_asign_

  function do_ajax_form_rel_desemp_posicion_1_validate_id_asign__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_asign_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_asign_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_asign_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_asign_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_id_asign__cb

  // ---------- Validate periodo_
  function do_ajax_form_rel_desemp_posicion_1_validate_periodo_(iNumLinha)
  {
    var nomeCampo_periodo_ = "periodo_" + iNumLinha;
    var var_periodo_ = scAjaxGetFieldText(nomeCampo_periodo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_periodo_(var_periodo_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_periodo__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_periodo_

  function do_ajax_form_rel_desemp_posicion_1_validate_periodo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_periodo__cb

  // ---------- Validate posicion_
  function do_ajax_form_rel_desemp_posicion_1_validate_posicion_(iNumLinha)
  {
    var nomeCampo_posicion_ = "posicion_" + iNumLinha;
    var var_posicion_ = scAjaxGetFieldRadio(nomeCampo_posicion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_posicion_(var_posicion_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_posicion__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_posicion_

  function do_ajax_form_rel_desemp_posicion_1_validate_posicion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_posicion__cb

  // ---------- Validate cod_desemp_
  function do_ajax_form_rel_desemp_posicion_1_validate_cod_desemp_(iNumLinha)
  {
    var nomeCampo_cod_desemp_ = "cod_desemp_" + iNumLinha;
    var var_cod_desemp_ = scAjaxGetFieldText(nomeCampo_cod_desemp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_cod_desemp_(var_cod_desemp_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_cod_desemp__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_cod_desemp_

  function do_ajax_form_rel_desemp_posicion_1_validate_cod_desemp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cod_desemp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cod_desemp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cod_desemp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cod_desemp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_cod_desemp__cb

  // ---------- Validate entorno_
  function do_ajax_form_rel_desemp_posicion_1_validate_entorno_(iNumLinha)
  {
    var nomeCampo_entorno_ = "entorno_" + iNumLinha;
    var var_entorno_ = scAjaxGetFieldText(nomeCampo_entorno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_validate_entorno_(var_entorno_, iNumLinha, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_validate_entorno__cb);
  } // do_ajax_form_rel_desemp_posicion_1_validate_entorno_

  function do_ajax_form_rel_desemp_posicion_1_validate_entorno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rel_desemp_posicion_1_validate_entorno__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_rel_desemp_posicion_1_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_rel_desemp_posicion_1_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_rel_desemp_posicion_1_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_add_new_line_cb);
  } // do_ajax_form_rel_desemp_posicion_1_add_new_line

  function do_ajax_form_rel_desemp_posicion_1_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_rel_desemp_posicion_1_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_rel_desemp_posicion_1_backup_line(iNumLinha)
  {
    var var_id_grado_ = scAjaxGetFieldText("id_grado_" + iNumLinha);
    var var_id_grupo_ = scAjaxGetFieldText("id_grupo_" + iNumLinha);
    var var_id_asign_ = scAjaxGetFieldText("id_asign_" + iNumLinha);
    var var_periodo_ = scAjaxGetFieldText("periodo_" + iNumLinha);
    var var_posicion_ = scAjaxGetFieldRadio("posicion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rel_desemp_posicion_1_backup_line(var_id_grado_, var_id_grupo_, var_id_asign_, var_periodo_, var_posicion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_backup_line_cb);
  } // do_ajax_form_rel_desemp_posicion_1_backup_line

  function do_ajax_form_rel_desemp_posicion_1_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_rel_desemp_posicion_1_backup_line_cb

  function do_ajax_form_rel_desemp_posicion_1_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_rel_desemp_posicion_1_cancel_insert

  function do_ajax_form_rel_desemp_posicion_1_cancel_update(iSeqVert)
  {
    do_ajax_form_rel_desemp_posicion_1_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_rel_desemp_posicion_1_cancel_update

  function do_ajax_form_rel_desemp_posicion_1_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_rel_desemp_posicion_1_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_rel_desemp_posicion_1_table_refresh()
  {
    var var_id_grado_ = document.F2.id_grado_.value;
    var var_id_grupo_ = document.F2.id_grupo_.value;
    var var_id_asign_ = document.F2.id_asign_.value;
    var var_periodo_ = document.F2.periodo_.value;
    var var_posicion_ = document.F2.posicion_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_rel_desemp_posicion_1_table_refresh(var_id_grado_, var_id_grupo_, var_id_asign_, var_periodo_, var_posicion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_table_refresh_cb);
  } //  do_ajax_form_rel_desemp_posicion_1_table_refresh

  function do_ajax_form_rel_desemp_posicion_1_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_grado_.value = scAjaxGetKeyValue("id_grado_");
    document.F2.id_grupo_.value = scAjaxGetKeyValue("id_grupo_");
    document.F2.id_asign_.value = scAjaxGetKeyValue("id_asign_");
    document.F2.periodo_.value = scAjaxGetKeyValue("periodo_");
    document.F2.posicion_.value = scAjaxGetKeyValue("posicion_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_rel_desemp_posicion_1_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_rel_desemp_posicion_1_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_rel_desemp_posicion_1_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_periodo_ = scAjaxGetFieldText("periodo_" + iNumLinha);
    var var_posicion_ = scAjaxGetFieldRadio("posicion_" + iNumLinha);
    var var_cod_desemp_ = scAjaxGetFieldText("cod_desemp_" + iNumLinha);
...
?>
    x_ajax_form_rel_desemp_posicion_1_submit_form(var_id_grado_, var_id_grupo_, var_id_asign_, var_periodo_, var_posicion_, var_cod_desemp_, var_entorno_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_rel_desemp_posicion_1_submit_form_cb);
  } // do_ajax_form_rel_desemp_posicion_1_submit_form

  function do_ajax_form_rel_desemp_posicion_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("id_asign_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("periodo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("posicion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cod_desemp_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_rel_desemp_posicion_1_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_rel_desemp_posicion_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_rel_desemp_posicion_1_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("id_asign_" + iNavForm);
      scAjaxHideErrorDisplay("periodo_" + iNavForm);
      scAjaxHideErrorDisplay("posicion_" + iNavForm);
      scAjaxHideErrorDisplay("cod_desemp_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_rel_desemp_posicion_1_navigate_form(var_id_grado_, var_id_grupo_, var_id_asign_, var_periodo_, var_posicion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_rel_desemp_posicion_1_navigate_form_cb);
  } // do_ajax_form_rel_desemp_posicion_1_navigate_form

  function do_ajax_form_rel_desemp_posicion_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_grado_.value = scAjaxGetKeyValue("id_grado_" + var_last_index);
    document.F2.id_grupo_.value = scAjaxGetKeyValue("id_grupo_" + var_last_index);
    document.F2.id_asign_.value = scAjaxGetKeyValue("id_asign_" + var_last_index);
    document.F2.periodo_.value = scAjaxGetKeyValue("periodo_" + var_last_index);
    document.F2.posicion_.value = scAjaxGetKeyValue("posicion_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_rel_desemp_posicion_1_navigate_form_cb
  function sc_hide_form_rel_desemp_posicion_1_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_rel_desemp_posicion_1_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_asign_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "periodo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "posicion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cod_desemp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "entorno_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_grado_" + iNumLinha] = {"label": "Grado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["id_asign_" + iNumLinha] = {"label": "Id Asign<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["periodo_" + iNumLinha] = {"label": "Periodo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["cod_desemp_" + iNumLinha] = {"label": "Cod Desemp<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_asign_"][iNumLinha] = "id_asign_" + iNumLinha;
    ajax_field_mult["periodo_"][iNumLinha] = "periodo_" + iNumLinha;
    ajax_field_mult["posicion_"][iNumLinha] = "posicion_" + iNumLinha;
    ajax_field_mult["cod_desemp_"][iNumLinha] = "cod_desemp_" + iNumLinha;
    ...
    ajax_field_id["cod_desemp_" + iNumLinha] = new Array("hidden_field_label_cod_desemp_", "hidden_field_data_cod_desemp_" + iNumLinha);
    ajax_error_count["id_grado_" + iNumLinha] = "off";
    ajax_error_count["id_grupo_" + iNumLinha] = "off";
    ajax_error_count["id_asign_" + iNumLinha] = "off";
    ajax_error_count["periodo_" + iNumLinha] = "off";
    ajax_error_count["posicion_" + iNumLinha] = "off";
    ajax_error_count["cod_desemp_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["id_asign_" + iNumLinha] = "on";
    ajax_read_only["periodo_" + iNumLinha] = "on";
    ajax_read_only["posicion_" + iNumLinha] = "on";
    ajax_read_only["cod_desemp_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["periodo_" + iNumLinha] = "on";
    ajax_read_only["posicion_" + iNumLinha] = "on";
    ajax_read_only["cod_desemp_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["id_asign_" + iNumLinha] = null;
    ajax_error_list["periodo_" + iNumLinha] = null;
    ajax_error_list["posicion_" + iNumLinha] = null;
    ajax_error_list["cod_desemp_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["id_asign_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_asign_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_asign_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_asign_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_asign_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["cod_desemp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cod_desemp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cod_desemp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cod_desemp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cod_desemp_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_grado_'])) ? $this->nmgp_cmp_readonly['id_grado_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_asign_'])) ? $this->nmgp_cmp_readonly['id_asign_'] : 'on';
?>
    scAjaxFieldRead("id_asign_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['periodo_'])) ? $this->nmgp_cmp_readonly['periodo_'] : 'on';
?>
    scAjaxFieldRead("periodo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['posicion_'])) ? $this->nmgp_cmp_readonly['posicion_'] : 'on';
?>
    scAjaxFieldRead("posicion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cod_desemp_'])) ? $this->nmgp_cmp_readonly['cod_desemp_'] : 'off';
?>
    scAjaxFieldRead("cod_desemp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("id_asign_" + iSeq, "on");
    scAjaxFieldRead("periodo_" + iSeq, "on");
    scAjaxFieldRead("posicion_" + iSeq, "on");
    scAjaxFieldRead("cod_desemp_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_grado_" + iRow] || "on" == ajax_error_count["id_grupo_" + iRow] || "on" == ajax_error_count["id_asign_" + iRow] || "on" == ajax_error_count["periodo_" + iRow] || "on" == ajax_error_count["posicion_" + iRow] || "on" == ajax_error_count["cod_desemp_" + iRow] || "on" == ajax_error_count["entorno_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_id_asign_" + iRow))
        document.getElementById("hidden_field_data_id_asign_" + iRow).className = "scFormErrorLine";
      ...
      if (document.getElementById("hidden_field_data_cod_desemp_" + iRow))
        document.getElementById("hidden_field_data_cod_desemp_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_grado_" + iRow] && "off" == ajax_error_count["id_grupo_" + iRow] && "off" == ajax_error_count["id_asign_" + iRow] && "off" == ajax_error_count["periodo_" + iRow] && "off" == ajax_error_count["posicion_" + iRow] && "off" == ajax_error_count["cod_desemp_" + iRow] && "off" == ajax_error_count["entorno_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_grado_" + iRow] = "off";
        ajax_error_count["id_grupo_" + iRow] = "off";
        ajax_error_count["id_asign_" + iRow] = "off";
        ajax_error_count["periodo_" + iRow] = "off";
        ajax_error_count["posicion_" + iRow] = "off";
        ajax_error_count["cod_desemp_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_id_asign_" + iRow))
        document.getElementById("hidden_field_data_id_asign_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_periodo_" + iRow))
      ...
      if (document.getElementById("hidden_field_data_cod_desemp_" + iRow))
        document.getElementById("hidden_field_data_cod_desemp_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_entorno_" + iRow))
