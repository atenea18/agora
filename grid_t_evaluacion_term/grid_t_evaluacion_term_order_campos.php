<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_term_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_term_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["id_asignatura"] : "Asignatura";
   ...
   $tab_labels["inasistencia_p1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["inasistencia_p1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["inasistencia_p1"] : "FAA";
   $tab_ger_campos['ihs'] = "on";
   $tab_def_campos['ihs'] = "ihs";
   $tab_converte["ihs"]   = "ihs";
   $tab_labels["ihs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["ihs"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["ihs"] : "Ihs";
   ...
   $tab_labels["eval_periodo1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["eval_periodo1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["eval_periodo1"] : "VAL";
   ...
   $tab_labels["desem_asig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["desem_asig"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['labels']["desem_asig"] : "DESEMPEÑO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_term_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_term']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
