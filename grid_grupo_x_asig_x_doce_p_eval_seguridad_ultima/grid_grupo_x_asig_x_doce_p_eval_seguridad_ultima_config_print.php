 ...
 */
    ...
    session_start();
    $SC_apl_proc = "grid_grupo_x_asig_x_doce_p_eval_seguridad_ultima";
...
<form name="config_prt" method="post" action="grid_grupo_x_asig_x_doce_p_eval_seguridad_ultima_config_print.php">
<?php
