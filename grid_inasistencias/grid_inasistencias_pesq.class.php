...
class grid_inasistencias_pesq
{
    ...
    * @access  public
    */
   function grid_inasistencias_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_inasistencias_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_inasistencias_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_inasistencias_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_inasistencia')
      {
          $id_inasistencia = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_inasistencia($id_inasistencia);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_inasistencia($id_inasistencia)
   {
      $id_inasistencia = substr($this->Db->qstr($id_inasistencia), 1, -1);
            $id_inasistencia_look = substr($this->Db->qstr($id_inasistencia), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_inasistencia from " . $this->Ini->nm_tabela . " where  id_inasistencia like '%" . $id_inasistencia . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_inasistencia from " . $this->Ini->nm_tabela . " where  id_inasistencia like '%" . $id_inasistencia . "%'"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "fecha";$Nm_datas[] = "hora";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_datas))
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - inasistencias</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_inasistencias/grid_inasistencias_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_inasistencias_ajax_search.js"></script>
 <script type="text/javascript" src="grid_inasistencias_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_inasistencia_cond#NMF#' + search_get_sel_txt('SC_id_inasistencia_cond') + '@NMF@';
  str_out += 'SC_id_inasistencia#NMF#' + search_get_text('SC_id_inasistencia') + '@NMF@';
  str_out += 'id_ac_id_inasistencia#NMF#' + search_get_text('id_ac_id_inasistencia') + '@NMF@';
  str_out += 'SC_id_inasistencia_input_2#NMF#' + search_get_text('SC_id_inasistencia_input_2') + '@NMF@';
  ...
  str_out += 'SC_idstudents_input_2#NMF#' + search_get_text('SC_idstudents_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_id_inasistencia").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_inasistencia",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_inasistencia").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_inasistencia").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - inasistencias</span></td>
...
<?php
   ...
   {
      global 
             $id_inasistencia_cond, $id_inasistencia, $id_inasistencia_input_2, $id_inasistencia_autocomp,
             $idstudents_cond, $idstudents, $idstudents_input_2, $idstudents_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_inasistencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_inasistencia']; 
          $id_inasistencia_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_inasistencia_input_2']; 
          $id_inasistencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_inasistencia_cond']; 
          $idstudents = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['idstudents']; 
          $idstudents_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['idstudents_input_2']; 
          $idstudents_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['idstudents_cond']; 
          $id_grado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grado']; 
          $id_grado_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grado_input_2']; 
          $id_grado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grado_cond']; 
          $id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grupo']; 
          $id_grupo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grupo_input_2']; 
          $id_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grupo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_inasistencia_cond) || empty($id_inasistencia_cond))
      {
         $id_inasistencia_cond = "gt";
      }
      ...
      $str_hide_id_inasistencia = (in_array($id_inasistencia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_id_inasistencia = ('bw' == $id_inasistencia_cond) ? $display_aberto : $display_fechado;
      $str_display_idstudents = ('bw' == $idstudents_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($id_inasistencia) || $id_inasistencia == "")
      {
          $id_inasistencia = "";
      }
      if (isset($id_inasistencia) && !empty($id_inasistencia))
      {
         $tmp_pos = strpos($id_inasistencia, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_inasistencia = substr($id_inasistencia, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_inasistencias_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_inasistencia'])) ? $this->New_label['id_inasistencia'] : "Id Inasistencia"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_inasistencia_cond" name="id_inasistencia_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_inasistencia'), this, 'id_inasistencia')">
       <OPTION value="gt" <?php if ("gt" == $id_inasistencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_inasistencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_inasistencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_inasistencia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_inasistencia" <?php echo $str_hide_id_inasistencia?> valign="top">
 ...
 $nmgp_tab_label .= "id_inasistencia?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_inasistencia_look = substr($this->Db->qstr($id_inasistencia), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_inasistencia))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_inasistencia from " . $this->Ini->nm_tabela . " where id_inasistencia = $id_inasistencia_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_inasistencia from " . $this->Ini->nm_tabela . " where id_inasistencia = $id_inasistencia_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_inasistencia]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_inasistencia];
      }
      else
      {
          $sAutocompValue = $id_inasistencia;
      }
?>
<INPUT  type="text" id="SC_id_inasistencia" name="id_inasistencia" value="<?php echo NM_encode_input($id_inasistencia) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_inasistencia" name="id_inasistencia_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_inasistencia"  <?php echo $str_display_id_inasistencia; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_inasistencia_input_2" name="id_inasistencia_input_2" value="<?php echo NM_encode_input($id_inasistencia_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['idstudents'])) ? $this->New_label['idstudents'] : "Idstudents"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idstudents_cond" name="idstudents_cond" onChange="nm_campos_between(document.getElementById('id_vis_idstudents'), this, 'idstudents')">
       <OPTION value="gt" <?php if ("gt" == $idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_idstudents" name="idstudents" value="<?php echo NM_encode_input($idstudents) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_idstudents" name="idstudents_autocomp" size="19" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idstudents"  <?php echo $str_display_idstudents; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idstudents_input_2" name="idstudents_input_2" value="<?php echo NM_encode_input($idstudents_input_2) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_grado'])) ? $this->New_label['id_grado'] : "Id Grado"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_grado_cond" name="id_grado_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_grado'), this, 'id_grado')">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_grado" name="id_grado_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_grado"  <?php echo $str_display_id_grado; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_grado_input_2" name="id_grado_input_2" value="<?php echo NM_encode_input($id_grado_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_inasistencias']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_inasistencias']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_inasistencia'), document.F1.id_inasistencia_cond, 'id_inasistencia');
   document.F1.id_inasistencia.value = "";
   document.F1.id_inasistencia_autocomp.value = "";
   document.F1.id_inasistencia_input_2.value = "";
   ...
   document.F1.idstudents_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_inasistencias";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_inasistencia_cond'] = 'cond';
      $tp_fields['SC_id_inasistencia'] = 'text_aut';
      $tp_fields['id_ac_id_inasistencia'] = 'text_aut';
      $tp_fields['SC_id_inasistencia_input_2'] = 'text';
      $tp_fields['SC_idstudents_cond'] = 'cond';
      $tp_fields['SC_idstudents'] = 'text_aut';
      $tp_fields['id_ac_idstudents'] = 'text_aut';
      $tp_fields['SC_idstudents_input_2'] = 'text';
   ...
   {
      global $id_inasistencia_cond, $id_inasistencia, $id_inasistencia_input_2, $id_inasistencia_autocomp,
             $idstudents_cond, $idstudents, $idstudents_input_2, $idstudents_autocomp,
             $id_grado_cond, $id_grado, $id_grado_input_2, $id_grado_autocomp,
      ...
      if (!empty($id_inasistencia_autocomp) && empty($id_inasistencia))
      {
          $id_inasistencia = $id_inasistencia_autocomp;
      }
      ...
      $id_inasistencia_cond_salva = $id_inasistencia_cond; 
      if (!isset($id_inasistencia_input_2) || $id_inasistencia_input_2 == "")
      {
          $id_inasistencia_input_2 = $id_inasistencia;
      }
      ...
      if ($id_inasistencia_cond != "in")
      {
          nm_limpa_numero($id_inasistencia, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_inasistencia);
          ...
          $id_inasistencia = implode(",", $Nm_sc_valores);
      }
      if ($id_inasistencia_cond != "in")
      {
          nm_limpa_numero($id_inasistencia_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      if ($idstudents_cond != "in")
      {
          nm_limpa_numero($idstudents_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_grado_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_inasistencia'] = $id_inasistencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_inasistencia_input_2'] = $id_inasistencia_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_inasistencia_cond'] = $id_inasistencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['idstudents'] = $idstudents; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['idstudents_input_2'] = $idstudents_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['idstudents_cond'] = $idstudents_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grado'] = $id_grado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grado_input_2'] = $id_grado_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grado_cond'] = $id_grado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grupo'] = $id_grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grupo_input_2'] = $id_grupo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['id_grupo_cond'] = $id_grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_inasistencia_cond != "in" && $id_inasistencia_cond != "bw" && !empty($id_inasistencia) && !is_numeric($id_inasistencia))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Inasistencia";
      }
      if ($id_inasistencia_cond == "bw" && ((!empty($id_inasistencia) && !is_numeric($id_inasistencia)) || (!empty($id_inasistencia_input_2) && !is_numeric($id_inasistencia_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Inasistencia";
      }
      if ($idstudents_cond != "in" && $idstudents_cond != "bw" && !empty($idstudents) && !is_numeric($idstudents))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idstudents";
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Grado";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_inasistencia'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_inasistencia'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_inasistencia'] = $id_inasistencia;
      }
      $Conteudo = $id_inasistencia_input_2;
      if (strtoupper($id_inasistencia_cond) != "II" && strtoupper($id_inasistencia_cond) != "QP" && strtoupper($id_inasistencia_cond) != "NP" && strtoupper($id_inasistencia_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_inasistencia_input_2'] = $Conteudo;
      $idstudents_look = substr($this->Db->qstr($idstudents), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idstudents))
   { 
      ...
      $Conteudo = $idstudents_input_2;
      if (strtoupper($idstudents_cond) != "II" && strtoupper($idstudents_cond) != "QP" && strtoupper($idstudents_cond) != "NP" && strtoupper($idstudents_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idstudents_input_2'] = $Conteudo;
      $id_grado_look = substr($this->Db->qstr($id_grado), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_grado))
   { 
   ...
   { 
      ...
      if (isset($id_inasistencia) || $id_inasistencia_cond == "nu" || $id_inasistencia_cond == "nn" || $id_inasistencia_cond == "ep" || $id_inasistencia_cond == "ne")
      {
         $this->monta_condicao("id_inasistencia", $id_inasistencia_cond, $id_inasistencia, $id_inasistencia_input_2, "id_inasistencia");
      }
      ...
      {
         $this->monta_condicao("idstudents", $idstudents_cond, $idstudents, $idstudents_input_2, "idstudents");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inasistencias']['where_pesq_ant'] = $this->comando . $this->comando_fim;
