<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_inasistencias_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_inasistencias_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_inasistencia'] = "on";
   $tab_def_campos['id_inasistencia'] = "id_inasistencia";
   $tab_converte["id_inasistencia"]   = "id_inasistencia";
   $tab_labels["id_inasistencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_inasistencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_inasistencia"] : "Id Inasistencia";
   $tab_ger_campos['idstudents'] = "on";
   $tab_def_campos['idstudents'] = "idstudents";
   $tab_converte["idstudents"]   = "idstudents";
   $tab_labels["idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["idstudents"] : "Idstudents";
   $tab_ger_campos['id_grado'] = "on";
   $tab_def_campos['id_grado'] = "id_grado";
   $tab_converte["id_grado"]   = "id_grado";
   $tab_labels["id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_grado"] : "Id Grado";
   $tab_ger_campos['id_grupo'] = "on";
   $tab_def_campos['id_grupo'] = "id_grupo";
   $tab_converte["id_grupo"]   = "id_grupo";
   $tab_labels["id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_grupo"] : "Id Grupo";
   $tab_ger_campos['id_asignatura'] = "on";
   $tab_def_campos['id_asignatura'] = "id_asignatura";
   $tab_converte["id_asignatura"]   = "id_asignatura";
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['labels']["fecha"] : "Fecha";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - inasistencias</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_inasistencias_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_inasistencias']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
