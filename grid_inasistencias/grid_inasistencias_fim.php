...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_inasistencias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_inasistencias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inasistencias</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inasistencias']['embutida_filho'] as $ind => $sc_init)
          {
