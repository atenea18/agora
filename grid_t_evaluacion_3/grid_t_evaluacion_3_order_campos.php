<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_3_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_3_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["id_asignatura"] : "Asignatura";
   ...
   $tab_labels["ihs_vac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["ihs_vac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["ihs_vac"] : "IHS";
   $tab_ger_campos['eval_1_per'] = "on";
   $tab_def_campos['eval_1_per'] = "eval_1_per";
   $tab_converte["eval_1_per"]   = "eval_1_per";
   $tab_labels["eval_1_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_1_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_1_per"] : "VAL";
   ...
   $tab_labels["sup_p1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p1"] : "SUP";
   $tab_ger_campos['eval_2_per'] = "on";
   $tab_def_campos['eval_2_per'] = "eval_2_per";
   $tab_converte["eval_2_per"]   = "eval_2_per";
   $tab_labels["eval_2_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_2_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_2_per"] : "VAL";
   ...
   $tab_labels["sup_p2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p2"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p2"] : "SUP";
   $tab_ger_campos['eval_3_per'] = "on";
   $tab_def_campos['eval_3_per'] = "eval_3_per";
   $tab_converte["eval_3_per"]   = "eval_3_per";
   $tab_labels["eval_3_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_3_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_3_per"] : "VAL";
   ...
   $tab_labels["sup_p3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p3"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p3"] : "SUP";
   $tab_ger_campos['eval_4_per'] = "on";
   $tab_def_campos['eval_4_per'] = "eval_4_per";
   $tab_converte["eval_4_per"]   = "eval_4_per";
   $tab_labels["eval_4_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_4_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["eval_4_per"] : "VAL";
   ...
   $tab_labels["sup_p4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p4"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["sup_p4"] : "SUP";
   ...
   $tab_labels["fea_re_ac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["fea_re_ac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["fea_re_ac"] : "Fa/Re Ac";
   ...
   $tab_labels["definitiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["definitiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["definitiva"] : "DEF";
   ...
   $tab_labels["vac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["vac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["vac"] : "VAc";
   ...
   $tab_labels["vra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["vra"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['labels']["vra"] : "VRA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_3_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_3']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
