<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_matricula_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_matricula_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["idstudents"] : "Estudiantes";
   $tab_ger_campos['year_matricula'] = "on";
   $tab_def_campos['year_matricula'] = "year_matricula";
   $tab_converte["year_matricula"]   = "year_matricula";
   $tab_labels["year_matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["year_matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["year_matricula"] : "Año Matricula";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['id_grado'] = "on";
   $tab_def_campos['id_grado'] = "id_grado";
   $tab_converte["id_grado"]   = "id_grado";
   $tab_labels["id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["id_grado"] : "Grado";
   $tab_ger_campos['id_sede'] = "on";
   $tab_def_campos['id_sede'] = "id_sede";
   $tab_converte["id_sede"]   = "id_sede";
   $tab_labels["id_sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["id_sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["id_sede"] : "Sede";
   $tab_ger_campos['id_jornada'] = "on";
   $tab_def_campos['id_jornada'] = "id_jornada";
   $tab_converte["id_jornada"]   = "id_jornada";
   $tab_labels["id_jornada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["id_jornada"])) ? $_SESSION['sc_session'][$sc_init]['grid_matricula']['labels']["id_jornada"] : "Jornada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_matricula']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_matricula']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_matricula_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_matricula']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
