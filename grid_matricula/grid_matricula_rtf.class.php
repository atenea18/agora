...
class grid_matricula_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_matricula.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['rtf_name']);
      }
   ...
   function NM_export_year_matricula()
   {
         ...
         $this->year_matricula = str_replace('<', '&lt;', $this->year_matricula);
         $this->year_matricula = str_replace('>', '&gt;', $this->year_matricula);
         $this->Texto_tag .= "<td>" . $this->year_matricula . "</td>\r\n";
   }
   //----- fecha
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
