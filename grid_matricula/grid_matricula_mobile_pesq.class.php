...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_numeric[] = "idstudents";$Nm_numeric[] = "id_grado";$Nm_numeric[] = "id_sede";$Nm_numeric[] = "id_jornada";$Nm_numeric[] = "semestre";
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idstudents" name="idstudents_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_idstudents"  <?php echo $str_display_idstudents; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idstudents_input_2" name="idstudents_input_2" value="<?php echo NM_encode_input($idstudents_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $SC_Label = (isset($this->New_label['year_matricula'])) ? $this->New_label['year_matricula'] : "A̱o Matricula";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_year_matricula"  <?php echo $str_hide_year_matricula?>><?php
      $year_matricula_look = substr($this->Db->qstr($year_matricula), 1, -1); 
      $nmgp_def_dados = array(); 
