...
class grid_matricula_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_matricula_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_matricula_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_matricula_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_year_matricula')
      {
          $year_matricula = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_year_matricula($year_matricula);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_year_matricula($year_matricula)
   {
      $year_matricula = substr($this->Db->qstr($year_matricula), 1, -1);
            $year_matricula_look = substr($this->Db->qstr($year_matricula), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct year_matricula from " . $this->Ini->nm_tabela . " where  year_matricula like '%" . $year_matricula . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_matricula/grid_matricula_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_matricula_ajax_search.js"></script>
 <script type="text/javascript" src="grid_matricula_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_year_matricula_cond#NMF#' + search_get_sel_txt('SC_year_matricula_cond') + '@NMF@';
  str_out += 'SC_year_matricula#NMF#' + search_get_text('SC_year_matricula') + '@NMF@';
  str_out += 'id_ac_year_matricula#NMF#' + search_get_text('id_ac_year_matricula') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_year_matricula").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_year_matricula",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_year_matricula").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_year_matricula").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><h3> <?php echo $_SESSION['par_nombre_institucion'] ?></h3></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $year_matricula_cond, $year_matricula, $year_matricula_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idstudents = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['idstudents']; 
          $idstudents_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['idstudents_input_2']; 
          $idstudents_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['idstudents_cond']; 
          $year_matricula = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['year_matricula']; 
          $year_matricula_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['year_matricula_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_cond']; 
          $id_grado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['id_grado']; 
          $id_grado_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['id_grado_input_2']; 
          $id_grado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['id_grado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idstudents_cond) || empty($idstudents_cond))
      {
         $idstudents_cond = "gt";
      }
      if (!isset($year_matricula_cond) || empty($year_matricula_cond))
      {
         $year_matricula_cond = "qp";
      }
      ...
      $str_hide_year_matricula = (in_array($year_matricula_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($year_matricula) || $year_matricula == "")
      {
          $year_matricula = "";
      }
      if (isset($year_matricula) && !empty($year_matricula))
      {
         $tmp_pos = strpos($year_matricula, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $year_matricula = substr($year_matricula, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_matricula_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idstudents'])) ? $this->New_label['idstudents'] : "Estudiantes"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idstudents" name="idstudents_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
       ...
       <TR valign="top">
        <TD id="id_vis_idstudents"  <?php echo $str_display_idstudents; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idstudents_input_2" name="idstudents_input_2" value="<?php echo NM_encode_input($idstudents_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['year_matricula'])) ? $this->New_label['year_matricula'] : "Año Matricula"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_year_matricula_cond" name="year_matricula_cond" onChange="nm_campos_between(document.getElementById('id_vis_year_matricula'), this, 'year_matricula')">
       <OPTION value="qp" <?php if ("qp" == $year_matricula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $year_matricula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $year_matricula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $year_matricula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_year_matricula" <?php echo $str_hide_year_matricula?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['year_matricula'])) ? $this->New_label['year_matricula'] : "Año Matricula";
 $nmgp_tab_label .= "year_matricula?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $year_matricula_look = substr($this->Db->qstr($year_matricula), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct year_matricula from " . $this->Ini->nm_tabela . " where year_matricula = '$year_matricula_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$year_matricula]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$year_matricula];
      }
      else
      {
          $sAutocompValue = $year_matricula;
      }
?>
<INPUT  type="text" id="SC_year_matricula" name="year_matricula" value="<?php echo NM_encode_input($year_matricula) ?>" size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_year_matricula" name="year_matricula_autocomp" size="4" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_matricula']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_matricula']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_year_matricula'), document.F1.year_matricula_cond, 'year_matricula');
   document.F1.year_matricula.value = "";
   document.F1.year_matricula_autocomp.value = "";
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_matricula_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_matricula_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_matricula_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_matricula_valida_mes(this)});
 }
 function sc_grid_matricula_valida_dia(obj)
 {
 ...
 function sc_grid_matricula_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_matricula";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_year_matricula_cond'] = 'cond';
      $tp_fields['SC_year_matricula'] = 'text_aut';
      $tp_fields['id_ac_year_matricula'] = 'text_aut';
   ...
   {
      global $idstudents_cond, $idstudents, $idstudents_input_2, $idstudents_autocomp,
             $year_matricula_cond, $year_matricula, $year_matricula_autocomp,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             $id_grado_cond, $id_grado, $id_grado_input_2, $id_grado_autocomp, $nmgp_tab_label;
      ...
      if (!empty($year_matricula_autocomp) && empty($year_matricula))
      {
          $year_matricula = $year_matricula_autocomp;
      }
      ...
      $year_matricula_cond_salva = $year_matricula_cond; 
      if (!isset($year_matricula_input_2) || $year_matricula_input_2 == "")
      {
          $year_matricula_input_2 = $year_matricula;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['idstudents'] = $idstudents; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['idstudents_input_2'] = $idstudents_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['idstudents_cond'] = $idstudents_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['year_matricula'] = $year_matricula; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['year_matricula_cond'] = $year_matricula_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['id_grado'] = $id_grado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['id_grado_input_2'] = $id_grado_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['id_grado_cond'] = $id_grado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($idstudents_cond != "in" && $idstudents_cond != "bw" && !empty($idstudents) && !is_numeric($idstudents))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Estudiantes";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['year_matricula'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['year_matricula'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['year_matricula'] = $year_matricula;
      }
      $id_grado_look = substr($this->Db->qstr($id_grado), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_grado))
   { 
      ...
      //----- $year_matricula
      $this->Date_part = false;
      if (isset($year_matricula) || $year_matricula_cond == "nu" || $year_matricula_cond == "nn" || $year_matricula_cond == "ep" || $year_matricula_cond == "ne")
      {
         $this->monta_condicao("year_matricula", $year_matricula_cond, $year_matricula, "", "year_matricula");
      }
      ...
      if ($fecha_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']['fecha_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_matricula']['where_pesq_ant'] = $this->comando . $this->comando_fim;
