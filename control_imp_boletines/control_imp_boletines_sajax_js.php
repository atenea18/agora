  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_imp_boletines" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_sede
  function do_ajax_control_imp_boletines_validate_id_sede()
  {
    var nomeCampo_id_sede = "id_sede";
    var var_id_sede = scAjaxGetFieldSelect(nomeCampo_id_sede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_imp_boletines_validate_id_sede(var_id_sede, var_script_case_init, do_ajax_control_imp_boletines_validate_id_sede_cb);
  } // do_ajax_control_imp_boletines_validate_id_sede

  function do_ajax_control_imp_boletines_validate_id_sede_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_imp_boletines_validate_id_sede_cb

  // ---------- Validate id_jornada
  function do_ajax_control_imp_boletines_validate_id_jornada()
  {
    var nomeCampo_id_jornada = "id_jornada";
    var var_id_jornada = scAjaxGetFieldSelect(nomeCampo_id_jornada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_imp_boletines_validate_id_jornada(var_id_jornada, var_script_case_init, do_ajax_control_imp_boletines_validate_id_jornada_cb);
  } // do_ajax_control_imp_boletines_validate_id_jornada

  function do_ajax_control_imp_boletines_validate_id_jornada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_imp_boletines_validate_id_jornada_cb

  // ---------- Validate id_grado
  function do_ajax_control_imp_boletines_validate_id_grado()
  {
    var nomeCampo_id_grado = "id_grado";
    var var_id_grado = scAjaxGetFieldSelect(nomeCampo_id_grado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_imp_boletines_validate_id_grado(var_id_grado, var_script_case_init, do_ajax_control_imp_boletines_validate_id_grado_cb);
  } // do_ajax_control_imp_boletines_validate_id_grado

  function do_ajax_control_imp_boletines_validate_id_grado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_imp_boletines_validate_id_grado_cb

  // ---------- Validate id_grupo
  function do_ajax_control_imp_boletines_validate_id_grupo()
  {
    var nomeCampo_id_grupo = "id_grupo";
    var var_id_grupo = scAjaxGetFieldSelect(nomeCampo_id_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_imp_boletines_validate_id_grupo(var_id_grupo, var_script_case_init, do_ajax_control_imp_boletines_validate_id_grupo_cb);
  } // do_ajax_control_imp_boletines_validate_id_grupo

  function do_ajax_control_imp_boletines_validate_id_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_imp_boletines_validate_id_grupo_cb

  // ---------- Validate id_estudent
  function do_ajax_control_imp_boletines_validate_id_estudent()
  {
  } // do_ajax_control_imp_boletines_validate_id_estudent

  function do_ajax_control_imp_boletines_validate_id_estudent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_imp_boletines_validate_id_estudent_cb

  // ---------- Validate fecha
  function do_ajax_control_imp_boletines_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_imp_boletines_validate_fecha(var_fecha, var_script_case_init, do_ajax_control_imp_boletines_validate_fecha_cb);
  } // do_ajax_control_imp_boletines_validate_fecha

  function do_ajax_control_imp_boletines_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_imp_boletines_validate_fecha_cb
  // ---------- Form
  function do_ajax_control_imp_boletines_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_imp_boletines_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_imp_boletines_submit_form(var_id_sede, var_id_jornada, var_id_grado, var_id_grupo, var_id_estudent, var_fecha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_imp_boletines_submit_form_cb);
  } // do_ajax_control_imp_boletines_submit_form

  function do_ajax_control_imp_boletines_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_imp_boletines_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_imp_boletines_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_imp_boletines_navigate_form

  function do_ajax_control_imp_boletines_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_imp_boletines_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_imp_boletines_navigate_form_cb
  function sc_hide_control_imp_boletines_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_imp_boletines_form
