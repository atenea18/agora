<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_codigos_dese_grup_asig_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_codigos_dese_grup_asig_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["desempeno_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['labels']["desempeno_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['labels']["desempeno_codigo"] : "Codigo";
   ...
   $tab_labels["t_grupos_nombre_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['labels']["t_grupos_nombre_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['labels']["t_grupos_nombre_grupo"] : "Nombre Grupo";
   ...
   $tab_labels["rel_desemp_posicion_posicion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['labels']["rel_desemp_posicion_posicion"])) ? $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['labels']["rel_desemp_posicion_posicion"] : "Posicion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_codigos_dese_grup_asig_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_codigos_dese_grup_asig']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
