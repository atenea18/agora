...
class grid_codigos_dese_grup_asig_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_codigos_dese_grup_asig_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_codigos_dese_grup_asig.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_dese_grup_asig']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_dese_grup_asig']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_dese_grup_asig']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_dese_grup_asig']['rtf_name']);
      }
   ...
   function NM_export_rel_desemp_posicion_periodo()
   {
         ...
         $this->rel_desemp_posicion_periodo = str_replace('<', '&lt;', $this->rel_desemp_posicion_periodo);
         $this->rel_desemp_posicion_periodo = str_replace('>', '&gt;', $this->rel_desemp_posicion_periodo);
         $this->Texto_tag .= "<td>" . $this->rel_desemp_posicion_periodo . "</td>\r\n";
   }
   //----- desempeno_superior
   ...
   function NM_export_desempeno_alto()
   {
         ...
         $this->desempeno_alto = str_replace('<', '&lt;', $this->desempeno_alto);
         $this->desempeno_alto = str_replace('>', '&gt;', $this->desempeno_alto);
         $this->Texto_tag .= "<td>" . $this->desempeno_alto . "</td>\r\n";
   }
   //----- desempeno_basico
   function NM_export_desempeno_basico()
   {
         ...
         $this->desempeno_basico = str_replace('<', '&lt;', $this->desempeno_basico);
         $this->desempeno_basico = str_replace('>', '&gt;', $this->desempeno_basico);
         $this->Texto_tag .= "<td>" . $this->desempeno_basico . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_dese_grup_asig']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_dese_grup_asig']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
