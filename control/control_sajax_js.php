...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate estudiante
  function do_ajax_control_validate_estudiante()
  {
  } // do_ajax_control_validate_estudiante

  function do_ajax_control_validate_estudiante_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_validate_estudiante_cb

  // ---------- Validate year
  function do_ajax_control_validate_year()
  {
    var nomeCampo_year = "year";
    var var_year = scAjaxGetFieldSelect(nomeCampo_year);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_validate_year(var_year, var_script_case_init, do_ajax_control_validate_year_cb);
  } // do_ajax_control_validate_year

  function do_ajax_control_validate_year_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "year";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_validate_year_cb
  // ---------- Form
  function do_ajax_control_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_control_submit_form(var_estudiante, var_year, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_submit_form_cb);
