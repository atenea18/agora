...
//
   function init()
   {
      ...
      $this->nm_hr_criacao   = "173514"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20161211"; 
      $this->nm_hr_ult_alt   = "110738"; 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'agora_IV'); 
      } 
      else 
      { 
...
//
    ...
    {
        if ('ajax_control_mob_validate_estudiante' == $_POST['rs'])
        {
            $estudiante = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_year' == $_POST['rs'])
        {
            $year = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_autocomp_estudiante' == $_POST['rs'])
        {
            $estudiante = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        ...
        {
            $estudiante = NM_utf8_urldecode($_POST['rsargs'][0]);
            $year = NM_utf8_urldecode($_POST['rsargs'][1]);
    ...
    { 
        ...
        if (isset($par_caracter)) 
        {
            $_SESSION['par_caracter'] = $par_caracter;
        }
    } 
    ...
    else
    {
        ...
        if (isset($_POST["par_estudiante"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['par_estudiante']);
        }
        ...
        if (isset($_POST["par_tipo_identif"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['par_tipo_identif']);
        }
        ...
        if (isset($_POST["par_numero_doc"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['par_numero_doc']);
        }
        ...
        if (isset($_POST["par_fecha"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['par_fecha']);
        }
        ...
        if (isset($_POST["par_idestudiante"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['par_idestudiante']);
        }
        ...
        if (isset($_POST["par_year"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['par_year']);
        }
        ...
        {
            $_SESSION['par_caracter'] = $_POST["par_caracter"];
            nm_limpa_str_control_mob($_SESSION['par_caracter']);
        }
        if (isset($_GET["par_caracter"])) 
        {
            $_SESSION['par_caracter'] = $_GET["par_caracter"];
            nm_limpa_str_control_mob($_SESSION['par_caracter']);
        }
...
<?php
    ...
    $inicial_control_mob->contr_control_mob->NM_ajax_info['select_html']['year'] = "class=\"sc-js-input scFormObjectOdd css_year_obj\" style=\"\" id=\"id_sc_field_year\" name=\"year\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_control_mob_validate_estudiante");
    sajax_export("ajax_control_mob_validate_year");
    sajax_export("ajax_control_mob_autocomp_estudiante");
...
//
    ...
    function ajax_control_mob_validate_estudiante($estudiante, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_estudiante';
    ...
    function ajax_control_mob_validate_year($year, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_year';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'year' => NM_utf8_urldecode($year),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
    ...
    function ajax_control_mob_autocomp_estudiante($estudiante, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'autocomp_estudiante';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'estudiante' => NM_utf8_urldecode($estudiante),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param']['estudiante'] = utf8_decode(urldecode($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['estudiante']));
        if ($inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'])
        {
            ob_start();
        }
    ...
    function ajax_control_mob_submit_form($estudiante, $year, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
