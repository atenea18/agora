...
<input type=hidden name="year" value="<?php echo $this->form_encode_input($this->year) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_year_label" id="hidden_field_label_year" style="<?php echo $sStyleHidden_year; ?>"><span id="id_label_year"><?php echo $this->nm_new_label['year']; ?></span></TD>
...
$year_look = "";
 if ($this->year == "2010") { $year_look .= "2010" ;} 
 if ($this->year == "2011") { $year_look .= "2011" ;} 
 if ($this->year == "2012") { $year_look .= "2012" ;} 
 if ($this->year == "2013") { $year_look .= "2013" ;} 
 if ($this->year == "2014") { $year_look .= "2014" ;} 
 if ($this->year == "2015") { $year_look .= "2015" ;} 
 if ($this->year == "2016") { $year_look .= "2016" ;} 
 if ($this->year == "2017") { $year_look .= "2017" ;} 
 if (empty($year_look)) { $year_look = $this->year; }
?>
<input type="hidden" name="year" value="<?php echo $this->form_encode_input($year) . "\">" . $year_look . ""; ?>
<?php } else { ?>
<?php
...
$year_look = "";
 ...
 if (empty($year_look)) { $year_look = $this->year; }
?>
<span id="id_read_on_year" class="css_year_line"  style="<?php echo $sStyleReadLab_year; ?>"><?php echo $this->form_encode_input($year_look); ?></span><span id="id_read_off_year" style="<?php echo $sStyleReadInp_year; ?>">
 <span id="idAjaxSelect_year"><select class="sc-js-input scFormObjectOdd css_year_obj" style="" id="id_sc_field_year" name="year" size="1" alt="{type: 'select', enterTab: false}">
 <option value="2010" <?php  if ($this->year == "2010") { echo " selected" ;} ?>>2010</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2010'; ?>
 <option value="2011" <?php  if ($this->year == "2011") { echo " selected" ;} ?>>2011</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2011'; ?>
 <option value="2012" <?php  if ($this->year == "2012") { echo " selected" ;} ?>>2012</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2012'; ?>
 <option value="2013" <?php  if ($this->year == "2013") { echo " selected" ;} ?>>2013</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2013'; ?>
 <option value="2014" <?php  if ($this->year == "2014") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2014'; ?>
 <option value="2015" <?php  if ($this->year == "2015") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2015'; ?>
 <option value="2016" <?php  if ($this->year == "2016") { echo " selected" ;} ?><?php  if (empty($this->year)) { echo " selected" ;} ?>>2016</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2016'; ?>
 <option value="2017" <?php  if ($this->year == "2017") { echo " selected" ;} ?>>2017</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control']['Lookup_year'][] = '2017'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
