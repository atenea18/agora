...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_year_line" id="hidden_field_data_year" style="<?php echo $sStyleHidden_year; ?>"> <span class="scFormLabelOddFormat css_year_label"><span id="id_label_year"><?php echo $this->nm_new_label['year']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2010'; ?>
 <option value="2011" <?php  if ($this->year == "2011") { echo " selected" ;} ?>>2011</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2011'; ?>
 <option value="2012" <?php  if ($this->year == "2012") { echo " selected" ;} ?>>2012</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2012'; ?>
 <option value="2013" <?php  if ($this->year == "2013") { echo " selected" ;} ?>>2013</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2013'; ?>
 <option value="2014" <?php  if ($this->year == "2014") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2014'; ?>
 <option value="2015" <?php  if ($this->year == "2015") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2015'; ?>
 <option value="2016" <?php  if ($this->year == "2016") { echo " selected" ;} ?><?php  if (empty($this->year)) { echo " selected" ;} ?>>2016</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2016'; ?>
 <option value="2017" <?php  if ($this->year == "2017") { echo " selected" ;} ?>>2017</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2017'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
