...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['year']))
          {
              $this->year = $this->NM_ajax_info['param']['year'];
          }
      ...
      if (isset($this->par_caracter) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['par_caracter'] = $this->par_caracter;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_year' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'year');
          }
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_estudiante']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_estudiante'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_estudiante']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_estudiante'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_estudiante'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $estudiante = $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][0]; 
                  $year = $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][1]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][0] = $this->estudiante; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][1] = $this->year; 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ('' == $filtro || 'year' == $filtro)
        $this->ValidateField_year($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
if (!isset($this->sc_temp_par_caracter)) {$this->sc_temp_par_caracter = (isset($_SESSION['par_caracter'])) ? $_SESSION['par_caracter'] : "";}
...
if (!isset($this->sc_temp_global_0)) {$this->sc_temp_global_0 = (isset($_SESSION['par_fecha]; 
		 [par_idestudiante]; [par_year]; [par_estudiante]; [par_tipo_identif]; 
		 [par_numero_doc]; [par_caracter] "_top'])) ? $_SESSION['par_fecha]; 
		 [par_idestudiante]; [par_year]; [par_estudiante]; [par_tipo_identif]; 
		 [par_numero_doc]; [par_caracter] "_top'] : "";}
 $check_sql = "SELECT primer_apellido, segundo_apellido, primer_nombre, segundo_nombre, tipo_identificacion, numero_documento, caracter "
   . " FROM students"
   . " WHERE idstudents = '" . $this->estudiante  . "'";
...
{
    $par_estudiante = $this->rs[0][0]." ".$this->rs[0][1]." ".$this->rs[0][2]." ".$this->rs[0][3];
	$par_tipo_identif = $this->rs[0][4];
	$par_numero_doc = $this->rs[0][5];
	$caracter = $this->rs[0][6];
...
if($caracter == 'A'){
$this->sc_temp_par_caracter= 'ACADEMICO';
}else{
$this->sc_temp_par_caracter= 'TÉCNICO';
}
...
$this->sc_temp_par_fecha = date("d-m-Y");
$this->sc_temp_par_idestudiante=$this->estudiante ;
$this->sc_temp_par_year=$this->year ;

 if (isset($par_estudiante)) {$this->sc_temp_par_estudiante = $par_estudiante;}
;
 if (isset($par_tipo_identif)) {$this->sc_temp_par_tipo_identif = $par_tipo_identif;}
;
 if (isset($par_numero_doc)) {$this->sc_temp_par_numero_doc = $par_numero_doc;}
;
 ...
 if (isset($this->sc_temp_global_0)) { $_SESSION['par_fecha]; 
		 [par_idestudiante]; [par_year]; [par_estudiante]; [par_tipo_identif]; 
		 [par_numero_doc]; [par_caracter] "_top'] = $this->sc_temp_global_0;}
 ...
 if (isset($this->sc_temp_par_caracter)) { $_SESSION['par_caracter'] = $this->sc_temp_par_caracter;}
 ...
 {
$this->nmgp_redireciona_form("../reportes/certificado.php", $this->nm_location, $this->sc_temp_global_0, "_self", "ret_self", 440, 630);
 };
if (isset($this->sc_temp_global_0)) { $_SESSION['par_fecha]; 
		 [par_idestudiante]; [par_year]; [par_estudiante]; [par_tipo_identif]; 
		 [par_numero_doc]; [par_caracter] "_top'] = $this->sc_temp_global_0;}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_year != $this->year || (isset($bFlagRead_year) && $bFlagRead_year)))
    {
        $this->ajax_return_values_year(true);
    }
}
$_SESSION['scriptcase']['control_mob']['contr_erro'] = 'off'; 
          }
    ...
    function ValidateField_year(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->year == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      if ($this->year == "")  
      { 
          $this->year = 0;
          $this->sc_force_zero[] = 'year';
      } 
    } // ValidateField_year
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['year'] = $this->year;
...
//
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][control_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_estudiante))]) ? $aLookup[0][control_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_estudiante))] : "";
          ...
          //----- year
   function ajax_return_values_year($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("year", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->year);
              $aLookup = array();
              $this->_tmp_lookup_year = $this->year;

$aLookup[] = array(control_mob_pack_protect_string('2010') => control_mob_pack_protect_string("2010"));
$aLookup[] = array(control_mob_pack_protect_string('2011') => control_mob_pack_protect_string("2011"));
$aLookup[] = array(control_mob_pack_protect_string('2012') => control_mob_pack_protect_string("2012"));
$aLookup[] = array(control_mob_pack_protect_string('2013') => control_mob_pack_protect_string("2013"));
$aLookup[] = array(control_mob_pack_protect_string('2014') => control_mob_pack_protect_string("2014"));
$aLookup[] = array(control_mob_pack_protect_string('2015') => control_mob_pack_protect_string("2015"));
$aLookup[] = array(control_mob_pack_protect_string('2016') => control_mob_pack_protect_string("2016"));
$aLookup[] = array(control_mob_pack_protect_string('2017') => control_mob_pack_protect_string("2017"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2010';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2011';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2012';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2013';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2014';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2015';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2016';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['Lookup_year'][] = '2017';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"year\"";
          if (isset($this->NM_ajax_info['select_html']['year']) && !empty($this->NM_ajax_info['select_html']['year']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['year'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['year'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['year']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['year']['valList'][$i] = control_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['year']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['year']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['year']['labList'] = $aLabel;
          }
   }
