<?php
class form_t_evaluacion_p3_form extends form_t_evaluacion_p3_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['embutida_pdf']))
 {
 ?>
<?php
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_t_evaluacion_p3/form_t_evaluacion_p3_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_t_evaluacion_p3_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_t_evaluacion_p3_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['recarga'];
}
...
<?php
 include_once("form_t_evaluacion_p3_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_t_evaluacion_p3'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_t_evaluacion_p3'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['mostra_cab'] != "N"))
  {
?>
<tr><td>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scFormHeaderFont">
          <?php echo "<FONT SIZE=4>Periodo 3</font>" ?>
        </TD>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpdf", "", "", "sc_b_pdf_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . SC_dir_app_name('form_t_evaluacion_p3') . "/form_t_evaluacion_p3_config_pdf.php?nm_opc=pdf&nm_target=2&nm_cor=cor&papel=8&lpapel=0&apapel=0&orientacao=2&bookmarks=XX&largura=800&conf_larg=10&conf_fonte=N&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "");?>
 
<?php
        $NM_btn = true;
        $sCondStyle = ($this->nmgp_botoes['print'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bprint", "", "", "sc_b_prt_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . SC_dir_app_name('form_t_evaluacion_p3') . "/form_t_evaluacion_p3_config_print.php?nm_opc=print&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "");?>
...
<?php
     $Col_span = "";
       ...
       if (!$this->Embutida_form && $this->nmgp_opcao != "novo" && ($this->nmgp_botoes['delete'] == "on" || $this->nmgp_botoes['update'] == "on")) { $Col_span = " colspan=2"; if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['pdf_view']) { $Col_span = 1;} }
 ?>

    <TD class="scFormLabelOddMult" <?php echo $Col_span ?>> &nbsp; </TD>
   
   <?php if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['pdf_view'] && $this->Embutida_form && $this->nmgp_botoes['insert'] == "on") {?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['eval_3_per_']) && $this->nmgp_cmp_hidden['eval_3_per_'] == 'off') { $sStyleHidden_eval_3_per_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['eval_3_per_'])) {
          $this->nm_new_label['eval_3_per_'] = "3 Per"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_t_evaluacion_p3);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_t_evaluacion_p3 = $this->form_vert_form_t_evaluacion_p3;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_t_evaluacion_p3))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_t_evaluacion_p3 as $sc_seq_vert => $sc_lixo)
   {
       $this->primer_apellido_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['primer_apellido_'];
       $this->segundo_apellido_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['segundo_apellido_'];
       $this->primer_nombre_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['primer_nombre_'];
       $this->segundo_nombre_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['segundo_nombre_'];
       $this->id_grupo_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_grupo_'];
       $this->id_area_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_area_'];
       $this->id_asignatura_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_asignatura_'];
       $this->id_grado_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_grado_'];
       $this->id_nivel_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_nivel_'];
       $this->ihs_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ihs_'];
       $this->pfa_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pfa_'];
       $this->tipo_asig_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['tipo_asig_'];
       $this->eval_1_per_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['eval_1_per_'];
       $this->dc1_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc1_'];
       $this->dc2_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc2_'];
       $this->dc3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc3_'];
       $this->dc4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc4_'];
       $this->dc5_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc5_'];
       $this->pcent_dc_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dc_'];
       $this->ds1_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds1_'];
       $this->ds2_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds2_'];
       $this->ds3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds3_'];
       $this->ds4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds4_'];
       $this->ds5_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds5_'];
       $this->pcent_ds_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_ds_'];
       $this->dp1_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp1_'];
       $this->dp2_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp2_'];
       $this->dp3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp3_'];
       $this->dp4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp4_'];
       $this->dp5_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp5_'];
       $this->pcent_dp_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dp_'];
       $this->eval_2_per_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['eval_2_per_'];
       $this->dc1_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc1_2p_'];
       $this->dc2_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc2_2p_'];
       $this->dc3_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc3_2p_'];
       $this->dc4_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc4_2p_'];
       $this->dc5_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc5_2p_'];
       $this->pcent_dc2_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dc2_'];
       $this->ds1_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds1_2p_'];
       $this->ds2_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds2_2p_'];
       $this->ds3_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds3_2p_'];
       $this->ds4_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds4_2p_'];
       $this->ds5_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds5_2p_'];
       $this->pcent_ds2_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_ds2_'];
       $this->dp1_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp1_2p_'];
       $this->dp2_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp2_2p_'];
       $this->dp3_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp3_2p_'];
       $this->dp4_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp4_2p_'];
       $this->dp5_2p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp5_2p_'];
       $this->pcent_dp2_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dp2_'];
       $this->eval_4_per_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['eval_4_per_'];
       $this->dc1_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc1_p4_'];
       $this->dc2_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc2_p4_'];
       $this->dc3_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc3_p4_'];
       $this->dc4_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc4_p4_'];
       $this->dc5_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc5_p4_'];
       $this->pcent_dc4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dc4_'];
       $this->ds1_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds1_p4_'];
       $this->ds2_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds2_p4_'];
       $this->ds3_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds3_p4_'];
       $this->ds4_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds4_p4_'];
       $this->ds5_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds5_p4_'];
       $this->pcent_ds4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_ds4_'];
       $this->dp1_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp1_p4_'];
       $this->dp2_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp2_p4_'];
       $this->dp3_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp3_p4_'];
       $this->dp4_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp4_p4_'];
       $this->dp5_p4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp5_p4_'];
       $this->pcent_dp4_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dp4_'];
       $this->eval_final_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['eval_final_'];
       $this->entorno_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['entorno_'];
       $this->estudiantes_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['estudiantes_'];
       $this->id_novedad_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_novedad_'];
       $this->nom_grupo_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['nom_grupo_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_estudiante_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['id_estudiante_']; 
       ...
       $this->estatus_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['estatus_']; 
       ...
       $this->novedad_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['novedad_']; 
       ...
       $this->eval_3_per_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['eval_3_per_']; 
       ...
       $this->dc1_3p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc1_3p_']; 
       ...
       $this->dc2_3p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc2_3p_']; 
       ...
       $this->dc3_3p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc3_3p_']; 
       ...
       $this->dc4_3p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc4_3p_']; 
       ...
       $this->dc5_3p_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dc5_3p_']; 
       ...
       $this->pcent_dc3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dc3_']; 
       ...
       $this->dp1_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp1_p3_']; 
       ...
       $this->dp2_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp2_p3_']; 
       ...
       $this->dp3_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp3_p3_']; 
       ...
       $this->dp4_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['dp4_p3_']; 
       ...
       $this->sc_field_0_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['sc_field_0_']; 
       ...
       $this->pcent_dp3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_dp3_']; 
       ...
       $this->ds1_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds1_p3_']; 
       ...
       $this->ds2_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds2_p3_']; 
       ...
       $this->ds3_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds3_p3_']; 
       ...
       $this->ds4_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds4_p3_']; 
       ...
       $this->ds5_p3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['ds5_p3_']; 
       ...
       $this->pcent_ds3_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['pcent_ds3_']; 
       ...
       $this->val_acumulada_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['val_acumulada_']; 
       ...
       $this->val_requerida_ = $this->form_vert_form_t_evaluacion_p3[$sc_seq_vert]['val_requerida_']; 
...
?>   
   ...
   <?php if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['pdf_view'] && !$this->Embutida_form && $this->nmgp_opcao != "novo" && ($this->nmgp_botoes['delete'] == "on" || $this->nmgp_botoes['update'] == "on")) {?>
    <TD class="scFormDataOddMult" > 
<input type="checkbox" name="sc_check_vert[<?php echo $sc_seq_vert ?>]" value="<?php echo $sc_seq_vert . "\""; if (in_array($sc_seq_vert, $sc_check_excl)) { echo " checked";} ?> onclick="if (this.checked) {sc_quant_excl++; } else {sc_quant_excl--; }" class="sc-js-input" alt="{type: 'checkbox', enterTab: false}"> </TD>
   <?php }?>
   <?php if ($this->Embutida_form && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['pdf_view']) {?>
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_t_evaluacion_p3_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_t_evaluacion_p3_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_t_evaluacion_p3_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_t_evaluacion_p3_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_t_evaluacion_p3_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_t_evaluacion_p3_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_eval_3_per_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-eval_3_per_<?php echo $sc_seq_vert ?> css_eval_3_per__line" style="<?php echo $sStyleReadLab_eval_3_per_; ?>"><?php echo $this->form_encode_input($this->eval_3_per_); ?></span><span id="id_read_off_eval_3_per_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_eval_3_per_; ?>">
 ...
 size=5 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['eval_3_per_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['eval_3_per_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dc1_3p_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dc1_3p_<?php echo $sc_seq_vert ?> css_dc1_3p__line" style="<?php echo $sStyleReadLab_dc1_3p_; ?>"><?php echo $this->form_encode_input($this->dc1_3p_); ?></span><span id="id_read_off_dc1_3p_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dc1_3p_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dc1_3p_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dc1_3p_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dc2_3p_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dc2_3p_<?php echo $sc_seq_vert ?> css_dc2_3p__line" style="<?php echo $sStyleReadLab_dc2_3p_; ?>"><?php echo $this->form_encode_input($this->dc2_3p_); ?></span><span id="id_read_off_dc2_3p_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dc2_3p_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dc2_3p_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dc2_3p_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dc3_3p_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dc3_3p_<?php echo $sc_seq_vert ?> css_dc3_3p__line" style="<?php echo $sStyleReadLab_dc3_3p_; ?>"><?php echo $this->form_encode_input($this->dc3_3p_); ?></span><span id="id_read_off_dc3_3p_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dc3_3p_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dc3_3p_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dc3_3p_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dc4_3p_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dc4_3p_<?php echo $sc_seq_vert ?> css_dc4_3p__line" style="<?php echo $sStyleReadLab_dc4_3p_; ?>"><?php echo $this->form_encode_input($this->dc4_3p_); ?></span><span id="id_read_off_dc4_3p_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dc4_3p_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dc4_3p_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dc4_3p_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dc5_3p_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dc5_3p_<?php echo $sc_seq_vert ?> css_dc5_3p__line" style="<?php echo $sStyleReadLab_dc5_3p_; ?>"><?php echo $this->form_encode_input($this->dc5_3p_); ?></span><span id="id_read_off_dc5_3p_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dc5_3p_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dc5_3p_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dc5_3p_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_pcent_dc3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-pcent_dc3_<?php echo $sc_seq_vert ?> css_pcent_dc3__line" style="<?php echo $sStyleReadLab_pcent_dc3_; ?>"><?php echo $this->form_encode_input($this->pcent_dc3_); ?></span><span id="id_read_off_pcent_dc3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_pcent_dc3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['pcent_dc3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['pcent_dc3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dp1_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dp1_p3_<?php echo $sc_seq_vert ?> css_dp1_p3__line" style="<?php echo $sStyleReadLab_dp1_p3_; ?>"><?php echo $this->form_encode_input($this->dp1_p3_); ?></span><span id="id_read_off_dp1_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dp1_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dp1_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dp1_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dp2_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dp2_p3_<?php echo $sc_seq_vert ?> css_dp2_p3__line" style="<?php echo $sStyleReadLab_dp2_p3_; ?>"><?php echo $this->form_encode_input($this->dp2_p3_); ?></span><span id="id_read_off_dp2_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dp2_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dp2_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dp2_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dp3_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dp3_p3_<?php echo $sc_seq_vert ?> css_dp3_p3__line" style="<?php echo $sStyleReadLab_dp3_p3_; ?>"><?php echo $this->form_encode_input($this->dp3_p3_); ?></span><span id="id_read_off_dp3_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dp3_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dp3_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dp3_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_dp4_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dp4_p3_<?php echo $sc_seq_vert ?> css_dp4_p3__line" style="<?php echo $sStyleReadLab_dp4_p3_; ?>"><?php echo $this->form_encode_input($this->dp4_p3_); ?></span><span id="id_read_off_dp4_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dp4_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dp4_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dp4_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_sc_field_0_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-sc_field_0_<?php echo $sc_seq_vert ?> css_sc_field_0__line" style="<?php echo $sStyleReadLab_sc_field_0_; ?>"><?php echo $this->form_encode_input($this->sc_field_0_); ?></span><span id="id_read_off_sc_field_0_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_0_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['sc_field_0_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['sc_field_0_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_pcent_dp3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-pcent_dp3_<?php echo $sc_seq_vert ?> css_pcent_dp3__line" style="<?php echo $sStyleReadLab_pcent_dp3_; ?>"><?php echo $this->form_encode_input($this->pcent_dp3_); ?></span><span id="id_read_off_pcent_dp3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_pcent_dp3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['pcent_dp3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['pcent_dp3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_ds1_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-ds1_p3_<?php echo $sc_seq_vert ?> css_ds1_p3__line" style="<?php echo $sStyleReadLab_ds1_p3_; ?>"><?php echo $this->form_encode_input($this->ds1_p3_); ?></span><span id="id_read_off_ds1_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ds1_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['ds1_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['ds1_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_ds2_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-ds2_p3_<?php echo $sc_seq_vert ?> css_ds2_p3__line" style="<?php echo $sStyleReadLab_ds2_p3_; ?>"><?php echo $this->form_encode_input($this->ds2_p3_); ?></span><span id="id_read_off_ds2_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ds2_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['ds2_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['ds2_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_ds3_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-ds3_p3_<?php echo $sc_seq_vert ?> css_ds3_p3__line" style="<?php echo $sStyleReadLab_ds3_p3_; ?>"><?php echo $this->form_encode_input($this->ds3_p3_); ?></span><span id="id_read_off_ds3_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ds3_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['ds3_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['ds3_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_ds4_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-ds4_p3_<?php echo $sc_seq_vert ?> css_ds4_p3__line" style="<?php echo $sStyleReadLab_ds4_p3_; ?>"><?php echo $this->form_encode_input($this->ds4_p3_); ?></span><span id="id_read_off_ds4_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ds4_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['ds4_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['ds4_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_ds5_p3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-ds5_p3_<?php echo $sc_seq_vert ?> css_ds5_p3__line" style="<?php echo $sStyleReadLab_ds5_p3_; ?>"><?php echo $this->form_encode_input($this->ds5_p3_); ?></span><span id="id_read_off_ds5_p3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ds5_p3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['ds5_p3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['ds5_p3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_pcent_ds3_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-pcent_ds3_<?php echo $sc_seq_vert ?> css_pcent_ds3__line" style="<?php echo $sStyleReadLab_pcent_ds3_; ?>"><?php echo $this->form_encode_input($this->pcent_ds3_); ?></span><span id="id_read_off_pcent_ds3_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_pcent_ds3_; ?>">
 ...
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 1, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['pcent_ds3_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['pcent_ds3_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_t_evaluacion_p3 = $guarda_form_vert_form_t_evaluacion_p3;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p3']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_t_evaluacion_p3");
 parent.scAjaxDetailHeight("form_t_evaluacion_p3", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
