  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_evaluacion_p3" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_t_evaluacion_p3_validate_id_estudiante_(iNumLinha)
  {
    ...
    x_ajax_form_t_evaluacion_p3_validate_id_estudiante_(var_id_estudiante_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_id_estudiante__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_id_estudiante_

  function do_ajax_form_t_evaluacion_p3_validate_id_estudiante__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_id_estudiante__cb

  // ---------- Validate estatus_
  function do_ajax_form_t_evaluacion_p3_validate_estatus_(iNumLinha)
  {
    var nomeCampo_estatus_ = "estatus_" + iNumLinha;
    var var_estatus_ = scAjaxGetFieldHidden(nomeCampo_estatus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_estatus_(var_estatus_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_estatus__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_estatus_

  function do_ajax_form_t_evaluacion_p3_validate_estatus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_estatus__cb

  // ---------- Validate novedad_
  function do_ajax_form_t_evaluacion_p3_validate_novedad_(iNumLinha)
  {
    var nomeCampo_novedad_ = "novedad_" + iNumLinha;
    var var_novedad_ = scAjaxGetFieldHidden(nomeCampo_novedad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_novedad_(var_novedad_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_novedad__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_novedad_

  function do_ajax_form_t_evaluacion_p3_validate_novedad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_novedad__cb

  // ---------- Validate eval_3_per_
  function do_ajax_form_t_evaluacion_p3_validate_eval_3_per_(iNumLinha)
  {
    var nomeCampo_eval_3_per_ = "eval_3_per_" + iNumLinha;
    var var_eval_3_per_ = scAjaxGetFieldText(nomeCampo_eval_3_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_eval_3_per_(var_eval_3_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_eval_3_per__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_eval_3_per_

  function do_ajax_form_t_evaluacion_p3_validate_eval_3_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_eval_3_per__cb

  // ---------- Validate dc1_3p_
  function do_ajax_form_t_evaluacion_p3_validate_dc1_3p_(iNumLinha)
  {
    var nomeCampo_dc1_3p_ = "dc1_3p_" + iNumLinha;
    var var_dc1_3p_ = scAjaxGetFieldText(nomeCampo_dc1_3p_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dc1_3p_(var_dc1_3p_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dc1_3p__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dc1_3p_

  function do_ajax_form_t_evaluacion_p3_validate_dc1_3p__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dc1_3p__cb

  // ---------- Validate dc2_3p_
  function do_ajax_form_t_evaluacion_p3_validate_dc2_3p_(iNumLinha)
  {
    var nomeCampo_dc2_3p_ = "dc2_3p_" + iNumLinha;
    var var_dc2_3p_ = scAjaxGetFieldText(nomeCampo_dc2_3p_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dc2_3p_(var_dc2_3p_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dc2_3p__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dc2_3p_

  function do_ajax_form_t_evaluacion_p3_validate_dc2_3p__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dc2_3p__cb

  // ---------- Validate dc3_3p_
  function do_ajax_form_t_evaluacion_p3_validate_dc3_3p_(iNumLinha)
  {
    var nomeCampo_dc3_3p_ = "dc3_3p_" + iNumLinha;
    var var_dc3_3p_ = scAjaxGetFieldText(nomeCampo_dc3_3p_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dc3_3p_(var_dc3_3p_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dc3_3p__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dc3_3p_

  function do_ajax_form_t_evaluacion_p3_validate_dc3_3p__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dc3_3p__cb

  // ---------- Validate dc4_3p_
  function do_ajax_form_t_evaluacion_p3_validate_dc4_3p_(iNumLinha)
  {
    var nomeCampo_dc4_3p_ = "dc4_3p_" + iNumLinha;
    var var_dc4_3p_ = scAjaxGetFieldText(nomeCampo_dc4_3p_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dc4_3p_(var_dc4_3p_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dc4_3p__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dc4_3p_

  function do_ajax_form_t_evaluacion_p3_validate_dc4_3p__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dc4_3p__cb

  // ---------- Validate dc5_3p_
  function do_ajax_form_t_evaluacion_p3_validate_dc5_3p_(iNumLinha)
  {
    var nomeCampo_dc5_3p_ = "dc5_3p_" + iNumLinha;
    var var_dc5_3p_ = scAjaxGetFieldText(nomeCampo_dc5_3p_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dc5_3p_(var_dc5_3p_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dc5_3p__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dc5_3p_

  function do_ajax_form_t_evaluacion_p3_validate_dc5_3p__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dc5_3p__cb

  // ---------- Validate pcent_dc3_
  function do_ajax_form_t_evaluacion_p3_validate_pcent_dc3_(iNumLinha)
  {
    var nomeCampo_pcent_dc3_ = "pcent_dc3_" + iNumLinha;
    var var_pcent_dc3_ = scAjaxGetFieldText(nomeCampo_pcent_dc3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_pcent_dc3_(var_pcent_dc3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_pcent_dc3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_pcent_dc3_

  function do_ajax_form_t_evaluacion_p3_validate_pcent_dc3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_pcent_dc3__cb

  // ---------- Validate dp1_p3_
  function do_ajax_form_t_evaluacion_p3_validate_dp1_p3_(iNumLinha)
  {
    var nomeCampo_dp1_p3_ = "dp1_p3_" + iNumLinha;
    var var_dp1_p3_ = scAjaxGetFieldText(nomeCampo_dp1_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dp1_p3_(var_dp1_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dp1_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dp1_p3_

  function do_ajax_form_t_evaluacion_p3_validate_dp1_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dp1_p3__cb

  // ---------- Validate dp2_p3_
  function do_ajax_form_t_evaluacion_p3_validate_dp2_p3_(iNumLinha)
  {
    var nomeCampo_dp2_p3_ = "dp2_p3_" + iNumLinha;
    var var_dp2_p3_ = scAjaxGetFieldText(nomeCampo_dp2_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dp2_p3_(var_dp2_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dp2_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dp2_p3_

  function do_ajax_form_t_evaluacion_p3_validate_dp2_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dp2_p3__cb

  // ---------- Validate dp3_p3_
  function do_ajax_form_t_evaluacion_p3_validate_dp3_p3_(iNumLinha)
  {
    var nomeCampo_dp3_p3_ = "dp3_p3_" + iNumLinha;
    var var_dp3_p3_ = scAjaxGetFieldText(nomeCampo_dp3_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dp3_p3_(var_dp3_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dp3_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dp3_p3_

  function do_ajax_form_t_evaluacion_p3_validate_dp3_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dp3_p3__cb

  // ---------- Validate dp4_p3_
  function do_ajax_form_t_evaluacion_p3_validate_dp4_p3_(iNumLinha)
  {
    var nomeCampo_dp4_p3_ = "dp4_p3_" + iNumLinha;
    var var_dp4_p3_ = scAjaxGetFieldText(nomeCampo_dp4_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_dp4_p3_(var_dp4_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_dp4_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_dp4_p3_

  function do_ajax_form_t_evaluacion_p3_validate_dp4_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_dp4_p3__cb

  // ---------- Validate sc_field_0_
  function do_ajax_form_t_evaluacion_p3_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_sc_field_0__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_sc_field_0_

  function do_ajax_form_t_evaluacion_p3_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_sc_field_0__cb

  // ---------- Validate pcent_dp3_
  function do_ajax_form_t_evaluacion_p3_validate_pcent_dp3_(iNumLinha)
  {
    var nomeCampo_pcent_dp3_ = "pcent_dp3_" + iNumLinha;
    var var_pcent_dp3_ = scAjaxGetFieldText(nomeCampo_pcent_dp3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_pcent_dp3_(var_pcent_dp3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_pcent_dp3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_pcent_dp3_

  function do_ajax_form_t_evaluacion_p3_validate_pcent_dp3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_pcent_dp3__cb

  // ---------- Validate ds1_p3_
  function do_ajax_form_t_evaluacion_p3_validate_ds1_p3_(iNumLinha)
  {
    var nomeCampo_ds1_p3_ = "ds1_p3_" + iNumLinha;
    var var_ds1_p3_ = scAjaxGetFieldText(nomeCampo_ds1_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_ds1_p3_(var_ds1_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_ds1_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_ds1_p3_

  function do_ajax_form_t_evaluacion_p3_validate_ds1_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_ds1_p3__cb

  // ---------- Validate ds2_p3_
  function do_ajax_form_t_evaluacion_p3_validate_ds2_p3_(iNumLinha)
  {
    var nomeCampo_ds2_p3_ = "ds2_p3_" + iNumLinha;
    var var_ds2_p3_ = scAjaxGetFieldText(nomeCampo_ds2_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_ds2_p3_(var_ds2_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_ds2_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_ds2_p3_

  function do_ajax_form_t_evaluacion_p3_validate_ds2_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_ds2_p3__cb

  // ---------- Validate ds3_p3_
  function do_ajax_form_t_evaluacion_p3_validate_ds3_p3_(iNumLinha)
  {
    var nomeCampo_ds3_p3_ = "ds3_p3_" + iNumLinha;
    var var_ds3_p3_ = scAjaxGetFieldText(nomeCampo_ds3_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_ds3_p3_(var_ds3_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_ds3_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_ds3_p3_

  function do_ajax_form_t_evaluacion_p3_validate_ds3_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_ds3_p3__cb

  // ---------- Validate ds4_p3_
  function do_ajax_form_t_evaluacion_p3_validate_ds4_p3_(iNumLinha)
  {
    var nomeCampo_ds4_p3_ = "ds4_p3_" + iNumLinha;
    var var_ds4_p3_ = scAjaxGetFieldText(nomeCampo_ds4_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_ds4_p3_(var_ds4_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_ds4_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_ds4_p3_

  function do_ajax_form_t_evaluacion_p3_validate_ds4_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_ds4_p3__cb

  // ---------- Validate ds5_p3_
  function do_ajax_form_t_evaluacion_p3_validate_ds5_p3_(iNumLinha)
  {
    var nomeCampo_ds5_p3_ = "ds5_p3_" + iNumLinha;
    var var_ds5_p3_ = scAjaxGetFieldText(nomeCampo_ds5_p3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_ds5_p3_(var_ds5_p3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_ds5_p3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_ds5_p3_

  function do_ajax_form_t_evaluacion_p3_validate_ds5_p3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_ds5_p3__cb

  // ---------- Validate pcent_ds3_
  function do_ajax_form_t_evaluacion_p3_validate_pcent_ds3_(iNumLinha)
  {
    var nomeCampo_pcent_ds3_ = "pcent_ds3_" + iNumLinha;
    var var_pcent_ds3_ = scAjaxGetFieldText(nomeCampo_pcent_ds3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_pcent_ds3_(var_pcent_ds3_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_pcent_ds3__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_pcent_ds3_

  function do_ajax_form_t_evaluacion_p3_validate_pcent_ds3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_pcent_ds3__cb

  // ---------- Validate val_acumulada_
  function do_ajax_form_t_evaluacion_p3_validate_val_acumulada_(iNumLinha)
  {
    var nomeCampo_val_acumulada_ = "val_acumulada_" + iNumLinha;
    var var_val_acumulada_ = scAjaxGetFieldText(nomeCampo_val_acumulada_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_val_acumulada_(var_val_acumulada_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_val_acumulada__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_val_acumulada_

  function do_ajax_form_t_evaluacion_p3_validate_val_acumulada__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_val_acumulada__cb

  // ---------- Validate val_requerida_
  function do_ajax_form_t_evaluacion_p3_validate_val_requerida_(iNumLinha)
  {
    var nomeCampo_val_requerida_ = "val_requerida_" + iNumLinha;
    var var_val_requerida_ = scAjaxGetFieldText(nomeCampo_val_requerida_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_validate_val_requerida_(var_val_requerida_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_p3_validate_val_requerida__cb);
  } // do_ajax_form_t_evaluacion_p3_validate_val_requerida_

  function do_ajax_form_t_evaluacion_p3_validate_val_requerida__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_p3_validate_val_requerida__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_evaluacion_p3_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_evaluacion_p3_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_p3_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_evaluacion_p3_add_new_line_cb);
  } // do_ajax_form_t_evaluacion_p3_add_new_line

  function do_ajax_form_t_evaluacion_p3_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_evaluacion_p3_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_evaluacion_p3_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_p3_backup_line(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_evaluacion_p3_backup_line_cb);
  } // do_ajax_form_t_evaluacion_p3_backup_line

  function do_ajax_form_t_evaluacion_p3_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_evaluacion_p3_backup_line_cb

  function do_ajax_form_t_evaluacion_p3_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_evaluacion_p3_cancel_insert

  function do_ajax_form_t_evaluacion_p3_cancel_update(iSeqVert)
  {
    do_ajax_form_t_evaluacion_p3_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_evaluacion_p3_cancel_update

  function do_ajax_form_t_evaluacion_p3_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_evaluacion_p3_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_evaluacion_p3_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_p3_table_refresh(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_p3_table_refresh_cb);
  } //  do_ajax_form_t_evaluacion_p3_table_refresh

  function do_ajax_form_t_evaluacion_p3_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_evaluacion_p3_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_evaluacion_p3_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_evaluacion_p3_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_t_evaluacion_p3_submit_form(var_id_estudiante_, var_estatus_, var_novedad_, var_eval_3_per_, var_dc1_3p_, var_dc2_3p_, var_dc3_3p_, var_dc4_3p_, var_dc5_3p_, var_pcent_dc3_, var_dp1_p3_, var_dp2_p3_, var_dp3_p3_, var_dp4_p3_, var_sc_field_0_, var_pcent_dp3_, var_ds1_p3_, var_ds2_p3_, var_ds3_p3_, var_ds4_p3_, var_ds5_p3_, var_pcent_ds3_, var_val_acumulada_, var_val_requerida_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_evaluacion_p3_submit_form_cb);
  } // do_ajax_form_t_evaluacion_p3_submit_form

  function do_ajax_form_t_evaluacion_p3_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_t_evaluacion_p3_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_evaluacion_p3_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_p3_navigate_form(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_p3_navigate_form_cb);
  } // do_ajax_form_t_evaluacion_p3_navigate_form

  function do_ajax_form_t_evaluacion_p3_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_t_evaluacion_p3_navigate_form_cb
  function sc_hide_form_t_evaluacion_p3_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_evaluacion_p3_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["eval_3_per_" + iNumLinha] = {"label": "3 Per<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_estudiante_" + iRow] || "on" == ajax_error_count["estatus_" + iRow] || "on" == ajax_error_count["novedad_" + iRow] || "on" == ajax_error_count["eval_3_per_" + iRow] || "on" == ajax_error_count["dc1_3p_" + iRow] || "on" == ajax_error_count["dc2_3p_" + iRow] || "on" == ajax_error_count["dc3_3p_" + iRow] || "on" == ajax_error_count["dc4_3p_" + iRow] || "on" == ajax_error_count["dc5_3p_" + iRow] || "on" == ajax_error_count["pcent_dc3_" + iRow] || "on" == ajax_error_count["dp1_p3_" + iRow] || "on" == ajax_error_count["dp2_p3_" + iRow] || "on" == ajax_error_count["dp3_p3_" + iRow] || "on" == ajax_error_count["dp4_p3_" + iRow] || "on" == ajax_error_count["sc_field_0_" + iRow] || "on" == ajax_error_count["pcent_dp3_" + iRow] || "on" == ajax_error_count["ds1_p3_" + iRow] || "on" == ajax_error_count["ds2_p3_" + iRow] || "on" == ajax_error_count["ds3_p3_" + iRow] || "on" == ajax_error_count["ds4_p3_" + iRow] || "on" == ajax_error_count["ds5_p3_" + iRow] || "on" == ajax_error_count["pcent_ds3_" + iRow] || "on" == ajax_error_count["val_acumulada_" + iRow] || "on" == ajax_error_count["val_requerida_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_estudiante_" + iRow] && "off" == ajax_error_count["estatus_" + iRow] && "off" == ajax_error_count["novedad_" + iRow] && "off" == ajax_error_count["eval_3_per_" + iRow] && "off" == ajax_error_count["dc1_3p_" + iRow] && "off" == ajax_error_count["dc2_3p_" + iRow] && "off" == ajax_error_count["dc3_3p_" + iRow] && "off" == ajax_error_count["dc4_3p_" + iRow] && "off" == ajax_error_count["dc5_3p_" + iRow] && "off" == ajax_error_count["pcent_dc3_" + iRow] && "off" == ajax_error_count["dp1_p3_" + iRow] && "off" == ajax_error_count["dp2_p3_" + iRow] && "off" == ajax_error_count["dp3_p3_" + iRow] && "off" == ajax_error_count["dp4_p3_" + iRow] && "off" == ajax_error_count["sc_field_0_" + iRow] && "off" == ajax_error_count["pcent_dp3_" + iRow] && "off" == ajax_error_count["ds1_p3_" + iRow] && "off" == ajax_error_count["ds2_p3_" + iRow] && "off" == ajax_error_count["ds3_p3_" + iRow] && "off" == ajax_error_count["ds4_p3_" + iRow] && "off" == ajax_error_count["ds5_p3_" + iRow] && "off" == ajax_error_count["pcent_ds3_" + iRow] && "off" == ajax_error_count["val_acumulada_" + iRow] && "off" == ajax_error_count["val_requerida_" + iRow]))
    {
      if (bErrorRow)
      {
