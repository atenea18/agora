...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_evaluacion_p3"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
   ...
   {
       window.open('<?php echo$this->Ini->path_link . "" . SC_dir_app_name('form_t_evaluacion_p3') . "/form_t_evaluacion_p3_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . $this->form_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id(); ?>&apl_prt=form_t_evaluacion_p3.php&opcao=print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');
   }
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_t_evaluacion_p3_submit_form(y, z); 
} 
<?php
}
?>
