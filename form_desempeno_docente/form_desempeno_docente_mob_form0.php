...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Indicadores de Desempeño"); } else { echo strip_tags("Indicadores de Desempeño"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_desempeno_docente/form_desempeno_docente_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_desempeno_docente_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_desempeno_docente_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['recarga'];
}
?>
...
<?php
 include_once("form_desempeno_docente_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_desempeno_docente_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_desempeno_docente_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_desempeno_docente_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Indicadores de Desempeño"; } else { echo "Indicadores de Desempeño"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_grado']))
           {
               $this->nmgp_cmp_readonly['id_grado'] = 'on';
           }
?>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['periodos']))
           {
               $this->nmgp_cmp_readonly['periodos'] = 'on';
           }
?>
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_grado"]) &&  $this->nmgp_cmp_readonly["id_grado"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_grado_line" id="hidden_field_data_id_grado" style="<?php echo $sStyleHidden_id_grado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_grado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_grado_label"><span id="id_label_id_grado"><?php echo $this->nm_new_label['id_grado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['id_grado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['id_grado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["id_grado"]) &&  $this->nmgp_cmp_readonly["id_grado"] == "on")) { 
...
?>
<input type="hidden" name="id_grado" value="<?php echo $this->form_encode_input($id_grado) . "\"><span id=\"id_ajax_label_id_grado\">" . $id_grado_look . "</span>"; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_area']))
           {
               $this->nmgp_cmp_readonly['id_area'] = 'on';
           }
?>
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["periodos"]) &&  $this->nmgp_cmp_readonly["periodos"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_periodos_line" id="hidden_field_data_periodos" style="<?php echo $sStyleHidden_periodos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_periodos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_periodos_label"><span id="id_label_periodos"><?php echo $this->nm_new_label['periodos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['periodos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['periodos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["periodos"]) &&  $this->nmgp_cmp_readonly["periodos"] == "on")) { 
...
?>
<input type="hidden" name="periodos" value="<?php echo $this->form_encode_input($periodos) . "\"><span id=\"id_ajax_label_periodos\">" . $periodos_look . "</span>"; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_asignatura']))
           {
               $this->nmgp_cmp_readonly['id_asignatura'] = 'on';
           }
?>
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_area"]) &&  $this->nmgp_cmp_readonly["id_area"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_area_line" id="hidden_field_data_id_area" style="<?php echo $sStyleHidden_id_area; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_area_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_area_label"><span id="id_label_id_area"><?php echo $this->nm_new_label['id_area']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['id_area']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['id_area'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["id_area"]) &&  $this->nmgp_cmp_readonly["id_area"] == "on")) { 
...
?>
<input type="hidden" name="id_area" value="<?php echo $this->form_encode_input($id_area) . "\"><span id=\"id_ajax_label_id_area\">" . $id_area_look . "</span>"; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_asignatura"]) &&  $this->nmgp_cmp_readonly["id_asignatura"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_asignatura_line" id="hidden_field_data_id_asignatura" style="<?php echo $sStyleHidden_id_asignatura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_asignatura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_asignatura_label"><span id="id_label_id_asignatura"><?php echo $this->nm_new_label['id_asignatura']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['id_asignatura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['id_asignatura'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["id_asignatura"]) &&  $this->nmgp_cmp_readonly["id_asignatura"] == "on")) { 
...
?>
<input type="hidden" name="id_asignatura" value="<?php echo $this->form_encode_input($id_asignatura) . "\"><span id=\"id_ajax_label_id_asignatura\">" . $id_asignatura_look . "</span>"; ?>
<?php } else { ?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_codigo_line" id="hidden_field_data_codigo" style="<?php echo $sStyleHidden_codigo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_label"><span id="id_label_codigo"><?php echo $this->nm_new_label['codigo']; ?></span></span><br><span id="id_read_on_codigo" class="css_codigo_line" style="<?php echo $sStyleReadLab_codigo; ?>"><?php echo $this->form_encode_input($this->codigo); ?></span><span id="id_read_off_codigo" style="<?php echo $sStyleReadInp_codigo; ?>"><input type="hidden" name="codigo" value="<?php echo $this->form_encode_input($codigo) . "\">"?><span id="id_ajax_label_codigo"><?php echo nl2br($codigo); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_codigo_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_codigo_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_superior_line" id="hidden_field_data_superior" style="<?php echo $sStyleHidden_superior; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_superior_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_superior_label"><span id="id_label_superior"><?php echo $this->nm_new_label['superior']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['superior']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['superior'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['Lookup_copia_desem'][] = 'null'; ?>
 <option value="null">Seleccione</option>
 <option value="1" <?php  if ($this->copia_desem == "1") { echo " selected" ;} ?>>Copiar Desempeño</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['Lookup_copia_desem'][] = '1'; ?>
 <option value="2" <?php  if ($this->copia_desem == "2") { echo " selected" ;} ?>>No Copiar Desempeño</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['Lookup_copia_desem'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bajo_line" id="hidden_field_data_bajo" style="<?php echo $sStyleHidden_bajo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bajo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bajo_label"><span id="id_label_bajo"><?php echo $this->nm_new_label['bajo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['bajo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['php_cmp_required']['bajo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<span id="id_read_on_bajo" class="sc-ui-readonly-bajo css_bajo_line" style="<?php echo $sStyleReadLab_bajo; ?>"><?php echo $this->form_encode_input($bajo_val); ?></span><span id="id_read_off_bajo" style="white-space: nowrap;<?php echo $sStyleReadInp_bajo; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_bajo_obj" style="white-space: pre-wrap;" name="bajo" id="id_sc_field_bajo" rows="2" cols="150"
 alt="{datatype: 'text', maxLength: 32767, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">
<?php echo $bajo; ?>
</textarea>
</span><?php } ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_desempeno_docente_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_desempeno_docente_mob");
 parent.scAjaxDetailHeight("form_desempeno_docente_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
