<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_subgrupo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_subgrupo_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_evaluacion_p1_m_itigvc_tec"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_id_grado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
var var_btn_sc_btn_0_id_grupo = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['dados_form'][$sc_seq_vert]['id_grupo_'])?>;
var var_btn_sc_btn_0_id_asign = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
var var_btn_sc_btn_0_par_idgrupo = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['dados_form'][$sc_seq_vert]['id_grupo_'])?>;
var var_btn_sc_btn_0_par_asign = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
var var_btn_sc_btn_0_par_idgrado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1_m_itigvc_tec']['where_detal']))
  {
?>  
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_t_evaluacion_p1_m_itigvc_tec_submit_form(y, z); 
} 
<?php
}
?>
