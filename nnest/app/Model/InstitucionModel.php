...
class InstitucionModel extends BD{
	...
	{	
		...
		$this->query = "SELECT datos_institucion.nombre_inst, datos_institucion.logo_byte, docentes.primer_apellido, docentes.primer_nombre, datos_institucion.logo, t_grupos.id_grupo, t_grupos.nombre_grupo, t_grupos.id_director_grupo, sedes.sede FROM t_grupos 
