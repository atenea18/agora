<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_boletin_estudiantes_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_boletin_estudiantes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["area"])) ? $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["area"] : "area";
   $tab_ger_campos['resumen'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['resumen'] = "resumen";
       $tab_converte["resumen"]   = "resumen";
   }
   else
   {
       $tab_def_campos['resumen'] = "";
       $tab_converte[""]   = "resumen";
   }
   $tab_labels["resumen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["resumen"])) ? $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["resumen"] : "resumen";
   $tab_ger_campos['obsg'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['obsg'] = "obsg";
       $tab_converte["obsg"]   = "obsg";
   }
   else
   {
       $tab_def_campos['obsg'] = "";
   ...
   $tab_labels["obsg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["obsg"])) ? $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["obsg"] : "obsg";
   ...
   $tab_labels["linea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["linea"])) ? $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["linea"] : "linea";
   ...
   $tab_labels["t_grupos_id_director_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["t_grupos_id_director_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['labels']["t_grupos_id_director_grupo"] : "Id Director Grupo";
   $tab_ger_campos['area'] = "none";
   $tab_ger_campos['resumen'] = "none";
   $tab_ger_campos['obsg'] = "none";
   $tab_ger_campos['linea'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_boletin_estudiantes']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_boletin_estudiantes']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_boletin_estudiantes']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_boletin_estudiantes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_boletin_estudiantes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
