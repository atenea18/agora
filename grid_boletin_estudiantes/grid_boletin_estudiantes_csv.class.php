...
class grid_boletin_estudiantes_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_boletin_estudiantes_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo    .= ".csv";
      $this->Tit_doc    = "grid_boletin_estudiantes.csv";
      $this->Delim_dados = "\"";
      $this->Delim_col   = ";";
      $this->Delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['csv_name']);
      }
...
$_SESSION['scriptcase']['grid_boletin_estudiantes']['contr_erro'] = 'off'; 
   ...
   function NM_export_obsg()
   {
      ...
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->obsg);
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
