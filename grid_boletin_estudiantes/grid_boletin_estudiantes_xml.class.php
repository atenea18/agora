...
class grid_boletin_estudiantes_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_boletin_estudiantes_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_boletin_estudiantes.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_boletin_estudiantes";
...
$_SESSION['scriptcase']['grid_boletin_estudiantes']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->obsg))
         {
             $this->obsg = sc_convert_encoding($this->obsg, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " obsg =\"" . $this->trata_dados($this->obsg) . "\"";
   }
   //----- linea
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletin_estudiantes']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
