  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_asignaturas_aux" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_t_asignaturas_aux_validate_id_asignatura_(iNumLinha)
  {
    var nomeCampo_id_asignatura_ = "id_asignatura_" + iNumLinha;
    var var_id_asignatura_ = scAjaxGetFieldHidden(nomeCampo_id_asignatura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignaturas_aux_validate_id_asignatura_(var_id_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_t_asignaturas_aux_validate_id_asignatura__cb);
  } // do_ajax_form_t_asignaturas_aux_validate_id_asignatura_

  function do_ajax_form_t_asignaturas_aux_validate_id_asignatura__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignaturas_aux_validate_id_asignatura__cb

  // ---------- Validate asignatura_
  function do_ajax_form_t_asignaturas_aux_validate_asignatura_(iNumLinha)
  {
    var nomeCampo_asignatura_ = "asignatura_" + iNumLinha;
    var var_asignatura_ = scAjaxGetFieldText(nomeCampo_asignatura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignaturas_aux_validate_asignatura_(var_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_t_asignaturas_aux_validate_asignatura__cb);
  } // do_ajax_form_t_asignaturas_aux_validate_asignatura_

  function do_ajax_form_t_asignaturas_aux_validate_asignatura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "asignatura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "asignatura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "asignatura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "asignatura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignaturas_aux_validate_asignatura__cb

  // ---------- Validate n_simpl_
  function do_ajax_form_t_asignaturas_aux_validate_n_simpl_(iNumLinha)
  {
    var nomeCampo_n_simpl_ = "n_simpl_" + iNumLinha;
    var var_n_simpl_ = scAjaxGetFieldText(nomeCampo_n_simpl_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignaturas_aux_validate_n_simpl_(var_n_simpl_, iNumLinha, var_script_case_init, do_ajax_form_t_asignaturas_aux_validate_n_simpl__cb);
  } // do_ajax_form_t_asignaturas_aux_validate_n_simpl_

  function do_ajax_form_t_asignaturas_aux_validate_n_simpl__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "n_simpl_" + iLineNumber;
    }
    else
    {
      sFieldValid = "n_simpl_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "n_simpl_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "n_simpl_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignaturas_aux_validate_n_simpl__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_asignaturas_aux_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_asignaturas_aux_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_asignaturas_aux_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_asignaturas_aux_add_new_line_cb);
  } // do_ajax_form_t_asignaturas_aux_add_new_line

  function do_ajax_form_t_asignaturas_aux_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_asignaturas_aux_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_asignaturas_aux_backup_line(iNumLinha)
  {
    var var_id_asignatura_ = scAjaxGetFieldHidden("id_asignatura_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignaturas_aux_backup_line(var_id_asignatura_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_asignaturas_aux_backup_line_cb);
  } // do_ajax_form_t_asignaturas_aux_backup_line

  function do_ajax_form_t_asignaturas_aux_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_asignaturas_aux_backup_line_cb

  function do_ajax_form_t_asignaturas_aux_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_asignaturas_aux_cancel_insert

  function do_ajax_form_t_asignaturas_aux_cancel_update(iSeqVert)
  {
    do_ajax_form_t_asignaturas_aux_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_asignaturas_aux_cancel_update

  function do_ajax_form_t_asignaturas_aux_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_asignaturas_aux_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_asignaturas_aux_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_t_asignaturas_aux_table_refresh(var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_asignaturas_aux_table_refresh_cb);
  } //  do_ajax_form_t_asignaturas_aux_table_refresh

  function do_ajax_form_t_asignaturas_aux_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_asignaturas_aux_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_asignaturas_aux_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_asignaturas_aux_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_asignatura_ = scAjaxGetFieldHidden("id_asignatura_" + iNumLinha);
    var var_asignatura_ = scAjaxGetFieldText("asignatura_" + iNumLinha);
    var var_n_simpl_ = scAjaxGetFieldText("n_simpl_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_t_asignaturas_aux_submit_form(var_id_asignatura_, var_asignatura_, var_n_simpl_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_asignaturas_aux_submit_form_cb);
  } // do_ajax_form_t_asignaturas_aux_submit_form

  function do_ajax_form_t_asignaturas_aux_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("asignatura_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("n_simpl_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_t_asignaturas_aux_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_asignaturas_aux_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_t_asignaturas_aux_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("asignatura_" + iNavForm);
      scAjaxHideErrorDisplay("n_simpl_" + iNavForm);
    }
    var var_id_asignatura_ = document.F2.id_asignatura_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_asignaturas_aux_navigate_form(var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_asignaturas_aux_navigate_form_cb);
  } // do_ajax_form_t_asignaturas_aux_navigate_form

  function do_ajax_form_t_asignaturas_aux_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_t_asignaturas_aux_navigate_form_cb
  function sc_hide_form_t_asignaturas_aux_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_asignaturas_aux_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "asignatura_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "n_simpl_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["asignatura_" + iNumLinha] = {"label": "Asignatura<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["n_simpl_" + iNumLinha] = {"label": "N Simpl<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_asignatura_"][iNumLinha] = "id_asignatura_" + iNumLinha;
    ajax_field_mult["asignatura_"][iNumLinha] = "asignatura_" + iNumLinha;
    ajax_field_mult["n_simpl_"][iNumLinha] = "n_simpl_" + iNumLinha;
    ...
    ajax_field_id["asignatura_" + iNumLinha] = new Array("hidden_field_label_asignatura_", "hidden_field_data_asignatura_" + iNumLinha);
    ajax_field_id["n_simpl_" + iNumLinha] = new Array("hidden_field_label_n_simpl_", "hidden_field_data_n_simpl_" + iNumLinha);
    ajax_error_count["id_asignatura_" + iNumLinha] = "off";
    ajax_error_count["asignatura_" + iNumLinha] = "off";
    ajax_error_count["n_simpl_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_asignatura_" + iNumLinha] = "on";
    ajax_read_only["asignatura_" + iNumLinha] = "off";
    ajax_read_only["n_simpl_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_asignatura_" + iNumLinha] = "on";
    ajax_read_only["asignatura_" + iNumLinha] = "on";
    ajax_read_only["n_simpl_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["asignatura_" + iNumLinha] = null;
    ajax_error_list["n_simpl_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["asignatura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["asignatura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["asignatura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["asignatura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["asignatura_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["n_simpl_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["n_simpl_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["n_simpl_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["n_simpl_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["n_simpl_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['asignatura_'])) ? $this->nmgp_cmp_readonly['asignatura_'] : 'off';
?>
    scAjaxFieldRead("asignatura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['n_simpl_'])) ? $this->nmgp_cmp_readonly['n_simpl_'] : 'off';
?>
    scAjaxFieldRead("n_simpl_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_asignatura_" + iSeq, "on");
    scAjaxFieldRead("asignatura_" + iSeq, "on");
    scAjaxFieldRead("n_simpl_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_asignatura_" + iRow] || "on" == ajax_error_count["asignatura_" + iRow] || "on" == ajax_error_count["n_simpl_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_asignatura_" + iRow))
        document.getElementById("hidden_field_data_asignatura_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_n_simpl_" + iRow))
        document.getElementById("hidden_field_data_n_simpl_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_asignatura_" + iRow] && "off" == ajax_error_count["asignatura_" + iRow] && "off" == ajax_error_count["n_simpl_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_asignatura_" + iRow] = "off";
        ajax_error_count["asignatura_" + iRow] = "off";
        ajax_error_count["n_simpl_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_asignatura_" + iRow))
        document.getElementById("hidden_field_data_asignatura_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_n_simpl_" + iRow))
        document.getElementById("hidden_field_data_n_simpl_" + iRow).className = sCssLine;
    }
  }
