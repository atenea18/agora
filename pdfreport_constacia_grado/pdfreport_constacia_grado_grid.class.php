<?php
class pdfreport_constacia_grado_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_constacia_grado']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_constacia_grado", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq_filtro'];
   $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
   $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
   $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
   $_SESSION['scriptcase']['contr_link_emb'] = $this->nm_location;
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq'];  
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['idstudents'] = "Idstudents";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['id_sede'] = "Id Sede";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['id_jornada'] = "Id Jornada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['semestre'] = "Semestre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['tipo_identificacion'] = "Tipo Identificacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['numero_documento'] = "Numero Documento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['primer_nombre'] = "Primer Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['segundo_nombre'] = "Segundo Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['primer_apellido'] = "Primer Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['segundo_apellido'] = "Segundo Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['grado_igreso'] = "Grado Igreso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['id_grupo'] = "Id Grupo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['cadena_principal'] = "cadena_principal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['cadena_principal_1'] = "cadena_principal_1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['cadena_secundaria'] = "cadena_secundaria";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['cargo_pri_firma'] = "cargo_pri_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['cargo_seg_firma'] = "cargo_seg_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['cod_dane'] = "cod_dane";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['direccion'] = "direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['encabezado'] = "encabezado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['especialidad'] = "especialidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['logo'] = "logo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['municipio'] = "municipio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['nit'] = "nit";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['nombre_institucion'] = "nombre_institucion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['pie_pagina'] = "pie_pagina";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['primera_firma'] = "primera_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['segunda_firma'] = "segunda_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['labels']['telefonos'] = "telefonos";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grado']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grado']['qt_col_grid']) 
      {  
          ...
          $_SESSION['scriptcase']['pdfreport_constacia_grado']['contr_erro'] = 'on';
