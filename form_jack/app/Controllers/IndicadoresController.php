...
public function insertarCodigosDesempAction($database){
		...
		var_dump($indicador_obj->insertDesempCodigos());

}

public function deleteCodigosDesempAction($posDelet,$desemp,$grup,$asign, $per, $database){
    $indicador_obj = new Indicadores($database);
    $indicador_obj->delteCodigoDesemp($posDelet,$desemp,$grup,$asign,$per);
}
