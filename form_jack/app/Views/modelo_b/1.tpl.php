...
<table class="table content-table " id="content-inputs">
	...
	<thead class="">
		<tr id="background-rows-table"  valign="middle">
			...
			<th colspan="5" >DESEMPEÑO PERSONAL</th>			
			<th rowspan="2"><?=$porcentajes['porcentaje_grupo2']?>%</th>

			<th colspan="5" >DESEMPEÑO SOCIAL</th>			
		...
		<tr id="item-posicion" valign="middle" class="border-th">
			...
			<th data-update="dp1"></th>
			<th data-update="dp2"></th>
			<th data-update="dp3"></th>
			<th data-update="dp4"></th>
			<th data-update="dp5"></th>


			<th data-update="ds1"></th>
			<th data-update="ds2"></th>
			<th data-update="ds3"></th>
			<th data-update="ds4"></th>
			<th data-update="ds5"></th>
