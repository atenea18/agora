...
<body>
	...
	<script type="text/javascript">
        ...
        function posicionesClick(ev){
            ...
            $.ajax({
                method: "POST",
                url: urls+"/Indicadores/deleteCodigosDesemp/"+posDelet+"/"+desemp+"/"+grup+"/"+asign+"/"+per+"/"+arreglo[4],
                data: ''
            })
                .done(function(datos) {
                    console.log(datos);
		...
		$('#periodos').change(function(){
			...
			if(this.value == 0){
					...
					$.ajax({
                        ...
                        crossDomain: true,
                        // dataType: "json",
                        url: '<?=URL?>/Evaluacion/getPeriodos/' + this.value + '/' + arreglo[2] + '/' + arreglo[3] + '/' + arreglo[4],
                        ...
                        success: function (data) {
                        	...
                        	$('#item-posicion').find('th[data-estado="false"]').each(function (i, element) {
                        		...
                        		.done(function (datos) {
                                    ...
                                    $(element).append('<span class="delete-pos" data-pos="'+pos+'" data-desemp="'+datos+'" data-grup="'+arreglo[2]+'" data-asign="'+arreglo[3]+'"> <i class="fa fa-trash" aria-hidden="true"></i></span>');
