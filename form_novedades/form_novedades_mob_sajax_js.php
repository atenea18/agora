  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_novedades_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_novedad
  function do_ajax_form_novedades_mob_validate_id_novedad()
  {
    var nomeCampo_id_novedad = "id_novedad";
    var var_id_novedad = scAjaxGetFieldHidden(nomeCampo_id_novedad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novedades_mob_validate_id_novedad(var_id_novedad, var_script_case_init, do_ajax_form_novedades_mob_validate_id_novedad_cb);
  } // do_ajax_form_novedades_mob_validate_id_novedad

  function do_ajax_form_novedades_mob_validate_id_novedad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_novedad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novedades_mob_validate_id_novedad_cb

  // ---------- Validate novedad
  function do_ajax_form_novedades_mob_validate_novedad()
  {
    var nomeCampo_novedad = "novedad";
    var var_novedad = scAjaxGetFieldText(nomeCampo_novedad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novedades_mob_validate_novedad(var_novedad, var_script_case_init, do_ajax_form_novedades_mob_validate_novedad_cb);
  } // do_ajax_form_novedades_mob_validate_novedad

  function do_ajax_form_novedades_mob_validate_novedad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "novedad";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novedades_mob_validate_novedad_cb
  // ---------- Form
  function do_ajax_form_novedades_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_novedades_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_novedad = scAjaxGetFieldHidden("id_novedad");
    var var_novedad = scAjaxGetFieldText("novedad");
    ...
    scAjaxProcOn();
    x_ajax_form_novedades_mob_submit_form(var_id_novedad, var_novedad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_novedades_mob_submit_form_cb);
  } // do_ajax_form_novedades_mob_submit_form

  function do_ajax_form_novedades_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_novedad");
      scAjaxHideErrorDisplay("novedad");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_novedades_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_novedades_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_novedad");
    scAjaxHideErrorDisplay("novedad");
    var var_id_novedad = document.F2.id_novedad.value;
    ...
    scAjaxProcOn();
    x_ajax_form_novedades_mob_navigate_form(var_id_novedad, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_novedades_mob_navigate_form_cb);
  } // do_ajax_form_novedades_mob_navigate_form

  function do_ajax_form_novedades_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_novedades_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_novedad.value = scAjaxGetKeyValue("id_novedad");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_novedades_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_novedades_mob_navigate_form_cb
  function sc_hide_form_novedades_mob_form()
  {
  ...
  ajax_field_list[0] = "id_novedad";
  ajax_field_list[1] = "novedad";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_novedad": {"label": "Id Novedad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "novedad": {"label": "Novedad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_novedad": new Array(),
    "novedad": new Array()
  };
  ajax_field_mult["id_novedad"][1] = "id_novedad";
  ajax_field_mult["novedad"][1] = "novedad";

  var ajax_field_id = {
    "id_novedad": new Array("hidden_field_label_id_novedad", "hidden_field_data_id_novedad"),
    "novedad": new Array("hidden_field_label_novedad", "hidden_field_data_novedad")
  };
