<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_datos_institucion_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_datos_institucion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["id"] : "Id";
   $tab_ger_campos['nombre_inst'] = "on";
   $tab_def_campos['nombre_inst'] = "nombre_inst";
   $tab_converte["nombre_inst"]   = "nombre_inst";
   $tab_labels["nombre_inst"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["nombre_inst"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["nombre_inst"] : "Nombre Inst";
   $tab_ger_campos['nit'] = "on";
   $tab_def_campos['nit'] = "nit";
   $tab_converte["nit"]   = "nit";
   $tab_labels["nit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["nit"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["nit"] : "Nit";
   $tab_ger_campos['cod_dane'] = "on";
   $tab_def_campos['cod_dane'] = "cod_dane";
   $tab_converte["cod_dane"]   = "cod_dane";
   $tab_labels["cod_dane"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["cod_dane"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["cod_dane"] : "Cod Dane";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_converte["direccion"]   = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['telefonos'] = "on";
   $tab_def_campos['telefonos'] = "telefonos";
   $tab_converte["telefonos"]   = "telefonos";
   $tab_labels["telefonos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["telefonos"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["telefonos"] : "Telefonos";
   $tab_ger_campos['logo'] = "on";
   $tab_def_campos['logo'] = "logo";
   $tab_converte["logo"]   = "logo";
   $tab_labels["logo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["logo"])) ? $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['labels']["logo"] : "Logo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - datos_institucion</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_datos_institucion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_datos_institucion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
