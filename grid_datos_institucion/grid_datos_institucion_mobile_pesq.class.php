...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_inst"  <?php echo $str_hide_nombre_inst?>><?php
      $nombre_inst_look = substr($this->Db->qstr($nombre_inst), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cod_dane"  <?php echo $str_hide_cod_dane?>><?php
      $cod_dane_look = substr($this->Db->qstr($cod_dane), 1, -1); 
      $nmgp_def_dados = array(); 
