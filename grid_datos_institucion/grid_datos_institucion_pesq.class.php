...
class grid_datos_institucion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_datos_institucion_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_datos_institucion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_datos_institucion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_datos_institucion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_inst')
      {
          $nombre_inst = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_inst($nombre_inst);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cod_dane')
      {
          $cod_dane = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cod_dane($cod_dane);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_nombre_inst($nombre_inst)
   {
      $nombre_inst = substr($this->Db->qstr($nombre_inst), 1, -1);
            $nombre_inst_look = substr($this->Db->qstr($nombre_inst), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_inst from " . $this->Ini->nm_tabela . " where  nombre_inst like '%" . $nombre_inst . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_nit($nit)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nit from " . $this->Ini->nm_tabela . " where  nit like '%" . $nit . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_cod_dane($cod_dane)
   {
      $cod_dane = substr($this->Db->qstr($cod_dane), 1, -1);
            $cod_dane_look = substr($this->Db->qstr($cod_dane), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cod_dane from " . $this->Ini->nm_tabela . " where  cod_dane like '%" . $cod_dane . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "datos_institucion.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - datos_institucion</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_datos_institucion/grid_datos_institucion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_datos_institucion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_datos_institucion_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nombre_inst_cond#NMF#' + search_get_sel_txt('SC_nombre_inst_cond') + '@NMF@';
  str_out += 'SC_nombre_inst#NMF#' + search_get_text('SC_nombre_inst') + '@NMF@';
  str_out += 'id_ac_nombre_inst#NMF#' + search_get_text('id_ac_nombre_inst') + '@NMF@';
  str_out += 'SC_nit_cond#NMF#' + search_get_sel_txt('SC_nit_cond') + '@NMF@';
  str_out += 'SC_nit#NMF#' + search_get_text('SC_nit') + '@NMF@';
  str_out += 'id_ac_nit#NMF#' + search_get_text('id_ac_nit') + '@NMF@';
  str_out += 'SC_cod_dane_cond#NMF#' + search_get_sel_txt('SC_cod_dane_cond') + '@NMF@';
  str_out += 'SC_cod_dane#NMF#' + search_get_text('SC_cod_dane') + '@NMF@';
  str_out += 'id_ac_cod_dane#NMF#' + search_get_text('id_ac_cod_dane') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_nombre_inst").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_inst",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nombre_inst").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_inst").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nit").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
   ...
   $("#id_ac_cod_dane").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cod_dane",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_cod_dane").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cod_dane").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - datos_institucion</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $nombre_inst_cond, $nombre_inst, $nombre_inst_autocomp,
             $nit_cond, $nit, $nit_autocomp,
             $cod_dane_cond, $cod_dane, $cod_dane_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['id_cond']; 
          $nombre_inst = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nombre_inst']; 
          $nombre_inst_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nombre_inst_cond']; 
          $nit = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nit']; 
          $nit_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nit_cond']; 
          $cod_dane = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['cod_dane']; 
          $cod_dane_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['cod_dane_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_cond) || empty($id_cond))
      {
         $id_cond = "gt";
      }
      if (!isset($nombre_inst_cond) || empty($nombre_inst_cond))
      {
         $nombre_inst_cond = "qp";
      }
      ...
      if (!isset($cod_dane_cond) || empty($cod_dane_cond))
      {
         $cod_dane_cond = "qp";
      }
      ...
      $str_hide_nombre_inst = (in_array($nombre_inst_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nit = (in_array($nit_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cod_dane = (in_array($cod_dane_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($nombre_inst) || $nombre_inst == "")
      {
          $nombre_inst = "";
      }
      if (isset($nombre_inst) && !empty($nombre_inst))
      {
         $tmp_pos = strpos($nombre_inst, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_inst = substr($nombre_inst, 0, $tmp_pos);
         }
      }
      if (!isset($nit) || $nit == "")
      {
      ...
      if (!isset($cod_dane) || $cod_dane == "")
      {
          $cod_dane = "";
      }
      if (isset($cod_dane) && !empty($cod_dane))
      {
         $tmp_pos = strpos($cod_dane, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cod_dane = substr($cod_dane, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_datos_institucion_help.txt"))
   {
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id" name="id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['nombre_inst'])) ? $this->New_label['nombre_inst'] : "Nombre Inst"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nombre_inst_cond" name="nombre_inst_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_inst'), this, 'nombre_inst')">
       <OPTION value="qp" <?php if ("qp" == $nombre_inst_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_inst_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_inst_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_inst_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_inst" <?php echo $str_hide_nombre_inst?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nombre_inst'])) ? $this->New_label['nombre_inst'] : "Nombre Inst";
 $nmgp_tab_label .= "nombre_inst?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $nombre_inst_look = substr($this->Db->qstr($nombre_inst), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_inst from " . $this->Ini->nm_tabela . " where nombre_inst = '$nombre_inst_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nombre_inst]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_inst];
      }
      else
      {
          $sAutocompValue = $nombre_inst;
      }
?>
<INPUT  type="text" id="SC_nombre_inst" name="nombre_inst" value="<?php echo NM_encode_input($nombre_inst) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre_inst" name="nombre_inst_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nit'])) ? $this->New_label['nit'] : "Nit"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nit_cond" name="nit_cond" onChange="nm_campos_between(document.getElementById('id_vis_nit'), this, 'nit')">
...
<?php
      $nit_look = substr($this->Db->qstr($nit), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nit from " . $this->Ini->nm_tabela . " where nit = '$nit_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nit" name="nit_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cod_dane'])) ? $this->New_label['cod_dane'] : "Cod Dane"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cod_dane_cond" name="cod_dane_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_dane'), this, 'cod_dane')">
       <OPTION value="qp" <?php if ("qp" == $cod_dane_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cod_dane_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cod_dane_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cod_dane_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_dane" <?php echo $str_hide_cod_dane?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cod_dane'])) ? $this->New_label['cod_dane'] : "Cod Dane";
 $nmgp_tab_label .= "cod_dane?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $cod_dane_look = substr($this->Db->qstr($cod_dane), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cod_dane from " . $this->Ini->nm_tabela . " where cod_dane = '$cod_dane_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$cod_dane]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cod_dane];
      }
      else
      {
          $sAutocompValue = $cod_dane;
      }
?>
<INPUT  type="text" id="SC_cod_dane" name="cod_dane" value="<?php echo NM_encode_input($cod_dane) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cod_dane" name="cod_dane_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_datos_institucion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_datos_institucion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_nombre_inst'), document.F1.nombre_inst_cond, 'nombre_inst');
   document.F1.nombre_inst.value = "";
   document.F1.nombre_inst_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_cod_dane'), document.F1.cod_dane_cond, 'cod_dane');
   document.F1.cod_dane.value = "";
   document.F1.cod_dane_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_datos_institucion";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_datos_institucion/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_nombre_inst_cond'] = 'cond';
      $tp_fields['SC_nombre_inst'] = 'text_aut';
      $tp_fields['id_ac_nombre_inst'] = 'text_aut';
      $tp_fields['SC_nit_cond'] = 'cond';
      $tp_fields['SC_nit'] = 'text_aut';
      $tp_fields['id_ac_nit'] = 'text_aut';
      $tp_fields['SC_cod_dane_cond'] = 'cond';
      $tp_fields['SC_cod_dane'] = 'text_aut';
      $tp_fields['id_ac_cod_dane'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $id_cond, $id, $id_input_2, $id_autocomp,
             $nombre_inst_cond, $nombre_inst, $nombre_inst_autocomp,
             $nit_cond, $nit, $nit_autocomp,
             $cod_dane_cond, $cod_dane, $cod_dane_autocomp, $nmgp_tab_label;
      ...
      if (!empty($nombre_inst_autocomp) && empty($nombre_inst))
      {
          $nombre_inst = $nombre_inst_autocomp;
      }
      if (!empty($nit_autocomp) && empty($nit))
      {
          $nit = $nit_autocomp;
      }
      if (!empty($cod_dane_autocomp) && empty($cod_dane))
      {
          $cod_dane = $cod_dane_autocomp;
      }
      ...
      $nombre_inst_cond_salva = $nombre_inst_cond; 
      if (!isset($nombre_inst_input_2) || $nombre_inst_input_2 == "")
      {
          $nombre_inst_input_2 = $nombre_inst;
      }
      ...
      $cod_dane_cond_salva = $cod_dane_cond; 
      if (!isset($cod_dane_input_2) || $cod_dane_input_2 == "")
      {
          $cod_dane_input_2 = $cod_dane;
      }
      if ($id_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nombre_inst'] = $nombre_inst; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nombre_inst_cond'] = $nombre_inst_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nit'] = $nit; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['nit_cond'] = $nit_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['cod_dane'] = $cod_dane; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['cod_dane_cond'] = $cod_dane_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_inst'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombre_inst'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_inst'] = $nombre_inst;
      }
      $nit_look = substr($this->Db->qstr($nit), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nit from " . $this->Ini->nm_tabela . " where nit = '$nit_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cod_dane'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cod_dane'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cod_dane'] = $cod_dane;
      }
      ...
      //----- $nombre_inst
      $this->Date_part = false;
      if (isset($nombre_inst) || $nombre_inst_cond == "nu" || $nombre_inst_cond == "nn" || $nombre_inst_cond == "ep" || $nombre_inst_cond == "ne")
      {
         $this->monta_condicao("nombre_inst", $nombre_inst_cond, $nombre_inst, "", "nombre_inst");
      }
      ...
      //----- $cod_dane
      $this->Date_part = false;
      if (isset($cod_dane) || $cod_dane_cond == "nu" || $cod_dane_cond == "nn" || $cod_dane_cond == "ep" || $cod_dane_cond == "ne")
      {
         $this->monta_condicao("cod_dane", $cod_dane_cond, $cod_dane, "", "cod_dane");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_datos_institucion']['where_pesq_ant'] = $this->comando . $this->comando_fim;
