...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_c_estudantes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_c_estudantes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_c_estudantes']['embutida_filho'] as $ind => $sc_init)
          {
