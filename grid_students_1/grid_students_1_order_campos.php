<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_students_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_students_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["students_idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["students_idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["students_idstudents"] : "";
   ...
   $tab_labels["areas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["areas"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["areas"] : "areas";
   ...
   $tab_labels["dias_inasiste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["dias_inasiste"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["dias_inasiste"] : "dias_inasiste";
   ...
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["obs"] : "obs";
   ...
   $tab_labels["linea_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["linea_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["linea_1"] : "linea_1";
   $tab_ger_campos['linea_2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['linea_2'] = "linea_2";
       $tab_converte["linea_2"]   = "linea_2";
   }
   else
   {
       $tab_def_campos['linea_2'] = "";
       $tab_converte[""]   = "linea_2";
   }
   $tab_labels["linea_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["linea_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["linea_2"] : "linea_2";
...
t_estudiante_grupo.idstudent = '{students.idstudents}'"]   = "dir_grupo";
   ...
   $tab_labels["dir_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["dir_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["dir_grupo"] : "dir_grupo";
   ...
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_students_1']['labels']["titulo"] : "";
   $tab_ger_campos['areas'] = "none";
   $tab_ger_campos['dias_inasiste'] = "none";
   $tab_ger_campos['obs'] = "none";
   $tab_ger_campos['linea_1'] = "none";
   $tab_ger_campos['linea_2'] = "none";
   $tab_ger_campos['dir_grupo'] = "none";
   $tab_ger_campos['titulo'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_students_1']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_students_1']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_students_1']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_students_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_students_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_students_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_students_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
