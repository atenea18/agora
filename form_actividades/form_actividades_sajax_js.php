  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_actividades" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_actividades_validate_id_actividad_(iNumLinha)
  {
    ...
    x_ajax_form_actividades_validate_id_actividad_(var_id_actividad_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_id_actividad__cb);
  } // do_ajax_form_actividades_validate_id_actividad_

  function do_ajax_form_actividades_validate_id_actividad__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_id_actividad__cb

  // ---------- Validate actividad_
  function do_ajax_form_actividades_validate_actividad_(iNumLinha)
  {
    var nomeCampo_actividad_ = "actividad_" + iNumLinha;
    var var_actividad_ = scAjaxGetFieldText(nomeCampo_actividad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_actividad_(var_actividad_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_actividad__cb);
  } // do_ajax_form_actividades_validate_actividad_

  function do_ajax_form_actividades_validate_actividad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_actividad__cb

  // ---------- Validate codigo_desemp_
  function do_ajax_form_actividades_validate_codigo_desemp_(iNumLinha)
  {
    var nomeCampo_codigo_desemp_ = "codigo_desemp_" + iNumLinha;
    var var_codigo_desemp_ = scAjaxGetFieldText(nomeCampo_codigo_desemp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_codigo_desemp_(var_codigo_desemp_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_codigo_desemp__cb);
  } // do_ajax_form_actividades_validate_codigo_desemp_

  function do_ajax_form_actividades_validate_codigo_desemp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_codigo_desemp__cb

  // ---------- Validate posicion_
  function do_ajax_form_actividades_validate_posicion_(iNumLinha)
  {
    var nomeCampo_posicion_ = "posicion_" + iNumLinha;
    var var_posicion_ = scAjaxGetFieldText(nomeCampo_posicion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_posicion_(var_posicion_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_posicion__cb);
  } // do_ajax_form_actividades_validate_posicion_

  function do_ajax_form_actividades_validate_posicion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_posicion__cb

  // ---------- Validate id_asignatura_
  function do_ajax_form_actividades_validate_id_asignatura_(iNumLinha)
  {
    var nomeCampo_id_asignatura_ = "id_asignatura_" + iNumLinha;
    var var_id_asignatura_ = scAjaxGetFieldText(nomeCampo_id_asignatura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_id_asignatura_(var_id_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_id_asignatura__cb);
  } // do_ajax_form_actividades_validate_id_asignatura_

  function do_ajax_form_actividades_validate_id_asignatura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_id_asignatura__cb

  // ---------- Validate id_grupo_
  function do_ajax_form_actividades_validate_id_grupo_(iNumLinha)
  {
    var nomeCampo_id_grupo_ = "id_grupo_" + iNumLinha;
    var var_id_grupo_ = scAjaxGetFieldText(nomeCampo_id_grupo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_id_grupo_(var_id_grupo_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_id_grupo__cb);
  } // do_ajax_form_actividades_validate_id_grupo_

  function do_ajax_form_actividades_validate_id_grupo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_id_grupo__cb

  // ---------- Validate porcentaje_
  function do_ajax_form_actividades_validate_porcentaje_(iNumLinha)
  {
    var nomeCampo_porcentaje_ = "porcentaje_" + iNumLinha;
    var var_porcentaje_ = scAjaxGetFieldText(nomeCampo_porcentaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_porcentaje_(var_porcentaje_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_porcentaje__cb);
  } // do_ajax_form_actividades_validate_porcentaje_

  function do_ajax_form_actividades_validate_porcentaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_porcentaje__cb

  // ---------- Validate entorno_
  function do_ajax_form_actividades_validate_entorno_(iNumLinha)
  {
    var nomeCampo_entorno_ = "entorno_" + iNumLinha;
    var var_entorno_ = scAjaxGetFieldText(nomeCampo_entorno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_validate_entorno_(var_entorno_, iNumLinha, var_script_case_init, do_ajax_form_actividades_validate_entorno__cb);
  } // do_ajax_form_actividades_validate_entorno_

  function do_ajax_form_actividades_validate_entorno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_actividades_validate_entorno__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_actividades_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_actividades_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_actividades_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_actividades_add_new_line_cb);
  } // do_ajax_form_actividades_add_new_line

  function do_ajax_form_actividades_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_actividades_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_actividades_backup_line(iNumLinha)
  {
    var var_id_actividad_ = scAjaxGetFieldHidden("id_actividad_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_actividades_backup_line(var_id_actividad_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_actividades_backup_line_cb);
  } // do_ajax_form_actividades_backup_line

  function do_ajax_form_actividades_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_actividades_backup_line_cb

  function do_ajax_form_actividades_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_actividades_cancel_insert

  function do_ajax_form_actividades_cancel_update(iSeqVert)
  {
    do_ajax_form_actividades_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_actividades_cancel_update

  function do_ajax_form_actividades_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_actividades_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_actividades_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_actividades_table_refresh(var_id_actividad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_actividades_table_refresh_cb);
  } //  do_ajax_form_actividades_table_refresh

  function do_ajax_form_actividades_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_actividades_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_actividades_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_actividades_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_actividades_submit_form(var_id_actividad_, var_actividad_, var_codigo_desemp_, var_posicion_, var_id_asignatura_, var_id_grupo_, var_porcentaje_, var_entorno_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_actividades_submit_form_cb);
  } // do_ajax_form_actividades_submit_form

  function do_ajax_form_actividades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_actividades_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_actividades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_actividades_navigate_form(var_id_actividad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_actividades_navigate_form_cb);
  } // do_ajax_form_actividades_navigate_form

  function do_ajax_form_actividades_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_actividades_navigate_form_cb
  function sc_hide_form_actividades_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_actividades_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_field_id["id_actividad_" + iNumLinha] = new Array("hidden_field_label_id_actividad_", "hidden_field_data_id_actividad_" + iNumLinha);
