<?php
class form_actividades_form extends form_actividades_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_actividades/form_actividades_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_actividades_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_actividades_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['recarga'];
}
...
<?php
 include_once("form_actividades_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_actividades'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_actividades'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['fast_search'][2] : "";
?> 
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_actividades_add_new_line(); return false;", "do_ajax_form_actividades_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_actividades);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_actividades = $this->form_vert_form_actividades;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_actividades))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_actividades as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_actividad_ = $this->form_vert_form_actividades[$sc_seq_vert]['id_actividad_']; 
       ...
       $this->actividad_ = $this->form_vert_form_actividades[$sc_seq_vert]['actividad_']; 
       ...
       $this->codigo_desemp_ = $this->form_vert_form_actividades[$sc_seq_vert]['codigo_desemp_']; 
       ...
       $this->posicion_ = $this->form_vert_form_actividades[$sc_seq_vert]['posicion_']; 
       ...
       $this->id_asignatura_ = $this->form_vert_form_actividades[$sc_seq_vert]['id_asignatura_']; 
       ...
       $this->id_grupo_ = $this->form_vert_form_actividades[$sc_seq_vert]['id_grupo_']; 
       ...
       $this->porcentaje_ = $this->form_vert_form_actividades[$sc_seq_vert]['porcentaje_']; 
       ...
       $this->entorno_ = $this->form_vert_form_actividades[$sc_seq_vert]['entorno_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_actividades_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_actividades_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_actividades_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_actividades_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_actividades_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_actividades_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { ?>
<span id="id_read_on_actividad_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-actividad_<?php echo $sc_seq_vert ?> css_actividad__line" style="<?php echo $sStyleReadLab_actividad_; ?>"><?php echo $this->form_encode_input($this->actividad_); ?></span><span id="id_read_off_actividad_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_actividad_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_actividad__obj" style="" id="id_sc_field_actividad_<?php echo $sc_seq_vert ?>" type=text name="actividad_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($actividad_) ?>"
...
<span id="id_read_on_porcentaje_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-porcentaje_<?php echo $sc_seq_vert ?> css_porcentaje__line" style="<?php echo $sStyleReadLab_porcentaje_; ?>"><?php echo $this->form_encode_input($this->porcentaje_); ?></span><span id="id_read_off_porcentaje_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_porcentaje_; ?>">
 ...
 size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['porcentaje_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['porcentaje_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_actividades = $guarda_form_vert_form_actividades;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_actividades");
 parent.scAjaxDetailHeight("form_actividades", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
