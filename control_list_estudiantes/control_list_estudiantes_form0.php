...
<?php
include_once("control_list_estudiantes_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_list_estudiantes_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['recarga'];
}
?>
...
<?php
 include_once("control_list_estudiantes_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_list_estudiantes'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_list_estudiantes'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_estatus'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_semestre'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_fecha_matricula'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_tipo_identificacion'][] = '1'; ?>
...
<?php $sStyleHidden_semestre_dumb = ('' == $sStyleHidden_semestre) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_semestre_dumb" style="<?php echo $sStyleHidden_semestre_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_numero_documento'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_genero'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_fecha_nacimiento'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_anos_cumplidos'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_telefono'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_etnia'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_emai'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_zona'][] = '1'; ?>
...
<?php $sStyleHidden_emai_dumb = ('' == $sStyleHidden_emai) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_emai_dumb" style="<?php echo $sStyleHidden_emai_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '0'; ?>
 <option value="0">Seleccione</option>
 <option value="1" <?php  if ($this->celdas_vacias == "1") { echo " selected" ;} ?>>1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '1'; ?>
 <option value="2" <?php  if ($this->celdas_vacias == "2") { echo " selected" ;} ?>>2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '2'; ?>
 <option value="3" <?php  if ($this->celdas_vacias == "3") { echo " selected" ;} ?>>3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '3'; ?>
 <option value="4" <?php  if ($this->celdas_vacias == "4") { echo " selected" ;} ?>>4</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '4'; ?>
 <option value="5" <?php  if ($this->celdas_vacias == "5") { echo " selected" ;} ?>>5</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '5'; ?>
 <option value="6" <?php  if ($this->celdas_vacias == "6") { echo " selected" ;} ?>>6</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '6'; ?>
 <option value="7" <?php  if ($this->celdas_vacias == "7") { echo " selected" ;} ?>>7</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '7'; ?>
 <option value="8" <?php  if ($this->celdas_vacias == "8") { echo " selected" ;} ?>>8</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '8'; ?>
 <option value="9" <?php  if ($this->celdas_vacias == "9") { echo " selected" ;} ?>>9</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '9'; ?>
 <option value="10" <?php  if ($this->celdas_vacias == "10") { echo " selected" ;} ?>>10</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '10'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_list_estudiantes");
 parent.scAjaxDetailHeight("control_list_estudiantes", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
