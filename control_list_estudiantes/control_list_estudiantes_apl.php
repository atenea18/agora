<?php
//
class control_list_estudiantes_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_estatus)) 
          {
              $_SESSION['par_estatus'] = $this->par_estatus;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new control_list_estudiantes_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['control_list_estudiantes']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_list_estudiantes']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['control_list_estudiantes'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_list_estudiantes']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_list_estudiantes']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('control_list_estudiantes') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['control_list_estudiantes']['label'] = "Escoja los Campos a Imprimir";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "control_list_estudiantes")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['control_list_estudiantes']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['control_list_estudiantes'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['control_list_estudiantes']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("control_list_estudiantes", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'control_list_estudiantes_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'control_list_estudiantes_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'control_list_estudiantes/control_list_estudiantes_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "control_list_estudiantes_erro.class.php"); 
      }
      $this->Erro      = new control_list_estudiantes_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['control_list_estudiantes']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->zona = "" ;  
          $this->celdas_vacias = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['recarga'] = $this->nmgp_opcao;
      }
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos']))
              { 
                  $estatus = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][0]; 
                  $semestre = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][1]; 
                  $fecha_matricula = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][2]; 
                  $tipo_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][3]; 
                  $numero_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][4]; 
                  $genero = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][5]; 
                  $fecha_nacimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][6]; 
                  $anos_cumplidos = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][7]; 
                  $telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][8]; 
                  $etnia = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][9]; 
                  $emai = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][10]; 
                  $zona = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][11]; 
                  $celdas_vacias = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][12]; 
              } 
          }
          $this->nm_gera_html();
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][0] = $this->estatus; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][1] = $this->semestre; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][2] = $this->fecha_matricula; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][3] = $this->tipo_identificacion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][4] = $this->numero_documento; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][5] = $this->genero; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][6] = $this->fecha_nacimiento; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][7] = $this->anos_cumplidos; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][8] = $this->telefono; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][9] = $this->etnia; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][10] = $this->emai; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][11] = $this->zona; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['campos'][12] = $this->celdas_vacias; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("control_list_estudiantes", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->nmgp_redireciona_form("control_list_estudiantes_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_control_list_estudiantes']) || !is_array($this->NM_ajax_info['errList']['geral_control_list_estudiantes']))
              {
                  $this->NM_ajax_info['errList']['geral_control_list_estudiantes'] = array();
              }
              $this->NM_ajax_info['errList']['geral_control_list_estudiantes'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['control_list_estudiantes']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['control_list_estudiantes']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Estatus"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_estatus'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['estatus']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Semestre"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_semestre'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['semestre']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Fecha de Matrícula"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_fecha_matricula'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['fecha_matricula']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Tipo de Identificación"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_tipo_identificacion'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_identificacion']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Número de Documento"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_numero_documento'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['numero_documento']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Género"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_genero'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['genero']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Fecha de Nacimiento"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_fecha_nacimiento'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['fecha_nacimiento']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Años Cumplidos"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_anos_cumplidos'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['anos_cumplidos']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Teléfono"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_telefono'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['telefono']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Etnia"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_etnia'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['etnia']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Email"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_emai'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['emai']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("Comuna"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_zona'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['zona']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(control_list_estudiantes_pack_protect_string('1') => control_list_estudiantes_pack_protect_string("1"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('2') => control_list_estudiantes_pack_protect_string("2"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('3') => control_list_estudiantes_pack_protect_string("3"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('4') => control_list_estudiantes_pack_protect_string("4"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('5') => control_list_estudiantes_pack_protect_string("5"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('6') => control_list_estudiantes_pack_protect_string("6"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('7') => control_list_estudiantes_pack_protect_string("7"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('8') => control_list_estudiantes_pack_protect_string("8"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('9') => control_list_estudiantes_pack_protect_string("9"));
$aLookup[] = array(control_list_estudiantes_pack_protect_string('10') => control_list_estudiantes_pack_protect_string("10"));
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['Lookup_celdas_vacias'][] = '10';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['celdas_vacias']['valList'][$i] = control_list_estudiantes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->nm_formatar_campos();
    include_once("control_list_estudiantes_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['sc_outra_jan'])
   {
       $nmgp_saida_form = "control_list_estudiantes_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['nm_run_menu'] = 2;
       $nmgp_saida_form = "control_list_estudiantes_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['masterValue'] as $cmp_master => $val_master)
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_list_estudiantes']['retorno_edit'] = "";
   }
