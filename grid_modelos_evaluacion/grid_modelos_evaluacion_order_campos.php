<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_modelos_evaluacion_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_modelos_evaluacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['labels']["id_modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['labels']["id_modelo"] : "Id Modelo";
   $tab_ger_campos['modelo'] = "on";
   $tab_def_campos['modelo'] = "modelo";
   $tab_converte["modelo"]   = "modelo";
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['labels']["modelo"] : "Modelo";
   $tab_ger_campos['documento'] = "on";
   $tab_def_campos['documento'] = "documento";
   $tab_converte["documento"]   = "documento";
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['labels']["documento"] : "Documento";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_modelos_evaluacion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_modelos_evaluacion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
