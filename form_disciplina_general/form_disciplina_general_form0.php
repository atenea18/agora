<?php
class form_disciplina_general_form extends form_disciplina_general_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['embutida_pdf']))
 {
 ?>
<?php
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_disciplina_general/form_disciplina_general_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_disciplina_general_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_disciplina_general_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['recarga'];
}
...
<?php
 include_once("form_disciplina_general_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_disciplina_general'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_disciplina_general'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   ...
   <?php if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['pdf_view'] && $this->Embutida_form && $this->nmgp_botoes['insert'] == "on") {?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['dc12_']) && $this->nmgp_cmp_hidden['dc12_'] == 'off') { $sStyleHidden_dc12_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['dc12_'])) {
          $this->nm_new_label['dc12_'] = "Dc 12"; } ?>

    <TD class="scFormLabelOddMult css_dc12__label" id="hidden_field_label_dc12_" style="white-space:nowrap;<?php echo $sStyleHidden_dc12_; ?>" > <?php echo $this->nm_new_label['dc12_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_disciplina_general);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_disciplina_general = $this->form_vert_form_disciplina_general;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_disciplina_general))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_disciplina_general as $sc_seq_vert => $sc_lixo)
   {
       $this->primer_apellido_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['primer_apellido_'];
       $this->segundo_apellido_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['segundo_apellido_'];
       $this->primer_nombre_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['primer_nombre_'];
       $this->segundo_nombre_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['segundo_nombre_'];
       $this->id_grupo_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_grupo_'];
       $this->id_area_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_area_'];
       $this->id_asignatura_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_asignatura_'];
       $this->id_grado_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_grado_'];
       $this->id_nivel_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_nivel_'];
       $this->ihs_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ihs_'];
       $this->pfa_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pfa_'];
       $this->tipo_asig_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['tipo_asig_'];
       $this->inasistencia_p1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['inasistencia_p1_'];
       $this->dc1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc1_'];
       $this->dc2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc2_'];
       $this->dc3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc3_'];
       $this->dc4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc4_'];
       $this->dc5_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc5_'];
       $this->dc6_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc6_'];
       $this->dc7_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc7_'];
       $this->dc8_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc8_'];
       $this->dc9_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc9_'];
       $this->dc10_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc10_'];
       $this->dc11_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc11_'];
       $this->letras_p1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['letras_p1_'];
       $this->pcent_dc_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dc_'];
       $this->ds1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds1_'];
       $this->ds2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds2_'];
       $this->ds3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds3_'];
       $this->ds4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds4_'];
       $this->ds5_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds5_'];
       $this->pcent_ds_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_ds_'];
       $this->dp1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp1_'];
       $this->dp2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp2_'];
       $this->dp3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp3_'];
       $this->dp4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp4_'];
       $this->dp5_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp5_'];
       $this->pcent_dp_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dp_'];
       $this->aeep1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['aeep1_'];
       $this->porcent_aeep1_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['porcent_aeep1_'];
       $this->inasistencia_p2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['inasistencia_p2_'];
       $this->eval_2_per_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['eval_2_per_'];
       $this->dc1_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc1_2p_'];
       $this->dc2_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc2_2p_'];
       $this->dc3_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc3_2p_'];
       $this->dc4_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc4_2p_'];
       $this->dc5_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc5_2p_'];
       $this->pcent_dc2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dc2_'];
       $this->ds1_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds1_2p_'];
       $this->ds2_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds2_2p_'];
       $this->ds3_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds3_2p_'];
       $this->ds4_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds4_2p_'];
       $this->ds5_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds5_2p_'];
       $this->pcent_ds2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_ds2_'];
       $this->dp1_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp1_2p_'];
       $this->dp2_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp2_2p_'];
       $this->dp3_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp3_2p_'];
       $this->dp4_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp4_2p_'];
       $this->dp5_2p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp5_2p_'];
       $this->pcent_dp2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dp2_'];
       $this->aee_p2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['aee_p2_'];
       $this->letras_p2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['letras_p2_'];
       $this->porcet_aee_p2_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['porcet_aee_p2_'];
       $this->inasistencia_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['inasistencia_p3_'];
       $this->eval_3_per_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['eval_3_per_'];
       $this->dc1_3p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc1_3p_'];
       $this->dc2_3p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc2_3p_'];
       $this->dc3_3p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc3_3p_'];
       $this->dc4_3p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc4_3p_'];
       $this->dc5_3p_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc5_3p_'];
       $this->pcent_dc3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dc3_'];
       $this->ds1_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds1_p3_'];
       $this->ds2_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds2_p3_'];
       $this->ds3_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds3_p3_'];
       $this->ds4_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds4_p3_'];
       $this->ds5_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds5_p3_'];
       $this->pcent_ds3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_ds3_'];
       $this->dp1_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp1_p3_'];
       $this->dp2_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp2_p3_'];
       $this->dp3_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp3_p3_'];
       $this->dp4_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp4_p3_'];
       $this->sc_field_0_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['sc_field_0_'];
       $this->pcent_dp3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dp3_'];
       $this->aee_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['aee_p3_'];
       $this->letras_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['letras_p3_'];
       $this->porcent_aee_p3_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['porcent_aee_p3_'];
       $this->inasistencia_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['inasistencia_p4_'];
       $this->eval_4_per_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['eval_4_per_'];
       $this->dc1_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc1_p4_'];
       $this->dc2_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc2_p4_'];
       $this->dc3_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc3_p4_'];
       $this->dc4_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc4_p4_'];
       $this->dc5_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc5_p4_'];
       $this->pcent_dc4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dc4_'];
       $this->ds1_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds1_p4_'];
       $this->ds2_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds2_p4_'];
       $this->ds3_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds3_p4_'];
       $this->ds4_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds4_p4_'];
       $this->ds5_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['ds5_p4_'];
       $this->pcent_ds4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_ds4_'];
       $this->dp1_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp1_p4_'];
       $this->dp2_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp2_p4_'];
       $this->dp3_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp3_p4_'];
       $this->dp4_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp4_p4_'];
       $this->dp5_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dp5_p4_'];
       $this->aee_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['aee_p4_'];
       $this->letras_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['letras_p4_'];
       $this->porcent_aee_p4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['porcent_aee_p4_'];
       $this->pcent_dp4_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['pcent_dp4_'];
       $this->eval_final_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['eval_final_'];
       $this->entorno_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['entorno_'];
       $this->estudiantes_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['estudiantes_'];
       $this->id_novedad_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_novedad_'];
       $this->nom_grupo_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['nom_grupo_'];
       $this->val_acumulada_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['val_acumulada_'];
       $this->val_requerida_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['val_requerida_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_estudiante_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['id_estudiante_']; 
       ...
       $this->estatus_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['estatus_']; 
       ...
       $this->novedad_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['novedad_']; 
       ...
       $this->eval_1_per_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['eval_1_per_']; 
       ...
       $this->dc12_ = $this->form_vert_form_disciplina_general[$sc_seq_vert]['dc12_']; 
       $dc12_ = $this->dc12_; 
       $sStyleHidden_dc12_ = '';
...
?>   
   ...
   <?php if ($this->Embutida_form && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['pdf_view']) {?>
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_disciplina_general_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_disciplina_general_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_disciplina_general_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_disciplina_general_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_disciplina_general_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_disciplina_general_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_dc12_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dc12_<?php echo $sc_seq_vert ?> css_dc12__line" style="<?php echo $sStyleReadLab_dc12_; ?>"><?php echo $this->form_encode_input($this->dc12_); ?></span><span id="id_read_off_dc12_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dc12_; ?>">
 ...
 size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['dc12_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['dc12_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dc12_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dc12_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_disciplina_general = $guarda_form_vert_form_disciplina_general;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_disciplina_general']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_disciplina_general");
 parent.scAjaxDetailHeight("form_disciplina_general", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
