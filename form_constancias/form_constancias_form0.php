...
<?php
include_once("form_constancias_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_constancias_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['recarga'];
}
?>
...
<?php
 include_once("form_constancias_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_constancias'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_constancias'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['fast_search'][2] : "";
?> 
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_t", "", "Imprimir", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['Lookup_tipo_impresion'][] = 'null'; ?>
 <option value="null">Seleccione</option>
 <option value="1" <?php  if ($this->tipo_impresion == "1") { echo " selected" ;} ?>>Por Grado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['Lookup_tipo_impresion'][] = '1'; ?>
 <option value="2" <?php  if ($this->tipo_impresion == "2") { echo " selected" ;} ?>>Por Grupo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['Lookup_tipo_impresion'][] = '2'; ?>
 <option value="3" <?php  if ($this->tipo_impresion == "3") { echo " selected" ;} ?>>Por Estudiante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['Lookup_tipo_impresion'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_constancias']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_constancias");
 parent.scAjaxDetailHeight("form_constancias", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
