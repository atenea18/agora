...
<?php
include_once("form_t_grupos_taller_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_t_grupos_taller_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['recarga'];
}
?>
...
<?php
 include_once("form_t_grupos_taller_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_t_grupos_taller_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_t_grupos_taller_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_t_grupos_taller_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_t_grupos_taller_mob_form0";
</script>
<ul class="scTabLine">
<?php
    if ($nmgp_num_form == "form_t_grupos_taller_mob_form0")
    {
...
?>
   <li id="id_form_t_grupos_taller_mob_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_t_grupos_taller_mob_form0')">
     Datos Grupo
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_t_grupos_taller_mob_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_t_grupos_taller_mob_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_t_grupos_taller_mob_form1')">
...
<div id="form_t_grupos_taller_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['Lookup_modalidad'][] = 'A'; ?>
 <option value="T" <?php  if ($this->modalidad == "T") { echo " selected" ;} ?>>Técnico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['Lookup_modalidad'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['Lookup_calendario'][] = 'A'; ?>
 <option value="B" <?php  if ($this->calendario == "B") { echo " selected" ;} ?>>B</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller_mob']['Lookup_calendario'][] = 'B'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_num_estudiantes_grupo_line" id="hidden_field_data_num_estudiantes_grupo" style="<?php echo $sStyleHidden_num_estudiantes_grupo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_num_estudiantes_grupo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_num_estudiantes_grupo_label"><span id="id_label_num_estudiantes_grupo"><?php echo $this->nm_new_label['num_estudiantes_grupo']; ?></span></span><br><input type="hidden" name="num_estudiantes_grupo" value="<?php echo $this->form_encode_input($num_estudiantes_grupo); ?>"><span id="id_ajax_label_num_estudiantes_grupo"><?php echo nl2br($num_estudiantes_grupo); ?></span>
...
<?php $sStyleHidden_num_estudiantes_grupo_dumb = ('' == $sStyleHidden_num_estudiantes_grupo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_num_estudiantes_grupo_dumb" style="<?php echo $sStyleHidden_num_estudiantes_grupo_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
