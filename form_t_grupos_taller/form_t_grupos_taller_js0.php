...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_grupos_taller"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var var_btn_sc_btn_1_par_id_grupo = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_grupo']); ?>";
var var_btn_sc_btn_1_par_id_grado = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_grado']); ?>";
function sc_btn_sc_btn_1()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_blank_copia_pensum; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "par_id_grupo?#?' + var_btn_sc_btn_1_par_id_grupo + '?@?par_id_grado?#?' + var_btn_sc_btn_1_par_id_grado + '?@?"; ?>', '', '_self', '0', '0', 'blank_copia_pensum');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_grupos_taller']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_t_grupos_taller_form0').style.width='1px';
    document.getElementById('form_t_grupos_taller_form0').style.height='0px';
    document.getElementById('form_t_grupos_taller_form0').style.display='none';
    document.getElementById('form_t_grupos_taller_form0').style.overflow='scroll';
    document.getElementById('form_t_grupos_taller_form1').style.width='1px';
    document.getElementById('form_t_grupos_taller_form1').style.height='0px';
    document.getElementById('form_t_grupos_taller_form1').style.display='none';
    document.getElementById('form_t_grupos_taller_form1').style.overflow='scroll';
   ...
   if ("form_t_grupos_taller_form1" == N_pagina) {
