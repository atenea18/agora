<?php
class form_actividades_est_form extends form_actividades_est_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags(" actividades Indicadfor de Desempeño"); } else { echo strip_tags("ctividades Indicadfor de Desempeño"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_actividades_est/form_actividades_est_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_actividades_est_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_actividades_est_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['recarga'];
}
...
<?php
 include_once("form_actividades_est_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_actividades_est'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_actividades_est'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['mostra_cab'] != "N"))
  {
?>
<tr><td>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scFormHeaderFont">
          <?php if ($this->nmgp_opcao == "novo") { echo " actividades Indicadfor de Desempeño"; } else { echo "ctividades Indicadfor de Desempeño"; } ?>
        </TD>
       ...
       <TR valign="middle">
        <TD align="left" class="scFormHeaderFont">
          <?php echo "" . $_SESSION['par_des_superior'] . "" ?>
        </TD>
        <TD style="font-size: 5px">
          &nbsp; &nbsp;
        </TD>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['fast_search'][2] : "";
?> 
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_actividades_est_add_new_line(); return false;", "do_ajax_form_actividades_est_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<?php
   if (!isset($this->nmgp_cmp_hidden['id_actividad_']))
   {
       $this->nmgp_cmp_hidden['id_actividad_'] = 'off';
   }
...
<?php
 ...
 ?>
   ...
   <?php if ($this->Embutida_form && $this->nmgp_botoes['insert'] != "on") {?>
    <TD class="scFormLabelOddMult"  width="10"> &nbsp; </TD>
   <?php }?>
   <?php if ((!isset($this->nmgp_cmp_hidden['id_actividad_']) || $this->nmgp_cmp_hidden['id_actividad_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
      if (!isset($this->nm_new_label['id_actividad_'])) {
          $this->nm_new_label['id_actividad_'] = "Id Actividad"; } ?>

    <TD class="scFormLabelOddMult css_id_actividad__label" id="hidden_field_label_id_actividad_" style="<?php echo $sStyleHidden_id_actividad_; ?>" > <?php echo $this->nm_new_label['id_actividad_'] ?> </TD>
   <?php }?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['porcentaje_']) && $this->nmgp_cmp_hidden['porcentaje_'] == 'off') { $sStyleHidden_porcentaje_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult css_porcentaje__label" id="hidden_field_label_porcentaje_" style="<?php echo $sStyleHidden_porcentaje_; ?>" > <?php echo $this->nm_new_label['porcentaje_'] ?> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_actividades_est);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_actividades_est = $this->form_vert_form_actividades_est;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_actividades_est))
   {
       $sc_seq_vert = 0;
   }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_actividad_']))
           {
               $this->nmgp_cmp_readonly['id_actividad_'] = 'on';
           }
   foreach ($this->form_vert_form_actividades_est as $sc_seq_vert => $sc_lixo)
   {
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           $this->nmgp_cmp_readonly['id_actividad_'] = true;
       ...
       elseif ($Line_Add)
       {
           if (!isset($this->nmgp_cmp_readonly['id_actividad_']) || $this->nmgp_cmp_readonly['id_actividad_'] != "on") {$this->nmgp_cmp_readonly['id_actividad_'] = false;}
        ...
        $this->id_actividad_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['id_actividad_']; 
       $id_actividad_ = $this->id_actividad_; 
       if (!isset($this->nmgp_cmp_hidden['id_actividad_']))
       {
           $this->nmgp_cmp_hidden['id_actividad_'] = 'off';
       }
       $sStyleHidden_id_actividad_ = '';
       if (isset($sCheckRead_id_actividad_))
       {
           unset($sCheckRead_id_actividad_);
       }
       if (isset($this->nmgp_cmp_readonly['id_actividad_']))
       {
           $sCheckRead_id_actividad_ = $this->nmgp_cmp_readonly['id_actividad_'];
       }
       if (isset($this->nmgp_cmp_hidden['id_actividad_']) && $this->nmgp_cmp_hidden['id_actividad_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['id_actividad_']);
           $sStyleHidden_id_actividad_ = 'display: none;';
       }
       $bTestReadOnly_id_actividad_ = true;
       $sStyleReadLab_id_actividad_ = 'display: none;';
       $sStyleReadInp_id_actividad_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_actividad_"]) &&  $this->nmgp_cmp_readonly["id_actividad_"] == "on"))
       {
           $bTestReadOnly_id_actividad_ = false;
           unset($this->nmgp_cmp_readonly['id_actividad_']);
           $sStyleReadLab_id_actividad_ = '';
           $sStyleReadInp_id_actividad_ = 'display: none;';
       }
       $this->actividad_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['actividad_']; 
       ...
       $this->codigo_desemp_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['codigo_desemp_']; 
       ...
       $this->posicion_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['posicion_']; 
       ...
       $this->id_asignatura_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['id_asignatura_']; 
       ...
       $this->id_grupo_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['id_grupo_']; 
       ...
       $this->id_estudent_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['id_estudent_']; 
       ...
       $this->eval_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['eval_']; 
       $eval_ = $this->eval_; 
       $sStyleHidden_eval_ = '';
       ...
       $this->porcentaje_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['porcentaje_']; 
       ...
       $this->entorno_ = $this->form_vert_form_actividades_est[$sc_seq_vert]['entorno_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_actividades_est_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_actividades_est_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_actividades_est_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_actividades_est_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_actividades_est_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_actividades_est_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['id_actividad_']) && $this->nmgp_cmp_hidden['id_actividad_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="id_actividad_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($id_actividad_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>

    <TD class="scFormDataOddMult css_id_actividad__line" id="hidden_field_data_id_actividad_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_id_actividad_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_id_actividad__line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_actividad_<?php echo $sc_seq_vert ?>" class="css_id_actividad__line" style="<?php echo $sStyleReadLab_id_actividad_; ?>"><?php echo $this->form_encode_input($this->id_actividad_); ?></span><span id="id_read_off_id_actividad_<?php echo $sc_seq_vert ?>" style="<?php echo $sStyleReadInp_id_actividad_; ?>"><input type="hidden" id="id_sc_field_id_actividad_<?php echo $sc_seq_vert ?>" name="id_actividad_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($id_actividad_) . "\">"?><span id="id_ajax_label_id_actividad_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($id_actividad_); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_actividad_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_actividad_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
<?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_codigo_desemp__line" id="hidden_field_data_codigo_desemp_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_codigo_desemp_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_codigo_desemp__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="codigo_desemp_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($codigo_desemp_); ?>"><span id="id_ajax_label_codigo_desemp_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($codigo_desemp_); ?></span>
...
<?php if ($bTestReadOnly_posicion_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["posicion_"]) &&  $this->nmgp_cmp_readonly["posicion_"] == "on") { 
 ...
 ?>
<input type="hidden" name="posicion_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($posicion_) . "\">" . $posicion_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_posicion_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-posicion_<?php echo $sc_seq_vert ?> css_posicion__line" style="<?php echo $sStyleReadLab_posicion_; ?>"><?php echo $this->form_encode_input($this->posicion_); ?></span><span id="id_read_off_posicion_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_posicion_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_posicion__obj" style="" id="id_sc_field_posicion_<?php echo $sc_seq_vert ?>" type=text name="posicion_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($posicion_) ?>"
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_id_estudent__line" id="hidden_field_data_id_estudent_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_id_estudent_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_id_estudent__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="id_estudent_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($id_estudent_); ?>"><span id="id_ajax_label_id_estudent_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($id_estudent_); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_porcentaje__line" id="hidden_field_data_porcentaje_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_porcentaje_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_porcentaje__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="porcentaje_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($porcentaje_); ?>"><span id="id_ajax_label_porcentaje_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($porcentaje_); ?></span>
...
<?php   
        if (isset($sCheckRead_id_actividad_))
       {
           $this->nmgp_cmp_readonly['id_actividad_'] = $sCheckRead_id_actividad_;
       }
       if ('display: none;' == $sStyleHidden_id_actividad_)
       {
           $this->nmgp_cmp_hidden['id_actividad_'] = 'off';
       }
       if (isset($sCheckRead_actividad_))
   ...
   { 
       ...
       $this->form_vert_form_actividades_est = $guarda_form_vert_form_actividades_est;
   } 
   if ($Table_refresh) 
   { 
...
<?php 
              $obj_sel = ($this->sc_max_reg == '4') ? " selected" : "";
?> 
           <option value="4" <?php echo $obj_sel ?>>4</option>
<?php 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_actividades_est']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_actividades_est");
 parent.scAjaxDetailHeight("form_actividades_est", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
