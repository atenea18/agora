...
<html>
    <head>
        ...
        <title> [par_nombre_institucion]</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_docentes"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>para_login/para_login_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>para_login/para_login_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        <script src="<?php echo $_SESSION["scriptcase"]["menu_docentes"]["glo_nm_path_prod"]; ?>/third/jquery/js/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_docentes"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    </head>
    <body>
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($menu_docentes_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
