<?php
include_once('menu_docentes_session.php');
session_start();
...
else
{
    ...
    $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] = "";
    $_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil']    = "conn_mysql";
    $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] = "";

ob_start();

class menu_docentes_class
{
  var $Db;
 ...
 function menu_docentes_menu()
 {
    global $menu_docentes_menuData;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_docentes']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_docentes/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_docentes');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_docentes_erro.php");
}
include_once(dirname(__FILE__) . "/menu_docentes_erro.class.php"); 
$this->Erro = new menu_docentes_erro();
$str_path = substr($_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_docentes_menuData         = array();
$menu_docentes_menuData['path'] = array();
$menu_docentes_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_docentes_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_docentes_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_docentes_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_docentes_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_docentes_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_docentes_menuData['url']['web']   = str_replace("\\", '/', $menu_docentes_menuData['url']['web']);
$menu_docentes_menuData['path']['root'] = substr($menu_docentes_menuData['path']['sys'],  0, -1 * strlen($menu_docentes_menuData['url']['web']));
$menu_docentes_menuData['path']['app']  = substr($menu_docentes_menuData['path']['sys'],  0, strrpos($menu_docentes_menuData['path']['sys'],  '/'));
$menu_docentes_menuData['path']['link'] = substr($menu_docentes_menuData['path']['app'],  0, strrpos($menu_docentes_menuData['path']['app'],  '/'));
$menu_docentes_menuData['path']['link'] = substr($menu_docentes_menuData['path']['link'], 0, strrpos($menu_docentes_menuData['path']['link'], '/')) . '/';
$menu_docentes_menuData['path']['app'] .= '/';
$menu_docentes_menuData['url']['app']   = substr($menu_docentes_menuData['url']['web'],  0, strrpos($menu_docentes_menuData['url']['web'],  '/'));
$menu_docentes_menuData['url']['link']  = substr($menu_docentes_menuData['url']['app'],  0, strrpos($menu_docentes_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] == "S")
{
    $menu_docentes_menuData['url']['link']  = substr($menu_docentes_menuData['url']['link'], 0, strrpos($menu_docentes_menuData['url']['link'], '/'));
}
$menu_docentes_menuData['url']['link']  .= '/';
$menu_docentes_menuData['url']['app']   .= '/';
...
include_once("menu_docentes_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_docentes";
     $_SESSION['scriptcase']['menu_apls']['menu_docentes'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_docentes']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_docentes']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_docentes']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_docentes']['init']))
{
    $_SESSION['sc_session'][1]['menu_docentes']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_docentes']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_docentes'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_docentes'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_docentes'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "para_login/para_login";
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_docentes'] = "on";
} 
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_docentes']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_docentes'] != "on")
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'], 'agora_IV', 2); 
}
if (isset($_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_docentes']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_docentes']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_docentes']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_docentes']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_docentes']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_docentes']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_docentes']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_docentes']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'], 'agora_IV'); 
} 
else 
{ 
...
//
      $_SESSION['scriptcase']['menu_docentes']['contr_erro'] = 'on';
if (!isset($_SESSION['par_id_director_grupo'])) {$_SESSION['par_id_director_grupo'] = "";}
...
if (!isset($_SESSION['par_periodo'])) {$_SESSION['par_periodo'] = "";}
if (!isset($this->sc_temp_par_periodo)) {$this->sc_temp_par_periodo = (isset($_SESSION['par_periodo'])) ? $_SESSION['par_periodo'] : "";}
if (!isset($_SESSION['par_cierre'])) {$_SESSION['par_cierre'] = "";}
if (!isset($this->sc_temp_par_cierre)) {$this->sc_temp_par_cierre = (isset($_SESSION['par_cierre'])) ? $_SESSION['par_cierre'] : "";}
if (!isset($_SESSION['par_apertura'])) {$_SESSION['par_apertura'] = "";}
if (!isset($this->sc_temp_par_apertura)) {$this->sc_temp_par_apertura = (isset($_SESSION['par_apertura'])) ? $_SESSION['par_apertura'] : "";}
...
$check_sql = "SELECT apertura, cierre, periodos"
   . " FROM periodos "
   . " WHERE now() BETWEEN apertura AND cierre";
...
if (isset($this->rs[0][0]))     
{
    $this->sc_temp_par_apertura =  $this->rs[0][0];
    $this->sc_temp_par_cierre = $this->rs[0][1];	
	$this->sc_temp_par_periodo=   $this->rs[0][2];	
}
		else     
{
    $this->sc_temp_par_apertura = '';
    $this->sc_temp_par_cierre = '';
...
if (isset($this->rs[0][0]))     
{
    $this->sc_temp_par_id_director_grupo = $this->rs[0][0];
    
}
		else     
{
		    $this->sc_temp_par_id_director_grupo = '';
   
}
if (isset($this->sc_temp_usr_login)) {$_SESSION['usr_login'] = $this->sc_temp_usr_login;}
if (isset($this->sc_temp_name)) {$_SESSION['name'] = $this->sc_temp_name;}
if (isset($this->sc_temp_par_apertura)) {$_SESSION['par_apertura'] = $this->sc_temp_par_apertura;}
if (isset($this->sc_temp_par_cierre)) {$_SESSION['par_cierre'] = $this->sc_temp_par_cierre;}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_docentes'))
{
    $_SESSION['sc_session'][1]['menu_docentes']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_docentes'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_docentes_menuData['iframe'] = TRUE;
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_observ_generales_periodo") . "/grid_observ_generales_periodo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_observ_generales_periodo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_observ_generales_periodo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_informe_general_periodo") . "/grid_informe_general_periodo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_informe_general_periodo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_informe_general_periodo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_grupo_x_asig_x_doce_p_eval") . "/grid_grupo_x_asig_x_doce_p_eval_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo_x_asig_x_doce_p_eval']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_grupo_x_asig_x_doce_p_eval'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "Observaciones Generales";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Informe General del Periodo";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Evaluaciones Generales";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_docentes'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['dashboard']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_56|.|" . $nm_var_lab[0] . "|menu_docentes_form_php.php?sc_item_menu=item_56&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_docentes_target('_self') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_56|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_observ_generales_periodo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_observ_generales_periodo']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_57|.|" . $nm_var_lab[1] . "|menu_docentes_form_php.php?sc_item_menu=item_57&sc_apl_menu=grid_observ_generales_periodo&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_docentes_target('_self') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_57|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_informe_general_periodo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_informe_general_periodo']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_58|.|" . $nm_var_lab[2] . "|menu_docentes_form_php.php?sc_item_menu=item_58&sc_apl_menu=grid_informe_general_periodo&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_docentes_target('_self') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_58|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo_x_asig_x_doce_p_eval']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo_x_asig_x_doce_p_eval']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_53|.|" . $nm_var_lab[3] . "|menu_docentes_form_php.php?sc_item_menu=item_53&sc_apl_menu=grid_grupo_x_asig_x_doce_p_eval&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_docentes_target('_self') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_53|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_t_grupos_5']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_t_grupos_5']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_59|..|" . $nm_var_lab[4] . "|menu_docentes_form_php.php?sc_item_menu=item_59&sc_apl_menu=grid_t_grupos_5&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_docentes_target('_self') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_59|..|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
$menu_docentes_menuData['data'] .= "item_54|.|" . $nm_var_lab[5] . "||" . $nm_var_hint[5] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_55|.|" . $this->Nm_lang['lang_change_pswd'] . "|menu_docentes_form_php.php?sc_item_menu=item_55&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_docentes_target('_self') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_55|.|" . $this->Nm_lang['lang_change_pswd'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_docentes_menuData['data'] .= "item_36|.|" . $this->Nm_lang['lang_exit'] . "|menu_docentes_form_php.php?sc_item_menu=item_36&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_docentes_target('_parent') . "|" . "\n";
}
else
{
    $menu_docentes_menuData['data'] .= "item_36|.|" . $this->Nm_lang['lang_exit'] . "||||_parent|disabled\n";
}

$menu_docentes_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_56&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['dashboard']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_docentes_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_docentes_target('_self') . "\"",
        'sc_id'    => "item_56",
        'disabled' => $str_disabled,
    );
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_57&sc_apl_menu=grid_observ_generales_periodo&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_observ_generales_periodo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_observ_generales_periodo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_58&sc_apl_menu=grid_informe_general_periodo&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_informe_general_periodo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_informe_general_periodo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_53&sc_apl_menu=grid_grupo_x_asig_x_doce_p_eval&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo_x_asig_x_doce_p_eval']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo_x_asig_x_doce_p_eval']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_59&sc_apl_menu=grid_t_grupos_5&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_t_grupos_5']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_t_grupos_5']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_55&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_docentes_form_php.php?sc_item_menu=item_36&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_docentes_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_docentes_target('_parent') . "\"",
        'sc_id'    => "item_36",
        'disabled' => $str_disabled,
    );

if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_docentes']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_docentes']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_docentes');
    $menu_docentes_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_docentes_help.txt"))
{
    $Arq_WebHelp = file("menu_docentes_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_docentes_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_docentes_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_docentes']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_docentes']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_docentes_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_docentes']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_docentes_menuData['data'][$i_menu]);
       }
    ...
    $menu_docentes_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_docentes']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_docentes']))
{
    $disable_menu = false;
    foreach ($menu_docentes_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_docentes']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_docentes_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_docentes_menuData['iframe'])
{
    $menu_docentes_menuData['height'] = '100%';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
{
    $menu_docentes_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_docentes']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
Iframe_atual = "menu_docentes_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_docentes\";\r\n";
echo "Tab_labels['menu_docentes'] = \"\";\r\n";
echo "Tab_hints['menu_docentes'] = \"\";\r\n";
echo "Tab_icons['menu_docentes'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_docentes'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_abas['menu_docentes']   = \"none\";\r\n";
echo "Tab_refresh['menu_docentes']   = \"\";\r\n";
         $seq++;
 foreach ($menu_docentes_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_docentes_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    tmp += "</div>";
    var home_style="";
    if(str_id === 'menu_docentes'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_docentes').css('display','none');
    if (str_id == "")
    {
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            Iframe_atual = "menu_docentes_" + Tab_iframes[i] + '_iframe';
        } else {
...
{
    str_target_sv = "";
    if (str_id != "iframe_menu_docentes")
    {
        str_target_sv = str_id + "_iframe";
        str_id        = str_id.replace("menu_docentes_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    str_id = str_id.replace('iframe_menu_docentes', 'menu_docentes');
    if (str_target == "menu_docentes_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_docentes")
        {
            $('#links_abas').css('display','');
        }
        if (str_id != "menu_docentes" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    <TR align="center">
     <TD style="padding: 0px">
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       ...
       <TR valign="middle">
        <TD align="left" class="scMenuHHeaderFont">
          <?php echo "Fecha de Apertura del Período:  " . $_SESSION['par_apertura'] . "" ?>
        </TD>
        <TD style="font-size: 5px">
          &nbsp; &nbsp;
        </TD>
        <TD align="center" class="scMenuHHeaderFont">
          <?php echo "Fecha de Cierre del Periodo:  " . $_SESSION['par_cierre'] . "" ?>
        </TD>
        <TD style="font-size: 5px">
          &nbsp; &nbsp;
        </TD>
...
<div id="idDivMenu">
<?php
echo $this->menu_docentes_escreveMenu($menu_docentes_menuData['data']);
?>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_docentes_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_docentes');\" item-href=\"menu_docentes_form_php.php?sc_item_menu=menu_docentes&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_docentes_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_docentes_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_docentes" name="menu_docentes_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($menu_docentes_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_docentes_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_docentes').click()";
    echo "</script>";
}
...
/* Control de Target */
function menu_docentes_escreveMenu($arr_menu)
{
    $last      = '';
    $itemClass = ' topfirst';
    $subSize   = 2;
...
function menu_docentes_target($str_target)
{
    global $menu_docentes_menuData;
    ...
    elseif ($menu_docentes_menuData['iframe'])
    {
        return 'menu_docentes_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_docentes_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_docentes_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_docentes_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_docentes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_docentes']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_docentes_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        if (!isset($_SESSION['scriptcase']['menu_docentes']['sc_init'][$apl_menu]))
        {
            $_SESSION['scriptcase']['menu_docentes']['sc_init'][$apl_menu] = rand(2, 10000);
        }
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_docentes']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_docentes']['sc_init'][$apl_menu];
   }
...
$contr_menu_docentes = new menu_docentes_class;
$contr_menu_docentes->menu_docentes_menu();
