<?php
class pdfreport_grado_matricula_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_grado_matricula']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_grado_matricula", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['idstudents'] = "Idstudents";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['id_sede'] = "Id Sede";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['id_jornada'] = "Id Jornada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['semestre'] = "Semestre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['estatus'] = "Estatus";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['fecha_matricula'] = "Fecha Matricula";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['tipo_identificacion'] = "Tipo Identificacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['numero_documento'] = "Numero Documento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['departanebti_expedicion'] = "Departanebti Expedicion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['municipio_expedicion'] = "Municipio Expedicion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['primer_nombre'] = "Primer Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['segundo_nombre'] = "Segundo Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['primer_apellido'] = "Primer Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['segundo_apellido'] = "Segundo Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['firstname'] = "Firstname";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['lastname'] = "Lastname";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['genero'] = "Genero";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['fecha_nacimiento'] = "Fecha Nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['anos_cumplidos'] = "Anos Cumplidos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['dpto_nacimiento'] = "Dpto Nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['municipio_nacimiento'] = "Municipio Nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['address'] = "Address";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['barrio'] = "Barrio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['zona'] = "Zona";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['city'] = "City";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['state'] = "State";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['telefono'] = "Telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['grado_anterior'] = "Grado Anterior";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['last_year'] = "Last Year";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['nombre_ult_plantel'] = "Nombre Ult Plantel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['resultado'] = "Resultado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['grado_igreso'] = "Grado Igreso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['id_nivel'] = "Id Nivel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['subsidado'] = "Subsidado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['interno'] = "Interno";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['id_grupo'] = "Id Grupo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['otro_modelo'] = "Otro Modelo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['caracter'] = "Caracter";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['especialidad'] = "Especialidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['anyo_mat'] = "anyo_mat";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['anyo_nacimiento'] = "anyo_nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['aprobado'] = "aprobado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['caracter_acad'] = "caracter_acad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['caracter_tec'] = "caracter_tec";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['cero'] = "cero";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['cinco'] = "cinco";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['continuidad'] = "continuidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['cuatro'] = "cuatro";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['desertor'] = "desertor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['dia_mat'] = "dia_mat";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['dia_nacimiento'] = "dia_nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['diez'] = "diez";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['directtor_grupo'] = "directtor_grupo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['documento_docente_dg'] = "documento_docente_dg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['dos'] = "dos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['esp_agropec'] = "esp_agropec";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['esp_comercial'] = "esp_comercial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['esp_normalista'] = "esp_normalista";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['esp_turismo'] = "esp_turismo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['est_educativo'] = "est_educativo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['gen_femenino'] = "gen_femenino";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['gen_masculino'] = "gen_masculino";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['idmunicipio'] = "idmunicipio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['institucion_educ'] = "institucion_educ";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['interno_no'] = "interno_no";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['interno_si'] = "interno_si";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['logo'] = "logo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['mes_mat'] = "mes_mat";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['mes_nacimiento'] = "mes_nacimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['n_basica_prim'] = "n_basica_prim";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['n_basica_secund'] = "n_basica_secund";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['n_preescolar'] = "n_preescolar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['nombre_docente_dg'] = "nombre_docente_dg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['nueve'] = "nueve";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['nuevo'] = "nuevo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['ocho'] = "ocho";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['once'] = "once";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['otro_modelo_aceleracion'] = "otro_modelo_aceleracion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['otro_modelo_n1'] = "otro_modelo_n1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['otro_modelo_n2'] = "otro_modelo_n2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['reprobado'] = "reprobado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['seis'] = "seis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['siete'] = "siete";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['subsidio_no'] = "subsidio_no";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['subsidio_si'] = "subsidio_si";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['ti_cc'] = "ti_cc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['ti_ce'] = "ti_ce";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['ti_rc'] = "ti_rc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['ti_ti'] = "ti_ti";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['tres'] = "tres";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['uno'] = "uno";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['zona_rural'] = "zona_rural";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['labels']['zona_urbana'] = "zona_urbana";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_grado_matricula']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_grado_matricula']['qt_col_grid']) 
      {  
