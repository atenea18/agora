<?php
class pdfreport_constacia_grupo_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_constacia_grupo']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_constacia_grupo", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['idstudents'] = "Idstudents";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['id_sede'] = "Id Sede";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['id_jornada'] = "Id Jornada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['semestre'] = "Semestre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['tipo_identificacion'] = "Tipo Identificacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['numero_documento'] = "Numero Documento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['primer_nombre'] = "Primer Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['segundo_nombre'] = "Segundo Nombre";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['primer_apellido'] = "Primer Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['segundo_apellido'] = "Segundo Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['grado_igreso'] = "Grado Igreso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['id_grupo'] = "Id Grupo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['cadena_principal'] = "cadena_principal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['cadena_principal_1'] = "cadena_principal_1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['cadena_secundaria'] = "cadena_secundaria";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['cargo_pri_firma'] = "cargo_pri_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['cargo_seg_firma'] = "cargo_seg_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['cod_dane'] = "cod_dane";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['direccion'] = "direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['encabezado'] = "encabezado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['especialidad'] = "especialidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['logo'] = "logo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['municipio'] = "municipio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['nit'] = "nit";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['nombre_institucion'] = "nombre_institucion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['pie_pagina'] = "pie_pagina";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['primera_firma'] = "primera_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['segunda_firma'] = "segunda_firma";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['labels']['telefonos'] = "telefonos";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_constacia_grupo']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_constacia_grupo']['qt_col_grid']) 
      {  
