...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_desem_notas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_desem_notas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_desem_notas']['embutida_filho'] as $ind => $sc_init)
          {
