<?php
//
class form_evalua_actividad_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['dc1']))
          {
              $this->dc1 = $this->NM_ajax_info['param']['dc1'];
          }
      ...
      if (isset($this->etiqueta_grupo1dc) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['etiqueta_grupo1dc'] = $this->etiqueta_grupo1dc;
      }
      if (isset($this->etiqueta_grupo2dp) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['etiqueta_grupo2dp'] = $this->etiqueta_grupo2dp;
      }
      if (isset($this->etiqueta_grupo3ds) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['etiqueta_grupo3ds'] = $this->etiqueta_grupo3ds;
      }
      if (isset($this->activa_dc1) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dc1'] = $this->activa_dc1;
      }
      if (isset($this->activa_dc2) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dc2'] = $this->activa_dc2;
      }
      if (isset($this->activa_dc3) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dc3'] = $this->activa_dc3;
      }
      if (isset($this->activa_dc4) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dc4'] = $this->activa_dc4;
      }
      if (isset($this->activa_dc5) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dc5'] = $this->activa_dc5;
      }
      if (isset($this->activa_dp1) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dp1'] = $this->activa_dp1;
      }
      if (isset($this->activa_dp2) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dp2'] = $this->activa_dp2;
      }
      if (isset($this->activa_dp3) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dp3'] = $this->activa_dp3;
      }
      if (isset($this->activa_dp4) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dp4'] = $this->activa_dp4;
      }
      if (isset($this->activa_dp5) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_dp5'] = $this->activa_dp5;
      }
      if (isset($this->activa_ds1) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_ds1'] = $this->activa_ds1;
      }
      if (isset($this->activa_ds2) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_ds2'] = $this->activa_ds2;
      }
      if (isset($this->activa_ds3) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_ds3'] = $this->activa_ds3;
      }
      if (isset($this->activa_ds4) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_ds4'] = $this->activa_ds4;
      }
      if (isset($this->activa_ds5) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['activa_ds5'] = $this->activa_ds5;
      }
      ...
      if (isset($this->autoevaluacion) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['autoevaluacion'] = $this->autoevaluacion;
      }
      ...
      if (isset($this->num_campos_dc) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['num_campos_dc'] = $this->num_campos_dc;
      }
      if (isset($this->num_campos_dp) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['num_campos_dp'] = $this->num_campos_dp;
      }
      if (isset($this->num_campos_ds) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['num_campos_ds'] = $this->num_campos_ds;
      }
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad']['embutida_parms'];
      ...
      { 
          ...
          if (isset($this->etiqueta_grupo1dc)) 
          {
              $_SESSION['etiqueta_grupo1dc'] = $this->etiqueta_grupo1dc;
          }
          if (isset($this->etiqueta_grupo2dp)) 
          {
              $_SESSION['etiqueta_grupo2dp'] = $this->etiqueta_grupo2dp;
          }
          if (isset($this->etiqueta_grupo3ds)) 
          {
              $_SESSION['etiqueta_grupo3ds'] = $this->etiqueta_grupo3ds;
          }
          if (isset($this->activa_dc1)) 
          {
              $_SESSION['activa_dc1'] = $this->activa_dc1;
          }
          if (isset($this->activa_dc2)) 
          {
              $_SESSION['activa_dc2'] = $this->activa_dc2;
          }
          if (isset($this->activa_dc3)) 
          {
              $_SESSION['activa_dc3'] = $this->activa_dc3;
          }
          if (isset($this->activa_dc4)) 
          {
              $_SESSION['activa_dc4'] = $this->activa_dc4;
          }
          if (isset($this->activa_dc5)) 
          {
              $_SESSION['activa_dc5'] = $this->activa_dc5;
          }
          if (isset($this->activa_dp1)) 
          {
              $_SESSION['activa_dp1'] = $this->activa_dp1;
          }
          if (isset($this->activa_dp2)) 
          {
              $_SESSION['activa_dp2'] = $this->activa_dp2;
          }
          if (isset($this->activa_dp3)) 
          {
              $_SESSION['activa_dp3'] = $this->activa_dp3;
          }
          if (isset($this->activa_dp4)) 
          {
              $_SESSION['activa_dp4'] = $this->activa_dp4;
          }
          if (isset($this->activa_dp5)) 
          {
              $_SESSION['activa_dp5'] = $this->activa_dp5;
          }
          if (isset($this->activa_ds1)) 
          {
              $_SESSION['activa_ds1'] = $this->activa_ds1;
          }
          if (isset($this->activa_ds2)) 
          {
              $_SESSION['activa_ds2'] = $this->activa_ds2;
          }
          if (isset($this->activa_ds3)) 
          {
              $_SESSION['activa_ds3'] = $this->activa_ds3;
          }
          if (isset($this->activa_ds4)) 
          {
              $_SESSION['activa_ds4'] = $this->activa_ds4;
          }
          if (isset($this->activa_ds5)) 
          {
              $_SESSION['activa_ds5'] = $this->activa_ds5;
          }
          ...
          if (isset($this->num_campos_dc)) 
          {
              $_SESSION['num_campos_dc'] = $this->num_campos_dc;
          }
          if (isset($this->num_campos_dp)) 
          {
              $_SESSION['num_campos_dp'] = $this->num_campos_dp;
          }
          if (isset($this->num_campos_ds)) 
          {
              $_SESSION['num_campos_ds'] = $this->num_campos_ds;
          }
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_det_evalua_actividad_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_det_evalua_actividad_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idgrupo)) 
          {
              $_SESSION['par_idgrupo'] = $this->par_idgrupo;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_evalua_actividad_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['initialize'])
          {
...
$_SESSION['scriptcase']['form_evalua_actividad_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_evalua_actividad_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_evalua_actividad_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_evalua_actividad_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_evalua_actividad_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_evalua_actividad_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_evalua_actividad_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - t_evaluacion";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_evalua_actividad_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_evalua_actividad_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_evalua_actividad_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_orig'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura = " . $_SESSION['par_idasignatura'] . " AND id_estudiante = " . $_SESSION['par_idestudiante'] . " AND entorno = " . $_SESSION['entorno'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_pesq'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura = " . $_SESSION['par_idasignatura'] . " AND id_estudiante = " . $_SESSION['par_idestudiante'] . " AND entorno = " . $_SESSION['entorno'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_form'];
          ...
          if (!isset($this->dc4)){$this->dc4 = $this->nmgp_dados_form['dc4'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_evalua_actividad_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_evalua_actividad_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_evalua_actividad_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_evalua_actividad/form_evalua_actividad_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_evalua_actividad_mob_erro.class.php"); 
      }
      $this->Erro      = new form_evalua_actividad_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao']))
         { 
             if ($this->id_estudiante != "" || $this->id_grupo != "" || $this->id_asignatura != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_det_evalua_actividad_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_det_evalua_actividad_mob') . "/form_det_evalua_actividad_apl.php");
      ...
      if (isset($this->dc1)) { $this->nm_limpa_alfa($this->dc1); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['dc4']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dc4']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dc4']['symbol_dec'] = '';
      $this->field_config['dc4']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dc4']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dc5
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_dc1' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'dc1');
          }
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_dc1_onchange' == $this->NM_ajax_opcao)
          {
              $this->dc1_onChange();
          }
          form_evalua_actividad_mob_pack_ajax_response();
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_evalua_actividad_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_evalua_actividad_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_evalua_actividad_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_evalua_actividad_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'id_estudiante' == $filtro)
        $this->ValidateField_id_estudiante($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'dc1' == $filtro)
        $this->ValidateField_dc1($Campos_Crit, $Campos_Falta, $Campos_Erros);
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_estudiante == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['php_cmp_required']['id_estudiante']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['php_cmp_required']['id_estudiante'] == "on"))
      {
          ...
          if (!empty($this->id_estudiante) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante']) && !in_array($this->id_estudiante, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante']))
          {
    ...
    function ValidateField_dc1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->dc1 == "")  
      { 
      ...
      if (!empty($this->field_config['dc1']['symbol_dec']))
      {
          ...
          if ('.' == substr($this->dc1, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->dc1, 1)))
              {
                  $this->dc1 = '';
              }
              else
      ...
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->dc1) > $iTestSize)  
              { 
                  $Campos_Crit .= "Dc 1: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['dc1']))
                  {
                      $Campos_Erros['dc1'] = array();
                  }
                  $Campos_Erros['dc1'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['dc1']) || !is_array($this->NM_ajax_info['errList']['dc1']))
                  {
                      $this->NM_ajax_info['errList']['dc1'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc1'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->dc1, 11, 1, -0, 999999999999, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 1; " ; 
                  if (!isset($Campos_Erros['dc1']))
                  {
                  ...
                  $Campos_Erros['dc1'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['dc1']) || !is_array($this->NM_ajax_info['errList']['dc1']))
                  {
                      $this->NM_ajax_info['errList']['dc1'] = array();
                  }
                  $this->NM_ajax_info['errList']['dc1'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_dc1
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->dc4, $this->field_config['dc4']['symbol_grp']) ; 
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if (!empty($this->dc1) || (!empty($format_fields) && isset($format_fields['dc1'])))
      {
          nmgp_Form_Num_Val($this->dc1, $this->field_config['dc1']['symbol_grp'], $this->field_config['dc1']['symbol_dec'], "1", "S", "", "", "", "-", $this->field_config['dc1']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_estudiante']['keyVal'] = form_evalua_actividad_mob_pack_protect_string($this->nmgp_dados_form['id_estudiante']);
              $this->NM_ajax_info['fldList']['id_grupo']['keyVal'] = form_evalua_actividad_mob_pack_protect_string($this->nmgp_dados_form['id_grupo']);
              $this->NM_ajax_info['fldList']['id_asignatura']['keyVal'] = form_evalua_actividad_mob_pack_protect_string($this->nmgp_dados_form['id_asignatura']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total'] < 0)
              {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 

   $old_value_dc1 = $this->dc1;
   $this->nm_tira_formatacao();


   $unformatted_value_dc1 = $this->dc1;

   $nm_comando = "SELECT idstudents, concat_ws(' ',primer_apellido, segundo_apellido,primer_nombre, segundo_nombre) as nombre
FROM students 
ORDER BY nombre";

   $this->dc1 = $old_value_dc1;
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_evalua_actividad_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_evalua_actividad_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['Lookup_id_estudiante'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_estudiante']['valList'][$i] = form_evalua_actividad_mob_pack_protect_string($v);
          }
          ...
          //----- dc1
   function ajax_return_values_dc1($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("dc1", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->dc1);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['dc1'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_id_asignatura($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = false; 
          $SC_ex_upd_or = false; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['dc4']) && $NM_val_form['dc4'] != $this->nmgp_dados_select['dc4']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " dc4 = $this->dc4"; 
                  $comando_oracle        .= " dc4 = $this->dc4"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
          ...
          $this->actividades = $this->actividades_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['dc1'])) { $this->dc1 = $NM_val_form['dc1']; }
              elseif (isset($this->dc1)) { $this->nm_limpa_alfa($this->dc1); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('id_estudiante', 'dc1', 'actividades'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] = 0; 
              }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_dc1 != $this->dc1 || (isset($bFlagRead_dc1) && $bFlagRead_dc1)))
    {
...
$_SESSION['scriptcase']['form_evalua_actividad_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['parms'] = "id_estudiante?#?$this->id_estudiante?@?id_grupo?#?$this->id_grupo?@?id_asignatura?#?$this->id_asignatura?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_evalua_actividad_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total'] = $qt_geral_reg_form_evalua_actividad_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_estudiante) && !empty($this->id_grupo) && !empty($this->id_asignatura))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_evalua_actividad_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] > $qt_geral_reg_form_evalua_actividad_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] = $qt_geral_reg_form_evalua_actividad_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['reg_start'] < $qt_geral_reg_form_evalua_actividad_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['dados_select'];
                  $this->primer_apellido = $this->nmgp_dados_select['primer_apellido'];  
                  $this->segundo_apellido = $this->nmgp_dados_select['segundo_apellido'];  
                  $this->primer_nombre = $this->nmgp_dados_select['primer_nombre'];  
                  $this->segundo_nombre = $this->nmgp_dados_select['segundo_nombre'];  
                  $this->id_area = $this->nmgp_dados_select['id_area'];  
                  $this->id_grado = $this->nmgp_dados_select['id_grado'];  
                  $this->id_nivel = $this->nmgp_dados_select['id_nivel'];  
                  $this->ihs = $this->nmgp_dados_select['ihs'];  
                  $this->pfa = $this->nmgp_dados_select['pfa'];  
                  $this->tipo_asig = $this->nmgp_dados_select['tipo_asig'];  
                  $this->novedad = $this->nmgp_dados_select['novedad'];  
                  $this->estatus = $this->nmgp_dados_select['estatus'];  
                  $this->eval_1_per = $this->nmgp_dados_select['eval_1_per'];  
                  $this->dc1 = $this->nmgp_dados_select['dc1'];  
                  $this->dc2 = $this->nmgp_dados_select['dc2'];  
                  $this->dc3 = $this->nmgp_dados_select['dc3'];  
                  $this->dc4 = $this->nmgp_dados_select['dc4'];  
                  $this->dc5 = $this->nmgp_dados_select['dc5'];  
                  $this->pcent_dc = $this->nmgp_dados_select['pcent_dc'];  
                  $this->ds1 = $this->nmgp_dados_select['ds1'];  
                  $this->ds2 = $this->nmgp_dados_select['ds2'];  
                  $this->ds3 = $this->nmgp_dados_select['ds3'];  
                  $this->ds4 = $this->nmgp_dados_select['ds4'];  
                  $this->ds5 = $this->nmgp_dados_select['ds5'];  
                  $this->pcent_ds = $this->nmgp_dados_select['pcent_ds'];  
                  $this->dp1 = $this->nmgp_dados_select['dp1'];  
                  $this->dp2 = $this->nmgp_dados_select['dp2'];  
                  $this->dp3 = $this->nmgp_dados_select['dp3'];  
                  $this->dp4 = $this->nmgp_dados_select['dp4'];  
                  $this->dp5 = $this->nmgp_dados_select['dp5'];  
                  $this->pcent_dp = $this->nmgp_dados_select['pcent_dp'];  
                  $this->eval_2_per = $this->nmgp_dados_select['eval_2_per'];  
                  $this->dc1_2p = $this->nmgp_dados_select['dc1_2p'];  
                  $this->dc2_2p = $this->nmgp_dados_select['dc2_2p'];  
                  $this->dc3_2p = $this->nmgp_dados_select['dc3_2p'];  
                  $this->dc4_2p = $this->nmgp_dados_select['dc4_2p'];  
                  $this->dc5_2p = $this->nmgp_dados_select['dc5_2p'];  
                  $this->pcent_dc2 = $this->nmgp_dados_select['pcent_dc2'];  
                  $this->ds1_2p = $this->nmgp_dados_select['ds1_2p'];  
                  $this->ds2_2p = $this->nmgp_dados_select['ds2_2p'];  
                  $this->ds3_2p = $this->nmgp_dados_select['ds3_2p'];  
                  $this->ds4_2p = $this->nmgp_dados_select['ds4_2p'];  
                  $this->ds5_2p = $this->nmgp_dados_select['ds5_2p'];  
                  $this->pcent_ds2 = $this->nmgp_dados_select['pcent_ds2'];  
                  $this->dp1_2p = $this->nmgp_dados_select['dp1_2p'];  
                  $this->dp2_2p = $this->nmgp_dados_select['dp2_2p'];  
                  $this->dp3_2p = $this->nmgp_dados_select['dp3_2p'];  
                  $this->dp4_2p = $this->nmgp_dados_select['dp4_2p'];  
                  $this->dp5_2p = $this->nmgp_dados_select['dp5_2p'];  
                  $this->pcent_dp2 = $this->nmgp_dados_select['pcent_dp2'];  
                  $this->eval_3_per = $this->nmgp_dados_select['eval_3_per'];  
                  $this->dc1_3p = $this->nmgp_dados_select['dc1_3p'];  
                  $this->dc2_3p = $this->nmgp_dados_select['dc2_3p'];  
                  $this->dc3_3p = $this->nmgp_dados_select['dc3_3p'];  
                  $this->dc4_3p = $this->nmgp_dados_select['dc4_3p'];  
                  $this->dc5_3p = $this->nmgp_dados_select['dc5_3p'];  
                  $this->pcent_dc3 = $this->nmgp_dados_select['pcent_dc3'];  
                  $this->ds1_p3 = $this->nmgp_dados_select['ds1_p3'];  
                  $this->ds2_p3 = $this->nmgp_dados_select['ds2_p3'];  
                  $this->ds3_p3 = $this->nmgp_dados_select['ds3_p3'];  
                  $this->ds4_p3 = $this->nmgp_dados_select['ds4_p3'];  
                  $this->ds5_p3 = $this->nmgp_dados_select['ds5_p3'];  
                  $this->pcent_ds3 = $this->nmgp_dados_select['pcent_ds3'];  
                  $this->dp1_p3 = $this->nmgp_dados_select['dp1_p3'];  
                  $this->dp2_p3 = $this->nmgp_dados_select['dp2_p3'];  
                  $this->dp3_p3 = $this->nmgp_dados_select['dp3_p3'];  
                  $this->dp4_p3 = $this->nmgp_dados_select['dp4_p3'];  
                  $this->sc_field_0 = $this->nmgp_dados_select['sc_field_0'];  
                  $this->pcent_dp3 = $this->nmgp_dados_select['pcent_dp3'];  
                  $this->eval_4_per = $this->nmgp_dados_select['eval_4_per'];  
                  $this->dc1_p4 = $this->nmgp_dados_select['dc1_p4'];  
                  $this->dc2_p4 = $this->nmgp_dados_select['dc2_p4'];  
                  $this->dc3_p4 = $this->nmgp_dados_select['dc3_p4'];  
                  $this->dc4_p4 = $this->nmgp_dados_select['dc4_p4'];  
                  $this->dc5_p4 = $this->nmgp_dados_select['dc5_p4'];  
                  $this->pcent_dc4 = $this->nmgp_dados_select['pcent_dc4'];  
                  $this->ds1_p4 = $this->nmgp_dados_select['ds1_p4'];  
                  $this->ds2_p4 = $this->nmgp_dados_select['ds2_p4'];  
                  $this->ds3_p4 = $this->nmgp_dados_select['ds3_p4'];  
                  $this->ds4_p4 = $this->nmgp_dados_select['ds4_p4'];  
                  $this->ds5_p4 = $this->nmgp_dados_select['ds5_p4'];  
                  $this->pcent_ds4 = $this->nmgp_dados_select['pcent_ds4'];  
                  $this->dp1_p4 = $this->nmgp_dados_select['dp1_p4'];  
                  $this->dp2_p4 = $this->nmgp_dados_select['dp2_p4'];  
                  $this->dp3_p4 = $this->nmgp_dados_select['dp3_p4'];  
                  $this->dp4_p4 = $this->nmgp_dados_select['dp4_p4'];  
                  $this->dp5_p4 = $this->nmgp_dados_select['dp5_p4'];  
                  $this->pcent_dp4 = $this->nmgp_dados_select['pcent_dp4'];  
                  $this->eval_final = $this->nmgp_dados_select['eval_final'];  
                  $this->entorno = $this->nmgp_dados_select['entorno'];  
                  $this->actividades = $this->nmgp_dados_select['actividades'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['foreign_key']))
          {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_evalua_actividad_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['where_filter_form'] . " and (id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura = " . $_SESSION['par_idasignatura'] . " AND id_estudiante = " . $_SESSION['par_idestudiante'] . " AND entorno = " . $_SESSION['entorno'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_evalua_actividad_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['total'] = $qt_geral_reg_form_evalua_actividad_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_evalua_actividad_mob_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_evalua_actividad_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_evalua_actividad_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
