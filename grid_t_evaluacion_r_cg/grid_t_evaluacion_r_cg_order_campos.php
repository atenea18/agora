<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_r_cg_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_r_cg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["id_asignatura"] : "Asignatura";
   ...
   $tab_labels["ihs_vac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["ihs_vac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["ihs_vac"] : "IHS";
   $tab_ger_campos['eval_1_per'] = "on";
   $tab_def_campos['eval_1_per'] = "eval_1_per";
   $tab_converte["eval_1_per"]   = "eval_1_per";
   $tab_labels["eval_1_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["eval_1_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["eval_1_per"] : "Eval 1 Per";
   ...
   $tab_labels["sup_p1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["sup_p1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["sup_p1"] : "SUP";
   ...
   $tab_labels["sup_p2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["sup_p2"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["sup_p2"] : "SUP";
   ...
   $tab_labels["sup_p3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["sup_p3"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["sup_p3"] : "SUP";
   ...
   $tab_labels["fea_re_ac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["fea_re_ac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["fea_re_ac"] : "Fa/Re Ac";
   ...
   $tab_labels["definitiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["definitiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["definitiva"] : "DEF";
   ...
   $tab_labels["vac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["vac"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["vac"] : "VAc";
   ...
   $tab_labels["vra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["vra"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['labels']["vra"] : "VRA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_r_cg_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_r_cg']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
