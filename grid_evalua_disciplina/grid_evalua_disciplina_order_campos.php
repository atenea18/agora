<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_evalua_disciplina_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_evalua_disciplina_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["students_idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["students_idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["students_idstudents"] : "Codigo Estudiante";
   $tab_ger_campos['estudiantes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['estudiantes'] = "estudiantes";
       $tab_converte["estudiantes"]   = "estudiantes";
   }
   else
   {
       $tab_def_campos['estudiantes'] = "";
       $tab_converte[""]   = "estudiantes";
   }
   $tab_labels["estudiantes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["estudiantes"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["estudiantes"] : "Estudiantes";
   $tab_ger_campos['t_estudiante_grupo_id_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_estudiante_grupo_id_grupo'] = "t_estudiante_grupo_id_grupo";
       $tab_converte["t_estudiante_grupo_id_grupo"]   = "t_estudiante_grupo_id_grupo";
   }
   else
   {
       $tab_def_campos['t_estudiante_grupo_id_grupo'] = "t_estudiante_grupo.id_grupo";
       $tab_converte["t_estudiante_grupo.id_grupo"]   = "t_estudiante_grupo_id_grupo";
   }
   $tab_labels["t_estudiante_grupo_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["t_estudiante_grupo_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["t_estudiante_grupo_id_grupo"] : "Grupo";
   $tab_ger_campos['disciplina_entorno'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disciplina_entorno'] = "disciplina_entorno";
       $tab_converte["disciplina_entorno"]   = "disciplina_entorno";
   }
   else
   {
       $tab_def_campos['disciplina_entorno'] = "disciplina.entorno";
       $tab_converte["disciplina.entorno"]   = "disciplina_entorno";
   }
   $tab_labels["disciplina_entorno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["disciplina_entorno"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["disciplina_entorno"] : "Entorno";
   $tab_ger_campos['disciplina_id_periodo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disciplina_id_periodo'] = "disciplina_id_periodo";
       $tab_converte["disciplina_id_periodo"]   = "disciplina_id_periodo";
   }
   else
   {
       $tab_def_campos['disciplina_id_periodo'] = "disciplina.id_periodo";
       $tab_converte["disciplina.id_periodo"]   = "disciplina_id_periodo";
   }
   $tab_labels["disciplina_id_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["disciplina_id_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["disciplina_id_periodo"] : "Período";
   $tab_ger_campos['eval'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['eval'] = "eval";
       $tab_converte["eval"]   = "eval";
   }
   else
   {
       $tab_def_campos['eval'] = "";
   ...
   $tab_labels["eval"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["eval"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["eval"] : "eval";
   $tab_ger_campos['disciplina_evaluacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disciplina_evaluacion'] = "disciplina_evaluacion";
       $tab_converte["disciplina_evaluacion"]   = "disciplina_evaluacion";
   }
   else
   {
       $tab_def_campos['disciplina_evaluacion'] = "disciplina.evaluacion";
       $tab_converte["disciplina.evaluacion"]   = "disciplina_evaluacion";
   }
   $tab_labels["disciplina_evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["disciplina_evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['labels']["disciplina_evaluacion"] : "Evaluación";
   $tab_ger_campos['estudiantes'] = "none";
   $tab_ger_campos['eval'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_evalua_disciplina_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_evalua_disciplina']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
