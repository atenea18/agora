...
class grid_evalua_disciplina_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_evalua_disciplina_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_evalua_disciplina.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evalua_disciplina']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evalua_disciplina']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evalua_disciplina']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evalua_disciplina']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_evalua_disciplina";
...
$_SESSION['scriptcase']['grid_evalua_disciplina']['contr_erro'] = 'off'; 
   ...
   function NM_export_disciplina_entorno()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->disciplina_entorno))
         {
             $this->disciplina_entorno = sc_convert_encoding($this->disciplina_entorno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " disciplina_entorno =\"" . $this->trata_dados($this->disciplina_entorno) . "\"";
   }
   ...
   function NM_export_disciplina_id_periodo()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->disciplina_id_periodo))
         {
             $this->disciplina_id_periodo = sc_convert_encoding($this->disciplina_id_periodo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " disciplina_id_periodo =\"" . $this->trata_dados($this->disciplina_id_periodo) . "\"";
   }
   //----- eval
   function NM_export_eval()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->eval))
         {
             $this->eval = sc_convert_encoding($this->eval, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " eval =\"" . $this->trata_dados($this->eval) . "\"";
   }
   ...
   function NM_export_disciplina_evaluacion()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->disciplina_evaluacion))
         {
             $this->disciplina_evaluacion = sc_convert_encoding($this->disciplina_evaluacion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " disciplina_evaluacion =\"" . $this->trata_dados($this->disciplina_evaluacion) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evalua_disciplina']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evalua_disciplina']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
