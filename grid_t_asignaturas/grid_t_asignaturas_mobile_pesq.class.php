...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_asignatura";$Nm_numeric[] = "id_asignatura";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_asignatura"  <?php echo $str_hide_asignatura?>><?php
      $asignatura_look = substr($this->Db->qstr($asignatura), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_n_simpl"  <?php echo $str_hide_n_simpl?>><?php
      $n_simpl_look = substr($this->Db->qstr($n_simpl), 1, -1); 
      $nmgp_def_dados = array(); 
