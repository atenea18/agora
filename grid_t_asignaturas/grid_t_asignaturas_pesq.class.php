...
class grid_t_asignaturas_pesq
{
    ...
    * @access  public
    */
   function grid_t_asignaturas_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_t_asignaturas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_t_asignaturas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_t_asignaturas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_asignatura')
      {
          $asignatura = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_asignatura($asignatura);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_n_simpl')
      {
          $n_simpl = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_n_simpl($n_simpl);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_asignatura($asignatura)
   {
      $asignatura = substr($this->Db->qstr($asignatura), 1, -1);
            $asignatura_look = substr($this->Db->qstr($asignatura), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct asignatura from " . $this->Ini->nm_tabela . " where  asignatura like '%" . $asignatura . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_n_simpl($n_simpl)
   {
      $n_simpl = substr($this->Db->qstr($n_simpl), 1, -1);
            $n_simpl_look = substr($this->Db->qstr($n_simpl), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct n_simpl from " . $this->Ini->nm_tabela . " where  n_simpl like '%" . $n_simpl . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - t_asignaturas</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_t_asignaturas/grid_t_asignaturas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_t_asignaturas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_t_asignaturas_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_asignatura_cond#NMF#' + search_get_sel_txt('SC_asignatura_cond') + '@NMF@';
  str_out += 'SC_asignatura#NMF#' + search_get_text('SC_asignatura') + '@NMF@';
  str_out += 'id_ac_asignatura#NMF#' + search_get_text('id_ac_asignatura') + '@NMF@';
  str_out += 'SC_n_simpl_cond#NMF#' + search_get_sel_txt('SC_n_simpl_cond') + '@NMF@';
  str_out += 'SC_n_simpl#NMF#' + search_get_text('SC_n_simpl') + '@NMF@';
  str_out += 'id_ac_n_simpl#NMF#' + search_get_text('id_ac_n_simpl') + '@NMF@';
   ...
   $("#id_ac_asignatura").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_asignatura",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_asignatura").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_asignatura").val( $(this).val() );
       }
     }
   });
   $("#id_ac_n_simpl").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_n_simpl",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_n_simpl").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_n_simpl").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - t_asignaturas</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $asignatura_cond, $asignatura, $asignatura_autocomp,
             $n_simpl_cond, $n_simpl, $n_simpl_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_asignatura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['id_asignatura']; 
          $id_asignatura_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['id_asignatura_input_2']; 
          $id_asignatura_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['id_asignatura_cond']; 
          $asignatura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['asignatura']; 
          $asignatura_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['asignatura_cond']; 
          $n_simpl = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['n_simpl']; 
          $n_simpl_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['n_simpl_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_asignatura_cond) || empty($id_asignatura_cond))
      {
         $id_asignatura_cond = "gt";
      }
      if (!isset($asignatura_cond) || empty($asignatura_cond))
      {
         $asignatura_cond = "qp";
      }
      if (!isset($n_simpl_cond) || empty($n_simpl_cond))
      {
         $n_simpl_cond = "qp";
      }
      ...
      $str_hide_asignatura = (in_array($asignatura_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_n_simpl = (in_array($n_simpl_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (isset($asignatura) && !empty($asignatura))
      {
         $tmp_pos = strpos($asignatura, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $asignatura = substr($asignatura, 0, $tmp_pos);
         }
      }
      if (!isset($n_simpl) || $n_simpl == "")
      {
          $n_simpl = "";
      }
      if (isset($n_simpl) && !empty($n_simpl))
      {
         $tmp_pos = strpos($n_simpl, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $n_simpl = substr($n_simpl, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_t_asignaturas_help.txt"))
   {
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_asignatura" name="id_asignatura_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['asignatura'])) ? $this->New_label['asignatura'] : "Asignatura"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_asignatura_cond" name="asignatura_cond" onChange="nm_campos_between(document.getElementById('id_vis_asignatura'), this, 'asignatura')">
       <OPTION value="qp" <?php if ("qp" == $asignatura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $asignatura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $asignatura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $asignatura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_asignatura" <?php echo $str_hide_asignatura?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['asignatura'])) ? $this->New_label['asignatura'] : "Asignatura";
 $nmgp_tab_label .= "asignatura?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $asignatura_look = substr($this->Db->qstr($asignatura), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct asignatura from " . $this->Ini->nm_tabela . " where asignatura = '$asignatura_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$asignatura]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$asignatura];
      }
      else
      {
          $sAutocompValue = $asignatura;
      }
?>
<INPUT  type="text" id="SC_asignatura" name="asignatura" value="<?php echo NM_encode_input($asignatura) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_asignatura" name="asignatura_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['n_simpl'])) ? $this->New_label['n_simpl'] : "N Simpl"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_n_simpl_cond" name="n_simpl_cond" onChange="nm_campos_between(document.getElementById('id_vis_n_simpl'), this, 'n_simpl')">
       <OPTION value="qp" <?php if ("qp" == $n_simpl_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $n_simpl_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $n_simpl_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $n_simpl_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_n_simpl" <?php echo $str_hide_n_simpl?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['n_simpl'])) ? $this->New_label['n_simpl'] : "N Simpl";
 $nmgp_tab_label .= "n_simpl?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $n_simpl_look = substr($this->Db->qstr($n_simpl), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct n_simpl from " . $this->Ini->nm_tabela . " where n_simpl = '$n_simpl_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$n_simpl]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$n_simpl];
      }
      else
      {
          $sAutocompValue = $n_simpl;
      }
?>
<INPUT  type="text" id="SC_n_simpl" name="n_simpl" value="<?php echo NM_encode_input($n_simpl) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_n_simpl" name="n_simpl_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_asignaturas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_asignaturas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_asignatura'), document.F1.asignatura_cond, 'asignatura');
   document.F1.asignatura.value = "";
   document.F1.asignatura_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_n_simpl'), document.F1.n_simpl_cond, 'n_simpl');
   document.F1.n_simpl.value = "";
   document.F1.n_simpl_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_t_asignaturas";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_asignatura_cond'] = 'cond';
      $tp_fields['SC_asignatura'] = 'text_aut';
      $tp_fields['id_ac_asignatura'] = 'text_aut';
      $tp_fields['SC_n_simpl_cond'] = 'cond';
      $tp_fields['SC_n_simpl'] = 'text_aut';
      $tp_fields['id_ac_n_simpl'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $id_asignatura_cond, $id_asignatura, $id_asignatura_input_2, $id_asignatura_autocomp,
             $asignatura_cond, $asignatura, $asignatura_autocomp,
             $n_simpl_cond, $n_simpl, $n_simpl_autocomp, $nmgp_tab_label;
      ...
      if (!empty($asignatura_autocomp) && empty($asignatura))
      {
          $asignatura = $asignatura_autocomp;
      }
      if (!empty($n_simpl_autocomp) && empty($n_simpl))
      {
          $n_simpl = $n_simpl_autocomp;
      }
      ...
      $asignatura_cond_salva = $asignatura_cond; 
      if (!isset($asignatura_input_2) || $asignatura_input_2 == "")
      {
          $asignatura_input_2 = $asignatura;
      }
      $n_simpl_cond_salva = $n_simpl_cond; 
      if (!isset($n_simpl_input_2) || $n_simpl_input_2 == "")
      {
          $n_simpl_input_2 = $n_simpl;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['id_asignatura'] = $id_asignatura; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['id_asignatura_input_2'] = $id_asignatura_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['id_asignatura_cond'] = $id_asignatura_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['asignatura'] = $asignatura; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['asignatura_cond'] = $asignatura_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['n_simpl'] = $n_simpl; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['n_simpl_cond'] = $n_simpl_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['asignatura'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['asignatura'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['asignatura'] = $asignatura;
      }
      $n_simpl_look = substr($this->Db->qstr($n_simpl), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct n_simpl from " . $this->Ini->nm_tabela . " where n_simpl = '$n_simpl_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['n_simpl'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['n_simpl'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['n_simpl'] = $n_simpl;
      }
      ...
      //----- $asignatura
      $this->Date_part = false;
      if (isset($asignatura) || $asignatura_cond == "nu" || $asignatura_cond == "nn" || $asignatura_cond == "ep" || $asignatura_cond == "ne")
      {
         $this->monta_condicao("asignatura", $asignatura_cond, $asignatura, "", "asignatura");
      }

      //----- $n_simpl
      $this->Date_part = false;
      if (isset($n_simpl) || $n_simpl_cond == "nu" || $n_simpl_cond == "nn" || $n_simpl_cond == "ep" || $n_simpl_cond == "ne")
      {
         $this->monta_condicao("n_simpl", $n_simpl_cond, $n_simpl, "", "n_simpl");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asignaturas']['where_pesq_ant'] = $this->comando . $this->comando_fim;
