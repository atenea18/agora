  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_nov_excluy_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate novedad_excluyente
  function do_ajax_form_nov_excluy_mob_validate_novedad_excluyente()
  {
    var nomeCampo_novedad_excluyente = "novedad_excluyente";
    var var_novedad_excluyente = scAjaxGetFieldCheckbox(nomeCampo_novedad_excluyente, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nov_excluy_mob_validate_novedad_excluyente(var_novedad_excluyente, var_script_case_init, do_ajax_form_nov_excluy_mob_validate_novedad_excluyente_cb);
  } // do_ajax_form_nov_excluy_mob_validate_novedad_excluyente

  function do_ajax_form_nov_excluy_mob_validate_novedad_excluyente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "novedad_excluyente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nov_excluy_mob_validate_novedad_excluyente_cb
  // ---------- Form
  function do_ajax_form_nov_excluy_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_nov_excluy_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_novedad_excluyente = scAjaxGetFieldCheckbox("novedad_excluyente", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_nov_excluy_mob_submit_form(var_novedad_excluyente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_nov_excluy_mob_submit_form_cb);
  } // do_ajax_form_nov_excluy_mob_submit_form

  function do_ajax_form_nov_excluy_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("novedad_excluyente");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_nov_excluy_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_nov_excluy_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("table");
    scAjaxHideErrorDisplay("novedad_excluyente");
    var var_novedad_excluyente = document.F2.novedad_excluyente.value;
    ...
    scAjaxProcOn();
    x_ajax_form_nov_excluy_mob_navigate_form(var_novedad_excluyente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_nov_excluy_mob_navigate_form_cb);
  } // do_ajax_form_nov_excluy_mob_navigate_form

  function do_ajax_form_nov_excluy_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_nov_excluy_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.novedad_excluyente.value = scAjaxGetKeyValue("novedad_excluyente");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_nov_excluy_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_nov_excluy_mob_navigate_form_cb
  function sc_hide_form_nov_excluy_mob_form()
  {
  ...
  ajax_field_list[0] = "novedad_excluyente";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "novedad_excluyente": {"label": "Novedad Excluyente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "novedad_excluyente": new Array()
  };
  ajax_field_mult["novedad_excluyente"][1] = "novedad_excluyente";

  var ajax_field_id = {
    "novedad_excluyente": new Array("hidden_field_label_novedad_excluyente", "hidden_field_data_novedad_excluyente")
  };

  var ajax_read_only = {
    "novedad_excluyente": "on"
  };
