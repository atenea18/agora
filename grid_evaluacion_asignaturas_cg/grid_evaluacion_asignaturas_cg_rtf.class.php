...
class grid_evaluacion_asignaturas_cg_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_evaluacion_asignaturas_cg_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_evaluacion_asignaturas_cg.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_cg']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_cg']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_cg']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_cg']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_evaluacion_asignaturas_cg']['contr_erro'] = 'off'; 
   ...
   function NM_export_inasistencias()
   {
         ...
         $this->inasistencias = str_replace('<', '&lt;', $this->inasistencias);
         $this->inasistencias = str_replace('>', '&gt;', $this->inasistencias);
         $this->Texto_tag .= "<td>" . $this->inasistencias . "</td>\r\n";
   }
   //----- profesor
   function NM_export_profesor()
   {
         ...
         $this->profesor = str_replace('<', '&lt;', $this->profesor);
         $this->profesor = str_replace('>', '&gt;', $this->profesor);
         $this->Texto_tag .= "<td>" . $this->profesor . "</td>\r\n";
   }
   //----- ihs
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_cg']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_evaluacion_asignaturas_cg']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
