<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_evaluacion_asignaturas_cg_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_evaluacion_asignaturas_cg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["id_asignatura"] : "";
   $tab_ger_campos['inasistencias'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inasistencias'] = "inasistencias";
       $tab_converte["inasistencias"]   = "inasistencias";
   }
   else
   {
       $tab_def_campos['inasistencias'] = "";
       $tab_converte[""]   = "inasistencias";
   }
   $tab_labels["inasistencias"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["inasistencias"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["inasistencias"] : "";
   $tab_ger_campos['profesor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['profesor'] = "profesor";
       $tab_converte["profesor"]   = "profesor";
   }
   else
   {
       $tab_def_campos['profesor'] = "";
       $tab_converte[""]   = "profesor";
   }
   $tab_labels["profesor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["profesor"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["profesor"] : "";
   $tab_ger_campos['ihs'] = "on";
   $tab_def_campos['ihs'] = "ihs";
   $tab_converte["ihs"]   = "ihs";
   $tab_labels["ihs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["ihs"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["ihs"] : "";
   $tab_ger_campos['eval_periodo1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['eval_periodo1'] = "eval_periodo1";
       $tab_converte["eval_periodo1"]   = "eval_periodo1";
   }
   else
   {
       $tab_def_campos['eval_periodo1'] = "";
       $tab_converte[""]   = "eval_periodo1";
   }
   $tab_labels["eval_periodo1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["eval_periodo1"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["eval_periodo1"] : "";
   $tab_ger_campos['desem_asig'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_asig'] = "desem_asig";
       $tab_converte["desem_asig"]   = "desem_asig";
   }
   else
   {
       $tab_def_campos['desem_asig'] = "";
       $tab_converte[""]   = "desem_asig";
   }
   $tab_labels["desem_asig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["desem_asig"])) ? $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['labels']["desem_asig"] : "";
   $tab_ger_campos['inasistencias'] = "none";
   $tab_ger_campos['profesor'] = "none";
   $tab_ger_campos['eval_periodo1'] = "none";
   $tab_ger_campos['desem_asig'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_evaluacion_asignaturas_cg_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_evaluacion_asignaturas_cg']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
