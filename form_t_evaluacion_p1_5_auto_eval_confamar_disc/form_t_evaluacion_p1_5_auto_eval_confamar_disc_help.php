...
@session_start() ;
class form_t_evaluacion_p1_5_auto_eval_confamar_disc_help
{
    function form_t_evaluacion_p1_5_auto_eval_confamar_disc_help()
    {
...
$exec_help = new form_t_evaluacion_p1_5_auto_eval_confamar_disc_help();
?>
