...
class grid_prueba_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prueba']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prueba']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prueba']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prueba']['rtf_name']);
      }
   ...
   function NM_export_t_grupos_id_sede()
   {
         ...
         if (!NM_is_utf8($this->t_grupos_id_sede))
         {
             $this->t_grupos_id_sede = sc_convert_encoding($this->t_grupos_id_sede, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->t_grupos_id_sede = str_replace('<', '&lt;', $this->t_grupos_id_sede);
         $this->t_grupos_id_sede = str_replace('>', '&gt;', $this->t_grupos_id_sede);
         $this->Texto_tag .= "<td>" . $this->t_grupos_id_sede . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_prueba']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_prueba']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
