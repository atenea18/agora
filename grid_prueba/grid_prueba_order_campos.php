<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_prueba_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_prueba_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_evaluacion_id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_id_estudiante"] : "Id Estudiante";
   $tab_ger_campos['t_evaluacion_primer_apellido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_primer_apellido'] = "t_evaluacion_primer_apellido";
       $tab_converte["t_evaluacion_primer_apellido"]   = "t_evaluacion_primer_apellido";
   }
   else
   {
       $tab_def_campos['t_evaluacion_primer_apellido'] = "t_evaluacion.primer_apellido";
       $tab_converte["t_evaluacion.primer_apellido"]   = "t_evaluacion_primer_apellido";
   }
   $tab_labels["t_evaluacion_primer_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_primer_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_primer_apellido"] : "Primer Apellido";
   $tab_ger_campos['t_evaluacion_segundo_apellido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_segundo_apellido'] = "t_evaluacion_segundo_apellido";
       $tab_converte["t_evaluacion_segundo_apellido"]   = "t_evaluacion_segundo_apellido";
   }
   else
   {
       $tab_def_campos['t_evaluacion_segundo_apellido'] = "t_evaluacion.segundo_apellido";
       $tab_converte["t_evaluacion.segundo_apellido"]   = "t_evaluacion_segundo_apellido";
   }
   $tab_labels["t_evaluacion_segundo_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_segundo_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_segundo_apellido"] : "Segundo Apellido";
   $tab_ger_campos['t_evaluacion_primer_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_primer_nombre'] = "t_evaluacion_primer_nombre";
       $tab_converte["t_evaluacion_primer_nombre"]   = "t_evaluacion_primer_nombre";
   }
   else
   {
       $tab_def_campos['t_evaluacion_primer_nombre'] = "t_evaluacion.primer_nombre";
       $tab_converte["t_evaluacion.primer_nombre"]   = "t_evaluacion_primer_nombre";
   }
   $tab_labels["t_evaluacion_primer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_primer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_primer_nombre"] : "Primer Nombre";
   $tab_ger_campos['t_evaluacion_segundo_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_segundo_nombre'] = "t_evaluacion_segundo_nombre";
       $tab_converte["t_evaluacion_segundo_nombre"]   = "t_evaluacion_segundo_nombre";
   }
   else
   {
       $tab_def_campos['t_evaluacion_segundo_nombre'] = "t_evaluacion.segundo_nombre";
       $tab_converte["t_evaluacion.segundo_nombre"]   = "t_evaluacion_segundo_nombre";
   }
   $tab_labels["t_evaluacion_segundo_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_segundo_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_evaluacion_segundo_nombre"] : "Segundo Nombre";
   ...
   $tab_labels["t_grupos_id_sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_grupos_id_sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_prueba']['labels']["t_grupos_id_sede"] : "Id Sede";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_prueba']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_prueba']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_prueba_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_prueba']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
