...
class grid_students_1_seguridad_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $Tit_doc;
   //---- 
   function grid_students_1_seguridad_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_students_1_seguridad";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_students_1_seguridad.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['order_grid'];
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['field_order'] as $Cada_col)
      { 
...
$_SESSION['scriptcase']['grid_students_1_seguridad']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students_1_seguridad'][$path_doc_md5][1] = $this->Tit_doc;
?>
