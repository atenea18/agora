<?php
class form_t_evaluacion_p1_form extends form_t_evaluacion_p1_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['embutida_pdf']))
 {
 ?>
<?php
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_t_evaluacion_p1/form_t_evaluacion_p1_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_t_evaluacion_p1_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_t_evaluacion_p1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['recarga'];
}
...
<?php
 include_once("form_t_evaluacion_p1_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_t_evaluacion_p1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_t_evaluacion_p1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
     ...
     <TD class="scFormLabelOddMult">&nbsp;</TD>
     <TD class="scFormLabelOddMult" colspan=5 style="text-align:center;vertical-align:middle;">DESEMPEÑO PERSONAL</TD>
     <TD class="scFormLabelOddMult" style="text-align:center;vertical-align:middle;">&nbsp;</TD>
     <TD class="scFormLabelOddMult" colspan=5 style="text-align:center;vertical-align:middle;">DESEMPEÑO SOCIAL</TD>
     <TD class="scFormLabelOddMult">&nbsp;</TD>
     <TD class="scFormLabelOddMult">&nbsp;</TD>
     <TD class="scFormLabelOddMult">&nbsp;</TD>
    </TR>
...
<?php
   ...
   <?php if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['pdf_view'] && $this->Embutida_form && $this->nmgp_botoes['insert'] == "on") {?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_t_evaluacion_p1);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_t_evaluacion_p1 = $this->form_vert_form_t_evaluacion_p1;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_t_evaluacion_p1))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_t_evaluacion_p1 as $sc_seq_vert => $sc_lixo)
   {
       $this->primer_apellido_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['primer_apellido_'];
       $this->segundo_apellido_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['segundo_apellido_'];
       $this->primer_nombre_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['primer_nombre_'];
       $this->segundo_nombre_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['segundo_nombre_'];
       $this->id_grupo_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_grupo_'];
       $this->id_area_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_area_'];
       $this->id_asignatura_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_asignatura_'];
       $this->id_grado_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_grado_'];
       $this->id_nivel_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_nivel_'];
       $this->ihs_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ihs_'];
       $this->pfa_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pfa_'];
       $this->tipo_asig_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['tipo_asig_'];
       $this->dc6_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc6_'];
       $this->dc7_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc7_'];
       $this->dc8_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc8_'];
       $this->dc9_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc9_'];
       $this->aeep1_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['aeep1_'];
       $this->porcent_aeep1_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['porcent_aeep1_'];
       $this->inasistencia_p2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['inasistencia_p2_'];
       $this->eval_2_per_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['eval_2_per_'];
       $this->dc1_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc1_2p_'];
       $this->dc2_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc2_2p_'];
       $this->dc3_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc3_2p_'];
       $this->dc4_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc4_2p_'];
       $this->dc5_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc5_2p_'];
       $this->pcent_dc2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dc2_'];
       $this->ds1_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds1_2p_'];
       $this->ds2_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds2_2p_'];
       $this->ds3_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds3_2p_'];
       $this->ds4_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds4_2p_'];
       $this->ds5_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds5_2p_'];
       $this->pcent_ds2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_ds2_'];
       $this->dp1_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp1_2p_'];
       $this->dp2_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp2_2p_'];
       $this->dp3_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp3_2p_'];
       $this->dp4_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp4_2p_'];
       $this->dp5_2p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp5_2p_'];
       $this->pcent_dp2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dp2_'];
       $this->aee_p2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['aee_p2_'];
       $this->porcet_aee_p2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['porcet_aee_p2_'];
       $this->inasistencia_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['inasistencia_p3_'];
       $this->eval_3_per_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['eval_3_per_'];
       $this->dc1_3p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc1_3p_'];
       $this->dc2_3p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc2_3p_'];
       $this->dc3_3p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc3_3p_'];
       $this->dc4_3p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc4_3p_'];
       $this->dc5_3p_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc5_3p_'];
       $this->pcent_dc3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dc3_'];
       $this->ds1_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds1_p3_'];
       $this->ds2_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds2_p3_'];
       $this->ds3_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds3_p3_'];
       $this->ds4_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds4_p3_'];
       $this->ds5_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds5_p3_'];
       $this->pcent_ds3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_ds3_'];
       $this->dp1_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp1_p3_'];
       $this->dp2_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp2_p3_'];
       $this->dp3_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp3_p3_'];
       $this->dp4_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp4_p3_'];
       $this->sc_field_0_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['sc_field_0_'];
       $this->pcent_dp3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dp3_'];
       $this->aee_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['aee_p3_'];
       $this->porcent_aee_p3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['porcent_aee_p3_'];
       $this->inasistencia_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['inasistencia_p4_'];
       $this->eval_4_per_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['eval_4_per_'];
       $this->dc1_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc1_p4_'];
       $this->dc2_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc2_p4_'];
       $this->dc3_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc3_p4_'];
       $this->dc4_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc4_p4_'];
       $this->dc5_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc5_p4_'];
       $this->pcent_dc4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dc4_'];
       $this->ds1_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds1_p4_'];
       $this->ds2_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds2_p4_'];
       $this->ds3_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds3_p4_'];
       $this->ds4_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds4_p4_'];
       $this->ds5_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds5_p4_'];
       $this->pcent_ds4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_ds4_'];
       $this->dp1_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp1_p4_'];
       $this->dp2_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp2_p4_'];
       $this->dp3_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp3_p4_'];
       $this->dp4_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp4_p4_'];
       $this->dp5_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp5_p4_'];
       $this->aee_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['aee_p4_'];
       $this->porcent_aee_p4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['porcent_aee_p4_'];
       $this->pcent_dp4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dp4_'];
       $this->eval_final_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['eval_final_'];
       $this->entorno_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['entorno_'];
       $this->estudiantes_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['estudiantes_'];
       $this->id_novedad_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_novedad_'];
       $this->nom_grupo_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['nom_grupo_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_estudiante_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['id_estudiante_']; 
       ...
       $this->estatus_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['estatus_']; 
       ...
       $this->novedad_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['novedad_']; 
       ...
       $this->asienta_inasistencias_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['asienta_inasistencias_']; 
       ...
       $this->inasistencia_p1_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['inasistencia_p1_']; 
       ...
       $this->eval_1_per_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['eval_1_per_']; 
       ...
       $this->dc1_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc1_']; 
       $dc1_ = $this->dc1_; 
       $sStyleHidden_dc1_ = '';
       ...
       $this->dc2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc2_']; 
       $dc2_ = $this->dc2_; 
       $sStyleHidden_dc2_ = '';
       ...
       $this->dc3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc3_']; 
       $dc3_ = $this->dc3_; 
       $sStyleHidden_dc3_ = '';
       ...
       $this->dc4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc4_']; 
       $dc4_ = $this->dc4_; 
       $sStyleHidden_dc4_ = '';
       ...
       $this->dc5_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dc5_']; 
       $dc5_ = $this->dc5_; 
       $sStyleHidden_dc5_ = '';
       ...
       $this->pcent_dc_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dc_']; 
       ...
       $this->dp1_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp1_']; 
       $dp1_ = $this->dp1_; 
       $sStyleHidden_dp1_ = '';
       ...
       $this->dp2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp2_']; 
       $dp2_ = $this->dp2_; 
       $sStyleHidden_dp2_ = '';
       ...
       $this->dp3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp3_']; 
       $dp3_ = $this->dp3_; 
       $sStyleHidden_dp3_ = '';
       ...
       $this->dp4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp4_']; 
       $dp4_ = $this->dp4_; 
       $sStyleHidden_dp4_ = '';
       ...
       $this->dp5_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['dp5_']; 
       $dp5_ = $this->dp5_; 
       $sStyleHidden_dp5_ = '';
       ...
       $this->pcent_dp_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_dp_']; 
       ...
       $this->ds1_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds1_']; 
       $ds1_ = $this->ds1_; 
       $sStyleHidden_ds1_ = '';
       ...
       $this->ds2_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds2_']; 
       $ds2_ = $this->ds2_; 
       $sStyleHidden_ds2_ = '';
       ...
       $this->ds3_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds3_']; 
       $ds3_ = $this->ds3_; 
       $sStyleHidden_ds3_ = '';
       ...
       $this->ds4_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds4_']; 
       $ds4_ = $this->ds4_; 
       $sStyleHidden_ds4_ = '';
       ...
       $this->ds5_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['ds5_']; 
       $ds5_ = $this->ds5_; 
       $sStyleHidden_ds5_ = '';
       ...
       $this->pcent_ds_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['pcent_ds_']; 
       ...
       $this->val_acumulada_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['val_acumulada_']; 
       ...
       $this->val_requerida_ = $this->form_vert_form_t_evaluacion_p1[$sc_seq_vert]['val_requerida_']; 
...
?>   
   ...
   <?php if ($this->Embutida_form && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['pdf_view']) {?>
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_t_evaluacion_p1_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_t_evaluacion_p1_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_t_evaluacion_p1_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_t_evaluacion_p1_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_t_evaluacion_p1_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_t_evaluacion_p1_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
?>
<span id="id_imghtml_asienta_inasistencias_<?php echo $sc_seq_vert; ?>"><a href="javascript:nm_gp_submit('<?php echo $this->Ini->link_form_inasistencias_edit . "', '$this->nm_location', 'par_idstudents*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['dados_form'][$sc_seq_vert]['id_estudiante_'] . "*scoutpar_id_grado*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['dados_form'][$sc_seq_vert]['id_grado_'] . "*scoutpar_id_grupo*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['dados_form'][$sc_seq_vert]['id_grupo_'] . "*scoutpar_id_asignatura*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['dados_form'][$sc_seq_vert]['id_asignatura_'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutNMSC_modal*scinok*scoutsc_redir_insert*scinok*scout', '', 'modal', '450', '550', 'form_inasistencias')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $asienta_inasistencias_ ; ?></font></a></span>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_t_evaluacion_p1 = $guarda_form_vert_form_t_evaluacion_p1;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_p1']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_t_evaluacion_p1");
 parent.scAjaxDetailHeight("form_t_evaluacion_p1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
