...
class grid_sedes_xml
{
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sedes']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sedes']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sedes']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sedes']['xml_name']);
      }
      if (!$this->Grava_view)
      {
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->sede))
         {
             $this->sede = sc_convert_encoding($this->sede, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " sede =\"" . $this->trata_dados($this->sede) . "\"";
   }
   //----- direccion
   ...
   function NM_export_coordinador_manana()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_coordinador_manana))
         {
             $this->look_coordinador_manana = sc_convert_encoding($this->look_coordinador_manana, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " coordinador_manana =\"" . $this->trata_dados($this->look_coordinador_manana) . "\"";
   }
   //----- coordinador_tarde
   function NM_export_coordinador_tarde()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_coordinador_tarde))
         {
             $this->look_coordinador_tarde = sc_convert_encoding($this->look_coordinador_tarde, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " coordinador_tarde =\"" . $this->trata_dados($this->look_coordinador_tarde) . "\"";
   }
   ...
   function NM_export_coordinador_nocturno()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_coordinador_nocturno))
         {
             $this->look_coordinador_nocturno = sc_convert_encoding($this->look_coordinador_nocturno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " coordinador_nocturno =\"" . $this->trata_dados($this->look_coordinador_nocturno) . "\"";
   }
   //----- coordinador_sabado
   function NM_export_coordinador_sabado()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_coordinador_sabado))
         {
             $this->look_coordinador_sabado = sc_convert_encoding($this->look_coordinador_sabado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " coordinador_sabado =\"" . $this->trata_dados($this->look_coordinador_sabado) . "\"";
   }
   //----- id_sede
   ...
   function NM_export_capacidad_fisica()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->capacidad_fisica))
         {
             $this->capacidad_fisica = sc_convert_encoding($this->capacidad_fisica, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " capacidad_fisica =\"" . $this->trata_dados($this->capacidad_fisica) . "\"";
   }
   //----- cod_dane
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sedes']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sedes']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - sedes :: XML</TITLE>
