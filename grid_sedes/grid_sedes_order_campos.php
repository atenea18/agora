<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_sedes_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_sedes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['sede'] = "on";
   $tab_def_campos['sede'] = "sede";
   $tab_converte["sede"]   = "sede";
   $tab_labels["sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["sede"] : "Sede";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_converte["direccion"]   = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['telefonos'] = "on";
   $tab_def_campos['telefonos'] = "telefonos";
   $tab_converte["telefonos"]   = "telefonos";
   $tab_labels["telefonos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["telefonos"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["telefonos"] : "Telefonos";
   $tab_ger_campos['coordinador_manana'] = "on";
   $tab_def_campos['coordinador_manana'] = "coordinador_manana";
   $tab_converte["coordinador_manana"]   = "coordinador_manana";
   $tab_labels["coordinador_manana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_manana"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_manana"] : "Coordinador Mañana";
   $tab_ger_campos['coordinador_tarde'] = "on";
   $tab_def_campos['coordinador_tarde'] = "coordinador_tarde";
   $tab_converte["coordinador_tarde"]   = "coordinador_tarde";
   $tab_labels["coordinador_tarde"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_tarde"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_tarde"] : "Coordinador Tarde";
   $tab_ger_campos['coordinador_nocturno'] = "on";
   $tab_def_campos['coordinador_nocturno'] = "coordinador_nocturno";
   $tab_converte["coordinador_nocturno"]   = "coordinador_nocturno";
   $tab_labels["coordinador_nocturno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_nocturno"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_nocturno"] : "Coordinador Nocturno";
   $tab_ger_campos['coordinador_sabado'] = "on";
   $tab_def_campos['coordinador_sabado'] = "coordinador_sabado";
   $tab_converte["coordinador_sabado"]   = "coordinador_sabado";
   $tab_labels["coordinador_sabado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_sabado"])) ? $_SESSION['sc_session'][$sc_init]['grid_sedes']['labels']["coordinador_sabado"] : "Coordinador Sabado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sedes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sedes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - sedes</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_sedes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_sedes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
