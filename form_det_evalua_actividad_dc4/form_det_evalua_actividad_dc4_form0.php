<?php
class form_det_evalua_actividad_dc4_form extends form_det_evalua_actividad_dc4_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_det_evalua_actividad_dc4/form_det_evalua_actividad_dc4_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_det_evalua_actividad_dc4_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_det_evalua_actividad_dc4_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['recarga'];
}
...
<?php
 include_once("form_det_evalua_actividad_dc4_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_det_evalua_actividad_dc4'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_det_evalua_actividad_dc4'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_det_evalua_actividad_dc4);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_det_evalua_actividad_dc4 = $this->form_vert_form_det_evalua_actividad_dc4;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_det_evalua_actividad_dc4))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_det_evalua_actividad_dc4 as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_rel_act_est_per_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['id_rel_act_est_per_']; 
       ...
       $this->id_estudent_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['id_estudent_']; 
       ...
       $this->actividad_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['actividad_']; 
       ...
       $this->codigo_desemp_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['codigo_desemp_']; 
       ...
       $this->posicion_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['posicion_']; 
       ...
       $this->id_asignatura_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['id_asignatura_']; 
       ...
       $this->id_grupo_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['id_grupo_']; 
       ...
       $this->eval_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['eval_']; 
       $eval_ = $this->eval_; 
       $sStyleHidden_eval_ = '';
       ...
       $this->porcentaje_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['porcentaje_']; 
       ...
       $this->entorno_ = $this->form_vert_form_det_evalua_actividad_dc4[$sc_seq_vert]['entorno_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_det_evalua_actividad_dc4_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_det_evalua_actividad_dc4_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_det_evalua_actividad_dc4_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_det_evalua_actividad_dc4_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_det_evalua_actividad_dc4_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_det_evalua_actividad_dc4_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_det_evalua_actividad_dc4 = $guarda_form_vert_form_det_evalua_actividad_dc4;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['total'] + 1)?>);</script><?php }} ?>
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_evalua_actividad_dc4']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_det_evalua_actividad_dc4");
 parent.scAjaxDetailHeight("form_det_evalua_actividad_dc4", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
