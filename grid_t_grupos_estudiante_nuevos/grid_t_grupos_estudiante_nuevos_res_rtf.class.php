...
class grid_t_grupos_estudiante_nuevos_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   //---- 
   function grid_t_grupos_estudiante_nuevos_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_t_grupos_estudiante_nuevos.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['arr_export']['data'];
       $b_display = false;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Estudiantes en Grupos Nuevos :: RTF</TITLE>
