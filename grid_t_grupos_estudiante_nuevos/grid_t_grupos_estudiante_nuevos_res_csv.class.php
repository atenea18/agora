...
class grid_t_grupos_estudiante_nuevos_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_grupos_estudiante_nuevos_csv()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".csv";
      $this->Tit_doc    = "grid_t_grupos_estudiante_nuevos.csv";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['csv_name']);
      }
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['arr_export']['data'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - Estudiantes en Grupos Nuevos :: CSV</TITLE>
