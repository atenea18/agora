...
class grid_t_grupos_estudiante_nuevos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function grid_t_grupos_estudiante_nuevos_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_t_grupos_estudiante_nuevos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_t_grupos_estudiante_nuevos']['campos_busca']))
      { 
   ...
   function quebra_geral()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_estudiante_nuevos']['contr_total_geral'] = "OK";
   } 
