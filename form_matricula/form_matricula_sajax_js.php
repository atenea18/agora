  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_matricula" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idstudents
  function do_ajax_form_matricula_validate_idstudents()
  {
    var nomeCampo_idstudents = "idstudents";
    var var_idstudents = scAjaxGetFieldSelect(nomeCampo_idstudents);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_idstudents(var_idstudents, var_script_case_init, do_ajax_form_matricula_validate_idstudents_cb);
  } // do_ajax_form_matricula_validate_idstudents

  function do_ajax_form_matricula_validate_idstudents_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_idstudents_cb

  // ---------- Validate year_matricula
  function do_ajax_form_matricula_validate_year_matricula()
  {
    var nomeCampo_year_matricula = "year_matricula";
    var var_year_matricula = scAjaxGetFieldText(nomeCampo_year_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_year_matricula(var_year_matricula, var_script_case_init, do_ajax_form_matricula_validate_year_matricula_cb);
  } // do_ajax_form_matricula_validate_year_matricula

  function do_ajax_form_matricula_validate_year_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_year_matricula_cb

  // ---------- Validate fecha
  function do_ajax_form_matricula_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_matricula_validate_fecha_cb);
  } // do_ajax_form_matricula_validate_fecha

  function do_ajax_form_matricula_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_fecha_cb

  // ---------- Validate id_grado
  function do_ajax_form_matricula_validate_id_grado()
  {
    var nomeCampo_id_grado = "id_grado";
    var var_id_grado = scAjaxGetFieldSelect(nomeCampo_id_grado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_id_grado(var_id_grado, var_script_case_init, do_ajax_form_matricula_validate_id_grado_cb);
  } // do_ajax_form_matricula_validate_id_grado

  function do_ajax_form_matricula_validate_id_grado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_id_grado_cb

  // ---------- Validate id_sede
  function do_ajax_form_matricula_validate_id_sede()
  {
    var nomeCampo_id_sede = "id_sede";
    var var_id_sede = scAjaxGetFieldSelect(nomeCampo_id_sede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_id_sede(var_id_sede, var_script_case_init, do_ajax_form_matricula_validate_id_sede_cb);
  } // do_ajax_form_matricula_validate_id_sede

  function do_ajax_form_matricula_validate_id_sede_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_sede";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_id_sede_cb

  // ---------- Validate id_jornada
  function do_ajax_form_matricula_validate_id_jornada()
  {
    var nomeCampo_id_jornada = "id_jornada";
    var var_id_jornada = scAjaxGetFieldSelect(nomeCampo_id_jornada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_id_jornada(var_id_jornada, var_script_case_init, do_ajax_form_matricula_validate_id_jornada_cb);
  } // do_ajax_form_matricula_validate_id_jornada

  function do_ajax_form_matricula_validate_id_jornada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_id_jornada_cb

  // ---------- Validate semestre
  function do_ajax_form_matricula_validate_semestre()
  {
    var nomeCampo_semestre = "semestre";
    var var_semestre = scAjaxGetFieldRadio(nomeCampo_semestre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matricula_validate_semestre(var_semestre, var_script_case_init, do_ajax_form_matricula_validate_semestre_cb);
  } // do_ajax_form_matricula_validate_semestre

  function do_ajax_form_matricula_validate_semestre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matricula_validate_semestre_cb
  // ---------- Form
  function do_ajax_form_matricula_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_matricula_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_matricula_submit_form(var_idstudents, var_year_matricula, var_fecha, var_id_grado, var_id_sede, var_id_jornada, var_semestre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_matricula_submit_form_cb);
  } // do_ajax_form_matricula_submit_form

  function do_ajax_form_matricula_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_matricula_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_matricula_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_matricula_navigate_form(var_idstudents, var_year_matricula, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_matricula_navigate_form_cb);
  } // do_ajax_form_matricula_navigate_form

  function do_ajax_form_matricula_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_matricula_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_matricula_navigate_form_cb
  function sc_hide_form_matricula_form()
  {
