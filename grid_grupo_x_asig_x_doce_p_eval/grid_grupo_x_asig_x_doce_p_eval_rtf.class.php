...
class grid_grupo_x_asig_x_doce_p_eval_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_grupo_x_asig_x_doce_p_eval_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_grupo_x_asig_x_doce_p_eval.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_p_eval']['contr_erro'] = 'off'; 
   ...
   function NM_export_boton_superar()
   {
         ...
         $this->boton_superar = str_replace('<', '&lt;', $this->boton_superar);
         $this->boton_superar = str_replace('>', '&gt;', $this->boton_superar);
         $this->Texto_tag .= "<td>" . $this->boton_superar . "</td>\r\n";
   }
   //----- evalua_pp
   function NM_export_evalua_pp()
   {
         ...
         $this->evalua_pp = str_replace('<', '&lt;', $this->evalua_pp);
         $this->evalua_pp = str_replace('>', '&gt;', $this->evalua_pp);
         $this->Texto_tag .= "<td>" . $this->evalua_pp . "</td>\r\n";
   }
   //----- evaluar
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
