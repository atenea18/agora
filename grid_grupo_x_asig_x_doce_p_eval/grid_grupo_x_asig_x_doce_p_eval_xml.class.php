...
class grid_grupo_x_asig_x_doce_p_eval_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_grupo_x_asig_x_doce_p_eval_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_grupo_x_asig_x_doce_p_eval.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_grupo_x_asig_x_doce_p_eval";
...
$_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_p_eval']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->boton_superar))
         {
             $this->boton_superar = sc_convert_encoding($this->boton_superar, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " boton_superar =\"" . $this->trata_dados($this->boton_superar) . "\"";
   }
   //----- evalua_pp
   function NM_export_evalua_pp()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evalua_pp))
         {
             $this->evalua_pp = sc_convert_encoding($this->evalua_pp, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evalua_pp =\"" . $this->trata_dados($this->evalua_pp) . "\"";
   }
   //----- evaluar
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
