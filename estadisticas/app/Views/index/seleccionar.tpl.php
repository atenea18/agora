		...
		<div class="row">
			<div class="col-md-4 hidden Jornadas">
				<div class="form-group">
					...
					<select  id="selectGradosN" class="form-control">
			...
			<div class="col-md-4 hidden Jornadas">
				<div class="form-group">
					<label for="">AÑO</label>
					<select  id="selectLectivo" class="form-control">											
						<?php							
			...
			<div class="col-md-4 hidden Jornadas">
				<div class="form-group">
					...
					<select name="sede" id="selectLectivoN" class="form-control">						
						<?php							
							foreach ($novedades as $value) {
								echo "<option value='".$value['id_novedad']."' >".$value['novedad']."</option>";
							}						
						?>
					</select>
				</div>
			...
			<div class="col-md-4 hidden Novedades">
				<div class="form-group">
