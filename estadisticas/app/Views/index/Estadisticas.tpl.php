		...
		<div class="row titles-rows seconds">
								...
								<ul class="nav navbar-nav" >
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li data-accion="click" data-v="EJK" data-value="/Estudiantes/getNovedades/"><a  href="#">Novedades</a></li>
			...
			<div class="col-md-3 ocultar-panel" >
				<form id="idform" action=""  method="post">
					...
					<input type="hidden" name="superacion" id="inputSuperacion">
			...
			<div class="col-md-9  ocultar-panel">
				<div class="form-group" id="gruposCheckbox">
					...
					<label class="radio-inline academicas">
						<input type="checkbox" id="idAcademicas" name=""> Ver Técnicas
					</label>
					...
					<label class="radio-inline informe">
						<input type="checkbox" id="idSuper" name=""> FINAL S.
					</label>
				</div>
			</div>
