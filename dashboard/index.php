...
class dashboard_ini {
    ...
    function init()
    {
        ...
        $this->nm_hr_criacao   = "190514";
        $this->nm_autor_alt    = "admin";
        $this->nm_dt_ult_alt   = "20170403";
        $this->nm_hr_ult_alt   = "065244";
...
class dashboard_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dashboard'] = array(
            'grid_grupo_x_asig_x_doce_p_eval',
            'calendar_calendar',
            'chart_docente_login',
        );
    } // init
...
?>
  ...
  <li class="scContainerWidget widget" id="widget1">
   <div class="widget-head scContainerTitle" >
    ...
    <h3 id="id-title-widget1">Acciones</h3>
   </div>
   <div class="widget-content" style="height: 700px; padding: 0px">
    <iframe id="id-iframe-widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_grupo_x_asig_x_doce_p_eval'); ?>/?sc_proc_container=1&script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>

  <li class="scContainerWidget widget" id="widget11">
   <div class="widget-head scContainerTitle" >
    <img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="widget11" />
    <h3 id="id-title-widget11">Agenda</h3>
   </div>
   <div class="widget-content" style="height: 500px; padding: 0px">
    <iframe id="id-iframe-widget11" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('calendar_calendar'); ?>/?sc_proc_container=1&script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>

  <li class="scContainerWidget widget" id="widget12">
   <div class="widget-head scContainerTitle" >
    <img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="widget12" />
    <h3 id="id-title-widget12">widget12</h3>
   </div>
   <div class="widget-content" style="height: 500px; padding: 0px">
    <iframe id="id-iframe-widget12" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_docente_login'); ?>/?sc_proc_container=1&script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>
...
var widgets_indiv = { widget1: { movable: true, removable: true, collapsible: true, editable: false }, widget11: { movable: true, removable: true, collapsible: true, editable: false }, widget12: { movable: true, removable: true, collapsible: true, editable: false } };
</script>
