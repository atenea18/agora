...
class grid_estudiantes_en_subgrupo_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_estudiantes_en_subgrupo_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_estudiantes_en_subgrupo.xml";
...
$_SESSION['scriptcase']['grid_estudiantes_en_subgrupo']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_estudiantes_en_subgrupo";
   ...
   function NM_export_t_estudiante_subgrupo_idstudent()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->t_estudiante_subgrupo_idstudent))
         {
         ...
         $this->xml_registro .= " t_estudiante_subgrupo_idstudent =\"" . $this->trata_dados($this->t_estudiante_subgrupo_idstudent) . "\"";
   }
   //----- nombre_completo
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
