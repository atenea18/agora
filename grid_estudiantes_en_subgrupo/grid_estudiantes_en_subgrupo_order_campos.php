<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiantes_en_subgrupo_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiantes_en_subgrupo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['t_estudiante_subgrupo_idstudent'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_estudiante_subgrupo_idstudent'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "t_estudiante_subgrupo_idstudent";
   }
   else
   {
       $tab_def_campos['t_estudiante_subgrupo_idstudent'] = "t_estudiante_subgrupo.idstudent";
       $tab_converte["t_estudiante_subgrupo.idstudent"]   = "t_estudiante_subgrupo_idstudent";
   }
   $tab_labels["t_estudiante_subgrupo_idstudent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['labels']["t_estudiante_subgrupo_idstudent"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['labels']["t_estudiante_subgrupo_idstudent"] : "Idstudent";
   ...
   {
       $tab_def_campos['nombre_completo'] = "CONCAT_WS(' ',students.primer_apellido,students.segundo_apellido,students.primer_nombre,students.segundo_nombre)";
       $tab_converte["CONCAT_WS(' ',students.primer_apellido,students.segundo_apellido,students.primer_nombre,students.segundo_nombre)"]   = "nombre_completo";
   }
   $tab_labels["nombre_completo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['labels']["nombre_completo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['labels']["nombre_completo"] : "Nombre Completo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiantes_en_subgrupo_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_en_subgrupo']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
