...
class grid_estudiantes_en_subgrupo_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_estudiantes_en_subgrupo_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo    .= ".csv";
      $this->Tit_doc    = "grid_estudiantes_en_subgrupo.csv";
      $this->Delim_dados = "\"";
      $this->Delim_col   = ";";
      $this->Delim_line  = "\r\n";
   }
...
$_SESSION['scriptcase']['grid_estudiantes_en_subgrupo']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['csv_name']);
      }
   ...
   function NM_export_t_estudiante_subgrupo_idstudent()
   {
      ...
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->t_estudiante_subgrupo_idstudent);
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_en_subgrupo']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
