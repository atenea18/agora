...
//
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['SC_Gb_Free_cmp']))
   { 
...
//
   ...
   { 
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_quebra'][$nmgp_ordem])) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] = "inicio" ;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_grid'] = ""; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_quebra'][$nmgp_ordem] == "asc") 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_quebra'][$nmgp_ordem] = "desc"; 
           }   
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_quebra'][$nmgp_ordem] = "asc"; 
           }   
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] = $nmgp_ordem;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_quebra'][$nmgp_ordem]);  
       }   
       else   
       { 
...
//----- 
   ...
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] == "pdf" || isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['paginacao']))
   {
   ...
   { 
       ...
       $this->tel_fijo = $this->rs_grid->fields[1] ;  
       $this->tel_celular = $this->rs_grid->fields[2] ;  
       $this->email = $this->rs_grid->fields[3] ;  
       $this->direccion = $this->rs_grid->fields[4] ;  
       $this->id_area = $this->rs_grid->fields[5] ;  
       $this->id_area = (string)$this->id_area;
       $this->foto = $this->rs_grid->fields[6] ;  
       $this->id_docente = $this->rs_grid->fields[7] ;  
       $this->id_docente = (string)$this->id_docente;
       $this->primer_apellido = $this->rs_grid->fields[8] ;  
       $this->segundo_apellido = $this->rs_grid->fields[9] ;  
       $this->primer_nombre = $this->rs_grid->fields[10] ;  
       $this->segundo_nombre = $this->rs_grid->fields[11] ;  
       $GLOBALS["id_area"] = $this->rs_grid->fields[5] ;  
...
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-grid_docentes-1\");\r\n");
 ...
 {  
   ...
   $this->css_nom_completo_label = $compl_css_emb . "css_nom_completo_label";
   $this->css_nom_completo_grid_line = $compl_css_emb . "css_nom_completo_grid_line";
   $this->css_tel_fijo_label = $compl_css_emb . "css_tel_fijo_label";
   $this->css_tel_fijo_grid_line = $compl_css_emb . "css_tel_fijo_grid_line";
   $this->css_tel_celular_label = $compl_css_emb . "css_tel_celular_label";
   $this->css_tel_celular_grid_line = $compl_css_emb . "css_tel_celular_grid_line";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_segundo_nombre_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_documento()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] == 'documento')
      {
 ...
 function NM_label_nom_completo()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nom_completo'])) ? $this->New_label['nom_completo'] : "Nombre"; 
   if (!isset($this->NM_cmp_hidden['nom_completo']) || $this->NM_cmp_hidden['nom_completo'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_nom_completo_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nom_completo_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_tel_fijo()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['tel_fijo'])) ? $this->New_label['tel_fijo'] : "Tel Fijo"; 
   if (!isset($this->NM_cmp_hidden['tel_fijo']) || $this->NM_cmp_hidden['tel_fijo'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_tel_fijo_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tel_fijo_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_tel_celular()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['tel_celular'])) ? $this->New_label['tel_celular'] : "Tel Celular"; 
   if (!isset($this->NM_cmp_hidden['tel_celular']) || $this->NM_cmp_hidden['tel_celular'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_tel_celular_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tel_celular_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 ...
 function NM_label_direccion()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_direccion_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_direccion_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_id_area()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_id_area_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_id_area_label'] . "\" NOWRAP WIDTH=\"300px\">" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 ...
 function NM_label_id_docente()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] == 'id_docente')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_primer_apellido()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] == 'primer_apellido')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_segundo_apellido()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] == 'segundo_apellido')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_primer_nombre()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] == 'primer_nombre')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_segundo_nombre()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_cmp'] == 'segundo_nombre')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
// 
   $SC_Label = (isset($this->New_label['documento'])) ? $this->New_label['documento'] : "Documento"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['documento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nom_completo'])) ? $this->New_label['nom_completo'] : "Nombre"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['nom_completo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tel_fijo'])) ? $this->New_label['tel_fijo'] : "Tel Fijo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['tel_fijo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tel_celular'])) ? $this->New_label['tel_celular'] : "Tel Celular"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['tel_celular'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['email'])) ? $this->New_label['email'] : "Email"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['direccion'])) ? $this->New_label['direccion'] : "Direccion"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_area'])) ? $this->New_label['id_area'] : "Area"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['id_area'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['foto'])) ? $this->New_label['foto'] : "Foto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['foto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_docente'])) ? $this->New_label['id_docente'] : "Id Docente"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['id_docente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['primer_apellido'])) ? $this->New_label['primer_apellido'] : "Primer Apellido"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['primer_apellido'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['segundo_apellido'])) ? $this->New_label['segundo_apellido'] : "Segundo Apellido"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['segundo_apellido'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['primer_nombre'])) ? $this->New_label['primer_nombre'] : "Primer Nombre"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['primer_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['segundo_nombre'])) ? $this->New_label['segundo_nombre'] : "Segundo Nombre"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['labels']['segundo_nombre'] = $SC_Label; 
...
// 
   ...
   {  
          ...
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
...
$_SESSION['scriptcase']['grid_docentes']['contr_erro'] = 'off';
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "id_docente?#?" . str_replace('"', "@aspasd@", $this->id_docente) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              ...
              {
                  $Md5_Edt  = "id_docente?#?" . str_replace('"', "@aspasd@", $this->id_docente) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_docentes . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_docentes', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_docentes . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_docentes', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->id_docente . "?@?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_docentes@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
 ...
 function NM_grid_nom_completo()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nom_completo']) || $this->NM_cmp_hidden['nom_completo'] != "off") { 
          $conteudo = sc_strip_script($this->nom_completo); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nom_completo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nom_completo_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nom_completo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_tel_fijo()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['tel_fijo']) || $this->NM_cmp_hidden['tel_fijo'] != "off") { 
          $conteudo = sc_strip_script($this->tel_fijo); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_tel_fijo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_tel_fijo_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_tel_fijo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_tel_celular()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['tel_celular']) || $this->NM_cmp_hidden['tel_celular'] != "off") { 
          $conteudo = sc_strip_script($this->tel_celular); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_tel_celular_grid_line . "\"  style=\"" . $this->Css_Cmp['css_tel_celular_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_tel_celular_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_foto()
 {
      ...
      if (!isset($this->NM_cmp_hidden['foto']) || $this->NM_cmp_hidden['foto'] != "off") { 
          ...
          { 
              ...
              $NM_redim_img = true;
              $out_foto = $this->Ini->path_imag_temp . "/sc_foto_7580" . $md5_foto . ".jpg" ;  
              if (is_file($this->Ini->root . $out_foto))  
              { 
                  $NM_img_time = filemtime($this->Ini->root . $out_foto) + 0; 
                  if ($this->Ini->nm_timestamp < $NM_img_time)  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_foto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_foto_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_foto_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_docentes/grid_docentes_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_docentes/grid_docentes_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $UseAlias =  "S";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_docentes/grid_docentes_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_docentes/grid_docentes_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_docentes/grid_docentes_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_docentes/grid_docentes_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
        ...
        if (!$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['mostra_edit'] != "N" && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
           $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
           if (isset($this->Ini->sc_lig_md5["form_docentes"]) && $this->Ini->sc_lig_md5["form_docentes"] == "S") {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['paginacao']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['paginacao']))
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['nav']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_docentes']['opc_liga']['nav']))
          {
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_docentes/grid_docentes_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_docentes/grid_docentes_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=print&tp_print=' + tp + '&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
   $nm_saida->saida("   }\r\n");
