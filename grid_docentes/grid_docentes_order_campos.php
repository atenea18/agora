<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_docentes_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_docentes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["documento"]   = "documento";
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["documento"] : "Documento";
   $tab_ger_campos['nom_completo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nom_completo'] = "nom_completo";
       $tab_converte["nom_completo"]   = "nom_completo";
   }
   else
   {
       $tab_def_campos['nom_completo'] = "";
       $tab_converte[""]   = "nom_completo";
   }
   $tab_labels["nom_completo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["nom_completo"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["nom_completo"] : "Nombre";
   $tab_ger_campos['tel_fijo'] = "on";
   $tab_def_campos['tel_fijo'] = "tel_fijo";
   $tab_converte["tel_fijo"]   = "tel_fijo";
   $tab_labels["tel_fijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["tel_fijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["tel_fijo"] : "Tel Fijo";
   $tab_ger_campos['tel_celular'] = "on";
   $tab_def_campos['tel_celular'] = "tel_celular";
   $tab_converte["tel_celular"]   = "tel_celular";
   $tab_labels["tel_celular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["tel_celular"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["tel_celular"] : "Tel Celular";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["email"] : "Email";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_converte["direccion"]   = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['id_area'] = "on";
   $tab_def_campos['id_area'] = "id_area";
   $tab_converte["id_area"]   = "id_area";
   $tab_labels["id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["id_area"] : "Area";
   $tab_ger_campos['foto'] = "on";
   $tab_def_campos['foto'] = "foto";
   $tab_converte["foto"]   = "foto";
   $tab_labels["foto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["foto"])) ? $_SESSION['sc_session'][$sc_init]['grid_docentes']['labels']["foto"] : "Foto";
   $tab_ger_campos['nom_completo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_docentes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_docentes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - docentes</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_docentes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_docentes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
