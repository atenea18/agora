...
class grid_t_estudiante_grupo_4_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_t_estudiante_grupo_4_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_t_estudiante_grupo_4_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_t_estudiante_grupo_4_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_t_estudiante_grupo_4_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idstudent')
      {
          $idstudent = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idstudent($idstudent);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idstudent($idstudent)
   {
      $idstudent = substr($this->Db->qstr($idstudent), 1, -1);
            $idstudent_look = substr($this->Db->qstr($idstudent), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idstudent from " . $this->Ini->nm_tabela . " where  idstudent like '%" . $idstudent . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct idstudent from " . $this->Ini->nm_tabela . " where  idstudent like '%" . $idstudent . "%'"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "t_estudiante_grupo.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - t_estudiante_grupo</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_t_estudiante_grupo_4/grid_t_estudiante_grupo_4_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_t_estudiante_grupo_4_ajax_search.js"></script>
 <script type="text/javascript" src="grid_t_estudiante_grupo_4_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idstudent_cond#NMF#' + search_get_sel_txt('SC_idstudent_cond') + '@NMF@';
  str_out += 'SC_idstudent#NMF#' + search_get_text('SC_idstudent') + '@NMF@';
  str_out += 'id_ac_idstudent#NMF#' + search_get_text('id_ac_idstudent') + '@NMF@';
  str_out += 'SC_idstudent_input_2#NMF#' + search_get_text('SC_idstudent_input_2') + '@NMF@';
   ...
   $("#id_ac_idstudent").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idstudent",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_idstudent").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idstudent").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - t_estudiante_grupo</span></td>
...
<?php
   ...
   {
      global 
             $idstudent_cond, $idstudent, $idstudent_input_2, $idstudent_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idstudent = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['idstudent']; 
          $idstudent_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['idstudent_input_2']; 
          $idstudent_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['idstudent_cond']; 
          $entorno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['entorno']; 
          $entorno_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['entorno_input_2']; 
          $entorno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['entorno_cond']; 
          $id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['id_grupo']; 
          $id_grupo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['id_grupo_input_2']; 
          $id_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['id_grupo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idstudent_cond) || empty($idstudent_cond))
      {
         $idstudent_cond = "gt";
      }
      ...
      $str_hide_idstudent = (in_array($idstudent_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_idstudent = ('bw' == $idstudent_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($idstudent) || $idstudent == "")
      {
          $idstudent = "";
      }
      if (isset($idstudent) && !empty($idstudent))
      {
         $tmp_pos = strpos($idstudent, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idstudent = substr($idstudent, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_t_estudiante_grupo_4_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idstudent'])) ? $this->New_label['idstudent'] : "Idstudent"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idstudent_cond" name="idstudent_cond" onChange="nm_campos_between(document.getElementById('id_vis_idstudent'), this, 'idstudent')">
       <OPTION value="gt" <?php if ("gt" == $idstudent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idstudent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idstudent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idstudent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idstudent" <?php echo $str_hide_idstudent?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idstudent'])) ? $this->New_label['idstudent'] : "Idstudent";
 $nmgp_tab_label .= "idstudent?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $idstudent_look = substr($this->Db->qstr($idstudent), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idstudent from " . $this->Ini->nm_tabela . " where idstudent = $idstudent_look"; 
      }
      else
      {
          $nm_comando = "select distinct idstudent from " . $this->Ini->nm_tabela . " where idstudent = $idstudent_look"; 
      ...
      if (isset($nmgp_def_dados[0][$idstudent]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idstudent];
      }
      else
      {
          $sAutocompValue = $idstudent;
      }
?>
<INPUT  type="text" id="SC_idstudent" name="idstudent" value="<?php echo NM_encode_input($idstudent) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idstudent" name="idstudent_autocomp" size="19" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idstudent"  <?php echo $str_display_idstudent; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idstudent_input_2" name="idstudent_input_2" value="<?php echo NM_encode_input($idstudent_input_2) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<INPUT  type="text" id="SC_entorno" name="entorno" value="<?php echo NM_encode_input($entorno) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_entorno" name="entorno_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_entorno"  <?php echo $str_display_entorno; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_entorno_input_2" name="entorno_input_2" value="<?php echo NM_encode_input($entorno_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_grupo'])) ? $this->New_label['id_grupo'] : "Id Grupo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_estudiante_grupo_4']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_estudiante_grupo_4']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idstudent'), document.F1.idstudent_cond, 'idstudent');
   document.F1.idstudent.value = "";
   document.F1.idstudent_autocomp.value = "";
   document.F1.idstudent_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_t_estudiante_grupo_4";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_t_estudiante_grupo_4/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_idstudent_cond'] = 'cond';
      $tp_fields['SC_idstudent'] = 'text_aut';
      $tp_fields['id_ac_idstudent'] = 'text_aut';
      $tp_fields['SC_idstudent_input_2'] = 'text';
   ...
   {
      global $idstudent_cond, $idstudent, $idstudent_input_2, $idstudent_autocomp,
             $entorno_cond, $entorno, $entorno_input_2, $entorno_autocomp,
      ...
      if (!empty($idstudent_autocomp) && empty($idstudent))
      {
          $idstudent = $idstudent_autocomp;
      }
      ...
      $idstudent_cond_salva = $idstudent_cond; 
      if (!isset($idstudent_input_2) || $idstudent_input_2 == "")
      {
          $idstudent_input_2 = $idstudent;
      }
      ...
      if ($idstudent_cond != "in")
      {
          nm_limpa_numero($idstudent, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $idstudent);
          ...
          $idstudent = implode(",", $Nm_sc_valores);
      }
      if ($idstudent_cond != "in")
      {
          nm_limpa_numero($idstudent_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($entorno_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['idstudent'] = $idstudent; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['idstudent_input_2'] = $idstudent_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['idstudent_cond'] = $idstudent_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['entorno'] = $entorno; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['entorno_input_2'] = $entorno_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['entorno_cond'] = $entorno_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['id_grupo'] = $id_grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['id_grupo_input_2'] = $id_grupo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['id_grupo_cond'] = $id_grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($idstudent_cond != "in" && $idstudent_cond != "bw" && !empty($idstudent) && !is_numeric($idstudent))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idstudent";
      }
      if ($idstudent_cond == "bw" && ((!empty($idstudent) && !is_numeric($idstudent)) || (!empty($idstudent_input_2) && !is_numeric($idstudent_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idstudent";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idstudent'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idstudent'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idstudent'] = $idstudent;
      }
      $Conteudo = $idstudent_input_2;
      if (strtoupper($idstudent_cond) != "II" && strtoupper($idstudent_cond) != "QP" && strtoupper($idstudent_cond) != "NP" && strtoupper($idstudent_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idstudent_input_2'] = $Conteudo;
      $entorno_look = substr($this->Db->qstr($entorno), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($entorno))
   { 
   ...
   { 
      ...
      if (isset($idstudent) || $idstudent_cond == "nu" || $idstudent_cond == "nn" || $idstudent_cond == "ep" || $idstudent_cond == "ne")
      {
         $this->monta_condicao("idstudent", $idstudent_cond, $idstudent, $idstudent_input_2, "idstudent");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_estudiante_grupo_4']['where_pesq_ant'] = $this->comando . $this->comando_fim;
