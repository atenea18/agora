...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_informe_general/control_informe_general_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_informe_general_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_informe_general_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_estudent", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_informe_general.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['recarga'];
}
?>
...
<?php
 include_once("control_informe_general_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_informe_general'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_informe_general'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_informe_general']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_informe_general");
 parent.scAjaxDetailHeight("control_informe_general", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
