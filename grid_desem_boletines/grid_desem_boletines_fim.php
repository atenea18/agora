...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_desem_boletines"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_desem_boletines"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_desem_boletines</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_desem_boletines']['embutida_filho'] as $ind => $sc_init)
          {
