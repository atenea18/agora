...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_t_subgrupos_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_t_subgrupos_1"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_t_subgrupos_1</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_t_subgrupos_1']['embutida_filho'] as $ind => $sc_init)
          {
