...
class grid_novedades_x_estudiante_fecha_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_novedades_x_estudiante_fecha_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_novedades_x_estudiante_fecha_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_novedades_x_estudiante_fecha_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_novedades_x_estudiante_fecha_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_naf')
      {
          $id_naf = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_naf($id_naf);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_novedad')
      {
          $id_novedad = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_novedad($id_novedad);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_naf($id_naf)
   {
      $id_naf = substr($this->Db->qstr($id_naf), 1, -1);
            $id_naf_look = substr($this->Db->qstr($id_naf), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_naf from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and  id_naf like '%" . $id_naf . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_naf from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and  id_naf like '%" . $id_naf . "%'"; 
   ...
   function lookup_ajax_idstudents($idstudents)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and  idstudents like '%" . $idstudents . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and  idstudents like '%" . $idstudents . "%'"; 
   ...
   function lookup_ajax_id_novedad($id_novedad)
   {
      $id_novedad = substr($this->Db->qstr($id_novedad), 1, -1);
            $id_novedad_look = substr($this->Db->qstr($id_novedad), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and  id_novedad like '%" . $id_novedad . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and  id_novedad like '%" . $id_novedad . "%'"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "novedades_x_estudiante_fecha.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - novedades_x_estudiante_fecha</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_novedades_x_estudiante_fecha/grid_novedades_x_estudiante_fecha_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_novedades_x_estudiante_fecha_ajax_search.js"></script>
 <script type="text/javascript" src="grid_novedades_x_estudiante_fecha_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_naf_cond#NMF#' + search_get_sel_txt('SC_id_naf_cond') + '@NMF@';
  str_out += 'SC_id_naf#NMF#' + search_get_text('SC_id_naf') + '@NMF@';
  str_out += 'id_ac_id_naf#NMF#' + search_get_text('id_ac_id_naf') + '@NMF@';
  str_out += 'SC_id_naf_input_2#NMF#' + search_get_text('SC_id_naf_input_2') + '@NMF@';
  ...
  str_out += 'SC_id_novedad_cond#NMF#' + search_get_sel_txt('SC_id_novedad_cond') + '@NMF@';
  str_out += 'SC_id_novedad#NMF#' + search_get_text('SC_id_novedad') + '@NMF@';
  str_out += 'id_ac_id_novedad#NMF#' + search_get_text('id_ac_id_novedad') + '@NMF@';
  str_out += 'SC_id_novedad_input_2#NMF#' + search_get_text('SC_id_novedad_input_2') + '@NMF@';
   ...
   $("#id_ac_id_naf").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_naf",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_naf").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_naf").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_id_novedad").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_novedad",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_id_novedad").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_novedad").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - novedades_x_estudiante_fecha</span></td>
...
<?php
   ...
   {
      global 
             $id_naf_cond, $id_naf, $id_naf_input_2, $id_naf_autocomp,
             $idstudents_cond, $idstudents, $idstudents_input_2, $idstudents_autocomp,
             $id_novedad_cond, $id_novedad, $id_novedad_input_2, $id_novedad_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_naf = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_naf']; 
          $id_naf_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_naf_input_2']; 
          $id_naf_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_naf_cond']; 
          $idstudents = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['idstudents']; 
          $idstudents_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['idstudents_input_2']; 
          $idstudents_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['idstudents_cond']; 
          $id_novedad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_novedad']; 
          $id_novedad_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_novedad_input_2']; 
          $id_novedad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_novedad_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_naf_cond) || empty($id_naf_cond))
      {
         $id_naf_cond = "gt";
      }
      ...
      if (!isset($id_novedad_cond) || empty($id_novedad_cond))
      {
         $id_novedad_cond = "gt";
      }
      ...
      $str_hide_id_naf = (in_array($id_naf_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idstudents = (in_array($idstudents_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_novedad = (in_array($id_novedad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fecha = (in_array($fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_naf = ('bw' == $id_naf_cond) ? $display_aberto : $display_fechado;
      $str_display_idstudents = ('bw' == $idstudents_cond) ? $display_aberto : $display_fechado;
      $str_display_id_novedad = ('bw' == $id_novedad_cond) ? $display_aberto : $display_fechado;
      $str_display_fecha = ('bw' == $fecha_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_naf) || $id_naf == "")
      {
          $id_naf = "";
      }
      if (isset($id_naf) && !empty($id_naf))
      {
         $tmp_pos = strpos($id_naf, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_naf = substr($id_naf, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($id_novedad) || $id_novedad == "")
      {
          $id_novedad = "";
      }
      if (isset($id_novedad) && !empty($id_novedad))
      {
         $tmp_pos = strpos($id_novedad, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_novedad = substr($id_novedad, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_novedades_x_estudiante_fecha_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_naf'])) ? $this->New_label['id_naf'] : "Id Naf"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_naf_cond" name="id_naf_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_naf'), this, 'id_naf')">
       <OPTION value="gt" <?php if ("gt" == $id_naf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_naf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_naf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_naf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_naf" <?php echo $str_hide_id_naf?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_naf'])) ? $this->New_label['id_naf'] : "Id Naf";
 $nmgp_tab_label .= "id_naf?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_naf_look = substr($this->Db->qstr($id_naf), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_naf))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_naf from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and id_naf = $id_naf_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_naf from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and id_naf = $id_naf_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_naf]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_naf];
      }
      else
      {
          $sAutocompValue = $id_naf;
      }
?>
<INPUT  type="text" id="SC_id_naf" name="id_naf" value="<?php echo NM_encode_input($id_naf) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_naf" name="id_naf_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_naf"  <?php echo $str_display_id_naf; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_naf_input_2" name="id_naf_input_2" value="<?php echo NM_encode_input($id_naf_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and idstudents = $idstudents_look"; 
      }
      else
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and idstudents = $idstudents_look"; 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_idstudents" name="idstudents_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idstudents"  <?php echo $str_display_idstudents; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idstudents_input_2" name="idstudents_input_2" value="<?php echo NM_encode_input($idstudents_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_novedad'])) ? $this->New_label['id_novedad'] : "Id Novedad"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_novedad_cond" name="id_novedad_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_novedad'), this, 'id_novedad')">
       <OPTION value="gt" <?php if ("gt" == $id_novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_novedad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_novedad" <?php echo $str_hide_id_novedad?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_novedad'])) ? $this->New_label['id_novedad'] : "Id Novedad";
 $nmgp_tab_label .= "id_novedad?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_novedad_look = substr($this->Db->qstr($id_novedad), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_novedad))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and id_novedad = $id_novedad_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_novedad from " . $this->Ini->nm_tabela . " where idstudents = " . $_SESSION['par_idestudiante'] . " and id_novedad = $id_novedad_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_novedad]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_novedad];
      }
      else
      {
          $sAutocompValue = $id_novedad;
      }
?>
<INPUT  type="text" id="SC_id_novedad" name="id_novedad" value="<?php echo NM_encode_input($id_novedad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_novedad" name="id_novedad_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_novedad"  <?php echo $str_display_id_novedad; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_novedad_input_2" name="id_novedad_input_2" value="<?php echo NM_encode_input($id_novedad_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_input_2_dia" name="fecha_input_2_dia" value="<?php echo NM_encode_input($fecha_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.fecha_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_input_2_mes" name="fecha_input_2_mes" value="<?php echo NM_encode_input($fecha_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.fecha_cond.value)">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_novedades_x_estudiante_fecha']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_novedades_x_estudiante_fecha']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_naf'), document.F1.id_naf_cond, 'id_naf');
   document.F1.id_naf.value = "";
   document.F1.id_naf_autocomp.value = "";
   document.F1.id_naf_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_id_novedad'), document.F1.id_novedad_cond, 'id_novedad');
   document.F1.id_novedad.value = "";
   document.F1.id_novedad_autocomp.value = "";
   document.F1.id_novedad_input_2.value = "";
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_novedades_x_estudiante_fecha_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_novedades_x_estudiante_fecha_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_novedades_x_estudiante_fecha_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_novedades_x_estudiante_fecha_valida_mes(this)});
 }
 function sc_grid_novedades_x_estudiante_fecha_valida_dia(obj)
 {
 ...
 function sc_grid_novedades_x_estudiante_fecha_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_novedades_x_estudiante_fecha";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_novedades_x_estudiante_fecha/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_naf_cond'] = 'cond';
      $tp_fields['SC_id_naf'] = 'text_aut';
      $tp_fields['id_ac_id_naf'] = 'text_aut';
      $tp_fields['SC_id_naf_input_2'] = 'text';
      ...
      $tp_fields['SC_id_novedad_cond'] = 'cond';
      $tp_fields['SC_id_novedad'] = 'text_aut';
      $tp_fields['id_ac_id_novedad'] = 'text_aut';
      $tp_fields['SC_id_novedad_input_2'] = 'text';
   ...
   {
      global $id_naf_cond, $id_naf, $id_naf_input_2, $id_naf_autocomp,
             $idstudents_cond, $idstudents, $idstudents_input_2, $idstudents_autocomp,
             $id_novedad_cond, $id_novedad, $id_novedad_input_2, $id_novedad_autocomp,
      ...
      if (!empty($id_naf_autocomp) && empty($id_naf))
      {
          $id_naf = $id_naf_autocomp;
      }
      if (!empty($idstudents_autocomp) && empty($idstudents))
      {
          $idstudents = $idstudents_autocomp;
      }
      if (!empty($id_novedad_autocomp) && empty($id_novedad))
      {
          $id_novedad = $id_novedad_autocomp;
      }
      $id_naf_cond_salva = $id_naf_cond; 
      if (!isset($id_naf_input_2) || $id_naf_input_2 == "")
      {
          $id_naf_input_2 = $id_naf;
      }
      ...
      $id_novedad_cond_salva = $id_novedad_cond; 
      if (!isset($id_novedad_input_2) || $id_novedad_input_2 == "")
      {
          $id_novedad_input_2 = $id_novedad;
      }
      ...
      if ($id_naf_cond != "in")
      {
          nm_limpa_numero($id_naf, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_naf);
          ...
          $id_naf = implode(",", $Nm_sc_valores);
      }
      if ($id_naf_cond != "in")
      {
          nm_limpa_numero($id_naf_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      if ($id_novedad_cond != "in")
      {
          nm_limpa_numero($id_novedad, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_novedad);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $id_novedad = implode(",", $Nm_sc_valores);
      }
      if ($id_novedad_cond != "in")
      {
          nm_limpa_numero($id_novedad_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_naf'] = $id_naf; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_naf_input_2'] = $id_naf_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_naf_cond'] = $id_naf_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['idstudents'] = $idstudents; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['idstudents_input_2'] = $idstudents_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['idstudents_cond'] = $idstudents_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_novedad'] = $id_novedad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_novedad_input_2'] = $id_novedad_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['id_novedad_cond'] = $id_novedad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_naf_cond != "in" && $id_naf_cond != "bw" && !empty($id_naf) && !is_numeric($id_naf))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Naf";
      }
      if ($id_naf_cond == "bw" && ((!empty($id_naf) && !is_numeric($id_naf)) || (!empty($id_naf_input_2) && !is_numeric($id_naf_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Naf";
      }
      ...
      if ($id_novedad_cond != "in" && $id_novedad_cond != "bw" && !empty($id_novedad) && !is_numeric($id_novedad))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Novedad";
      }
      if ($id_novedad_cond == "bw" && ((!empty($id_novedad) && !is_numeric($id_novedad)) || (!empty($id_novedad_input_2) && !is_numeric($id_novedad_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Novedad";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_naf'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_naf'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_naf'] = $id_naf;
      }
      $Conteudo = $id_naf_input_2;
      if (strtoupper($id_naf_cond) != "II" && strtoupper($id_naf_cond) != "QP" && strtoupper($id_naf_cond) != "NP" && strtoupper($id_naf_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_naf_input_2'] = $Conteudo;
      $idstudents_look = substr($this->Db->qstr($idstudents), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idstudents))
   { 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_novedad'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_novedad'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_novedad'] = $id_novedad;
      }
      $Conteudo = $id_novedad_input_2;
      if (strtoupper($id_novedad_cond) != "II" && strtoupper($id_novedad_cond) != "QP" && strtoupper($id_novedad_cond) != "NP" && strtoupper($id_novedad_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_novedad_input_2'] = $Conteudo;

      //----- $id_naf
      $this->Date_part = false;
      if (isset($id_naf) || $id_naf_cond == "nu" || $id_naf_cond == "nn" || $id_naf_cond == "ep" || $id_naf_cond == "ne")
      {
         $this->monta_condicao("id_naf", $id_naf_cond, $id_naf, $id_naf_input_2, "id_naf");
      }
      ...
      //----- $id_novedad
      $this->Date_part = false;
      if (isset($id_novedad) || $id_novedad_cond == "nu" || $id_novedad_cond == "nn" || $id_novedad_cond == "ep" || $id_novedad_cond == "ne")
      {
         $this->monta_condicao("id_novedad", $id_novedad_cond, $id_novedad, $id_novedad_input_2, "id_novedad");
      }
      ...
      if ($fecha_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']['fecha_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_novedades_x_estudiante_fecha']['where_pesq_ant'] = $this->comando . $this->comando_fim;
