<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_novedades_x_estudiante_fecha_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_novedades_x_estudiante_fecha_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_naf'] = "on";
   $tab_def_campos['id_naf'] = "id_naf";
   $tab_converte["id_naf"]   = "id_naf";
   $tab_labels["id_naf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["id_naf"])) ? $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["id_naf"] : "Id Naf";
   $tab_ger_campos['idstudents'] = "on";
   $tab_def_campos['idstudents'] = "idstudents";
   $tab_converte["idstudents"]   = "idstudents";
   $tab_labels["idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["idstudents"] : "Idstudents";
   $tab_ger_campos['id_novedad'] = "on";
   $tab_def_campos['id_novedad'] = "id_novedad";
   $tab_converte["id_novedad"]   = "id_novedad";
   $tab_labels["id_novedad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["id_novedad"])) ? $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["id_novedad"] : "Id Novedad";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_converte["observaciones"]   = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - novedades_x_estudiante_fecha</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_novedades_x_estudiante_fecha_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_novedades_x_estudiante_fecha']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
