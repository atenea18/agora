...
class grid_t_grupos_calif_m_normal_cero_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function grid_t_grupos_calif_m_normal_cero_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_t_grupos_calif_m_normal_cero']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_t_grupos_calif_m_normal_cero']['campos_busca']))
      { 
   ...
   function quebra_geral()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_normal_cero']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_normal_cero']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_normal_cero']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_normal_cero']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_normal_cero']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_calif_m_normal_cero']['contr_total_geral'] = "OK";
   } 
   ...
   //----- 
   function resumo_grupos($destino_resumo, &$array_total_t_grupos_id_grupo, &$array_total_grupo_x_asig_x_doce_id_asignatura, &$array_total_grupo_x_asig_x_doce_id_docente)
   {
   ...
   $nmgp_order_by = " order by t_grupos.id_grupo asc, grupo_x_asig_x_doce.id_asignatura asc, grupo_x_asig_x_doce.id_docente asc"; 
     $comando  = "select count(*), t_grupos.id_grupo, grupo_x_asig_x_doce.id_asignatura, grupo_x_asig_x_doce.id_docente from " . $this->Ini->nm_tabela . " " . $this->sc_where_atual . " group by t_grupos.id_grupo, grupo_x_asig_x_doce.id_asignatura, grupo_x_asig_x_doce.id_docente  " . $nmgp_order_by;
      ...
      foreach ($array_db_total as $registro)
      {
        ...
        nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         ...
         $grupo_x_asig_x_doce_id_docente      = $registro[3];
         $grupo_x_asig_x_doce_id_docente_orig = $registro[3];
         $conteudo = $registro[3];
         ...
         if (isset($t_grupos_id_grupo_orig))
         {
            ...
            {
               //-----  grupo_x_asig_x_doce_id_asignatura
               if (!isset($array_total_grupo_x_asig_x_doce_id_asignatura[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig]))
               {
                  $array_total_grupo_x_asig_x_doce_id_asignatura[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][0] = $registro[0];
                  $array_total_grupo_x_asig_x_doce_id_asignatura[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][1] = NM_encode_input(sc_strip_script($val_grafico_grupo_x_asig_x_doce_id_asignatura));
                  $array_total_grupo_x_asig_x_doce_id_asignatura[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][2] = $grupo_x_asig_x_doce_id_asignatura_orig;
               }
               else
               {
                  $array_total_grupo_x_asig_x_doce_id_asignatura[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][0] += $registro[0];
               ...
               {
                  //-----  grupo_x_asig_x_doce_id_docente
                  if (!isset($array_total_grupo_x_asig_x_doce_id_docente[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][$grupo_x_asig_x_doce_id_docente_orig]))
                  {
                     $array_total_grupo_x_asig_x_doce_id_docente[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][$grupo_x_asig_x_doce_id_docente_orig][0] = $registro[0];
                     $array_total_grupo_x_asig_x_doce_id_docente[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][$grupo_x_asig_x_doce_id_docente_orig][1] = NM_encode_input(sc_strip_script($val_grafico_grupo_x_asig_x_doce_id_docente));
                     $array_total_grupo_x_asig_x_doce_id_docente[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][$grupo_x_asig_x_doce_id_docente_orig][2] = $grupo_x_asig_x_doce_id_docente_orig;
                  }
                  else
                  {
                     $array_total_grupo_x_asig_x_doce_id_docente[$t_grupos_id_grupo_orig][$grupo_x_asig_x_doce_id_asignatura_orig][$grupo_x_asig_x_doce_id_docente_orig][0] += $registro[0];
