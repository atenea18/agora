<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_desempeno_docente_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_desempeno_docente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['desempeno_codigo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desempeno_codigo'] = "desempeno_codigo";
       $tab_converte["desempeno_codigo"]   = "desempeno_codigo";
   }
   else
   {
       $tab_def_campos['desempeno_codigo'] = "desempeno.codigo";
       $tab_converte["desempeno.codigo"]   = "desempeno_codigo";
   }
   $tab_labels["desempeno_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_codigo"] : "CÓDIGO";
   $tab_ger_campos['desempeno_periodos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desempeno_periodos'] = "desempeno_periodos";
       $tab_converte["desempeno_periodos"]   = "desempeno_periodos";
   }
   else
   {
       $tab_def_campos['desempeno_periodos'] = "desempeno.periodos";
       $tab_converte["desempeno.periodos"]   = "desempeno_periodos";
   }
   $tab_labels["desempeno_periodos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_periodos"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_periodos"] : "PERÍODO";
   $tab_ger_campos['desempeno_superior'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desempeno_superior'] = "desempeno_superior";
       $tab_converte["desempeno_superior"]   = "desempeno_superior";
   }
   else
   {
       $tab_def_campos['desempeno_superior'] = "desempeno.superior";
       $tab_converte["desempeno.superior"]   = "desempeno_superior";
   }
   $tab_labels["desempeno_superior"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_superior"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_superior"] : "DESEMPEÑO";
   $tab_ger_campos['desempeno_id_asignatura'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desempeno_id_asignatura'] = "desempeno_id_asignatura";
       $tab_converte["desempeno_id_asignatura"]   = "desempeno_id_asignatura";
   }
   else
   {
       $tab_def_campos['desempeno_id_asignatura'] = "desempeno.id_asignatura";
       $tab_converte["desempeno.id_asignatura"]   = "desempeno_id_asignatura";
   }
   $tab_labels["desempeno_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["desempeno_id_asignatura"] : "ASIGNATURA";
   $tab_ger_campos['rel_desemp_posicion_id_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rel_desemp_posicion_id_grupo'] = "rel_desemp_posicion_id_grupo";
       $tab_converte["rel_desemp_posicion_id_grupo"]   = "rel_desemp_posicion_id_grupo";
   }
   else
   {
       $tab_def_campos['rel_desemp_posicion_id_grupo'] = "rel_desemp_posicion.id_grupo";
       $tab_converte["rel_desemp_posicion.id_grupo"]   = "rel_desemp_posicion_id_grupo";
   }
   $tab_labels["rel_desemp_posicion_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["rel_desemp_posicion_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["rel_desemp_posicion_id_grupo"] : "GRUPO";
   $tab_ger_campos['rel_desemp_posicion_posicion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rel_desemp_posicion_posicion'] = "rel_desemp_posicion_posicion";
       $tab_converte["rel_desemp_posicion_posicion"]   = "rel_desemp_posicion_posicion";
   }
   else
   {
       $tab_def_campos['rel_desemp_posicion_posicion'] = "rel_desemp_posicion.posicion";
       $tab_converte["rel_desemp_posicion.posicion"]   = "rel_desemp_posicion_posicion";
   }
   $tab_labels["rel_desemp_posicion_posicion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["rel_desemp_posicion_posicion"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["rel_desemp_posicion_posicion"] : "POSICIÓN";
   $tab_ger_campos['actividades'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['actividades'] = "actividades";
       $tab_converte["actividades"]   = "actividades";
   }
   else
   {
       $tab_def_campos['actividades'] = "";
       $tab_converte[""]   = "actividades";
   }
   $tab_labels["actividades"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["actividades"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["actividades"] : "CREAR ACTIVIDADES";
   $tab_ger_campos['evalua_actividades'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evalua_actividades'] = "evalua_actividades";
       $tab_converte["evalua_actividades"]   = "evalua_actividades";
   }
   else
   {
       $tab_def_campos['evalua_actividades'] = "";
       $tab_converte[""]   = "evalua_actividades";
   }
   $tab_labels["evalua_actividades"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["evalua_actividades"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['labels']["evalua_actividades"] : "Evaluar Actividades";
   $tab_ger_campos['actividades'] = "none";
   $tab_ger_campos['evalua_actividades'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_desempeno_docente_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_desempeno_docente']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
