...
<?php
include_once("control_libro_final_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_libro_final_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-estudiante", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_libro_final_mob.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['recarga'];
}
?>
...
<?php
 include_once("control_libro_final_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_libro_final_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_libro_final_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_libro_final_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_el_entorno_line" id="hidden_field_data_el_entorno" style="<?php echo $sStyleHidden_el_entorno; ?>"> <span class="scFormLabelOddFormat css_el_entorno_label"><span id="id_label_el_entorno"><?php echo $this->nm_new_label['el_entorno']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2016'; ?>
 <option value="2015" <?php  if ($this->el_entorno == "2015") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2015'; ?>
 <option value="2014" <?php  if ($this->el_entorno == "2014") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2014'; ?>
 <option value="2013" <?php  if ($this->el_entorno == "2013") { echo " selected" ;} ?>>2013</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2013'; ?>
 <option value="2012" <?php  if ($this->el_entorno == "2012") { echo " selected" ;} ?>>2012</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2012'; ?>
 <option value="2011" <?php  if ($this->el_entorno == "2011") { echo " selected" ;} ?>>2011</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2011'; ?>
 <option value="2010" <?php  if ($this->el_entorno == "2010") { echo " selected" ;} ?>>2010</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['Lookup_el_entorno'][] = '2010'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_libro_final_mob");
 parent.scAjaxDetailHeight("control_libro_final_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
