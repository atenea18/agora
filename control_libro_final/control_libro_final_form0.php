...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_libro_final/control_libro_final_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_libro_final_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_libro_final_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['recarga'];
}
?>
...
<?php
 include_once("control_libro_final_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_libro_final'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_libro_final'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['empty_filter'] = true;
       }
  }
  else
  {
...
ORDER BY sede";
   ...
   echo "  <option value=\"399\">Seleccione</option>" ; 
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['el_entorno']))
   {
       $this->nm_new_label['el_entorno'] = "Entorno";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $el_entorno = $this->el_entorno;
   $sStyleHidden_el_entorno = '';
   if (isset($this->nmgp_cmp_hidden['el_entorno']) && $this->nmgp_cmp_hidden['el_entorno'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['el_entorno']);
       $sStyleHidden_el_entorno = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_el_entorno = 'display: none;';
   $sStyleReadInp_el_entorno = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['el_entorno']) && $this->nmgp_cmp_readonly['el_entorno'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['el_entorno']);
       $sStyleReadLab_el_entorno = '';
       $sStyleReadInp_el_entorno = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['el_entorno']) && $this->nmgp_cmp_hidden['el_entorno'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="el_entorno" value="<?php echo $this->form_encode_input($this->el_entorno) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_el_entorno_label" id="hidden_field_label_el_entorno" style="<?php echo $sStyleHidden_el_entorno; ?>"><span id="id_label_el_entorno"><?php echo $this->nm_new_label['el_entorno']; ?></span></TD>
    <TD class="scFormDataOdd css_el_entorno_line" id="hidden_field_data_el_entorno" style="<?php echo $sStyleHidden_el_entorno; ?>">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["el_entorno"]) &&  $this->nmgp_cmp_readonly["el_entorno"] == "on") { 

$el_entorno_look = "";
 if ($this->el_entorno == "2016") { $el_entorno_look .= "2016" ;} 
 if ($this->el_entorno == "2015") { $el_entorno_look .= "2015" ;} 
 if ($this->el_entorno == "2014") { $el_entorno_look .= "2014" ;} 
 if ($this->el_entorno == "2013") { $el_entorno_look .= "2013" ;} 
 if ($this->el_entorno == "2012") { $el_entorno_look .= "2012" ;} 
 if ($this->el_entorno == "2011") { $el_entorno_look .= "2011" ;} 
 if ($this->el_entorno == "2010") { $el_entorno_look .= "2010" ;} 
 if (empty($el_entorno_look)) { $el_entorno_look = $this->el_entorno; }
?>
<input type="hidden" name="el_entorno" value="<?php echo $this->form_encode_input($el_entorno) . "\">" . $el_entorno_look . ""; ?>
<?php } else { ?>
<?php
...
$el_entorno_look = "";
 ...
 if (empty($el_entorno_look)) { $el_entorno_look = $this->el_entorno; }
?>
<span id="id_read_on_el_entorno" class="css_el_entorno_line"  style="<?php echo $sStyleReadLab_el_entorno; ?>"><?php echo $this->form_encode_input($el_entorno_look); ?></span><span id="id_read_off_el_entorno" style="<?php echo $sStyleReadInp_el_entorno; ?>">
 <span id="idAjaxSelect_el_entorno"><select class="sc-js-input scFormObjectOdd css_el_entorno_obj" style="" id="id_sc_field_el_entorno" name="el_entorno" size="1" alt="{type: 'select', enterTab: false}">
 <option value="2016" <?php  if ($this->el_entorno == "2016") { echo " selected" ;} ?>>2016</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2016'; ?>
 <option value="2015" <?php  if ($this->el_entorno == "2015") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2015'; ?>
 <option value="2014" <?php  if ($this->el_entorno == "2014") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2014'; ?>
 <option value="2013" <?php  if ($this->el_entorno == "2013") { echo " selected" ;} ?>>2013</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2013'; ?>
 <option value="2012" <?php  if ($this->el_entorno == "2012") { echo " selected" ;} ?>>2012</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2012'; ?>
 <option value="2011" <?php  if ($this->el_entorno == "2011") { echo " selected" ;} ?>>2011</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2011'; ?>
 <option value="2010" <?php  if ($this->el_entorno == "2010") { echo " selected" ;} ?>>2010</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['Lookup_el_entorno'][] = '2010'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_libro_final']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_libro_final");
 parent.scAjaxDetailHeight("control_libro_final", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
