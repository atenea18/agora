...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_eventos/control_eventos_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_eventos_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_eventos_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['recarga'];
}
?>
...
<?php
 include_once("control_eventos_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_eventos_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_eventos_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_eventos_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['evento']))
    {
        $this->nm_new_label['evento'] = "Evento";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $evento = $this->evento;
   $sStyleHidden_evento = '';
   if (isset($this->nmgp_cmp_hidden['evento']) && $this->nmgp_cmp_hidden['evento'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['evento']);
       $sStyleHidden_evento = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_evento = 'display: none;';
   $sStyleReadInp_evento = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['evento']) && $this->nmgp_cmp_readonly['evento'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['evento']);
       $sStyleReadLab_evento = '';
       $sStyleReadInp_evento = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['evento']) && $this->nmgp_cmp_hidden['evento'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="evento" value="<?php echo $this->form_encode_input($evento) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_evento_line" id="hidden_field_data_evento" style="<?php echo $sStyleHidden_evento; ?>"> <span class="scFormLabelOddFormat css_evento_label"><span id="id_label_evento"><?php echo $this->nm_new_label['evento']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["evento"]) &&  $this->nmgp_cmp_readonly["evento"] == "on") { 

 ?>
<input type="hidden" name="evento" value="<?php echo $this->form_encode_input($evento) . "\">" . $evento . ""; ?>
<?php } else { ?>
<span id="id_read_on_evento" class="sc-ui-readonly-evento css_evento_line" style="<?php echo $sStyleReadLab_evento; ?>"><?php echo $this->form_encode_input($this->evento); ?></span><span id="id_read_off_evento" style="white-space: nowrap;<?php echo $sStyleReadInp_evento; ?>">
 <input class="sc-js-input scFormObjectOdd css_evento_obj" style="" id="id_sc_field_evento" type=text name="evento" value="<?php echo $this->form_encode_input($evento) ?>"
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['eecha']))
    {
        $this->nm_new_label['eecha'] = "Fecha";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $eecha = $this->eecha;
   $sStyleHidden_eecha = '';
   if (isset($this->nmgp_cmp_hidden['eecha']) && $this->nmgp_cmp_hidden['eecha'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['eecha']);
       $sStyleHidden_eecha = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_eecha = 'display: none;';
   $sStyleReadInp_eecha = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['eecha']) && $this->nmgp_cmp_readonly['eecha'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['eecha']);
       $sStyleReadLab_eecha = '';
       $sStyleReadInp_eecha = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['eecha']) && $this->nmgp_cmp_hidden['eecha'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="eecha" value="<?php echo $this->form_encode_input($eecha) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_eecha_line" id="hidden_field_data_eecha" style="<?php echo $sStyleHidden_eecha; ?>"> <span class="scFormLabelOddFormat css_eecha_label"><span id="id_label_eecha"><?php echo $this->nm_new_label['eecha']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["eecha"]) &&  $this->nmgp_cmp_readonly["eecha"] == "on") { 

 ?>
<input type="hidden" name="eecha" value="<?php echo $this->form_encode_input($eecha) . "\">" . $eecha . ""; ?>
<?php } else { ?>
<span id="id_read_on_eecha" class="sc-ui-readonly-eecha css_eecha_line" style="<?php echo $sStyleReadLab_eecha; ?>"><?php echo $this->form_encode_input($this->eecha); ?></span><span id="id_read_off_eecha" style="white-space: nowrap;<?php echo $sStyleReadInp_eecha; ?>">
 <input class="sc-js-input scFormObjectOdd css_eecha_obj" style="" id="id_sc_field_eecha" type=text name="eecha" value="<?php echo $this->form_encode_input($eecha) ?>"
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_eventos_mob");
 parent.scAjaxDetailHeight("control_eventos_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
