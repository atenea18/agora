...
<?php
include_once("control_eventos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_eventos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['recarga'];
}
?>
...
<?php
 include_once("control_eventos_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_eventos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_eventos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_evento_label" id="hidden_field_label_evento" style="<?php echo $sStyleHidden_evento; ?>"><span id="id_label_evento"><?php echo $this->nm_new_label['evento']; ?></span></TD>
    <TD class="scFormDataOdd css_evento_line" id="hidden_field_data_evento" style="<?php echo $sStyleHidden_evento; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_eecha_label" id="hidden_field_label_eecha" style="<?php echo $sStyleHidden_eecha; ?>"><span id="id_label_eecha"><?php echo $this->nm_new_label['eecha']; ?></span></TD>
    <TD class="scFormDataOdd css_eecha_line" id="hidden_field_data_eecha" style="<?php echo $sStyleHidden_eecha; ?>">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_eventos']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_eventos");
 parent.scAjaxDetailHeight("control_eventos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
