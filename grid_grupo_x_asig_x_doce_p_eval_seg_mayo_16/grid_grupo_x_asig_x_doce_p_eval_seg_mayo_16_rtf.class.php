...
class grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['contr_erro'] = 'off'; 
   ...
   function NM_export_evalua_periodo1_m7()
   {
         ...
         $this->evalua_periodo1_m7 = str_replace('<', '&lt;', $this->evalua_periodo1_m7);
         $this->evalua_periodo1_m7 = str_replace('>', '&gt;', $this->evalua_periodo1_m7);
         $this->Texto_tag .= "<td>" . $this->evalua_periodo1_m7 . "</td>\r\n";
   }
   //----- evalua_periodom8
   ...
   function NM_export_evalua_periodo1_mo9()
   {
         ...
         $this->evalua_periodo1_mo9 = str_replace('<', '&lt;', $this->evalua_periodo1_mo9);
         $this->evalua_periodo1_mo9 = str_replace('>', '&gt;', $this->evalua_periodo1_mo9);
         $this->Texto_tag .= "<td>" . $this->evalua_periodo1_mo9 . "</td>\r\n";
   }
   //----- evalua_periodom10
   function NM_export_evalua_periodom10()
   {
         ...
         $this->evalua_periodom10 = str_replace('<', '&lt;', $this->evalua_periodom10);
         $this->evalua_periodom10 = str_replace('>', '&gt;', $this->evalua_periodom10);
         $this->Texto_tag .= "<td>" . $this->evalua_periodom10 . "</td>\r\n";
   }
   //----- evalua_p1_m11
   function NM_export_evalua_p1_m11()
   {
         ...
         $this->evalua_p1_m11 = str_replace('<', '&lt;', $this->evalua_p1_m11);
         $this->evalua_p1_m11 = str_replace('>', '&gt;', $this->evalua_p1_m11);
         $this->Texto_tag .= "<td>" . $this->evalua_p1_m11 . "</td>\r\n";
   }
   //----- evalua_disciplina
   ...
   function NM_export_director_grupo()
   {
         ...
         $this->director_grupo = str_replace('<', '&lt;', $this->director_grupo);
         $this->director_grupo = str_replace('>', '&gt;', $this->director_grupo);
         $this->Texto_tag .= "<td>" . $this->director_grupo . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
