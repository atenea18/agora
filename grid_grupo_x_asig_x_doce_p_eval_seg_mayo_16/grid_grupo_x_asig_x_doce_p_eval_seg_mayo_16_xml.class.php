...
class grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= "_grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16";
...
$_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evalua_periodo1_m7))
         {
             $this->evalua_periodo1_m7 = sc_convert_encoding($this->evalua_periodo1_m7, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evalua_periodo1_m7 =\"" . $this->trata_dados($this->evalua_periodo1_m7) . "\"";
   }
   //----- evalua_periodom8
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evalua_periodo1_mo9))
         {
             $this->evalua_periodo1_mo9 = sc_convert_encoding($this->evalua_periodo1_mo9, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evalua_periodo1_mo9 =\"" . $this->trata_dados($this->evalua_periodo1_mo9) . "\"";
   }
   //----- evalua_periodom10
   function NM_export_evalua_periodom10()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evalua_periodom10))
         {
             $this->evalua_periodom10 = sc_convert_encoding($this->evalua_periodom10, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evalua_periodom10 =\"" . $this->trata_dados($this->evalua_periodom10) . "\"";
   }
   //----- evalua_p1_m11
   function NM_export_evalua_p1_m11()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->evalua_p1_m11))
         {
             $this->evalua_p1_m11 = sc_convert_encoding($this->evalua_p1_m11, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " evalua_p1_m11 =\"" . $this->trata_dados($this->evalua_p1_m11) . "\"";
   }
   //----- evalua_disciplina
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->director_grupo))
         {
             $this->director_grupo = sc_convert_encoding($this->director_grupo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " director_grupo =\"" . $this->trata_dados($this->director_grupo) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16'][$path_doc_md5][1] = $this->Tit_doc;
?>
