<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_grupos_id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["t_grupos_id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["t_grupos_id_grado"] : "Grado";
   ...
   $tab_labels["grupo_x_asig_x_doce_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["grupo_x_asig_x_doce_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["grupo_x_asig_x_doce_id_asignatura"] : "";
   ...
   $tab_labels["grupo_x_asig_x_doce_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["grupo_x_asig_x_doce_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["grupo_x_asig_x_doce_id_grupo"] : "";
   ...
   $tab_labels["crea_desempeno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["crea_desempeno"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["crea_desempeno"] : "Crear Desempeño";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["sc_field_0"] : "Crear Actividades Evalúa Desempeños";
   ...
   $tab_labels["evalua_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo"] : "";
   ...
   $tab_labels["evlua_periodom2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom2"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom2"] : "";
   ...
   $tab_labels["evlua_periodom3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom3"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom3"] : "";
   ...
   $tab_labels["evlua_periodom4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom4"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom4"] : "";
   ...
   $tab_labels["evlua_periodom5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom5"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom5"] : "";
   ...
   $tab_labels["evlua_periodom6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom6"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evlua_periodom6"] : "";
   ...
   $tab_labels["evalua_periodo1_m7"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo1_m7"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo1_m7"] : "";
   ...
   $tab_labels["evalua_periodom8"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodom8"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodom8"] : "";
   ...
   $tab_labels["evalua_disc_confam"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_disc_confam"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_disc_confam"] : "";
   ...
   $tab_labels["evalua_periodo1_mo9"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo1_mo9"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo1_mo9"] : "";
   ...
   $tab_labels["evalua_periodom10"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodom10"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodom10"] : "";
   ...
   $tab_labels["evalua_p1_m11"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_p1_m11"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_p1_m11"] : "";
   ...
   $tab_labels["evalua_disciplina"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_disciplina"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_disciplina"] : "";
   ...
   $tab_labels["evalua_periodomp1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodomp1"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodomp1"] : "";
   ...
   $tab_labels["evalua_tec_iti"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_tec_iti"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_tec_iti"] : "";
   ...
   $tab_labels["evalua_periodo_tran"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo_tran"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["evalua_periodo_tran"] : "";
   ...
   $tab_labels["obs_asig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["obs_asig"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["obs_asig"] : "";
   $tab_ger_campos['superaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['superaciones'] = "superaciones";
       $tab_converte["superaciones"]   = "superaciones";
   }
   else
   {
       $tab_def_campos['superaciones'] = "";
       $tab_converte[""]   = "superaciones";
   }
   $tab_labels["superaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["superaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["superaciones"] : "";
   ...
   $tab_labels["eval_pendiente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["eval_pendiente"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["eval_pendiente"] : "";
   ...
   $tab_labels["ref_acade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["ref_acade"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["ref_acade"] : "";
   ...
   $tab_labels["enviar_tarea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["enviar_tarea"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["enviar_tarea"] : "";
   ...
   $tab_labels["director_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["director_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['labels']["director_grupo"] : "";
   ...
   $tab_ger_campos['superaciones'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
