...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['contr_erro']) && $_SESSION['scriptcase']['grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16']['contr_erro'] == 'on')
    {
