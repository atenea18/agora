 ...
 */
    ...
    session_start();
    $SC_apl_proc = "grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16";
...
<form name="config_prt" method="post" action="grid_grupo_x_asig_x_doce_p_eval_seg_mayo_16_config_print.php">
<?php
