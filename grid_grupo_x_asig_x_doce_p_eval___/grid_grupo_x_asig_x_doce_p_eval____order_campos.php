<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_grupo_x_asig_x_doce_p_eval____Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_grupo_x_asig_x_doce_p_eval____Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_grupos_id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["t_grupos_id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["t_grupos_id_grado"] : "Grado";
   ...
   $tab_labels["grupo_x_asig_x_doce_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["grupo_x_asig_x_doce_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["grupo_x_asig_x_doce_id_asignatura"] : "";
   ...
   $tab_labels["grupo_x_asig_x_doce_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["grupo_x_asig_x_doce_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["grupo_x_asig_x_doce_id_grupo"] : "";
   ...
   $tab_labels["crea_desempeno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["crea_desempeno"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["crea_desempeno"] : "Crear Desempeño";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["sc_field_0"] : "Crear Actividades Evalúa Desempeños";
   ...
   $tab_labels["evalua_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evalua_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evalua_periodo"] : "";
   ...
   $tab_labels["evlua_periodom2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom2"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom2"] : "";
   ...
   $tab_labels["evlua_periodom3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom3"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom3"] : "Evaluar Periodo";
   ...
   $tab_labels["evlua_periodom4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom4"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom4"] : "";
   ...
   $tab_labels["evlua_periodom5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom5"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom5"] : "";
   ...
   $tab_labels["evlua_periodom6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom6"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evlua_periodom6"] : "";
   ...
   $tab_labels["evalua_periodomp1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evalua_periodomp1"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evalua_periodomp1"] : "";
   ...
   $tab_labels["evalua_periodo_tran"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evalua_periodo_tran"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["evalua_periodo_tran"] : "";
   ...
   $tab_labels["obs_asig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["obs_asig"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["obs_asig"] : "";
   ...
   $tab_labels["superaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["superaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["superaciones"] : "";
   ...
   $tab_labels["eval_pendiente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["eval_pendiente"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["eval_pendiente"] : "";
   ...
   $tab_labels["ref_acade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["ref_acade"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["ref_acade"] : "";
   ...
   $tab_labels["enviar_tarea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["enviar_tarea"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['labels']["enviar_tarea"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_grupo_x_asig_x_doce_p_eval____order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_p_eval___']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
