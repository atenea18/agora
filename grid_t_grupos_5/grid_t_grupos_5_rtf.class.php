...
class grid_t_grupos_5_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_t_grupos_5.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_5']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_5']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_5']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_5']['rtf_name']);
      }
   ...
   function NM_export_ver_calificaciones()
   {
         ...
         $this->ver_calificaciones = str_replace('<', '&lt;', $this->ver_calificaciones);
         $this->ver_calificaciones = str_replace('>', '&gt;', $this->ver_calificaciones);
         $this->Texto_tag .= "<td>" . $this->ver_calificaciones . "</td>\r\n";
   }
   //----- puesto_grupo
   function NM_export_puesto_grupo()
   {
         ...
         $this->puesto_grupo = str_replace('<', '&lt;', $this->puesto_grupo);
         $this->puesto_grupo = str_replace('>', '&gt;', $this->puesto_grupo);
         $this->Texto_tag .= "<td>" . $this->puesto_grupo . "</td>\r\n";
   }
   //----- id_grupo
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_5']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_5']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
