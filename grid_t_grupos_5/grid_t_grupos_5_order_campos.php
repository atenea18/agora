<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_grupos_5_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_grupos_5_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nombre_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['labels']["nombre_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['labels']["nombre_grupo"] : "Nombre Grupo";
   $tab_ger_campos['ver_calificaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ver_calificaciones'] = "ver_calificaciones";
       $tab_converte["ver_calificaciones"]   = "ver_calificaciones";
   }
   else
   {
       $tab_def_campos['ver_calificaciones'] = "";
       $tab_converte[""]   = "ver_calificaciones";
   }
   $tab_labels["ver_calificaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['labels']["ver_calificaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['labels']["ver_calificaciones"] : "ver_calificaciones";
   $tab_ger_campos['puesto_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['puesto_grupo'] = "puesto_grupo";
       $tab_converte["puesto_grupo"]   = "puesto_grupo";
   }
   else
   {
       $tab_def_campos['puesto_grupo'] = "";
       $tab_converte[""]   = "puesto_grupo";
   }
   $tab_labels["puesto_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['labels']["puesto_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['labels']["puesto_grupo"] : "puesto_grupo";
   $tab_ger_campos['ver_calificaciones'] = "none";
   $tab_ger_campos['puesto_grupo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_grupos_5_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_grupos_5']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
