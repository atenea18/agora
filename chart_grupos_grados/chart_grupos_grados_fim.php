...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____chart_grupos_grados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____chart_grupos_grados"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_grupos_grados</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_grupos_grados']['embutida_filho'] as $ind => $sc_init)
          {
