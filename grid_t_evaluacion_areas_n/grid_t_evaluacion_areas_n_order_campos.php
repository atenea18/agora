<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_areas_n_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_areas_n_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["linea5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['labels']["linea5"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['labels']["linea5"] : "linea5";
   $tab_ger_campos['res_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['res_area'] = "res_area";
       $tab_converte["res_area"]   = "res_area";
   }
   else
   {
       $tab_def_campos['res_area'] = "";
       $tab_converte[""]   = "res_area";
   }
   $tab_labels["res_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['labels']["res_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['labels']["res_area"] : "res_area";
   ...
   $tab_labels["asignaturas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['labels']["asignaturas"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['labels']["asignaturas"] : "";
   $tab_ger_campos['linea5'] = "none";
   $tab_ger_campos['res_area'] = "none";
   $tab_ger_campos['asignaturas'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_areas_n']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_areas_n']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_areas_n']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_areas_n_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_n']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
