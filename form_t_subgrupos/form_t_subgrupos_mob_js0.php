<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="id_subgrupo" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_subgrupo']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_subgrupos_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_subgrupos_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_par_grado = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_grado']); ?>";
var var_btn_sc_btn_0_par_id_subgrupo = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_subgrupo']); ?>";
function sc_btn_sc_btn_0()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_grid_estu_subgrupo_selec_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "par_grado?#?' + var_btn_sc_btn_0_par_grado + '?@?par_id_subgrupo?#?' + var_btn_sc_btn_0_par_id_subgrupo + '?@?"; ?>', 'inicio', '_self', '0', '0', 'grid_estu_subgrupo_selec');
}
...
function sc_btn_sc_btn_1()
{
    ...
    document.F1.action = "form_t_subgrupos_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_subgrupos']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_t_subgrupos_mob_form0').style.width='1px';
    document.getElementById('form_t_subgrupos_mob_form0').style.height='0px';
    document.getElementById('form_t_subgrupos_mob_form0').style.display='none';
    document.getElementById('form_t_subgrupos_mob_form0').style.overflow='scroll';
    document.getElementById('form_t_subgrupos_mob_form1').style.width='1px';
    document.getElementById('form_t_subgrupos_mob_form1').style.height='0px';
    document.getElementById('form_t_subgrupos_mob_form1').style.display='none';
    document.getElementById('form_t_subgrupos_mob_form1').style.overflow='scroll';
   ...
   if ("form_t_subgrupos_mob_form0" == N_pagina) {
     scAjaxDetailHeight("grid_estudiantes_en_subgrupo", "800");
    }
   if ("form_t_subgrupos_mob_form1" == N_pagina) {
