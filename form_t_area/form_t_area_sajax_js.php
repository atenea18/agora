  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_area" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate area
  function do_ajax_form_t_area_validate_area()
  {
    var nomeCampo_area = "area";
    var var_area = scAjaxGetFieldText(nomeCampo_area);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_area_validate_area(var_area, var_script_case_init, do_ajax_form_t_area_validate_area_cb);
  } // do_ajax_form_t_area_validate_area

  function do_ajax_form_t_area_validate_area_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_area_validate_area_cb

  // ---------- Validate nombre_corto
  function do_ajax_form_t_area_validate_nombre_corto()
  {
    var nomeCampo_nombre_corto = "nombre_corto";
    var var_nombre_corto = scAjaxGetFieldText(nomeCampo_nombre_corto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_area_validate_nombre_corto(var_nombre_corto, var_script_case_init, do_ajax_form_t_area_validate_nombre_corto_cb);
  } // do_ajax_form_t_area_validate_nombre_corto

  function do_ajax_form_t_area_validate_nombre_corto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_area_validate_nombre_corto_cb

  // ---------- Validate asignaturas
  function do_ajax_form_t_area_validate_asignaturas()
  {
    var nomeCampo_asignaturas = "asignaturas";
    var var_asignaturas = scAjaxGetFieldText(nomeCampo_asignaturas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_area_validate_asignaturas(var_asignaturas, var_script_case_init, do_ajax_form_t_area_validate_asignaturas_cb);
  } // do_ajax_form_t_area_validate_asignaturas

  function do_ajax_form_t_area_validate_asignaturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_area_validate_asignaturas_cb
  // ---------- Form
  function do_ajax_form_t_area_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_t_area_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_t_area_submit_form(var_area, var_nombre_corto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_area_submit_form_cb);
  } // do_ajax_form_t_area_submit_form

  function do_ajax_form_t_area_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_t_area_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_t_asignatura_x_area"] = "off";

  function do_ajax_form_t_area_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_t_area_navigate_form(var_id_area, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_area_navigate_form_cb);
  } // do_ajax_form_t_area_navigate_form

  function do_ajax_form_t_area_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_t_area_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_t_area_navigate_form_cb
  function sc_hide_form_t_area_form()
  {
