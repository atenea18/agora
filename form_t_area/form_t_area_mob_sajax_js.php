  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_area_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate area
  function do_ajax_form_t_area_mob_validate_area()
  {
    var nomeCampo_area = "area";
    var var_area = scAjaxGetFieldText(nomeCampo_area);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_area_mob_validate_area(var_area, var_script_case_init, do_ajax_form_t_area_mob_validate_area_cb);
  } // do_ajax_form_t_area_mob_validate_area

  function do_ajax_form_t_area_mob_validate_area_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_area_mob_validate_area_cb

  // ---------- Validate nombre_corto
  function do_ajax_form_t_area_mob_validate_nombre_corto()
  {
    var nomeCampo_nombre_corto = "nombre_corto";
    var var_nombre_corto = scAjaxGetFieldText(nomeCampo_nombre_corto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_area_mob_validate_nombre_corto(var_nombre_corto, var_script_case_init, do_ajax_form_t_area_mob_validate_nombre_corto_cb);
  } // do_ajax_form_t_area_mob_validate_nombre_corto

  function do_ajax_form_t_area_mob_validate_nombre_corto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre_corto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_area_mob_validate_nombre_corto_cb

  // ---------- Validate asignaturas
  function do_ajax_form_t_area_mob_validate_asignaturas()
  {
    var nomeCampo_asignaturas = "asignaturas";
    var var_asignaturas = scAjaxGetFieldText(nomeCampo_asignaturas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_area_mob_validate_asignaturas(var_asignaturas, var_script_case_init, do_ajax_form_t_area_mob_validate_asignaturas_cb);
  } // do_ajax_form_t_area_mob_validate_asignaturas

  function do_ajax_form_t_area_mob_validate_asignaturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_area_mob_validate_asignaturas_cb
  // ---------- Form
  function do_ajax_form_t_area_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_t_area_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_area = scAjaxGetFieldText("area");
    var var_nombre_corto = scAjaxGetFieldText("nombre_corto");
    ...
    scAjaxProcOn();
    x_ajax_form_t_area_mob_submit_form(var_area, var_nombre_corto, var_id_area, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_area_mob_submit_form_cb);
  } // do_ajax_form_t_area_mob_submit_form

  function do_ajax_form_t_area_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_corto");
  ...
  } // do_ajax_form_t_area_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_t_asignatura_x_area"] = "off";

  function do_ajax_form_t_area_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nombre_corto");
    scAjaxHideErrorDisplay("asignaturas");
    var var_id_area = document.F2.id_area.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_t_asignatura_x_area"] = "on";
    x_ajax_form_t_area_mob_navigate_form(var_id_area, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_area_mob_navigate_form_cb);
  } // do_ajax_form_t_area_mob_navigate_form

  function do_ajax_form_t_area_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_t_area_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_area.value = scAjaxGetKeyValue("id_area");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    document.getElementById('nmsc_iframe_liga_form_t_asignatura_x_area').contentWindow.nm_move('apl_detalhe', true, '550');
    document.getElementById('nmsc_iframe_liga_form_t_asignatura_x_area').style.height = "550";
    document.getElementById('nmsc_iframe_liga_form_t_asignatura_x_area').style.display = "none";
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
    scAjaxMessage();
...
{
?>
    do_ajax_form_t_area_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_t_area_mob_navigate_form_cb
  function sc_hide_form_t_area_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_t_asignatura_x_area"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "area";
  ajax_field_list[1] = "nombre_corto";
  ajax_field_list[2] = "asignaturas";
  ...
  var ajax_error_list = {
    ...
    "nombre_corto": {"label": "Nombre Corto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "area": new Array(),
    "nombre_corto": new Array(),
    "asignaturas": new Array()
  };
  ajax_field_mult["area"][1] = "area";
  ajax_field_mult["nombre_corto"][1] = "nombre_corto";
  ajax_field_mult["asignaturas"][1] = "asignaturas";

  var ajax_field_id = {
    "area": new Array("hidden_field_label_area", "hidden_field_data_area"),
    "nombre_corto": new Array("hidden_field_label_nombre_corto", "hidden_field_data_nombre_corto"),
