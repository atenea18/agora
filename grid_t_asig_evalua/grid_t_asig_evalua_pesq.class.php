...
class grid_t_asig_evalua_pesq
{
    ...
    * @access  public
    */
   function grid_t_asig_evalua_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_t_asig_evalua_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_t_asig_evalua_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_t_asig_evalua_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_t_evaluacion_evaluacion')
      {
          $t_evaluacion_evaluacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_t_evaluacion_evaluacion($t_evaluacion_evaluacion);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_t_asignaturas_asignatura($t_asignaturas_asignatura)
   {
      ...
      $nm_comando = "select distinct t_asignaturas.asignatura from " . $this->Ini->nm_tabela . " where t_evaluacion.id_estudiante = " . $_SESSION['par_idestudiante'] . " AND t_asignatura_x_area.id_area = " . $_SESSION['par_id_area'] . " AND YEAR(t_evaluacion.fecha_entorno) = " . $_SESSION['par_year'] . " and  t_asignaturas.asignatura like '%" . $t_asignaturas_asignatura . "%'"; 
   ...
   function lookup_ajax_t_evaluacion_evaluacion($t_evaluacion_evaluacion)
   {
      $t_evaluacion_evaluacion = substr($this->Db->qstr($t_evaluacion_evaluacion), 1, -1);
            $t_evaluacion_evaluacion_look = substr($this->Db->qstr($t_evaluacion_evaluacion), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct t_evaluacion.evaluacion from " . $this->Ini->nm_tabela . " where t_evaluacion.id_estudiante = " . $_SESSION['par_idestudiante'] . " AND t_asignatura_x_area.id_area = " . $_SESSION['par_id_area'] . " AND YEAR(t_evaluacion.fecha_entorno) = " . $_SESSION['par_year'] . " and  t_evaluacion.evaluacion like '%" . $t_evaluacion_evaluacion . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct t_evaluacion.evaluacion from " . $this->Ini->nm_tabela . " where t_evaluacion.id_estudiante = " . $_SESSION['par_idestudiante'] . " AND t_asignatura_x_area.id_area = " . $_SESSION['par_id_area'] . " AND YEAR(t_evaluacion.fecha_entorno) = " . $_SESSION['par_year'] . " and  t_evaluacion.evaluacion like '%" . $t_evaluacion_evaluacion . "%'"; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_t_asig_evalua/grid_t_asig_evalua_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_t_asig_evalua_ajax_search.js"></script>
 <script type="text/javascript" src="grid_t_asig_evalua_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_t_evaluacion_evaluacion_cond#NMF#' + search_get_sel_txt('SC_t_evaluacion_evaluacion_cond') + '@NMF@';
  str_out += 'SC_t_evaluacion_evaluacion#NMF#' + search_get_text('SC_t_evaluacion_evaluacion') + '@NMF@';
  str_out += 'id_ac_t_evaluacion_evaluacion#NMF#' + search_get_text('id_ac_t_evaluacion_evaluacion') + '@NMF@';
  str_out += 'SC_t_evaluacion_evaluacion_input_2#NMF#' + search_get_text('SC_t_evaluacion_evaluacion_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_t_evaluacion_evaluacion").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_t_evaluacion_evaluacion",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_t_evaluacion_evaluacion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_t_evaluacion_evaluacion").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - </span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $t_evaluacion_evaluacion_cond, $t_evaluacion_evaluacion, $t_evaluacion_evaluacion_input_2, $t_evaluacion_evaluacion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $t_asignaturas_asignatura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_asignaturas_asignatura']; 
          $t_asignaturas_asignatura_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_asignaturas_asignatura_cond']; 
          $t_evaluacion_evaluacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_evaluacion_evaluacion']; 
          $t_evaluacion_evaluacion_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_evaluacion_evaluacion_input_2']; 
          $t_evaluacion_evaluacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_evaluacion_evaluacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['NM_operador']; 
      } 
      if (!isset($t_asignaturas_asignatura_cond) || empty($t_asignaturas_asignatura_cond))
      {
         $t_asignaturas_asignatura_cond = "qp";
      }
      if (!isset($t_evaluacion_evaluacion_cond) || empty($t_evaluacion_evaluacion_cond))
      {
         $t_evaluacion_evaluacion_cond = "gt";
      }
      ...
      $str_hide_t_evaluacion_evaluacion = (in_array($t_evaluacion_evaluacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_t_evaluacion_evaluacion = ('bw' == $t_evaluacion_evaluacion_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($t_evaluacion_evaluacion) || $t_evaluacion_evaluacion == "")
      {
          $t_evaluacion_evaluacion = "";
      }
      if (isset($t_evaluacion_evaluacion) && !empty($t_evaluacion_evaluacion))
      {
         $tmp_pos = strpos($t_evaluacion_evaluacion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $t_evaluacion_evaluacion = substr($t_evaluacion_evaluacion, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_t_asig_evalua_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['t_asignaturas_asignatura'])) ? $this->New_label['t_asignaturas_asignatura'] : ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      $t_asignaturas_asignatura_look = substr($this->Db->qstr($t_asignaturas_asignatura), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t_asignaturas.asignatura from " . $this->Ini->nm_tabela . " where t_evaluacion.id_estudiante = " . $_SESSION['par_idestudiante'] . " AND t_asignatura_x_area.id_area = " . $_SESSION['par_id_area'] . " AND YEAR(t_evaluacion.fecha_entorno) = " . $_SESSION['par_year'] . " and t_asignaturas.asignatura = '$t_asignaturas_asignatura_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_t_asignaturas_asignatura" name="t_asignaturas_asignatura_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['t_evaluacion_evaluacion'])) ? $this->New_label['t_evaluacion_evaluacion'] : "eva"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_t_evaluacion_evaluacion_cond" name="t_evaluacion_evaluacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_t_evaluacion_evaluacion'), this, 't_evaluacion_evaluacion')">
       <OPTION value="gt" <?php if ("gt" == $t_evaluacion_evaluacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $t_evaluacion_evaluacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $t_evaluacion_evaluacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $t_evaluacion_evaluacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_t_evaluacion_evaluacion" <?php echo $str_hide_t_evaluacion_evaluacion?> valign="top">
 ...
 $nmgp_tab_label .= "t_evaluacion_evaluacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $t_evaluacion_evaluacion_look = substr($this->Db->qstr($t_evaluacion_evaluacion), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($t_evaluacion_evaluacion))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct t_evaluacion.evaluacion from " . $this->Ini->nm_tabela . " where t_evaluacion.id_estudiante = " . $_SESSION['par_idestudiante'] . " AND t_asignatura_x_area.id_area = " . $_SESSION['par_id_area'] . " AND YEAR(t_evaluacion.fecha_entorno) = " . $_SESSION['par_year'] . " and t_evaluacion.evaluacion = $t_evaluacion_evaluacion_look"; 
      }
      else
      {
          $nm_comando = "select distinct t_evaluacion.evaluacion from " . $this->Ini->nm_tabela . " where t_evaluacion.id_estudiante = " . $_SESSION['par_idestudiante'] . " AND t_asignatura_x_area.id_area = " . $_SESSION['par_id_area'] . " AND YEAR(t_evaluacion.fecha_entorno) = " . $_SESSION['par_year'] . " and t_evaluacion.evaluacion = $t_evaluacion_evaluacion_look"; 
      ...
      if (isset($nmgp_def_dados[0][$t_evaluacion_evaluacion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$t_evaluacion_evaluacion];
      }
      else
      {
          $sAutocompValue = $t_evaluacion_evaluacion;
      }
?>
<INPUT  type="text" id="SC_t_evaluacion_evaluacion" name="t_evaluacion_evaluacion" value="<?php echo NM_encode_input($t_evaluacion_evaluacion) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_t_evaluacion_evaluacion" name="t_evaluacion_evaluacion_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_t_evaluacion_evaluacion"  <?php echo $str_display_t_evaluacion_evaluacion; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_t_evaluacion_evaluacion_input_2" name="t_evaluacion_evaluacion_input_2" value="<?php echo NM_encode_input($t_evaluacion_evaluacion_input_2) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_asig_evalua']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_asig_evalua']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_t_evaluacion_evaluacion'), document.F1.t_evaluacion_evaluacion_cond, 't_evaluacion_evaluacion');
   document.F1.t_evaluacion_evaluacion.value = "";
   document.F1.t_evaluacion_evaluacion_autocomp.value = "";
   document.F1.t_evaluacion_evaluacion_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_t_asig_evalua";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_t_evaluacion_evaluacion_cond'] = 'cond';
      $tp_fields['SC_t_evaluacion_evaluacion'] = 'text_aut';
      $tp_fields['id_ac_t_evaluacion_evaluacion'] = 'text_aut';
      $tp_fields['SC_t_evaluacion_evaluacion_input_2'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $t_asignaturas_asignatura_cond, $t_asignaturas_asignatura, $t_asignaturas_asignatura_autocomp,
             $t_evaluacion_evaluacion_cond, $t_evaluacion_evaluacion, $t_evaluacion_evaluacion_input_2, $t_evaluacion_evaluacion_autocomp, $nmgp_tab_label;
      ...
      if (!empty($t_evaluacion_evaluacion_autocomp) && empty($t_evaluacion_evaluacion))
      {
          $t_evaluacion_evaluacion = $t_evaluacion_evaluacion_autocomp;
      }
      ...
      $t_evaluacion_evaluacion_cond_salva = $t_evaluacion_evaluacion_cond; 
      if (!isset($t_evaluacion_evaluacion_input_2) || $t_evaluacion_evaluacion_input_2 == "")
      {
          $t_evaluacion_evaluacion_input_2 = $t_evaluacion_evaluacion;
      }
      if ($t_evaluacion_evaluacion_cond != "in")
      {
          nm_limpa_numero($t_evaluacion_evaluacion, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $t_evaluacion_evaluacion);
          ...
          $t_evaluacion_evaluacion = implode(",", $Nm_sc_valores);
      }
      if ($t_evaluacion_evaluacion_cond != "in")
      {
          nm_limpa_numero($t_evaluacion_evaluacion_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_asignaturas_asignatura'] = $t_asignaturas_asignatura; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_asignaturas_asignatura_cond'] = $t_asignaturas_asignatura_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_evaluacion_evaluacion'] = $t_evaluacion_evaluacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_evaluacion_evaluacion_input_2'] = $t_evaluacion_evaluacion_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['t_evaluacion_evaluacion_cond'] = $t_evaluacion_evaluacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($t_evaluacion_evaluacion_cond != "in" && $t_evaluacion_evaluacion_cond != "bw" && !empty($t_evaluacion_evaluacion) && !is_numeric($t_evaluacion_evaluacion))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : eva";
      }
      if ($t_evaluacion_evaluacion_cond == "bw" && ((!empty($t_evaluacion_evaluacion) && !is_numeric($t_evaluacion_evaluacion)) || (!empty($t_evaluacion_evaluacion_input_2) && !is_numeric($t_evaluacion_evaluacion_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : eva";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['t_evaluacion_evaluacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['t_evaluacion_evaluacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['t_evaluacion_evaluacion'] = $t_evaluacion_evaluacion;
      }
      $Conteudo = $t_evaluacion_evaluacion_input_2;
      if (strtoupper($t_evaluacion_evaluacion_cond) != "II" && strtoupper($t_evaluacion_evaluacion_cond) != "QP" && strtoupper($t_evaluacion_evaluacion_cond) != "NP" && strtoupper($t_evaluacion_evaluacion_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['t_evaluacion_evaluacion_input_2'] = $Conteudo;
      ...
      //----- $t_evaluacion_evaluacion
      $this->Date_part = false;
      if (isset($t_evaluacion_evaluacion) || $t_evaluacion_evaluacion_cond == "nu" || $t_evaluacion_evaluacion_cond == "nn" || $t_evaluacion_evaluacion_cond == "ep" || $t_evaluacion_evaluacion_cond == "ne")
      {
         $this->monta_condicao("t_evaluacion.evaluacion", $t_evaluacion_evaluacion_cond, $t_evaluacion_evaluacion, $t_evaluacion_evaluacion_input_2, "t_evaluacion_evaluacion");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_asig_evalua']['where_pesq_ant'] = $this->comando . $this->comando_fim;
