...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "t_evaluacion_ihs";$Nm_numeric[] = "t_evaluacion_evaluacion";$Nm_numeric[] = "t_evaluacion_ihs";$Nm_numeric[] = "t_evaluacion_evaluacion";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_t_evaluacion_evaluacion"  <?php echo $str_hide_t_evaluacion_evaluacion?>><?php
      $t_evaluacion_evaluacion_look = substr($this->Db->qstr($t_evaluacion_evaluacion), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_t_evaluacion_evaluacion" name="t_evaluacion_evaluacion_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_t_evaluacion_evaluacion"  <?php echo $str_display_t_evaluacion_evaluacion; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_t_evaluacion_evaluacion_input_2" name="t_evaluacion_evaluacion_input_2" value="<?php echo NM_encode_input($t_evaluacion_evaluacion_input_2) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
