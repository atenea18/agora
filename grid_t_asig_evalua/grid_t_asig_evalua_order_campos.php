<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_asig_evalua_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_asig_evalua_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_asignaturas_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['labels']["t_asignaturas_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['labels']["t_asignaturas_asignatura"] : "";
   $tab_ger_campos['t_evaluacion_ihs'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_ihs'] = "t_evaluacion_ihs";
       $tab_converte["t_evaluacion_ihs"]   = "t_evaluacion_ihs";
   }
   else
   {
       $tab_def_campos['t_evaluacion_ihs'] = "t_evaluacion.ihs";
       $tab_converte["t_evaluacion.ihs"]   = "t_evaluacion_ihs";
   }
   $tab_labels["t_evaluacion_ihs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['labels']["t_evaluacion_ihs"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['labels']["t_evaluacion_ihs"] : "ihs";
   $tab_ger_campos['t_evaluacion_evaluacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_evaluacion'] = "t_evaluacion_evaluacion";
       $tab_converte["t_evaluacion_evaluacion"]   = "t_evaluacion_evaluacion";
   }
   else
   {
       $tab_def_campos['t_evaluacion_evaluacion'] = "t_evaluacion.evaluacion";
       $tab_converte["t_evaluacion.evaluacion"]   = "t_evaluacion_evaluacion";
   }
   $tab_labels["t_evaluacion_evaluacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['labels']["t_evaluacion_evaluacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['labels']["t_evaluacion_evaluacion"] : "eva";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_asig_evalua_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_asig_evalua']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
