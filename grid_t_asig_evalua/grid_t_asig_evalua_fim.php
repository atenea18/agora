...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_t_asig_evalua"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_t_asig_evalua"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_t_asig_evalua</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_t_asig_evalua']['embutida_filho'] as $ind => $sc_init)
          {
