...
class form_det_evalua_actividad_dc2_erro
{
   var $Ini;
   ...
   //----- 
   function form_det_evalua_actividad_dc2_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return form_det_evalua_actividad_dc2_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
