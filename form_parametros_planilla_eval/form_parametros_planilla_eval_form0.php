...
<?php
include_once("form_parametros_planilla_eval_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_parametros_planilla_eval_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['recarga'];
}
?>
...
<?php
 include_once("form_parametros_planilla_eval_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_parametros_planilla_eval'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_parametros_planilla_eval'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_modelo_line" id="hidden_field_data_modelo" style="<?php echo $sStyleHidden_modelo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_modelo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_modelo_label"><span id="id_label_modelo"><?php echo $this->nm_new_label['modelo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['php_cmp_required']['modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['php_cmp_required']['modelo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_uno_dumb = ('' == $sStyleHidden_uno) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_uno_dumb" style="<?php echo $sStyleHidden_uno_dumb; ?>"></TD>
<?php $sStyleHidden_dos_dumb = ('' == $sStyleHidden_dos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dos_dumb" style="<?php echo $sStyleHidden_dos_dumb; ?>"></TD>
<?php $sStyleHidden_tres_dumb = ('' == $sStyleHidden_tres) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tres_dumb" style="<?php echo $sStyleHidden_tres_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_cuatro_dumb = ('' == $sStyleHidden_cuatro) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cuatro_dumb" style="<?php echo $sStyleHidden_cuatro_dumb; ?>"></TD>
<?php $sStyleHidden_cinco_dumb = ('' == $sStyleHidden_cinco) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cinco_dumb" style="<?php echo $sStyleHidden_cinco_dumb; ?>"></TD>
<?php $sStyleHidden_seis_dumb = ('' == $sStyleHidden_seis) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_seis_dumb" style="<?php echo $sStyleHidden_seis_dumb; ?>"></TD>
<?php $sStyleHidden_siete_dumb = ('' == $sStyleHidden_siete) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_siete_dumb" style="<?php echo $sStyleHidden_siete_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_ocho_dumb = ('' == $sStyleHidden_ocho) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ocho_dumb" style="<?php echo $sStyleHidden_ocho_dumb; ?>"></TD>
<?php $sStyleHidden_nueve_dumb = ('' == $sStyleHidden_nueve) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_nueve_dumb" style="<?php echo $sStyleHidden_nueve_dumb; ?>"></TD>
<?php $sStyleHidden_diez_dumb = ('' == $sStyleHidden_diez) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_diez_dumb" style="<?php echo $sStyleHidden_diez_dumb; ?>"></TD>
<?php $sStyleHidden_once_dumb = ('' == $sStyleHidden_once) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_once_dumb" style="<?php echo $sStyleHidden_once_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_doce_dumb = ('' == $sStyleHidden_doce) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_doce_dumb" style="<?php echo $sStyleHidden_doce_dumb; ?>"></TD>
<?php $sStyleHidden_trece_dumb = ('' == $sStyleHidden_trece) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_trece_dumb" style="<?php echo $sStyleHidden_trece_dumb; ?>"></TD>
<?php $sStyleHidden_catorce_dumb = ('' == $sStyleHidden_catorce) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_catorce_dumb" style="<?php echo $sStyleHidden_catorce_dumb; ?>"></TD>
<?php $sStyleHidden_quince_dumb = ('' == $sStyleHidden_quince) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_quince_dumb" style="<?php echo $sStyleHidden_quince_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_diez_y_seis_dumb = ('' == $sStyleHidden_diez_y_seis) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_diez_y_seis_dumb" style="<?php echo $sStyleHidden_diez_y_seis_dumb; ?>"></TD>
<?php $sStyleHidden_diez_y_siete_dumb = ('' == $sStyleHidden_diez_y_siete) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_diez_y_siete_dumb" style="<?php echo $sStyleHidden_diez_y_siete_dumb; ?>"></TD>
<?php $sStyleHidden_diez_y_ocho_dumb = ('' == $sStyleHidden_diez_y_ocho) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_diez_y_ocho_dumb" style="<?php echo $sStyleHidden_diez_y_ocho_dumb; ?>"></TD>
<?php $sStyleHidden_diez_y_nueve_dumb = ('' == $sStyleHidden_diez_y_nueve) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_diez_y_nueve_dumb" style="<?php echo $sStyleHidden_diez_y_nueve_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_veinte_dumb = ('' == $sStyleHidden_veinte) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_veinte_dumb" style="<?php echo $sStyleHidden_veinte_dumb; ?>"></TD>
<?php $sStyleHidden_veintiuno_dumb = ('' == $sStyleHidden_veintiuno) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_veintiuno_dumb" style="<?php echo $sStyleHidden_veintiuno_dumb; ?>"></TD>
<?php $sStyleHidden_veintidos_dumb = ('' == $sStyleHidden_veintidos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_veintidos_dumb" style="<?php echo $sStyleHidden_veintidos_dumb; ?>"></TD>
<?php $sStyleHidden_veintitres_dumb = ('' == $sStyleHidden_veintitres) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_veintitres_dumb" style="<?php echo $sStyleHidden_veintitres_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_parametros_planilla_eval");
 parent.scAjaxDetailHeight("form_parametros_planilla_eval", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
