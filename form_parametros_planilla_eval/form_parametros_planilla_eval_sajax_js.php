  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_parametros_planilla_eval" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate modelo
  function do_ajax_form_parametros_planilla_eval_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_modelo_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_modelo

  function do_ajax_form_parametros_planilla_eval_validate_modelo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_modelo_cb

  // ---------- Validate uno
  function do_ajax_form_parametros_planilla_eval_validate_uno()
  {
    var nomeCampo_uno = "uno";
    var var_uno = scAjaxGetFieldText(nomeCampo_uno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_uno(var_uno, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_uno_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_uno

  function do_ajax_form_parametros_planilla_eval_validate_uno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "uno";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_uno_cb

  // ---------- Validate dos
  function do_ajax_form_parametros_planilla_eval_validate_dos()
  {
    var nomeCampo_dos = "dos";
    var var_dos = scAjaxGetFieldText(nomeCampo_dos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_dos(var_dos, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_dos_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_dos

  function do_ajax_form_parametros_planilla_eval_validate_dos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "dos";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_dos_cb

  // ---------- Validate tres
  function do_ajax_form_parametros_planilla_eval_validate_tres()
  {
    var nomeCampo_tres = "tres";
    var var_tres = scAjaxGetFieldText(nomeCampo_tres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_tres(var_tres, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_tres_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_tres

  function do_ajax_form_parametros_planilla_eval_validate_tres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tres";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_tres_cb

  // ---------- Validate cuatro
  function do_ajax_form_parametros_planilla_eval_validate_cuatro()
  {
    var nomeCampo_cuatro = "cuatro";
    var var_cuatro = scAjaxGetFieldText(nomeCampo_cuatro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_cuatro(var_cuatro, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_cuatro_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_cuatro

  function do_ajax_form_parametros_planilla_eval_validate_cuatro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cuatro";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_cuatro_cb

  // ---------- Validate cinco
  function do_ajax_form_parametros_planilla_eval_validate_cinco()
  {
    var nomeCampo_cinco = "cinco";
    var var_cinco = scAjaxGetFieldText(nomeCampo_cinco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_cinco(var_cinco, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_cinco_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_cinco

  function do_ajax_form_parametros_planilla_eval_validate_cinco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cinco";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_cinco_cb

  // ---------- Validate seis
  function do_ajax_form_parametros_planilla_eval_validate_seis()
  {
    var nomeCampo_seis = "seis";
    var var_seis = scAjaxGetFieldText(nomeCampo_seis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_seis(var_seis, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_seis_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_seis

  function do_ajax_form_parametros_planilla_eval_validate_seis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "seis";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_seis_cb

  // ---------- Validate siete
  function do_ajax_form_parametros_planilla_eval_validate_siete()
  {
    var nomeCampo_siete = "siete";
    var var_siete = scAjaxGetFieldText(nomeCampo_siete);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_siete(var_siete, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_siete_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_siete

  function do_ajax_form_parametros_planilla_eval_validate_siete_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "siete";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_siete_cb

  // ---------- Validate ocho
  function do_ajax_form_parametros_planilla_eval_validate_ocho()
  {
    var nomeCampo_ocho = "ocho";
    var var_ocho = scAjaxGetFieldText(nomeCampo_ocho);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_ocho(var_ocho, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_ocho_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_ocho

  function do_ajax_form_parametros_planilla_eval_validate_ocho_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ocho";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_ocho_cb

  // ---------- Validate nueve
  function do_ajax_form_parametros_planilla_eval_validate_nueve()
  {
    var nomeCampo_nueve = "nueve";
    var var_nueve = scAjaxGetFieldText(nomeCampo_nueve);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_nueve(var_nueve, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_nueve_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_nueve

  function do_ajax_form_parametros_planilla_eval_validate_nueve_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nueve";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_nueve_cb

  // ---------- Validate diez
  function do_ajax_form_parametros_planilla_eval_validate_diez()
  {
    var nomeCampo_diez = "diez";
    var var_diez = scAjaxGetFieldText(nomeCampo_diez);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_diez(var_diez, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_diez_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_diez

  function do_ajax_form_parametros_planilla_eval_validate_diez_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "diez";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_diez_cb

  // ---------- Validate once
  function do_ajax_form_parametros_planilla_eval_validate_once()
  {
    var nomeCampo_once = "once";
    var var_once = scAjaxGetFieldText(nomeCampo_once);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_once(var_once, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_once_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_once

  function do_ajax_form_parametros_planilla_eval_validate_once_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "once";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_once_cb

  // ---------- Validate doce
  function do_ajax_form_parametros_planilla_eval_validate_doce()
  {
    var nomeCampo_doce = "doce";
    var var_doce = scAjaxGetFieldText(nomeCampo_doce);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_doce(var_doce, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_doce_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_doce

  function do_ajax_form_parametros_planilla_eval_validate_doce_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "doce";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_doce_cb

  // ---------- Validate trece
  function do_ajax_form_parametros_planilla_eval_validate_trece()
  {
    var nomeCampo_trece = "trece";
    var var_trece = scAjaxGetFieldText(nomeCampo_trece);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_trece(var_trece, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_trece_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_trece

  function do_ajax_form_parametros_planilla_eval_validate_trece_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "trece";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_trece_cb

  // ---------- Validate catorce
  function do_ajax_form_parametros_planilla_eval_validate_catorce()
  {
    var nomeCampo_catorce = "catorce";
    var var_catorce = scAjaxGetFieldText(nomeCampo_catorce);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_catorce(var_catorce, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_catorce_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_catorce

  function do_ajax_form_parametros_planilla_eval_validate_catorce_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "catorce";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_catorce_cb

  // ---------- Validate quince
  function do_ajax_form_parametros_planilla_eval_validate_quince()
  {
    var nomeCampo_quince = "quince";
    var var_quince = scAjaxGetFieldText(nomeCampo_quince);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_quince(var_quince, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_quince_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_quince

  function do_ajax_form_parametros_planilla_eval_validate_quince_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "quince";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_quince_cb

  // ---------- Validate diez_y_seis
  function do_ajax_form_parametros_planilla_eval_validate_diez_y_seis()
  {
    var nomeCampo_diez_y_seis = "diez_y_seis";
    var var_diez_y_seis = scAjaxGetFieldText(nomeCampo_diez_y_seis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_diez_y_seis(var_diez_y_seis, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_diez_y_seis_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_seis

  function do_ajax_form_parametros_planilla_eval_validate_diez_y_seis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_seis_cb

  // ---------- Validate diez_y_siete
  function do_ajax_form_parametros_planilla_eval_validate_diez_y_siete()
  {
    var nomeCampo_diez_y_siete = "diez_y_siete";
    var var_diez_y_siete = scAjaxGetFieldText(nomeCampo_diez_y_siete);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_diez_y_siete(var_diez_y_siete, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_diez_y_siete_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_siete

  function do_ajax_form_parametros_planilla_eval_validate_diez_y_siete_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_siete_cb

  // ---------- Validate diez_y_ocho
  function do_ajax_form_parametros_planilla_eval_validate_diez_y_ocho()
  {
    var nomeCampo_diez_y_ocho = "diez_y_ocho";
    var var_diez_y_ocho = scAjaxGetFieldText(nomeCampo_diez_y_ocho);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_diez_y_ocho(var_diez_y_ocho, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_diez_y_ocho_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_ocho

  function do_ajax_form_parametros_planilla_eval_validate_diez_y_ocho_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_ocho_cb

  // ---------- Validate diez_y_nueve
  function do_ajax_form_parametros_planilla_eval_validate_diez_y_nueve()
  {
    var nomeCampo_diez_y_nueve = "diez_y_nueve";
    var var_diez_y_nueve = scAjaxGetFieldText(nomeCampo_diez_y_nueve);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_diez_y_nueve(var_diez_y_nueve, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_diez_y_nueve_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_nueve

  function do_ajax_form_parametros_planilla_eval_validate_diez_y_nueve_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_diez_y_nueve_cb

  // ---------- Validate veinte
  function do_ajax_form_parametros_planilla_eval_validate_veinte()
  {
    var nomeCampo_veinte = "veinte";
    var var_veinte = scAjaxGetFieldText(nomeCampo_veinte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_veinte(var_veinte, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_veinte_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_veinte

  function do_ajax_form_parametros_planilla_eval_validate_veinte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "veinte";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_veinte_cb

  // ---------- Validate veintiuno
  function do_ajax_form_parametros_planilla_eval_validate_veintiuno()
  {
    var nomeCampo_veintiuno = "veintiuno";
    var var_veintiuno = scAjaxGetFieldText(nomeCampo_veintiuno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_veintiuno(var_veintiuno, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_veintiuno_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_veintiuno

  function do_ajax_form_parametros_planilla_eval_validate_veintiuno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_veintiuno_cb

  // ---------- Validate veintidos
  function do_ajax_form_parametros_planilla_eval_validate_veintidos()
  {
    var nomeCampo_veintidos = "veintidos";
    var var_veintidos = scAjaxGetFieldText(nomeCampo_veintidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_veintidos(var_veintidos, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_veintidos_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_veintidos

  function do_ajax_form_parametros_planilla_eval_validate_veintidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_veintidos_cb

  // ---------- Validate veintitres
  function do_ajax_form_parametros_planilla_eval_validate_veintitres()
  {
    var nomeCampo_veintitres = "veintitres";
    var var_veintitres = scAjaxGetFieldText(nomeCampo_veintitres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_veintitres(var_veintitres, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_veintitres_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_veintitres

  function do_ajax_form_parametros_planilla_eval_validate_veintitres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_veintitres_cb

  // ---------- Validate veinticuatro
  function do_ajax_form_parametros_planilla_eval_validate_veinticuatro()
  {
    var nomeCampo_veinticuatro = "veinticuatro";
    var var_veinticuatro = scAjaxGetFieldText(nomeCampo_veinticuatro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_veinticuatro(var_veinticuatro, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_veinticuatro_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_veinticuatro

  function do_ajax_form_parametros_planilla_eval_validate_veinticuatro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_veinticuatro_cb

  // ---------- Validate vinticinco
  function do_ajax_form_parametros_planilla_eval_validate_vinticinco()
  {
    var nomeCampo_vinticinco = "vinticinco";
    var var_vinticinco = scAjaxGetFieldText(nomeCampo_vinticinco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_planilla_eval_validate_vinticinco(var_vinticinco, var_script_case_init, do_ajax_form_parametros_planilla_eval_validate_vinticinco_cb);
  } // do_ajax_form_parametros_planilla_eval_validate_vinticinco

  function do_ajax_form_parametros_planilla_eval_validate_vinticinco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_planilla_eval_validate_vinticinco_cb
  // ---------- Form
  function do_ajax_form_parametros_planilla_eval_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_parametros_planilla_eval_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_parametros_planilla_eval_submit_form(var_modelo, var_uno, var_dos, var_tres, var_cuatro, var_cinco, var_seis, var_siete, var_ocho, var_nueve, var_diez, var_once, var_doce, var_trece, var_catorce, var_quince, var_diez_y_seis, var_diez_y_siete, var_diez_y_ocho, var_diez_y_nueve, var_veinte, var_veintiuno, var_veintidos, var_veintitres, var_veinticuatro, var_vinticinco, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_parametros_planilla_eval_submit_form_cb);
  } // do_ajax_form_parametros_planilla_eval_submit_form

  function do_ajax_form_parametros_planilla_eval_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_parametros_planilla_eval_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_parametros_planilla_eval_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_parametros_planilla_eval_navigate_form(var_modelo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_parametros_planilla_eval_navigate_form_cb);
  } // do_ajax_form_parametros_planilla_eval_navigate_form

  function do_ajax_form_parametros_planilla_eval_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_parametros_planilla_eval_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_parametros_planilla_eval_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_parametros_planilla_eval_navigate_form_cb
  function sc_hide_form_parametros_planilla_eval_form()
  {
