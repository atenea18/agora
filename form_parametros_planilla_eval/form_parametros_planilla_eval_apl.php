<?php
//
class form_parametros_planilla_eval_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_parametros_planilla_eval_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_parametros_planilla_eval']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_parametros_planilla_eval']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_parametros_planilla_eval'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_parametros_planilla_eval']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_parametros_planilla_eval']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_parametros_planilla_eval') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_parametros_planilla_eval']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - parametros_planilla_eval";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_parametros_planilla_eval")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_parametros_planilla_eval']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_parametros_planilla_eval'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_parametros_planilla_eval']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_parametros_planilla_eval", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_parametros_planilla_eval_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_parametros_planilla_eval_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_parametros_planilla_eval/form_parametros_planilla_eval_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_parametros_planilla_eval_erro.class.php"); 
      }
      $this->Erro      = new form_parametros_planilla_eval_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao']))
         { 
             if ($this->modelo != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_parametros_planilla_eval']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_parametros_planilla_eval']) || !is_array($this->NM_ajax_info['errList']['geral_form_parametros_planilla_eval']))
              {
                  $this->NM_ajax_info['errList']['geral_form_parametros_planilla_eval'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_parametros_planilla_eval'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_modelo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['php_cmp_required']['modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['php_cmp_required']['modelo'] == "on")) 
      { 
          if ($this->modelo == "")  
          { 
              $Campos_Falta[] =  "Modelo" ; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['modelo']['keyVal'] = form_parametros_planilla_eval_pack_protect_string($this->nmgp_dados_form['modelo']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_vinticinco($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->vinticinco = $this->vinticinco_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['parms'] = "modelo?#?$this->modelo?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
      ...
      { 
          ...
          $qt_geral_reg_form_parametros_planilla_eval = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total'] = $qt_geral_reg_form_parametros_planilla_eval;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->modelo))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_parametros_planilla_eval = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] > $qt_geral_reg_form_parametros_planilla_eval)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] = $qt_geral_reg_form_parametros_planilla_eval; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_parametros_planilla_eval) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['reg_start'] < $qt_geral_reg_form_parametros_planilla_eval;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_parametros_planilla_eval_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_parametros_planilla_eval_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_parametros_planilla_eval_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_parametros_planilla_eval_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros_planilla_eval']['masterValue'] as $cmp_master => $val_master)
{
?>
