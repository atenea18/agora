<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_estudiante_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_estudiante_']); ?>">
<input type="hidden" name="id_grupo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_grupo_']); ?>">
<input type="hidden" name="id_asignatura_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_asignatura_']); ?>">
<input type="hidden" name="entorno_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['entorno_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_evaluacion_itigvc_tecnica"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_sc_btn_0_id_grado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
var var_btn_sc_btn_0_id_grupo = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_grupo_'])?>;
var var_btn_sc_btn_0_id_asign = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
var var_btn_sc_btn_0_par_idgrado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
var var_btn_sc_btn_0_par_idgrupo = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_grupo_'])?>;
var var_btn_sc_btn_0_par_asign = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
function sc_btn_sc_btn_0()
{
  ...
  tb_show('', '<?php echo $this->Ini->link_form_rel_desemp_posicion_1_edit; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&script_case_session=<?php echo session_id() ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "id_grado*scin' + var_btn_sc_btn_0_id_grado + '*scoutid_grupo*scin' + var_btn_sc_btn_0_id_grupo + '*scoutid_asign*scin' + var_btn_sc_btn_0_id_asign + '*scoutperiodo*scin" . str_replace("'", "@aspass@", $_SESSION['par_periodo']) . "*scoutSC_glo_par_periodo*scinpar_periodo*scoutpar_idgrado*scin' + var_btn_sc_btn_0_par_idgrado + '*scoutpar_idgrupo*scin' + var_btn_sc_btn_0_par_idgrupo + '*scoutpar_asign*scin' + var_btn_sc_btn_0_par_asign + '*scoutpar_periodo*scin" . str_replace("'", "@aspass@", $_SESSION['par_periodo']) . "*scoutSC_glo_par_par_periodo*scinpar_periodo*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=550&width=600&modal=true', '');
}
var var_btn_sc_btn_1_par_grado = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_grado_'])?>;
var var_btn_sc_btn_1_par_asignatura = <?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['dados_form'][$sc_seq_vert]['id_asignatura_'])?>;
function sc_btn_sc_btn_1()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_form_desempeno_docente_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "par_grado?#?' + var_btn_sc_btn_1_par_grado + '?@?par_asignatura?#?' + var_btn_sc_btn_1_par_asignatura + '?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?S?@?"; ?>', '', '_self', '0', '0', 'form_desempeno_docente');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_t_evaluacion_itigvc_tecnica']['where_detal']))
  {
?>  
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form(y, z); 
} 
<?php
}
?>
