  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_evaluacion_itigvc_tecnica" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_id_estudiante_(iNumLinha)
  {
    ...
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_id_estudiante_(var_id_estudiante_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_id_estudiante__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_id_estudiante_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_id_estudiante__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_id_estudiante__cb

  // ---------- Validate estatus_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_estatus_(iNumLinha)
  {
    var nomeCampo_estatus_ = "estatus_" + iNumLinha;
    var var_estatus_ = scAjaxGetFieldHidden(nomeCampo_estatus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_estatus_(var_estatus_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_estatus__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_estatus_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_estatus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_estatus__cb

  // ---------- Validate novedad_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_novedad_(iNumLinha)
  {
    var nomeCampo_novedad_ = "novedad_" + iNumLinha;
    var var_novedad_ = scAjaxGetFieldText(nomeCampo_novedad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_novedad_(var_novedad_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_novedad__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_novedad_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_novedad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_novedad__cb

  // ---------- Validate asienta_inasistencias_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_asienta_inasistencias_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_asienta_inasistencias_(var_asienta_inasistencias_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_asienta_inasistencias__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_asienta_inasistencias_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_asienta_inasistencias__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_asienta_inasistencias__cb

  // ---------- Validate inasistencia_p1_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_inasistencia_p1_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_inasistencia_p1_(var_inasistencia_p1_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_inasistencia_p1__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_inasistencia_p1_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_inasistencia_p1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_inasistencia_p1__cb

  // ---------- Validate eval_1_per_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_eval_1_per_(iNumLinha)
  {
    var nomeCampo_eval_1_per_ = "eval_1_per_" + iNumLinha;
    var var_eval_1_per_ = scAjaxGetFieldHidden(nomeCampo_eval_1_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_eval_1_per_(var_eval_1_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_eval_1_per__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_eval_1_per_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_eval_1_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_eval_1_per__cb

  // ---------- Validate dc1_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc1_(iNumLinha)
  {
    var nomeCampo_dc1_ = "dc1_" + iNumLinha;
    var var_dc1_ = scAjaxGetFieldText(nomeCampo_dc1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc1_(var_dc1_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc1__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc1_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc1__cb

  // ---------- Validate dc2_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc2_(iNumLinha)
  {
    var nomeCampo_dc2_ = "dc2_" + iNumLinha;
    var var_dc2_ = scAjaxGetFieldText(nomeCampo_dc2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc2_(var_dc2_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc2__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc2_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_dc2__cb

  // ---------- Validate pcent_dc_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_pcent_dc_(iNumLinha)
  {
    var nomeCampo_pcent_dc_ = "pcent_dc_" + iNumLinha;
    var var_pcent_dc_ = scAjaxGetFieldText(nomeCampo_pcent_dc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_pcent_dc_(var_pcent_dc_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_pcent_dc__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_pcent_dc_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_pcent_dc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_pcent_dc__cb

  // ---------- Validate aeep1_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_aeep1_(iNumLinha)
  {
    var nomeCampo_aeep1_ = "aeep1_" + iNumLinha;
    var var_aeep1_ = scAjaxGetFieldText(nomeCampo_aeep1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_aeep1_(var_aeep1_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_aeep1__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_aeep1_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_aeep1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_aeep1__cb

  // ---------- Validate porcent_aeep1_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_porcent_aeep1_(iNumLinha)
  {
    var nomeCampo_porcent_aeep1_ = "porcent_aeep1_" + iNumLinha;
    var var_porcent_aeep1_ = scAjaxGetFieldText(nomeCampo_porcent_aeep1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_validate_porcent_aeep1_(var_porcent_aeep1_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_validate_porcent_aeep1__cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_porcent_aeep1_

  function do_ajax_form_t_evaluacion_itigvc_tecnica_validate_porcent_aeep1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_validate_porcent_aeep1__cb

  // ---------- Event onblur aeep1_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_event_aeep1__onblur(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_itigvc_tecnica_event_aeep1__onblur(var_dc1_, var_dc2_, var_aeep1_, var_pcent_dc_, var_porcent_aeep1_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_itigvc_tecnica_event_aeep1__onblur_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_event_aeep1__onblur

  function do_ajax_form_t_evaluacion_itigvc_tecnica_event_aeep1__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_event_aeep1__onblur_cb

  // ---------- Event onblur dc1_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc1__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_aeep1_ = scAjaxGetFieldText("aeep1_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_itigvc_tecnica_event_dc1__onblur(var_dc1_, var_dc2_, var_aeep1_, var_pcent_dc_, var_porcent_aeep1_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc1__onblur_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc1__onblur

  function do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc1__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc1__onblur_cb

  // ---------- Event onblur dc2_
  function do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc2__onblur(iSeqForm)
  {
    var var_dc1_ = scAjaxGetFieldText("dc1_" + iSeqForm);
    var var_dc2_ = scAjaxGetFieldText("dc2_" + iSeqForm);
    var var_aeep1_ = scAjaxGetFieldText("aeep1_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_itigvc_tecnica_event_dc2__onblur(var_dc1_, var_dc2_, var_aeep1_, var_pcent_dc_, var_porcent_aeep1_, var_eval_1_per_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc2__onblur_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc2__onblur

  function do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc2__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_event_dc2__onblur_cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_evaluacion_itigvc_tecnica_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_evaluacion_itigvc_tecnica_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_itigvc_tecnica_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_add_new_line_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_add_new_line

  function do_ajax_form_t_evaluacion_itigvc_tecnica_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_evaluacion_itigvc_tecnica_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_itigvc_tecnica_backup_line(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_entorno_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_backup_line_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_backup_line

  function do_ajax_form_t_evaluacion_itigvc_tecnica_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_backup_line_cb

  function do_ajax_form_t_evaluacion_itigvc_tecnica_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_cancel_insert

  function do_ajax_form_t_evaluacion_itigvc_tecnica_cancel_update(iSeqVert)
  {
    do_ajax_form_t_evaluacion_itigvc_tecnica_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_cancel_update

  function do_ajax_form_t_evaluacion_itigvc_tecnica_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_evaluacion_itigvc_tecnica_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_itigvc_tecnica_table_refresh(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_entorno_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_table_refresh_cb);
  } //  do_ajax_form_t_evaluacion_itigvc_tecnica_table_refresh

  function do_ajax_form_t_evaluacion_itigvc_tecnica_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_t_evaluacion_itigvc_tecnica_submit_form(var_id_estudiante_, var_estatus_, var_novedad_, var_asienta_inasistencias_, var_inasistencia_p1_, var_eval_1_per_, var_dc1_, var_dc2_, var_pcent_dc_, var_aeep1_, var_porcent_aeep1_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form

  function do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_evaluacion_itigvc_tecnica_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_t_evaluacion_itigvc_tecnica_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_itigvc_tecnica_navigate_form(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_entorno_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_itigvc_tecnica_navigate_form_cb);
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_navigate_form

  function do_ajax_form_t_evaluacion_itigvc_tecnica_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_t_evaluacion_itigvc_tecnica_navigate_form_cb
  function sc_hide_form_t_evaluacion_itigvc_tecnica_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_evaluacion_itigvc_tecnica_form
