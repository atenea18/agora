   ...
   function trata_campos()
   {
      ...
      if (is_array($id_sede)) {
          foreach ($id_sede as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_sede'])) {
      ...
      if (is_array($id_jornada)) {
          foreach ($id_jornada as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_jornada'])) {
      ...
      if (is_array($grado_igreso)) {
          foreach ($grado_igreso as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['grado_igreso'])) {
      ...
      if (is_array($id_grupo)) {
          foreach ($id_grupo as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_grupo'])) {
