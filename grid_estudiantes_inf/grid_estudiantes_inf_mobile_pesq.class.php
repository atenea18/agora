...
class grid_estudiantes_inf_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_estudiantes_inf_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_estudiantes_inf_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_estudiantes_inf_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_estudiantes_inf_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_idstudents($idstudents)
   {
      ...
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and  idstudents like '%" . $idstudents . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and  idstudents like '%" . $idstudents . "%'"; 
   ...
   function lookup_ajax_primer_nombre($primer_nombre)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_nombre from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and  primer_nombre like '%" . $primer_nombre . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_segundo_nombre($segundo_nombre)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct segundo_nombre from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and  segundo_nombre like '%" . $segundo_nombre . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_primer_apellido($primer_apellido)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_apellido from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and  primer_apellido like '%" . $primer_apellido . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_segundo_apellido($segundo_apellido)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct segundo_apellido from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and  segundo_apellido like '%" . $segundo_apellido . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_estudiantes_inf/grid_estudiantes_inf_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_estudiantes_inf_ajax_search.js"></script>
 <script type="text/javascript" src="grid_estudiantes_inf_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idstudents = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['idstudents']; 
          $idstudents_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['idstudents_cond']; 
          $id_sede = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_sede']; 
          $id_sede_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_sede_cond']; 
          $id_jornada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_jornada']; 
          $id_jornada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_jornada_cond']; 
          $grado_igreso = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['grado_igreso']; 
          $grado_igreso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['grado_igreso_cond']; 
          $id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_grupo']; 
          $id_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_grupo_cond']; 
          $primer_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_nombre']; 
          $primer_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_nombre_cond']; 
          $segundo_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_nombre']; 
          $segundo_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_nombre_cond']; 
          $primer_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_apellido']; 
          $primer_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_apellido_cond']; 
          $segundo_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_apellido']; 
          $segundo_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_apellido_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_estudiantes_inf_help.txt"))
   {
...
<?php echo $SC_Label ?><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and idstudents = $idstudents_look"; 
      }
      else
      {
          $nm_comando = "select distinct idstudents from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and idstudents = $idstudents_look"; 
...
?>
<?php echo $SC_Label ?><br>
      <SELECT class="scFilterObjectEven" id="SC_id_sede_cond" name="id_sede_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sede'), this, 'id_sede')">
      ...
      <br><span id="id_hide_id_sede"  <?php echo $str_hide_id_sede?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_sede'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_sede'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_id_sede">
      <SELECT class="scFilterObjectEven" id="SC_id_sede" name="id_sede[]"  size="7" multiple>
<?php
...
?>
<?php echo $SC_Label ?><br>
      <SELECT class="scFilterObjectOdd" id="SC_id_jornada_cond" name="id_jornada_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_jornada'), this, 'id_jornada')">
       <OPTION value="gt" <?php if ("gt" == $id_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_jornada"  <?php echo $str_hide_id_jornada?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_jornada'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_jornada'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_id_jornada">
      <SELECT class="scFilterObjectOdd" id="SC_id_jornada" name="id_jornada[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_grado_igreso"  <?php echo $str_hide_grado_igreso?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['grado_igreso'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['grado_igreso'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_grado_igreso">
      <SELECT class="scFilterObjectEven" id="SC_grado_igreso" name="grado_igreso[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_grupo"  <?php echo $str_hide_id_grupo?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_grupo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_grupo'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_id_grupo">
      <SELECT class="scFilterObjectOdd" id="SC_id_grupo" name="id_grupo[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php echo $SC_Label ?><br>
      ...
      $primer_nombre_look = substr($this->Db->qstr($primer_nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_nombre from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and primer_nombre = '$primer_nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php echo $SC_Label ?><br>
      ...
      $segundo_nombre_look = substr($this->Db->qstr($segundo_nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct segundo_nombre from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and segundo_nombre = '$segundo_nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php echo $SC_Label ?><br>
      ...
      $primer_apellido_look = substr($this->Db->qstr($primer_apellido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct primer_apellido from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and primer_apellido = '$primer_apellido_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_segundo_apellido"  <?php echo $str_hide_segundo_apellido?>><?php
      $segundo_apellido_look = substr($this->Db->qstr($segundo_apellido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct segundo_apellido from " . $this->Ini->nm_tabela . " where id_grupo = " . $_SESSION['par_grupo'] . " and segundo_apellido = '$segundo_apellido_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_inf']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_estudiantes_inf']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'id_sede[]')
      {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'id_jornada[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'grado_igreso[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'id_grupo[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/grid_estudiantes_inf";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_sede'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_jornada'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['grado_igreso'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['psq_check_ret']['id_grupo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Grupo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['idstudents'] = $idstudents; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['idstudents_cond'] = $idstudents_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_sede'] = $id_sede; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_sede_cond'] = $id_sede_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_jornada'] = $id_jornada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_jornada_cond'] = $id_jornada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['grado_igreso'] = $grado_igreso; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['grado_igreso_cond'] = $grado_igreso_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_grupo'] = $id_grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_grupo_cond'] = $id_grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_nombre'] = $primer_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_nombre_cond'] = $primer_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_nombre'] = $segundo_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_nombre_cond'] = $segundo_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_apellido'] = $primer_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['primer_apellido_cond'] = $primer_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_apellido'] = $segundo_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['segundo_apellido_cond'] = $segundo_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      $this->cmp_formatado['id_sede'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_sede'];
      $this->cmp_formatado['id_sede_input_2'] = $id_sede_input_2;
      $this->cmp_formatado['id_jornada'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_jornada'];
      $this->cmp_formatado['id_jornada_input_2'] = $id_jornada_input_2;
      $this->cmp_formatado['grado_igreso'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['grado_igreso'];
      $this->cmp_formatado['grado_igreso_input_2'] = $grado_igreso_input_2;
      $this->cmp_formatado['id_grupo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']['id_grupo'];
      ...
      if (count($id_sede) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label['id_sede'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($id_jornada) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label['id_jornada'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($grado_igreso) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label['grado_igreso'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($id_grupo) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $nmgp_tab_label['id_grupo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq_ant'] = $this->comando . $this->comando_fim;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "id_sede" : return ('class="scFilterObjectEven"'); break;
         case "id_jornada" : return ('class="scFilterObjectOdd"'); break;
