<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiantes_inf_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiantes_inf_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idstudents'] = "on";
   $tab_def_campos['idstudents'] = "idstudents";
   $tab_converte["idstudents"]   = "idstudents";
   $tab_labels["idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["idstudents"] : "Código";
   ...
   {
       $tab_def_campos['nombre'] = "";
       $tab_converte[""]   = "nombre";
   }
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['genero'] = "on";
   $tab_def_campos['genero'] = "genero";
   $tab_converte["genero"]   = "genero";
   $tab_labels["genero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["genero"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["genero"] : "Genero";
   $tab_ger_campos['fecha_nacimiento'] = "on";
   $tab_def_campos['fecha_nacimiento'] = "fecha_nacimiento";
   $tab_converte["fecha_nacimiento"]   = "fecha_nacimiento";
   $tab_labels["fecha_nacimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["fecha_nacimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["fecha_nacimiento"] : "Fecha Nacimiento";
   $tab_ger_campos['edad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['edad'] = "edad";
       $tab_converte["edad"]   = "edad";
   }
   else
   {
       $tab_def_campos['edad'] = "";
   ...
   $tab_labels["edad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["edad"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["edad"] : "Edad";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_converte["telefono"]   = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["telefono"] : "Telefono";
   $tab_ger_campos['tipo_identificacion'] = "on";
   $tab_def_campos['tipo_identificacion'] = "tipo_identificacion";
   $tab_converte["tipo_identificacion"]   = "tipo_identificacion";
   $tab_labels["tipo_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["tipo_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["tipo_identificacion"] : "T Ident";
   ...
   $tab_labels["numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["numero_documento"] : "Numero Documento";
   ...
   {
       $tab_def_campos['matricula'] = "";
       $tab_converte[""]   = "matricula";
   }
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["matricula"] : "Matriculados";
   $tab_ger_campos['estatus'] = "on";
   $tab_def_campos['estatus'] = "estatus";
   $tab_converte["estatus"]   = "estatus";
   $tab_labels["estatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["estatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['labels']["estatus"] : "Estatus";
   $tab_ger_campos['nombre'] = "none";
   $tab_ger_campos['edad'] = "none";
   $tab_ger_campos['matricula'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiantes_inf_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_inf']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
