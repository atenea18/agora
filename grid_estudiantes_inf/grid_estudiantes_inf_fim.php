...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_estudiantes_inf"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_estudiantes_inf"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_estudiantes_inf</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_estudiantes_inf']['embutida_filho'] as $ind => $sc_init)
          {
