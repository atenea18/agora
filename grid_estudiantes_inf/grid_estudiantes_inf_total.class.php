...
class grid_estudiantes_inf_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function grid_estudiantes_inf_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_estudiantes_inf']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_estudiantes_inf']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $id_sede, $id_jornada, $grado_anterior, $grado_igreso, $id_grupo;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes_inf']['contr_total_geral'] = "OK";
   } 

   //-----  id_grupo
   function quebra_id_grupo_sc_free_group_by($id_grupo, $Where_qb) 
   {
      global $tot_id_grupo , $id_sede, $id_jornada, $grado_anterior, $grado_igreso, $id_grupo;  
      $tot_id_grupo = array() ;  
