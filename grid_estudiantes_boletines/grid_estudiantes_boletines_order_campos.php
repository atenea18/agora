<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiantes_boletines_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiantes_boletines_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["students_idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_idstudents"] : "Idstudents";
   ...
   $tab_labels["students_id_sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_id_sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_id_sede"] : "Id Sede";
   $tab_ger_campos['students_id_jornada'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['students_id_jornada'] = "students_id_jornada";
       $tab_converte["students_id_jornada"]   = "students_id_jornada";
   }
   else
   {
       $tab_def_campos['students_id_jornada'] = "students.id_jornada";
       $tab_converte["students.id_jornada"]   = "students_id_jornada";
   }
   $tab_labels["students_id_jornada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_id_jornada"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_id_jornada"] : "Id Jornada";
   ...
   $tab_labels["students_numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_numero_documento"] : "Numero Documento";
   ...
   $tab_labels["students_primer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_primer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_primer_nombre"] : "Primer Nombre";
   ...
   $tab_labels["students_segundo_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_segundo_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['labels']["students_segundo_nombre"] : "Segundo Nombre";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiantes_boletines_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes_boletines']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
