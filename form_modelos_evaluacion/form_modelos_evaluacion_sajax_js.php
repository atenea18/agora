  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_modelos_evaluacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_modelo
  function do_ajax_form_modelos_evaluacion_validate_id_modelo()
  {
    var nomeCampo_id_modelo = "id_modelo";
    var var_id_modelo = scAjaxGetFieldHidden(nomeCampo_id_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_modelos_evaluacion_validate_id_modelo(var_id_modelo, var_script_case_init, do_ajax_form_modelos_evaluacion_validate_id_modelo_cb);
  } // do_ajax_form_modelos_evaluacion_validate_id_modelo

  function do_ajax_form_modelos_evaluacion_validate_id_modelo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_modelos_evaluacion_validate_id_modelo_cb

  // ---------- Validate modelo
  function do_ajax_form_modelos_evaluacion_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_modelos_evaluacion_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_modelos_evaluacion_validate_modelo_cb);
  } // do_ajax_form_modelos_evaluacion_validate_modelo

  function do_ajax_form_modelos_evaluacion_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modelo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_modelos_evaluacion_validate_modelo_cb

  // ---------- Validate documento
  function do_ajax_form_modelos_evaluacion_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_modelos_evaluacion_validate_documento(var_documento, var_script_case_init, do_ajax_form_modelos_evaluacion_validate_documento_cb);
  } // do_ajax_form_modelos_evaluacion_validate_documento

  function do_ajax_form_modelos_evaluacion_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_modelos_evaluacion_validate_documento_cb
  // ---------- Form
  function do_ajax_form_modelos_evaluacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_modelos_evaluacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_modelos_evaluacion_submit_form(var_id_modelo, var_modelo, var_documento, var_documento_ul_name, var_documento_ul_type, var_documento_salva, var_documento_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_modelos_evaluacion_submit_form_cb);
  } // do_ajax_form_modelos_evaluacion_submit_form

  function do_ajax_form_modelos_evaluacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_modelos_evaluacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_modelos_evaluacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_modelos_evaluacion_navigate_form(var_id_modelo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_modelos_evaluacion_navigate_form_cb);
  } // do_ajax_form_modelos_evaluacion_navigate_form

  function do_ajax_form_modelos_evaluacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_modelos_evaluacion_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_modelos_evaluacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_modelos_evaluacion_navigate_form_cb
  function sc_hide_form_modelos_evaluacion_form()
  {
