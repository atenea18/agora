...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_planillas_jacson/control_planillas_jacson_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_planillas_jacson_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_planillas_jacson_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['recarga'];
}
?>
...
<?php
 include_once("control_planillas_jacson_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_planillas_jacson_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_planillas_jacson_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_planillas_jacson_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_planillas_jacson_mob");
 parent.scAjaxDetailHeight("control_planillas_jacson_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
