  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_planillas_jacson" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate grupo
  function do_ajax_control_planillas_jacson_validate_grupo()
  {
    var nomeCampo_grupo = "grupo";
    var var_grupo = scAjaxGetFieldSelect(nomeCampo_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_planillas_jacson_validate_grupo(var_grupo, var_script_case_init, do_ajax_control_planillas_jacson_validate_grupo_cb);
  } // do_ajax_control_planillas_jacson_validate_grupo

  function do_ajax_control_planillas_jacson_validate_grupo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_planillas_jacson_validate_grupo_cb

  // ---------- Validate asignatura
  function do_ajax_control_planillas_jacson_validate_asignatura()
  {
    var nomeCampo_asignatura = "asignatura";
    var var_asignatura = scAjaxGetFieldSelect(nomeCampo_asignatura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_planillas_jacson_validate_asignatura(var_asignatura, var_script_case_init, do_ajax_control_planillas_jacson_validate_asignatura_cb);
  } // do_ajax_control_planillas_jacson_validate_asignatura

  function do_ajax_control_planillas_jacson_validate_asignatura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_planillas_jacson_validate_asignatura_cb
  // ---------- Form
  function do_ajax_control_planillas_jacson_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_planillas_jacson_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_planillas_jacson_submit_form(var_grupo, var_asignatura, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_planillas_jacson_submit_form_cb);
  } // do_ajax_control_planillas_jacson_submit_form

  function do_ajax_control_planillas_jacson_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_planillas_jacson_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_planillas_jacson_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_planillas_jacson_navigate_form

  function do_ajax_control_planillas_jacson_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_planillas_jacson_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_planillas_jacson_navigate_form_cb
  function sc_hide_control_planillas_jacson_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_planillas_jacson_form
