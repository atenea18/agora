...
<?php
include_once("control_planillas_jacson_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_planillas_jacson_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['recarga'];
}
?>
...
<?php
 include_once("control_planillas_jacson_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_planillas_jacson'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_planillas_jacson'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planillas_jacson']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_planillas_jacson");
 parent.scAjaxDetailHeight("control_planillas_jacson", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
