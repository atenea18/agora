...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_imp_boletines_term/control_imp_boletines_term_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_imp_boletines_term_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_imp_boletines_term_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_estudent", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_imp_boletines_term.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['recarga'];
}
?>
...
<?php
 include_once("control_imp_boletines_term_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_imp_boletines_term'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_imp_boletines_term'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_imp_boletines_term']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_imp_boletines_term");
 parent.scAjaxDetailHeight("control_imp_boletines_term", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
