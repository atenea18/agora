<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_boletines_areas_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_boletines_areas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['labels']["id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['labels']["id_area"] : "";
   ...
   $tab_labels["eval_periodo1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['labels']["eval_periodo1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['labels']["eval_periodo1"] : "";
   $tab_ger_campos['desem_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desem_area'] = "desem_area";
       $tab_converte["desem_area"]   = "desem_area";
   }
   else
   {
       $tab_def_campos['desem_area'] = "";
       $tab_converte[""]   = "desem_area";
   }
   $tab_labels["desem_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['labels']["desem_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['labels']["desem_area"] : "";
   $tab_ger_campos['eval_periodo1'] = "none";
   $tab_ger_campos['desem_area'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_boletines_areas_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_boletines_areas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
