  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_grados" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate grado_
  function do_ajax_form_t_grados_validate_grado_(iNumLinha)
  {
    var nomeCampo_grado_ = "grado_" + iNumLinha;
    var var_grado_ = scAjaxGetFieldText(nomeCampo_grado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_grados_validate_grado_(var_grado_, iNumLinha, var_script_case_init, do_ajax_form_t_grados_validate_grado__cb);
  } // do_ajax_form_t_grados_validate_grado_

  function do_ajax_form_t_grados_validate_grado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "grado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "grado_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "grado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "grado_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_grados_validate_grado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_grados_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_grados_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_grados_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_grados_add_new_line_cb);
  } // do_ajax_form_t_grados_add_new_line

  function do_ajax_form_t_grados_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_grados_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_grados_backup_line(iNumLinha)
  {
    var var_id_grado_ = scAjaxGetFieldText("id_grado_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_grados_backup_line(var_id_grado_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_grados_backup_line_cb);
  } // do_ajax_form_t_grados_backup_line

  function do_ajax_form_t_grados_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_grados_backup_line_cb

  function do_ajax_form_t_grados_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_grados_cancel_insert

  function do_ajax_form_t_grados_cancel_update(iSeqVert)
  {
    do_ajax_form_t_grados_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_grados_cancel_update

  function do_ajax_form_t_grados_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_grados_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_grados_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_t_grados_table_refresh(var_id_grado_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_grados_table_refresh_cb);
  } //  do_ajax_form_t_grados_table_refresh

  function do_ajax_form_t_grados_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_grados_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_grados_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_grados_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_grado_ = scAjaxGetFieldText("grado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_t_grados_submit_form(var_grado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_grados_submit_form_cb);
  } // do_ajax_form_t_grados_submit_form

  function do_ajax_form_t_grados_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("grado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_t_grados_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_grados_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_t_grados_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("grado_" + iNavForm);
    }
    var var_id_grado_ = document.F2.id_grado_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_grados_navigate_form(var_id_grado_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_grados_navigate_form_cb);
  } // do_ajax_form_t_grados_navigate_form

  function do_ajax_form_t_grados_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_t_grados_navigate_form_cb
  function sc_hide_form_t_grados_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_grados_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "grado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["grado_" + iNumLinha] = {"label": "Grado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["grado_"][iNumLinha] = "grado_" + iNumLinha;
    ajax_field_id["grado_" + iNumLinha] = new Array("hidden_field_label_grado_", "hidden_field_data_grado_" + iNumLinha);
    ajax_error_count["grado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["grado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["grado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["grado_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["grado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["grado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["grado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["grado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["grado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['grado_'])) ? $this->nmgp_cmp_readonly['grado_'] : 'off';
?>
    scAjaxFieldRead("grado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("grado_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["grado_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_grado_" + iRow))
        document.getElementById("hidden_field_data_grado_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["grado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["grado_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_grado_" + iRow))
        document.getElementById("hidden_field_data_grado_" + iRow).className = sCssLine;
    }
  }
