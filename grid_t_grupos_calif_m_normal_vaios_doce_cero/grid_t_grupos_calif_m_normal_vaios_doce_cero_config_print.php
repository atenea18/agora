 ...
 */
    ...
    session_start();
    $SC_apl_proc = "grid_t_grupos_calif_m_normal_vaios_doce_cero";
...
<form name="config_prt" method="post" action="grid_t_grupos_calif_m_normal_vaios_doce_cero_config_print.php">
<?php
