<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_rel_act_est_per_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_rel_act_est_per_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_det_evalua_actividad_dc3"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_det_evalua_actividad_dc3_submit_form(y, z); 
} 
<?php
}
?>
