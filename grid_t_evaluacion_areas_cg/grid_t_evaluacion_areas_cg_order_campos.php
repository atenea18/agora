<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_areas_cg_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_areas_cg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['linea1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['linea1'] = "linea1";
       $tab_converte["linea1"]   = "linea1";
   }
   else
   {
       $tab_def_campos['linea1'] = "";
       $tab_converte[""]   = "linea1";
   }
   $tab_labels["linea1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["linea1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["linea1"] : "linea1";
   $tab_ger_campos['id_area'] = "on";
   $tab_def_campos['id_area'] = "id_area";
   $tab_converte["id_area"]   = "id_area";
   $tab_labels["id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["id_area"] : "";
   $tab_ger_campos['linea5'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['linea5'] = "linea5";
       $tab_converte["linea5"]   = "linea5";
   }
   else
   {
       $tab_def_campos['linea5'] = "";
       $tab_converte[""]   = "linea5";
   }
   $tab_labels["linea5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["linea5"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["linea5"] : "linea5";
   $tab_ger_campos['eval_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['eval_area'] = "eval_area";
       $tab_converte["eval_area"]   = "eval_area";
   }
   else
   {
       $tab_def_campos['eval_area'] = "";
       $tab_converte[""]   = "eval_area";
   }
   $tab_labels["eval_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["eval_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["eval_area"] : "";
   $tab_ger_campos['linea'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['linea'] = "linea";
       $tab_converte["linea"]   = "linea";
   }
   else
   {
       $tab_def_campos['linea'] = "";
       $tab_converte[""]   = "linea";
   }
   $tab_labels["linea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["linea"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["linea"] : "";
   ...
   $tab_labels["desempeno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["desempeno"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["desempeno"] : "";
   $tab_ger_campos['asignaturas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['asignaturas'] = "asignaturas";
       $tab_converte["asignaturas"]   = "asignaturas";
   }
   else
   {
       $tab_def_campos['asignaturas'] = "";
       $tab_converte[""]   = "asignaturas";
   }
   $tab_labels["asignaturas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["asignaturas"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['labels']["asignaturas"] : "";
   $tab_ger_campos['linea1'] = "none";
   $tab_ger_campos['linea5'] = "none";
   $tab_ger_campos['eval_area'] = "none";
   $tab_ger_campos['linea'] = "none";
   $tab_ger_campos['desempeno'] = "none";
   $tab_ger_campos['asignaturas'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_areas_cg']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_areas_cg']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_areas_cg']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_areas_cg_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_areas_cg']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
