...
class grid_t_evaluacion_areas_cg_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_evaluacion_areas_cg_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_t_evaluacion_areas_cg.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_areas_cg']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_areas_cg']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_areas_cg']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_areas_cg']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_t_evaluacion_areas_cg']['contr_erro'] = 'off'; 
   ...
   function NM_export_linea5()
   {
         ...
         $this->linea5 = str_replace('<', '&lt;', $this->linea5);
         $this->linea5 = str_replace('>', '&gt;', $this->linea5);
         $this->Texto_tag .= "<td>" . $this->linea5 . "</td>\r\n";
   }
   //----- eval_area
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_areas_cg']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_areas_cg']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
