...
<?php
include_once("control_periodos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_periodos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['recarga'];
}
?>
...
<?php
 include_once("control_periodos_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_periodos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_periodos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_periodos']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_periodos");
 parent.scAjaxDetailHeight("control_periodos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
