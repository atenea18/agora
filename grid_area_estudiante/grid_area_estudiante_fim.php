...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_area_estudiante"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_area_estudiante"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_area_estudiante</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_area_estudiante']['embutida_filho'] as $ind => $sc_init)
          {
