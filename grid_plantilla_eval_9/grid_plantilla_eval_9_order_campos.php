<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_plantilla_eval_9_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_plantilla_eval_9_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["t_evaluacion_id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_id_estudiante"] : "Estudiante";
   ...
   $tab_labels["t_evaluacion_novedad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_novedad"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_novedad"] : "Nov";
   ...
   $tab_labels["t_evaluacion_inasistencia_p1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_inasistencia_p1"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_inasistencia_p1"] : "FA";
   ...
   $tab_labels["re"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["re"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["re"] : "RE";
   ...
   $tab_labels["t_evaluacion_eval_1_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_eval_1_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_eval_1_per"] : "P1";
   ...
   $tab_labels["t_evaluacion_eval_2_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_eval_2_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_eval_2_per"] : "P2";
   ...
   $tab_labels["t_evaluacion_eval_3_per"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_eval_3_per"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_eval_3_per"] : "P3";
   ...
   $tab_labels["fa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["fa"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["fa"] : "VAc";
   ...
   $tab_labels["vra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["vra"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["vra"] : "VRa";
   ...
   $tab_labels["t_evaluacion_dc1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc1"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc1"] : "ExP";
   ...
   $tab_labels["t_evaluacion_dc2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc2"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc2"] : "ExFp";
   ...
   $tab_labels["t_evaluacion_dc3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc3"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc3"] : "TyT";
   ...
   $tab_labels["t_evaluacion_dc4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc4"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc4"] : "ParA";
   ...
   $tab_labels["t_evaluacion_dc5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc5"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["t_evaluacion_dc5"] : "ObsR";
   ...
   $tab_labels["val"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["val"])) ? $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['labels']["val"] : "VAL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_plantilla_eval_9_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_plantilla_eval_9']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
