...
class grid_plantilla_eval_9_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_plantilla_eval_9_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo    .= ".csv";
      $this->Tit_doc    = "grid_plantilla_eval_9.csv";
      $this->Delim_dados = "\"";
      $this->Delim_col   = ";";
      $this->Delim_line  = "\r\n";
   }
...
$_SESSION['scriptcase']['grid_plantilla_eval_9']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_plantilla_eval_9']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_plantilla_eval_9']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_plantilla_eval_9']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_plantilla_eval_9']['csv_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_plantilla_eval_9']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_plantilla_eval_9']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
