...
class grid_informe_general_periodo_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_informe_general_periodo_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_informe_general_periodo.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_informe_general_periodo";
   ...
   function NM_export_id_informe_general_periodo()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_informe_general_periodo))
         {
             $this->id_informe_general_periodo = sc_convert_encoding($this->id_informe_general_periodo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " id_informe_general_periodo =\"" . $this->trata_dados($this->id_informe_general_periodo) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - informe_general_periodo :: XML</TITLE>
