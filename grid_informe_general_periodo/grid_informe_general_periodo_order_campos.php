<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_informe_general_periodo_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_informe_general_periodo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_estudiante"] : "Estudiante";
   $tab_ger_campos['id_grupo'] = "on";
   $tab_def_campos['id_grupo'] = "id_grupo";
   $tab_converte["id_grupo"]   = "id_grupo";
   $tab_labels["id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_grupo"] : "Grupo";
   $tab_ger_campos['id_periodo'] = "on";
   $tab_def_campos['id_periodo'] = "id_periodo";
   $tab_converte["id_periodo"]   = "id_periodo";
   $tab_labels["id_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_periodo"] : "Periodo";
   ...
   $tab_labels["id_director_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_director_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["id_director_grupo"] : "Director Grupo";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_converte["observaciones"]   = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - informe_general_periodo</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_informe_general_periodo_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_informe_general_periodo']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
