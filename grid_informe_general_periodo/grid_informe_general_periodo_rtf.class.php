...
class grid_informe_general_periodo_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_informe_general_periodo_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_informe_general_periodo";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_informe_general_periodo.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "id_informe_general_periodo" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->id_informe_general_periodo = $rs->fields[5] ;  
   ...
   function NM_export_id_informe_general_periodo()
   {
         nmgp_Form_Num_Val($this->id_informe_general_periodo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if (!NM_is_utf8($this->id_informe_general_periodo))
         {
             $this->id_informe_general_periodo = sc_convert_encoding($this->id_informe_general_periodo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->id_informe_general_periodo = str_replace('<', '&lt;', $this->id_informe_general_periodo);
         $this->id_informe_general_periodo = str_replace('>', '&gt;', $this->id_informe_general_periodo);
         $this->Texto_tag .= "<td>" . $this->id_informe_general_periodo . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_informe_general_periodo'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - informe_general_periodo :: RTF</TITLE>
