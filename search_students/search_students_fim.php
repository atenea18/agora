...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____search_students"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____search_students"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_students'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['search_students']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['search_students']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['search_students']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['search_students']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['search_students']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['search_students']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['search_students']['embutida_filho'] as $ind => $sc_init)
          {
