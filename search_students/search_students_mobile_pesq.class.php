...
class search_students_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . search_students_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . search_students_pack_protect_string($Tipo_filter[0]) . "\">.." . search_students_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numero_documento($numero_documento)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numero_documento from " . $this->Ini->nm_tabela . " where  numero_documento like '%" . $numero_documento . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_students') . "/";
?>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>search_students/search_students_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="search_students_ajax_search.js"></script>
 <script type="text/javascript" src="search_students_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_grado_igreso#NMF#' + search_get_select('SC_grado_igreso') + '@NMF@';
  ...
  str_out += 'SC_genero_cond#NMF#' + search_get_sel_txt('SC_genero_cond') + '@NMF@';
  str_out += 'SC_genero#NMF#' + search_get_radio('SC_genero') + '@NMF@';
  str_out += 'SC_id_sede_cond#NMF#' + search_get_sel_txt('SC_id_sede_cond') + '@NMF@';
  str_out += 'SC_id_sede#NMF#' + search_get_select('SC_id_sede') + '@NMF@';
  str_out += 'SC_id_jornada_cond#NMF#' + search_get_sel_txt('SC_id_jornada_cond') + '@NMF@';
  str_out += 'SC_id_jornada#NMF#' + search_get_select('SC_id_jornada') + '@NMF@';
  str_out += 'SC_id_grupo_cond#NMF#' + search_get_sel_txt('SC_id_grupo_cond') + '@NMF@';
  str_out += 'SC_id_grupo#NMF#' + search_get_select('SC_id_grupo') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - students</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['search_students']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['search_students']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['search_students']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("search_students", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idstudents = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['idstudents']; 
          $idstudents_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['idstudents_cond']; 
          $grado_igreso = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['grado_igreso']; 
          $grado_igreso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['grado_igreso_cond']; 
          $numero_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['numero_documento']; 
          $numero_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['numero_documento_cond']; 
          $primer_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_nombre']; 
          $primer_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_nombre_cond']; 
          $segundo_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_nombre']; 
          $segundo_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_nombre_cond']; 
          $primer_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_apellido']; 
          $primer_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_apellido_cond']; 
          $segundo_apellido = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_apellido']; 
          $segundo_apellido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_apellido_cond']; 
          $genero = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['genero']; 
          $genero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['genero_cond']; 
          $id_sede = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_sede']; 
          $id_sede_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_sede_cond']; 
          $id_jornada = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_jornada']; 
          $id_jornada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_jornada_cond']; 
          $id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_grupo']; 
          $id_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_grupo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($genero_cond) || empty($genero_cond))
      {
         $genero_cond = "eq";
      }
      ...
      $str_hide_genero = (in_array($genero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (isset($grado_igreso) && !empty($grado_igreso))
      {
         $tmp_pos = strpos($grado_igreso, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $grado_igreso = substr($grado_igreso, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($genero, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $genero = substr($genero, 0, $tmp_pos);
         }
      }
      ...
      if (isset($id_jornada) && !empty($id_jornada))
      {
         $tmp_pos = strpos($id_jornada, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_jornada = substr($id_jornada, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("search_students_help.txt"))
   {
      $Arq_WebHelp = file("search_students_help.txt"); 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idstudents'])) ? $this->New_label['idstudents'] : "Idstudents"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idstudents_cond" name="idstudents_cond" onChange="nm_campos_between(document.getElementById('id_vis_idstudents'), this, 'idstudents')">
       ...
       <OPTION value="ep" <?php if ("ep" == $idstudents_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_idstudents" name="idstudents" value="<?php echo NM_encode_input($idstudents) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idstudents" name="idstudents_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['grado_igreso'])) ? $this->New_label['grado_igreso'] : "Grado Igreso"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_grado_igreso_cond" name="grado_igreso_cond" onChange="nm_campos_between(document.getElementById('id_vis_grado_igreso'), this, 'grado_igreso')">
       <OPTION value="gt" <?php if ("gt" == $grado_igreso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $grado_igreso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $grado_igreso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['grado_igreso'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['grado_igreso'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_grado_igreso">
      <SELECT class="scFilterObjectEven" id="SC_grado_igreso" name="grado_igreso"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $grado_igreso)
            {
                    $grado_igreso_sel = ($nm_opc_cod === $grado_igreso) ? "selected" : "";
            }
            else
            {
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['numero_documento'])) ? $this->New_label['numero_documento'] : "Numero Documento"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_numero_documento_cond" name="numero_documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_documento'), this, 'numero_documento')">
       <OPTION value="eq" <?php if ("eq" == $numero_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $numero_documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      $numero_documento_look = substr($this->Db->qstr($numero_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numero_documento from " . $this->Ini->nm_tabela . " where numero_documento = '$numero_documento_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_numero_documento" name="numero_documento" value="<?php echo NM_encode_input($numero_documento) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_numero_documento" name="numero_documento_autocomp" size="15" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_segundo_apellido" name="segundo_apellido_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['genero'])) ? $this->New_label['genero'] : "Genero"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_genero_cond" name="genero_cond" onChange="nm_campos_between(document.getElementById('id_vis_genero'), this, 'genero')">
       <OPTION value="eq"><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_genero" <?php echo $str_hide_genero?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['genero'])) ? $this->New_label['genero'] : "Genero";
 $nmgp_tab_label .= "genero?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($genero)) {$genero = $genero;}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['genero'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['genero'][] = "M";
  $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['genero'][] = "F";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_genero" name="genero" value="M##@@Masculino"  <?php if ("M" == $genero)  { echo " checked" ;} ?>>Masculino</TD>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_genero" name="genero" value="F##@@Femenino"  <?php if ("F" == $genero)  { echo " checked" ;} ?>>Femenino</TD>
</TR></TABLE>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_sede_cond" name="id_sede_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sede'), this, 'id_sede')">
       ...
       <OPTION value="ep" <?php if ("ep" == $id_sede_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_sede'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_sede'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_id_sede">
      <SELECT class="scFilterObjectOdd" id="SC_id_sede" name="id_sede"  size="1">
       <OPTION value="">Seleccione</OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_sede)
            {
                    $id_sede_sel = ($nm_opc_cod === $id_sede) ? "selected" : "";
            }
            else
            {
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_jornada'])) ? $this->New_label['id_jornada'] : "Jornada"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_jornada_cond" name="id_jornada_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_jornada'), this, 'id_jornada')">
       <OPTION value="eq" <?php if ("eq" == $id_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $id_jornada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_jornada'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_jornada'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_id_jornada">
      <SELECT class="scFilterObjectEven" id="SC_id_jornada" name="id_jornada"  size="1">
       <OPTION value="">Seleccione</OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_jornada)
            {
                    $id_jornada_sel = ($nm_opc_cod === $id_jornada) ? "selected" : "";
            }
            else
            {
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT id_grupo, id_grado  FROM t_grupos  ORDER BY id_grado"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_grupo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_grupo'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_id_grupo">
      <SELECT class="scFilterObjectOdd" id="SC_id_grupo" name="id_grupo"  size="1">
       <OPTION value="">Seleccione</OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_grupo)
            {
                    $id_grupo_sel = ($nm_opc_cod === $id_grupo) ? "selected" : "";
            }
            else
            {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.grado_igreso.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_genero'), document.F1.genero_cond, 'genero');
   for (i = 0; i < document.F1.genero.length; i++)
   {
      if (document.F1.genero[i].checked)
      {
          document.F1.genero[i].checked = false;
      }
   }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "agora_IV/search_students";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_grado_igreso'] = 'select';
      ...
      $tp_fields['SC_genero_cond'] = 'cond';
      $tp_fields['SC_genero'] = 'radio';
      $tp_fields['SC_id_sede_cond'] = 'cond';
      $tp_fields['SC_id_sede'] = 'select';
      $tp_fields['SC_id_jornada_cond'] = 'cond';
      $tp_fields['SC_id_jornada'] = 'select';
      $tp_fields['SC_id_grupo_cond'] = 'cond';
      $tp_fields['SC_id_grupo'] = 'select';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $idstudents_cond, $idstudents, $idstudents_autocomp,
             ...
             $id_sede_cond, $id_sede,
             $id_jornada_cond, $id_jornada,
             $id_grupo_cond, $id_grupo, $nmgp_tab_label;
      ...
      $genero_cond_salva = $genero_cond; 
      if (!isset($genero_input_2) || $genero_input_2 == "")
      {
          $genero_input_2 = $genero;
      }
      ...
      $tmp_pos = strpos($grado_igreso, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $grado_igreso;
      }
      else {
          $L_lookup = substr($grado_igreso, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['grado_igreso'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Grado Igreso : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($genero, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $genero;
          ...
          $L_lookup = substr($genero, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['genero'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Genero : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($id_sede, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $id_sede;
          ...
          $L_lookup = substr($id_sede, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_sede'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($id_jornada, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_jornada'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($id_grupo, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['psq_check_ret']['id_grupo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Id Grupo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['idstudents'] = $idstudents; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['idstudents_cond'] = $idstudents_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['grado_igreso'] = $grado_igreso; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['grado_igreso_cond'] = $grado_igreso_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['numero_documento'] = $numero_documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['numero_documento_cond'] = $numero_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_nombre'] = $primer_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_nombre_cond'] = $primer_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_nombre'] = $segundo_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_nombre_cond'] = $segundo_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_apellido'] = $primer_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['primer_apellido_cond'] = $primer_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_apellido'] = $segundo_apellido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['segundo_apellido_cond'] = $segundo_apellido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['genero'] = $genero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['genero_cond'] = $genero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_sede'] = $id_sede; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_sede_cond'] = $id_sede_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_jornada'] = $id_jornada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_jornada_cond'] = $id_jornada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_grupo'] = $id_grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['id_grupo_cond'] = $id_grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      $this->cmp_formatado['genero'] = $genero;
      if (strpos($this->cmp_formatado['genero'], "##@@") !== false)
      {
          $this->cmp_formatado['genero'] = substr($this->cmp_formatado['genero'], strpos($this->cmp_formatado['genero'], "##@@") + 4);
      }
      $this->cmp_formatado['genero_input_2'] = $genero_input_2;
      $Conteudo = $id_sede;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['id_sede'] = $Conteudo;
      $Conteudo = $id_jornada;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['id_jornada'] = $Conteudo;
      $Conteudo = $id_grupo;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['id_grupo'] = $Conteudo;
      ...
      //----- $grado_igreso
      $this->Date_part = false;
      if (isset($grado_igreso))
      {
         $this->monta_condicao("grado_igreso", $grado_igreso_cond, $grado_igreso, "", "grado_igreso");
      }
      ...
      if (isset($genero))
      {
         $this->monta_condicao("genero", $genero_cond, $genero, "", "genero");
      }
      ...
      if (isset($id_sede))
      {
         $this->monta_condicao("id_sede", $id_sede_cond, $id_sede, "", "id_sede");
      }
      ...
      if (isset($id_jornada))
      {
         $this->monta_condicao("id_jornada", $id_jornada_cond, $id_jornada, "", "id_jornada");
      }
      ...
      if (isset($id_grupo))
      {
         $this->monta_condicao("id_grupo", $id_grupo_cond, $id_grupo, "", "id_grupo");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['search_students']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['form_students']['where_filtro'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "grado_igreso" : return ('class="scFilterObjectEven"'); break;
         case "id_sede" : return ('class="scFilterObjectOdd"'); break;
         case "id_jornada" : return ('class="scFilterObjectEven"'); break;
         case "id_grupo" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
