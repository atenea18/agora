  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Login_seguridad_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_app_Login_seguridad_mob_validate_institucion()
  {
  } // do_ajax_app_Login_seguridad_mob_validate_institucion

  function do_ajax_app_Login_seguridad_mob_validate_institucion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_seguridad_mob_validate_institucion_cb

  // ---------- Validate login
  function do_ajax_app_Login_seguridad_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_seguridad_mob_validate_login(var_login, var_script_case_init, do_ajax_app_Login_seguridad_mob_validate_login_cb);
  } // do_ajax_app_Login_seguridad_mob_validate_login

  function do_ajax_app_Login_seguridad_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_seguridad_mob_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_app_Login_seguridad_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_seguridad_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_app_Login_seguridad_mob_validate_pswd_cb);
  } // do_ajax_app_Login_seguridad_mob_validate_pswd

  function do_ajax_app_Login_seguridad_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_seguridad_mob_validate_pswd_cb

  // ---------- Validate links
  function do_ajax_app_Login_seguridad_mob_validate_links()
  {
    var nomeCampo_links = "links";
    var var_links = scAjaxGetFieldText(nomeCampo_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_seguridad_mob_validate_links(var_links, var_script_case_init, do_ajax_app_Login_seguridad_mob_validate_links_cb);
  } // do_ajax_app_Login_seguridad_mob_validate_links

  function do_ajax_app_Login_seguridad_mob_validate_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "links";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_seguridad_mob_validate_links_cb

  // ---------- Event onchange institucion
  function do_ajax_app_Login_seguridad_mob_event_institucion_onchange()
  {
    var var_institucion = scAjaxGetFieldText("institucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    scEventControl_onChange_call("institucion", "");
    x_ajax_app_Login_seguridad_mob_event_institucion_onchange(var_institucion, var_script_case_init, do_ajax_app_Login_seguridad_mob_event_institucion_onchange_cb);
  } // do_ajax_app_Login_seguridad_mob_event_institucion_onchange

  function do_ajax_app_Login_seguridad_mob_event_institucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "institucion";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_Login_seguridad_mob_event_institucion_onchange_cb
  // ---------- Form
  function do_ajax_app_Login_seguridad_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app_Login_seguridad_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_institucion = scAjaxGetFieldText("institucion");
    ...
    scAjaxProcOn();
    x_ajax_app_Login_seguridad_mob_submit_form(var_institucion, var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_seguridad_mob_submit_form_cb);
  } // do_ajax_app_Login_seguridad_mob_submit_form

  function do_ajax_app_Login_seguridad_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_app_Login_seguridad_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_app_Login_seguridad_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app_Login_seguridad_mob_navigate_form

  function do_ajax_app_Login_seguridad_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_app_Login_seguridad_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app_Login_seguridad_mob_navigate_form_cb
  function sc_hide_app_Login_seguridad_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_app_Login_seguridad_mob_form
  ...
  var ajax_error_list = {
    "institucion": {"label": "Institución", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
