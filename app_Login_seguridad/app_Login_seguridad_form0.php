...
<?php
include_once("app_Login_seguridad_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('app_Login_seguridad_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-institucion", elem).focus(function() {
   ...
   select: function (event, ui) {
    ...
    do_ajax_app_Login_seguridad_event_institucion_onchange(sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['recarga'];
}
?>
...
<?php
 include_once("app_Login_seguridad_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['app_Login_seguridad'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['app_Login_seguridad'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_institucion_label" id="hidden_field_label_institucion" style="<?php echo $sStyleHidden_institucion; ?>"><span id="id_label_institucion"><?php echo $this->nm_new_label['institucion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['php_cmp_required']['institucion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['php_cmp_required']['institucion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_institucion_line" id="hidden_field_data_institucion" style="<?php echo $sStyleHidden_institucion; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_login_label" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pswd_label" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("app_Login_seguridad");
 parent.scAjaxDetailHeight("app_Login_seguridad", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
