<?php
//
class app_Login_seguridad_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_email)) 
          {
              $_SESSION['usr_email'] = $this->usr_email;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new app_Login_seguridad_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['initialize'])
          {
              $_SESSION['scriptcase']['app_Login_seguridad_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['app_Login_seguridad_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['app_Login_seguridad_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app_Login_seguridad_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app_Login_seguridad_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login_seguridad_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login_seguridad_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('app_Login_seguridad_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_Login_seguridad_mob']['label'] = "Login";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "app_Login_seguridad_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['app_Login_seguridad_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['app_Login_seguridad_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app_Login_seguridad_mob']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("app_Login_seguridad_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'app_Login_seguridad_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'app_Login_seguridad_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'app_Login_seguridad/app_Login_seguridad_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "app_Login_seguridad_mob_erro.class.php"); 
      }
      $this->Erro      = new app_Login_seguridad_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['app_Login_seguridad_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['app_Login_seguridad_mob']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['Lookup_institucion']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['Lookup_institucion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['Lookup_institucion']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['Lookup_institucion'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Ini->nm_db_conn_mysql_ge->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(app_Login_seguridad_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => app_Login_seguridad_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['Lookup_institucion'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['recarga'] = $this->nmgp_opcao;
      }
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos']))
              { 
                  $institucion = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][0]; 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][1]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][2]; 
                  $links = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][3]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][0] = $this->institucion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][1] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][2] = $this->pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['campos'][3] = $this->links; 
          if (!empty($this->links))
          {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['redir'] == "redir")
          {
              $this->nmgp_redireciona(); 
          }
          else
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("app_Login_seguridad_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("app_Login_seguridad_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_app_Login_seguridad_mob']) || !is_array($this->NM_ajax_info['errList']['geral_app_Login_seguridad_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_app_Login_seguridad_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_app_Login_seguridad_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if(count($this->rs ) == 0)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_app_Login_seguridad_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['app_Login_seguridad_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_institucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['php_cmp_required']['institucion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['php_cmp_required']['institucion'] == "on")) 
      { 
          if ($this->institucion == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['php_cmp_required']['login'] == "on")) 
      { 
          if ($this->login == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['php_cmp_required']['pswd'] == "on")) 
      { 
          if ($this->pswd == "")  
          { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][app_Login_seguridad_mob_pack_protect_string(NM_charset_to_utf8($this->institucion))]) ? $aLookup[0][app_Login_seguridad_mob_pack_protect_string(NM_charset_to_utf8($this->institucion))] : "";
   ...
   function ajax_return_values_links($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['app_Login_seguridad_mob']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
    include_once("app_Login_seguridad_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_app_Login_seguridad_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['total'] = $qt_geral_reg_app_Login_seguridad_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          app_Login_seguridad_mob_pack_ajax_response();
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['empty_filter'] = true;
          $this->NM_ajax_info['empty_filter'] = 'ok';
          app_Login_seguridad_mob_pack_ajax_response();
          exit;
      }
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "app_Login_seguridad_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "app_Login_seguridad_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_seguridad_mob']['retorno_edit'] = "";
   }
