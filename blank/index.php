...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20161227"; 
      $this->nm_hr_criacao   = "125328"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20170105"; 
      $this->nm_hr_ult_alt   = "163758"; 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'agora_IV'); 
      } 
      else 
      { 
...
<div class="centrar">
<img src="../evaluacion.jpg" width="1029" height="215">
</div>
<?php 
