<?php
class grid_t_evaluacion_grupos_area_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['charts_html'] = '';
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_t_evaluacion_grupos_area'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['force_toolbar']);
   } 
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['mostra_edit'] = "N";
       }
   }
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_t_evaluacion_grupos_area", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['SC_Gb_Free_cmp']))
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "muda_qt_linhas";
   } 
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_t_evaluacion_grupos_area_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_t_evaluacion_grupos_area_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_lin_grid']; 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select']['primer_apellido'] = 'asc'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select']['segundo_apellido'] = 'asc'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select']['primer_nombre'] = 'asc'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select']['segundo_nombre'] = 'ASC'; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_quebra'][$nmgp_ordem])) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "inicio" ;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'] = ""; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_quebra'][$nmgp_ordem] == "asc") 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_quebra'][$nmgp_ordem] = "desc"; 
           }   
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_quebra'][$nmgp_ordem] = "asc"; 
           }   
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_cmp'] = $nmgp_ordem;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_quebra'][$nmgp_ordem]);  
       }   
       else   
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'] = $nmgp_ordem  ; 
       }   
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao']       = "igual" ; 
   } 
// 
   $this->count_ger = 0;
   $this->Tot->quebra_geral() ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['tot_geral'][1];
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['order_grid'] = $nmgp_order_by;
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']; 
           $this->rs_grid->MoveNext(); 
           $this->id_estudiante = $this->rs_grid->fields[0] ;  
           $this->id_grupo = $this->rs_grid->fields[1] ;  
       } 
   } 
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['pivot_charts']) : 0;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_t_evaluacion_grupos_area_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_t_evaluacion_grupos_area_ajax.js\"></script>\r\n");
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-grid_t_evaluacion_grupos_area-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-0785ea65\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_t_evaluacion_grupos_area_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_t_evaluacion_grupos_area_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_t_evaluacion_grupos_area_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_t_evaluacion_grupos_area_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_t_evaluacion_grupos_area']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_t_evaluacion_grupos_area']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_t_evaluacion_grupos_area']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_t_evaluacion_grupos_area']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida']) ? "grid_t_evaluacion_grupos_area_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cond_pesq'], 0, $trab_pos);
   ...
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS");
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d F Y");
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   $nm_saida->saida("          " . "Grupo -" . $_SESSION['par_nombre_grupo'] . "" . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
   ...
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   $nm_saida->saida("          " . "Primer Período" . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD align=\"center\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   $nm_saida->saida("          " . "Sede: " . $_SESSION['par_sede'] . "" . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_t_evaluacion_grupos_area__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_t_evaluacion_grupos_area-" . $tmp_header_row . "\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_id_grupo_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['field_order'] as $Cada_label)
   { 
       $NM_func_lab = "NM_label_" . $Cada_label;
       $this->$NM_func_lab();
   } 
   $nm_saida->saida("</TR>\r\n");
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_label'])
     { 
         if (isset($_SESSION['scriptcase']['saida_var']) && $_SESSION['scriptcase']['saida_var'])
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_t_evaluacion_grupos_area_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_id_estudiante()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_cmp'] == 'id_estudiante')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_label'] == "desc")
          {
 ...
 function NM_label_id_grupo()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_cmp'] == 'id_grupo')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['id_estudiante'])) ? $this->New_label['id_estudiante'] : "Estudiante"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['id_estudiante'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig1'])) ? $this->New_label['asig1'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig2'])) ? $this->New_label['asig2'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig3'])) ? $this->New_label['asig3'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig4'])) ? $this->New_label['asig4'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig5'])) ? $this->New_label['asig5'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig6'])) ? $this->New_label['asig6'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig7'])) ? $this->New_label['asig7'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig8'])) ? $this->New_label['asig8'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig9'])) ? $this->New_label['asig9'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig10'])) ? $this->New_label['asig10'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig11'])) ? $this->New_label['asig11'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig11'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig12'])) ? $this->New_label['asig12'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig12'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig13'])) ? $this->New_label['asig13'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig13'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig14'])) ? $this->New_label['asig14'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig14'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig15'])) ? $this->New_label['asig15'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig15'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig16'])) ? $this->New_label['asig16'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig16'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig17'])) ? $this->New_label['asig17'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig17'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig18'])) ? $this->New_label['asig18'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig18'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig19'])) ? $this->New_label['asig19'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig20'])) ? $this->New_label['asig20'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig20'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig21'])) ? $this->New_label['asig21'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig21'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig22'])) ? $this->New_label['asig22'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig22'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig23'])) ? $this->New_label['asig23'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig23'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig24'])) ? $this->New_label['asig24'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig24'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig25'])) ? $this->New_label['asig25'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig25'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig26'])) ? $this->New_label['asig26'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig26'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig27'])) ? $this->New_label['asig27'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig27'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig28'])) ? $this->New_label['asig28'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig28'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig29'])) ? $this->New_label['asig29'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig29'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asig30'])) ? $this->New_label['asig30'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['asig30'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_grupo'])) ? $this->New_label['id_grupo'] : "Id Grupo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['labels']['id_grupo'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_t_evaluacion_grupos_area']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_t_evaluacion_grupos_area#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['force_toolbar'] = true;
           } 
   ...
   { 
       $nm_saida->saida(" <TR> \r\n");
       $nm_id_aplicacao = " id=\"apl_grid_t_evaluacion_grupos_area#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-0785ea65\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'])
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['cab_embutida'] != "S" )
      { 
...
// 
   ...
   {  
          ...
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->id_grupo = (string)$this->id_grupo;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final'] + 1; 
          if (!$ini_grid) {
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
          ...
          $this->sc_proc_grid = false;
          $nm_quant_linhas++ ;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pdf" || isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_liga']['paginacao']))
          { 
              $nm_quant_linhas = 0; 
          } 
   }  
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['exibe_total'] == "S")
       { 
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "PDF", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=2&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_config_print.php?nm_opc=AM&nm_cor=AM&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_modal'])
        {
        ...
        else
        {
         ...
         $NM_btn = true;
          ...
          if (is_file("grid_t_evaluacion_grupos_area_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_t_evaluacion_grupos_area_help.txt"); 
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            </div>\r\n");
              ...
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['group_2'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           <table style=\"border-collapse: collapse; border-width: 0; display: none; position: absolute; z-index: 1000\" id=\"sc_btgp_div_group_2_top\">\r\n");
              $nm_saida->saida("           <tr><td class=\"scBtnGrpBackground\">\r\n");
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "", "", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&KeepThis=true&TB_iframe=true&modal=true", "group_2", "only_text", "text_right", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          $nm_saida->saida("            </div>\r\n");
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          $UseAlias =  "S";
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "", "", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&KeepThis=true&TB_iframe=true&modal=true", "group_2", "only_text", "text_right", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          $nm_saida->saida("            </div>\r\n");
      }
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_t_evaluacion_grupos_area', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_t_evaluacion_grupos_area\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_t_evaluacion_grupos_area_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['grid_t_evaluacion_grupos_area_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_t_evaluacion_grupos_area@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_t_evaluacion_grupos_area/grid_t_evaluacion_grupos_area_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=print&tp_print=' + tp + '&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret']))
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_t_evaluacion_grupos_area']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_t_evaluacion_grupos_area_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('grid_t_evaluacion_grupos_area');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_t_evaluacion_grupos_area', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
