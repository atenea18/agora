<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_grupos_area_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_grupos_area_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["id_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["id_estudiante"] : "Estudiante";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig1]'"]   = "asig1";
   ...
   $tab_labels["asig1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig1"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig1"] : " " . $_SESSION['par_assig1'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig2]'"]   = "asig2";
   ...
   $tab_labels["asig2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig2"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig2"] : " " . $_SESSION['par_assig2'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig3]'"]   = "asig3";
   ...
   $tab_labels["asig3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig3"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig3"] : " " . $_SESSION['par_assig3'] . " ";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig4]'"]   = "asig4";
   ...
   $tab_labels["asig4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig4"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig4"] : "" . $_SESSION['par_assig4'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig5]'"]   = "asig5";
   ...
   $tab_labels["asig5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig5"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig5"] : "" . $_SESSION['par_assig5'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig6]'"]   = "asig6";
   ...
   $tab_labels["asig6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig6"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig6"] : "" . $_SESSION['par_assig6'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig7]'"]   = "asig7";
   ...
   $tab_labels["asig7"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig7"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig7"] : "" . $_SESSION['par_assig7'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig8]'"]   = "asig8";
   ...
   $tab_labels["asig8"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig8"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig8"] : "" . $_SESSION['par_assig8'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig9]'"]   = "asig9";
   ...
   $tab_labels["asig9"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig9"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig9"] : "" . $_SESSION['par_assig9'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig10]'"]   = "asig10";
   ...
   $tab_labels["asig10"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig10"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig10"] : "" . $_SESSION['par_assig10'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig11]'"]   = "asig11";
   ...
   $tab_labels["asig11"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig11"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig11"] : "" . $_SESSION['par_assig11'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig12]'"]   = "asig12";
   ...
   $tab_labels["asig12"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig12"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig12"] : "" . $_SESSION['par_assig12'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig13]'"]   = "asig13";
   ...
   $tab_labels["asig13"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig13"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig13"] : "" . $_SESSION['par_assig13'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig14]'"]   = "asig14";
   ...
   $tab_labels["asig14"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig14"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig14"] : "" . $_SESSION['par_assig14'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig15]'"]   = "asig15";
   ...
   $tab_labels["asig15"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig15"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig15"] : "" . $_SESSION['par_assig15'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig16]'"]   = "asig16";
   ...
   $tab_labels["asig16"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig16"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig16"] : "" . $_SESSION['par_assig16'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig17]'"]   = "asig17";
   ...
   $tab_labels["asig17"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig17"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig17"] : "" . $_SESSION['par_assig17'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig18]'"]   = "asig18";
   ...
   $tab_labels["asig18"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig18"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig18"] : "" . $_SESSION['par_assig18'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig19]'"]   = "asig19";
   ...
   $tab_labels["asig19"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig19"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig19"] : "" . $_SESSION['par_assig19'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig20]'"]   = "asig20";
   ...
   $tab_labels["asig20"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig20"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig20"] : "" . $_SESSION['par_assig20'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig21]'"]   = "asig21";
   ...
   $tab_labels["asig21"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig21"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig21"] : "" . $_SESSION['par_assig21'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig22]'"]   = "asig22";
   ...
   $tab_labels["asig22"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig22"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig22"] : "" . $_SESSION['par_assig22'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig23]'"]   = "asig23";
   ...
   $tab_labels["asig23"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig23"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig23"] : "" . $_SESSION['par_assig23'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig24]'"]   = "asig24";
   ...
   $tab_labels["asig24"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig24"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig24"] : "" . $_SESSION['par_assig24'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig25]'"]   = "asig25";
   ...
   $tab_labels["asig25"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig25"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig25"] : "" . $_SESSION['par_assig25'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig26]'"]   = "asig26";
   ...
   $tab_labels["asig26"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig26"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig26"] : " " . $_SESSION['par_assig26'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig27]'"]   = "asig27";
   ...
   $tab_labels["asig27"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig27"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig27"] : " " . $_SESSION['par_assig27'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig28]'"]   = "asig28";
   ...
   $tab_labels["asig28"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig28"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig28"] : "" . $_SESSION['par_assig28'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig29]'"]   = "asig29";
   ...
   $tab_labels["asig29"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig29"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig29"] : "" . $_SESSION['par_assig29'] . "";
...
WHERE id_estudiante = '{id_estudiante}' AND id_asignatura = '[par_id_asig30]'"]   = "asig30";
   ...
   $tab_labels["asig30"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig30"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['labels']["asig30"] : "" . $_SESSION['par_assig30'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_grupos_area_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_grupos_area']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
