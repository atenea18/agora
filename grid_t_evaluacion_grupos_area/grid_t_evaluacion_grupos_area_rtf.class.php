...
class grid_t_evaluacion_grupos_area_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_t_evaluacion_grupos_area_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_t_evaluacion_grupos_area.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rtf_name']);
      }
   ...
   function NM_export_asig1()
   {
         ...
         $this->asig1 = str_replace('<', '&lt;', $this->asig1);
         $this->asig1 = str_replace('>', '&gt;', $this->asig1);
         $this->Texto_tag .= "<td>" . $this->asig1 . "</td>\r\n";
   }
   //----- asig2
   function NM_export_asig2()
   {
         ...
         $this->asig2 = str_replace('<', '&lt;', $this->asig2);
         $this->asig2 = str_replace('>', '&gt;', $this->asig2);
         $this->Texto_tag .= "<td>" . $this->asig2 . "</td>\r\n";
   }
   //----- asig3
   function NM_export_asig3()
   {
         ...
         $this->asig3 = str_replace('<', '&lt;', $this->asig3);
         $this->asig3 = str_replace('>', '&gt;', $this->asig3);
         $this->Texto_tag .= "<td>" . $this->asig3 . "</td>\r\n";
   }
   //----- asig4
   function NM_export_asig4()
   {
         ...
         $this->asig4 = str_replace('<', '&lt;', $this->asig4);
         $this->asig4 = str_replace('>', '&gt;', $this->asig4);
         $this->Texto_tag .= "<td>" . $this->asig4 . "</td>\r\n";
   }
   //----- asig5
   function NM_export_asig5()
   {
         ...
         $this->asig5 = str_replace('<', '&lt;', $this->asig5);
         $this->asig5 = str_replace('>', '&gt;', $this->asig5);
         $this->Texto_tag .= "<td>" . $this->asig5 . "</td>\r\n";
   }
   //----- asig6
   function NM_export_asig6()
   {
         ...
         $this->asig6 = str_replace('<', '&lt;', $this->asig6);
         $this->asig6 = str_replace('>', '&gt;', $this->asig6);
         $this->Texto_tag .= "<td>" . $this->asig6 . "</td>\r\n";
   }
   //----- asig7
   function NM_export_asig7()
   {
         ...
         $this->asig7 = str_replace('<', '&lt;', $this->asig7);
         $this->asig7 = str_replace('>', '&gt;', $this->asig7);
         $this->Texto_tag .= "<td>" . $this->asig7 . "</td>\r\n";
   }
   //----- asig8
   function NM_export_asig8()
   {
         ...
         $this->asig8 = str_replace('<', '&lt;', $this->asig8);
         $this->asig8 = str_replace('>', '&gt;', $this->asig8);
         $this->Texto_tag .= "<td>" . $this->asig8 . "</td>\r\n";
   }
   //----- asig9
   function NM_export_asig9()
   {
         ...
         $this->asig9 = str_replace('<', '&lt;', $this->asig9);
         $this->asig9 = str_replace('>', '&gt;', $this->asig9);
         $this->Texto_tag .= "<td>" . $this->asig9 . "</td>\r\n";
   }
   //----- asig10
   function NM_export_asig10()
   {
         ...
         $this->asig10 = str_replace('<', '&lt;', $this->asig10);
         $this->asig10 = str_replace('>', '&gt;', $this->asig10);
         $this->Texto_tag .= "<td>" . $this->asig10 . "</td>\r\n";
   }
   //----- asig11
   function NM_export_asig11()
   {
         ...
         $this->asig11 = str_replace('<', '&lt;', $this->asig11);
         $this->asig11 = str_replace('>', '&gt;', $this->asig11);
         $this->Texto_tag .= "<td>" . $this->asig11 . "</td>\r\n";
   }
   //----- asig12
   function NM_export_asig12()
   {
         ...
         $this->asig12 = str_replace('<', '&lt;', $this->asig12);
         $this->asig12 = str_replace('>', '&gt;', $this->asig12);
         $this->Texto_tag .= "<td>" . $this->asig12 . "</td>\r\n";
   }
   //----- asig13
   function NM_export_asig13()
   {
         ...
         $this->asig13 = str_replace('<', '&lt;', $this->asig13);
         $this->asig13 = str_replace('>', '&gt;', $this->asig13);
         $this->Texto_tag .= "<td>" . $this->asig13 . "</td>\r\n";
   }
   //----- asig14
   function NM_export_asig14()
   {
         ...
         $this->asig14 = str_replace('<', '&lt;', $this->asig14);
         $this->asig14 = str_replace('>', '&gt;', $this->asig14);
         $this->Texto_tag .= "<td>" . $this->asig14 . "</td>\r\n";
   }
   //----- asig15
   function NM_export_asig15()
   {
         ...
         $this->asig15 = str_replace('<', '&lt;', $this->asig15);
         $this->asig15 = str_replace('>', '&gt;', $this->asig15);
         $this->Texto_tag .= "<td>" . $this->asig15 . "</td>\r\n";
   }
   //----- asig16
   function NM_export_asig16()
   {
         ...
         $this->asig16 = str_replace('<', '&lt;', $this->asig16);
         $this->asig16 = str_replace('>', '&gt;', $this->asig16);
         $this->Texto_tag .= "<td>" . $this->asig16 . "</td>\r\n";
   }
   //----- asig17
   function NM_export_asig17()
   {
         ...
         $this->asig17 = str_replace('<', '&lt;', $this->asig17);
         $this->asig17 = str_replace('>', '&gt;', $this->asig17);
         $this->Texto_tag .= "<td>" . $this->asig17 . "</td>\r\n";
   }
   //----- asig18
   function NM_export_asig18()
   {
         ...
         $this->asig18 = str_replace('<', '&lt;', $this->asig18);
         $this->asig18 = str_replace('>', '&gt;', $this->asig18);
         $this->Texto_tag .= "<td>" . $this->asig18 . "</td>\r\n";
   }
   //----- asig19
   function NM_export_asig19()
   {
         ...
         $this->asig19 = str_replace('<', '&lt;', $this->asig19);
         $this->asig19 = str_replace('>', '&gt;', $this->asig19);
         $this->Texto_tag .= "<td>" . $this->asig19 . "</td>\r\n";
   }
   //----- asig20
   function NM_export_asig20()
   {
         ...
         $this->asig20 = str_replace('<', '&lt;', $this->asig20);
         $this->asig20 = str_replace('>', '&gt;', $this->asig20);
         $this->Texto_tag .= "<td>" . $this->asig20 . "</td>\r\n";
   }
   //----- asig21
   function NM_export_asig21()
   {
         ...
         $this->asig21 = str_replace('<', '&lt;', $this->asig21);
         $this->asig21 = str_replace('>', '&gt;', $this->asig21);
         $this->Texto_tag .= "<td>" . $this->asig21 . "</td>\r\n";
   }
   //----- asig22
   function NM_export_asig22()
   {
         ...
         $this->asig22 = str_replace('<', '&lt;', $this->asig22);
         $this->asig22 = str_replace('>', '&gt;', $this->asig22);
         $this->Texto_tag .= "<td>" . $this->asig22 . "</td>\r\n";
   }
   //----- asig23
   function NM_export_asig23()
   {
         ...
         $this->asig23 = str_replace('<', '&lt;', $this->asig23);
         $this->asig23 = str_replace('>', '&gt;', $this->asig23);
         $this->Texto_tag .= "<td>" . $this->asig23 . "</td>\r\n";
   }
   //----- asig24
   function NM_export_asig24()
   {
         ...
         $this->asig24 = str_replace('<', '&lt;', $this->asig24);
         $this->asig24 = str_replace('>', '&gt;', $this->asig24);
         $this->Texto_tag .= "<td>" . $this->asig24 . "</td>\r\n";
   }
   //----- asig25
   function NM_export_asig25()
   {
         ...
         $this->asig25 = str_replace('<', '&lt;', $this->asig25);
         $this->asig25 = str_replace('>', '&gt;', $this->asig25);
         $this->Texto_tag .= "<td>" . $this->asig25 . "</td>\r\n";
   }
   //----- asig26
   function NM_export_asig26()
   {
         ...
         $this->asig26 = str_replace('<', '&lt;', $this->asig26);
         $this->asig26 = str_replace('>', '&gt;', $this->asig26);
         $this->Texto_tag .= "<td>" . $this->asig26 . "</td>\r\n";
   }
   //----- asig27
   function NM_export_asig27()
   {
         ...
         $this->asig27 = str_replace('<', '&lt;', $this->asig27);
         $this->asig27 = str_replace('>', '&gt;', $this->asig27);
         $this->Texto_tag .= "<td>" . $this->asig27 . "</td>\r\n";
   }
   //----- asig28
   function NM_export_asig28()
   {
         ...
         $this->asig28 = str_replace('<', '&lt;', $this->asig28);
         $this->asig28 = str_replace('>', '&gt;', $this->asig28);
         $this->Texto_tag .= "<td>" . $this->asig28 . "</td>\r\n";
   }
   //----- asig29
   function NM_export_asig29()
   {
         ...
         $this->asig29 = str_replace('<', '&lt;', $this->asig29);
         $this->asig29 = str_replace('>', '&gt;', $this->asig29);
         $this->Texto_tag .= "<td>" . $this->asig29 . "</td>\r\n";
   }
   //----- asig30
   function NM_export_asig30()
   {
         ...
         $this->asig30 = str_replace('<', '&lt;', $this->asig30);
         $this->asig30 = str_replace('>', '&gt;', $this->asig30);
         $this->Texto_tag .= "<td>" . $this->asig30 . "</td>\r\n";
   }
   //----- id_grupo
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_evaluacion_grupos_area']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
