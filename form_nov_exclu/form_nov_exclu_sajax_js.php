  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_nov_exclu" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_nov_exclu_
  function do_ajax_form_nov_exclu_validate_id_nov_exclu_(iNumLinha)
  {
    var nomeCampo_id_nov_exclu_ = "id_nov_exclu_" + iNumLinha;
    var var_id_nov_exclu_ = scAjaxGetFieldHidden(nomeCampo_id_nov_exclu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nov_exclu_validate_id_nov_exclu_(var_id_nov_exclu_, iNumLinha, var_script_case_init, do_ajax_form_nov_exclu_validate_id_nov_exclu__cb);
  } // do_ajax_form_nov_exclu_validate_id_nov_exclu_

  function do_ajax_form_nov_exclu_validate_id_nov_exclu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_nov_exclu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_nov_exclu_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_nov_exclu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_nov_exclu_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nov_exclu_validate_id_nov_exclu__cb

  // ---------- Validate id_novedad_
  function do_ajax_form_nov_exclu_validate_id_novedad_(iNumLinha)
  {
    var nomeCampo_id_novedad_ = "id_novedad_" + iNumLinha;
    var var_id_novedad_ = scAjaxGetFieldSelect(nomeCampo_id_novedad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nov_exclu_validate_id_novedad_(var_id_novedad_, iNumLinha, var_script_case_init, do_ajax_form_nov_exclu_validate_id_novedad__cb);
  } // do_ajax_form_nov_exclu_validate_id_novedad_

  function do_ajax_form_nov_exclu_validate_id_novedad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_nov_exclu_validate_id_novedad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_nov_exclu_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_nov_exclu_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_nov_exclu_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_nov_exclu_add_new_line_cb);
  } // do_ajax_form_nov_exclu_add_new_line

  function do_ajax_form_nov_exclu_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_nov_exclu_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_nov_exclu_backup_line(iNumLinha)
  {
    var var_id_nov_exclu_ = scAjaxGetFieldHidden("id_nov_exclu_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_nov_exclu_backup_line(var_id_nov_exclu_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_nov_exclu_backup_line_cb);
  } // do_ajax_form_nov_exclu_backup_line

  function do_ajax_form_nov_exclu_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_nov_exclu_backup_line_cb

  function do_ajax_form_nov_exclu_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_nov_exclu_cancel_insert

  function do_ajax_form_nov_exclu_cancel_update(iSeqVert)
  {
    do_ajax_form_nov_exclu_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_nov_exclu_cancel_update

  function do_ajax_form_nov_exclu_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_nov_exclu_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_nov_exclu_table_refresh()
  {
    var var_id_nov_exclu_ = document.F2.id_nov_exclu_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_nov_exclu_table_refresh(var_id_nov_exclu_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_nov_exclu_table_refresh_cb);
  } //  do_ajax_form_nov_exclu_table_refresh

  function do_ajax_form_nov_exclu_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_nov_exclu_.value = scAjaxGetKeyValue("id_nov_exclu_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_nov_exclu_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_nov_exclu_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_nov_exclu_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_nov_exclu_submit_form(var_id_nov_exclu_, var_id_novedad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_nov_exclu_submit_form_cb);
  } // do_ajax_form_nov_exclu_submit_form

  function do_ajax_form_nov_exclu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_nov_exclu_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_nov_exclu_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_nov_exclu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("id_nov_exclu_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_nov_exclu_navigate_form(var_id_nov_exclu_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_nov_exclu_navigate_form_cb);
  } // do_ajax_form_nov_exclu_navigate_form

  function do_ajax_form_nov_exclu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_nov_exclu_.value = scAjaxGetKeyValue("id_nov_exclu_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_nov_exclu_navigate_form_cb
  function sc_hide_form_nov_exclu_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_nov_exclu_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_nov_exclu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_novedad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_nov_exclu_" + iNumLinha] = {"label": "Novedades Excluyentes<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_nov_exclu_"][iNumLinha] = "id_nov_exclu_" + iNumLinha;
    ajax_field_mult["id_novedad_"][iNumLinha] = "id_novedad_" + iNumLinha;
    ajax_field_id["id_nov_exclu_" + iNumLinha] = new Array("hidden_field_label_id_nov_exclu_", "hidden_field_data_id_nov_exclu_" + iNumLinha);
    ajax_field_id["id_novedad_" + iNumLinha] = new Array("hidden_field_label_id_novedad_", "hidden_field_data_id_novedad_" + iNumLinha);
    ajax_error_count["id_nov_exclu_" + iNumLinha] = "off";
    ajax_error_count["id_novedad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_nov_exclu_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_nov_exclu_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_nov_exclu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_nov_exclu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_nov_exclu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_nov_exclu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_nov_exclu_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_nov_exclu_'])) ? $this->nmgp_cmp_readonly['id_nov_exclu_'] : 'on';
?>
    scAjaxFieldRead("id_nov_exclu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_novedad_'])) ? $this->nmgp_cmp_readonly['id_novedad_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("id_nov_exclu_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_nov_exclu_" + iRow] || "on" == ajax_error_count["id_novedad_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_id_nov_exclu_" + iRow))
        document.getElementById("hidden_field_data_id_nov_exclu_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_nov_exclu_" + iRow] && "off" == ajax_error_count["id_novedad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_nov_exclu_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_id_nov_exclu_" + iRow))
        document.getElementById("hidden_field_data_id_nov_exclu_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_id_novedad_" + iRow))
