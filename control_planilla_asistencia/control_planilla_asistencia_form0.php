...
<?php
include_once("control_planilla_asistencia_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_planilla_asistencia_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['recarga'];
}
?>
...
<?php
 include_once("control_planilla_asistencia_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_planilla_asistencia'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_planilla_asistencia'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_planilla_asistencia']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_planilla_asistencia");
 parent.scAjaxDetailHeight("control_planilla_asistencia", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
