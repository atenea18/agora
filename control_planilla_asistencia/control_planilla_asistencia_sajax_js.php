  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_planilla_asistencia" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate sede
  function do_ajax_control_planilla_asistencia_validate_sede()
  {
    var nomeCampo_sede = "sede";
    var var_sede = scAjaxGetFieldSelect(nomeCampo_sede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_planilla_asistencia_validate_sede(var_sede, var_script_case_init, do_ajax_control_planilla_asistencia_validate_sede_cb);
  } // do_ajax_control_planilla_asistencia_validate_sede

  function do_ajax_control_planilla_asistencia_validate_sede_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_planilla_asistencia_validate_sede_cb

  // ---------- Validate grado
  function do_ajax_control_planilla_asistencia_validate_grado()
  {
    var nomeCampo_grado = "grado";
    var var_grado = scAjaxGetFieldSelect(nomeCampo_grado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_planilla_asistencia_validate_grado(var_grado, var_script_case_init, do_ajax_control_planilla_asistencia_validate_grado_cb);
  } // do_ajax_control_planilla_asistencia_validate_grado

  function do_ajax_control_planilla_asistencia_validate_grado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "grado";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_planilla_asistencia_validate_grado_cb

  // ---------- Validate grupo
  function do_ajax_control_planilla_asistencia_validate_grupo()
  {
    var nomeCampo_grupo = "grupo";
    var var_grupo = scAjaxGetFieldSelect(nomeCampo_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_planilla_asistencia_validate_grupo(var_grupo, var_script_case_init, do_ajax_control_planilla_asistencia_validate_grupo_cb);
  } // do_ajax_control_planilla_asistencia_validate_grupo

  function do_ajax_control_planilla_asistencia_validate_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "grupo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_planilla_asistencia_validate_grupo_cb
  // ---------- Form
  function do_ajax_control_planilla_asistencia_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_planilla_asistencia_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_planilla_asistencia_submit_form(var_sede, var_grado, var_grupo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_planilla_asistencia_submit_form_cb);
  } // do_ajax_control_planilla_asistencia_submit_form

  function do_ajax_control_planilla_asistencia_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_planilla_asistencia_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_planilla_asistencia_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_planilla_asistencia_navigate_form

  function do_ajax_control_planilla_asistencia_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_planilla_asistencia_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_planilla_asistencia_navigate_form_cb
  function sc_hide_control_planilla_asistencia_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_planilla_asistencia_form
