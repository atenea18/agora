<?php
//
class form_matricula_pruebas_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_matricula_pruebas_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_matricula_pruebas']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_matricula_pruebas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_matricula_pruebas'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_matricula_pruebas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_matricula_pruebas']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_matricula_pruebas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_matricula_pruebas']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - matricula";
      ...
      $_SESSION['scriptcase']['error_icon']['form_matricula_pruebas']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_matricula_pruebas'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matricula_pruebas']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_matricula_pruebas", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_matricula_pruebas/form_matricula_pruebas_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_matricula_pruebas_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_matricula_pruebas_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_matricula_pruebas_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_matricula_pruebas/form_matricula_pruebas_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_matricula_pruebas_erro.class.php"); 
      }
      $this->Erro      = new form_matricula_pruebas_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao']))
         { 
             if ($this->idstudents != "" || $this->year_matricula != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_matricula_pruebas']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_matricula_pruebas']) || !is_array($this->NM_ajax_info['errList']['geral_form_matricula_pruebas']))
              {
                  $this->NM_ajax_info['errList']['geral_form_matricula_pruebas'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_matricula_pruebas'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_idstudents(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->idstudents, 11, 0, 0, 0, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['php_cmp_required']['idstudents']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['php_cmp_required']['idstudents'] == "on") 
           { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['php_cmp_required']['year_matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['php_cmp_required']['year_matricula'] == "on")) 
      { 
    ...
    function ValidateField_id_jornada(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_jornada, 11, 0, 0, 0, "N") == false)  
              { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idstudents']['keyVal'] = form_matricula_pruebas_pack_protect_string($this->nmgp_dados_form['idstudents']);
              $this->NM_ajax_info['fldList']['year_matricula']['keyVal'] = form_matricula_pruebas_pack_protect_string($this->nmgp_dados_form['year_matricula']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_semestre($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->year_matricula = $this->year_matricula_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['parms'] = "idstudents?#?$this->idstudents?@?year_matricula?#?$this->year_matricula?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_matricula_pruebas = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total'] = $qt_geral_reg_form_matricula_pruebas;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idstudents) && !empty($this->year_matricula))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_matricula_pruebas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] > $qt_geral_reg_form_matricula_pruebas)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] = $qt_geral_reg_form_matricula_pruebas; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_matricula_pruebas) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] < $qt_geral_reg_form_matricula_pruebas;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_matricula_pruebas_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_matricula_pruebas_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      $Nm_datas['fecha'] = "date";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_matricula_pruebas_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_matricula_pruebas_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matricula_pruebas']['masterValue'] as $cmp_master => $val_master)
{
?>
