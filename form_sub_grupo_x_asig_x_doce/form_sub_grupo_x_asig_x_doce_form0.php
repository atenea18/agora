<?php
class form_sub_grupo_x_asig_x_doce_form extends form_sub_grupo_x_asig_x_doce_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - sub_grupo_x_asig_x_doce"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - sub_grupo_x_asig_x_doce"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_sub_grupo_x_asig_x_doce/form_sub_grupo_x_asig_x_doce_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_sub_grupo_x_asig_x_doce_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_sub_grupo_x_asig_x_doce_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['recarga'];
}
...
<?php
 include_once("form_sub_grupo_x_asig_x_doce_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_sub_grupo_x_asig_x_doce'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_sub_grupo_x_asig_x_doce'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - sub_grupo_x_asig_x_doce"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - sub_grupo_x_asig_x_doce"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['fast_search'][2] : "";
?> 
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line(); return false;", "do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['intensidad_horaria_']) && $this->nmgp_cmp_hidden['intensidad_horaria_'] == 'off') { $sStyleHidden_intensidad_horaria_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['intensidad_horaria_'])) {
          $this->nm_new_label['intensidad_horaria_'] = "Intensidad Horaria"; } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['peso_asig_fre_area_']) && $this->nmgp_cmp_hidden['peso_asig_fre_area_'] == 'off') { $sStyleHidden_peso_asig_fre_area_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['peso_asig_fre_area_'])) {
          $this->nm_new_label['peso_asig_fre_area_'] = "Peso Asig Fre Area"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_sub_grupo_x_asig_x_doce);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_sub_grupo_x_asig_x_doce = $this->form_vert_form_sub_grupo_x_asig_x_doce;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_sub_grupo_x_asig_x_doce))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_form_sub_grupo_x_asig_x_doce as $sc_seq_vert => $sc_lixo)
   {
       $this->id_docente_sub_grupo_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['id_docente_sub_grupo_'];
       $this->id_subgrupo_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['id_subgrupo_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_area_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['id_area_']; 
       ...
       $this->id_asignatura_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['id_asignatura_']; 
       ...
       $this->id_docente_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['id_docente_']; 
       ...
       $this->intensidad_horaria_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['intensidad_horaria_']; 
       ...
       $this->peso_asig_fre_area_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['peso_asig_fre_area_']; 
       ...
       $this->tipo_asig_ = $this->form_vert_form_sub_grupo_x_asig_x_doce[$sc_seq_vert]['tipo_asig_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_sub_grupo_x_asig_x_doce_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_sub_grupo_x_asig_x_doce_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_sub_grupo_x_asig_x_doce_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_sub_grupo_x_asig_x_doce_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
?>
<input type="hidden" name="id_area_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($id_area_) . "\">" . $id_area__look . ""; ?>
<?php } else { ?>
...
?>
<input type="hidden" name="id_asignatura_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($id_asignatura_) . "\">" . $id_asignatura__look . ""; ?>
<?php } else { ?>
...
<span id="id_read_on_intensidad_horaria_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-intensidad_horaria_<?php echo $sc_seq_vert ?> css_intensidad_horaria__line" style="<?php echo $sStyleReadLab_intensidad_horaria_; ?>"><?php echo $this->form_encode_input($this->intensidad_horaria_); ?></span><span id="id_read_off_intensidad_horaria_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_intensidad_horaria_; ?>">
 ...
 size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['intensidad_horaria_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['intensidad_horaria_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['Lookup_tipo_asig_'][] = 'A'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['Lookup_tipo_asig_'][] = 'T'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['Lookup_tipo_asig_'][] = 'C'; ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_sub_grupo_x_asig_x_doce = $guarda_form_vert_form_sub_grupo_x_asig_x_doce;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sub_grupo_x_asig_x_doce']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_sub_grupo_x_asig_x_doce");
 parent.scAjaxDetailHeight("form_sub_grupo_x_asig_x_doce", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
