...
class form_sub_grupo_x_asig_x_doce_erro
{
   var $Ini;
   ...
   //----- 
   function form_sub_grupo_x_asig_x_doce_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return form_sub_grupo_x_asig_x_doce_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
