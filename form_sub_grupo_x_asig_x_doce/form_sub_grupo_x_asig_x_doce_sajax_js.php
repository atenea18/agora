  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sub_grupo_x_asig_x_doce" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_area_
  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_area_(iNumLinha)
  {
    var nomeCampo_id_area_ = "id_area_" + iNumLinha;
    var var_id_area_ = scAjaxGetFieldSelect(nomeCampo_id_area_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_validate_id_area_(var_id_area_, iNumLinha, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_area__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_area_

  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_area__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_area__cb

  // ---------- Validate id_asignatura_
  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_asignatura_(iNumLinha)
  {
    var nomeCampo_id_asignatura_ = "id_asignatura_" + iNumLinha;
    var var_id_asignatura_ = scAjaxGetFieldSelect(nomeCampo_id_asignatura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_validate_id_asignatura_(var_id_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_asignatura__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_asignatura_

  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_asignatura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_asignatura__cb

  // ---------- Validate id_docente_
  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_docente_(iNumLinha)
  {
    var nomeCampo_id_docente_ = "id_docente_" + iNumLinha;
    var var_id_docente_ = scAjaxGetFieldSelect(nomeCampo_id_docente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_validate_id_docente_(var_id_docente_, iNumLinha, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_docente__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_docente_

  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_docente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_docente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_docente_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_docente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_docente_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_id_docente__cb

  // ---------- Validate intensidad_horaria_
  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_intensidad_horaria_(iNumLinha)
  {
    var nomeCampo_intensidad_horaria_ = "intensidad_horaria_" + iNumLinha;
    var var_intensidad_horaria_ = scAjaxGetFieldText(nomeCampo_intensidad_horaria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_validate_intensidad_horaria_(var_intensidad_horaria_, iNumLinha, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_validate_intensidad_horaria__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_intensidad_horaria_

  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_intensidad_horaria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "intensidad_horaria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "intensidad_horaria_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "intensidad_horaria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "intensidad_horaria_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_intensidad_horaria__cb

  // ---------- Validate peso_asig_fre_area_
  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_peso_asig_fre_area_(iNumLinha)
  {
    var nomeCampo_peso_asig_fre_area_ = "peso_asig_fre_area_" + iNumLinha;
    var var_peso_asig_fre_area_ = scAjaxGetFieldText(nomeCampo_peso_asig_fre_area_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_validate_peso_asig_fre_area_(var_peso_asig_fre_area_, iNumLinha, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_validate_peso_asig_fre_area__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_peso_asig_fre_area_

  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_peso_asig_fre_area__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "peso_asig_fre_area_" + iLineNumber;
    }
    else
    {
      sFieldValid = "peso_asig_fre_area_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "peso_asig_fre_area_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "peso_asig_fre_area_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_peso_asig_fre_area__cb

  // ---------- Validate tipo_asig_
  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_tipo_asig_(iNumLinha)
  {
    var nomeCampo_tipo_asig_ = "tipo_asig_" + iNumLinha;
    var var_tipo_asig_ = scAjaxGetFieldRadio(nomeCampo_tipo_asig_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_validate_tipo_asig_(var_tipo_asig_, iNumLinha, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_validate_tipo_asig__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_tipo_asig_

  function do_ajax_form_sub_grupo_x_asig_x_doce_validate_tipo_asig__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_validate_tipo_asig__cb

  // ---------- Refresh id_area_
  function do_ajax_form_sub_grupo_x_asig_x_doce_refresh_id_area_(iSeqForm)
  {
    var var_id_area_ = scAjaxGetFieldSelect("id_area_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "id_asignatura_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sub_grupo_x_asig_x_doce_refresh_id_area_(var_id_area_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_refresh_id_area__cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_refresh_id_area_

  function do_ajax_form_sub_grupo_x_asig_x_doce_refresh_id_area__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sub_grupo_x_asig_x_doce_refresh_id_area__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sub_grupo_x_asig_x_doce_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sub_grupo_x_asig_x_doce_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line_cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line

  function do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_sub_grupo_x_asig_x_doce_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sub_grupo_x_asig_x_doce_backup_line(iNumLinha)
  {
    var var_id_docente_sub_grupo_ = scAjaxGetFieldText("id_docente_sub_grupo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sub_grupo_x_asig_x_doce_backup_line(var_id_docente_sub_grupo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_backup_line_cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_backup_line

  function do_ajax_form_sub_grupo_x_asig_x_doce_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_sub_grupo_x_asig_x_doce_backup_line_cb

  function do_ajax_form_sub_grupo_x_asig_x_doce_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sub_grupo_x_asig_x_doce_cancel_insert

  function do_ajax_form_sub_grupo_x_asig_x_doce_cancel_update(iSeqVert)
  {
    do_ajax_form_sub_grupo_x_asig_x_doce_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sub_grupo_x_asig_x_doce_cancel_update

  function do_ajax_form_sub_grupo_x_asig_x_doce_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sub_grupo_x_asig_x_doce_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sub_grupo_x_asig_x_doce_table_refresh()
  {
    var var_id_docente_sub_grupo_ = document.F2.id_docente_sub_grupo_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sub_grupo_x_asig_x_doce_table_refresh(var_id_docente_sub_grupo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_table_refresh_cb);
  } //  do_ajax_form_sub_grupo_x_asig_x_doce_table_refresh

  function do_ajax_form_sub_grupo_x_asig_x_doce_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_docente_sub_grupo_.value = scAjaxGetKeyValue("id_docente_sub_grupo_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_sub_grupo_x_asig_x_doce_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sub_grupo_x_asig_x_doce_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sub_grupo_x_asig_x_doce_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_area_ = scAjaxGetFieldSelect("id_area_" + iNumLinha);
    var var_id_asignatura_ = scAjaxGetFieldSelect("id_asignatura_" + iNumLinha);
    var var_id_docente_ = scAjaxGetFieldSelect("id_docente_" + iNumLinha);
    var var_intensidad_horaria_ = scAjaxGetFieldText("intensidad_horaria_" + iNumLinha);
    var var_peso_asig_fre_area_ = scAjaxGetFieldText("peso_asig_fre_area_" + iNumLinha);
    var var_tipo_asig_ = scAjaxGetFieldRadio("tipo_asig_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sub_grupo_x_asig_x_doce_submit_form(var_id_area_, var_id_asignatura_, var_id_docente_, var_intensidad_horaria_, var_peso_asig_fre_area_, var_tipo_asig_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sub_grupo_x_asig_x_doce_submit_form_cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_submit_form

  function do_ajax_form_sub_grupo_x_asig_x_doce_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("id_docente_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("intensidad_horaria_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("peso_asig_fre_area_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_sub_grupo_x_asig_x_doce_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_sub_grupo_x_asig_x_doce_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sub_grupo_x_asig_x_doce_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("id_docente_" + iNavForm);
      scAjaxHideErrorDisplay("intensidad_horaria_" + iNavForm);
      scAjaxHideErrorDisplay("peso_asig_fre_area_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sub_grupo_x_asig_x_doce_navigate_form(var_id_docente_sub_grupo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sub_grupo_x_asig_x_doce_navigate_form_cb);
  } // do_ajax_form_sub_grupo_x_asig_x_doce_navigate_form

  function do_ajax_form_sub_grupo_x_asig_x_doce_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_docente_sub_grupo_.value = scAjaxGetKeyValue("id_docente_sub_grupo_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_sub_grupo_x_asig_x_doce_navigate_form_cb
  function sc_hide_form_sub_grupo_x_asig_x_doce_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_sub_grupo_x_asig_x_doce_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_docente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "intensidad_horaria_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "peso_asig_fre_area_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_asig_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_area_" + iNumLinha] = {"label": "Area<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_asignatura_" + iNumLinha] = {"label": "Asignatura<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_docente_" + iNumLinha] = {"label": "Docente<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["intensidad_horaria_" + iNumLinha] = {"label": "Intensidad Horaria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["peso_asig_fre_area_" + iNumLinha] = {"label": "Peso Asig Fre Area<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_docente_"][iNumLinha] = "id_docente_" + iNumLinha;
    ajax_field_mult["intensidad_horaria_"][iNumLinha] = "intensidad_horaria_" + iNumLinha;
    ajax_field_mult["peso_asig_fre_area_"][iNumLinha] = "peso_asig_fre_area_" + iNumLinha;
    ...
    ajax_field_id["id_docente_" + iNumLinha] = new Array("hidden_field_label_id_docente_", "hidden_field_data_id_docente_" + iNumLinha);
    ajax_field_id["intensidad_horaria_" + iNumLinha] = new Array("hidden_field_label_intensidad_horaria_", "hidden_field_data_intensidad_horaria_" + iNumLinha);
    ajax_field_id["peso_asig_fre_area_" + iNumLinha] = new Array("hidden_field_label_peso_asig_fre_area_", "hidden_field_data_peso_asig_fre_area_" + iNumLinha);
    ...
    ajax_error_count["id_docente_" + iNumLinha] = "off";
    ajax_error_count["intensidad_horaria_" + iNumLinha] = "off";
    ajax_error_count["peso_asig_fre_area_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["id_docente_" + iNumLinha] = "off";
    ajax_read_only["intensidad_horaria_" + iNumLinha] = "off";
    ajax_read_only["peso_asig_fre_area_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["id_docente_" + iNumLinha] = "on";
    ajax_read_only["intensidad_horaria_" + iNumLinha] = "on";
    ajax_read_only["peso_asig_fre_area_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["id_docente_" + iNumLinha] = null;
    ajax_error_list["intensidad_horaria_" + iNumLinha] = null;
    ajax_error_list["peso_asig_fre_area_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "id_docente_": new Array(),
    "intensidad_horaria_": new Array(),
    "peso_asig_fre_area_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["id_docente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_docente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_docente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_docente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_docente_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["intensidad_horaria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["intensidad_horaria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["intensidad_horaria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["intensidad_horaria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["intensidad_horaria_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["peso_asig_fre_area_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["peso_asig_fre_area_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["peso_asig_fre_area_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["peso_asig_fre_area_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["peso_asig_fre_area_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_docente_'])) ? $this->nmgp_cmp_readonly['id_docente_'] : 'off';
?>
    scAjaxFieldRead("id_docente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['intensidad_horaria_'])) ? $this->nmgp_cmp_readonly['intensidad_horaria_'] : 'off';
?>
    scAjaxFieldRead("intensidad_horaria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['peso_asig_fre_area_'])) ? $this->nmgp_cmp_readonly['peso_asig_fre_area_'] : 'off';
?>
    scAjaxFieldRead("peso_asig_fre_area_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("id_docente_" + iSeq, "on");
    scAjaxFieldRead("intensidad_horaria_" + iSeq, "on");
    scAjaxFieldRead("peso_asig_fre_area_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_area_" + iRow] || "on" == ajax_error_count["id_asignatura_" + iRow] || "on" == ajax_error_count["id_docente_" + iRow] || "on" == ajax_error_count["intensidad_horaria_" + iRow] || "on" == ajax_error_count["peso_asig_fre_area_" + iRow] || "on" == ajax_error_count["tipo_asig_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_id_docente_" + iRow))
        document.getElementById("hidden_field_data_id_docente_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_intensidad_horaria_" + iRow))
        document.getElementById("hidden_field_data_intensidad_horaria_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_peso_asig_fre_area_" + iRow))
        document.getElementById("hidden_field_data_peso_asig_fre_area_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_area_" + iRow] && "off" == ajax_error_count["id_asignatura_" + iRow] && "off" == ajax_error_count["id_docente_" + iRow] && "off" == ajax_error_count["intensidad_horaria_" + iRow] && "off" == ajax_error_count["peso_asig_fre_area_" + iRow] && "off" == ajax_error_count["tipo_asig_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_area_" + iRow] = "off";
        ajax_error_count["id_asignatura_" + iRow] = "off";
        ajax_error_count["id_docente_" + iRow] = "off";
        ajax_error_count["intensidad_horaria_" + iRow] = "off";
        ajax_error_count["peso_asig_fre_area_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_id_docente_" + iRow))
        document.getElementById("hidden_field_data_id_docente_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_intensidad_horaria_" + iRow))
        document.getElementById("hidden_field_data_intensidad_horaria_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_peso_asig_fre_area_" + iRow))
        document.getElementById("hidden_field_data_peso_asig_fre_area_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_tipo_asig_" + iRow))
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_docente_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("intensidad_horaria_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("peso_asig_fre_area_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
