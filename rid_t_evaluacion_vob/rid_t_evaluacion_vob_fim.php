...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____rid_t_evaluacion_vob"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____rid_t_evaluacion_vob"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>rid_t_evaluacion_vob</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rid_t_evaluacion_vob']['embutida_filho'] as $ind => $sc_init)
          {
