...
class rid_t_evaluacion_vob_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function rid_t_evaluacion_vob_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "rid_t_evaluacion_vob.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<rid_t_evaluacion_vob";
...
$_SESSION['scriptcase']['rid_t_evaluacion_vob']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Grupo - <?php echo $_SESSION['par_nombre_grupo'] ?> :: XML</TITLE>
