...
class rid_t_evaluacion_vob_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function rid_t_evaluacion_vob_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "rid_t_evaluacion_vob.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['rtf_name']);
      }
...
$_SESSION['scriptcase']['rid_t_evaluacion_vob']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Grupo - <?php echo $_SESSION['par_nombre_grupo'] ?> :: RTF</TITLE>
