...
class rid_t_evaluacion_vob_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $Tit_doc;
   //---- 
   function rid_t_evaluacion_vob_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "rid_t_evaluacion_vob.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
$_SESSION['scriptcase']['rid_t_evaluacion_vob']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rid_t_evaluacion_vob']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Grupo - <?php echo $_SESSION['par_nombre_grupo'] ?> :: Excel</TITLE>
