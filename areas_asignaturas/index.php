<?php
//
    include_once('areas_asignaturas_session.php');
    session_start();
    $_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_imag_temp'] = "";
class areas_asignaturas
{
  var $nm_data;
  var $sc_page;
  var $str_lang;
...
//
     ...
     $_SESSION['scriptcase']['sc_aba_iframe']['areas_asignaturas'][] = "grid_t_asignaturas";
     $_SESSION['scriptcase']['sc_aba_iframe']['areas_asignaturas'][] = "grid_t_area_1";
//
      $NM_dir_atual = getcwd();
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
     ...
     $path_imag_temp  = $_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_imag_temp'];
     ...
     $path_imagens    = $_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_prod'] . "/imagens/";
     $path_libs       = $root . $_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_prod'] . "/lib/php/";
     $path_third      = $root . $_SESSION['scriptcase']['areas_asignaturas']['glo_nm_path_prod'] . "/third/";
...
<?php
     ...
     $_SESSION['scriptcase']['contr_link_emb'] = $dir_raiz . "areas_asignaturas.php" ; 
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->sc_page]['areas_asignaturas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->sc_page]['areas_asignaturas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['areas_asignaturas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['areas_asignaturas'];
          }
          ...
          if ($this->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['areas_asignaturas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['areas_asignaturas']['link'] = $path_link . "" . SC_dir_app_name('areas_asignaturas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['areas_asignaturas']['label'] = "Asignaturas y Áreas";
     ...
     $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
     ...
     if (!empty($nmsc_falta_var)) 
     {
         ...
         echo "    action='areas_asignaturas_fim.php'"; 
         echo "    target='_self'>"; 
         echo "    <input type='hidden' name='saida_aba' value='" . NM_encode_input($_SESSION['sc_session'][$this->sc_page]['areas_asignaturas']['aba_saida']) . "'/>";
...
//  
     if (isset($_SESSION['scriptcase']['sc_apl_conf']['areas_asignaturas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['areas_asignaturas']['exit'] != '')
     {
         $_SESSION['sc_session'][$this->sc_page]['areas_asignaturas']['aba_saida'] = $_SESSION['scriptcase']['sc_apl_conf']['areas_asignaturas']['exit'];
     }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
     ...
     $nm_saida->saida("  <HEAD>\r\n");
     $nm_saida->saida("   <TITLE>Asignaturas y Áreas</TITLE>\r\n");
     ...
     $nm_saida->saida("            min-width: 1024 !important;\r\n");
     $nm_saida->saida("   }\r\n");
     ...
     $nm_saida->saida("   <TABLE class=\"scTabTable\" cellpadding=0 cellspacing=0 ALIGN=\"center\" WIDTH=\"50%\">\r\n");
     $nm_saida->saida("    <TR>\r\n");
     $nm_saida->saida("     <TD>\r\n");
     $this->cabecalho();
     $nm_saida->saida("     </TD>\r\n");
     ...
     $nm_saida->saida("           <A HREF=\"javascript:nm_gp_aba1()\" TARGET=\"_self\">Asignaturas</A>\r\n");
     $nm_saida->saida("         </li>\r\n");
     $cor_celula  = "scTabInactive";
     if ($nmgp_num_aba == "2") 
     {
     ...
     $nm_saida->saida("           <A HREF=\"javascript:nm_gp_aba2()\" TARGET=\"_self\">Areas</A>\r\n");
     $nm_saida->saida("         </li>\r\n");
//
     $cor_celula  = "scTabInactive";
//
         $cor_celula  = "scTabInactive";
     if (is_file("areas_asignaturas_help.txt"))
     {
        $Arq_WebHelp = file("areas_asignaturas_help.txt"); 
     ...
     $nm_saida->saida("    <TR>\r\n");
     $nm_saida->saida("      <TD style=\"padding: 0px\">\r\n");
     $nm_saida->saida("         <iframe id=\"nmsc_iframe_grid_t_asignaturas_1\" frameborder=\"0\" align=\"center\" valign=\"top\" name=\"nm_iframe_aba_grid_t_asignaturas_1\" height=\"600px\" width=\"100%\" scrolling=\"auto\"></iframe>\r\n");
     $nm_saida->saida("      </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     $nm_saida->saida("    <TR>\r\n");
     $nm_saida->saida("      <TD style=\"padding: 0px\">\r\n");
     $nm_saida->saida("         <iframe id=\"nmsc_iframe_grid_t_area_1_2\" frameborder=\"0\" align=\"center\" valign=\"top\" name=\"nm_iframe_aba_grid_t_area_1_2\" height=\"600px\" width=\"100%\" scrolling=\"auto\"></iframe>\r\n");
     $nm_saida->saida("      </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     $nm_saida->saida("   </TABLE>\r\n");
     $nm_saida->saida("     </TD>\r\n");
     $nm_saida->saida("    </TR>\r\n");
     if (!$_SESSION['sc_session'][$this->sc_page]['areas_asignaturas']['iframe_menu'])
     {
         $nm_saida->saida("    <TR>\r\n");
         $Saida = $_SESSION['sc_session'][$this->sc_page]['areas_asignaturas']['aba_saida'];
     ...
     $nm_saida->saida("      document.F2.action = \"areas_asignaturas_fim.php\";\r\n");
     ...
     $nm_saida->saida("   var nm_grid_t_asignaturas_1 = 'no';\r\n");
     $nm_saida->saida("   var nm_grid_t_area_1_2 = 'no';\r\n");
     ...
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_t_area_1_2').style.display = 'none'; \r\n");
     $nm_saida->saida("      tst_clear_iframe = document.getElementById(\"nmsc_iframe_grid_t_asignaturas_1\"); \r\n");
     ...
     $nm_saida->saida("      }\r\n");
     $nm_saida->saida("      document.Faba.nmgp_parms.value = \"sc_proc_container*scin1*scout\"; \r\n");
     $nm_saida->saida("      document.Faba.target   = \"nm_iframe_aba_grid_t_asignaturas_1\"; \r\n");
     $nm_saida->saida("      document.Faba.action   = \"" . $path_link  . SC_dir_app_name('grid_t_asignaturas') . "/\";\r\n");
     $nm_saida->saida("      document.Faba.submit() ;\r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_t_asignaturas_1').style.display = 'block'; \r\n");
     $nm_saida->saida("   } \r\n");
     ...
     $nm_saida->saida("      document.getElementById('cel'+sc_cel_ativa).className = 'scTabActive';\r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_t_asignaturas_1').style.display = 'none'; \r\n");
     $nm_saida->saida("      if (nm_grid_t_area_1_2 == 'no') \r\n");
     $nm_saida->saida("      { \r\n");
     $nm_saida->saida("          document.Faba.nmgp_parms.value = \"sc_proc_container*scin1*scout\"; \r\n");
     $nm_saida->saida("          document.Faba.target   = \"nm_iframe_aba_grid_t_area_1_2\"; \r\n");
     $nm_saida->saida("          document.Faba.action   = \"" . $path_link  . SC_dir_app_name('grid_t_area_1') . "/\";\r\n");
     $nm_saida->saida("          document.Faba.submit() ;\r\n");
     $nm_saida->saida("      } \r\n");
     $nm_saida->saida("      document.getElementById('nmsc_iframe_grid_t_area_1_2').style.display = 'block'; \r\n");
     $nm_saida->saida("      nm_grid_t_area_1_2 = 'yes';\r\n");
     $nm_saida->saida("   } \r\n");
     if ($nmgp_num_aba == "1" || empty($nmgp_num_aba)) 
     { 
...
<?php
  ...
  function cabecalho()
  {
     ...
     $nm_saida->saida("<style>\r\n");
     $nm_saida->saida("#lin1_col1 { margin-left:9px; margin-top:7px;  width:70%; height:27px; float:left; overflow:hidden;}			 \r\n");
     $nm_saida->saida("#lin1_col2 { margin-right:9px; margin-top:7px; width:20%; height:27px; float:right; overflow:hidden; text-align:right;}\r\n");
     $nm_saida->saida("</style>\r\n");
     $nm_saida->saida("<div style=\"width: 100%\" class=\"scTabHeader\">\r\n");
     $nm_saida->saida(" <span style=\"height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px; display: block\">\r\n");
     $nm_saida->saida("      <span id=\"lin1_col1\" class=\"scTabHeaderFont\">Asignaturas y Áreas</span>\r\n");
     $nm_saida->saida("      <span id=\"lin1_col2\" class=\"scTabHeaderFont\" style=\"float: right\">" . $nm_data_fixa . "</span>\r\n");
     $nm_saida->saida(" </span>\r\n");
     $nm_saida->saida("</div>\r\n");
  }
}
...
if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'areas_asignaturas')
{
    $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['sc_outra_jan'] = true;
...
$salva_iframe = false;
if (isset($_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['iframe_menu']))
{
    $salva_iframe = $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['iframe_menu'];
    unset($_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['iframe_menu']);
}
if (isset($nm_run_menu) && $nm_run_menu == 1)
{
    ...
    $_SESSION['scriptcase']['sc_apl_menu_atual'] = "areas_asignaturas";
    $achou = false;
    if (isset($_SESSION['sc_session'][$script_case_init]))
    {
        foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
        {
            if ($nome_apl == 'areas_asignaturas' || $achou)
            {
                if ($achou)
                {
    ...
    $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['iframe_menu'] = true;
}
else
{
    $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['iframe_menu'] = $salva_iframe;
}

   if (!isset($_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('areas_asignaturas' == $sReferer || 'areas_asignaturas_' == substr($sReferer, 0, 18))
       {
           $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['initialize'] = false;
       }
       else
...
{
    $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['num_aba'] = $nmgp_num_aba;
}
if (isset($nmgp_url_saida) && !empty($nmgp_url_saida)) 
{ 
    $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['aba_saida'] = $nmgp_url_saida ; 
...
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['areas_asignaturas']) || $_SESSION['scriptcase']['sc_apl_seg']['areas_asignaturas'] != "on")
{ 
    $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
    $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['iframe_menu']) ? false : true;
    if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
    {
        foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
        {
            if (in_array("areas_asignaturas", $apls_aba))
            {
                $nm_botao_ok = false;
                 break;
            }
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
    ...
    <HTML>
     <HEAD>
      <TITLE>Asignaturas y Áreas</TITLE>
...
?>
      ...
      <form name="Fseg" method="post" 
                          action="<?php echo $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['aba_saida']; ?>" 
                          target="_self"> 
...
$_POST = array();
$_GET  = array();
$nmgp_num_aba = (isset($_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['num_aba'])) ? $_SESSION['sc_session'][$script_case_init]['areas_asignaturas']['num_aba'] : 1;
$areas_asignaturas_contr = new areas_asignaturas();
$areas_asignaturas_contr->controle();
?>
