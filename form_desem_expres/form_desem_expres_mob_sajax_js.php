  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_desem_expres_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate alto
  function do_ajax_form_desem_expres_mob_validate_alto()
  {
    var nomeCampo_alto = "alto";
    var var_alto = scAjaxGetFieldText(nomeCampo_alto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_desem_expres_mob_validate_alto(var_alto, var_script_case_init, do_ajax_form_desem_expres_mob_validate_alto_cb);
  } // do_ajax_form_desem_expres_mob_validate_alto

  function do_ajax_form_desem_expres_mob_validate_alto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_desem_expres_mob_validate_alto_cb

  // ---------- Validate basico
  function do_ajax_form_desem_expres_mob_validate_basico()
  {
    var nomeCampo_basico = "basico";
    var var_basico = scAjaxGetFieldText(nomeCampo_basico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_desem_expres_mob_validate_basico(var_basico, var_script_case_init, do_ajax_form_desem_expres_mob_validate_basico_cb);
  } // do_ajax_form_desem_expres_mob_validate_basico

  function do_ajax_form_desem_expres_mob_validate_basico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "basico";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_desem_expres_mob_validate_basico_cb

  // ---------- Validate bajo
  function do_ajax_form_desem_expres_mob_validate_bajo()
  {
    var nomeCampo_bajo = "bajo";
    var var_bajo = scAjaxGetFieldText(nomeCampo_bajo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_desem_expres_mob_validate_bajo(var_bajo, var_script_case_init, do_ajax_form_desem_expres_mob_validate_bajo_cb);
  } // do_ajax_form_desem_expres_mob_validate_bajo

  function do_ajax_form_desem_expres_mob_validate_bajo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bajo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_desem_expres_mob_validate_bajo_cb
  // ---------- Form
  function do_ajax_form_desem_expres_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_desem_expres_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_id_des_expres = scAjaxGetFieldText("id_des_expres");
    ...
    scAjaxProcOn();
    x_ajax_form_desem_expres_mob_submit_form(var_alto, var_basico, var_bajo, var_id_des_expres, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_desem_expres_mob_submit_form_cb);
  } // do_ajax_form_desem_expres_mob_submit_form

  function do_ajax_form_desem_expres_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_desem_expres_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_desem_expres_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("basico");
    scAjaxHideErrorDisplay("bajo");
    var var_id_des_expres = document.F2.id_des_expres.value;
    ...
    scAjaxProcOn();
    x_ajax_form_desem_expres_mob_navigate_form(var_id_des_expres, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_desem_expres_mob_navigate_form_cb);
  } // do_ajax_form_desem_expres_mob_navigate_form

  function do_ajax_form_desem_expres_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_desem_expres_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_des_expres.value = scAjaxGetKeyValue("id_des_expres");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_desem_expres_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_desem_expres_mob_navigate_form_cb
  function sc_hide_form_desem_expres_mob_form()
  {
  ...
  ajax_field_list[0] = "alto";
  ajax_field_list[1] = "basico";
  ajax_field_list[2] = "bajo";
