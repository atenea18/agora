...
class PdfController
{
	...
	public function studentAttendanceAction($id_asignature, $id_group, $db){
	...
	public function generateGradeBookByStudentAction($db)
	{	
		...
		if(isset($_POST['btn_p_superacion']))
		{
			...
			{	
				...
				$pdf = new GradeBookPDF('P', 'mm', 'A4',$db);
