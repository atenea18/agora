...
class grid_boletines_estudiantes_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_boletines_estudiantes_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_boletines_estudiantes.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletines_estudiantes']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletines_estudiantes']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletines_estudiantes']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletines_estudiantes']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_boletines_estudiantes";
...
$_SESSION['scriptcase']['grid_boletines_estudiantes']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->estudiantes))
         {
             $this->estudiantes = sc_convert_encoding($this->estudiantes, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " estudiantes =\"" . $this->trata_dados($this->estudiantes) . "\"";
   }
   //----- t_grupos_id_sede
   ...
   function NM_export_t_evaluacion_id_grupo()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_t_evaluacion_id_grupo))
         {
             $this->look_t_evaluacion_id_grupo = sc_convert_encoding($this->look_t_evaluacion_id_grupo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " t_evaluacion_id_grupo =\"" . $this->trata_dados($this->look_t_evaluacion_id_grupo) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletines_estudiantes']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boletines_estudiantes']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
