<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_grupo_x_asig_x_doce_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_grupo_x_asig_x_doce_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["grupo_x_asig_x_doce_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["grupo_x_asig_x_doce_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["grupo_x_asig_x_doce_id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['grupo_x_asig_x_doce_intensidad_horaria'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['grupo_x_asig_x_doce_intensidad_horaria'] = "cmp_maior_30_2";
       $tab_converte["cmp_maior_30_2"]   = "grupo_x_asig_x_doce_intensidad_horaria";
   }
   else
   {
       $tab_def_campos['grupo_x_asig_x_doce_intensidad_horaria'] = "grupo_x_asig_x_doce.intensidad_horaria";
       $tab_converte["grupo_x_asig_x_doce.intensidad_horaria"]   = "grupo_x_asig_x_doce_intensidad_horaria";
   }
   $tab_labels["grupo_x_asig_x_doce_intensidad_horaria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["grupo_x_asig_x_doce_intensidad_horaria"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["grupo_x_asig_x_doce_intensidad_horaria"] : "Intensidad Horaria";
   $tab_ger_campos['grupo_x_asig_x_doce_peso_asig_fre_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['grupo_x_asig_x_doce_peso_asig_fre_area'] = "cmp_maior_30_3";
       $tab_converte["cmp_maior_30_3"]   = "grupo_x_asig_x_doce_peso_asig_fre_area";
   }
   else
   {
       $tab_def_campos['grupo_x_asig_x_doce_peso_asig_fre_area'] = "grupo_x_asig_x_doce.peso_asig_fre_area";
       $tab_converte["grupo_x_asig_x_doce.peso_asig_fre_area"]   = "grupo_x_asig_x_doce_peso_asig_fre_area";
   }
   $tab_labels["grupo_x_asig_x_doce_peso_asig_fre_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["grupo_x_asig_x_doce_peso_asig_fre_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["grupo_x_asig_x_doce_peso_asig_fre_area"] : "Peso Asig Fre Area";
   ...
   $tab_labels["evaluar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["evaluar"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["evaluar"] : "Evaluar";
   $tab_ger_campos['desempeno'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['desempeno'] = "desempeno";
       $tab_converte["desempeno"]   = "desempeno";
   }
   else
   {
       $tab_def_campos['desempeno'] = "";
       $tab_converte[""]   = "desempeno";
   }
   $tab_labels["desempeno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["desempeno"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["desempeno"] : "Desempeño";
   $tab_ger_campos['criterios'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['criterios'] = "criterios";
       $tab_converte["criterios"]   = "criterios";
   }
   else
   {
       $tab_def_campos['criterios'] = "";
       $tab_converte[""]   = "criterios";
   }
   $tab_labels["criterios"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["criterios"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["criterios"] : "Criterios";
   $tab_ger_campos['otro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['otro'] = "otro";
       $tab_converte["otro"]   = "otro";
   }
   else
   {
       $tab_def_campos['otro'] = "";
   ...
   $tab_labels["otro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["otro"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['labels']["otro"] : "otro";
   $tab_ger_campos['evaluar'] = "none";
   $tab_ger_campos['desempeno'] = "none";
   $tab_ger_campos['criterios'] = "none";
   $tab_ger_campos['otro'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_grupo_x_asig_x_doce_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
