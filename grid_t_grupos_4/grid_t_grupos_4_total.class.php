...
class grid_t_grupos_4_total
{
   ...
   //----- 
   function grid_t_grupos_4_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_t_grupos_4']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_t_grupos_4']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $id_grado, $id_director_grupo, $jornada, $id_grupo, $id_sede;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_4']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_4']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_4']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_4']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_4']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_t_grupos_4']['contr_total_geral'] = "OK";
   } 

   //-----  id_grupo
   function quebra_id_grupo_grupos($id_grupo, $arg_sum_id_grupo) 
   {
      global $tot_id_grupo , $id_grado, $id_director_grupo, $jornada, $id_grupo, $id_sede;  
      $tot_id_grupo = array() ;  
