<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_grupos_4_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_grupos_4_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['labels']["id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['labels']["id_grado"] : "Grado";
   ...
   $tab_labels["id_director_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['labels']["id_director_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['labels']["id_director_grupo"] : "Director Grupo";
   $tab_ger_campos['jornada'] = "on";
   $tab_def_campos['jornada'] = "jornada";
   $tab_converte["jornada"]   = "jornada";
   $tab_labels["jornada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['labels']["jornada"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['labels']["jornada"] : "Jornada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_grupos_4_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_grupos_4']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
