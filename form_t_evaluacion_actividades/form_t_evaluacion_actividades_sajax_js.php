  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_evaluacion_actividades" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_t_evaluacion_actividades_validate_id_estudiante_(iNumLinha)
  {
    ...
    x_ajax_form_t_evaluacion_actividades_validate_id_estudiante_(var_id_estudiante_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_id_estudiante__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_id_estudiante_

  function do_ajax_form_t_evaluacion_actividades_validate_id_estudiante__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_id_estudiante__cb

  // ---------- Validate id_grupo_
  function do_ajax_form_t_evaluacion_actividades_validate_id_grupo_(iNumLinha)
  {
    var nomeCampo_id_grupo_ = "id_grupo_" + iNumLinha;
    var var_id_grupo_ = scAjaxGetFieldText(nomeCampo_id_grupo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_id_grupo_(var_id_grupo_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_id_grupo__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_id_grupo_

  function do_ajax_form_t_evaluacion_actividades_validate_id_grupo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_id_grupo__cb

  // ---------- Validate id_area_
  function do_ajax_form_t_evaluacion_actividades_validate_id_area_(iNumLinha)
  {
    var nomeCampo_id_area_ = "id_area_" + iNumLinha;
    var var_id_area_ = scAjaxGetFieldText(nomeCampo_id_area_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_id_area_(var_id_area_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_id_area__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_id_area_

  function do_ajax_form_t_evaluacion_actividades_validate_id_area__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_id_area__cb

  // ---------- Validate id_asignatura_
  function do_ajax_form_t_evaluacion_actividades_validate_id_asignatura_(iNumLinha)
  {
    var nomeCampo_id_asignatura_ = "id_asignatura_" + iNumLinha;
    var var_id_asignatura_ = scAjaxGetFieldText(nomeCampo_id_asignatura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_id_asignatura_(var_id_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_id_asignatura__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_id_asignatura_

  function do_ajax_form_t_evaluacion_actividades_validate_id_asignatura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_id_asignatura__cb

  // ---------- Validate id_grado_
  function do_ajax_form_t_evaluacion_actividades_validate_id_grado_(iNumLinha)
  {
    var nomeCampo_id_grado_ = "id_grado_" + iNumLinha;
    var var_id_grado_ = scAjaxGetFieldText(nomeCampo_id_grado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_id_grado_(var_id_grado_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_id_grado__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_id_grado_

  function do_ajax_form_t_evaluacion_actividades_validate_id_grado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_id_grado__cb

  // ---------- Validate id_nivel_
  function do_ajax_form_t_evaluacion_actividades_validate_id_nivel_(iNumLinha)
  {
    var nomeCampo_id_nivel_ = "id_nivel_" + iNumLinha;
    var var_id_nivel_ = scAjaxGetFieldText(nomeCampo_id_nivel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_id_nivel_(var_id_nivel_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_id_nivel__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_id_nivel_

  function do_ajax_form_t_evaluacion_actividades_validate_id_nivel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_id_nivel__cb

  // ---------- Validate ihs_
  function do_ajax_form_t_evaluacion_actividades_validate_ihs_(iNumLinha)
  {
    var nomeCampo_ihs_ = "ihs_" + iNumLinha;
    var var_ihs_ = scAjaxGetFieldText(nomeCampo_ihs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_ihs_(var_ihs_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_ihs__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_ihs_

  function do_ajax_form_t_evaluacion_actividades_validate_ihs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_ihs__cb

  // ---------- Validate pfa_
  function do_ajax_form_t_evaluacion_actividades_validate_pfa_(iNumLinha)
  {
    var nomeCampo_pfa_ = "pfa_" + iNumLinha;
    var var_pfa_ = scAjaxGetFieldText(nomeCampo_pfa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_pfa_(var_pfa_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_pfa__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_pfa_

  function do_ajax_form_t_evaluacion_actividades_validate_pfa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_pfa__cb

  // ---------- Validate tipo_asig_
  function do_ajax_form_t_evaluacion_actividades_validate_tipo_asig_(iNumLinha)
  {
    var nomeCampo_tipo_asig_ = "tipo_asig_" + iNumLinha;
    var var_tipo_asig_ = scAjaxGetFieldText(nomeCampo_tipo_asig_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_tipo_asig_(var_tipo_asig_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_tipo_asig__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_tipo_asig_

  function do_ajax_form_t_evaluacion_actividades_validate_tipo_asig__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_tipo_asig__cb

  // ---------- Validate eval_1_per_
  function do_ajax_form_t_evaluacion_actividades_validate_eval_1_per_(iNumLinha)
  {
    var nomeCampo_eval_1_per_ = "eval_1_per_" + iNumLinha;
    var var_eval_1_per_ = scAjaxGetFieldText(nomeCampo_eval_1_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_eval_1_per_(var_eval_1_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_eval_1_per__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_1_per_

  function do_ajax_form_t_evaluacion_actividades_validate_eval_1_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_1_per__cb

  // ---------- Validate eval_2_per_
  function do_ajax_form_t_evaluacion_actividades_validate_eval_2_per_(iNumLinha)
  {
    var nomeCampo_eval_2_per_ = "eval_2_per_" + iNumLinha;
    var var_eval_2_per_ = scAjaxGetFieldText(nomeCampo_eval_2_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_eval_2_per_(var_eval_2_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_eval_2_per__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_2_per_

  function do_ajax_form_t_evaluacion_actividades_validate_eval_2_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_2_per__cb

  // ---------- Validate eval_3_per_
  function do_ajax_form_t_evaluacion_actividades_validate_eval_3_per_(iNumLinha)
  {
    var nomeCampo_eval_3_per_ = "eval_3_per_" + iNumLinha;
    var var_eval_3_per_ = scAjaxGetFieldText(nomeCampo_eval_3_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_eval_3_per_(var_eval_3_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_eval_3_per__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_3_per_

  function do_ajax_form_t_evaluacion_actividades_validate_eval_3_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_3_per__cb

  // ---------- Validate eval_4_per_
  function do_ajax_form_t_evaluacion_actividades_validate_eval_4_per_(iNumLinha)
  {
    var nomeCampo_eval_4_per_ = "eval_4_per_" + iNumLinha;
    var var_eval_4_per_ = scAjaxGetFieldText(nomeCampo_eval_4_per_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_eval_4_per_(var_eval_4_per_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_eval_4_per__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_4_per_

  function do_ajax_form_t_evaluacion_actividades_validate_eval_4_per__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_4_per__cb

  // ---------- Validate eval_final_
  function do_ajax_form_t_evaluacion_actividades_validate_eval_final_(iNumLinha)
  {
    var nomeCampo_eval_final_ = "eval_final_" + iNumLinha;
    var var_eval_final_ = scAjaxGetFieldText(nomeCampo_eval_final_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_eval_final_(var_eval_final_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_eval_final__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_final_

  function do_ajax_form_t_evaluacion_actividades_validate_eval_final__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_eval_final__cb

  // ---------- Validate entorno_
  function do_ajax_form_t_evaluacion_actividades_validate_entorno_(iNumLinha)
  {
    var nomeCampo_entorno_ = "entorno_" + iNumLinha;
    var var_entorno_ = scAjaxGetFieldText(nomeCampo_entorno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_validate_entorno_(var_entorno_, iNumLinha, var_script_case_init, do_ajax_form_t_evaluacion_actividades_validate_entorno__cb);
  } // do_ajax_form_t_evaluacion_actividades_validate_entorno_

  function do_ajax_form_t_evaluacion_actividades_validate_entorno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_evaluacion_actividades_validate_entorno__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_evaluacion_actividades_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_evaluacion_actividades_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_evaluacion_actividades_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_evaluacion_actividades_add_new_line_cb);
  } // do_ajax_form_t_evaluacion_actividades_add_new_line

  function do_ajax_form_t_evaluacion_actividades_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_evaluacion_actividades_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_evaluacion_actividades_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_evaluacion_actividades_backup_line(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_evaluacion_actividades_backup_line_cb);
  } // do_ajax_form_t_evaluacion_actividades_backup_line

  function do_ajax_form_t_evaluacion_actividades_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_evaluacion_actividades_backup_line_cb

  function do_ajax_form_t_evaluacion_actividades_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_evaluacion_actividades_cancel_insert

  function do_ajax_form_t_evaluacion_actividades_cancel_update(iSeqVert)
  {
    do_ajax_form_t_evaluacion_actividades_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_evaluacion_actividades_cancel_update

  function do_ajax_form_t_evaluacion_actividades_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_evaluacion_actividades_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_evaluacion_actividades_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_actividades_table_refresh(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_actividades_table_refresh_cb);
  } //  do_ajax_form_t_evaluacion_actividades_table_refresh

  function do_ajax_form_t_evaluacion_actividades_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_evaluacion_actividades_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_evaluacion_actividades_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_evaluacion_actividades_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_t_evaluacion_actividades_submit_form(var_id_estudiante_, var_id_grupo_, var_id_area_, var_id_asignatura_, var_id_grado_, var_id_nivel_, var_ihs_, var_pfa_, var_tipo_asig_, var_eval_1_per_, var_eval_2_per_, var_eval_3_per_, var_eval_4_per_, var_eval_final_, var_entorno_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_evaluacion_actividades_submit_form_cb);
  } // do_ajax_form_t_evaluacion_actividades_submit_form

  function do_ajax_form_t_evaluacion_actividades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_t_evaluacion_actividades_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_evaluacion_actividades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_evaluacion_actividades_navigate_form(var_id_estudiante_, var_id_grupo_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_evaluacion_actividades_navigate_form_cb);
  } // do_ajax_form_t_evaluacion_actividades_navigate_form

  function do_ajax_form_t_evaluacion_actividades_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_t_evaluacion_actividades_navigate_form_cb
  function sc_hide_form_t_evaluacion_actividades_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_evaluacion_actividades_form
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_estudiante_" + iRow] || "on" == ajax_error_count["id_grupo_" + iRow] || "on" == ajax_error_count["id_area_" + iRow] || "on" == ajax_error_count["id_asignatura_" + iRow] || "on" == ajax_error_count["id_grado_" + iRow] || "on" == ajax_error_count["id_nivel_" + iRow] || "on" == ajax_error_count["ihs_" + iRow] || "on" == ajax_error_count["pfa_" + iRow] || "on" == ajax_error_count["tipo_asig_" + iRow] || "on" == ajax_error_count["eval_1_per_" + iRow] || "on" == ajax_error_count["eval_2_per_" + iRow] || "on" == ajax_error_count["eval_3_per_" + iRow] || "on" == ajax_error_count["eval_4_per_" + iRow] || "on" == ajax_error_count["eval_final_" + iRow] || "on" == ajax_error_count["entorno_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_estudiante_" + iRow] && "off" == ajax_error_count["id_grupo_" + iRow] && "off" == ajax_error_count["id_area_" + iRow] && "off" == ajax_error_count["id_asignatura_" + iRow] && "off" == ajax_error_count["id_grado_" + iRow] && "off" == ajax_error_count["id_nivel_" + iRow] && "off" == ajax_error_count["ihs_" + iRow] && "off" == ajax_error_count["pfa_" + iRow] && "off" == ajax_error_count["tipo_asig_" + iRow] && "off" == ajax_error_count["eval_1_per_" + iRow] && "off" == ajax_error_count["eval_2_per_" + iRow] && "off" == ajax_error_count["eval_3_per_" + iRow] && "off" == ajax_error_count["eval_4_per_" + iRow] && "off" == ajax_error_count["eval_final_" + iRow] && "off" == ajax_error_count["entorno_" + iRow]))
    {
      if (bErrorRow)
      {
