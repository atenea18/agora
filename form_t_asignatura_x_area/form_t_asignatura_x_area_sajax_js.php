  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_t_asignatura_x_area" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_t_asignatura_x_area_validate_id_asignatura_(iNumLinha)
  {
    ...
    x_ajax_form_t_asignatura_x_area_validate_id_asignatura_(var_id_asignatura_, iNumLinha, var_script_case_init, do_ajax_form_t_asignatura_x_area_validate_id_asignatura__cb);
  } // do_ajax_form_t_asignatura_x_area_validate_id_asignatura_

  function do_ajax_form_t_asignatura_x_area_validate_id_asignatura__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignatura_x_area_validate_id_asignatura__cb

  // ---------- Validate id_grado_
  function do_ajax_form_t_asignatura_x_area_validate_id_grado_(iNumLinha)
  {
    var nomeCampo_id_grado_ = "id_grado_" + iNumLinha;
    var var_id_grado_ = scAjaxGetFieldSelect(nomeCampo_id_grado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignatura_x_area_validate_id_grado_(var_id_grado_, iNumLinha, var_script_case_init, do_ajax_form_t_asignatura_x_area_validate_id_grado__cb);
  } // do_ajax_form_t_asignatura_x_area_validate_id_grado_

  function do_ajax_form_t_asignatura_x_area_validate_id_grado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignatura_x_area_validate_id_grado__cb

  // ---------- Validate peso_frente_area_
  function do_ajax_form_t_asignatura_x_area_validate_peso_frente_area_(iNumLinha)
  {
    var nomeCampo_peso_frente_area_ = "peso_frente_area_" + iNumLinha;
    var var_peso_frente_area_ = scAjaxGetFieldText(nomeCampo_peso_frente_area_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignatura_x_area_validate_peso_frente_area_(var_peso_frente_area_, iNumLinha, var_script_case_init, do_ajax_form_t_asignatura_x_area_validate_peso_frente_area__cb);
  } // do_ajax_form_t_asignatura_x_area_validate_peso_frente_area_

  function do_ajax_form_t_asignatura_x_area_validate_peso_frente_area__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "peso_frente_area_" + iLineNumber;
    }
    else
    {
      sFieldValid = "peso_frente_area_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "peso_frente_area_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "peso_frente_area_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignatura_x_area_validate_peso_frente_area__cb

  // ---------- Validate int_horaria_
  function do_ajax_form_t_asignatura_x_area_validate_int_horaria_(iNumLinha)
  {
    var nomeCampo_int_horaria_ = "int_horaria_" + iNumLinha;
    var var_int_horaria_ = scAjaxGetFieldText(nomeCampo_int_horaria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignatura_x_area_validate_int_horaria_(var_int_horaria_, iNumLinha, var_script_case_init, do_ajax_form_t_asignatura_x_area_validate_int_horaria__cb);
  } // do_ajax_form_t_asignatura_x_area_validate_int_horaria_

  function do_ajax_form_t_asignatura_x_area_validate_int_horaria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "int_horaria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "int_horaria_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "int_horaria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "int_horaria_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignatura_x_area_validate_int_horaria__cb

  // ---------- Validate tipo_asig_
  function do_ajax_form_t_asignatura_x_area_validate_tipo_asig_(iNumLinha)
  {
    var nomeCampo_tipo_asig_ = "tipo_asig_" + iNumLinha;
    var var_tipo_asig_ = scAjaxGetFieldRadio(nomeCampo_tipo_asig_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignatura_x_area_validate_tipo_asig_(var_tipo_asig_, iNumLinha, var_script_case_init, do_ajax_form_t_asignatura_x_area_validate_tipo_asig__cb);
  } // do_ajax_form_t_asignatura_x_area_validate_tipo_asig_

  function do_ajax_form_t_asignatura_x_area_validate_tipo_asig__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_t_asignatura_x_area_validate_tipo_asig__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_t_asignatura_x_area_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_t_asignatura_x_area_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_t_asignatura_x_area_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_t_asignatura_x_area_add_new_line_cb);
  } // do_ajax_form_t_asignatura_x_area_add_new_line

  function do_ajax_form_t_asignatura_x_area_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_t_asignatura_x_area_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_t_asignatura_x_area_backup_line(iNumLinha)
  {
    var var_id_asignatura_area_grado_peso_ = scAjaxGetFieldText("id_asignatura_area_grado_peso_" + iNumLinha);
    var var_id_asignatura_ = scAjaxGetFieldSelect("id_asignatura_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_t_asignatura_x_area_backup_line(var_id_asignatura_area_grado_peso_, var_id_asignatura_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_t_asignatura_x_area_backup_line_cb);
  } // do_ajax_form_t_asignatura_x_area_backup_line

  function do_ajax_form_t_asignatura_x_area_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_t_asignatura_x_area_backup_line_cb

  function do_ajax_form_t_asignatura_x_area_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_t_asignatura_x_area_cancel_insert

  function do_ajax_form_t_asignatura_x_area_cancel_update(iSeqVert)
  {
    do_ajax_form_t_asignatura_x_area_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_t_asignatura_x_area_cancel_update

  function do_ajax_form_t_asignatura_x_area_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_t_asignatura_x_area_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_t_asignatura_x_area_table_refresh()
  {
    var var_id_asignatura_area_grado_peso_ = document.F2.id_asignatura_area_grado_peso_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_t_asignatura_x_area_table_refresh(var_id_asignatura_area_grado_peso_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_asignatura_x_area_table_refresh_cb);
  } //  do_ajax_form_t_asignatura_x_area_table_refresh

  function do_ajax_form_t_asignatura_x_area_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_asignatura_area_grado_peso_.value = scAjaxGetKeyValue("id_asignatura_area_grado_peso_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_t_asignatura_x_area_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_t_asignatura_x_area_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_t_asignatura_x_area_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_asignatura_ = scAjaxGetFieldSelect("id_asignatura_" + iNumLinha);
    var var_id_grado_ = scAjaxGetFieldSelect("id_grado_" + iNumLinha);
    var var_peso_frente_area_ = scAjaxGetFieldText("peso_frente_area_" + iNumLinha);
    var var_int_horaria_ = scAjaxGetFieldText("int_horaria_" + iNumLinha);
...
?>
    x_ajax_form_t_asignatura_x_area_submit_form(var_id_asignatura_, var_id_grado_, var_peso_frente_area_, var_int_horaria_, var_tipo_asig_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_t_asignatura_x_area_submit_form_cb);
  } // do_ajax_form_t_asignatura_x_area_submit_form

  function do_ajax_form_t_asignatura_x_area_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("peso_frente_area_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("int_horaria_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_t_asignatura_x_area_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_t_asignatura_x_area_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_t_asignatura_x_area_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("peso_frente_area_" + iNavForm);
      scAjaxHideErrorDisplay("int_horaria_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_t_asignatura_x_area_navigate_form(var_id_asignatura_area_grado_peso_, var_id_asignatura_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_t_asignatura_x_area_navigate_form_cb);
  } // do_ajax_form_t_asignatura_x_area_navigate_form

  function do_ajax_form_t_asignatura_x_area_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_asignatura_area_grado_peso_.value = scAjaxGetKeyValue("id_asignatura_area_grado_peso_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_t_asignatura_x_area_navigate_form_cb
  function sc_hide_form_t_asignatura_x_area_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_t_asignatura_x_area_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "peso_frente_area_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "int_horaria_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["peso_frente_area_" + iNumLinha] = {"label": "% F Area<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["int_horaria_" + iNumLinha] = {"label": "Int Horaria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["peso_frente_area_"][iNumLinha] = "peso_frente_area_" + iNumLinha;
    ajax_field_mult["int_horaria_"][iNumLinha] = "int_horaria_" + iNumLinha;
    ...
    ajax_field_id["peso_frente_area_" + iNumLinha] = new Array("hidden_field_label_peso_frente_area_", "hidden_field_data_peso_frente_area_" + iNumLinha);
    ajax_field_id["int_horaria_" + iNumLinha] = new Array("hidden_field_label_int_horaria_", "hidden_field_data_int_horaria_" + iNumLinha);
    ...
    ajax_error_count["peso_frente_area_" + iNumLinha] = "off";
    ajax_error_count["int_horaria_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["peso_frente_area_" + iNumLinha] = "off";
    ajax_read_only["int_horaria_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["peso_frente_area_" + iNumLinha] = "on";
    ajax_read_only["int_horaria_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["peso_frente_area_" + iNumLinha] = null;
    ajax_error_list["int_horaria_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "id_grado_": new Array(),
    "peso_frente_area_": new Array(),
    "int_horaria_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["peso_frente_area_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["peso_frente_area_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["peso_frente_area_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["peso_frente_area_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["peso_frente_area_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["int_horaria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["int_horaria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["int_horaria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["int_horaria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["int_horaria_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['peso_frente_area_'])) ? $this->nmgp_cmp_readonly['peso_frente_area_'] : 'off';
?>
    scAjaxFieldRead("peso_frente_area_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['int_horaria_'])) ? $this->nmgp_cmp_readonly['int_horaria_'] : 'off';
?>
    scAjaxFieldRead("int_horaria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("peso_frente_area_" + iSeq, "on");
    scAjaxFieldRead("int_horaria_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_asignatura_" + iRow] || "on" == ajax_error_count["id_grado_" + iRow] || "on" == ajax_error_count["peso_frente_area_" + iRow] || "on" == ajax_error_count["int_horaria_" + iRow] || "on" == ajax_error_count["tipo_asig_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_peso_frente_area_" + iRow))
        document.getElementById("hidden_field_data_peso_frente_area_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_int_horaria_" + iRow))
        document.getElementById("hidden_field_data_int_horaria_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_asignatura_" + iRow] && "off" == ajax_error_count["id_grado_" + iRow] && "off" == ajax_error_count["peso_frente_area_" + iRow] && "off" == ajax_error_count["int_horaria_" + iRow] && "off" == ajax_error_count["tipo_asig_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_asignatura_" + iRow] = "off";
        ajax_error_count["id_grado_" + iRow] = "off";
        ajax_error_count["peso_frente_area_" + iRow] = "off";
        ajax_error_count["int_horaria_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_peso_frente_area_" + iRow))
        document.getElementById("hidden_field_data_peso_frente_area_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_int_horaria_" + iRow))
        document.getElementById("hidden_field_data_int_horaria_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_tipo_asig_" + iRow))
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("peso_frente_area_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("int_horaria_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
