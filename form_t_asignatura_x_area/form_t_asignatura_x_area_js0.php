<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_asignatura_area_grado_peso_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_asignatura_area_grado_peso_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_t_asignatura_x_area"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_t_asignatura_x_area_submit_form(y, z); 
} 
<?php
}
?>
