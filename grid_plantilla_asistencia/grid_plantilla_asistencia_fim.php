...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_plantilla_asistencia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_plantilla_asistencia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_plantilla_asistencia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_plantilla_asistencia']['embutida_filho'] as $ind => $sc_init)
          {
