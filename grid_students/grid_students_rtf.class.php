...
class grid_students_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_students.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_students']['contr_erro'] = 'off'; 
   ...
   function NM_export_idstudents()
   {
         ...
         $this->look_idstudents = str_replace('<', '&lt;', $this->look_idstudents);
         $this->look_idstudents = str_replace('>', '&gt;', $this->look_idstudents);
         $this->Texto_tag .= "<td>" . $this->look_idstudents . "</td>\r\n";
   }
   //----- estatus
   ...
   {
         nmgp_Form_Num_Val($this->departanebti_expedicion, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         ...
         $this->departanebti_expedicion = str_replace('<', '&lt;', $this->departanebti_expedicion);
         $this->departanebti_expedicion = str_replace('>', '&gt;', $this->departanebti_expedicion);
         $this->Texto_tag .= "<td>" . $this->departanebti_expedicion . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
