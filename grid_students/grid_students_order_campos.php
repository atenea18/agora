<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_students_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_students_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idstudents"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students']['labels']["idstudents"])) ? $_SESSION['sc_session'][$sc_init]['grid_students']['labels']["idstudents"] : "Estudiantes";
   $tab_ger_campos['estatus'] = "on";
   $tab_def_campos['estatus'] = "estatus";
   $tab_converte["estatus"]   = "estatus";
   $tab_labels["estatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students']['labels']["estatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_students']['labels']["estatus"] : "Estatus";
   $tab_ger_campos['grado_igreso'] = "on";
   $tab_def_campos['grado_igreso'] = "grado_igreso";
   $tab_converte["grado_igreso"]   = "grado_igreso";
   $tab_labels["grado_igreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students']['labels']["grado_igreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_students']['labels']["grado_igreso"] : "Grado Actual";
   $tab_ger_campos['novedades'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['novedades'] = "novedades";
       $tab_converte["novedades"]   = "novedades";
   }
   else
   {
       $tab_def_campos['novedades'] = "";
       $tab_converte[""]   = "novedades";
   }
   $tab_labels["novedades"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_students']['labels']["novedades"])) ? $_SESSION['sc_session'][$sc_init]['grid_students']['labels']["novedades"] : "Novedades";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_students']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_students']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_students']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_students']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_students']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_students']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_students']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_students']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_students']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_students_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_students']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_students']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
