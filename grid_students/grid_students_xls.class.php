...
class grid_students_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_students";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_students.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->fecha_matricula = $rs->fields[3] ;  
         $this->tipo_identificacion = $rs->fields[4] ;  
         $this->numero_documento = $rs->fields[5] ;  
         $this->departanebti_expedicion = $rs->fields[6] ;  
...
$_SESSION['scriptcase']['grid_students']['contr_erro'] = 'off'; 
   ...
   {
         if (!NM_is_utf8($this->look_idstudents))
         {
             $this->look_idstudents = sc_convert_encoding($this->look_idstudents, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->look_idstudents))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_idstudents);
         $this->Xls_col++;
   }
   //----- estatus
   function NM_export_estatus()
   {
         $this->look_estatus = html_entity_decode($this->look_estatus, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_estatus = strip_tags($this->look_estatus);
         if (!NM_is_utf8($this->look_estatus))
         {
             $this->look_estatus = sc_convert_encoding($this->look_estatus, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->look_estatus, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- grado_igreso
   ...
   {
         if (!NM_is_utf8($this->novedades))
         {
             $this->novedades = sc_convert_encoding($this->novedades, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->novedades, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- fecha_matricula
   ...
   {
         if (!NM_is_utf8($this->departanebti_expedicion))
         {
             $this->departanebti_expedicion = sc_convert_encoding($this->departanebti_expedicion, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->departanebti_expedicion))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->departanebti_expedicion);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_students'][$path_doc_md5][1] = $this->Tit_doc;
?>
