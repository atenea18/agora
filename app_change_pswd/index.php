...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'agora_IV'); 
      } 
      else 
      { 
...
//
    ...
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || $_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd'] != "on")
    { 
