...
class chart_docente_login_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_id_asignatura;
   var $array_total_id_grupo;
   var $array_total_intensidad_horaria;
   ...
   var $conv_col;
   var $count_ger;
   var $avg_intensidad_horaria;
   var $sc_proc_quebra_id_asignatura;
   var $count_id_asignatura;
   var $avg_id_asignatura_intensidad_horaria;
   var $sc_proc_quebra_id_grupo;
   var $count_id_grupo;
   var $avg_id_grupo_intensidad_horaria;
   var $sc_proc_quebra_intensidad_horaria;
   var $count_intensidad_horaria;
   var $avg_intensidad_horaria_intensidad_horaria;

   //---- 
   function chart_docente_login_resumo($tipo = "")
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_docente_login']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_docente_login']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_docente_login']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_combination_type']        = 'column3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_combination_order_field'] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys'][1] = 1;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys'][2] = 2;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_cmp']["id_asignatura"] = 'id_asignatura';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_cmp']["id_grupo"] = 'id_grupo';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_cmp']["intensidad_horaria"] = 'intensidad_horaria';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_sql']["id_asignatura"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_sql']["id_grupo"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_sql']["intensidad_horaria"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['comb_field_display_type'][2] = 'line';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_display_values'][2] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][2]['display'] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_order'][] = 2;
       }

      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_docente_login", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['contr_total_geral'] == "OK")
      {
          $this->array_total_id_asignatura = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_total']['id_asignatura'];
          $this->array_total_id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_total']['id_grupo'];
          $this->array_total_intensidad_horaria = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_total']['intensidad_horaria'];
      }
      else
      {
          $this->array_total_id_asignatura = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_total']['id_asignatura'] = $this->array_total_id_asignatura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_total']['id_grupo'] = $this->array_total_id_grupo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_total']['intensidad_horaria'] = $this->array_total_intensidad_horaria;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['id_asignatura'] = "Asignatura";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['labels'][''] = "Asignatura"; 
       $prep_field['id_grupo'] = "Id Grupo";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['labels'][''] = "Id Grupo"; 
       $prep_field['intensidad_horaria'] = "Intensidad Horaria";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['labels'][''] = "Intensidad Horaria"; 
       $Str_gb = "";
       ...
       //-----
       $this->comp_sum = array(
           2 => "Intensidad Horaria(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_control'] = array(
               'intensidad_horaria' => array(
                   'label' => "Intensidad Horaria(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")",
                   'label_field' => "Intensidad Horaria",
                   'options' => array(
                       array('op' => 'A', 'index' => '2', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . "", 'abbrev' => "Avg"),
                   ),
                   'select' => "<select class=\"sc-ui-select-intensidad_horaria\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-A\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "intensidad_horaria", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_intensidad_horaria_avg",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['id_grupo']['alin'] = "''";
       $Arr_parms['id_grupo']['link'] = "N";
       $Arr_parms['id_asignatura']['alin'] = "''";
       $Arr_parms['id_asignatura']['link'] = "N";
       $Arr_parms['intensidad_horaria']['alin'] = "''";
       $Arr_parms['intensidad_horaria']['link'] = "N";
       $Arr_parms['id_asignatura']['fill'] = "true";
       $Arr_parms['id_asignatura']['order'] = "value";
       $Arr_parms['id_grupo']['fill'] = "true";
       $Arr_parms['id_grupo']['order'] = "value";
       $Arr_parms['intensidad_horaria']['fill'] = "true";
       $Arr_parms['intensidad_horaria']['order'] = "value";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['id_grupo'] = array(0 => 'id_grupo', 1 => '');
       $prep_links_fl['id_asignatura'] = array(0 => 'id_asignatura', 1 => '');
       $prep_links_fl['intensidad_horaria'] = array(0 => 'intensidad_horaria', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'id_grupo' => array(
           '1' => array(
               'title'    => $this->getChartText("Intensidad Horaria(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")"),
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Id Grupo"),
               'label_y'  => $this->getChartText("Intensidad Horaria(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")"),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['summarizing_fields_order'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_docente_login_' . session_id() . '_C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__.xml' : '',
                               'xml'         => 'sc_chart_docente_login_' . session_id() . '_C_' . $i_index_group . '_' . $s_index_comb . '.xml',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_docente_login_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_docente_login_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_docente_login']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_docente_login']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_docente_login']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_docente_login']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_docente_login_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] = "print";
      ...
      $this->total   = new chart_docente_login_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_id_asignatura, $this->array_total_id_grupo, $this->array_total_intensidad_horaria);
      ksort($this->array_total_id_asignatura);
      ksort($this->array_total_id_grupo);
      ksort($this->array_total_intensidad_horaria);
      $this->total->quebra_geral();
   }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - docente_login</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_docente_login_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_docente_login_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_docente_login_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_docente_login_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_docente_login_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_docente_login_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_docente_login/chart_docente_login_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['embutida'])
      {
   ...
   $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsort_on", "scShowSort('#chart_sort_on_top')", "scShowSort('#chart_sort_on_top')", "chart_sort_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_docente_login/chart_docente_login_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&is_chart_app=Y&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_docente_login/chart_docente_login_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
         ...
         if (is_file("chart_docente_login_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_docente_login_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_docente_login_config_pivot.php?nome_apl=chart_docente_login&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "chart_docente_login/chart_docente_login_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_docente_login_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_docente_login@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_docente_login/chart_docente_login_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_docente_login_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_docente_login/chart_docente_login_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_docente_login_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - docente_login</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($avg_intensidad_horaria, $quebra_id_asignatura, $quebra_id_grupo, $quebra_intensidad_horaria, $quebra_id_asignatura_orig, $quebra_id_grupo_orig, $quebra_intensidad_horaria_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (empty($avg_intensidad_horaria)) {$avg_intensidad_horaria = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $avg_intensidad_horaria . ';
   ...
   function finaliza_arrays()
   {
      ...
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          $Str_gb .= "foreach (\$this->" . $Arr_name[$ix] . " as \$campo_" . $Arr_gb[$ix] . " => \$dados_" . $Arr_gb[$ix] . ")";
          $Str_gb .= "{";
          $Str_gb .=     "if (\$this->" . $Arr_name[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][0] != 0) {\$this->" . $Arr_name[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][1] /= \$this->" . $Arr_name[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][0];}";
      }
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          $Str_gb .= "}";
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT id_docente_grupo, id_grupo, id_area, id_asignatura, id_docente, intensidad_horaria, peso_asig_fre_area, tipo_asig, login from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT id_docente_grupo, id_grupo, id_area, id_asignatura, id_docente, intensidad_horaria, peso_asig_fre_area, tipo_asig, login from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_docente_login']['where_pesq']; 
     $temp = "";
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_docente_grupo = $rs_res->fields[0] ;  
            $this->id_grupo = $rs_res->fields[1] ;  
            $this->id_area = $rs_res->fields[2] ;  
            $this->id_asignatura = $rs_res->fields[3] ;  
            $this->id_docente = $rs_res->fields[4] ;  
            $this->intensidad_horaria = $rs_res->fields[5] ;  
            $this->peso_asig_fre_area = $rs_res->fields[6] ;  
            $this->tipo_asig = $rs_res->fields[7] ;  
            $this->login = $rs_res->fields[8] ;  
            $this->id_asignatura_orig = $this->id_asignatura;
            $this->id_grupo_orig = $this->id_grupo;
            $this->intensidad_horaria_orig = $this->intensidad_horaria;
            ...
            $this->id_grupo = $this->look_id_grupo ;
            $this->id_asignatura = $this->look_id_asignatura ;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->intensidad_horaria, $this->id_asignatura, $this->id_grupo, $this->intensidad_horaria, $this->id_asignatura_orig,  $this->id_grupo_orig,  $this->intensidad_horaria_orig);
            }
   }
//
