...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____chart_docente_login"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____chart_docente_login"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_docente_login']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_docente_login']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_docente_login']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_docente_login']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_docente_login']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_docente_login</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_docente_login']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_docente_login']['embutida_filho'] as $ind => $sc_init)
          {
