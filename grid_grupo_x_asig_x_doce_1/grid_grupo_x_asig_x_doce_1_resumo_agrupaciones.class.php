...
class grid_grupo_x_asig_x_doce_1_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_grupo_x_asig_x_doce_id_grupo;
   var $array_total_grupo_x_asig_x_doce_id_asignatura;
   var $array_total_grupo_x_asig_x_doce_intensidad_horaria;
   ...
   //---- 
   function grid_grupo_x_asig_x_doce_1_resumo($tipo = "")
   {
      ...
      $this->array_total_grupo_x_asig_x_doce_id_grupo           = array();
      $this->array_total_grupo_x_asig_x_doce_id_asignatura      = array();
      $this->array_total_grupo_x_asig_x_doce_intensidad_horaria = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['contr_total_geral'] == "OK")
      {
          $this->array_total_grupo_x_asig_x_doce_id_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_total']['grupo_x_asig_x_doce_id_grupo'];
          $this->array_total_grupo_x_asig_x_doce_id_asignatura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_total']['grupo_x_asig_x_doce_id_asignatura'];
          $this->array_total_grupo_x_asig_x_doce_intensidad_horaria = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_total']['grupo_x_asig_x_doce_intensidad_horaria'];
      }
      else
      {
          $this->array_total_grupo_x_asig_x_doce_id_grupo = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_total']['grupo_x_asig_x_doce_id_grupo'] = $this->array_total_grupo_x_asig_x_doce_id_grupo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_total']['grupo_x_asig_x_doce_id_asignatura'] = $this->array_total_grupo_x_asig_x_doce_id_asignatura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_total']['grupo_x_asig_x_doce_intensidad_horaria'] = $this->array_total_grupo_x_asig_x_doce_intensidad_horaria;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field_nm = array(
           'grupo_x_asig_x_doce_id_grupo' => 0,
           'grupo_x_asig_x_doce_id_asignatura' => 1,
           'grupo_x_asig_x_doce_intensidad_horaria' => 2,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       foreach ($this->array_total_grupo_x_asig_x_doce_id_grupo as $i_grupo_x_asig_x_doce_id_grupo => $d_grupo_x_asig_x_doce_id_grupo) {
           if (!in_array($i_grupo_x_asig_x_doce_id_grupo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_grupo_x_asig_x_doce_id_grupo[2] ] = $d_grupo_x_asig_x_doce_id_grupo[1];
               $this->comp_label[0][ $d_grupo_x_asig_x_doce_id_grupo[2] ] = $d_grupo_x_asig_x_doce_id_grupo[1];
           }
           foreach ($this->array_total_grupo_x_asig_x_doce_id_asignatura[$i_grupo_x_asig_x_doce_id_grupo] as $i_grupo_x_asig_x_doce_id_asignatura => $d_grupo_x_asig_x_doce_id_asignatura) {
               if (!in_array($i_grupo_x_asig_x_doce_id_asignatura, $this->comp_label[1][ $d_grupo_x_asig_x_doce_id_grupo[2] ], true)) {
                   $this->comp_index[1][ $d_grupo_x_asig_x_doce_id_asignatura[2] ] = $d_grupo_x_asig_x_doce_id_asignatura[1];
                   $this->comp_label[1][ $d_grupo_x_asig_x_doce_id_grupo[2] ][ $d_grupo_x_asig_x_doce_id_asignatura[2] ] = $d_grupo_x_asig_x_doce_id_asignatura[1];
               }
               foreach ($this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$i_grupo_x_asig_x_doce_id_grupo][$i_grupo_x_asig_x_doce_id_asignatura] as $i_grupo_x_asig_x_doce_intensidad_horaria => $d_grupo_x_asig_x_doce_intensidad_horaria) {
                   if (!in_array($i_grupo_x_asig_x_doce_intensidad_horaria, $this->comp_label[2][ $d_grupo_x_asig_x_doce_id_grupo[2] ][ $d_grupo_x_asig_x_doce_id_asignatura[2] ], true)) {
                       $this->comp_index[2][ $d_grupo_x_asig_x_doce_intensidad_horaria[2] ] = $d_grupo_x_asig_x_doce_intensidad_horaria[1];
                       $this->comp_label[2][ $d_grupo_x_asig_x_doce_id_grupo[2] ][ $d_grupo_x_asig_x_doce_id_asignatura[2] ][ $d_grupo_x_asig_x_doce_intensidad_horaria[2] ] = $d_grupo_x_asig_x_doce_intensidad_horaria[1];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'grupo_x_asig_x_doce.id_grupo', 'prot' => '@aspass@'),
           array('name' => 'grupo_x_asig_x_doce.id_asignatura', 'prot' => '@aspass@'),
           array('name' => 'grupo_x_asig_x_doce.intensidad_horaria', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_grupo_x_asig_x_doce_id_grupo => $l_grupo_x_asig_x_doce_id_grupo) {
           if (isset($this->array_total_grupo_x_asig_x_doce_id_grupo[$i_grupo_x_asig_x_doce_id_grupo])) {
               $this->comp_group[$i_grupo_x_asig_x_doce_id_grupo] = array();
           }
           foreach ($this->comp_label[1][$i_grupo_x_asig_x_doce_id_grupo] as $i_grupo_x_asig_x_doce_id_asignatura => $l_grupo_x_asig_x_doce_id_asignatura) {
               if (isset($this->array_total_grupo_x_asig_x_doce_id_asignatura[$i_grupo_x_asig_x_doce_id_grupo][$i_grupo_x_asig_x_doce_id_asignatura])) {
                   $this->comp_group[$i_grupo_x_asig_x_doce_id_grupo][$i_grupo_x_asig_x_doce_id_asignatura] = array();
               }
               foreach ($this->comp_label[2][$i_grupo_x_asig_x_doce_id_grupo][$i_grupo_x_asig_x_doce_id_asignatura] as $i_grupo_x_asig_x_doce_intensidad_horaria => $l_grupo_x_asig_x_doce_intensidad_horaria) {
                   if (isset($this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$i_grupo_x_asig_x_doce_id_grupo][$i_grupo_x_asig_x_doce_id_asignatura][$i_grupo_x_asig_x_doce_intensidad_horaria])) {
                       $this->comp_group[$i_grupo_x_asig_x_doce_id_grupo][$i_grupo_x_asig_x_doce_id_asignatura][$i_grupo_x_asig_x_doce_intensidad_horaria] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_grupo_x_asig_x_doce_id_grupo;
       }
       elseif (1 == $level) {
           $return = $this->array_total_grupo_x_asig_x_doce_id_asignatura;
       }
       elseif (2 == $level) {
           $return = $this->array_total_grupo_x_asig_x_doce_intensidad_horaria;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Grupo"),
           ...
           '1|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Asignatura"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '2|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Intensidad Horaria"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           'T|0' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_grupo_x_asig_x_doce_1_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_grupo_x_asig_x_doce_1_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_grupo_x_asig_x_doce_1_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] = "print";
      ...
      $this->total   = new grid_grupo_x_asig_x_doce_1_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_agrupaciones("res", $this->array_total_grupo_x_asig_x_doce_id_grupo, $this->array_total_grupo_x_asig_x_doce_id_asignatura, $this->array_total_grupo_x_asig_x_doce_intensidad_horaria);
      ksort($this->array_total_grupo_x_asig_x_doce_id_grupo);
      ksort($this->array_total_grupo_x_asig_x_doce_id_asignatura);
      ksort($this->array_total_grupo_x_asig_x_doce_intensidad_horaria);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_titl'] . " - grupo_x_asig_x_doce</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_grupo_x_asig_x_doce_1_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = grid_grupo_x_asig_x_doce_1_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = grid_grupo_x_asig_x_doce_1_grafico::getChartModule('Bar');
      }
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_grupo_x_asig_x_doce_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_grupo_x_asig_x_doce_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_grupo_x_asig_x_doce_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_config_graf_flash.php?nome_apl=grid_grupo_x_asig_x_doce_1&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_grupo_x_asig_x_doce_1_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_grupo_x_asig_x_doce_1_config_pivot.php?nome_apl=grid_grupo_x_asig_x_doce_1&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_grupo_x_asig_x_doce_1_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_grupo_x_asig_x_doce_1/grid_grupo_x_asig_x_doce_1_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_grupo_x_asig_x_doce_1_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grupo_x_asig_x_doce_1']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_smry_titl'] . " - grupo_x_asig_x_doce</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_grupo_x_asig_x_doce_id_grupo, $quebra_grupo_x_asig_x_doce_id_asignatura, $quebra_grupo_x_asig_x_doce_intensidad_horaria, $quebra_grupo_x_asig_x_doce_id_grupo_orig, $quebra_grupo_x_asig_x_doce_id_asignatura_orig, $quebra_grupo_x_asig_x_doce_intensidad_horaria_orig)
   {
      //----- Grupo
      if (!isset($this->array_total_grupo_x_asig_x_doce_id_grupo[$quebra_grupo_x_asig_x_doce_id_grupo_orig]))
      {
         $this->array_total_grupo_x_asig_x_doce_id_grupo[$quebra_grupo_x_asig_x_doce_id_grupo_orig][0] = 1;
         $this->array_total_grupo_x_asig_x_doce_id_grupo[$quebra_grupo_x_asig_x_doce_id_grupo_orig][1] = $quebra_grupo_x_asig_x_doce_id_grupo;
         $this->array_total_grupo_x_asig_x_doce_id_grupo[$quebra_grupo_x_asig_x_doce_id_grupo_orig][2] = $quebra_grupo_x_asig_x_doce_id_grupo_orig;
      }
      else
      {
         $this->array_total_grupo_x_asig_x_doce_id_grupo[$quebra_grupo_x_asig_x_doce_id_grupo_orig][0]++;
      }
      //----- Asignatura
      if (!isset($this->array_total_grupo_x_asig_x_doce_id_asignatura[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig]))
      {
         $this->array_total_grupo_x_asig_x_doce_id_asignatura[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][0] = 1;
         $this->array_total_grupo_x_asig_x_doce_id_asignatura[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][1] = $quebra_grupo_x_asig_x_doce_id_asignatura;
         $this->array_total_grupo_x_asig_x_doce_id_asignatura[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][2] = $quebra_grupo_x_asig_x_doce_id_asignatura_orig;
      }
      else
      {
         $this->array_total_grupo_x_asig_x_doce_id_asignatura[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][0]++;
      }
      //----- Intensidad Horaria
      if (!isset($this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][$quebra_grupo_x_asig_x_doce_intensidad_horaria_orig]))
      {
         $this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][$quebra_grupo_x_asig_x_doce_intensidad_horaria_orig][0] = 1;
         $this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][$quebra_grupo_x_asig_x_doce_intensidad_horaria_orig][1] = $quebra_grupo_x_asig_x_doce_intensidad_horaria;
         $this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][$quebra_grupo_x_asig_x_doce_intensidad_horaria_orig][2] = $quebra_grupo_x_asig_x_doce_intensidad_horaria_orig;
      }
      else
      {
         $this->array_total_grupo_x_asig_x_doce_intensidad_horaria[$quebra_grupo_x_asig_x_doce_id_grupo_orig][$quebra_grupo_x_asig_x_doce_id_asignatura_orig][$quebra_grupo_x_asig_x_doce_intensidad_horaria_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_order_by = " order by  grupo_x_asig_x_doce.id_grupo asc, grupo_x_asig_x_doce.id_asignatura asc, grupo_x_asig_x_doce.intensidad_horaria asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->grupo_x_asig_x_doce_id_grupo = $rs_res->fields[0] ;  
            $this->grupo_x_asig_x_doce_id_area = $rs_res->fields[1] ;  
            $this->grupo_x_asig_x_doce_id_asignatura = $rs_res->fields[2] ;  
            $this->grupo_x_asig_x_doce_intensidad_horaria = $rs_res->fields[3] ;  
            $this->grupo_x_asig_x_doce_id_grupo_orig = $this->grupo_x_asig_x_doce_id_grupo;
            $this->grupo_x_asig_x_doce_id_asignatura_orig = $this->grupo_x_asig_x_doce_id_asignatura;
            $this->grupo_x_asig_x_doce_intensidad_horaria_orig = $this->grupo_x_asig_x_doce_intensidad_horaria;
            ...
            $this->grupo_x_asig_x_doce_id_grupo = $this->look_grupo_x_asig_x_doce_id_grupo ;
            $this->grupo_x_asig_x_doce_id_asignatura = $this->look_grupo_x_asig_x_doce_id_asignatura ;
            nmgp_Form_Num_Val($this->grupo_x_asig_x_doce_intensidad_horaria, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->grupo_x_asig_x_doce_id_grupo, $this->grupo_x_asig_x_doce_id_asignatura, $this->grupo_x_asig_x_doce_intensidad_horaria, $this->grupo_x_asig_x_doce_id_grupo_orig,  $this->grupo_x_asig_x_doce_id_asignatura_orig,  $this->grupo_x_asig_x_doce_intensidad_horaria_orig);
            }
   }
//
