<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_grupo_x_asig_x_doce_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_grupo_x_asig_x_doce_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["grupo_x_asig_x_doce_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_id_grupo"] : "Grupo";
   $tab_ger_campos['grupo_x_asig_x_doce_id_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['grupo_x_asig_x_doce_id_area'] = "grupo_x_asig_x_doce_id_area";
       $tab_converte["grupo_x_asig_x_doce_id_area"]   = "grupo_x_asig_x_doce_id_area";
   }
   else
   {
       $tab_def_campos['grupo_x_asig_x_doce_id_area'] = "grupo_x_asig_x_doce.id_area";
       $tab_converte["grupo_x_asig_x_doce.id_area"]   = "grupo_x_asig_x_doce_id_area";
   }
   $tab_labels["grupo_x_asig_x_doce_id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_id_area"] : "Área";
   ...
   $tab_labels["grupo_x_asig_x_doce_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_id_asignatura"] : "Asignatura";
   ...
   $tab_labels["grupo_x_asig_x_doce_intensidad_horaria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_intensidad_horaria"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['labels']["grupo_x_asig_x_doce_intensidad_horaria"] : "Intensidad Horaria";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_grupo_x_asig_x_doce_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo_x_asig_x_doce_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
