<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_actividades_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_actividades_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id_actividad"]   = "id_actividad";
   $tab_labels["id_actividad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["id_actividad"])) ? $_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["id_actividad"] : "Id Actividad";
   $tab_ger_campos['actividad'] = "on";
   $tab_def_campos['actividad'] = "actividad";
   $tab_converte["actividad"]   = "actividad";
   $tab_labels["actividad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["actividad"])) ? $_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["actividad"] : "Actividad";
   $tab_ger_campos['codigo_desemp'] = "on";
   $tab_def_campos['codigo_desemp'] = "codigo_desemp";
   $tab_converte["codigo_desemp"]   = "codigo_desemp";
   $tab_labels["codigo_desemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["codigo_desemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["codigo_desemp"] : "Codigo Desemp";
   $tab_ger_campos['posicion'] = "on";
   $tab_def_campos['posicion'] = "posicion";
   $tab_converte["posicion"]   = "posicion";
   $tab_labels["posicion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["posicion"])) ? $_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["posicion"] : "Posicion";
   $tab_ger_campos['id_asignatura'] = "on";
   $tab_def_campos['id_asignatura'] = "id_asignatura";
   $tab_converte["id_asignatura"]   = "id_asignatura";
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['id_grupo'] = "on";
   $tab_def_campos['id_grupo'] = "id_grupo";
   $tab_converte["id_grupo"]   = "id_grupo";
   $tab_labels["id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_actividades']['labels']["id_grupo"] : "Id Grupo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_actividades']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_actividades']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - actividades</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_actividades_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_actividades']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
