<?php
class grid_grupo_x_asig_x_doce_1_normal_cero_lookup
{
//  
   ...
   {   
      ...
      $nm_comando = "select abrev from novedades where id_novedad = '$novedades_x_estudiante_fecha_id_novedad' order by novedad" ; 
      $conteudo = "" ; 
