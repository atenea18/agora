...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "t_estudiante_grupo_idstudent";$Nm_numeric[] = "t_estudiante_grupo_idstudent";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_t_estudiante_grupo_idstudent"  <?php echo $str_hide_t_estudiante_grupo_idstudent?>><?php
      $t_estudiante_grupo_idstudent_look = substr($this->Db->qstr($t_estudiante_grupo_idstudent), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_t_estudiante_grupo_idstudent" name="t_estudiante_grupo_idstudent_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_t_estudiante_grupo_idstudent"  <?php echo $str_display_t_estudiante_grupo_idstudent; ?> class="scFilterFieldFontOdd">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_novedades_x_estudiante_fecha_id_novedad"  <?php echo $str_hide_novedades_x_estudiante_fecha_id_novedad?>><?php
      $novedades_x_estudiante_fecha_id_novedad_look = substr($this->Db->qstr($novedades_x_estudiante_fecha_id_novedad), 1, -1); 
      $nmgp_def_dados = array(); 
