<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_desempeno_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_desempeno_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["codigo"]   = "codigo";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['superior'] = "on";
   $tab_def_campos['superior'] = "superior";
   $tab_converte["superior"]   = "superior";
   $tab_labels["superior"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["superior"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["superior"] : "Superior";
   $tab_ger_campos['id_grado'] = "on";
   $tab_def_campos['id_grado'] = "id_grado";
   $tab_converte["id_grado"]   = "id_grado";
   $tab_labels["id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_grado"] : "Id Grado";
   $tab_ger_campos['id_area'] = "on";
   $tab_def_campos['id_area'] = "id_area";
   $tab_converte["id_area"]   = "id_area";
   $tab_labels["id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_area"] : "Id Area";
   $tab_ger_campos['periodos'] = "on";
   $tab_def_campos['periodos'] = "periodos";
   $tab_converte["periodos"]   = "periodos";
   $tab_labels["periodos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["periodos"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["periodos"] : "Periodos";
   $tab_ger_campos['id_asignatura'] = "on";
   $tab_def_campos['id_asignatura'] = "id_asignatura";
   $tab_converte["id_asignatura"]   = "id_asignatura";
   $tab_labels["id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['id_clas_chs'] = "on";
   $tab_def_campos['id_clas_chs'] = "id_clas_chs";
   $tab_converte["id_clas_chs"]   = "id_clas_chs";
   $tab_labels["id_clas_chs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_clas_chs"])) ? $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['labels']["id_clas_chs"] : "Id Clas Chs";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - desempeno</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_desempeno_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_desempeno_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
