<?php
//
class form_evalua_actividad_dc2_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_det_evalua_actividad_dc2']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_det_evalua_actividad_dc2']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idgrupo)) 
          {
              $_SESSION['par_idgrupo'] = $this->par_idgrupo;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_evalua_actividad_dc2_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_evalua_actividad_dc2']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_evalua_actividad_dc2']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_evalua_actividad_dc2'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_evalua_actividad_dc2']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_evalua_actividad_dc2']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_evalua_actividad_dc2') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_evalua_actividad_dc2']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - t_evaluacion";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_evalua_actividad_dc2")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_evalua_actividad_dc2']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_evalua_actividad_dc2'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_orig'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura = " . $_SESSION['par_idasignatura'] . " AND id_estudiante = " . $_SESSION['par_idestudiante'] . " AND entorno = " . $_SESSION['entorno'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_pesq'] = " where id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura = " . $_SESSION['par_idasignatura'] . " AND id_estudiante = " . $_SESSION['par_idestudiante'] . " AND entorno = " . $_SESSION['entorno'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_evalua_actividad_dc2']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_evalua_actividad_dc2", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_evalua_actividad_dc2_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_evalua_actividad_dc2_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_evalua_actividad_dc2/form_evalua_actividad_dc2_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_evalua_actividad_dc2_erro.class.php"); 
      }
      $this->Erro      = new form_evalua_actividad_dc2_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao']))
         { 
             if ($this->id_estudiante != "" || $this->id_grupo != "" || $this->id_asignatura != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_evalua_actividad_dc2']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_det_evalua_actividad_dc2') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_det_evalua_actividad_dc2') . "/form_det_evalua_actividad_dc2_apl.php");
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_evalua_actividad_dc2']) || !is_array($this->NM_ajax_info['errList']['geral_form_evalua_actividad_dc2']))
              {
                  $this->NM_ajax_info['errList']['geral_form_evalua_actividad_dc2'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_evalua_actividad_dc2'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->id_estudiante == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['php_cmp_required']['id_estudiante']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['php_cmp_required']['id_estudiante'] == "on"))
      {
          ...
          if (!empty($this->id_estudiante) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante']) && !in_array($this->id_estudiante, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante']))
          {
    ...
    function ValidateField_dc2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dc2, 11, 1, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Dc 2; " ; 
                  if (!isset($Campos_Erros['dc2']))
                  {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_estudiante']['keyVal'] = form_evalua_actividad_dc2_pack_protect_string($this->nmgp_dados_form['id_estudiante']);
              $this->NM_ajax_info['fldList']['id_grupo']['keyVal'] = form_evalua_actividad_dc2_pack_protect_string($this->nmgp_dados_form['id_grupo']);
              $this->NM_ajax_info['fldList']['id_asignatura']['keyVal'] = form_evalua_actividad_dc2_pack_protect_string($this->nmgp_dados_form['id_asignatura']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total'] < 0)
              {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante'] = array(); 
}
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_evalua_actividad_dc2_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_evalua_actividad_dc2_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['Lookup_id_estudiante'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_estudiante']['valList'][$i] = form_evalua_actividad_dc2_pack_protect_string($v);
          }
   ...
   function ajax_return_values_actividades($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_evalua_actividad_dc2']['contr_erro'] = 'on';
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->actividades = $this->actividades_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['parms'] = "id_estudiante?#?$this->id_estudiante?@?id_grupo?#?$this->id_grupo?@?id_asignatura?#?$this->id_asignatura?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_evalua_actividad_dc2 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total'] = $qt_geral_reg_form_evalua_actividad_dc2;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_estudiante) && !empty($this->id_grupo) && !empty($this->id_asignatura))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_evalua_actividad_dc2 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] > $qt_geral_reg_form_evalua_actividad_dc2)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] = $qt_geral_reg_form_evalua_actividad_dc2; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_evalua_actividad_dc2) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] < $qt_geral_reg_form_evalua_actividad_dc2;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_evalua_actividad_dc2_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['where_filter_form'] . " and (id_grupo = " . $_SESSION['par_idgrupo'] . " AND id_asignatura = " . $_SESSION['par_idasignatura'] . " AND id_estudiante = " . $_SESSION['par_idestudiante'] . " AND entorno = " . $_SESSION['entorno'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_evalua_actividad_dc2_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_evalua_actividad_dc2_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_evalua_actividad_dc2_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evalua_actividad_dc2']['masterValue'] as $cmp_master => $val_master)
{
?>
