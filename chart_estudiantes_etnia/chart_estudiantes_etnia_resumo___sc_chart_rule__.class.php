...
class chart_estudiantes_etnia_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_students_etnia;
   ...
   var $conv_col;
   var $count_ger;
   var $sc_proc_quebra_students_etnia;
   var $count_students_etnia;
   var $sc_proc_quebra_t_estudiante_grupo_idstudent;
   var $count_t_estudiante_grupo_idstudent;

   //---- 
   function chart_estudiantes_etnia_resumo($tipo = "")
   {
      ...
      $this->array_total_students_etnia               = array();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_estudiantes_etnia']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_estudiantes_etnia']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_estudiantes_etnia']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['campos_busca'];
         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
         {
             $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
         }
     } 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_estudiantes_etnia", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['contr_total_geral'] == "OK")
      {
          $this->array_total_students_etnia = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['arr_total']['students_etnia'];
          $this->array_total_t_estudiante_grupo_idstudent = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['arr_total']['t_estudiante_grupo_idstudent'];
      }
      else
      {
          $this->array_total_students_etnia = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['arr_total']['students_etnia'] = $this->array_total_students_etnia;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['arr_total']['t_estudiante_grupo_idstudent'] = $this->array_total_t_estudiante_grupo_idstudent;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['summarizing_fields_control'] = array(
               'NM_Count' => array(
                   'label' => "Estudiantes x etnia",
                   'label_field' => "Estudiantes x etnia",
                   'options' => array(
       ...
       //-----
       foreach ($this->array_total_students_etnia as $i_students_etnia => $d_students_etnia) {
           if (!in_array($i_students_etnia, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_students_etnia[2] ] = $d_students_etnia[1];
               $this->comp_label[0][ $d_students_etnia[2] ] = $d_students_etnia[1];
           }
           foreach ($this->array_total_t_estudiante_grupo_idstudent[$i_students_etnia] as $i_t_estudiante_grupo_idstudent => $d_t_estudiante_grupo_idstudent) {
               if (!in_array($i_t_estudiante_grupo_idstudent, $this->comp_label[1][ $d_students_etnia[2] ], true)) {
                   $this->comp_index[1][ $d_t_estudiante_grupo_idstudent[2] ] = $d_t_estudiante_grupo_idstudent[1];
                   $this->comp_label[1][ $d_students_etnia[2] ][ $d_t_estudiante_grupo_idstudent[2] ] = $d_t_estudiante_grupo_idstudent[1];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'students.etnia', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_students_etnia => $l_students_etnia) {
           if (isset($this->array_total_students_etnia[$i_students_etnia])) {
               $this->comp_group[$i_students_etnia] = array();
           }
           foreach ($this->comp_label[1][$i_students_etnia] as $i_t_estudiante_grupo_idstudent => $l_t_estudiante_grupo_idstudent) {
               if (isset($this->array_total_t_estudiante_grupo_idstudent[$i_students_etnia][$i_t_estudiante_grupo_idstudent])) {
                   $this->comp_group[$i_students_etnia][$i_t_estudiante_grupo_idstudent] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_students_etnia;
       }
       elseif (1 == $level) {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               'title'    => $this->getChartText("Estudiantes x etnia"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Etnia"),
               'label_y'  => $this->getChartText("Estudiantes x etnia"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_estudiantes_etnia_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_estudiantes_etnia_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_estudiantes_etnia']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_estudiantes_etnia']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_estudiantes_etnia']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_estudiantes_etnia']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_estudiantes_etnia_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] = "print";
      ...
      $this->total   = new chart_estudiantes_etnia_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo___sc_chart_rule__("res", $this->array_total_students_etnia, $this->array_total_t_estudiante_grupo_idstudent);
      ksort($this->array_total_students_etnia);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_estudiantes_etnia_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_estudiantes_etnia_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_estudiantes_etnia_grafico::getChartModule('Pie');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_estudiantes_etnia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_estudiantes_etnia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_estudiantes_etnia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_estudiantes_etnia/chart_estudiantes_etnia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_estudiantes_etnia/chart_estudiantes_etnia_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         if (is_file("chart_estudiantes_etnia_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_estudiantes_etnia_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_estudiantes_etnia/chart_estudiantes_etnia_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
   ...
   function monta_html_fim()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['graf_pdf'] == "S")
      {
      }
      else
      {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_estudiantes_etnia_config_pivot.php?nome_apl=chart_estudiantes_etnia&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['chart_estudiantes_etnia_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_estudiantes_etnia@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          $nm_saida->saida("  if (\"pdf\" == x)\r\n");
          $nm_saida->saida("  {\r\n");
          $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_estudiantes_etnia/chart_estudiantes_etnia_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z;\r\n");
          $nm_saida->saida("  }\r\n");
          $nm_saida->saida("  else\r\n");
          $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_estudiantes_etnia_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_estudiantes_etnia/chart_estudiantes_etnia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_estudiantes_etnia_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_students_etnia, $quebra_t_estudiante_grupo_idstudent, $quebra_students_etnia_orig, $quebra_t_estudiante_grupo_idstudent_orig)
   {
      //----- Etnia
      if (!isset($this->array_total_students_etnia[$quebra_students_etnia_orig]))
      {
         $this->array_total_students_etnia[$quebra_students_etnia_orig][0] = 1;
         $this->array_total_students_etnia[$quebra_students_etnia_orig][1] = $quebra_students_etnia;
         $this->array_total_students_etnia[$quebra_students_etnia_orig][2] = $quebra_students_etnia_orig;
      }
      else
      {
         $this->array_total_students_etnia[$quebra_students_etnia_orig][0]++;
      }
      //----- Estudiantes
      if (!isset($this->array_total_t_estudiante_grupo_idstudent[$quebra_students_etnia_orig][$quebra_t_estudiante_grupo_idstudent_orig]))
      {
         $this->array_total_t_estudiante_grupo_idstudent[$quebra_students_etnia_orig][$quebra_t_estudiante_grupo_idstudent_orig][0] = 1;
         $this->array_total_t_estudiante_grupo_idstudent[$quebra_students_etnia_orig][$quebra_t_estudiante_grupo_idstudent_orig][1] = $quebra_t_estudiante_grupo_idstudent;
         $this->array_total_t_estudiante_grupo_idstudent[$quebra_students_etnia_orig][$quebra_t_estudiante_grupo_idstudent_orig][2] = $quebra_t_estudiante_grupo_idstudent_orig;
      }
      else
      {
         $this->array_total_t_estudiante_grupo_idstudent[$quebra_students_etnia_orig][$quebra_t_estudiante_grupo_idstudent_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT t_estudiante_grupo.idstudent as t_estudiante_grupo_idstudent, t_grupos.id_grado as t_grupos_id_grado, t_grupos.id_sede as t_grupos_id_sede, t_grupos.id_director_grupo as t_grupos_id_director_grupo, t_grupos.nombre_grupo as t_grupos_nombre_grupo, t_grupos.jornada as t_grupos_jornada, students.etnia as students_etnia from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT t_estudiante_grupo.idstudent as t_estudiante_grupo_idstudent, t_grupos.id_grado as t_grupos_id_grado, t_grupos.id_sede as t_grupos_id_sede, t_grupos.id_director_grupo as t_grupos_id_director_grupo, t_grupos.nombre_grupo as t_grupos_nombre_grupo, t_grupos.jornada as t_grupos_jornada, students.etnia as students_etnia from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_estudiantes_etnia']['where_pesq']; 
     $nmgp_order_by = " order by  students.etnia asc, t_estudiante_grupo.idstudent asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->students_etnia = $rs_res->fields[6] ;  
            $this->students_etnia_orig = $this->students_etnia;
            $this->t_estudiante_grupo_idstudent_orig = $this->t_estudiante_grupo_idstudent;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->students_etnia, $this->t_estudiante_grupo_idstudent, $this->students_etnia_orig,  $this->t_estudiante_grupo_idstudent_orig);
            }
   }
//
