<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_t_evaluacion_cabecera_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_t_evaluacion_cabecera_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['t_evaluacion_id_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_id_grupo'] = "t_evaluacion_id_grupo";
       $tab_converte["t_evaluacion_id_grupo"]   = "t_evaluacion_id_grupo";
   }
   else
   {
       $tab_def_campos['t_evaluacion_id_grupo'] = "t_evaluacion.id_grupo";
       $tab_converte["t_evaluacion.id_grupo"]   = "t_evaluacion_id_grupo";
   }
   $tab_labels["t_evaluacion_id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_grupo"] : "Id Grupo";
   $tab_ger_campos['t_evaluacion_id_area'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_id_area'] = "t_evaluacion_id_area";
       $tab_converte["t_evaluacion_id_area"]   = "t_evaluacion_id_area";
   }
   else
   {
       $tab_def_campos['t_evaluacion_id_area'] = "t_evaluacion.id_area";
       $tab_converte["t_evaluacion.id_area"]   = "t_evaluacion_id_area";
   }
   $tab_labels["t_evaluacion_id_area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_area"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_area"] : "Id Area";
   $tab_ger_campos['t_evaluacion_id_asignatura'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_id_asignatura'] = "t_evaluacion_id_asignatura";
       $tab_converte["t_evaluacion_id_asignatura"]   = "t_evaluacion_id_asignatura";
   }
   else
   {
       $tab_def_campos['t_evaluacion_id_asignatura'] = "t_evaluacion.id_asignatura";
       $tab_converte["t_evaluacion.id_asignatura"]   = "t_evaluacion_id_asignatura";
   }
   $tab_labels["t_evaluacion_id_asignatura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_asignatura"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_asignatura"] : "Id Asignatura";
   $tab_ger_campos['t_evaluacion_id_grado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_evaluacion_id_grado'] = "t_evaluacion_id_grado";
       $tab_converte["t_evaluacion_id_grado"]   = "t_evaluacion_id_grado";
   }
   else
   {
       $tab_def_campos['t_evaluacion_id_grado'] = "t_evaluacion.id_grado";
       $tab_converte["t_evaluacion.id_grado"]   = "t_evaluacion_id_grado";
   }
   $tab_labels["t_evaluacion_id_grado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_grado"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_evaluacion_id_grado"] : "Id Grado";
   $tab_ger_campos['t_grupos_nombre_grupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_grupos_nombre_grupo'] = "t_grupos_nombre_grupo";
       $tab_converte["t_grupos_nombre_grupo"]   = "t_grupos_nombre_grupo";
   }
   else
   {
       $tab_def_campos['t_grupos_nombre_grupo'] = "t_grupos.nombre_grupo";
       $tab_converte["t_grupos.nombre_grupo"]   = "t_grupos_nombre_grupo";
   }
   $tab_labels["t_grupos_nombre_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_grupos_nombre_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_grupos_nombre_grupo"] : "Nombre Grupo";
   $tab_ger_campos['t_grupos_id_sede'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_grupos_id_sede'] = "t_grupos_id_sede";
       $tab_converte["t_grupos_id_sede"]   = "t_grupos_id_sede";
   }
   else
   {
       $tab_def_campos['t_grupos_id_sede'] = "t_grupos.id_sede";
       $tab_converte["t_grupos.id_sede"]   = "t_grupos_id_sede";
   }
   $tab_labels["t_grupos_id_sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_grupos_id_sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_grupos_id_sede"] : "Id Sede";
   $tab_ger_campos['t_grupos_jornada'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_grupos_jornada'] = "t_grupos_jornada";
       $tab_converte["t_grupos_jornada"]   = "t_grupos_jornada";
   }
   else
   {
       $tab_def_campos['t_grupos_jornada'] = "t_grupos.jornada";
       $tab_converte["t_grupos.jornada"]   = "t_grupos_jornada";
   }
   $tab_labels["t_grupos_jornada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_grupos_jornada"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["t_grupos_jornada"] : "Jornada";
   $tab_ger_campos['grupo_x_asig_x_doce_id_docente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['grupo_x_asig_x_doce_id_docente'] = "grupo_x_asig_x_doce_id_docente";
       $tab_converte["grupo_x_asig_x_doce_id_docente"]   = "grupo_x_asig_x_doce_id_docente";
   }
   else
   {
       $tab_def_campos['grupo_x_asig_x_doce_id_docente'] = "grupo_x_asig_x_doce.id_docente";
       $tab_converte["grupo_x_asig_x_doce.id_docente"]   = "grupo_x_asig_x_doce_id_docente";
   }
   $tab_labels["grupo_x_asig_x_doce_id_docente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["grupo_x_asig_x_doce_id_docente"])) ? $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['labels']["grupo_x_asig_x_doce_id_docente"] : "Id Docente";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_t_evaluacion_cabecera_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_t_evaluacion_cabecera']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
