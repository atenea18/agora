...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_grupos_docentes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["agora_IV_____grid_grupos_docentes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_grupos_docentes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_grupos_docentes']['embutida_filho'] as $ind => $sc_init)
          {
