<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estudiantes_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estudiantes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['id_sede'] = "on";
   $tab_def_campos['id_sede'] = "id_sede";
   $tab_converte["id_sede"]   = "id_sede";
   $tab_labels["id_sede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["id_sede"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["id_sede"] : "Sede";
   $tab_ger_campos['id_jornada'] = "on";
   $tab_def_campos['id_jornada'] = "id_jornada";
   $tab_converte["id_jornada"]   = "id_jornada";
   $tab_labels["id_jornada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["id_jornada"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["id_jornada"] : "Jornada";
   $tab_ger_campos['grado_igreso'] = "on";
   $tab_def_campos['grado_igreso'] = "grado_igreso";
   $tab_converte["grado_igreso"]   = "grado_igreso";
   $tab_labels["grado_igreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["grado_igreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["grado_igreso"] : "Grado Ingreso";
   $tab_ger_campos['id_grupo'] = "on";
   $tab_def_campos['id_grupo'] = "id_grupo";
   $tab_converte["id_grupo"]   = "id_grupo";
   $tab_labels["id_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["id_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["id_grupo"] : "Grupo";
   ...
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['labels']["matricula"] : "Matriculados";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estudiantes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estudiantes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
