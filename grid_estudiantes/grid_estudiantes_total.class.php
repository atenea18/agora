...
class grid_estudiantes_total
{
   ...
   //----- 
   function grid_estudiantes_total($sc_page)
   {
   ...
   {
      global $nada, $nm_lang , $id_sede, $id_jornada, $grado_igreso, $id_grupo, $grado_anterior;
   ...
   {
      global $tot_id_grupo , $id_sede, $id_jornada, $grado_igreso, $id_grupo, $grado_anterior;  
      $tot_id_grupo = array() ;  
      $tot_id_grupo[0] = $id_grupo ; 
   }

   //----- 
   function resumo_sc_free_group_by($destino_resumo, &$array_total_id_grupo)
   {
      global $nada, $nm_lang, $nombre, $matricula, $edad, $id_sede, $id_jornada, $grado_igreso, $id_grupo, $grado_anterior;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['SC_Gb_Free_sql'][$cmp_gb]))
       {
           $free_group_by .= (empty($free_group_by)) ? $cmp_gb : ", " . $cmp_gb;
       }
   }
     $comando  = "select count(*), id_grupo from " . $this->Ini->nm_tabela . " " . $this->sc_where_atual . " group by " . $free_group_by . "  " . $nmgp_order_by;
