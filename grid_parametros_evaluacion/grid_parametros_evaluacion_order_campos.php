<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_parametros_evaluacion_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_parametros_evaluacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_modelo_eval'] = "on";
   $tab_def_campos['id_modelo_eval'] = "id_modelo_eval";
   $tab_converte["id_modelo_eval"]   = "id_modelo_eval";
   $tab_labels["id_modelo_eval"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["id_modelo_eval"])) ? $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["id_modelo_eval"] : "Id Modelo Eval";
   $tab_ger_campos['etiqueta_grupo_1'] = "on";
   $tab_def_campos['etiqueta_grupo_1'] = "etiqueta_grupo_1";
   $tab_converte["etiqueta_grupo_1"]   = "etiqueta_grupo_1";
   $tab_labels["etiqueta_grupo_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["etiqueta_grupo_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["etiqueta_grupo_1"] : "Etiqueta Grupo 1";
   $tab_ger_campos['num_columnas_grupo1'] = "on";
   $tab_def_campos['num_columnas_grupo1'] = "num_columnas_grupo1";
   $tab_converte["num_columnas_grupo1"]   = "num_columnas_grupo1";
   $tab_labels["num_columnas_grupo1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["num_columnas_grupo1"])) ? $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["num_columnas_grupo1"] : "Num Columnas Grupo 1";
   $tab_ger_campos['porcentaje_grupo1'] = "on";
   $tab_def_campos['porcentaje_grupo1'] = "porcentaje_grupo1";
   $tab_converte["porcentaje_grupo1"]   = "porcentaje_grupo1";
   $tab_labels["porcentaje_grupo1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["porcentaje_grupo1"])) ? $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["porcentaje_grupo1"] : "Porcentaje Grupo 1";
   $tab_ger_campos['etiqueta_grupo_2'] = "on";
   $tab_def_campos['etiqueta_grupo_2'] = "etiqueta_grupo_2";
   $tab_converte["etiqueta_grupo_2"]   = "etiqueta_grupo_2";
   $tab_labels["etiqueta_grupo_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["etiqueta_grupo_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["etiqueta_grupo_2"] : "Etiqueta Grupo 2";
   $tab_ger_campos['num_columnas_grupo2'] = "on";
   $tab_def_campos['num_columnas_grupo2'] = "num_columnas_grupo2";
   $tab_converte["num_columnas_grupo2"]   = "num_columnas_grupo2";
   $tab_labels["num_columnas_grupo2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["num_columnas_grupo2"])) ? $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['labels']["num_columnas_grupo2"] : "Num Columnas Grupo 2";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - parametros_evaluacion</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_parametros_evaluacion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_parametros_evaluacion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
