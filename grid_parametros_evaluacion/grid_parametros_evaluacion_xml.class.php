...
class grid_parametros_evaluacion_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_parametros_evaluacion_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_parametros_evaluacion.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_parametros_evaluacion']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_parametros_evaluacion']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_parametros_evaluacion']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_parametros_evaluacion']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_parametros_evaluacion";
   ...
   function NM_export_id_modelo_eval()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_modelo_eval))
         {
             $this->id_modelo_eval = sc_convert_encoding($this->id_modelo_eval, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " id_modelo_eval =\"" . $this->trata_dados($this->id_modelo_eval) . "\"";
   }
   //----- etiqueta_grupo_1
   function NM_export_etiqueta_grupo_1()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->etiqueta_grupo_1))
         {
             $this->etiqueta_grupo_1 = sc_convert_encoding($this->etiqueta_grupo_1, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " etiqueta_grupo_1 =\"" . $this->trata_dados($this->etiqueta_grupo_1) . "\"";
   }
   //----- num_columnas_grupo1
   function NM_export_num_columnas_grupo1()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->num_columnas_grupo1))
         {
             $this->num_columnas_grupo1 = sc_convert_encoding($this->num_columnas_grupo1, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " num_columnas_grupo1 =\"" . $this->trata_dados($this->num_columnas_grupo1) . "\"";
   }
   //----- porcentaje_grupo1
   function NM_export_porcentaje_grupo1()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->porcentaje_grupo1))
         {
             $this->porcentaje_grupo1 = sc_convert_encoding($this->porcentaje_grupo1, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " porcentaje_grupo1 =\"" . $this->trata_dados($this->porcentaje_grupo1) . "\"";
   }
   //----- etiqueta_grupo_2
   function NM_export_etiqueta_grupo_2()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->etiqueta_grupo_2))
         {
             $this->etiqueta_grupo_2 = sc_convert_encoding($this->etiqueta_grupo_2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " etiqueta_grupo_2 =\"" . $this->trata_dados($this->etiqueta_grupo_2) . "\"";
   }
   //----- num_columnas_grupo2
   function NM_export_num_columnas_grupo2()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->num_columnas_grupo2))
         {
             $this->num_columnas_grupo2 = sc_convert_encoding($this->num_columnas_grupo2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " num_columnas_grupo2 =\"" . $this->trata_dados($this->num_columnas_grupo2) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_parametros_evaluacion']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_parametros_evaluacion']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - parametros_evaluacion :: XML</TITLE>
