...
<?php
include_once("control_matricular_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_matricular_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['recarga'];
}
?>
...
<?php
 include_once("control_matricular_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_matricular_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_matricular_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_matricular_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_a_lectivo_line" id="hidden_field_data_a_lectivo" style="<?php echo $sStyleHidden_a_lectivo; ?>"> <span class="scFormLabelOddFormat css_a_lectivo_label"><span id="id_label_a_lectivo"><?php echo $this->nm_new_label['a_lectivo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['a_lectivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['a_lectivo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jornada_line" id="hidden_field_data_jornada" style="<?php echo $sStyleHidden_jornada; ?>"> <span class="scFormLabelOddFormat css_jornada_label"><span id="id_label_jornada"><?php echo $this->nm_new_label['jornada']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['jornada']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['jornada'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_grado_line" id="hidden_field_data_grado" style="<?php echo $sStyleHidden_grado; ?>"> <span class="scFormLabelOddFormat css_grado_label"><span id="id_label_grado"><?php echo $this->nm_new_label['grado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['grado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['grado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_semestre_line" id="hidden_field_data_semestre" style="<?php echo $sStyleHidden_semestre; ?>"> <span class="scFormLabelOddFormat css_semestre_label"><span id="id_label_semestre"><?php echo $this->nm_new_label['semestre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['semestre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['php_cmp_required']['semestre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['Lookup_semestre'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['Lookup_semestre'][] = '2'; ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_matricular_mob");
 parent.scAjaxDetailHeight("control_matricular_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
