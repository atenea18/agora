...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_matricular"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_sc_btn_0()
{
  ...
  tb_show('', '<?php echo $this->Ini->link_grid_novedades_cons; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&script_case_session=<?php echo session_id() ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "sc_redir_insert*scinok*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=600&width=400&modal=true', '');
}
function sc_btn_sc_btn_1()
{
  ...
  tb_show('', '<?php echo $this->Ini->link_form_nov_exclu_edit; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&script_case_session=<?php echo session_id() ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutsc_redir_atualiz*scinok*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=600&width=550&modal=true', '');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_matricular']['where_detal']))
  {
?>  
...
{ 
   ...
   document.F4.action               = "control_matricular_fim.php";
   document.F4.submit(); 
} 
...
{
    NovaJanela = window.open ("control_matricular_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
